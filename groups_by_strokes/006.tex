...
\begin{entry}{杀}{6}{⽊}
  \begin{phonetics}{杀}{sha1}[][HSK 5]
    \definition{adv.}{em extremo; excessivamente; usado após o verbo, indica grau intenso.}
    \definition{v.}{matar; abater; esquartejar |
lutar; entrar em batalha |
enfraquecer; reduzir; diminuir |
decolar; neutralizar}
  \end{phonetics}
\end{entry}
