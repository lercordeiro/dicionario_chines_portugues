...
\begin{entry}{会}{6}[Radical 人]
  \begin{phonetics}{会}{hui4}
    ...
    \definition{v.}{saber | ter habilidade | saber como fazer | ser provável | ter certeza de | encontrar | reunir-se}
  \end{phonetics}
  \begin{phonetics}{会}{kuai4}
    \definition{s.}{contador | contabilidade}
    \definition{v.}{equilibrar contas}
  \end{phonetics}
\end{entry}
...
\begin{entry}{传}{6}[Radical 人]
  \begin{phonetics}{传}{chuan2}
    \definition{v.}{passar para | espalhar | transmitir | infectar | transferir | circular | conduzir (eletricidade)}
  \end{phonetics}
  \begin{phonetics}{传}{zhuan4}
    \definition{s.}{biografia | narrativa histórica | comentários | estação de retransmissão}
  \end{phonetics}
\end{entry}

\begin{entry}{传来}{6,7}
  \begin{phonetics}{传来}{chuan2lai2}
...
\begin{entry}{动力}{6,2}
  \begin{phonetics}{动力}{dong4li4}
    \definition{s.}{força motriz | força | (fig.) motivação, ímpeto}
  \end{phonetics}
\end{entry}
...
\begin{entry}{回}{6}[Radical ⼞]
  \begin{phonetics}{回}{hui2}
    \definition{v.}{regressar}
  \end{phonetics}
\end{entry}

\begin{entry}{回去}{6,5}
  \begin{phonetics}{回去}{hui2qu5}
    \definition{v.}{regressar | voltar | estar de volta | (a partir da minha localização)}
  \end{phonetics}
\end{entry}

\begin{entry}{回来}{6,7}
  \begin{phonetics}{回来}{hui2lai5}
...
\begin{entry}{地区}{6,4}
  \begin{phonetics}{地区}{di4qu1}
    \definition{adj.}{regional}
    \definition[个]{s.}{área | distrito (não necessariamente unidade administrativa formal) | local | região}
...
\begin{entry}{多}{6}[Radical ⼣]
  \begin{phonetics}{多}{duo1}
    \definition{adv.}{muito | muitos | em excesso}
...
\begin{entry}{多少}{6,4}
  \begin{phonetics}{多少}{duo1shao3}
    \definition{num.}{número | quantidade}
  \end{phonetics}
  \begin{phonetics}{多少}{duo1shao5}
    \definition{adv.}{quanto? | quantos? | (para mais de 10 itens)}
  \end{phonetics}
\end{entry}
...
\begin{entry}{当初}{6,7}
  \begin{phonetics}{当初}{dang1chu1}
    \definition{adv.}{naquela hora | originalmente}
  \end{phonetics}
\end{entry}

\begin{entry}{当然}{6,12}
  \begin{phonetics}{当然}{dang1ran2}
    \definition{adv.}{claro | certamente}
  \end{phonetics}
\end{entry}
