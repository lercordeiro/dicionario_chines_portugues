...
\begin{entry}{会议}{6,5}
  \begin{phonetics}{会议}{hui4yi4}
    \definition[场,届]{s.}{reunião | conferência | conselho | congresso}
  \end{phonetics}
\end{entry}
...
\begin{entry}{关系}{6,7}
  \begin{phonetics}{关系}{guan1xi5}
    \definition[个]{s.}{relação | conexão | relacionamento | rolamento | impacto | significado | causa | razão (geralmente com 由于 a ou 因为) | credenciais que mostram filiação ou afiliação a uma organização}
  \end{phonetics}
\end{entry}
