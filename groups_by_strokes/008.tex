...
\begin{Entry}{货机}{8,6}{⾙、⽊}
  \begin{Phonetics}{货机}{huo4ji1}
    \definition{s.}{aeronave de carga (ou avião); cargueiro aéreo (oposto de 客机); aeronaves utilizadas principalmente para o transporte de carga}
  \seealsoref{客机}{ke4ji1}
  \end{Phonetics}
\end{Entry}
