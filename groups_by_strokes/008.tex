...
\begin{entry}{泪}{8}[Radical ⽔]
  \begin{phonetics}{泪}{lei4}[][HSK 4]
    \definition[滴]{s.}{lágrima}
  \end{phonetics}
\end{entry}

\begin{entry}{泪水}{8,4}[Radicais ⽔、⽔]
...
\begin{entry}{轮船}{8,11}[Radicais ⾞、⾈]
  \begin{phonetics}{轮船}{lun2chuan2}[][HSK 4]
    \definition[艘]{s.}{navio}
  \end{phonetics}
\end{entry}

\begin{entry}{轮椅}{8,12}[Radicais ⾞、⽊]
