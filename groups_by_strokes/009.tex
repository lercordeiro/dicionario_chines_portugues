...
\begin{entry}{信}{9}[Radical 人]
  \begin{phonetics}{信}{xin4}
    \definition[封]{s.}{carta | correspondência}
  \end{phonetics}
\end{entry}

\begin{entry}{信心}{9,4}
  \begin{phonetics}{信心}{xin4xin1}
...
\begin{entry}{信用卡}{9,5,5}
  \begin{phonetics}{信用卡}{xin4yong4ka3}
...
\begin{entry}{前天}{9,4}
  \begin{phonetics}{前天}{qian2tian1}
    \definition{adv.}{anteontem}
  \end{phonetics}
\end{entry}

\begin{entry}{前边}{9,5}
  \begin{phonetics}{前边}{qian2bian5}
    \definition{adv.}{à frente | da frente}
  \end{phonetics}
\end{entry}

\begin{entry}{前年}{9,6}
  \begin{phonetics}{前年}{qian2nian2}
...
\begin{entry}{南方}{9,4}
  \begin{phonetics}{南方}{nan2fang1}
    \definition{s.}{sul | o Sul | a parte sul do país}
  \end{phonetics}
\end{entry}

\begin{entry}{南边}{9,5}
  \begin{phonetics}{南边}{nan2bian5}
...
\begin{entry}{哪}{9}[Radical 口]
  \begin{phonetics}{哪}{na3}
    \definition{prep.}{que? | qual?}
  \end{phonetics}
\end{entry}

\begin{entry}{哪儿}{9,2}
  \begin{phonetics}{哪儿}{na3r5}
    \definition{adv.}{onde?}
  \end{phonetics}
\end{entry}

\begin{entry}{哪里}{9,7}
  \begin{phonetics}{哪里}{na3li3}
    \definition{adv.}{onde?}
  \end{phonetics}
\end{entry}

\begin{entry}{哪些}{9,8}
  \begin{phonetics}{哪些}{na3xie1}
...
\begin{entry}{差不多}{9,4,6}
  \begin{phonetics}{差不多}{cha4bu5duo1}
...
\begin{entry}{很}{9}[Radical 彳]
  \begin{phonetics}{很}{hen3}
    \definition{adv.}{muito | mui | advérbio de grau}
  \end{phonetics}
\end{entry}
...
\begin{entry}{怎么办}{9,3,4}
  \begin{phonetics}{怎么办}{zen3me5ban4}
...
\begin{entry}{怎么样}{9,3,10}
  \begin{phonetics}{怎么样}{zen3me5yang4}
...
\begin{entry}{星期二}{9,12,2}
  \begin{phonetics}{星期二}{xing1qi1'er4}
...
\begin{entry}{星期天}{9,12,4}
  \begin{phonetics}{星期天}{xing1qi1tian1}
...
\begin{entry}{星期日}{9,12,4}
  \begin{phonetics}{星期日}{xing1qi1ri4}
    \definition{s.}{domingo}
...
\begin{entry}{洗手间}{9,4,7}
  \begin{phonetics}{洗手间}{xi3shou3jian1}
...
\begin{entry}{看见}{9,4}
  \begin{phonetics}{看见}{kan4jian4}
    \definition{v.}{encontrar | enxergar | ver | avistar}
  \end{phonetics}
\end{entry}

\begin{entry}{看到}{9,8}
  \begin{phonetics}{看到}{kan4dao4}
    \definition{v.}{ver}
  \end{phonetics}
\end{entry}

\begin{entry}{看法}{9,8}
  \begin{phonetics}{看法}{kan4fa3}
    \definition[个]{s.}{modo de olhar alguma coisa | ponto de vista | opinião}
  \end{phonetics}
\end{entry}

\begin{entry}{看病}{9,10}
  \begin{phonetics}{看病}{kan4bing4}
...
\begin{entry}{给……打电话}{9,5,5,8}
  \begin{phonetics}{给……打电话}{gei3 da3dian4hua4}
...
\begin{entry}{语}{9}[Radical 言]
  \begin{phonetics}{语}{yu3}
    \definition{s.}{dialeto | linguagem | fala}
  \end{phonetics}
  \begin{phonetics}{语}{yu4}
    \definition{v.}{contar para | falar para}
  \end{phonetics}
\end{entry}
...
\begin{entry}{重}{9}[Radical ⾥]
  ...
  \end{phonetics}
  \begin{phonetics}{重}{zhong4}
    \definition{adj.}{pesado}
  \end{phonetics}
\end{entry}
...
\begin{entry}{院}{9}[Radical 阜]
  \begin{phonetics}{院}{yuan4}
    \definition[个]{s.}{pátio | instituição}
  \end{phonetics}
\end{entry}

\begin{entry}{院子}{9,3}
  \begin{phonetics}{院子}{yuan4zi5}
    \definition[个]{s.}{pátio | jardim | quintal}
  \end{phonetics}
\end{entry}

\begin{entry}{院长}{9,4}
  \begin{phonetics}{院长}{yuan4zhang3}
...
\begin{entry}{面}{9}[Radical 面][Kangxi 176]
  \begin{phonetics}{面}{mian4}
    \definition{clas.}{para objetos com superfície plana como tambores, espelhos, bandeiras, etc.}
    \definition{s.}{farinha | massa | (gíria) (uma pessoa) ineficaz}
  \end{phonetics}
\end{entry}

\begin{entry}{面包}{9,5}
  \begin{phonetics}{面包}{mian4bao1}
...
\begin{entry}{音乐会}{9,5,6}
  \begin{phonetics}{音乐会}{yin1yue4hui4}
