...
\begin{entry}{信}{9}{⼈}
  \begin{phonetics}{信}{xin4}[][HSK 2,3]
    ...
    \definition{adv.}{à vontade; ao acaso; sem plano; aleatoriamente}
    \definition[封,个,张]{s.}{carta; correio | mensagem; palavra; informação | sinal; evidência | confiança; fé | fusível | arsênico}
...
\begin{entry}{修}{9}{⼈}
  \begin{phonetics}{修}{xiu1}[][HSK 3]
    ...
    \definition{v.}{embelezar; decorar | consertar; reparar; reformar | escrever; compilar | estudar; cultivar | construir; edificar | aparar; podar}
  \end{phonetics}
\end{entry}
