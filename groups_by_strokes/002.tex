...
\begin{entry}{七}{2}[Radical ⼀]
  \begin{phonetics}{七}{qi1}[][HSK 1]
    \definition{num.}{sete; 7}
  \end{phonetics}
\end{entry}

\begin{entry}{七夕}{2,3}[Radicais ⼀、⼣]
...
\begin{entry}{力}{2}[Kangxi 19][Radical ⼒]
...
\begin{entry}{十}{2}[Kangxi 24][Radical ⼗]
  \begin{phonetics}{十}{shi2}[][HSK 1]
    \definition{num.}{dez; 10 | dezena}
  \end{phonetics}
\end{entry}

\begin{entry}{十分}{2,4}[Radicais ⼗、⼑]
...
\begin{entry}{厂}{2}[Kangxi 27][Radical ⼚]
