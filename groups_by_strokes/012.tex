...
\begin{entry}{喂母乳}{12,5,8}[Radicais ⼝、⽏、⼄]
...
\begin{entry}{葵花}{12,7}[Radicais ⾋、⾋]
  \begin{phonetics}{葵花}{kui2hua1}
    \definition{s.}{girassol (flor)}
  \end{phonetics}
\end{entry}

\begin{entry}{街}{12}[Radical ⾏]
  \begin{phonetics}{街}{jie1}[][HSK 2]
    \definition[条]{s.}{rua}
  \end{phonetics}
\end{entry}

\begin{entry}{街道}{12,12}[Radicais ⾏、⾡]
