...
\begin{EntryWithPhonetic}{西式餐厅}{xi1shi4 can1ting1}{6,6,16,4}{⾑,⼷,⾷,⼚}[HSK 5]
  \definition{s.}{restaurante ocidental; restaurante de estilo ocidental}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{西式厨房}{xi1shi4 chu2fang2}{6,6,12,8}{⾑,⼷,⼚,⼾}[HSK 5]
...
\begin{EntryWithPhonetic}{媳妇儿}{xi2fu5r5}{13,6,2}{⼥,⼥,⼉}
...
\begin{EntryWithPhonetic}{瞎聊}{xia1liao2}{15,11}{⽬,⽿}[HSK 5]
  \definition{v.}{conversar sobre tudo e mais um pouco; jogar conversa fora | tagarelar}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{下来}{xia4lai2}{3,7}{⼀,⽊}[HSK 3]
...
\begin{EntryWithPhonetic}{下面}{xia4mian4}{3,9}{⼀,⾯}[HSK 3]
...
\begin{EntryWithPhonetic}{下去}{xia4qu4}{3,5}{⼀,⼛}[HSK 3]
...
\begin{EntryWithPhonetic}{下台}{xia4tai2}{3,5}{⼀,⼝}[HSK 7-9]
...
\begin{EntryWithPhonetic}{现代人}{xian4dai4 ren2}{8,5,2}{⾒,⼈,⼈}[HSK 5]
...
\begin{EntryWithPhonetic}{现实主义者}{xian4shi2 zhu3yi4 zhe3}{8,8,5,3,8}{⾒,⼧,⼂,⼂,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{献身}{xian4shen1}{13,7}{⽝,⾝}
...
\begin{EntryWithPhonetic}{相像}{xiang1xiang4}{9,13}{⽬,⼈}
...
\begin{EntryWithPhonetic}{相应}{xiang1ying1}{9,7}{⽬,⼴}
...
\begin{EntryWithPhonetic}{相应}{xiang1ying5}{9,7}{⽬,⼴}
...
%%%%%%%%%% 降 %%%%%%%%%%
\subsection*{降}\addcontentsline{loh}{figure}{降 \dpy{xiang2}}

\begin{EntryWithPhonetic}{降}{xiang2}{8}{⾩}
...
\begin{EntryWithPhonetic}{享乐}{xiang3le4}{8,5}{⼇,⼃}
...
\begin{EntryWithPhonetic}{享用}{xiang3yong4}{8,5}{⼇,⽤}
...
\begin{EntryWithPhonetic}{想不开}{xiang3bu4kai1}{13,4,4}{⼼,⼀,⼶}[HSK 5]
...
\begin{EntryWithPhonetic}{项目负责人}{xiang4mu4 fu4ze2 ren2}{9,5,6,8,2}{⾴,⽬,⾙,⾙,⼈}[HSK 5]
...
\begin{EntryWithPhonetic}{消极情绪}{xiao1ji2 qing2xu4}{10,7,11,11}{⽔,⽊,⼼,⽷}[HSK 5]
...
\begin{EntryWithPhonetic}{销售人员}{xiao1shou4 ren2yuan2}{12,11,2,7}{⾦,⼝,⼈,⼝}[HSK 5]
  \definition{s.}{equipe de vendas; vendedores}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{销售员}{xiao1shou4 yuan2}{12,11,7}{⾦,⼝,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{小道消息}{xiao3dao4 xiao1xi1}{3,12,10,10}{⼩,⾡,⽔,⼼}[HSK 5]
  \definition{s.}{fofoca; boatos | boato; rumor}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{小说家}{xiao3shuo1 jia1}{3,9,10}{⼩,⾔,⼧}[HSK 5]
  \definition[位,名,个,些]{s.}{romancista; escritor de ficção; ficcionalista}
...
\begin{EntryWithPhonetic}{小题大做}{xiao3ti2da4zuo4}{3,15,3,11}{⼩,⾴,⼤,⼈}[HSK 5]
  \definition{expr.}{``Fazer um grande alvoroço por uma coisa pequena.''; fazer escândalo por; tratar uma questão trivial como um problema grave, sugerindo que não vale a pena fazê"-lo; fazer alvoroço por uma ninharia; fazer tempestade em copo d'água}
  \synonymref{大惊小怪}{da4jing1-xiao3guai4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{小偷儿}{xiao3tou1 er5}{3,11,2}{⼩,⼈,⼉}[HSK 5]
...
\begin{EntryWithPhonetic}{谢绝}{xie4jue2}{12,9}{⾔,⽷}[HSK 5]
...
\begin{EntryWithPhonetic}{心理医生}{xin1li3 yi1sheng1}{4,11,7,5}{⼼,⽟,⼖,⽣}[HSK 5]
  \definition{s.}{psicólogo; terapeuta}[心理医生暗示他放松。===O terapeuta sugeriu que ele relaxasse.]
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{心理治疗师}{xin1li3 zhi4liao2 shi1}{4,11,8,7,6}{⼼,⽟,⽔,⽧,⼱}[HSK 5]
...
\begin{EntryWithPhonetic}{新闻发言人}{xin1wen2 fa1yan2 ren2}{13,9,5,7,2}{⽄,⾨,⼜,⾔,⼈}[HSK 5]
  \definition{s.}{porta"-voz; representante; intérprete}[新闻发言人今天发表声明。===O porta"-voz divulgou um comunicado hoje.]
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{新闻媒体}{xin1wen2 mei2ti3}{13,9,12,7}{⽄,⾨,⼥,⼈}[HSK 5]
...
\begin{EntryWithPhonetic}{兴盛}{xing1sheng4}{6,11}{⼋,⽫}
  \definition{adj.}{próspero; florescente}
...
\begin{EntryWithPhonetic}{性格直}{xing4ge2 zhi2}{8,10,8}{⼼,⽊,⽬}[HSK 5]
...
\begin{EntryWithPhonetic}{雄壮}{xiong2zhuang4}{12,6}{⾫,⼠}
...
\begin{EntryWithPhonetic}{休闲中心}{xiu1xian2 zhong1xin1}{6,7,4,4}{⼈,⾨,⼁,⼼}[HSK 5]
...
\begin{EntryWithPhonetic}{修造}{xiu1zao4}{9,10}{⼈,⾡}
...
\begin{EntryWithPhonetic}{修筑}{xiu1zhu4}{9,12}{⼈,⽵}
...
\begin{EntryWithPhonetic}{学前班}{xue2qian2ban1}{8,9,10}{⼦,⼑,⽟}
  \definition{s.}{pré"-escola; jardim de infância | aula pré"-escolar}
  \seealsoref{幼儿园}{you4'er2yuan2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{学生餐厅}{xue2sheng1 can1ting1}{8,5,16,4}{⼦,⽣,⾷,⼚}[HSK 5]
  \definition{s.}{refeitório estudantil}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{学生处}{xue2sheng1 chu4}{8,5,5}{⼦,⽣,⼡}[HSK 5]
  \definition{s.}{divisão de assuntos estudantis (em instituições de ensino superior) | escritório de assuntos estudantis}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{学生登记处}{xue2sheng1 deng1ji4 chu4}{8,5,12,5,5}{⼦,⽣,⽨,⾔,⼡}[HSK 5]
  \definition{s.}{registro de alunos}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{学生公寓}{xue2sheng1 gong1yu4}{8,5,4,12}{⼦,⽣,⼋,⼧}[HSK 5]
  \definition{s.}{dormitório estudantil}[学生公寓离学校很近。===Os dormitórios estudantis ficam muito perto da escola.]
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{学生宿舍}{xue2sheng1 su4she4}{8,5,11,8}{⼦,⽣,⼧,⾆}[HSK 5]
...
\begin{EntryWithPhonetic}{学习用具}{xue2xi2 yong4ju4}{8,3,5,8}{⼦,⼄,⽤,⼋}[HSK 5]
...
\begin{EntryWithPhonetic}{学校证明}{xue2xiao4 zheng4ming2}{8,10,7,8}{⼦,⽊,⾔,⽇}[HSK 5]
...
\begin{EntryWithPhonetic}{寻找帮助}{xun2zhao3 bang1zhu4}{6,7,9,7}{⼨,⼿,⼱,⼒}[HSK 5]
