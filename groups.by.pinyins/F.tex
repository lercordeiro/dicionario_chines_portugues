...
%%% F
%%%
\section*{F}\addcontentsline{toc}{section}{F}\addcontentsline{loh}{figure}{\#\#\#\#\#\#\#\# F}

%%%%%%%%%% 发 %%%%%%%%%%
\subsection*{发}\addcontentsline{loh}{figure}{发 \dpy{fa1}}
...
\begin{EntryWithPhonetic}{发病}{fa1bing4}{5,10}{⼜,⽧}[HSK 6]
...
\begin{EntryWithPhonetic}{发布会}{fa1bu4 hui4}{5,5,6}{⼜,⼱,⼈}[HSK 7-9]
...
\begin{EntryWithPhonetic}{发出}{fa1chu1}{5,5}{⼜,⼐}[HSK 3]
...
\begin{EntryWithPhonetic}{发达地区}{fa1da2 di4qu1}{5,6,6,4}{⼜,⾡,⼟,⼖}[HSK 5]
  \definition{s.}{região desenvolvida; área desenvolvida}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{发电}{fa1dian4}{5,5}{⼜,⽥}[HSK 6]
...
\begin{EntryWithPhonetic}{发放}{fa1fang4}{5,8}{⼜,⽅}[HSK 6]
...
\begin{EntryWithPhonetic}{发放银子}{fa1fang4  yin2zi5}{5,8,11,3}{⼜,⽅,⾦,⼦}[HSK 5]
  \definition{v.}{distribuir dinheiro}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{发奋图强}{fa1fen4-tu2qiang2}{5,8,8,12}{⼜,⼤,⼞,⼸}
...
\begin{EntryWithPhonetic}{发愤图强}{fa1fen4-tu2qiang2}{5,12,8,12}{⼜,⼼,⼞,⼸}[HSK 7-9]
...
\begin{EntryWithPhonetic}{发明家}{fa1ming2 jia1}{5,8,10}{⼜,⽇,⼧}[HSK 5]
  \definition{s.}{inventor; aqueles que criam novos dispositivos, novos designs ou novos métodos}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{发明者}{fa1ming2 zhe3}{5,8,8}{⼜,⽇,⽼}[HSK 5]
  \definition{s.}{inventor}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{发怒}{fa1nu4}{5,9}{⼜,⼼}[HSK 6]
...
\begin{EntryWithPhonetic}{发脾气}{fa1pi2qi5}{5,12,4}{⼜,⾁,⽓}[HSK 7-9]
...
\begin{EntryWithPhonetic}{发起}{fa1qi3}{5,10}{⼜,⾛}[HSK 6]
...
\begin{EntryWithPhonetic}{发送}{fa1song4}{5,9}{⼜,⾡}[HSK 3]
...
\begin{EntryWithPhonetic}{发现者}{fa1xian4zhe3}{5,8,8}{⼜,⾒,⽼}
...
\begin{EntryWithPhonetic}{发言人}{fa1yan2ren2}{5,7,2}{⼜,⾔,⼈}[HSK 6]
  \definition{s.}{porta"-voz}
  \synonymref{代言人}{dai4yan2ren2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{发炎}{fa1//yan2}{5,8}{⼜,⽕}[HSK 6]
...
\begin{EntryWithPhonetic}{发音}{fa1//yin1}{5,9}{⼜,⾳}
...
%%%%%%%%%% 罚 %%%%%%%%%%
\subsection*{罚}\addcontentsline{loh}{figure}{罚 \dpy{fa2}}
...
%%%%%%%%%% 阀 %%%%%%%%%%
\subsection*{阀}\addcontentsline{loh}{figure}{阀 \dpy{fa2}}
...
%%%%%%%%%% 筏 %%%%%%%%%%
\subsection*{筏}\addcontentsline{loh}{figure}{筏 \dpy{fa2}}
...
%%%%%%%%%% 法 %%%%%%%%%%
\subsection*{法}\addcontentsline{loh}{figure}{法 \dpy{fa3}}
...
\begin{EntryWithPhonetic}{法令}{fa3ling4}{8,5}{⽔,⼈}
...
\begin{EntryWithPhonetic}{法庭}{fa3ting2}{8,9}{⽔,⼴}[HSK 6]
...
\begin{EntryWithPhonetic}{法语}{fa3yu3}{8,9}{⽔,⾔}[HSK 6]
...
\begin{EntryWithPhonetic}{法则}{fa3ze2}{8,6}{⽔,⼑}
...
\begin{EntryWithPhonetic}{法制}{fa3zhi4}{8,8}{⽔,⼑}[HSK 5]
  \definition{s.}{legalidade; instituições jurídicas; sistema jurídico}
  \synonymref{规章}{gui1zhang1}
\end{EntryWithPhonetic}

%%%%%%%%%% 发 %%%%%%%%%%
\subsection*{发}\addcontentsline{loh}{figure}{发 \dpy{fa4}}
...
%%%%%%%%%% 帆 %%%%%%%%%%
\subsection*{帆}\addcontentsline{loh}{figure}{帆 \dpy{fan1}}
...
%%%%%%%%%% 番 %%%%%%%%%%
\subsection*{番}\addcontentsline{loh}{figure}{番 \dpy{fan1}}
...
\begin{EntryWithPhonetic}{番茄}{fan1qie2}{12,8}{⽥,⾋}[HSK 6]
  \definition[个,斤,磅,公斤]{s.}{tomate | tomateiro}
\end{EntryWithPhonetic}

%%%%%%%%%% 蕃 %%%%%%%%%%
\subsection*{蕃}\addcontentsline{loh}{figure}{蕃 \dpy{fan1}}
...
\begin{EntryWithPhonetic}{蕃茄}{fan1qie2}{15,8}{⾋,⾋}
  \variantof{番茄}
\end{EntryWithPhonetic}

%%%%%%%%%% 翻 %%%%%%%%%%
\subsection*{翻}\addcontentsline{loh}{figure}{翻 \dpy{fan1}}
...
\begin{EntryWithPhonetic}{翻过}{fan1guo4}{18,6}{⽻,⾡}
  \definition{v.}{escalar | mover; virar | transformar}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{翻脸}{fan1//lian3}{18,11}{⽻,⾁}
  \definition{v.+compl.}{tornar"-se hostil; desentender"-se; perder a paciência}
...
\begin{EntryWithPhonetic}{翻译}{fan1yi4}{18,7}{⽻,⾔}[HSK 4]
  ...
  \synonymref{意译}{yi4yi4}
  \synonymref{直译}{zhi2yi4}
  \seealsoref{译}{yi4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{翻译者}{fan1yi4 zhe3}{18,7,8}{⽻,⾔,⽼}[HSK 5]
  \definition{s.}{intérprete; tradutor}
\end{EntryWithPhonetic}

%%%%%%%%%% 凡 %%%%%%%%%%
\subsection*{凡}\addcontentsline{loh}{figure}{凡 \dpy{fan2}}
...
%%%%%%%%%% 烦 %%%%%%%%%%
\subsection*{烦}\addcontentsline{loh}{figure}{烦 \dpy{fan2}}
...
\begin{EntryWithPhonetic}{烦恼}{fan2nao3}{10,9}{⽕,⼼}[HSK 5]
...
%%%%%%%%%% 蕃 %%%%%%%%%%
\subsection*{蕃}\addcontentsline{loh}{figure}{蕃 \dpy{fan2}}
...
%%%%%%%%%% 繁 %%%%%%%%%%
\subsection*{繁}\addcontentsline{loh}{figure}{繁 \dpy{fan2}}
...
%%%%%%%%%% 反 %%%%%%%%%%
\subsection*{反}\addcontentsline{loh}{figure}{反 \dpy{fan3}}
...
\begin{EntryWithPhonetic}{反过来}{fan3guo4lai2}{4,6,7}{⼜,⾡,⽊}[HSK 7-9]
...
\begin{EntryWithPhonetic}{反响}{fan3xiang3}{4,9}{⼜,⼝}[HSK 6]
...
\begin{EntryWithPhonetic}{反正}{fan3zheng5}{4,5}{⼜,⽌}[HSK 3]
...
%%%%%%%%%% 返 %%%%%%%%%%
\subsection*{返}\addcontentsline{loh}{figure}{返 \dpy{fan3}}
...
\begin{EntryWithPhonetic}{返回}{fan3hui2}{7,6}{⾡,⼞}[HSK 5]
...
%%%%%%%%%% 犯 %%%%%%%%%%
\subsection*{犯}\addcontentsline{loh}{figure}{犯 \dpy{fan4}}
...
\begin{EntryWithPhonetic}{犯不上}{fan4bu5shang4}{5,4,3}{⽝,⼀,⼀}[HSK 5]
...
\begin{EntryWithPhonetic}{犯不着}{fan4bu5zhao2}{5,4,11}{⽝,⼀,⽬}
...
\begin{EntryWithPhonetic}{犯法}{fan4//fa3}{5,8}{⽝,⽔}
...
\begin{EntryWithPhonetic}{犯规}{fan4gui1}{5,8}{⽝,⾒}[HSK 6]
...
\begin{EntryWithPhonetic}{犯浑}{fan4//hun2}{5,9}{⽝,⽔}
...
%%%%%%%%%% 泛 %%%%%%%%%%
\subsection*{泛}\addcontentsline{loh}{figure}{泛 \dpy{fan4}}
...
%%%%%%%%%% 饭 %%%%%%%%%%
\subsection*{饭}\addcontentsline{loh}{figure}{饭 \dpy{fan4}}
...
\begin{EntryWithPhonetic}{饭馆}{fan4guan3}{7,11}{⾷,⾷}[HSK 2]
  \definition[家,个]{s.}{restaurante; lanchonete}
  \synonymref{餐厅}{can1ting1}
  \synonymref{饭店}{fan4dian4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{饭馆儿}{fan4guan3r5}{7,11,2}{⾷,⾷,⼉}
  \definition[家,个]{s.}{restaurante; lanchonete}
...
%%%%%%%%%% 贩 %%%%%%%%%%
\subsection*{贩}\addcontentsline{loh}{figure}{贩 \dpy{fan4}}
...
%%%%%%%%%% 范 %%%%%%%%%%
\subsection*{范}\addcontentsline{loh}{figure}{范 \dpy{fan4}}
...
%%%%%%%%%% 方 %%%%%%%%%%
\subsection*{方}\addcontentsline{loh}{figure}{方 \dpy{fang1}}
...
\begin{EntryWithPhonetic}{方便面}{fang1bian4mian4}{4,9,9}{⽅,⼈,⾯}[HSK 2]
...
\begin{EntryWithPhonetic}{方片}{fang1pian4}{4,4}{⽅,⽚}
...
\begin{EntryWithPhonetic}{方术}{fang1shu4}{4,5}{⽅,⽊}
...
%%%%%%%%%% 防 %%%%%%%%%%
\subsection*{防}\addcontentsline{loh}{figure}{防 \dpy{fang2}}
...
\begin{EntryWithPhonetic}{防范}{fang2fan4}{6,9}{⾩,⾋}[HSK 6]
...
%%%%%%%%%% 妨 %%%%%%%%%%
\subsection*{妨}\addcontentsline{loh}{figure}{妨 \dpy{fang2}}
...
%%%%%%%%%% 房 %%%%%%%%%%
\subsection*{房}\addcontentsline{loh}{figure}{房 \dpy{fang2}}
...
\begin{EntryWithPhonetic}{房产主}{fang2chan3zhu3}{8,6,5}{⼾,⼇,⼂}
...
\begin{EntryWithPhonetic}{房价}{fang2jia4}{8,6}{⼾,⼈}[HSK 6]
...
\begin{EntryWithPhonetic}{房客}{fang2ke4}{8,9}{⼾,⼧}
...
\begin{EntryWithPhonetic}{房屋}{fang2wu5}{8,9}{⼾,⼫}[HSK 3]
...
\begin{EntryWithPhonetic}{房子}{fang2zi5}{8,3}{⼾,⼦}[HSK 1]
...
\begin{EntryWithPhonetic}{房租}{fang2zu1}{8,10}{⼾,⽲}[HSK 3]
  \definition[笔]{s.}{aluguel}
\end{EntryWithPhonetic}

%%%%%%%%%% 仿 %%%%%%%%%%
\subsection*{仿}\addcontentsline{loh}{figure}{仿 \dpy{fang3}}
...
%%%%%%%%%% 访 %%%%%%%%%%
\subsection*{访}\addcontentsline{loh}{figure}{访 \dpy{fang3}}
...
%%%%%%%%%% 放 %%%%%%%%%%
\subsection*{放}\addcontentsline{loh}{figure}{放 \dpy{fang4}}
...
\begin{EntryWithPhonetic}{放弃者}{fang4qi4 zhe3}{8,7,8}{⽅,⼶,⽼}
...
\begin{EntryWithPhonetic}{放下}{fang4xia4}{8,3}{⽅,⼀}[HSK 2]
...
\begin{EntryWithPhonetic}{放在眼里}{fang4 zai4 yan3 li3}{8,6,11,7}{⽅,⼟,⽬,⾥}[HSK 5]
...
%%%%%%%%%% 飞 %%%%%%%%%%
\subsection*{飞}\addcontentsline{loh}{figure}{飞 \dpy{fei1}}
...
\begin{EntryWithPhonetic}{飞船}{fei1chuan2}{3,11}{⾶,⾈}[HSK 6]
...
\begin{EntryWithPhonetic}{飞机票}{fei1ji1piao4}{3,6,11}{⾶,⽊,⽰}
...
\begin{EntryWithPhonetic}{飞行}{fei1xing2}{3,6}{⾶,⾏}[HSK 3]
  \definition{s.}{voo; aviação}
  \definition{v.}{voar; fazer um voo; (aviões, foguetes, etc.) voar no ar}
  \synonymref{飞翔}{fei1xiang2}
  \synonymref{航行}{hang2xing2}
  \antonymref{潜水}{qian2//shui3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{飞行员}{fei1xing2yuan2}{3,6,7}{⾶,⾏,⼝}[HSK 6]
...
%%%%%%%%%% 非 %%%%%%%%%%
\subsection*{非}\addcontentsline{loh}{figure}{非 \dpy{fei1}}
...
\begin{EntryWithPhonetic}{非……不可}{fei1 bu4ke3}{8,4,5}{⾮,⼀,⼝}
...
\begin{EntryWithPhonetic}{非金属}{fei1jin4shu3}{8,8,12}{⾮,⾦,⼫}
...
%%%%%%%%%% 绯 %%%%%%%%%%
\subsection*{绯}\addcontentsline{loh}{figure}{绯 \dpy{fei1}}
...
%%%%%%%%%% 肥 %%%%%%%%%%
\subsection*{肥}\addcontentsline{loh}{figure}{肥 \dpy{fei2}}
...
%%%%%%%%%% 诽 %%%%%%%%%%
\subsection*{诽}\addcontentsline{loh}{figure}{诽 \dpy{fei3}}
...
%%%%%%%%%% 废 %%%%%%%%%%
\subsection*{废}\addcontentsline{loh}{figure}{废 \dpy{fei4}}
...
%%%%%%%%%% 沸 %%%%%%%%%%
\subsection*{沸}\addcontentsline{loh}{figure}{沸 \dpy{fei4}}
...
%%%%%%%%%% 狒 %%%%%%%%%%
\subsection*{狒}\addcontentsline{loh}{figure}{狒 \dpy{fei4}}
...
%%%%%%%%%% 肺 %%%%%%%%%%
\subsection*{肺}\addcontentsline{loh}{figure}{肺 \dpy{fei4}}
...
%%%%%%%%%% 费 %%%%%%%%%%
\subsection*{费}\addcontentsline{loh}{figure}{费 \dpy{fei4}}
...
\begin{EntryWithPhonetic}{费尽心思}{fei4 jin4 xin1si1}{9,6,4,9}{⾙,⼫,⼼,⼼}[HSK 5]
...
\begin{EntryWithPhonetic}{费力}{fei4li4}{9,2}{⾙,⼒}
...
\begin{EntryWithPhonetic}{费用}{fei4yong5}{9,5}{⾙,⽤}[HSK 3]
...
%%%%%%%%%% 分 %%%%%%%%%%
\subsection*{分}\addcontentsline{loh}{figure}{分 \dpy{fen1}}
...
\begin{EntryWithPhonetic}{分成}{fen1cheng2}{4,6}{⼑,⼽}[HSK 5]
...
\begin{EntryWithPhonetic}{分成儿}{fen1cheng2r5}{4,6,2}{⼑,⼽,⼉}
...
\begin{EntryWithPhonetic}{分工}{fen1gong1}{4,3}{⼑,⼯}[HSK 6]
...
\begin{EntryWithPhonetic}{分离}{fen1li2}{4,10}{⼑,⼇}[HSK 5]
...
\begin{EntryWithPhonetic}{分数}{fen1shu4}{4,13}{⼑,⽁}[HSK 2]
...
\begin{EntryWithPhonetic}{分享}{fen1xiang3}{4,8}{⼑,⼇}[HSK 5]
...
\begin{EntryWithPhonetic}{分组}{fen1zu3}{4,8}{⼑,⽷}[HSK 3]
...
%%%%%%%%%% 吩 %%%%%%%%%%
\subsection*{吩}\addcontentsline{loh}{figure}{吩 \dpy{fen1}}
...
%%%%%%%%%% 纷 %%%%%%%%%%
\subsection*{纷}\addcontentsline{loh}{figure}{纷 \dpy{fen1}}
...
%%%%%%%%%% 芬 %%%%%%%%%%
\subsection*{芬}\addcontentsline{loh}{figure}{芬 \dpy{fen1}}
...
%%%%%%%%%% 氛 %%%%%%%%%%
\subsection*{氛}\addcontentsline{loh}{figure}{氛 \dpy{fen1}}
...
%%%%%%%%%% 坟 %%%%%%%%%%
\subsection*{坟}\addcontentsline{loh}{figure}{坟 \dpy{fen2}}
...
%%%%%%%%%% 焚 %%%%%%%%%%
\subsection*{焚}\addcontentsline{loh}{figure}{焚 \dpy{fen2}}
...
%%%%%%%%%% 粉 %%%%%%%%%%
\subsection*{粉}\addcontentsline{loh}{figure}{粉 \dpy{fen3}}
...
\begin{EntryWithPhonetic}{粉色}{fen3se4}{10,6}{⽶,⾊}
...
%%%%%%%%%% 分 %%%%%%%%%%
\subsection*{分}\addcontentsline{loh}{figure}{分 \dpy{fen4}}

\begin{EntryWithPhonetic}{分}{fen4}{4}{⼑}
...
%%%%%%%%%% 份 %%%%%%%%%%
\subsection*{份}\addcontentsline{loh}{figure}{份 \dpy{fen4}}

\begin{EntryWithPhonetic}{份}{fen4}{6}{⼈}[HSK 2]
...
%%%%%%%%%% 奋 %%%%%%%%%%
\subsection*{奋}\addcontentsline{loh}{figure}{奋 \dpy{fen4}}
...
%%%%%%%%%% 愤 %%%%%%%%%%
\subsection*{愤}\addcontentsline{loh}{figure}{愤 \dpy{fen4}}
...
%%%%%%%%%% 粪 %%%%%%%%%%
\subsection*{粪}\addcontentsline{loh}{figure}{粪 \dpy{fen4}}
...
%%%%%%%%%% 丰 %%%%%%%%%%
\subsection*{丰}\addcontentsline{loh}{figure}{丰 \dpy{feng1}}
...
\begin{EntryWithPhonetic}{丰产}{feng1chan3}{4,6}{⼁,⼇}
...
%%%%%%%%%% 风 %%%%%%%%%%
\subsection*{风}\addcontentsline{loh}{figure}{风 \dpy{feng1}}
...
\begin{EntryWithPhonetic}{风行}{feng1xing2}{4,6}{⾵,⾏}
...
%%%%%%%%%% 枫 %%%%%%%%%%
\subsection*{枫}\addcontentsline{loh}{figure}{枫 \dpy{feng1}}
...
%%%%%%%%%% 封 %%%%%%%%%%
\subsection*{封}\addcontentsline{loh}{figure}{封 \dpy{feng1}}
...
\begin{EntryWithPhonetic}{封四}{feng1si4}{9,5}{⼨,⼞}
...
%%%%%%%%%% 疯 %%%%%%%%%%
\subsection*{疯}\addcontentsline{loh}{figure}{疯 \dpy{feng1}}
...
%%%%%%%%%% 峰 %%%%%%%%%%
\subsection*{峰}\addcontentsline{loh}{figure}{峰 \dpy{feng1}}
...
\begin{EntryWithPhonetic}{峰会}{feng1hui4}{10,6}{⼭,⼈}[HSK 6]
  \definition{s.}{cúpula; reunião de cúpula}
\end{EntryWithPhonetic}

%%%%%%%%%% 蜂 %%%%%%%%%%
\subsection*{蜂}\addcontentsline{loh}{figure}{蜂 \dpy{feng1}}
...
%%%%%%%%%% 逢 %%%%%%%%%%
\subsection*{逢}\addcontentsline{loh}{figure}{逢 \dpy{feng2}}
...
%%%%%%%%%% 缝 %%%%%%%%%%
\subsection*{缝}\addcontentsline{loh}{figure}{缝 \dpy{feng2}}
...
\begin{EntryWithPhonetic}{缝纫}{feng2ren4}{13,6}{⽷,⽷}
  \definition{v.}{costurar; geralmente se refere à alfaiataria; costura de roupas, etc.}
  \synonymref{纺织}{fang3zhi1}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{缝纫机}{feng2ren4ji1}{13,6,6}{⽷,⽷,⽊}
  \definition[架]{s.}{máquina de costura; máquinas para costurar roupas, etc.}
\end{EntryWithPhonetic}

%%%%%%%%%% 讽 %%%%%%%%%%
\subsection*{讽}\addcontentsline{loh}{figure}{讽 \dpy{feng3}}
...
%%%%%%%%%% 凤 %%%%%%%%%%
\subsection*{凤}\addcontentsline{loh}{figure}{凤 \dpy{feng4}}
...
%%%%%%%%%% 奉 %%%%%%%%%%
\subsection*{奉}\addcontentsline{loh}{figure}{奉 \dpy{feng4}}
...
%%%%%%%%%% 缝 %%%%%%%%%%
\subsection*{缝}\addcontentsline{loh}{figure}{缝 \dpy{feng4}}
...
%%%%%%%%%% 佛 %%%%%%%%%%
\subsection*{佛}\addcontentsline{loh}{figure}{佛 \dpy{fo2}}
...
\begin{EntryWithPhonetic}{佛教}{fo2jiao4}{7,11}{⼈,⽁}[HSK 6]
...
%%%%%%%%%% 否 %%%%%%%%%%
\subsection*{否}\addcontentsline{loh}{figure}{否 \dpy{fou3}}
...
%%%%%%%%%% 夫 %%%%%%%%%%
\subsection*{夫}\addcontentsline{loh}{figure}{夫 \dpy{fu1}}
...
\begin{EntryWithPhonetic}{夫人}{fu1ren5}{4,2}{⼤,⼈}[HSK 4]
...
%%%%%%%%%% 孵 %%%%%%%%%%
\subsection*{孵}\addcontentsline{loh}{figure}{孵 \dpy{fu1}}
...
%%%%%%%%%% 敷 %%%%%%%%%%
\subsection*{敷}\addcontentsline{loh}{figure}{敷 \dpy{fu1}}
...
\begin{EntryWithPhonetic}{敷衍}{fu1yan3}{15,9}{⽁,⾏}
  \definition{v.}{elaborar (sobre um tema); expor (os clássicos) | ser superficial; fazer malfeito; fazer algo sem empenho ou apenas para mostrar | ser superficial; economizar demais; mal o suficiente para se virar}
  \synonymref{打发}{da3fa5}
  \synonymref{对付}{dui4fu5}
  \synonymref{潦草}{liao2cao3}
  \synonymref{马虎}{ma3hu5}
  \synonymref{随便}{sui2bian4}
  \synonymref{周旋}{zhou1xuan2}
  \antonymref{负责}{fu4ze2}
  \antonymref{鉴定}{jian4ding4}
  \antonymref{竭力}{jie2li4}
  \antonymref{尽力}{jin4//li4}
...
%%%%%%%%%% 夫 %%%%%%%%%%
\subsection*{夫}\addcontentsline{loh}{figure}{夫 \dpy{fu2}}
...
%%%%%%%%%% 佛 %%%%%%%%%%
\subsection*{佛}\addcontentsline{loh}{figure}{佛 \dpy{fu2}}
...
%%%%%%%%%% 扶 %%%%%%%%%%
\subsection*{扶}\addcontentsline{loh}{figure}{扶 \dpy{fu2}}
...
%%%%%%%%%% 服 %%%%%%%%%%
\subsection*{服}\addcontentsline{loh}{figure}{服 \dpy{fu2}}
...
\begin{EntryWithPhonetic}{服务}{fu2wu4}{8,5}{⽉,⼒}[HSK 2]
...
\begin{EntryWithPhonetic}{服务对象}{fu2wu4 dui4xiang4}{8,5,5,11}{⽉,⼒,⼨,⾗}[HSK 5]
...
\begin{EntryWithPhonetic}{服务人员}{fu2wu4 ren2yuan2}{8,5,2,7}{⽉,⼒,⼈,⼝}[HSK 5]
  \definition{s.}{pessoal de serviço; equipe de serviço}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{服务员}{fu2wu4yuan2}{8,5,7}{⽉,⼒,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{服装超市}{fu2zhuang1 chao1shi4}{8,12,12,5}{⽉,⾐,⾛,⼱}[HSK 5]
  \definition{s.}{loja de roupas; supermercado de roupas}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{服装供应商}{fu2zhuang1 gong1ying4 shang1}{8,12,8,7,11}{⽉,⾐,⼈,⼴,⼝}[HSK 5]
  \definition{s.}{fornecedor de vestuário}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{服装柜台}{fu2zhuang1 gui4tai2}{8,12,8,5}{⽉,⾐,⽊,⼝}[HSK 5]
  \definition{s.}{balcão de roupas}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{服装设计师}{fu2zhuang1 she4ji4 shi1}{8,12,6,4,6}{⽉,⾐,⾔,⾔,⼱}[HSK 5]
  \definition{s.}{profissionais de design de moda}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{服装杂志}{fu2zhuang1 za2zhi4}{8,12,6,7}{⽉,⾐,⽊,⼼}[HSK 5]
  \definition{s.}{revista de moda}
\end{EntryWithPhonetic}

%%%%%%%%%% 俘 %%%%%%%%%%
\subsection*{俘}\addcontentsline{loh}{figure}{俘 \dpy{fu2}}
...
%%%%%%%%%% 浮 %%%%%%%%%%
\subsection*{浮}\addcontentsline{loh}{figure}{浮 \dpy{fu2}}
...
%%%%%%%%%% 符 %%%%%%%%%%
\subsection*{符}\addcontentsline{loh}{figure}{符 \dpy{fu2}}
...
%%%%%%%%%% 幅 %%%%%%%%%%
\subsection*{幅}\addcontentsline{loh}{figure}{幅 \dpy{fu2}}
...
%%%%%%%%%% 福 %%%%%%%%%%
\subsection*{福}\addcontentsline{loh}{figure}{福 \dpy{fu2}}

\begin{EntryWithPhonetic}{福}{fu2}{13}{⽰}[HSK 3]
  \definition*{s.}{Província de Fujian (福建) | Sobrenome: Fu}
  ...
  \seealsoref{幸福}{xing4fu2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{福建}{fu2jian4}{13,8}{⽰,⼵}
  \definition*{s.}{Província de Fujian, abreviada como 闽}
  \seealsoref{闽}{min3}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{福泽}{fu2ze2}{13,8}{⽰,⽔}
  \definition{s.}{boa sorte; boa fortuna}
  \synonymref{福气}{fu2qi5}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{福州}{fu2zhou1}{13,6}{⽰,⼮}
  \definition*{s.}{Fuzhou, capital da província de Fujian (福建) | anteriormente conhecido como Foochow ou Fuchow}
  \seealsoref{福建}{fu2jian4}
\end{EntryWithPhonetic}

%%%%%%%%%% 辐 %%%%%%%%%%
\subsection*{辐}\addcontentsline{loh}{figure}{辐 \dpy{fu2}}
...
%%%%%%%%%% 抚 %%%%%%%%%%
\subsection*{抚}\addcontentsline{loh}{figure}{抚 \dpy{fu3}}
...
%%%%%%%%%% 拊 %%%%%%%%%%
\subsection*{拊}\addcontentsline{loh}{figure}{拊 \dpy{fu3}}
...
%%%%%%%%%% 斧 %%%%%%%%%%
\subsection*{斧}\addcontentsline{loh}{figure}{斧 \dpy{fu3}}
...
%%%%%%%%%% 俯 %%%%%%%%%%
\subsection*{俯}\addcontentsline{loh}{figure}{俯 \dpy{fu3}}
...
%%%%%%%%%% 辅 %%%%%%%%%%
\subsection*{辅}\addcontentsline{loh}{figure}{辅 \dpy{fu3}}
...
\begin{EntryWithPhonetic}{辅导员}{fu3dao3 yuan2}{11,6,7}{⾞,⼨,⼝}[HSK 5]
...
%%%%%%%%%% 腐 %%%%%%%%%%
\subsection*{腐}\addcontentsline{loh}{figure}{腐 \dpy{fu3}}
...
\begin{EntryWithPhonetic}{腐朽}{fu3xiu3}{14,6}{⾁,⽊}[HSK 7-9]
  \definition{adj.}{decaído; decadente; degenerado; ideias ultrapassadas das pessoas ou para a moral social corrupta}
  \definition{v.}{apodrecer; decair; apodrecimento e deterioração da madeira e outros materiais fibrosos}
\end{EntryWithPhonetic}

%%%%%%%%%% 父 %%%%%%%%%%
\subsection*{父}\addcontentsline{loh}{figure}{父 \dpy{fu4}}
...
\begin{EntryWithPhonetic}{父母}{fu4mu3}{4,5}{⽗,⽏}[HSK 3]
...
\begin{EntryWithPhonetic}{父女}{fu4nv3}{4,3}{⽗,⼥}[HSK 6]
...
\begin{EntryWithPhonetic}{父子}{fu4zi3}{4,3}{⽗,⼦}[HSK 6]
  \definition{s.}{pai e filho}
\end{EntryWithPhonetic}

%%%%%%%%%% 讣 %%%%%%%%%%
\subsection*{讣}\addcontentsline{loh}{figure}{讣 \dpy{fu4}}
...
%%%%%%%%%% 付 %%%%%%%%%%
\subsection*{付}\addcontentsline{loh}{figure}{付 \dpy{fu4}}
...
\begin{EntryWithPhonetic}{付出}{fu4chu1}{5,5}{⼈,⼐}[HSK 4]
...
\begin{EntryWithPhonetic}{付款}{fu4//kuan3}{5,12}{⼈,⽋}[HSK 7-9]
  \definition[次]{s.}{pagamento}
  \definition{v.+compl.}{pagar uma quantia em dinheiro}
\end{EntryWithPhonetic}

%%%%%%%%%% 妇 %%%%%%%%%%
\subsection*{妇}\addcontentsline{loh}{figure}{妇 \dpy{fu4}}
...
%%%%%%%%%% 负 %%%%%%%%%%
\subsection*{负}\addcontentsline{loh}{figure}{负 \dpy{fu4}}
...
\begin{EntryWithPhonetic}{负能量}{fu4 neng2liang4}{6,10,12}{⾙,⾁,⾥}[HSK 5]
...
\begin{EntryWithPhonetic}{负责人}{fu4ze2ren2}{6,8,2}{⾙,⾙,⼈}[HSK 5]
  \definition[位]{s.}{pessoa responsável; pessoa encarregada; pessoas com responsabilidades de liderança}
\end{EntryWithPhonetic}

%%%%%%%%%% 附 %%%%%%%%%%
\subsection*{附}\addcontentsline{loh}{figure}{附 \dpy{fu4}}
...
%%%%%%%%%% 服 %%%%%%%%%%
\subsection*{服}\addcontentsline{loh}{figure}{服 \dpy{fu4}}
...
%%%%%%%%%% 复 %%%%%%%%%%
\subsection*{复}\addcontentsline{loh}{figure}{复 \dpy{fu4}}
...
\begin{EntryWithPhonetic}{复苏}{fu4su1}{9,7}{⼢,⾋}[HSK 6]
...
\begin{EntryWithPhonetic}{复习材料}{fu4xi2 cai2liao4}{9,3,7,10}{⼢,⼄,⽊,⽃}[HSK 5]
...
%%%%%%%%%% 赴 %%%%%%%%%%
\subsection*{赴}\addcontentsline{loh}{figure}{赴 \dpy{fu4}}
...
%%%%%%%%%% 副 %%%%%%%%%%
\subsection*{副}\addcontentsline{loh}{figure}{副 \dpy{fu4}}
...
\begin{EntryWithPhonetic}{副业}{fu4ye4}{11,5}{⼑,⼀}
...
%%%%%%%%%% 富 %%%%%%%%%%
\subsection*{富}\addcontentsline{loh}{figure}{富 \dpy{fu4}}
...
\begin{EntryWithPhonetic}{富人}{fu4ren2}{12,2}{⼧,⼈}[HSK 6]
...
\begin{EntryWithPhonetic}{富有}{fu4you3}{12,6}{⼧,⽉}[HSK 6]
...
%%%%%%%%%% 赋 %%%%%%%%%%
\subsection*{赋}\addcontentsline{loh}{figure}{赋 \dpy{fu4}}
...
%%%%%%%%%% 腹 %%%%%%%%%%
\subsection*{腹}\addcontentsline{loh}{figure}{腹 \dpy{fu4}}
...
%%%%%%%%%% 覆 %%%%%%%%%%
\subsection*{覆}\addcontentsline{loh}{figure}{覆 \dpy{fu4}}
