...
%%% B
%%%
\section*{B}\addcontentsline{toc}{section}{B}\addcontentsline{loh}{figure}{\#\#\#\#\#\#\#\# B}

%%%%%%%%%% 八 %%%%%%%%%%
\subsection*{八}\addcontentsline{loh}{figure}{八 \dpy{ba1}}

\begin{EntryWithPhonetic}{八}{ba1}{2}{⼋}[HSK 1][Kangxi 12]
  \definition{num.}{oito; 8}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{八八六}{ba1ba1 liu4}{2,2,4}{⼋,⼋,⼋}
...
%%%%%%%%%% 巴 %%%%%%%%%%
\subsection*{巴}\addcontentsline{loh}{figure}{巴 \dpy{ba1}}
...
\begin{EntryWithPhonetic}{巴士}{ba1shi4}{4,3}{⼰,⼠}[HSK 4]
...
\begin{EntryWithPhonetic}{巴西人}{ba1xi1ren2}{4,6,2}{⼰,⾑,⼈}
  \definition[个,位]{s.}{brasileiro | pessoa ou povo do Brasil}[他是巴西人。===Ele é brasileiro.]
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{巴西战舞}{ba1xi1 zhan4wu3}{4,6,9,14}{⼰,⾑,⼽,⾇}
  \definition{s.}{capoeira}[他喜欢学习巴西战舞。===Ele gosta de aprender capoeira.]
\end{EntryWithPhonetic}

%%%%%%%%%% 扒 %%%%%%%%%%
\subsection*{扒}\addcontentsline{loh}{figure}{扒 \dpy{ba1}}
...
%%%%%%%%%% 吧 %%%%%%%%%%
\subsection*{吧}\addcontentsline{loh}{figure}{吧 \dpy{ba1}}
...
%%%%%%%%%% 芭 %%%%%%%%%%
\subsection*{芭}\addcontentsline{loh}{figure}{芭 \dpy{ba1}}
...
%%%%%%%%%% 拔 %%%%%%%%%%
\subsection*{拔}\addcontentsline{loh}{figure}{拔 \dpy{ba2}}
...
%%%%%%%%%% 把 %%%%%%%%%%
\subsection*{把}\addcontentsline{loh}{figure}{把 \dpy{ba3}}
...
\begin{EntryWithPhonetic}{把持}{ba3//chi2}{7,9}{⼿,⼿}
...
\begin{EntryWithPhonetic}{把风}{ba3//feng1}{7,4}{⼿,⾵}
...
\begin{EntryWithPhonetic}{把稳}{ba3//wen3}{7,14}{⼿,⽲}
...
\begin{EntryWithPhonetic}{把斋}{ba3//zhai1}{7,10}{⼿,⽂}
  \definition{s.}{jejum}
  \definition{v.+compl.}{jejuar}
\end{EntryWithPhonetic}

%%%%%%%%%% 靶 %%%%%%%%%%
\subsection*{靶}\addcontentsline{loh}{figure}{靶 \dpy{ba3}}
...
%%%%%%%%%% 坝 %%%%%%%%%%
\subsection*{坝}\addcontentsline{loh}{figure}{坝 \dpy{ba4}}
...
%%%%%%%%%% 把 %%%%%%%%%%
\subsection*{把}\addcontentsline{loh}{figure}{把 \dpy{ba4}}
...
%%%%%%%%%% 爸 %%%%%%%%%%
\subsection*{爸}\addcontentsline{loh}{figure}{爸 \dpy{ba4}}
...
%%%%%%%%%% 罢 %%%%%%%%%%
\subsection*{罢}\addcontentsline{loh}{figure}{罢 \dpy{ba4}}
...
\begin{EntryWithPhonetic}{罢了}{ba4liao3}{10,2}{⽹,⼅}
...
%%%%%%%%%% 霸 %%%%%%%%%%
\subsection*{霸}\addcontentsline{loh}{figure}{霸 \dpy{ba4}}
...
\begin{EntryWithPhonetic}{霸权}{ba4quan2}{21,6}{⾬,⽊}
  ...
  \antonymref{民主}{min2zhu3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{霸王}{ba4wang2}{21,4}{⾬,⽟}
  \definition*{s.}{Rei Hegemônico, título assumido por Xiang Yu (项羽), o Conquistador (232--202 a.C.)}
  \definition{s.}{senhor supremo; déspota; pessoa extremamente tirânica}
  \synonymref{恶霸}{e4ba4}
  \seealsoref{项羽}{xiang4 yu3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{霸占}{ba4zhan4}{21,5}{⾬,⼘}[HSK 7-9]
  \definition{v.}{ocupar à força; apreender ilegalmente | apreender; usurpar}
  \synonymref{强占}{qiang2zhan4}
  \synonymref{占据}{zhan4ju4}
  \synonymref{占领}{zhan4ling3}
  \seealsoref{侵占}{qin1zhan4}
\end{EntryWithPhonetic}

%%%%%%%%%% 吧 %%%%%%%%%%
\subsection*{吧}\addcontentsline{loh}{figure}{吧 \dpy{ba5}}
...
%%%%%%%%%% 罢 %%%%%%%%%%
\subsection*{罢}\addcontentsline{loh}{figure}{罢 \dpy{ba5}}
...
%%%%%%%%%% 掰 %%%%%%%%%%
\subsection*{掰}\addcontentsline{loh}{figure}{掰 \dpy{bai1}}
...
%%%%%%%%%% 白 %%%%%%%%%%
\subsection*{白}\addcontentsline{loh}{figure}{白 \dpy{bai2}}
...
\begin{EntryWithPhonetic}{白菜}{bai2cai4}{5,11}{⽩,⾋}[HSK 3]
...
\begin{EntryWithPhonetic}{白拣}{bai2//jian3}{5,8}{⽩,⼿}
  \definition{s.}{uma escolha barata}
  \definition{v.+compl.}{escolher algo que não custa nada}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{白酒}{bai2jiu3}{5,10}{⽩,⾣}[HSK 5]
...
\begin{EntryWithPhonetic}{白领}{bai2ling3}{5,11}{⽩,⾴}[HSK 6]
...
\begin{EntryWithPhonetic}{白色}{bai2se4}{5,6}{⽩,⾊}[HSK 2]
  \definition[片,种]{s.}{a cor branca}
  \antonymref{黑色}{hei1se4}
  \antonymref{红色}{hong2se4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{白天}{bai2tian5}{5,4}{⽩,⼤}[HSK 1]
...
%%%%%%%%%% 百 %%%%%%%%%%
\subsection*{百}\addcontentsline{loh}{figure}{百 \dpy{bai3}}
...
\begin{EntryWithPhonetic}{百分点}{bai3fen1dian3}{6,4,9}{⽩,⼑,⽕}[HSK 6]
...
\begin{EntryWithPhonetic}{百货}{bai3huo4}{6,8}{⽩,⾙}[HSK 4]
...
\begin{EntryWithPhonetic}{百科全书}{bai3ke1quan2shu1}{6,9,6,4}{⽩,⽲,⼊,⼄}[HSK 7-9]
  \definition[本,部,套,集]{s.}{enciclopédia; tesauro; \emph{thesaurus}}
\end{EntryWithPhonetic}

%%%%%%%%%% 伯 %%%%%%%%%%
\subsection*{伯}\addcontentsline{loh}{figure}{伯 \dpy{bai3}}
...
%%%%%%%%%% 柏 %%%%%%%%%%
\subsection*{柏}\addcontentsline{loh}{figure}{柏 \dpy{bai3}}
...
%%%%%%%%%% 摆 %%%%%%%%%%
\subsection*{摆}\addcontentsline{loh}{figure}{摆 \dpy{bai3}}
...
\begin{EntryWithPhonetic}{摆动}{bai3dong4}{13,6}{⼿,⼒}[HSK 4]
...
\begin{EntryWithPhonetic}{摆烂}{bai3//lan4}{13,9}{⼿,⽕}
  \definition{v.+compl.}{negligenciar; render"-se; desistir; não ter interesse; expressar uma atitude de perda de interesse ou desistência}
  \synonymref{放弃}{fang4qi4}
  \synonymref{放任}{fang4ren4}
...
\begin{EntryWithPhonetic}{摆手}{bai3//shou3}{13,4}{⼿,⼿}
  \definition{v.+compl.}{fazer um gesto de advertência ou desaprovação; levantar ou acenar com a mão indica obstrução ou negação | acenar; fazer sinal com a mão; acenar é um gesto usado para chamar alguém ou para dizer olá}
  \synonymref{招手}{zhao1shou3}
\end{EntryWithPhonetic}
...
%%%%%%%%%% 败 %%%%%%%%%%
\subsection*{败}\addcontentsline{loh}{figure}{败 \dpy{bai4}}
...
%%%%%%%%%% 拜 %%%%%%%%%%
\subsection*{拜}\addcontentsline{loh}{figure}{拜 \dpy{bai4}}
...
%%%%%%%%%% 扳 %%%%%%%%%%
\subsection*{扳}\addcontentsline{loh}{figure}{扳 \dpy{ban1}}
...
%%%%%%%%%% 班 %%%%%%%%%%
\subsection*{班}\addcontentsline{loh}{figure}{班 \dpy{ban1}}
...
%%%%%%%%%% 般 %%%%%%%%%%
\subsection*{般}\addcontentsline{loh}{figure}{般 \dpy{ban1}}
...
%%%%%%%%%% 颁 %%%%%%%%%%
\subsection*{颁}\addcontentsline{loh}{figure}{颁 \dpy{ban1}}
...
%%%%%%%%%% 斑 %%%%%%%%%%
\subsection*{斑}\addcontentsline{loh}{figure}{斑 \dpy{ban1}}
...
%%%%%%%%%% 搬 %%%%%%%%%%
\subsection*{搬}\addcontentsline{loh}{figure}{搬 \dpy{ban1}}
...
\begin{EntryWithPhonetic}{搬家}{ban1//jia1}{13,10}{⼿,⼧}[HSK 3]
  ...
  \synonymref{搬迁}{ban1qian1}
  \antonymref{定居}{ding4//ju1}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{搬家公司}{ban1jia1 gong1si1}{13,10,4,5}{⼿,⼧,⼋,⼝}[HSK 5]
  \definition{s.}{empresa de mudanças}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{搬口}{ban1//kou3}{13,3}{⼿,⼝}
  \definition{v.+compl.}{tagarelar | (idioma) transmitir histórias;  semear dissensão | contar histórias}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{搬弄}{ban1nong4}{13,7}{⼿,⼶}
  \definition{v.}{mover algo; mexer com algo; virar; mover | exibir; ostentar; mostrar | instigar; semear discórdia}
  \synonymref{挑衅}{tiao3xin4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{搬迁}{ban1qian1}{13,6}{⼿,⾡}[HSK 7-9]
  \definition{v.}{mover; transferir; realocar}
  \synonymref{搬家}{ban1//jia1}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{搬运}{ban1yun4}{13,7}{⼿,⾡}
  \definition{v.}{carregar; transportar}
  \synonymref{搬动}{ban1dong4}
  \synonymref{运输}{yun4shu1}
  \seealsoref{搬}{ban1}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{搬走}{ban1zou3}{13,7}{⼿,⾛}
  \definition{v.}{mover; carregar; levar embora; mercadorias em movimento  | mudar"-se; ir embora; mudança de residência}
\end{EntryWithPhonetic}

%%%%%%%%%% 板 %%%%%%%%%%
\subsection*{板}\addcontentsline{loh}{figure}{板 \dpy{ban3}}
...
%%%%%%%%%% 版 %%%%%%%%%%
\subsection*{版}\addcontentsline{loh}{figure}{版 \dpy{ban3}}
...
%%%%%%%%%% 办 %%%%%%%%%%
\subsection*{办}\addcontentsline{loh}{figure}{办 \dpy{ban4}}
...
\begin{EntryWithPhonetic}{办不到}{ban4bu5dao4}{4,4,8}{⼒,⼀,⼑}[HSK 7-9]
...
\begin{EntryWithPhonetic}{办事处}{ban4shi4chu4}{4,8,5}{⼒,⼅,⼡}[HSK 6]
...
%%%%%%%%%% 半 %%%%%%%%%%
\subsection*{半}\addcontentsline{loh}{figure}{半 \dpy{ban4}}
...
\begin{EntryWithPhonetic}{半吊子}{ban4diao4zi5}{5,6,3}{⼗,⼝,⼦}[HSK 5]
...
\begin{EntryWithPhonetic}{半决赛}{ban4jue2sai4}{5,6,14}{⼗,⼎,⾙}[HSK 6]
...
\begin{EntryWithPhonetic}{半年}{ban4nian2}{5,6}{⼗,⼲}[HSK 1]
  \definition{s.}{meio ano}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{半瓶子醋}{ban4 ping2zi5 cu4}{5,10,3,15}{⼗,⽡,⼦,⾣}[HSK 5]
...
\begin{EntryWithPhonetic}{半天}{ban4tian1}{5,4}{⼗,⼤}[HSK 1]
...
\begin{EntryWithPhonetic}{半夜}{ban4ye4}{5,8}{⼗,⼣}[HSK 2]
...
%%%%%%%%%% 伴 %%%%%%%%%%
\subsection*{伴}\addcontentsline{loh}{figure}{伴 \dpy{ban4}}
...
\begin{EntryWithPhonetic}{伴儿}{ban4r5}{7,2}{⼈,⼉}
...
\begin{EntryWithPhonetic}{伴奏}{ban4//zou4}{7,9}{⼈,⼤}[HSK 7-9]
...
%%%%%%%%%% 扮 %%%%%%%%%%
\subsection*{扮}\addcontentsline{loh}{figure}{扮 \dpy{ban4}}
...
%%%%%%%%%% 拌 %%%%%%%%%%
\subsection*{拌}\addcontentsline{loh}{figure}{拌 \dpy{ban4}}
...
%%%%%%%%%% 帮 %%%%%%%%%%
\subsection*{帮}\addcontentsline{loh}{figure}{帮 \dpy{bang1}}
...
\begin{EntryWithPhonetic}{帮倒忙}{bang1//dao4mang2}{9,10,6}{⼱,⼈,⼼}[HSK 5]
...
\begin{EntryWithPhonetic}{帮教}{bang1//jiao4}{9,11}{⼱,⽁}
...
\begin{EntryWithPhonetic}{帮手}{bang1shou5}{9,4}{⼱,⼿}[HSK 7-9]
...
\begin{EntryWithPhonetic}{帮佣}{bang1//yong1}{9,7}{⼱,⼈}
...
%%%%%%%%%% 绑 %%%%%%%%%%
\subsection*{绑}\addcontentsline{loh}{figure}{绑 \dpy{bang3}}
...
%%%%%%%%%% 榜 %%%%%%%%%%
\subsection*{榜}\addcontentsline{loh}{figure}{榜 \dpy{bang3}}
...
%%%%%%%%%% 傍 %%%%%%%%%%
\subsection*{傍}\addcontentsline{loh}{figure}{傍 \dpy{bang4}}
...
\begin{EntryWithPhonetic}{傍晚}{bang4wan3}{12,11}{⼈,⽇}[HSK 6]
  ...
  \synonymref{黄昏}{huang2hun1}
  \synonymref{晚上}{wan3shang5}
  \synonymref{夜幕}{ye4mu4}
  \antonymref{黎明}{li2ming2}
  \antonymref{凌晨}{ling2chen2}
  \antonymref{清晨}{qing1chen2}
  \antonymref{日出}{ri4chu1}
  \antonymref{早晨}{zao3chen5}
\end{EntryWithPhonetic}

%%%%%%%%%% 棒 %%%%%%%%%%
\subsection*{棒}\addcontentsline{loh}{figure}{棒 \dpy{bang4}}
...
\begin{EntryWithPhonetic}{棒棒糖}{bang4bang4tang2}{12,12,16}{⽊,⽊,⽶}
  \definition[根]{s.}{pirulito; bala dura com palito que derrete na boca}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{棒冰}{bang4bing1}{12,6}{⽊,⼎}
  \definition[支]{s.}{Dialeto: picolé; geladinho}
...
%%%%%%%%%% 磅 %%%%%%%%%%
\subsection*{磅}\addcontentsline{loh}{figure}{磅 \dpy{bang4}}
...
%%%%%%%%%% 包 %%%%%%%%%%
\subsection*{包}\addcontentsline{loh}{figure}{包 \dpy{bao1}}
...
\begin{EntryWithPhonetic}{包在我身上}{bao1 zai4 wo3 shen1shang5}{5,6,7,7,3}{⼓,⼟,⼽,⾝,⼀}[HSK 5]
...
\begin{EntryWithPhonetic}{包子}{bao1zi5}{5,3}{⼓,⼦}[HSK 1]
...
%%%%%%%%%% 炮 %%%%%%%%%%
\subsection*{炮}\addcontentsline{loh}{figure}{炮 \dpy{bao1}}
...
%%%%%%%%%% 剥 %%%%%%%%%%
\subsection*{剥}\addcontentsline{loh}{figure}{剥 \dpy{bao1}}
...
%%%%%%%%%% 煲 %%%%%%%%%%
\subsection*{煲}\addcontentsline{loh}{figure}{煲 \dpy{bao1}}
...
%%%%%%%%%% 薄 %%%%%%%%%%
\subsection*{薄}\addcontentsline{loh}{figure}{薄 \dpy{bao2}}
...
%%%%%%%%%% 宝 %%%%%%%%%%
\subsection*{宝}\addcontentsline{loh}{figure}{宝 \dpy{bao3}}
...
\begin{EntryWithPhonetic}{宝宝}{bao3bao5}{8,8}{⼧,⼧}[HSK 4]
...
\begin{EntryWithPhonetic}{宝石}{bao3shi2}{8,5}{⼧,⽯}[HSK 4]
...
%%%%%%%%%% 饱 %%%%%%%%%%
\subsection*{饱}\addcontentsline{loh}{figure}{饱 \dpy{bao3}}
...
%%%%%%%%%% 保 %%%%%%%%%%
\subsection*{保}\addcontentsline{loh}{figure}{保 \dpy{bao3}}
...
\begin{EntryWithPhonetic}{保不住}{bao3bu5zhu4}{9,4,7}{⼈,⼀,⼈}
...
\begin{EntryWithPhonetic}{保定}{bao3ding4}{9,8}{⼈,⼧}
...
\begin{EntryWithPhonetic}{保健}{bao3jian4}{9,10}{⼈,⼈}[HSK 6]
...
\begin{EntryWithPhonetic}{保密}{bao3//mi4}{9,11}{⼈,⼧}[HSK 4]
...
\begin{EntryWithPhonetic}{保亭}{bao3ting2}{9,9}{⼈,⼇}
...
\begin{EntryWithPhonetic}{保鲜}{bao3//xian1}{9,14}{⼈,⿂}[HSK 7-9]
  \definition{v.+compl.}{manter fresco; preservar o frescor}
  \antonymref{腐烂}{fu3lan4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{保险}{bao3//xian3}{9,9}{⼈,⾩}[HSK 3]
...
\begin{EntryWithPhonetic}{保修}{bao3//xiu1}{9,9}{⼈,⼈}[HSK 7-9]
...
\begin{EntryWithPhonetic}{保证书}{bao3zheng4shu1}{9,7,4}{⼈,⾔,⼄}[HSK 5]
...
\begin{EntryWithPhonetic}{保重}{bao3//zhong4}{9,9}{⼈,⾥}[HSK 7-9]
...
%%%%%%%%%% 堡 %%%%%%%%%%
\subsection*{堡}\addcontentsline{loh}{figure}{堡 \dpy{bao3}}
...
\begin{EntryWithPhonetic}{堡垒}{bao3lei3}{12,9}{⼟,⼟}[HSK 7-9]
  ...
  \synonymref{长城}{chang2cheng2}
  \synonymref{城堡}{cheng2bao3}
  \antonymref{敞开}{chang3kai1}
\end{EntryWithPhonetic}

%%%%%%%%%% 刨 %%%%%%%%%%
\subsection*{刨}\addcontentsline{loh}{figure}{刨 \dpy{bao4}}

\begin{EntryWithPhonetic}{刨}{bao4}{7}{⼑}
...
%%%%%%%%%% 报 %%%%%%%%%%
\subsection*{报}\addcontentsline{loh}{figure}{报 \dpy{bao4}}
...
\begin{EntryWithPhonetic}{报警}{bao4//jing3}{7,19}{⼿,⾔}[HSK 5]
...
\begin{EntryWithPhonetic}{报刊}{bao4kan1}{7,5}{⼿,⼑}[HSK 6]
...
\begin{EntryWithPhonetic}{报考}{bao4kao3}{7,6}{⼿,⽼}[HSK 6]
...
\begin{EntryWithPhonetic}{报亭}{bao4ting2}{7,9}{⼿,⼇}[HSK 7-9]
...
%%%%%%%%%% 抱 %%%%%%%%%%
\subsection*{抱}\addcontentsline{loh}{figure}{抱 \dpy{bao4}}
...
\begin{EntryWithPhonetic}{抱怨}{bao4//yuan4}{8,9}{⼿,⼼}[HSK 5]
...
%%%%%%%%%% 豹 %%%%%%%%%%
\subsection*{豹}\addcontentsline{loh}{figure}{豹 \dpy{bao4}}
...
%%%%%%%%%% 暴 %%%%%%%%%%
\subsection*{暴}\addcontentsline{loh}{figure}{暴 \dpy{bao4}}
...
\begin{EntryWithPhonetic}{暴风雨}{bao4feng1yu3}{15,4,8}{⽇,⾵,⾬}[HSK 6]
...
\begin{EntryWithPhonetic}{暴露}{bao4lu4}{15,21}{⽇,⾬}[HSK 6]
  ...
  \antonymref{隐瞒}{yin3man2}
  \seealsoref{揭露}{jie1lu4}
  \seealsoref{泄露}{xie4lou4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{暴乱}{bao4luan4}{15,7}{⽇,⼄}
  \definition{s.}{motim; rebelião; revolta; tumultos armados que perturbam a ordem social}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{暴行}{bao4xing2}{15,6}{⽇,⾏}
  \definition{s.}{ato selvagem; ultraje; atrocidade | tiranias; barbáries}
\end{EntryWithPhonetic}
...
%%%%%%%%%% 瀑 %%%%%%%%%%
\subsection*{瀑}\addcontentsline{loh}{figure}{瀑 \dpy{bao4}}
...
%%%%%%%%%% 曝 %%%%%%%%%%
\subsection*{曝}\addcontentsline{loh}{figure}{曝 \dpy{bao4}}
...
\begin{EntryWithPhonetic}{曝光}{bao4//guang1}{19,6}{⽇,⼉}[HSK 7-9]
  \definition{v.+compl.}{expor; sensibilizar filme fotográfico ou papel fotossensível para formar uma imagem latente | expor; tornar (algo ruim) público; revelar coisas secretas (geralmente vergonhosas) ao mundo}
  \antonymref{隐藏}{yin3cang2}
\end{EntryWithPhonetic}

%%%%%%%%%% 爆 %%%%%%%%%%
\subsection*{爆}\addcontentsline{loh}{figure}{爆 \dpy{bao4}}
...
\begin{EntryWithPhonetic}{爆冷门}{bao4//leng3men2}{19,7,3}{⽕,⼎,⾨}[HSK 7-9]
  \definition{v.+compl.}{ter um avanço significativo; refere"-se à ocorrência repentina de um evento inesperado em uma determinada área | ter uma vitória inesperada (especialmente no esporte) | dar um golpe de estado | ter uma reviravolta inesperada}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{爆竹}{bao4zhu2}{19,6}{⽕,⽵}[HSK 7-9]
  \definition[串,个]{s.}{fogo de artifício}
\end{EntryWithPhonetic}

%%%%%%%%%% 卑 %%%%%%%%%%
\subsection*{卑}\addcontentsline{loh}{figure}{卑 \dpy{bei1}}
...
%%%%%%%%%% 杯 %%%%%%%%%%
\subsection*{杯}\addcontentsline{loh}{figure}{杯 \dpy{bei1}}
...
\begin{EntryWithPhonetic}{杯子}{bei1zi5}{8,3}{⽊,⼦}[HSK 1]
...
%%%%%%%%%% 背 %%%%%%%%%%
\subsection*{背}\addcontentsline{loh}{figure}{背 \dpy{bei1}}

\begin{EntryWithPhonetic}{背}{bei1}{9}{⾁}[HSK 3]
...
\begin{EntryWithPhonetic}{背包}{bei1bao1}{9,5}{⾁,⼓}[HSK 5]
...
\begin{EntryWithPhonetic}{背包袱}{bei1//bao1fu5}{9,5,11}{⾁,⼓,⾐}[HSK 5]
...
\begin{EntryWithPhonetic}{背黑锅}{bei1//hei1guo1}{9,12,12}{⾁,⿊,⾦}[HSK 5]
...
%%%%%%%%%% 悲 %%%%%%%%%%
\subsection*{悲}\addcontentsline{loh}{figure}{悲 \dpy{bei1}}
...
\begin{EntryWithPhonetic}{悲剧}{bei1ju4}{12,10}{⽕,⼑}[HSK 5]
  \definition[出,部]{s.}{tragédia; drama trágico; uma das principais categorias de teatro, caracterizada basicamente pela representação do conflito irreconciliável entre o protagonista e a realidade e seu final trágico | tragédia; evento triste; encontro infeliz}
  \antonymref{喜剧}{xi3ju4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{悲伤}{bei1shang1}{12,6}{⽕,⼈}[HSK 5]
  \definition{adj.}{triste; pesaroso}
  \synonymref{难过}{nan2guo4}
  \synonymref{伤心}{shang1//xin1}
  \synonymref{伤感}{shang1gan3}
  \synonymref{痛苦}{tong4ku3}
...
%%%%%%%%%% 碑 %%%%%%%%%%
\subsection*{碑}\addcontentsline{loh}{figure}{碑 \dpy{bei1}}
...
%%%%%%%%%% 北 %%%%%%%%%%
\subsection*{北}\addcontentsline{loh}{figure}{北 \dpy{bei3}}
...
\begin{EntryWithPhonetic}{北边}{bei3bian5}{5,5}{⼔,⾡}[HSK 1]
...
\begin{EntryWithPhonetic}{北部}{bei3bu4}{5,10}{⼔,⾢}[HSK 3]
  \definition{s.}{parte norte de uma região ou país}
  \seealsoref{北边}{bei3bian5}
  \seealsoref{北方}{bei3fang1}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{北大西洋公约组织}{bei3da4xi1yang2gong1yue1zu3zhi1}{5,3,6,9,4,6,8,8}{⼔,⼤,⾑,⽔,⼋,⽷,⽷,⽷}
...
\begin{EntryWithPhonetic}{北京}{bei3jing1}{5,8}{⼔,⼇}[HSK 1]
...
\begin{EntryWithPhonetic}{北京地图}{bei3jing1 di4tu2}{5,8,6,8}{⼔,⼇,⼟,⼞}[HSK 5]
...
\begin{EntryWithPhonetic}{北面儿}{bei3mian4r5}{5,9,2}{⼔,⾯,⼉}
  \definition{s.}{norte}
\end{EntryWithPhonetic}
...
%%%%%%%%%% 贝 %%%%%%%%%%
\subsection*{贝}\addcontentsline{loh}{figure}{贝 \dpy{bei4}}
...
%%%%%%%%%% 备 %%%%%%%%%%
\subsection*{备}\addcontentsline{loh}{figure}{备 \dpy{bei4}}
...
\begin{EntryWithPhonetic}{备受}{bei4//shou4}{8,8}{⼡,⼜}[HSK 7-9]
...
%%%%%%%%%% 背 %%%%%%%%%%
\subsection*{背}\addcontentsline{loh}{figure}{背 \dpy{bei4}}

\begin{EntryWithPhonetic}{背}{bei4}{9}{⾁}[HSK 2]
...
\begin{EntryWithPhonetic}{背后}{bei4hou4}{9,6}{⾁,⼝}[HSK 3]
...
%%%%%%%%%% 被 %%%%%%%%%%
\subsection*{被}\addcontentsline{loh}{figure}{被 \dpy{bei4}}
...
%%%%%%%%%% 辈 %%%%%%%%%%
\subsection*{辈}\addcontentsline{loh}{figure}{辈 \dpy{bei4}}
...
\begin{EntryWithPhonetic}{辈}{bei4}{12}{⾞}[HSK 5]
  ...
  \synonymref{等}{deng3}
  \synonymref{类}{lei4}
  \seealsoref{辈儿}{bei4r5}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{辈儿}{bei4r5}{12,2}{⾞,⼉}
  \definition{s.}{vida inteira | geração}
\end{EntryWithPhonetic}

%%%%%%%%%% 奔 %%%%%%%%%%
\subsection*{奔}\addcontentsline{loh}{figure}{奔 \dpy{ben1}}
...
\begin{EntryWithPhonetic}{奔跑}{ben1pao3}{8,12}{⼤,⾜}[HSK 6]
...
%%%%%%%%%% 本 %%%%%%%%%%
\subsection*{本}\addcontentsline{loh}{figure}{本 \dpy{ben3}}
...
\begin{EntryWithPhonetic}{本地}{ben3di4}{5,6}{⽊,⼟}[HSK 6]
...
\begin{EntryWithPhonetic}{本金}{ben3jin1}{5,8}{⽊,⾦}
...
\begin{EntryWithPhonetic}{本科毕业}{ben3ke1 bi4ye4}{5,9,6,5}{⽊,⽲,⽐,⼀}[HSK 5]
...
\begin{EntryWithPhonetic}{本科学历}{ben3ke1 xue2li4}{5,9,8,4}{⽊,⽲,⼦,⼚}[HSK 5]
...
\begin{EntryWithPhonetic}{本领}{ben3ling3}{5,11}{⽊,⾴}[HSK 3]
...
\begin{EntryWithPhonetic}{本期}{ben3qi1}{5,12}{⽊,⽉}[HSK 6]
...
\begin{EntryWithPhonetic}{本事}{ben3shi4}{5,8}{⽊,⼅}[HSK 3]
...
\begin{EntryWithPhonetic}{本事}{ben3shi5}{5,8}{⽊,⼅}
  \definition{s.}{material de origem | história original}
  \seeref{ben3shi4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{本土}{ben3tu3}{5,3}{⽊,⼟}[HSK 6]
...
\begin{EntryWithPhonetic}{本子}{ben3zi5}{5,3}{⽊,⼦}[HSK 1]
...
%%%%%%%%%% 奔 %%%%%%%%%%
\subsection*{奔}\addcontentsline{loh}{figure}{奔 \dpy{ben4}}
...
%%%%%%%%%% 笨 %%%%%%%%%%
\subsection*{笨}\addcontentsline{loh}{figure}{笨 \dpy{ben4}}
...
\begin{EntryWithPhonetic}{笨拙}{ben4zhuo1}{11,8}{⽵,⼿}
  \definition{adj.}{desajeitado; atrapalhado; estúpido; sem graça; sem inteligência; sem habilidade}
  \synonymref{笨重}{ben4zhong4}
  \synonymref{痴呆}{chi1dai1}
  \synonymref{愚昧}{yu2mei4}
  \synonymref{拙劣}{zhuo1lie4}
  \antonymref{聪明}{cong1ming5}
  \antonymref{机灵}{ji1ling5}
  \antonymref{精明}{jing1ming2}
  \antonymref{灵活}{ling2huo2}
  \antonymref{伶俐}{ling2li4}
  \antonymref{灵敏}{ling2min3}
  \antonymref{灵巧}{ling2qiao3}
  \antonymref{敏捷}{min3jie2}
  \antonymref{能干}{neng2gan4}
  \antonymref{巧妙}{qiao3miao4}
  \seealsoref{愚蠢}{yu2chun3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{笨嘴}{ben4 zui3}{11,16}{⽵,⼝}[HSK 5]
  \definition{adj.}{com a fala desajeitada; inarticulado; com dificuldades de comunicação}
\end{EntryWithPhonetic}

%%%%%%%%%% 崩 %%%%%%%%%%
\subsection*{崩}\addcontentsline{loh}{figure}{崩 \dpy{beng1}}
...
\begin{EntryWithPhonetic}{崩溃}{beng1kui4}{11,12}{⼭,⽔}[HSK 7-9]
  ...
  \seealsoref{瓦解}{wa3jie3}
\end{EntryWithPhonetic}

%%%%%%%%%% 绷 %%%%%%%%%%
\subsection*{绷}\addcontentsline{loh}{figure}{绷 \dpy{beng1}}
...
%%%%%%%%%% 甭 %%%%%%%%%%
\subsection*{甭}\addcontentsline{loh}{figure}{甭 \dpy{beng2}}
...
%%%%%%%%%% 绷 %%%%%%%%%%
\subsection*{绷}\addcontentsline{loh}{figure}{绷 \dpy{beng3}}
...
%%%%%%%%%% 蹦 %%%%%%%%%%
\subsection*{蹦}\addcontentsline{loh}{figure}{蹦 \dpy{beng4}}
...
%%%%%%%%%% 逼 %%%%%%%%%%
\subsection*{逼}\addcontentsline{loh}{figure}{逼 \dpy{bi1}}
...
\begin{EntryWithPhonetic}{逼狭}{bi1 xia2}{12,9}{⾡,⽝}
  \definition{adj.}{estreito}
...
%%%%%%%%%% 鼻 %%%%%%%%%%
\subsection*{鼻}\addcontentsline{loh}{figure}{鼻 \dpy{bi2}}
...
\begin{EntryWithPhonetic}{鼻子发痒}{bi2zi5 fa1 yang3}{14,3,5,11}{⿐,⼦,⼜,⽧}[HSK 5]
  \definition{s.}{coceira no nariz; nariz coçando}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{鼻子过敏}{bi2zi5 guo4min3}{14,3,6,11}{⿐,⼦,⾡,⽁}[HSK 5]
  \definition{s.}{alergias nasais; nariz alérgico}
\end{EntryWithPhonetic}

%%%%%%%%%% 比 %%%%%%%%%%
\subsection*{比}\addcontentsline{loh}{figure}{比 \dpy{bi3}}
...
\begin{EntryWithPhonetic}{比不上}{bi3bu5shang4}{4,4,3}{⽐,⼀,⼀}[HSK 7-9]
...
\begin{EntryWithPhonetic}{比如说}{bi3ru2 shuo1}{4,6,9}{⽐,⼥,⾔}[HSK 2]
...
%%%%%%%%%% 彼 %%%%%%%%%%
\subsection*{彼}\addcontentsline{loh}{figure}{彼 \dpy{bi3}}
...
%%%%%%%%%% 笔 %%%%%%%%%%
\subsection*{笔}\addcontentsline{loh}{figure}{笔 \dpy{bi3}}
...
\begin{EntryWithPhonetic}{笔记}{bi3ji4}{10,5}{⽵,⾔}[HSK 2]
...
%%%%%%%%%% 必 %%%%%%%%%%
\subsection*{必}\addcontentsline{loh}{figure}{必 \dpy{bi4}}
...
\begin{EntryWithPhonetic}{必将}{bi4jiang1}{5,9}{⼼,⼨}[HSK 6]
...
\begin{EntryWithPhonetic}{必修}{bi4xiu1}{5,9}{⼼,⼈}[HSK 6]
...
\begin{EntryWithPhonetic}{必需}{bi4xu1}{5,14}{⼼,⾬}[HSK 5]
...
%%%%%%%%%% 毕 %%%%%%%%%%
\subsection*{毕}\addcontentsline{loh}{figure}{毕 \dpy{bi4}}
...
\begin{EntryWithPhonetic}{毕业生}{bi4ye4sheng1}{6,5,5}{⽐,⼀,⽣}[HSK 4]
  \definition[个,名,位,些]{s.}{diplomado; graduado; bacharel; pessoa que recebeu um diploma, grau ou certificado}
\end{EntryWithPhonetic}

%%%%%%%%%% 闭 %%%%%%%%%%
\subsection*{闭}\addcontentsline{loh}{figure}{闭 \dpy{bi4}}
...
\begin{EntryWithPhonetic}{闭幕式}{bi4mu4 shi4}{6,13,6}{⾨,⼱,⼷}[HSK 5]
...
%%%%%%%%%% 秘 %%%%%%%%%%
\subsection*{秘}\addcontentsline{loh}{figure}{秘 \dpy{bi4}}
...
%%%%%%%%%% 弊 %%%%%%%%%%
\subsection*{弊}\addcontentsline{loh}{figure}{弊 \dpy{bi4}}
...
%%%%%%%%%% 碧 %%%%%%%%%%
\subsection*{碧}\addcontentsline{loh}{figure}{碧 \dpy{bi4}}
...
%%%%%%%%%% 壁 %%%%%%%%%%
\subsection*{壁}\addcontentsline{loh}{figure}{壁 \dpy{bi4}}
...
%%%%%%%%%% 避 %%%%%%%%%%
\subsection*{避}\addcontentsline{loh}{figure}{避 \dpy{bi4}}
...
\begin{EntryWithPhonetic}{避免}{bi4mian3}{16,7}{⾌,⼉}[HSK 4]
  ...
  \antonymref{迎来}{ying2lai2}
  \antonymref{遭遇}{zao1yu4}
  \seealsoref{防止}{fang2zhi3}
  \seealsoref{免}{mian3}
\end{EntryWithPhonetic}
...
%%%%%%%%%% 边 %%%%%%%%%%
\subsection*{边}\addcontentsline{loh}{figure}{边 \dpy{bian1}}
...
%%%%%%%%%% 编 %%%%%%%%%%
\subsection*{编}\addcontentsline{loh}{figure}{编 \dpy{bian1}}
...
\begin{EntryWithPhonetic}{编辑}{bian1ji2}{12,13}{⽷,⾞}[HSK 5]
  ...
  \synonymref{改编}{gai3bian1}
  \seeref{bian1ji5}
  \seealsoref{编}{bian1}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{编辑部}{bian1ji2 bu4}{12,13,10}{⽷,⾞,⾢}[HSK 5]
  \definition{s.}{departamento editorial; unidade operacional responsável pelo processamento de manuscritos, composta por editores, pelo diretor e pelo diretor adjunto}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{编辑}{bian1ji5}{12,13}{⽷,⾞}
  \definition{s.}{editor; compilador; pessoa que organiza e processa dados ou trabalhos existentes}
  \seeref{bian1ji2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{编剧}{bian1//ju4}{12,10}{⽷,⼑}[HSK 7-9]
  \definition{v.}{escrever uma peça, um roteiro, etc.}
  \definition[个,位,名]{v.+compl.}{dramaturgo | roteirista}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{编造}{bian1//zao4}{12,10}{⽷,⾡}[HSK 7-9]
  \definition{v.+compl.}{compilar; compor; preparar | fabricar; inventar; criar; cozinhar | criar a partir da imaginação}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{编制}{bian1zhi4}{12,8}{⽷,⼑}[HSK 6]
...
%%%%%%%%%% 邉 %%%%%%%%%%
\subsection*{邉}\addcontentsline{loh}{figure}{邉 \dpy{bian1}}
...
%%%%%%%%%% 鞭 %%%%%%%%%%
\subsection*{鞭}\addcontentsline{loh}{figure}{鞭 \dpy{bian1}}
...
%%%%%%%%%% 贬 %%%%%%%%%%
\subsection*{贬}\addcontentsline{loh}{figure}{贬 \dpy{bian3}}
...
\begin{EntryWithPhonetic}{贬值}{bian3//zhi2}{8,10}{⾙,⼈}[HSK 7-9]
...
%%%%%%%%%% 扁 %%%%%%%%%%
\subsection*{扁}\addcontentsline{loh}{figure}{扁 \dpy{bian3}}
...
%%%%%%%%%% 变 %%%%%%%%%%
\subsection*{变}\addcontentsline{loh}{figure}{变 \dpy{bian4}}
...
\begin{EntryWithPhonetic}{变成}{bian4cheng2}{8,6}{⼜,⼽}[HSK 2]
...
\begin{EntryWithPhonetic}{变动}{bian4dong4}{8,6}{⼜,⼒}[HSK 5]
...
\begin{EntryWithPhonetic}{变更}{bian4geng1}{8,7}{⼜,⽈}[HSK 6]
...
\begin{EntryWithPhonetic}{变换}{bian4huan4}{8,10}{⼜,⼿}[HSK 6]
...
\begin{EntryWithPhonetic}{变为}{bian4wei2}{8,4}{⼜,⼂}[HSK 3]
...
\begin{EntryWithPhonetic}{变性}{bian4//xing4}{8,8}{⼜,⼼}
...
%%%%%%%%%% 便 %%%%%%%%%%
\subsection*{便}\addcontentsline{loh}{figure}{便 \dpy{bian4}}
...
\begin{EntryWithPhonetic}{便是}{bian4shi4}{9,9}{⼈,⽇}[HSK 6]
...
%%%%%%%%%% 遍 %%%%%%%%%%
\subsection*{遍}\addcontentsline{loh}{figure}{遍 \dpy{bian4}}
...
\begin{EntryWithPhonetic}{遍地}{bian4di4}{12,6}{⾡,⼟}[HSK 6]
...
%%%%%%%%%% 辨 %%%%%%%%%%
\subsection*{辨}\addcontentsline{loh}{figure}{辨 \dpy{bian4}}

\begin{EntryWithPhonetic}{辨}{bian4}{16}{⾟}
...
%%%%%%%%%% 辩 %%%%%%%%%%
\subsection*{辩}\addcontentsline{loh}{figure}{辩 \dpy{bian4}}
...
\begin{EntryWithPhonetic}{辩论}{bian4lun4}{16,6}{⾟,⾔}[HSK 4]
  ...
  \seealsoref{争论}{zheng1lun4}
\end{EntryWithPhonetic}

%%%%%%%%%% 辫 %%%%%%%%%%
\subsection*{辫}\addcontentsline{loh}{figure}{辫 \dpy{bian4}}
...
%%%%%%%%%% 边 %%%%%%%%%%
\subsection*{边}\addcontentsline{loh}{figure}{边 \dpy{bian5}}
...
%%%%%%%%%% 标 %%%%%%%%%%
\subsection*{标}\addcontentsline{loh}{figure}{标 \dpy{biao1}}
...
%%%%%%%%%% 髟 %%%%%%%%%%
\subsection*{髟}\addcontentsline{loh}{figure}{髟 \dpy{biao1}}
...
%%%%%%%%%% 彪 %%%%%%%%%%
\subsection*{彪}\addcontentsline{loh}{figure}{彪 \dpy{biao1}}
...
%%%%%%%%%% 镖 %%%%%%%%%%
\subsection*{镖}\addcontentsline{loh}{figure}{镖 \dpy{biao1}}
...
%%%%%%%%%% 飙 %%%%%%%%%%
\subsection*{飙}\addcontentsline{loh}{figure}{飙 \dpy{biao1}}
...
%%%%%%%%%% 表 %%%%%%%%%%
\subsection*{表}\addcontentsline{loh}{figure}{表 \dpy{biao3}}
...
\begin{EntryWithPhonetic}{表白}{biao3//bai2}{8,5}{⾐,⽩}[HSK 7-9]
...
\begin{EntryWithPhonetic}{表决}{biao3//jue2}{8,6}{⾐,⼎}[HSK 7-9]
...
\begin{EntryWithPhonetic}{表面上}{biao3mian4shang4}{8,9,3}{⾐,⾯,⼀}[HSK 6]
...
\begin{EntryWithPhonetic}{表演艺术}{biao3yan3yi4shu4}{8,14,4,5}{⾐,⽔,⾋,⽊}
...
\begin{EntryWithPhonetic}{表演者}{biao3yan3 zhe3}{8,14,8}{⾐,⽔,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{表扬信}{biao3yang2xin4}{8,6,9}{⾐,⼿,⼈}
...
%%%%%%%%%% 憋 %%%%%%%%%%
\subsection*{憋}\addcontentsline{loh}{figure}{憋 \dpy{bie1}}
...
%%%%%%%%%% 别 %%%%%%%%%%
\subsection*{别}\addcontentsline{loh}{figure}{别 \dpy{bie2}}
...
\begin{EntryWithPhonetic}{别人}{bie2ren2}{7,2}{⼑,⼈}[HSK 1]
...
%%%%%%%%%% 宾 %%%%%%%%%%
\subsection*{宾}\addcontentsline{loh}{figure}{宾 \dpy{bin1}}
...
%%%%%%%%%% 彬 %%%%%%%%%%
\subsection*{彬}\addcontentsline{loh}{figure}{彬 \dpy{bin1}}
...
%%%%%%%%%% 滨 %%%%%%%%%%
\subsection*{滨}\addcontentsline{loh}{figure}{滨 \dpy{bin1}}
...
\begin{EntryWithPhonetic}{滨海}{bin1hai3}{13,10}{⽔,⽔}[HSK 7-9]
...
%%%%%%%%%% 缤 %%%%%%%%%%
\subsection*{缤}\addcontentsline{loh}{figure}{缤 \dpy{bin1}}
...
%%%%%%%%%% 冰 %%%%%%%%%%
\subsection*{冰}\addcontentsline{loh}{figure}{冰 \dpy{bing1}}
...
\begin{EntryWithPhonetic}{冰冷}{bing1leng3}{6,7}{⼎,⼎}
...
\begin{EntryWithPhonetic}{冰雪}{bing1xue3}{6,11}{⼎,⾬}[HSK 4]
...
%%%%%%%%%% 并 %%%%%%%%%%
\subsection*{并}\addcontentsline{loh}{figure}{并 \dpy{bing1}}

\begin{EntryWithPhonetic}{并}{bing1}{6}{⼲}
...
%%%%%%%%%% 兵 %%%%%%%%%%
\subsection*{兵}\addcontentsline{loh}{figure}{兵 \dpy{bing1}}
...
%%%%%%%%%% 屏 %%%%%%%%%%
\subsection*{屏}\addcontentsline{loh}{figure}{屏 \dpy{bing1}}
...
%%%%%%%%%% 丙 %%%%%%%%%%
\subsection*{丙}\addcontentsline{loh}{figure}{丙 \dpy{bing3}}
...
%%%%%%%%%% 秉 %%%%%%%%%%
\subsection*{秉}\addcontentsline{loh}{figure}{秉 \dpy{bing3}}
...
%%%%%%%%%% 屏 %%%%%%%%%%
\subsection*{屏}\addcontentsline{loh}{figure}{屏 \dpy{bing3}}
...
%%%%%%%%%% 饼 %%%%%%%%%%
\subsection*{饼}\addcontentsline{loh}{figure}{饼 \dpy{bing3}}
...
%%%%%%%%%% 并 %%%%%%%%%%
\subsection*{并}\addcontentsline{loh}{figure}{并 \dpy{bing4}}
...
%%%%%%%%%% 幷 %%%%%%%%%%
\subsection*{幷}\addcontentsline{loh}{figure}{幷 \dpy{bing4}}
...
%%%%%%%%%% 倂 %%%%%%%%%%
\subsection*{倂}\addcontentsline{loh}{figure}{倂 \dpy{bing4}}
...
%%%%%%%%%% 病 %%%%%%%%%%
\subsection*{病}\addcontentsline{loh}{figure}{病 \dpy{bing4}}
...
\begin{EntryWithPhonetic}{病情}{bing4qing2}{10,11}{⽧,⼼}[HSK 6]
  \definition{s.}{estado de uma doença; condição do paciente; mudanças na doença}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{病人}{bing4ren2}{10,2}{⽧,⼈}[HSK 1]
...
%%%%%%%%%% 拨 %%%%%%%%%%
\subsection*{拨}\addcontentsline{loh}{figure}{拨 \dpy{bo1}}
...
\begin{EntryWithPhonetic}{拨打}{bo1da3}{8,5}{⼿,⼿}[HSK 6]
...
\begin{EntryWithPhonetic}{拨款}{bo1//kuan3}{8,12}{⼿,⽋}[HSK 7-9]
...
\begin{EntryWithPhonetic}{拨通}{bo1tong1}{8,10}{⼿,⾡}[HSK 7-9]
...
%%%%%%%%%% 波 %%%%%%%%%%
\subsection*{波}\addcontentsline{loh}{figure}{波 \dpy{bo1}}
...
\begin{EntryWithPhonetic}{波动}{bo1dong4}{8,6}{⽔,⼒}[HSK 6]
...
\begin{EntryWithPhonetic}{波及}{bo1ji2}{8,3}{⽔,⼃}[HSK 7-9]
...
%%%%%%%%%% 玻 %%%%%%%%%%
\subsection*{玻}\addcontentsline{loh}{figure}{玻 \dpy{bo1}}
...
%%%%%%%%%% 剥 %%%%%%%%%%
\subsection*{剥}\addcontentsline{loh}{figure}{剥 \dpy{bo1}}
...
%%%%%%%%%% 般 %%%%%%%%%%
\subsection*{般}\addcontentsline{loh}{figure}{般 \dpy{bo1}}
...
%%%%%%%%%% 啵 %%%%%%%%%%
\subsection*{啵}\addcontentsline{loh}{figure}{啵 \dpy{bo1}}
...
%%%%%%%%%% 菠 %%%%%%%%%%
\subsection*{菠}\addcontentsline{loh}{figure}{菠 \dpy{bo1}}
...
\begin{EntryWithPhonetic}{菠菜}{bo1cai4}{11,11}{⾋,⾋}
  \definition[棵,把,捆]{s.}{espinafre}
\end{EntryWithPhonetic}

%%%%%%%%%% 播 %%%%%%%%%%
\subsection*{播}\addcontentsline{loh}{figure}{播 \dpy{bo1}}
...
\begin{EntryWithPhonetic}{播放}{bo1fang4}{15,8}{⼿,⽅}[HSK 3]
  ...
  \synonymref{播出}{bo1 chu1}
  \synonymref{放映}{fang4ying4}
  \antonymref{停止}{ting2zhi3}
  \antonymref{暂停}{zan4ting2}
  \antonymref{中断}{zhong1duan4}
  \seealsoref{播送}{bo1song4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{播送}{bo1song4}{15,9}{⼿,⾡}
  \definition{v.}{transmitir; difundir; emitir; transmitir para o exterior via rádio ou comunicação por fio}
  \synonymref{播音}{bo1//yin1}
  \synonymref{广播}{guang3bo1}
  \seealsoref{播放}{bo1fang4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{播言}{bo1 yan2}{15,7}{⼿,⾔}
  \definition{s.}{transmissão; \emph{broadcast}}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{播音}{bo1//yin1}{15,9}{⼿,⾳}
  \definition{s.}{transmissão; difusão; diversos programas são transmitidos por meio de estações de rádio com fio ou sem fio}
  \definition{v.+compl.}{transmitir; difundir}
\end{EntryWithPhonetic}

%%%%%%%%%% 蕃 %%%%%%%%%%
\subsection*{蕃}\addcontentsline{loh}{figure}{蕃 \dpy{bo1}}
...
%%%%%%%%%% 伯 %%%%%%%%%%
\subsection*{伯}\addcontentsline{loh}{figure}{伯 \dpy{bo2}}
...
%%%%%%%%%% 驳 %%%%%%%%%%
\subsection*{驳}\addcontentsline{loh}{figure}{驳 \dpy{bo2}}
...
%%%%%%%%%% 柏 %%%%%%%%%%
\subsection*{柏}\addcontentsline{loh}{figure}{柏 \dpy{bo2}}
...
%%%%%%%%%% 亳 %%%%%%%%%%
\subsection*{亳}\addcontentsline{loh}{figure}{亳 \dpy{bo2}}

\begin{EntryWithPhonetic}{亳}{bo2}{10}{⼇}
...
\begin{EntryWithPhonetic}{亳州}{bo2zhou1}{10,6}{⼇,⼮}
  \definition*{s.}{Bozhou, uma cidade na província de Anhui ()}
  \seealsoref{安徽}{an1hui1}
\end{EntryWithPhonetic}

%%%%%%%%%% 脖 %%%%%%%%%%
\subsection*{脖}\addcontentsline{loh}{figure}{脖 \dpy{bo2}}
...
%%%%%%%%%% 博 %%%%%%%%%%
\subsection*{博}\addcontentsline{loh}{figure}{博 \dpy{bo2}}
...
\begin{EntryWithPhonetic}{博客}{bo2ke4}{12,9}{⼗,⼧}[HSK 5]
...
\begin{EntryWithPhonetic}{博物馆}{bo2wu4guan3}{12,8,11}{⼗,⽜,⾷}[HSK 5]
  ...
  \synonymref{纪念馆}{ji4nian4guan3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{博主}{bo2zhu3}{12,5}{⼗,⼂}
  \definition{s.}{blogueiro; pessoas que escrevem \emph{blogs} ou \emph{microblogs}}
\end{EntryWithPhonetic}

%%%%%%%%%% 渤 %%%%%%%%%%
\subsection*{渤}\addcontentsline{loh}{figure}{渤 \dpy{bo2}}

\begin{EntryWithPhonetic}{渤}{bo2}{12}{⽔}
  \definition*{s.}{Golfo de Jily ou Chihli; O mesmo que 渤海, Mar de Bohai entre Liaoning e Shandong}
  \seealsoref{渤海}{bo2hai3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{渤海}{bo2hai3}{12,10}{⽔,⽔}
  \definition*{s.}{Mar de Bohai; entre a Península de Shandong (山东)  e a Península de Liaodong (辽东)}
  \seealsoref{辽东}{liao2dong1}
  \seealsoref{山东}{shan1dong1}
\end{EntryWithPhonetic}

%%%%%%%%%% 搏 %%%%%%%%%%
\subsection*{搏}\addcontentsline{loh}{figure}{搏 \dpy{bo2}}
...
%%%%%%%%%% 魄 %%%%%%%%%%
\subsection*{魄}\addcontentsline{loh}{figure}{魄 \dpy{bo2}}

\begin{EntryWithPhonetic}{魄}{bo2}{14}{⿁}
...
%%%%%%%%%% 薄 %%%%%%%%%%
\subsection*{薄}\addcontentsline{loh}{figure}{薄 \dpy{bo2}}
...
\begin{EntryWithPhonetic}{薄弱}{bo2ruo4}{16,10}{⾋,⼸}[HSK 5]
  ...
  \antonymref{刚强}{gang1qiang2}
  \antonymref{坚强}{jian1qiang2}
  \antonymref{坚实}{jian1shi2}
  \antonymref{牢固}{lao2gu4}
  \antonymref{顽强}{wan2qiang2}
  \antonymref{雄厚}{xiong2hou4}
\end{EntryWithPhonetic}

%%%%%%%%%% 柏 %%%%%%%%%%
\subsection*{柏}\addcontentsline{loh}{figure}{柏 \dpy{bo4}}
...
%%%%%%%%%% 薄 %%%%%%%%%%
\subsection*{薄}\addcontentsline{loh}{figure}{薄 \dpy{bo4}}
...
%%%%%%%%%% 啵 %%%%%%%%%%
\subsection*{啵}\addcontentsline{loh}{figure}{啵 \dpy{bo5}}
...
%%%%%%%%%% 不 %%%%%%%%%%
\subsection*{不}\addcontentsline{loh}{figure}{不 \dpy{bu2}}

\begin{EntryWithPhonetic}{不}{bu2}[(不 $+$ 4º tom)]{4}{⼀}[HSK 1]
...
\begin{EntryWithPhonetic}{不碍事}{bu2 ai4shi4}{4,13,8}{⼀,⽯,⼅}[HSK 5]
  \definition{expr.}{não é nada demais; não importa; isso não interfere na questão}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{不必}{bu2bi4}{4,5}{⼀,⼼}[HSK 3]
...
\begin{EntryWithPhonetic}{不便}{bu2bian4}{4,9}{⼀,⼈}[HSK 6]
...
\begin{EntryWithPhonetic}{不错}{bu2cuo4}{4,13}{⼀,⾦}[HSK 2]
...
\begin{EntryWithPhonetic}{不但}{bu2dan4}{4,7}{⼀,⼈}[HSK 2]
...
\begin{EntryWithPhonetic}{不但……而且……}{bu2dan4 er2qie3}{4,7,6,5}{⼀,⼈,⽽,⼀}
...
\begin{EntryWithPhonetic}{不对劲}{bu2dui4jin4}{4,5,7}{⼀,⼨,⼒}[HSK 5]
...
\begin{EntryWithPhonetic}{不够}{bu2gou4}{4,11}{⼀,⼣}[HSK 2]
...
\begin{EntryWithPhonetic}{不会}{bu2hui4}{4,6}{⼀,⼈}
...
\begin{EntryWithPhonetic}{不会说话}{bu2 hui4 shuo1hua4}{4,6,9,8}{⼀,⼈,⾔,⾔}[HSK 5]
  \definition{expr.}{incapaz de falar; não ser bom em se expressar; incapaz de falar bem}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{不计其数}{bu2ji4qi2shu4}{4,4,8,13}{⼀,⾔,⼋,⽁}
...
\begin{EntryWithPhonetic}{不见}{bu2jian4}{4,4}{⼀,⾒}[HSK 6]
...
\begin{EntryWithPhonetic}{不见得}{bu2 jian4de2}{4,4,11}{⼀,⾒,⼻}[HSK 7-9]
...
\begin{EntryWithPhonetic}{不客气}{bu2 ke4qi4}{4,9,4}{⼀,⼧,⽓}[HSK 1]
...
\begin{EntryWithPhonetic}{不利}{bu2li4}{4,7}{⼀,⼑}[HSK 5]
...
\begin{EntryWithPhonetic}{不利于}{bu2li4yu2}{4,7,3}{⼀,⼑,⼆}[HSK 7-9]
...
\begin{EntryWithPhonetic}{不论}{bu2lun4}{4,6}{⼀,⾔}[HSK 3]
...
\begin{EntryWithPhonetic}{不是……，而是……}{bu2shi4 er2 shi4}{4,9,6,9}{⼀,⽇,⽽,⽇}
...
\begin{EntryWithPhonetic}{不是话}{bu2shi4 hua4}{4,9,8}{⼀,⽇,⾔}
...
\begin{EntryWithPhonetic}{不算}{bu2suan4}{4,14}{⼀,⽵}[HSK 7-9]
  \definition{adv.}{não realmente; não em vão; não é grande coisa}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{不太}{bu2tai4}{4,4}{⼀,⼤}[HSK 2]
...
\begin{EntryWithPhonetic}{不幸}{bu2xing4}{4,8}{⼀,⼲}[HSK 5]
...
\begin{EntryWithPhonetic}{不要}{bu2yao4}{4,9}{⼀,⾑}[HSK 2]
...
\begin{EntryWithPhonetic}{不用}{bu2yong4}{4,5}{⼀,⽤}[HSK 1]
...
\begin{EntryWithPhonetic}{不再}{bu2zai4}{4,6}{⼀,⼌}[HSK 6]
...
\begin{EntryWithPhonetic}{不在乎}{bu2zai4hu1}{4,6,5}{⼀,⼟,⼃}[HSK 4]
...
\begin{EntryWithPhonetic}{不至于}{bu2zhi4yu2}{4,6,3}{⼀,⾄,⼆}[HSK 6]
...
\begin{EntryWithPhonetic}{不注意}{bu2 zhu4yi4}{4,8,13}{⼀,⽔,⼼}
...
%%%%%%%%%% 补 %%%%%%%%%%
\subsection*{补}\addcontentsline{loh}{figure}{补 \dpy{bu3}}
...
\begin{EntryWithPhonetic}{补习}{bu3xi2}{7,3}{⾐,⼄}[HSK 6]
...
\begin{EntryWithPhonetic}{补助}{bu3zhu4}{7,7}{⾐,⼒}[HSK 6]
...
%%%%%%%%%% 哺 %%%%%%%%%%
\subsection*{哺}\addcontentsline{loh}{figure}{哺 \dpy{bu3}}
...
%%%%%%%%%% 捕 %%%%%%%%%%
\subsection*{捕}\addcontentsline{loh}{figure}{捕 \dpy{bu3}}
...
%%%%%%%%%% 堡 %%%%%%%%%%
\subsection*{堡}\addcontentsline{loh}{figure}{堡 \dpy{bu3}}
...
%%%%%%%%%% 不 %%%%%%%%%%
\subsection*{不}\addcontentsline{loh}{figure}{不 \dpy{bu4}}
...
\begin{EntryWithPhonetic}{不比}{bu4bi3}{4,4}{⼀,⽐}
...
\begin{EntryWithPhonetic}{不曾}{bu4ceng2}{4,12}{⼀,⽈}[HSK 5]
...
\begin{EntryWithPhonetic}{不成}{bu4cheng2}{4,6}{⼀,⼽}[HSK 6]
...
\begin{EntryWithPhonetic}{不服气}{bu4fu2//qi4}{4,8,4}{⼀,⽉,⽓}[HSK 7-9]
  \definition{v.+compl.}{recusar"-se a ser convencido; não confiar}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{不敢当}{bu4 gan3dang1}{4,11,6}{⼀,⽁,⼹}[HSK 5]
...
\begin{EntryWithPhonetic}{不管三七二十一}{bu4guan3 san1qi1'er4shi2yi1}{4,14,3,2,2,2,1}{⼀,⽵,⼀,⼀,⼆,⼗,⼀}[HSK 5]
...
\begin{EntryWithPhonetic}{不光}{bu4guang1}{4,6}{⼀,⼉}[HSK 3]
...
\begin{EntryWithPhonetic}{不好}{bu4hao3}{4,6}{⼀,⼥}
...
\begin{EntryWithPhonetic}{不好意思}{bu4hao3yi4si5}{4,6,13,9}{⼀,⼥,⼼,⼼}[HSK 2]
...
\begin{EntryWithPhonetic}{不及}{bu4ji2}{4,3}{⼀,⼃}
...
\begin{EntryWithPhonetic}{不仅仅}{bu4jin3jin3}{4,4,4}{⼀,⼈,⼈}[HSK 6]
  \definition{adv.}{não só; não apenas}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{不紧不慢}{bu4 jin3 bu2 man4}{4,10,4,14}{⼀,⽷,⼀,⼼}[HSK 5]
...
\begin{EntryWithPhonetic}{不久}{bu4jiu3}{4,3}{⼀,⼃}[HSK 2]
...
\begin{EntryWithPhonetic}{不可}{bu4ke3}{4,5}{⼀,⼝}
...
\begin{EntryWithPhonetic}{不肯}{bu4ken3}{4,8}{⼀,⾁}[HSK 7-9]
...
\begin{EntryWithPhonetic}{不良}{bu4liang2}{4,7}{⼀,⾉}[HSK 5]
...
\begin{EntryWithPhonetic}{不满}{bu4man3}{4,13}{⼀,⽔}[HSK 2]
...
\begin{EntryWithPhonetic}{不难}{bu4nan2}{4,10}{⼀,⾫}[HSK 7-9]
  \definition{v.}{não ser difícil}[这台电脑修理起来不难。===Este computador não é difícil de consertar.]
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{不能不}{bu4neng2bu4}{4,10,4}{⼀,⾁,⼀}[HSK 5]
...
\begin{EntryWithPhonetic}{不起眼儿}{bu4 qi3yan3r5}{4,10,11,2}{⼀,⾛,⽬,⼉}[HSK 5]
...
\begin{EntryWithPhonetic}{不如说}{bu4ru2shuo1}{4,6,9}{⼀,⼥,⾔}[HSK 7-9]
...
\begin{EntryWithPhonetic}{不少}{bu4shao3}{4,4}{⼀,⼩}[HSK 2]
...
\begin{EntryWithPhonetic}{不舒服}{bu4shu1fu5}{4,12,8}{⼀,⾆,⽉}
...
\begin{EntryWithPhonetic}{不通}{bu4tong1}{4,10}{⼀,⾡}[HSK 6]
...
\begin{EntryWithPhonetic}{不同}{bu4tong2}{4,6}{⼀,⼝}[HSK 2]
...
\begin{EntryWithPhonetic}{不喜欢}{bu4 xi3huan1}{4,12,6}{⼀,⼝,⽋}
...
\begin{EntryWithPhonetic}{不行}{bu4xing2}{4,6}{⼀,⾏}[HSK 2]
...
\begin{EntryWithPhonetic}{不许}{bu4xu3}{4,6}{⼀,⾔}[HSK 5]
...
\begin{EntryWithPhonetic}{不一定}{bu4 yi2ding4}{4,1,8}{⼀,⼀,⼧}[HSK 2]
...
\begin{EntryWithPhonetic}{不一会儿}{bu4 yi2hui4r5}{4,1,6,2}{⼀,⼀,⼈,⼉}[HSK 2]
...
\begin{EntryWithPhonetic}{不怎么}{bu4zen3me5}{4,9,3}{⼀,⼼,⼃}[HSK 6]
  \definition{adv.}{não muito; não particularmente; não exatamente}
  \seealsoref{不怎么样}{bu4zen3me5yang4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{不怎么样}{bu4zen3me5yang4}{4,9,3,10}{⼀,⼼,⼃,⽊}[HSK 6]
...
\begin{EntryWithPhonetic}{不知所措}{bu4zhi1-suo3cuo4}{4,8,8,11}{⼀,⽮,⼾,⼿}
  \definition{expr.}{sem saída; estar perdido; estar confuso; não saber o que fazer}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{不值}{bu4zhi2}{4,10}{⼀,⼈}[HSK 6]
...
\begin{EntryWithPhonetic}{不只}{bu4zhi3}{4,5}{⼀,⼝}
  \synonymref{不但}{bu2dan4}
  \synonymref{不光}{bu4guang1}
  \synonymref{不止}{bu4zhi3}
  \seealsoref{不仅}{bu4jin3}
...
\begin{EntryWithPhonetic}{不住}{bu4zhu4}{4,7}{⼀,⼈}
...
\begin{EntryWithPhonetic}{不准}{bu4zhun3}{4,10}{⼀,⼎}[HSK 7-9]
...
%%%%%%%%%% 布 %%%%%%%%%%
\subsection*{布}\addcontentsline{loh}{figure}{布 \dpy{bu4}}
...
\begin{EntryWithPhonetic}{布满}{bu4man3}{5,13}{⼱,⽔}[HSK 6]
...
%%%%%%%%%% 步 %%%%%%%%%%
\subsection*{步}\addcontentsline{loh}{figure}{步 \dpy{bu4}}
...
\begin{EntryWithPhonetic}{步行}{bu4xing2}{7,6}{⽌,⾏}[HSK 4]
...
%%%%%%%%%% 部 %%%%%%%%%%
\subsection*{部}\addcontentsline{loh}{figure}{部 \dpy{bu4}}
...
\begin{EntryWithPhonetic}{部队}{bu4dui4}{10,4}{⾢,⾩}[HSK 6]
...
\begin{EntryWithPhonetic}{部长}{bu4zhang3}{10,4}{⾢,⾧}[HSK 3]
...
%%%%%%%%%% 不 %%%%%%%%%%
\subsection*{不}\addcontentsline{loh}{figure}{不 \dpy{bu5}}

\begin{EntryWithPhonetic}{不}{bu5}{4}{⼀}
