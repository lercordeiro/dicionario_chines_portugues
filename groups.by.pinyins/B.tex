...
\begin{EntryWithPhonetic}{八卦}{ba1gua4}{2,8}{⼋,⼘}[HSK 7-9]
  \definition*{s.}{Oito Trigramas; na China antiga, havia um conjunto de símbolos, os oito trigramas, que são chamados de Bagua: ☰  (céu, paraíso), ☱ (lago), ☲ (fogo), ☳ (trovão), ☴ (vento), ☵ (água), ☶ (montanha) e ☷ (terra) onde ⚊ representa 阳 (Yang) e ⚋ representa 阴 (Yin); mais tarde, foi usado para prever sucesso ou fracasso, sorte ou infortúnio, etc.}
