...
%%%%%%%%%% 南 %%%%%%%%%%
\subsection*{南}\addcontentsline{loh}{figure}{南 \dpy{na1}}

\begin{EntryWithPhonetic}{南}{na1}{9}{⼗}
...
\begin{EntryWithPhonetic}{拿不出手}{na2 bu4 chu1shou3}{10,4,5,4}{⼿,⼀,⼐,⼿}[HSK 5]
...
\begin{EntryWithPhonetic}{拿主意}{na2//zhu3yi5}{10,5,13}{⼿,⼂,⼼}[HSK 5]
...
\begin{EntryWithPhonetic}{拿走}{na2zou3}{10,7}{⼿,⾛}[HSK 6]
...
\begin{EntryWithPhonetic}{哪}{na3}{9}{⼝}[HSK 1]
...
\begin{EntryWithPhonetic}{哪里}{na3li5}{9,7}{⼝,⾥}[HSK 1]
...
\begin{EntryWithPhonetic}{那边}{na4bian5}{6,5}{⾢,⾡}[HSK 1]
...
\begin{EntryWithPhonetic}{那么}{na4me5}{6,3}{⾢,⼃}[HSK 2]
...
\begin{EntryWithPhonetic}{那麽}{na4me5}{6,14}{⾢,⿇}
  \variantof{那么}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{那时}{na4shi2}{6,7}{⾢,⽇}
...
\begin{EntryWithPhonetic}{那时候}{na4 shi2hou4}{6,7,10}{⾢,⽇,⼈}[HSK 2]
  \definition{adv.}{naquela hora; em algum momento no passado}
  \seealsoref{那时}{na4shi2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{那些}{na4xie1}{6,8}{⾢,⼆}[HSK 1]
...
\begin{EntryWithPhonetic}{那样}{na4yang4}{6,10}{⾢,⽊}[HSK 2]
...
\begin{EntryWithPhonetic}{那咱}{na4zan5}{6,9}{⾢,⼝}
...
\begin{EntryWithPhonetic}{哪}{na5}{9}{⼝}[HSK 4]
...
\begin{EntryWithPhonetic}{奶茶}{nai3cha2}{5,9}{⼥,⾋}[HSK 3]
  \definition[杯]{s.}{chá com leite; chá com leite de vaca ou de ovelha}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{奶粉}{nai3fen3}{5,10}{⼥,⽶}[HSK 6]
...
\begin{EntryWithPhonetic}{奶牛}{nai3niu2}{5,4}{⼥,⽜}[HSK 6]
...
\begin{EntryWithPhonetic}{男女}{nan2nv3}{7,3}{⽥,⼥}[HSK 4]
  \definition{s.}{homens e mulheres; masculino e feminino}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{男朋友}{nan2peng2you5}{7,8,4}{⽥,⽉,⼜}[HSK 1]
  \definition[个,位,名]{s.}{namorado}
  \synonymref{女朋友}{nv3peng2you5}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{男人}{nan2ren2}{7,2}{⽥,⼈}[HSK 1]
...
\begin{EntryWithPhonetic}{男人}{nan2ren5}{7,2}{⽥,⼈}
...
\begin{EntryWithPhonetic}{男生}{nan2sheng1}{7,5}{⽥,⽣}[HSK 1]
...
\begin{EntryWithPhonetic}{男士}{nan2shi4}{7,3}{⽥,⼠}[HSK 4]
  \definition{s.}{cavalheiro; \emph{gentleman}}
  \synonymref{绅士}{shen1shi4}
  \synonymref{先生}{xian1sheng5}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{男性}{nan2xing4}{7,8}{⽥,⼼}[HSK 5]
...
\begin{EntryWithPhonetic}{南北}{nan2bei3}{9,5}{⼗,⼔}[HSK 5]
  \definition{s.}{(território) norte e sul | (distância) de norte a sul}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{南边}{nan2bian5}{9,5}{⼗,⾡}[HSK 1]
...
\begin{EntryWithPhonetic}{南部}{nan2bu4}{9,10}{⼗,⾢}[HSK 3]
...
\begin{EntryWithPhonetic}{南方}{nan2fang1}{9,4}{⼗,⽅}[HSK 2]
...
\begin{EntryWithPhonetic}{难得一见}{nan2de2yi2jian4}{10,11,1,4}{⾫,⼻,⼀,⾒}[HSK 7-9]
...
\begin{EntryWithPhonetic}{难度}{nan2du4}{10,9}{⾫,⼴}[HSK 3]
...
\begin{EntryWithPhonetic}{难看}{nan2kan4}{10,9}{⾫,⽬}[HSK 2]
...
\begin{EntryWithPhonetic}{难免}{nan2mian3}{10,7}{⾫,⼉}[HSK 4]
...
\begin{EntryWithPhonetic}{难题}{nan2ti2}{10,15}{⾫,⾴}[HSK 2]
...
\begin{EntryWithPhonetic}{难听}{nan2ting1}{10,7}{⾫,⼝}[HSK 2]
...
\begin{EntryWithPhonetic}{难忘}{nan2wang4}{10,7}{⾫,⼼}[HSK 6]
...
\begin{EntryWithPhonetic}{难为}{nan2wei5}{10,4}{⾫,⼂}
...
\begin{EntryWithPhonetic}{难以}{nan2yi3}{10,4}{⾫,⼈}[HSK 5]
...
\begin{EntryWithPhonetic}{恼怒}{nao3nu4}{9,9}{⼼,⼼}
...
\begin{EntryWithPhonetic}{脑子}{nao3zi5}{10,3}{⾁,⼦}[HSK 5]
...
\begin{EntryWithPhonetic}{闹别扭}{nao4//bie4niu5}{8,7,7}{⾾,⼑,⼿}[HSK 5]
...
\begin{EntryWithPhonetic}{闹钟}{nao4zhong1}{8,9}{⾾,⾦}[HSK 4]
  \definition[个,台,只,款]{s.}{despertador; relógios capazes de tocar alarmes em horários predeterminados}
\end{EntryWithPhonetic}

%%%%%%%%%% 哪 %%%%%%%%%%
\subsection*{哪}\addcontentsline{loh}{figure}{哪 \dpy{ne2}}

\begin{EntryWithPhonetic}{哪}{ne2}{9}{⼝}
...
\begin{EntryWithPhonetic}{哪吒}{ne2zha1}{9,6}{⼝,⼝}
...
\begin{EntryWithPhonetic}{内地}{nei4di4}{4,6}{⼌,⼟}[HSK 6]
...
\begin{EntryWithPhonetic}{内外}{nei4wai4}{4,5}{⼌,⼣}[HSK 6]
...
\begin{EntryWithPhonetic}{内心}{nei4xin1}{4,4}{⼌,⼼}[HSK 3]
...
\begin{EntryWithPhonetic}{内衣}{nei4yi1}{4,6}{⼌,⾐}[HSK 6]
...
\begin{EntryWithPhonetic}{内资}{nei4zi1}{4,10}{⼌,⾙}
...
\begin{EntryWithPhonetic}{能不能}{neng2 bu4neng2}{10,4,10}{⾁,⼀,⾁}[HSK 3]
  \definition{adv.}{pode ou não pode\dots?}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{能否}{neng2fou3}{10,7}{⾁,⼝}[HSK 6]
...
\begin{EntryWithPhonetic}{能够}{neng2gou4}{10,11}{⾁,⼣}[HSK 2]
...
\begin{EntryWithPhonetic}{年齿}{nian2chi3}{6,8}{⼲,⿒}
...
\begin{EntryWithPhonetic}{年初}{nian2chu1}{6,7}{⼲,⾐}[HSK 3]
...
\begin{EntryWithPhonetic}{年底}{nian2di3}{6,8}{⼲,⼴}[HSK 3]
...
\begin{EntryWithPhonetic}{年轻人}{nian2qing1 ren2}{6,9,2}{⼲,⾞,⼈}[HSK 5]
...
\begin{EntryWithPhonetic}{宁静}{ning2jing4}{5,14}{⼧,⾭}[HSK 4]
...
\begin{EntryWithPhonetic}{宁夏}{ning2xia4}{5,10}{⼧,⼢}
  \definition*{s.}{Região Autônoma Hui de Ningxia, abreviada como Ning (宁), capital Yinchuan (银川)}
  \seealsoref{宁}{ning2}
  \seealsoref{银川}{yin2chuan1}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{宁夏回族}{ning2xia4hui2zu2}{5,10,6,11}{⼧,⼢,⼞,⽅}
  \definition*{s.}{Região Autônoma de Ningxia Hui}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{宁夏回族自治区}{ning2xia4hui2zu2zi4zhi4qu1}{5,10,6,11,6,8,4}{⼧,⼢,⼞,⽅,⾃,⽔,⼖}
  \definition*{s.}{Região Autônoma de Ningxia Hui}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{牛郎织女}{niu2lang2zhi1nv3}{4,8,8,3}{⽜,⾢,⽷,⼥}
...
\begin{EntryWithPhonetic}{牛人}{niu2 ren2}{4,2}{⽜,⼈}
...
\begin{EntryWithPhonetic}{牛肉罐头}{niu2rou4 guan4tou2}{4,6,23,5}{⽜,⾁,⽸,⼤}[HSK 5]
...
\begin{EntryWithPhonetic}{农产品}{nong2chan3pin3}{6,6,9}{⼍,⼇,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{诺贝尔奖}{nuo4bei4'er3jiang3}{10,4,5,9}{⾔,⾙,⼩,⼤}
...
\begin{EntryWithPhonetic}{女孩儿}{nv3hai2r5}{3,9,2}{⼥,⼦,⼉}[HSK 1]
  \definition{s.}{garota; menina; atualmente também se refere a mulher adolescente | filha}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{女朋友}{nv3peng2you5}{3,8,4}{⼥,⽉,⼜}[HSK 1]
...
\begin{EntryWithPhonetic}{女人}{nv3ren2}{3,2}{⼥,⼈}[HSK 1]
  \definition[个]{s.}{mulher adulta}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{女生}{nv3sheng1}{3,5}{⼥,⽣}[HSK 1]
...
\begin{EntryWithPhonetic}{女性}{nv3xing4}{3,8}{⼥,⼼}[HSK 5]
...
\begin{EntryWithPhonetic}{女子}{nv3zi3}{3,3}{⼥,⼦}[HSK 3]
