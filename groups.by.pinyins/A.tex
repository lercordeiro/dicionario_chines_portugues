...
%%%%%%%%%% 呆 %%%%%%%%%%
\subsection*{呆}\addcontentsline{loh}{figure}{呆 \dpy{ai2}}

\begin{EntryWithPhonetic}{呆}{ai2}{7}{⼝}
...
%%%%%%%%%% 挨 %%%%%%%%%%
\subsection*{挨}\addcontentsline{loh}{figure}{挨 \dpy{ai2}}
...
\begin{EntryWithPhonetic}{挨打}{ai2da3}{10,5}{⼿,⼿}[HSK 6]
...
\begin{EntryWithPhonetic}{爱好者}{ai4hao4 zhe3}{10,6,8}{⽖,⼥,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{安全气囊}{an1quan2 qi4nang2}{6,6,4,22}{⼧,⼊,⽓,⾐}[HSK 5]
...
\begin{EntryWithPhonetic}{暗暗}{an4'an4}{13,13}{⽇,⽇}
...
%%%%%%%%%% 懊 %%%%%%%%%%
\subsection*{懊}\addcontentsline{loh}{figure}{懊 \dpy{ao4}}

\begin{EntryWithPhonetic}{懊}{ao4}{15}{⼼}
  \definition{adj.}{arrependido; pesaroso | irritado; aborrecido}
  \definition{v.}{arrepender"-se; lamentar"-se}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{懊悔}{ao4hui3}{15,10}{⼼,⼼}
