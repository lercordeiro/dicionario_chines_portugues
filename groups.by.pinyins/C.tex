...
%%%%%%%%%% 拆 %%%%%%%%%%
\subsection*{拆}\addcontentsline{loh}{figure}{拆 \dpy{ca1}}

\begin{EntryWithPhonetic}{拆}{ca1}{8}{⼿}
...
\begin{EntryWithPhonetic}{猜}{cai1}{11}{⽝}[HSK 5]
  ...
  \synonymref{蒙}{meng1}
  \synonymref{疑}{yi2}
  \seealsoref{猜测}{cai1ce4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{猜测}{cai1ce4}{11,9}{⽝,⽔}[HSK 5]
...
\begin{EntryWithPhonetic}{猜疑}{cai1yi2}{11,14}{⽝,⽦}
...
\begin{EntryWithPhonetic}{才干}{cai2gan4}{3,3}{⼿,⼲}
  \definition{s.}{habilidade; competência; capacidade; capacidade de lidar com tarefas; forte capacidade de raciocínio e resolução de problemas, com ênfase em habilidades práticas}
  \synonymref{本领}{ben3ling3}
  \synonymref{本事}{ben3shi4}
  \synonymref{才华}{cai2hua2}
  \synonymref{技能}{ji4neng2}
  \synonymref{能力}{neng2li4}
  \seealsoref{才能}{cai2neng2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{才能}{cai2neng2}{3,10}{⼿,⾁}[HSK 3]
  \definition[间]{s.}{talento; habilidade; dom; capacidade; inteligência e habilidade}
  \synonymref{本领}{ben3ling3}
  \synonymref{本事}{ben3shi4}
  \synonymref{才华}{cai2hua2}
  \synonymref{才略}{cai2lve4}
  \synonymref{能力}{neng2li4}
  \seealsoref{才干}{cai2gan4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{采用}{cai3yong4}{8,5}{⾤,⽤}[HSK 3]
...
\begin{EntryWithPhonetic}{彩色}{cai3se4}{11,6}{⼺,⾊}[HSK 3]
  \definition[个,种]{s.}{multicolorido; cor; várias cores}
  \synonymref{亮丽}{liang2li2}
  \antonymref{黑白}{hei1bai2}
  \antonymref{黑色}{hei1se4}
  \seealsoref{色彩}{se4cai3}
  \seealsoref{颜色}{yan2se4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{踩}{cai3}{15}{⾜}[HSK 6]
  \definition{v.}{pisar; pisotear | pisar; depreciar ou estragar | rastrear; antigamente significava rastrear (bandidos) ou investigar (casos)}
  \synonymref{贬}{bian3}
  \synonymref{踏}{ta4}
  \synonymref{抑}{yi4}
  \antonymref{吹}{chui1}
...
\begin{EntryWithPhonetic}{菜}{cai4}{11}{⾋}[HSK 1]
  ...
  \definition[种,棵,道,个,盘]{s.}{legumes; verduras; plantas que podem ser usadas como alimentos complementares | óleo de canola | prato; item ou prato do cardápio (seja de carne ou de vegetais)}
  \synonymref{差}{cha4}
  \synonymref{蔬}{shu1}
  \antonymref{好}{hao3}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{菜刀}{cai4dao1}{11,2}{⾋,⼑}
  \definition[把,个]{s.}{faca de cozinha; cutelo | faca de legumes}
\end{EntryWithPhonetic}
...
%%%%%%%%%% 蔡 %%%%%%%%%%
\subsection*{蔡}\addcontentsline{loh}{figure}{蔡 \dpy{cai4}}

\begin{EntryWithPhonetic}{蔡}{cai4}{14}{⾋}
  \definition*{s.}{Cai, um estado da Dinastia Zhou | Sobrenome: Cai}
  \definition{s.}{tartaruga grande}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{蔡伦}{cai4 lun2}{14,6}{⾋,⼈}
...
\begin{EntryWithPhonetic}{参观者}{can1guan1 zhe3}{8,6,8}{⼛,⾒,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{参赛}{can1sai4}{8,14}{⼛,⾙}[HSK 6]
...
\begin{EntryWithPhonetic}{餐馆}{can1guan3}{16,11}{⾷,⾷}[HSK 5]
...
\begin{EntryWithPhonetic}{餐厅}{can1ting1}{16,4}{⾷,⼚}[HSK 5]
  ...
  \definition[间,家,个]{s.}{restaurante; refeitório em um hotel | cantina, refeitório}
  \synonymref{餐馆}{can1guan3}
  \synonymref{饭店}{fan4dian4}
  \synonymref{饭馆}{fan4guan3}
  \synonymref{食堂}{shi2tang2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{餐饮}{can1yin3}{16,7}{⾷,⾷}[HSK 5]
...
\begin{EntryWithPhonetic}{残疾人}{can2ji2ren2}{9,10,2}{⽍,⽧,⼈}[HSK 6]
...
\begin{EntryWithPhonetic}{残疾}{can2ji5}{9,10}{⽍,⽧}[HSK 6]
...
\begin{EntryWithPhonetic}{沧海桑田}{cang1hai3-sang1tian2}{7,10,10,5}{⽔,⽔,⽊,⽥}
...
\begin{EntryWithPhonetic}{沧州}{cang1zhou1}{7,6}{⽔,⼮}
...
\begin{EntryWithPhonetic}{藏身}{cang2//shen1}{17,7}{⾋,⾝}[HSK 7-9]
  \definition{v.+compl.}{esconder"-se; esconder | abrigar"-se; estabelecer"-se}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{操练}{cao1lian4}{16,8}{⼿,⽷}
  \definition{v.}{treinar (militar ou esportivo); submeter"-se a treinamento militar e físico para dominar os movimentos e as habilidades}
  \synonymref{练习}{lian4xi2}
  \synonymref{实习}{shi2xi2}
  \synonymref{演练}{yan3lian4}
  \synonymref{演习}{yan3xi2}
  \seealsoref{训练}{xun4lian4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{操纵}{cao1zong4}{16,7}{⼿,⽷}[HSK 6]
  ...
  \seealsoref{操作}{cao1zuo4}
  \seealsoref{控制}{kong4zhi4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{操作}{cao1zuo4}{16,7}{⼿,⼈}[HSK 4]
  ...
  \antonymref{忽视}{hu1shi4}
  \seealsoref{操纵}{cao1zong4}
\end{EntryWithPhonetic}

%%%%%%%%%% 曹 %%%%%%%%%%
\subsection*{曹}\addcontentsline{loh}{figure}{曹 \dpy{cao2}}

\begin{EntryWithPhonetic}{曹}{cao2}{11}{⽈}
...
\begin{EntryWithPhonetic}{曹雪芹}{cao2 xue3qin2}{11,11,7}{⽈,⾬,⾋}
...
\begin{EntryWithPhonetic}{草地}{cao3di4}{9,6}{⾋,⼟}[HSK 2]
...
\begin{EntryWithPhonetic}{草原}{cao3yuan2}{9,10}{⾋,⼚}[HSK 5]
...
\begin{EntryWithPhonetic}{测定}{ce4ding4}{9,8}{⽔,⼧}[HSK 6]
...
\begin{EntryWithPhonetic}{测试}{ce4shi4}{9,8}{⽔,⾔}[HSK 4]
...
\begin{EntryWithPhonetic}{测验}{ce4//yan4}{9,10}{⽔,⾺}[HSK 7-9]
...
\begin{EntryWithPhonetic}{策略}{ce4lve4}{12,11}{⽵,⽥}[HSK 6]
  ...
  \synonymref{战术}{zhan4shu4}
  \synonymref{政策}{zheng4ce4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{层面}{ceng2mian4}{7,9}{⼫,⾯}[HSK 6]
...
\begin{EntryWithPhonetic}{叉}{cha1}{3}{⼜}[HSK 5]
  \definition[把,个]{s.}{garfo; forquilha | símbolo de cruz, ``×''}
...
\begin{EntryWithPhonetic}{差（一）点儿}{cha1(yi4)dian3r5}{9,1,9,2}{⼯,⼀,⽕,⼉}[HSK 5]
...
\begin{EntryWithPhonetic}{差异}{cha1yi4}{9,6}{⼯,⼶}[HSK 6]
...
\begin{EntryWithPhonetic}{插动}{cha1dong4}{12,6}{⼿,⼒}
  \definition{v.}{inserir | intervir; interferir | envolver"-se; tomar uma atitude (às vezes implicando interferência física) | em certos contextos é usado como um eufenismo para movimentos sexuais (estocadas ou movimentos de vai e vem)}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{插话}{cha1//hua4}{12,8}{⼿,⾔}
  \definition[段]{s.}{observação interposta | digressão; episódio | interrupção}
  \definition{v.+compl.}{intervir fazendo um comentário, etc.; dar sua opinião; interromper}
  \synonymref{插嘴}{cha1//zui3}
  \synonymref{打岔}{da3//cha4}
  \seealsoref{播言}{bo1 yan2}
  \seealsoref{插言}{cha1//yan2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{插言}{cha1//yan2}{12,7}{⼿,⾔}
  \definition{v.+compl.}{intervir fazendo um comentário, etc.; dar sua opinião; interromper}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{查出}{cha2chu1}{9,5}{⽊,⼐}[HSK 6]
...
\begin{EntryWithPhonetic}{查看}{cha2kan4}{9,9}{⽊,⽬}[HSK 6]
...
\begin{EntryWithPhonetic}{查询}{cha2xun2}{9,8}{⽊,⾔}[HSK 5]
  \definition{v.}{indagar; inquirir; perguntar sobre}
  \synonymref{追问}{zhui1wen4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{查阅}{cha2yue4}{9,10}{⽊,⾨}
...
\begin{EntryWithPhonetic}{茶叶}{cha2ye4}{9,5}{⾋,⼝}[HSK 4]
...
\begin{EntryWithPhonetic}{叉}{cha4}{3}{⼜}
  \definition[把,个]{s.}{ramo; geralmente se refere à parte de um objeto que se ramifica do corpo principal}
  \seeref{cha1}
  \seeref{cha2}
  \seeref{cha3}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{拆除}{chai1chu2}{8,9}{⼿,⾩}[HSK 5]
...
\begin{EntryWithPhonetic}{拆迁}{chai1qian1}{8,6}{⼿,⾡}[HSK 6]
...
\begin{EntryWithPhonetic}{差}{chai4}{9}{⼯}
...
%%%%%%%%%% 瘥 %%%%%%%%%%
\subsection*{瘥}\addcontentsline{loh}{figure}{瘥 \dpy{chai4}}

\begin{EntryWithPhonetic}{瘥}{chai4}{14}{⽧}
...
\begin{EntryWithPhonetic}{产量}{chan3liang4}{6,12}{⼇,⾥}[HSK 6]
...
\begin{EntryWithPhonetic}{铲车}{chan3che1}{11,4}{⾦,⾞}
  \definition[台]{s.}{empilhadeira; carregadeira frontal (veículo)}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{阐明}{chan3ming2}{11,8}{⾨,⽇}
  \definition{v.}{esclarecer; explicar (o raciocínio)}
...
\begin{EntryWithPhonetic}{昌盛}{chang1sheng4}{8,11}{⽇,⽫}[HSK 6]
...
\begin{EntryWithPhonetic}{长处}{chang2chu4}{4,5}{⾧,⼡}[HSK 3]
...
\begin{EntryWithPhonetic}{长度}{chang2du4}{4,9}{⾧,⼴}[HSK 5]
...
\begin{EntryWithPhonetic}{长短}{chang2duan3}{4,12}{⾧,⽮}[HSK 6]
...
\begin{EntryWithPhonetic}{长假}{chang2jia4}{4,11}{⾧,⼈}[HSK 6]
...
\begin{EntryWithPhonetic}{长江}{chang2jiang1}{4,6}{⾧,⽔}
...
\begin{EntryWithPhonetic}{长久}{chang2jiu3}{4,3}{⾧,⼃}[HSK 6]
...
\begin{EntryWithPhonetic}{长跑}{chang2pao3}{4,12}{⾧,⾜}[HSK 6]
  \definition{s.}{corrida de longa distância}
  \antonymref{短跑}{duan3pao3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{长篇小说}{chang2pian1 xiao3shuo1}{4,15,3,9}{⾧,⽵,⼩,⾔}[HSK 5]
  \definition[篇,部,本]{s.}{romance longo, com um enredo complexo e um vasto elenco de personagens}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{长期}{chang2qi1}{4,12}{⾧,⽉}[HSK 3]
...
\begin{EntryWithPhonetic}{长期以来}{chang2qi1yi3lai2}{4,12,4,7}{⾧,⽉,⼈,⽊}[HSK 7-9]
  \definition{adv.}{por muito tempo passado | desde muito tempo atrás}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{长寿}{chang2shou4}{4,7}{⾧,⼨}[HSK 5]
...
\begin{EntryWithPhonetic}{长途电话}{chang2tu2 dian4hua4}{4,10,5,8}{⾧,⾡,⽥,⾔}[HSK 5]
...
\begin{EntryWithPhonetic}{长远}{chang2yuan3}{4,7}{⾧,⾡}[HSK 6]
...
\begin{EntryWithPhonetic}{常常}{chang2chang2}{11,11}{⼱,⼱}[HSK 1]
  ...
  \seealsoref{常}{chang2}
  \seealsoref{往往}{wang3wang3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{常规}{chang2gui1}{11,8}{⼱,⾒}[HSK 6]
  \definition[个,种]{s.}{convenção; prática comum; rotina | (medicina) rotina | regra; sulco}
  \synonymref{惯例}{guan4li4}
  \synonymref{通常}{tong1chang2}
  \synonymref{一般}{yi4ban1}
  \antonymref{例外}{li4wai4}
  \antonymref{特例}{te4li4}
  \antonymref{异常}{yi4chang2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{常见}{chang2jian4}{11,4}{⼱,⾒}[HSK 2]
  ...
  \antonymref{少见}{shao3jian4}
  \antonymref{少有}{shao3you3}
  \antonymref{特别}{te4bie2}
  \antonymref{稀奇}{xi1qi2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{常问问题}{chang2wen4 wen4ti2}{11,6,6,15}{⼱,⾨,⾨,⾴}
  \definition{s.}{FAQ; perguntas frequentes}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{常用}{chang2yong4}{11,5}{⼱,⽤}[HSK 2]
...
\begin{EntryWithPhonetic}{厂商}{chang3shang1}{2,11}{⼚,⼝}[HSK 6]
...
\begin{EntryWithPhonetic}{场地}{chang3di4}{6,6}{⼟,⼟}[HSK 6]
...
\begin{EntryWithPhonetic}{场馆}{chang3guan3}{6,11}{⼟,⾷}[HSK 6]
...
\begin{EntryWithPhonetic}{场景}{chang3jing3}{6,12}{⼟,⽇}[HSK 6]
...
\begin{EntryWithPhonetic}{畅谈}{chang4//tan2}{8,10}{⽥,⾔}[HSK 7-9]
...
\begin{EntryWithPhonetic}{唱歌}{chang4//ge1}{11,14}{⼝,⽋}[HSK 1]
  ...
  \seealsoref{歌唱}{ge1chang4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{唱片}{chang4pian4}{11,4}{⼝,⽚}[HSK 4]
  ...
  \synonymref{音乐光碟}{yin1yue4 guang1die2}
\end{EntryWithPhonetic}

%%%%%%%%%% 吵 %%%%%%%%%%
\subsection*{吵}\addcontentsline{loh}{figure}{吵 \dpy{chao1}}

\begin{EntryWithPhonetic}{吵}{chao1}{7}{⼝}
...
\begin{EntryWithPhonetic}{抄表}{chao1biao3}{7,8}{⼿,⾐}
...
\begin{EntryWithPhonetic}{抄写}{chao1xie3}{7,5}{⼿,⼍}[HSK 4]
...
\begin{EntryWithPhonetic}{超出}{chao1chu1}{12,5}{⾛,⼐}[HSK 6]
...
\begin{EntryWithPhonetic}{超级市场}{chao1ji2shi4chang3}{12,6,5,6}{⾛,⽷,⼱,⼟}
...
\begin{EntryWithPhonetic}{超市人口}{chao1shi4 ren2kou3}{12,5,2,3}{⾛,⼱,⼈,⼝}[HSK 5]
  \definition{s.}{número de pessoas em um supermercado}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{潮}{chao2}{15}{⽔}[HSK 4]
  ...
  \definition{s.}{maré; água da maré | surto; corrente; maré; mudanças sociais em grande escala ou altos e baixos de um movimento (social)}
  \definition{s.}{Chaozhou, uma cidade na província de Guangdong}
  \synonymref{劣}{lie4}
  \synonymref{湿}{shi1}
  \antonymref{干}{gan1}
  \seealsoref{潮湿}{chao2shi1}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{潮湿}{chao2shi1}{15,12}{⽔,⽔}[HSK 4]
  ...
  \synonymref{湿润}{shi1run4}
  \synonymref{滋润}{zi1run4}
...
\begin{EntryWithPhonetic}{吵闹}{chao3nao4}{7,8}{⼝,⾾}
...
\begin{EntryWithPhonetic}{吵嘴打架}{chao3zui3 da3jia4}{7,16,5,9}{⼝,⼝,⼿,⽊}
...
\begin{EntryWithPhonetic}{炒作}{chao3zuo4}{8,7}{⽕,⼈}[HSK 6]
...
\begin{EntryWithPhonetic}{车号}{che1hao4}{4,5}{⾞,⼝}[HSK 6]
...
\begin{EntryWithPhonetic}{车辆}{che1liang4}{4,11}{⾞,⾞}[HSK 2]
...
\begin{EntryWithPhonetic}{车展}{che1zhan3}{4,10}{⾞,⼫}[HSK 6]
  \definition{s.}{salão do automóvel; exposição de carros}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{车站}{che1zhan4}{4,10}{⾞,⽴}[HSK 1]
...
\begin{EntryWithPhonetic}{车主}{che1zhu3}{4,5}{⾞,⼂}[HSK 5]
...
\begin{EntryWithPhonetic}{撤销}{che4xiao1}{15,12}{⼿,⾦}[HSK 6]
  ...
  \synonymref{推翻}{tui1//fan1}
  \antonymref{保留}{bao3liu2}
  \antonymref{部署}{bu4shu3}
  \antonymref{成立}{cheng2li4}
  \antonymref{建立}{jian4li4}
  \antonymref{设立}{she4li4}
  \antonymref{设置}{she4zhi4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{沉静}{chen2jing4}{7,14}{⽔,⾭}
...
\begin{EntryWithPhonetic}{衬衣}{chen4yi1}{8,6}{⾐,⾐}[HSK 3]
...
\begin{EntryWithPhonetic}{称为}{cheng1wei2}{10,4}{⽲,⼂}[HSK 3]
...
\begin{EntryWithPhonetic}{成分}{cheng2fen5}{6,4}{⼽,⼑}[HSK 6]
...
\begin{EntryWithPhonetic}{成功}{cheng2//gong1}{6,5}{⼽,⼒}[HSK 3]
...
\begin{EntryWithPhonetic}{成功者}{cheng2gong1 zhe3}{6,5,8}{⼽,⼒,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{成婚}{cheng2//hun1}{6,11}{⼽,⼥}
...
\begin{EntryWithPhonetic}{成品}{cheng2pin3}{6,9}{⼽,⼝}[HSK 6]
...
\begin{EntryWithPhonetic}{成问题}{cheng2//wen4ti2}{6,6,15}{⼽,⾨,⾴}[HSK 7-9]
...
\begin{EntryWithPhonetic}{成心}{cheng2xin1}{6,4}{⼽,⼼}
...
\begin{EntryWithPhonetic}{诚信}{cheng2xin4}{8,9}{⾔,⼈}[HSK 4]
...
\begin{EntryWithPhonetic}{城区}{cheng2qu1}{9,4}{⼟,⼖}[HSK 6]
...
\begin{EntryWithPhonetic}{乘车}{cheng2che1}{10,4}{⽲,⾞}[HSK 5]
...
\begin{EntryWithPhonetic}{乘客}{cheng2ke4}{10,9}{⽲,⼧}[HSK 5]
...
\begin{EntryWithPhonetic}{程控}{cheng2kong4}{12,11}{⽲,⼿}
  \definition{s.}{controle por programa | programado | sob controle automático}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{程序库}{cheng2xu4ku4}{12,7,7}{⽲,⼴,⼴}
  \definition{s.}{Computação: biblioteca de funções e procedimentos para programas de computador}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{程序设计}{cheng2xu4she4ji4}{12,7,6,4}{⽲,⼴,⾔,⾔}
  \definition{s.}{Computação: programação}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{澄清}{cheng2qing1}{15,11}{⽔,⽔}[HSK 7-9]
  \definition{adj.}{claro; transparente}
  \definition{v.}{esclarecer; deixar claro; entender | purificar; limpar; esclarecer a turbidez, esclarecer uma situação caótica}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{橙色}{cheng2se4}{16,6}{⽊,⾊}
  \definition{s.}{cor de laranja}
  \synonymref{黄色}{huang2se4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{吃屎}{chi1shi3}{6,9}{⼝,⼫}
...
\begin{EntryWithPhonetic}{池子}{chi2zi5}{6,3}{⽔,⼦}[HSK 5]
...
\begin{EntryWithPhonetic}{持有}{chi2you3}{9,6}{⼿,⽉}[HSK 6]
...
\begin{EntryWithPhonetic}{尺寸}{chi3cun4}{4,3}{⼫,⼨}[HSK 4]
...
\begin{EntryWithPhonetic}{冲}{chong1}{6}{⼎}[HSK 4]
...
\begin{EntryWithPhonetic}{冲锋}{chong1//feng1}{6,12}{⼎,⾦}
...
\begin{EntryWithPhonetic}{冲浪}{chong1//lang4}{6,10}{⼎,⽔}[HSK 7-9]
...
\begin{EntryWithPhonetic}{冲破}{chong1po4}{6,10}{⼎,⽯}
...
%%%%%%%%%% 涌 %%%%%%%%%%
\subsection*{涌}\addcontentsline{loh}{figure}{涌 \dpy{chong1}}

\begin{EntryWithPhonetic}{涌}{chong1}{10}{⽔}
...
\begin{EntryWithPhonetic}{虫子}{chong2zi5}{6,3}{⾍,⼦}[HSK 4]
  \definition[条,只,种]{s.}{percevejo; besouro; inseto; verme; criaturas semelhantes a insetos}
  \synonymref{昆虫}{kun1chong2}
\end{EntryWithPhonetic}

%%%%%%%%%% 种 %%%%%%%%%%
\subsection*{种}\addcontentsline{loh}{figure}{种 \dpy{chong2}}

\begin{EntryWithPhonetic}{种}{chong2}{9}{⽲}
...
\begin{EntryWithPhonetic}{重}{chong2}{9}{⾥}[HSK 3]
  \definition*{s.}{Sobrenome: Chong}
...
\begin{EntryWithPhonetic}{重建}{chong2jian4}{9,8}{⾥,⼵}[HSK 6]
...
\begin{EntryWithPhonetic}{重组}{chong2zu3}{9,8}{⾥,⽷}[HSK 6]
...
\begin{EntryWithPhonetic}{崇敬}{chong2jing4}{11,12}{⼭,⽁}
  \definition{v.}{estimar; respeitar; reverenciar}
...
\begin{EntryWithPhonetic}{宠物医院}{chong3wu4 yi1yuan4}{8,8,7,9}{⼧,⽜,⼖,⾩}[HSK 5]
...
\begin{EntryWithPhonetic}{冲}{chong4}{6}{⼎}[HSK 6]
...
\begin{EntryWithPhonetic}{抽奖}{chou1jiang3}{8,9}{⼿,⼤}[HSK 4]
...
\begin{EntryWithPhonetic}{筹备}{chou2//bei4}{13,8}{⽵,⼡}[HSK 7-9]
  \definition{v.+compl.}{preparar; organizar; planejar}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{筹划}{chou2//hua4}{13,6}{⽵,⼑}[HSK 7-9]
  \definition{v.+compl.}{planejar e preparar; encontrar um caminho; fazer um plano}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{酬劳}{chou2lao2}{13,7}{⾣,⼒}
  \definition{s.}{reembolso; recompensa; retribuição}
  \definition{v.}{retribuir; recompensar; compensar | agradecer a alguém com um presente | remunerar}
...
\begin{EntryWithPhonetic}{酬酢}{chou2zuo4}{13,12}{⾣,⾣}
  \definition{v.}{Literário: trocar brindes; brindar uns aos outros | Literário: ter relações sociais com; tratar com cortesia; conviver amigavelmente; geralmente se refere a compromissos sociais}
...
\begin{EntryWithPhonetic}{出厂}{chu1chang3}{5,2}{⼐,⼚}[HSK 7-9]
  \definition{v.}{(produtos) ser despachado da fábrica | sair da fábrica (produtos acabados)}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{出场}{chu1chang3}{5,6}{⼐,⼟}[HSK 6]
...
\begin{EntryWithPhonetic}{出动}{chu1dong4}{5,6}{⼐,⼒}[HSK 6]
...
\begin{EntryWithPhonetic}{出访}{chu1fang3}{5,6}{⼐,⾔}[HSK 6]
...
\begin{EntryWithPhonetic}{出家}{chu1jia1}{5,10}{⼐,⼧}
...
\begin{EntryWithPhonetic}{出来}{chu1lai2}{5,7}{⼐,⽊}[HSK 1]
...
\begin{EntryWithPhonetic}{出毛病}{chu1//mao2bing4}{5,4,10}{⼐,⽑,⽧}[HSK 7-9]
...
\begin{EntryWithPhonetic}{出去}{chu1qu4}{5,5}{⼐,⼛}[HSK 1]
...
\begin{EntryWithPhonetic}{出入}{chu1ru4}{5,2}{⼐,⼊}[HSK 6]
...
\begin{EntryWithPhonetic}{出山}{chu1shan1}{5,3}{⼐,⼭}[HSK 7-9]
...
\begin{EntryWithPhonetic}{出生地}{chu1sheng1 di4}{5,5,6}{⼐,⽣,⼟}[HSK 5]
...
\begin{EntryWithPhonetic}{出售}{chu1shou4}{5,11}{⼐,⼝}[HSK 4]
...
\begin{EntryWithPhonetic}{出台}{chu1tai2}{5,5}{⼐,⼝}[HSK 6]
...
\begin{EntryWithPhonetic}{出行}{chu1xing2}{5,6}{⼐,⾏}[HSK 6]
...
\begin{EntryWithPhonetic}{出游}{chu1//you2}{5,12}{⼐,⽔}[HSK 7-9]
...
\begin{EntryWithPhonetic}{出站}{chu1zhan4}{5,10}{⼐,⽴}
...
\begin{EntryWithPhonetic}{出租}{chu1zu1}{5,10}{⼐,⽲}[HSK 2]
...
\begin{EntryWithPhonetic}{出租司机}{chu1zu1 si1ji1}{5,10,5,6}{⼐,⽲,⼝,⽊}
...
\begin{EntryWithPhonetic}{初等}{chu1deng3}{7,12}{⾐,⽵}[HSK 6]
...
\begin{EntryWithPhonetic}{初期}{chu1qi1}{7,12}{⾐,⽉}[HSK 5]
...
\begin{EntryWithPhonetic}{初心}{chu1 xin1}{7,4}{⾐,⼼}
...
\begin{EntryWithPhonetic}{初中}{chu1zhong1}{7,4}{⾐,⼁}[HSK 3]
...
\begin{EntryWithPhonetic}{厨师}{chu2shi1}{12,6}{⼚,⼱}[HSK 6]
...
\begin{EntryWithPhonetic}{处}{chu3}{5}{⼡}
  \definition*{s.}{Sobrenome: Chu}
...
\begin{EntryWithPhonetic}{处罚}{chu3fa2}{5,9}{⼡,⽹}[HSK 5]
...
\begin{EntryWithPhonetic}{处方}{chu3//fang1}{5,4}{⼡,⽅}[HSK 7-9]
...
\begin{EntryWithPhonetic}{处于}{chu3yu2}{5,3}{⼡,⼆}[HSK 4]
...
\begin{EntryWithPhonetic}{储存}{chu3cun2}{12,6}{⼈,⼦}[HSK 6]
  ...
  \synonymref{贮藏}{zhu4cang2}
  \antonymref{动用}{dong4yong4}
  \antonymref{花费}{hua1fei5}
  \antonymref{消耗}{xiao1hao4}
  \seealsoref{储备}{chu3bei4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{处}{chu4}{5}{⼡}[HSK 4]
...
\begin{EntryWithPhonetic}{处处}{chu4chu4}{5,5}{⼡,⼡}[HSK 6]
...
\begin{EntryWithPhonetic}{处长}{chu4zhang3}{5,4}{⼡,⾧}[HSK 6]
...
\begin{EntryWithPhonetic}{穿上}{chuan1shang5}{9,3}{⽳,⼀}[HSK 4]
...
\begin{EntryWithPhonetic}{穿越}{chuan1//yue4}{9,12}{⽳,⾛}[HSK 7-9]
...
\begin{EntryWithPhonetic}{传出}{chuan2chu1}{6,5}{⼈,⼐}[HSK 6]
...
\begin{EntryWithPhonetic}{传递}{chuan2di4}{6,10}{⼈,⾡}[HSK 5]
...
\begin{EntryWithPhonetic}{传来}{chuan2lai2}{6,7}{⼈,⽊}[HSK 3]
...
\begin{EntryWithPhonetic}{传媒}{chuan2mei2}{6,12}{⼈,⼥}[HSK 6]
...
\begin{EntryWithPhonetic}{传输}{chuan2shu1}{6,13}{⼈,⾞}[HSK 6]
...
\begin{EntryWithPhonetic}{传送}{chuan2song4}{6,9}{⼈,⾡}
...
\begin{EntryWithPhonetic}{传言}{chuan2yan2}{6,7}{⼈,⾔}[HSK 6]
...
\begin{EntryWithPhonetic}{窗户}{chuang1hu5}{12,4}{⽳,⼾}[HSK 4]
  ...
  \synonymref{窗口}{chuang1kou3}
  \synonymref{窗子}{chuang1zi5}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{窗口}{chuang1kou3}{12,3}{⽳,⼝}[HSK 6]
  \definition[个,号]{s.}{janela; em frente à janela; perto da janela | janela; postigo; refere"-se a uma abertura especial em forma de janela | janela; meio; intermediário; peça de exibição; campo de testes; lugar com muitas interações com o mundo exterior e através do qual o entendimento mútuo é alcançado |  janela; lugar que pode refletir ou exibir a totalidade ou parte de algo |  caixa de diálogo; uma caixa de operação quadrada para aplicativos ou arquivos que aparece na tela do computador}
  \synonymref{窗户}{chuang1hu5}
  \synonymref{代表}{dai4biao3}
...
\begin{EntryWithPhonetic}{窗台}{chuang1tai2}{12,5}{⽳,⼝}[HSK 4]
  \definition{s.}{parapeito da janela; peitoril; parte plana de uma janela que segura a moldura}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{窗子}{chuang1zi5}{12,3}{⽳,⼦}[HSK 4]
  \definition[扇,个]{s.}{janela}
  \synonymref{窗口}{chuang1kou3}
  \synonymref{窗户}{chuang1hu5}
\end{EntryWithPhonetic}
...
%%%%%%%%%% 幢 %%%%%%%%%%
\subsection*{幢}\addcontentsline{loh}{figure}{幢 \dpy{chuang2}}

\begin{EntryWithPhonetic}{幢}{chuang2}{15}{⼱}
  \definition{s.}{flâmula ou estandarte usado na China antiga; bandeiras antigas e itens semelhantes | um pilar de pedra com o nome de Buda ou as escrituras budistas inscritos; pilares de pedra com inscrições de cânticos ou mantras budistas}
  \seeref{zhuang4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{创办}{chuang4ban4}{6,4}{⼑,⼒}[HSK 6]
...
\begin{EntryWithPhonetic}{创建}{chuang4jian4}{6,8}{⼑,⼵}[HSK 6]
...
\begin{EntryWithPhonetic}{创业}{chuang4//ye4}{6,5}{⼑,⼀}[HSK 3]
...
\begin{EntryWithPhonetic}{创意}{chuang4yi4}{6,13}{⼑,⼼}[HSK 6]
...
\begin{EntryWithPhonetic}{吹胡子瞪眼}{chui1 hu2zi3 deng4yan3}{7,9,3,17,11}{⼝,⾁,⼦,⽬,⽬}[HSK 5]
...
\begin{EntryWithPhonetic}{锤骨}{chui2gu3}{13,9}{⾦,⾻}
  \definition{s.}{martelo ou osso em forma de martelo do ouvido médio; um dos ossículos do ouvido interno, em forma de martelo, está conectado à membrana timpânica e transmite as vibrações sonoras para a bigorna e o estribo}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{春季}{chun1ji4}{9,8}{⽇,⼦}[HSK 4]
...
\begin{EntryWithPhonetic}{春节}{chun1jie2}{9,5}{⽇,⾋}[HSK 2]
...
\begin{EntryWithPhonetic}{春天}{chun1tian1}{9,4}{⽇,⼤}[HSK 2]
...
\begin{EntryWithPhonetic}{纯净水}{chun2jing4shui3}{7,8,4}{⽷,⼎,⽔}[HSK 4]
...
%%%%%%%%%% 差 %%%%%%%%%%
\subsection*{差}\addcontentsline{loh}{figure}{差 \dpy{ci1}}

\begin{EntryWithPhonetic}{差}{ci1}{9}{⼯}
...
\begin{EntryWithPhonetic}{词典}{ci2dian3}{7,8}{⾔,⼋}[HSK 2]
...
%%%%%%%%%% 兹 %%%%%%%%%%
\subsection*{兹}\addcontentsline{loh}{figure}{兹 \dpy{ci2}}

\begin{EntryWithPhonetic}{兹}{ci2}{9}{⼋}
...
\begin{EntryWithPhonetic}{辞典}{ci2dian3}{13,8}{⾟,⼋}[HSK 5]
...
\begin{EntryWithPhonetic}{此刻}{ci3ke4}{6,8}{⽌,⼑}[HSK 5]
...
\begin{EntryWithPhonetic}{此前}{ci3qian2}{6,9}{⽌,⼑}[HSK 6]
...
\begin{EntryWithPhonetic}{此事}{ci3shi4}{6,8}{⽌,⼅}[HSK 6]
...
\begin{EntryWithPhonetic}{此致}{ci3zhi4}{6,10}{⽌,⾄}[HSK 6]
...
\begin{EntryWithPhonetic}{聪明人}{cong1ming2 ren2}{15,8,2}{⽿,⽇,⼈}[HSK 5]
  \definition{s.}{pessoa inteligente}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{从今以后}{cong2jin1yi3hou4}{4,4,4,6}{⼈,⼈,⼈,⼝}[HSK 7-9]
...
\begin{EntryWithPhonetic}{从来不}{cong2lai2bu4}{4,7,4}{⼈,⽊,⼀}[HSK 7-9]
  \definition{adv.}{nunca; indica que algo não foi feito no passado ou no presente}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{从没}{cong2mei2}{4,7}{⼈,⽔}[HSK 6]
...
\begin{EntryWithPhonetic}{从小}{cong2xiao3}{4,3}{⼈,⼩}[HSK 2]
  \definition{adv.}{desde a infância; desde muito jovem; quando criança}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{从业}{cong2//ye4}{4,5}{⼈,⼀}[HSK 7-9]
...
\begin{EntryWithPhonetic}{从中}{cong2zhong1}{4,4}{⼈,⼁}[HSK 5]
...
\begin{EntryWithPhonetic}{粗心地做}{cu1xin1di4 zuo4}{11,4,6,11}{⽶,⼼,⼟,⼈}
...
\begin{EntryWithPhonetic}{促销}{cu4xiao1}{9,12}{⼈,⾦}[HSK 4]
...
\begin{EntryWithPhonetic}{促销活动}{cu4xiao1 huo2dong4}{9,12,9,6}{⼈,⾦,⽔,⼒}[HSK 5]
...
\begin{EntryWithPhonetic}{醋}{cu4}{15}{⾣}[HSK 6]
  \definition[瓶,坛,碟,碗]{s.}{(condimento) vinagre | ciúme (como em caso de amor); ciúme, referindo"-se principalmente aos relacionamentos entre pessoas}
\end{EntryWithPhonetic}
...
%%%%%%%%%% 攒 %%%%%%%%%%
\subsection*{攒}\addcontentsline{loh}{figure}{攒 \dpy{cuan2}}

\begin{EntryWithPhonetic}{攒}{cuan2}{19}{⼿}
  \definition{v.}{reunir; concentrar; juntar as peças}
  \seeref{zan3}
\end{EntryWithPhonetic}
...
%%%%%%%%%% 衰 %%%%%%%%%%
\subsection*{衰}\addcontentsline{loh}{figure}{衰 \dpy{cui1}}

\begin{EntryWithPhonetic}{衰}{cui1}{10}{⾐}
...
\begin{EntryWithPhonetic}{村庄}{cun1zhuang1}{7,6}{⽊,⼴}[HSK 6]
...
%%%%%%%%%% 蹲 %%%%%%%%%%
\subsection*{蹲}\addcontentsline{loh}{figure}{蹲 \dpy{cun2}}

\begin{EntryWithPhonetic}{蹲}{cun2}{19}{⾜}
...
%%%%%%%%%% 瘥 %%%%%%%%%%
\subsection*{瘥}\addcontentsline{loh}{figure}{瘥 \dpy{cuo2}}

\begin{EntryWithPhonetic}{瘥}{cuo2}{14}{⽧}
...
\begin{EntryWithPhonetic}{错}{cuo4}{13}{⾦}[HSK 1]
  ...
  \definition[个,处]{s.}{falha; demérito | erro; engano | Arcaico: pedra de amolar para polir jade}
...
\begin{EntryWithPhonetic}{错过}{cuo4guo4}{13,6}{⾦,⾡}[HSK 6]
...
\begin{EntryWithPhonetic}{错位}{cuo4wei4}{13,7}{⾦,⼈}[HSK 7-9]
  ...
  \definition{v.}{Medicina: deslocar | deslocar; inverter | extraviar}
\end{EntryWithPhonetic}
