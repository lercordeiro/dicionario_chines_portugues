...
\begin{EntryWithPhonetic}{杂志社}{za2zhi4she4}{6,7,7}{⽊,⼼,⽰}
...
\begin{EntryWithPhonetic}{再不}{zai4 bu4}{6,4}{⼌,⼀}
...
\begin{EntryWithPhonetic}{再读}{zai4 du2}{6,10}{⼌,⾔}
...
\begin{EntryWithPhonetic}{再发}{zai4fa1}{6,5}{⼌,⼜}
...
\begin{EntryWithPhonetic}{在地}{zai4 di4}{6,6}{⼟,⼟}
  \definition{s.}{local}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{在行}{zai4 hang2}{6,6}{⼟,⾏}
...
\begin{EntryWithPhonetic}{在下}{zai4 xia4}{6,3}{⼟,⼀}
...
\begin{EntryWithPhonetic}{在意}{zai4yi4}{6,13}{⼟,⼼}[HSK 7-9]
...
\begin{EntryWithPhonetic}{暂时}{zan4shi2}{12,7}{⽇,⽇}[HSK 5]
  \definition{adj.}{transitório; temporário; por enquanto; em um curto período de tempo}
...
\begin{EntryWithPhonetic}{脏辫}{zang1 bian4}{10,17}{⾁,⾟}
...
\begin{EntryWithPhonetic}{脏煤}{zang1 mei2}{10,13}{⾁,⽕}
...
\begin{EntryWithPhonetic}{脏字儿}{zang1zi4r5}{10,6,2}{⾁,⼦,⼉}
...
\begin{EntryWithPhonetic}{噪音污染}{zao4yin1 wu1ran3}{16,9,6,9}{⼝,⾳,⽔,⽊}[HSK 5]
  \definition{s.}{poluição sonora}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{责任人}{ze2ren4 ren2}{8,6,2}{⾙,⼈,⼈}[HSK 5]
  \definition{s.}{coordenador; pessoa diretamente responsável por um trabalho ou tarefa específica | pessoa responsável}
\end{EntryWithPhonetic}

%%%%%%%%%% 侧 %%%%%%%%%%
\subsection*{侧}\addcontentsline{loh}{figure}{侧 \dpy{ze4}}

\begin{EntryWithPhonetic}{侧}{ze4}{8}{⼈}
...
\begin{EntryWithPhonetic}{贼星}{zei2xing1}{10,9}{⾙,⽇}
...
\begin{EntryWithPhonetic}{怎么办}{zen3me5 ban4}{9,3,4}{⼼,⼃,⼒}[HSK 2]
...
\begin{EntryWithPhonetic}{怎么搞的}{zen3me5 gao3 de5}{9,3,13,8}{⼼,⼃,⼿,⽩}
...
\begin{EntryWithPhonetic}{怎么了}{zen3me5 le5}{9,3,2}{⼼,⼃,⼅}
  \definition{expr.}{``E aí?''; ``O que aconteceu?''; ``O que está rolando?''; informe"-se sobre a situação}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{怎么样}{zen3me5 yang4}{9,3,10}{⼼,⼃,⽊}[HSK 2]
...
\begin{EntryWithPhonetic}{赠送}{zeng4song4}{16,9}{⾙,⾡}[HSK 5]
  ...
  \synonymref{送给}{song4 gei3}
  \synonymref{送礼}{song4li3}
...
%%%%%%%%%% 斋 %%%%%%%%%%
\subsection*{斋}\addcontentsline{loh}{figure}{斋 \dpy{zhai1}}

\begin{EntryWithPhonetic}{斋}{zhai1}{10}{⽂}
...
\begin{EntryWithPhonetic}{斋月}{zhai1yue4}{10,4}{⽂,⽉}
...
\begin{EntryWithPhonetic}{长大}{zhang3da4}{4,3}{⾧,⼤}[HSK 2]
...
\begin{EntryWithPhonetic}{掌}{zhang3}{12}{⼿}
  \definition*{s.}{Sobrenome: Zhang}
  \definition[块]{s.}{palma da mão | parte inferior das patas de certos animais; almofada; sola | sola ou salto do sapato | ferradura; casco de cavalo}
  \definition{v.}{dar um tapa com a palma da mão; bater | ter na mão; estar encarregado de; controlar; manejar; gerir; controlar | consertar (a sola de um sapato); pregar ou costurar  na parte da frente ou de trás da sola, etc. | adicionar (sal, óleo, etc.) | usado como 把}
  \seealsoref{把}{ba3}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{招待员}{zhao1dai4 yuan2}{8,9,7}{⼿,⼻,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{招聘广告}{zhao1pin4 guang3gao4}{8,13,3,7}{⼿,⽿,⼴,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{招聘者}{zhao1pin4 zhe3}{8,13,8}{⼿,⽿,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{招手}{zhao1shou3}{8,4}{⼿,⼿}[HSK 5]
...
\begin{EntryWithPhonetic}{着急}{zhao2//ji2}{11,9}{⽬,⼼}[HSK 4]
  ...
  \synonymref{急性}{ji2xing4}
  \synonymref{焦急}{jiao1ji2}
  ...
  \antonymref{心安}{xin1'an1}
  \antonymref{镇定}{zhen4ding4}
  \seealsoref{急}{ji2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{着凉}{zhao2liang2}{11,10}{⽬,⼎}
  \definition{v.}{pegar um resfriado; sentir calafrios; sofrer de resfriados e outras doenças devido às baixas temperaturas}
  \synonymref{感冒}{gan3mao4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{找事儿}{zhao3 shi4r5}{7,8,2}{⼿,⼅,⼉}
...
\begin{EntryWithPhonetic}{找着}{zhao3 zhao2}{7,11}{⼿,⽬}
...
\begin{EntryWithPhonetic}{照片子}{zhao4pian4 zi5}{13,4,3}{⽕,⽚,⼦}
...
\begin{EntryWithPhonetic}{照相}{zhao4xiang4}{13,9}{⽕,⽬}[HSK 2]
  \definition{v.}{fotografar; tirar fotos; tirar uma foto; tirar uma fotografia}
...
\begin{EntryWithPhonetic}{照像}{zhao4xiang4}{13,13}{⽕,⼈}
  \variantof{照相}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{哲学家}{zhe2xue2 jia1}{10,8,10}{⼝,⼦,⼧}[HSK 5]
...
\begin{EntryWithPhonetic}{这会儿}{zhe4hui4r5}{7,6,2}{⾡,⼈,⼉}[HSK 7-9]
...
\begin{EntryWithPhonetic}{这时}{zhe4shi2}{7,7}{⾡,⽇}
...
\begin{EntryWithPhonetic}{这咱}{zhe4zan5}{7,9}{⾡,⼝}
...
%%%%%%%%%% 砧 %%%%%%%%%%
\subsection*{砧}\addcontentsline{loh}{figure}{砧 \dpy{zhen1}}

\begin{EntryWithPhonetic}{砧}{zhen1}{10}{⽯}
  \definition{s.}{bloco de martelar; bigorna; a ferramenta usada como apoio ao martelar ou esmagar algo}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{砧骨}{zhen1gu3}{10,9}{⽯,⾻}
...
\begin{EntryWithPhonetic}{睁一眼，闭一眼}{zheng1 yi1yan3 bi4 yi1yan3}{11,1,11,6,1,11}{⽬,⼀,⽬,⾨,⼀,⽬}[HSK 5]
  \definition{expr.}{``Abra um olho, feche um olho.''; fingir que não vê algo; piscar o olho para algo; fingir que não percebe}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{整理}{zheng3li3}{16,11}{⽁,⽟}[HSK 3]
  ...
  \antonymref{破坏}{po4huai4}
  \seealsoref{清理}{qing1li3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{整理者}{zheng3li3 zhe3}{16,11,8}{⽁,⽟,⽼}[HSK 5]
  \definition{s.}{compilador; organizador; arranjador}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{正常人}{zheng4chang2 ren2}{5,11,2}{⽌,⼱,⼈}[HSK 5]
...
\begin{EntryWithPhonetic}{正定}{zheng4ding4}{5,8}{⽌,⼧}
...
\begin{EntryWithPhonetic}{正能量}{zheng4 neng2liang4}{5,10,12}{⽌,⾁,⾥}[HSK 7-9]
...
\begin{EntryWithPhonetic}{正正}{zheng4 zheng4}{5,5}{⽌,⽌}
...
\begin{EntryWithPhonetic}{证明人}{zheng4ming2 ren2}{7,8,2}{⾔,⽇,⼈}[HSK 5]
...
\begin{EntryWithPhonetic}{政府部门}{zheng4fu3 bu4men2}{9,8,10,3}{⽁,⼴,⾢,⾨}[HSK 5]
...
\begin{EntryWithPhonetic}{政治纲领}{zheng4zhi4gang1ling3}{9,8,7,11}{⽁,⽔,⽷,⾴}
...
\begin{EntryWithPhonetic}{之上}{zhi1shang4}{3,3}{⼂,⼀}
  \definition{part./suf.}{acima: acima de uma determinada posição, estado, grau, etc., ou seja, superior a, em um nível superior ou dentro de uma faixa superior}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{之外}{zhi1 wai4}{3,5}{⼂,⼣}[HSK 5]
  ...
  \antonymref{其间}{qi2jian1}
  \antonymref{以内}{yi3nei4}
  \antonymref{之内}{zhi1 nei4}
  \antonymref{之中}{zhi1 zhong1}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{支持者}{zhi1chi2 zhe3}{4,9,8}{⽀,⼿,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{知道了}{zhi1dao4 le5}{8,12,2}{⽮,⾡,⼅}
...
\begin{EntryWithPhonetic}{蜘蛛网}{zhi1zhu1wang3}{14,12,6}{⾍,⾍,⽹}
...
\begin{EntryWithPhonetic}{值班人员}{zhi2ban1 ren2yuan2}{10,10,2,7}{⼈,⽟,⼈,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{职工餐厅}{zhi2gong1 can1ting1}{11,3,16,4}{⽿,⼯,⾷,⼚}[HSK 5]
  \definition{s.}{refeitório dos funcionários}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{职业律师}{zhi2ye4 lv4shi1}{11,5,9,6}{⽿,⼀,⼻,⼱}[HSK 5]
  \definition{s.}{advogado profissional; advogado de carreira}[她是一名职业律师。===Ela é uma advogada profissional.]
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{植物}{zhi2wu4}{12,8}{⽊,⽜}[HSK 4]
  ...
  \synonymref{树木}{shu4mu4}
  \antonymref{动物}{dong4wu4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{植物人}{zhi2wu4ren2}{12,8,2}{⽊,⽜,⼈}
  \definition{s.}{paciente em estado vegetativo}[医院里有个植物人。===Há um paciente em estado vegetativo no hospital.]
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{植物学家}{zhi2wu4 xue2 jia1}{12,8,8,10}{⽊,⽜,⼦,⼧}[HSK 5]
  \definition{s.}{botânico}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{殖}{zhi2}{12}{⽍}
  \definition*{s.}{Sobrenome: Zhi}
  \definition{v.}{procriar; multiplicar | crescer; gerar; produzir}
  \seeref{shi4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{止咳}{zhi3ke2}{4,9}{⽌,⼝}[HSK 7-9]
...
\begin{EntryWithPhonetic}{只不过}{zhi3 bu2guo4}{5,4,6}{⼝,⼀,⾡}[HSK 5]
...
\begin{EntryWithPhonetic}{指挥员}{zhi3hui1 yuan2}{9,9,7}{⼿,⼿,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{志愿者}{zhi4yuan4 zhe3}{7,14,8}{⼼,⽕,⽼}[HSK 3]
...
\begin{EntryWithPhonetic}{制造者}{zhi4zao4 zhe3}{8,10,8}{⼑,⾡,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{智障}{zhi4zhang4}{12,13}{⽇,⾩}
  \definition{adj.}{demência; desenvolvimento mental insuficiente; deficiência/retardo mental}
  \definition{s.}{retardado}
...
\begin{EntryWithPhonetic}{中国城}{zhong1guo2 cheng2}{4,8,9}{⼁,⼞,⼟}
  \definition*[座]{s.}{Bairro Chinês, Chinatown}
  \seealsoref{唐人街}{tang2ren2jie1}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{中国地图}{zhong1guo2 di4tu2}{4,8,6,8}{⼁,⼞,⼟,⼞}[HSK 5]
...
\begin{EntryWithPhonetic}{中国科学院}{zhong1guo2ke1xue2yuan4}{4,8,9,8,9}{⼁,⼞,⽲,⼦,⾩}
  \definition*{s.}{Academia Chinesa de Ciências}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{中国人}{zhong1guo2 ren2}{4,8,2}{⼁,⼞,⼈}
...
\begin{EntryWithPhonetic}{中华民族}{zhong1hua2 min2zu2}{4,6,5,11}{⼁,⼗,⽒,⽅}[HSK 3]
...
\begin{EntryWithPhonetic}{中间人}{zhong1jian1ren2}{4,7,2}{⼁,⾨,⼈}[HSK 5]
...
\begin{EntryWithPhonetic}{中介公司}{zhong1jie4 gong1si1}{4,4,4,5}{⼁,⼈,⼋,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{中秋节}{zhong1qiu1 jie2}{4,9,5}{⼁,⽲,⾋}[HSK 5]
  \definition*[个]{s.}{Festival do Meio"-Outono | Festival do Bolo Lunar (15º dia do oitavo mês lunar)}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{中式餐厅}{zhong1shi4 can1ting1}{4,6,16,4}{⼁,⼷,⾷,⼚}[HSK 5]
  \definition{s.}{restaurante chinês; restaurante de estilo chinês}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{中式厨房}{zhong1shi4 chu2fang2}{4,6,12,8}{⼁,⼷,⼚,⼾}[HSK 5]
  \definition{s.}{cozinha chinesa; cozinha ao estilo chinês}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{中坛元帅}{zhong1 tan2 yuan2shuai4}{4,7,4,5}{⼁,⼟,⼉,⼱}
...
\begin{EntryWithPhonetic}{中土}{zhong1tu3}{4,3}{⼁,⼟}
...
\begin{EntryWithPhonetic}{中心城市}{zhong1xin1 cheng2shi4}{4,4,9,5}{⼁,⼼,⼟,⼱}[HSK 5]
...
\begin{EntryWithPhonetic}{终身大事}{zhong1shen1 da4shi4}{8,7,3,8}{⽷,⾝,⼤,⼅}[HSK 5]
...
\begin{EntryWithPhonetic}{种地}{zhong4//di4}{9,6}{⽲,⼟}
...
\begin{EntryWithPhonetic}{重要人物}{zhong4yao4 ren2wu4}{9,9,2,8}{⾥,⾑,⼈,⽜}[HSK 5]
...
\begin{EntryWithPhonetic}{周边城市}{zhou1bian1 cheng2shi4}{8,5,9,5}{⼝,⾡,⼟,⼱}[HSK 5]
...
\begin{EntryWithPhonetic}{猪窠}{zhu1 ke1}{11,13}{⽝,⽳}
...
\begin{EntryWithPhonetic}{猪笼}{zhu1long2}{11,11}{⽝,⽵}
  \definition{s.}{estrutura cilíndrica de bambu ou arame usada para conter um porco durante o transporte}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{猪头}{zhu1tou2}{11,5}{⽝,⼤}
  \definition{s.}{Vulgar: pessoa estúpida; imbecil | Coloquial: tolo; cabeça"-dura | idiota}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{竹熊}{zhu2xiong2}{6,14}{⽵,⽕}[HSK 5]
  \definition{s.}{panda}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{主要角色}{zhu3yao4 jue2se4}{5,9,7,6}{⼂,⾑,⾓,⾊}[HSK 5]
...
\begin{EntryWithPhonetic}{属}{zhu3}{12}{⼫}
  \definition{v.}{juntar; combinar; continuar | fixar (a mente) em; centrar (a atenção, etc.) em; concentrar"-se em um ponto | conectar; unir (frases; escrita); ligar (palavras e frases); escrever}
  \seeref{shu3}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{嘱}{zhu3}{15}{⼝}
  \definition{v.}{ordenar; aconselhar; insistir | confiar}
  \synonymref{叮}{ding1}
  \synonymref{授}{shou4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{住院}{zhu4yuan4}{7,9}{⼈,⾩}[HSK 2]
...
\begin{EntryWithPhonetic}{注册人}{zhu4ce4 ren2}{8,5,2}{⽔,⼌,⼈}
  \definition{s.}{registrante; requerente; interessado}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{注册商标}{zhu4ce4shang1biao1}{8,5,11,9}{⽔,⼌,⼝,⽊}
...
\begin{EntryWithPhonetic}{注意地}{zhu4yi4 di4}{8,13,6}{⽔,⼼,⼟}
...
\begin{EntryWithPhonetic}{注意力缺失症}{zhu4yi4li4 que1shi1 zheng4}{8,13,2,10,5,10}{⽔,⼼,⼒,⽸,⼤,⽧}
...
\begin{EntryWithPhonetic}{祝告}{zhu4gao4}{9,7}{⽰,⼝}
  \definition{v.}{rezar; orar; fazer as suas orações}
  \synonymref{祈祷}{qi2dao3}
  \synonymref{祝愿}{zhu4yuan4}
  \antonymref{咒骂}{zhou4ma4}
...
\begin{EntryWithPhonetic}{著名专家}{zhu4ming2 zhuan1jia1}{11,6,4,10}{⽬,⼝,⼀,⼧}[HSK 5]
  \definition{s.}{especialista renomado; especialista famoso; pessoa amplamente conhecida em uma determinada área e que possui vasta experiência ou conhecimento}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{专家学者}{zhuan1jia1 xue2zhe3}{4,10,8,8}{⼀,⼧,⼦,⽼}
...
\begin{EntryWithPhonetic}{专业教育}{zhuan1ye4 jiao4yu4}{4,5,11,8}{⼀,⼀,⽁,⾁}
...
\begin{EntryWithPhonetic}{转身}{zhuan3shen1}{8,7}{⾞,⾝}[HSK 4]
...
\begin{EntryWithPhonetic}{转向}{zhuan3xiang4}{8,6}{⾞,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{赚钱}{zhuan4qian2}{14,10}{⾙,⾦}[HSK 6]
...
\begin{EntryWithPhonetic}{装}{zhuang1}{12}{⾐}[HSK 2]
  ...
  \synonymref{伪}{wei3}
  \synonymref{详}{xiang2}
  \synonymref{妆}{zhuang1}
  \antonymref{拆}{chai1}
  \antonymref{卸}{xie4}
  \seealsoref{假装}{jia3zhuang1}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{装饰}{zhuang1shi4}{12,8}{⾐,⾷}[HSK 5]
  ...
  \synonymref{点缀}{dian3zhui4}
  \synonymref{化妆}{hua4//zhuang1}
  \synonymref{装扮}{zhuang1ban4}
  \synonymref{装修}{zhuang1xiu1}
  \antonymref{破坏}{po4huai4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{壮族}{zhuang4zu2}{6,11}{⼠,⽅}
...
\begin{EntryWithPhonetic}{撞运气}{zhuang4 yun4qi5}{15,7,4}{⼿,⾡,⽓}
  \definition{v.}{tentar a sorte; arriscar; confiar no destino}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{着花}{zhuo2 hua1}{11,7}{⽬,⾋}
...
\begin{EntryWithPhonetic}{着眼于}{zhuo2yan3yu2}{11,11,3}{⽬,⽬,⼆}[HSK 7-9]
...
\begin{EntryWithPhonetic}{着装}{zhuo2zhuang1}{11,12}{⽬,⾐}
  \definition{s.}{vestimentas; roupas, chapéus, etc.}
  \definition{v.}{vestir; colocar; refere"-se ao uso de roupas, chapéus, etc.}
  \synonymref{打扮}{da3ban5}
...
\begin{EntryWithPhonetic}{咨询处}{zi1xun2 chu4}{9,8,5}{⼝,⾔,⼡}[HSK 5]
...
\begin{EntryWithPhonetic}{资本主义}{zi1ben3zhu3yi4}{10,5,5,3}{⾙,⽊,⼂,⼂}[HSK 7-9]
...
\begin{EntryWithPhonetic}{滋味}{zi1wei4}{12,8}{⽔,⼝}[HSK 7-9]
  \definition[种]{s.}{paladar; sabor; prazer; gosto | sentimento interior; sentimentos do coração}
  \synonymref{口味}{kou3wei4}
  \antonymref{吃苦}{chi1//ku3}
  \seealsoref{味道}{wei4dao4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{紫色}{zi3se4}{12,6}{⽷,⾊}
...
\begin{EntryWithPhonetic}{自己动手}{zi4ji3 dong4shou3}{6,3,6,4}{⾃,⼰,⼒,⼿}
...
\begin{EntryWithPhonetic}{自我催眠}{zi4wo3 cui1mian2}{6,7,13,10}{⾃,⼽,⼈,⽬}
  \definition{s.}{autohipnotismo; autohipnose; idiohipnotismo}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{自我的人}{zi4wo3 de5 ren2}{6,7,8,2}{⾃,⼽,⽩,⼈}
  \definition{s.}{(minha, sua) própria pessoa | (afirmar) a própria personalidade}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{自我防卫}{zi4wo3 fang2wei4}{6,7,6,3}{⾃,⼽,⾩,⼙}
  \definition{s.}{defesa pessoal | auto"-defesa}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{自我解嘲}{zi4wo3jie3chao2}{6,7,13,15}{⾃,⼽,⾓,⼝}
...
\begin{EntryWithPhonetic}{自我批评}{zi4wo3pi1ping2}{6,7,7,7}{⾃,⼽,⼿,⾔}
...
\begin{EntryWithPhonetic}{自我意识}{zi4wo3yi4shi2}{6,7,13,7}{⾃,⼽,⼼,⾔}
...
\begin{EntryWithPhonetic}{自行车馆}{zi4xing2che1 guan3}{6,6,4,11}{⾃,⾏,⾞,⾷}
  \definition{s.}{estádio de ciclismo | velódromo}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{自行车架}{zi4xing2che1 jia4}{6,6,4,9}{⾃,⾏,⾞,⽊}
...
\begin{EntryWithPhonetic}{自在}{zi4zai5}{6,6}{⾃,⼟}[HSK 6]
...
\begin{EntryWithPhonetic}{综合医院}{zong1he2 yi1yuan4}{11,6,7,9}{⽷,⼝,⼖,⾩}[HSK 5]
  \definition{s.}{hospital geral}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{总的来说}{zong3de5lai2shuo1}{9,8,7,9}{⼼,⽩,⽊,⾔}[HSK 7-9]
...
\begin{EntryWithPhonetic}{总是}{zong3 shi4}{9,9}{⼼,⽇}[HSK 3]
...
\begin{EntryWithPhonetic}{走过场}{zou3guo4chang3}{7,6,6}{⾛,⾡,⼟}[HSK 7-9]
...
\begin{EntryWithPhonetic}{走后门}{zou3hou4men2}{7,6,3}{⾛,⼝,⾨}[HSK 7-9]
...
\begin{EntryWithPhonetic}{走路}{zou3lu4}{7,13}{⾛,⾜}[HSK 1]
...
\begin{EntryWithPhonetic}{走去}{zou3 qu4}{7,5}{⾛,⼛}
...
\begin{EntryWithPhonetic}{走弯路}{zou3wan1lu4}{7,9,13}{⾛,⼸,⾜}[HSK 7-9]
...
\begin{EntryWithPhonetic}{足球队}{zu2qiu2dui4}{7,11,4}{⾜,⽟,⾩}
...
\begin{EntryWithPhonetic}{足球协会}{zu2qiu2 xie2hui4}{7,11,6,6}{⾜,⽟,⼗,⼈}
...
\begin{EntryWithPhonetic}{足月}{zu2 yue4}{7,4}{⾜,⽉}
...
\begin{EntryWithPhonetic}{组织者}{zu3zhi1 zhe3}{8,8,8}{⽷,⽷,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{钻空子}{zuan1kong4zi5}{10,8,3}{⾦,⽳,⼦}[HSK 7-9]
...
%%%%%%%%%% 赚 %%%%%%%%%%
\subsection*{赚}\addcontentsline{loh}{figure}{赚 \dpy{zuan4}}

\begin{EntryWithPhonetic}{赚}{zuan4}{14}{⾙}
...
\begin{EntryWithPhonetic}{嘴}{zui3}{16}{⼝}[HSK 2]
  \definition[张,个]{s.}{boca; boca humana ou animal | qualquer coisa com formato ou função semelhante a uma boca | fala | comida}
  \synonymref{口}{kou3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{嘴巴}{zui3ba5}{16,4}{⼝,⼰}[HSK 4]
  \definition[张]{s.}{boca}
  \synonymref{口腔}{kou3qiang1}
  \synonymref{嘴唇}{zui3chun2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{嘴巴子}{zui3ba5 zi5}{16,4,3}{⼝,⼰,⼦}
...
\begin{EntryWithPhonetic}{最多}{zui4 duo1}{12,6}{⽈,⼣}
...
\begin{EntryWithPhonetic}{最好}{zui4 hao3}{12,6}{⽈,⼥}[HSK 1]
...
\begin{EntryWithPhonetic}{罪恶}{zui4'e4}{13,10}{⽹,⼼}[HSK 6]
  ...
  \synonymref{罪行}{zui4xing2}
  \antonymref{无辜}{wu2gu1}
...
\begin{EntryWithPhonetic}{尊敬}{zun1jing4}{12,12}{⼨,⽁}[HSK 5]
  ...
  \synonymref{爱戴}{ai4dai4}
  \synonymref{崇拜}{chong2bai4}
  \synonymref{崇敬}{chong2jing4}
  \synonymref{敬爱}{jing4'ai4}
  \synonymref{敬佩}{jing4pei4}
...
\begin{EntryWithPhonetic}{左边抽屉}{zuo3bian1 chou1ti4}{5,5,8,8}{⼯,⾡,⼿,⼫}[HSK 5]
...
\begin{EntryWithPhonetic}{作战}{zuo4zhan4}{7,9}{⼈,⼽}[HSK 6]
...
\begin{EntryWithPhonetic}{坐垫儿}{zuo4dian4r5}{7,9,2}{⼟,⼟,⼉}
  \definition{s.}{almofada do assento}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{坐过了站}{zuo4guo4le5 zhan4}{7,6,2,10}{⼟,⾡,⼅,⽴}[HSK 5]
  \definition{v.}{passar do meu ponto; ultrapassar os limites, ir longe demais}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{坐好}{zuo4 hao3}{7,6}{⼟,⼥}
...
\begin{EntryWithPhonetic}{做到}{zuo4dao4}{11,8}{⼈,⼑}[HSK 2]
...
\begin{EntryWithPhonetic}{做饭}{zuo4fan4}{11,7}{⼈,⾷}[HSK 2]
...
\begin{EntryWithPhonetic}{做客}{zuo4ke4}{11,9}{⼈,⼧}[HSK 3]
  \definition{v.}{visitar; ser um convidado; ser hóspede}
  \synonymref{拜访}{bai4fang3}
  \synonymref{拜会}{bai4hui4}
  \synonymref{作客}{zuo4//ke4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{做梦}{zuo4meng4}{11,11}{⼈,⼣}[HSK 4]
  \definition{s.}{sonho; ilusões e visões na consciência durante o sono}
  \definition{v.}{sonhar; ter um sonho | sonhar acordado, ter um sonho impossível; ter uma fantasia irrealista}[别做梦了，她不会嫁给你的。===Pare de sonhar, ela não se casará com você.]
  \synonymref{幻想}{huan4xiang3}
  \synonymref{梦幻}{meng4huan4}
  \synonymref{妄想}{wang4xiang3}
  \antonymref{清醒}{qing1xing3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{做生活}{zuo4 sheng1huo2}{11,5,9}{⼈,⽣,⽔}
  \definition{v.}{realizar trabalho manual; trabalhar}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{做生意}{zuo4sheng1yi5}{11,5,13}{⼈,⽣,⼼}[HSK 7-9]
  \definition{v.}{fazer negócios}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{做戏}{zuo4xi4}{11,6}{⼈,⼽}
  \definition{v.}{encenar uma peça; atuar em uma peça | representar; fingir | dar um show}
  \synonymref{扮演}{ban4yan3}
  \synonymref{表演}{biao3yan3}
  \synonymref{演戏}{yan3//xi4}
  \antonymref{平凡}{ping2fan2}
...
\begin{EntryWithPhonetic}{酢浆草}{zuo4jiang1cao3}{12,10,9}{⾣,⽔,⾋}
