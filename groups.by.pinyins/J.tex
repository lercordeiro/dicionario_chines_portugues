...
\begin{EntryWithPhonetic}{肌肉发达}{ji1rou4 fa1da2}{6,6,5,6}{⾁,⾁,⼜,⾡}[HSK 5]
...
%%%%%%%%%% 其 %%%%%%%%%%
\subsection*{其}\addcontentsline{loh}{figure}{其 \dpy{ji1}}

\begin{EntryWithPhonetic}{其}{ji1}{8}{⼋}
...
\begin{EntryWithPhonetic}{基本}{ji1ben3}{11,5}{⼟,⽊}[HSK 3]
  ...
  \synonymref{大体}{da4ti3}
  \synonymref{大致}{da4zhi4}
  ...
  \seealsoref{根本}{gen1ben3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{基本法}{ji1ben3fa3}{11,5,8}{⼟,⽊,⽔}
  \definition{s.}{lei fundamental (constituição)}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{基本上}{ji1ben3 shang4}{11,5,3}{⼟,⽊,⼀}[HSK 3]
...
\begin{EntryWithPhonetic}{基色}{ji1se4}{11,6}{⼟,⾊}
...
%%%%%%%%%% 期 %%%%%%%%%%
\subsection*{期}\addcontentsline{loh}{figure}{期 \dpy{ji1}}

\begin{EntryWithPhonetic}{期}{ji1}{12}{⽉}
  \definition{s.}{um ano inteiro; um mês inteiro}
  \seeref{qi1}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{激烈}{ji1lie4}{16,10}{⽔,⽕}[HSK 4]
  ...
  \seealsoref{剧烈}{ju4lie4}
  \seealsoref{强烈}{qiang2lie4}
...
\begin{EntryWithPhonetic}{及格}{ji2//ge2}{3,10}{⼃,⽊}[HSK 4]
  ...
  \synonymref{过关}{guo4//guan1}
  \seealsoref{合格}{he2ge2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{及其}{ji2qi2}{3,8}{⼃,⼋}[HSK 7-9]
...
\begin{EntryWithPhonetic}{即或}{ji2 huo4}{7,8}{⼙,⼽}
...
\begin{EntryWithPhonetic}{即若}{ji2 ruo4}{7,8}{⼙,⾋}
...
\begin{EntryWithPhonetic}{即是}{ji2 shi4}{7,9}{⼙,⽇}
...
\begin{EntryWithPhonetic}{极少数}{ji2shao3shu4}{7,4,13}{⽊,⼩,⽁}[HSK 7-9]
...
\begin{EntryWithPhonetic}{急切}{ji2qie4}{9,4}{⼼,⼑}
...
\begin{EntryWithPhonetic}{集}{ji2}{12}{⾫}[HSK 6]
  ...
  \definition[本]{s.}{mercado; feira rural | coleção; conjunto; antologia | Matemática: conjunto}
...
\begin{EntryWithPhonetic}{集中}{ji2zhong1}{12,4}{⾫,⼁}[HSK 3]
  ...
  \antonymref{分布}{fen1bu4}
  \antonymref{分散}{fen1san4}
  \antonymref{散布}{san4bu4}
  \antonymref{疏散}{shu1san4}
  \seealsoref{集合}{ji2he2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{几}{ji3}{2}{⼏}[HSK 1][Kangxi 16]
  ...
  \seeref{ji1}
  \seealsoref{多少}{duo1shao3}
  \seealsoref{多少}{duo1shao5}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{几何}{ji3he2}{2,7}{⼏,⼈}
  \definition{pron.}{quanto; quantos}
  \definition[方]{s.}{geometria}
...
\begin{EntryWithPhonetic}{计算机程序}{ji4suan4ji1cheng2xu4}{4,14,6,12,7}{⾔,⽵,⽊,⽲,⼴}
...
\begin{EntryWithPhonetic}{记住}{ji4zhu5}{5,7}{⾔,⼈}[HSK 1]
...
%%%%%%%%%% 伎 %%%%%%%%%%
\subsection*{伎}\addcontentsline{loh}{figure}{伎 \dpy{ji4}}

\begin{EntryWithPhonetic}{伎}{ji4}{6}{⼈}
...
\begin{EntryWithPhonetic}{伎俩}{ji4liang3}{6,9}{⼈,⼈}
...
\begin{EntryWithPhonetic}{纪念册}{ji4nian4ce4}{6,8,5}{⽷,⼼,⼌}[HSK 5]
...
\begin{EntryWithPhonetic}{纪念品}{ji4nian4pin3}{6,8,9}{⽷,⼼,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{纪传}{ji4zhuan4}{6,6}{⽷,⼈}
  \definition{s.}{crônica; biografia}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{纪传体}{ji4zhuan4ti3}{6,6,7}{⽷,⼈,⼈}
  \definition{s.}{história apresentada em uma série de biografias | gênero histórico baseado em biografia}
\end{EntryWithPhonetic}

%%%%%%%%%% 齐 %%%%%%%%%%
\subsection*{齐}\addcontentsline{loh}{figure}{齐 \dpy{ji4}}

\begin{EntryWithPhonetic}{齐}{ji4}{6}{⿑}[Kangxi 210]
...
\begin{EntryWithPhonetic}{技术员}{ji4shu4yuan2}{7,5,7}{⼿,⽊,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{既又}{ji4 you4}{9,2}{⽆,⼜}
...
\begin{EntryWithPhonetic}{寄存}{ji4cun2}{11,6}{⼧,⼦}
  \definition{v.}{depositar; armazenar; deixar algo com alguém; guardar algo temporariamente em algum lugar e pedir para alguém guardar para você}
  \synonymref{存放}{cun2fang4}
  \synonymref{寄放}{ji4fang4}
  \antonymref{领取}{ling3qu3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{寄递}{ji4di4}{11,10}{⼧,⾡}
  \definition{s.}{entregar (uma carta)}
  \definition{s.}{entrega de correspondência pelos correios}
...
\begin{EntryWithPhonetic}{寄放}{ji4fang4}{11,8}{⼧,⽅}
  \definition{v.}{deixar com; deixar aos cuidados de; confiar seus pertences a outra pessoa para que sejam guardados em segurança}
  \synonymref{存放}{cun2fang4}
  \synonymref{寄存}{ji4cun2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{寄居}{ji4ju1}{11,8}{⼧,⼫}
  \definition{s.}{morar longe de casa; hospedar"-se | Zoologia: ser inquilino}
  \synonymref{寄生}{ji4sheng1}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{寄卖}{ji4mai4}{11,8}{⼧,⼗}
  \definition{v.}{consignar para venda em consignação; colocar à venda em uma loja de segunda mão; colocar à venda em uma loja de segunda mão}
  \seealsoref{寄售}{ji4shou4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{寄生}{ji4sheng1}{11,5}{⼧,⽣}
  \definition{adj.}{parasítico; parasitário}
  \definition{s.}{Biologia: parasitismo}
  \definition{v.}{ser parasita | viver às custas dos outros | viver dentro ou sobre outro organismo como parasita}
  \synonymref{寄居}{ji4ju1}
  \synonymref{依赖}{yi1lai4}
  \antonymref{独立}{du2li4}
  \antonymref{自主}{zi4zhu3}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{寄生生活}{ji4sheng1 sheng1huo2}{11,5,5,9}{⼧,⽣,⽣,⽔}
  \definition{s.}{parasitismo | vida parasitária}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{寄售}{ji4shou4}{11,11}{⼧,⼝}
  \definition{s.}{venda por consignação; consignações}
  \definition{v.}{consignar para venda em consignação; colocar à venda em uma loja de segunda mão}
  \synonymref{寄卖}{ji4mai4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{寄宿}{ji4su4}{11,11}{⼧,⼧}
  ...
  \definition{v.}{ficar; hospedar"-se; alojar"-se}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{寄养}{ji4yang3}{11,9}{⼧,⼋}
  \definition{v.}{contratar cuidados externos | colocar aos cuidados de alguém (uma criança, um animal de estimação, etc.)}
  \antonymref{抛弃}{pao1qi4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{寄予}{ji4yu3}{11,4}{⼧,⼅}
  \definition{v.}{depositar (esperança, etc.) em; ter esperança | mostrar; dar; expressar}
...
%%%%%%%%%% 冀 %%%%%%%%%%
\subsection*{冀}\addcontentsline{loh}{figure}{冀 \dpy{ji4}}

\begin{EntryWithPhonetic}{冀}{ji4}{16}{⼋}
  \definition*{s.}{Ji, outro nome para a província de Hebei (河北)}
  \definition{v.}{esperar; ansiar por; aguardar com expectativa}
...
\begin{EntryWithPhonetic}{加上}{jia1shang4}{5,3}{⼒,⼀}[HSK 5]
...
\begin{EntryWithPhonetic}{加油工}{jia1you2 gong1}{5,8,3}{⼒,⽔,⼯}
...
\begin{EntryWithPhonetic}{家常便饭}{jia1chang2bian4fan4}{10,11,9,7}{⼧,⼱,⼈,⾷}[HSK 5]
...
\begin{EntryWithPhonetic}{家用电器}{jia1yong4dian4qi4}{10,5,5,16}{⼧,⽤,⽥,⼝}
...
\begin{EntryWithPhonetic}{假}{jia3}{11}{⼈}[HSK 2]
  \definition{adj.}{falso; fingido; artificial}
...
\begin{EntryWithPhonetic}{假的}{jia3 de5}{11,8}{⼈,⽩}
  \definition{adj.}{conversa fiada; falso; enganoso; espúrio; falsificado}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{假声}{jia3sheng1}{11,7}{⼈,⼠}
  \definition{s.}{falsete | pseudosom}
...
\begin{EntryWithPhonetic}{假证件}{jia3 zheng4jian4}{11,7,6}{⼈,⾔,⼈}
...
\begin{EntryWithPhonetic}{价钱}{jia4qian2}{6,10}{⼈,⾦}[HSK 3]
...
\begin{EntryWithPhonetic}{价值连城}{jia4zhi2 lian2cheng2}{6,10,7,9}{⼈,⼈,⾡,⼟}[HSK 5]
...
\begin{EntryWithPhonetic}{驾车}{jia4che1}{8,4}{⾺,⾞}[HSK 7-9]
...
\begin{EntryWithPhonetic}{驾驶证}{jia4shi3 zheng4}{8,8,7}{⾺,⾺,⾔}[HSK 5]
...
\begin{EntryWithPhonetic}{坚定的信念}{jian1ding4 de5 xin4nian4}{7,8,8,9,8}{⼟,⼧,⽩,⼈,⼼}[HSK 5]
...
\begin{EntryWithPhonetic}{减肥药}{jian3fei2 yao4}{11,8,9}{⼎,⾁,⾋}[HSK 5]
  \definition{s.}{medicamentos para perda de peso; pílula para emagrecer; auxiliar na perda de peso}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{减肥者}{jian3fei2 zhe3}{11,8,8}{⼎,⾁,⽼}[HSK 5]
  \definition{s.}{pessoas que fazem dieta}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{减削}{jian3xue1}{11,9}{⼎,⼑}
...
\begin{EntryWithPhonetic}{剪草除根}{jian3cao3-chu2gen1}{11,9,9,10}{⼑,⾋,⾩,⽊}
  \definition{expr.}{``Cortar a grama e arrancar as raízes.''; cortar as ervas daninhas e arrancar as raízes; eliminar a fonte do problema; erradicar; destruir pela raiz e pelo ramo}
  \synonymref{斩草除根}{zhan3cao3-chu2gen1}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{检测}{jian3ce4}{11,9}{⽊,⽔}[HSK 4]
  ...
  \synonymref{化验}{hua4yan4}
  \synonymref{监测}{jian1ce4}
  \synonymref{检查}{jian3cha2}
...
\begin{EntryWithPhonetic}{检查}{jian3cha2}{11,9}{⽊,⽊}[HSK 2]
  ...
  \synonymref{监测}{jian1ce4}
  \synonymref{检测}{jian3ce4}
  \synonymref{检讨}{jian3tao3}
  \synonymref{检验}{jian3yan4}
  \synonymref{审查}{shen3cha2}
  \seealsoref{查}{cha2}
  \seealsoref{检察}{jian3cha2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{简便}{jian3bian4}{13,9}{⽵,⼈}
  \definition{adj.}{simples e prático; conveniente}
...
\begin{EntryWithPhonetic}{建立者}{jian4li4 zhe3}{8,5,8}{⼵,⽴,⽼}
...
\begin{EntryWithPhonetic}{建筑工程师}{jian4zhu4 gong1cheng2 shi1}{8,12,3,12,6}{⼵,⽵,⼯,⽲,⼱}[HSK 5]
...
\begin{EntryWithPhonetic}{健身教练}{jian4shen1 jiao4lian4}{10,7,11,8}{⼈,⾝,⽁,⽷}[HSK 5]
...
\begin{EntryWithPhonetic}{鉴定}{jian4ding4}{13,8}{⾦,⼧}[HSK 6]
  ...
  \synonymref{评价}{ping2jia4}
  \antonymref{混淆}{hun4xiao2}
  \seealsoref{坚决}{jian1jue2}
  \seealsoref{鉴别}{jian4bie2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{将心比心}{jiang1xin1bi3xin1}{9,4,4,4}{⼨,⼼,⽐,⼼}[HSK 5]
...
\begin{EntryWithPhonetic}{讲课}{jiang3ke4}{6,10}{⾔,⾔}[HSK 6]
...
\begin{EntryWithPhonetic}{讲信用}{jiang3 xin4yong4}{6,9,5}{⾔,⼈,⽤}[HSK 5]
...
\begin{EntryWithPhonetic}{讲演}{jiang3yan3}{6,14}{⾔,⽔}
...
\begin{EntryWithPhonetic}{降价}{jiang4jia4}{8,6}{⾩,⼈}[HSK 4]
...
\begin{EntryWithPhonetic}{降温}{jiang4wen1}{8,12}{⾩,⽔}[HSK 4]
...
\begin{EntryWithPhonetic}{交通警察}{jiao1tong1jing3cha2}{6,10,19,14}{⼇,⾡,⾔,⼧}
...
\begin{EntryWithPhonetic}{教学}{jiao1xue2}{11,8}{⽁,⼦}
  \definition{v.}{ensinar; educar}
  \synonymref{传授}{chuan2shou4}
  \synonymref{教导}{jiao4dao3}
  \synonymref{教授}{jiao4shou4}
  \synonymref{教育}{jiao4yu4}
...
%%%%%%%%%% 侥 %%%%%%%%%%
\subsection*{侥}\addcontentsline{loh}{figure}{侥 \dpy{jiao3}}

\begin{EntryWithPhonetic}{侥}{jiao3}{8}{⼈}
  \definition{adj.}{por sorte; por um acaso | por pura sorte}
  \seeref{yao2}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{侥幸}{jiao3xing4}{8,8}{⼈,⼲}
...
\begin{EntryWithPhonetic}{饺子馆}{jiao3zi5 guan3}{9,3,11}{⾷,⼦,⾷}[HSK 5]
...
\begin{EntryWithPhonetic}{教会}{jiao4hui4}{11,6}{⽁,⼈}
  \definition{s.}{igreja; organizações de fiéis do catolicismo, da ortodoxia oriental, do protestantismo e de outras denominações}
  \seeref{jiao1hui4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{教师}{jiao4shi1}{11,6}{⽁,⼱}[HSK 2]
  ...
  \antonymref{学员}{xue2yuan2}
  \antonymref{学生}{xue2sheng5}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{教师宿舍}{jiao4shi1 su4she4}{11,6,11,8}{⽁,⼱,⼧,⾆}[HSK 5]
  \definition{s.}{alojamento dos professores; dormitório dos professores; acomodação fornecida pela escola destina"-se à moradia dos professores}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{教室}{jiao4shi4}{11,9}{⽁,⼧}[HSK 2]
  \definition[个,间]{s.}{sala de aula}
  \synonymref{课堂}{ke4tang2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{教学楼}{jiao4xue2 lou2}{11,8,13}{⽁,⼦,⽊}[HSK 1]
...
\begin{EntryWithPhonetic}{教育}{jiao4yu4}{11,8}{⽁,⾁}[HSK 2]
  ...
  \antonymref{引诱}{yin3you4}
  \seealsoref{教导}{jiao4dao3}
  \seealsoref{培养}{pei2yang3}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{教育部门}{jiao4yu4 bu4men2}{11,8,10,3}{⽁,⾁,⾢,⾨}[HSK 5]
  \definition{s.}{autoridade educacional; setor educacional; departamento de educação}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{教育对象}{jiao4yu4 dui4xiang4}{11,8,5,11}{⽁,⾁,⼨,⾗}[HSK 5]
  \definition{s.}{público"-alvo para educação; alvo educacional; estudante}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{教育工作者}{jiao4yu4 gong1zuo4 zhe3}{11,8,3,7,8}{⽁,⾁,⼯,⼈,⽼}[HSK 5]
  \definition{s.}{educador; profissional da educação}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{教育家}{jiao4yu4 jia1}{11,8,10}{⽁,⾁,⼧}[HSK 5]
  \definition[名,位]{s.}{educador, professor}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{教长}{jiao4zhang3}{11,4}{⽁,⾧}
  \definition{s.}{sacerdote; imã; decano}
  \synonymref{教育}{jiao4yu4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{结果}{jie1guo3}{9,8}{⽷,⽊}[HSK 7-9]
...
\begin{EntryWithPhonetic}{接待}{jie1dai4}{11,9}{⼿,⼻}[HSK 3]
  ...
  \seealsoref{招待}{zhao1dai4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{接待员}{jie1dai4 yuan2}{11,9,7}{⼿,⼻,⼝}[HSK 5]
  \definition[名,位,个]{s.}{recepcionista; pessoa que recebe visitantes, colegas de trabalho ou pacientes}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{接电话）}{jie1(dian4hua4)}{11,5,8}{⼿,⽥,⾔}
...
\begin{EntryWithPhonetic}{接轨}{jie1//gui3}{11,6}{⼿,⾞}[HSK 7-9]
  ...
  \definition{v.+compl.}{ligar; juntar; conectar os trilhos | integrar; juntar"-se a; mudar para; entrar na onda; alinhar"-se; alinhar a; descreve como sistemas e métodos podem ser interconectados e consistentes}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{接续}{jie1xu4}{11,11}{⼿,⽷}
  \definition{v.}{continuar; seguir; dar continuidade ao ponto anterior; prosseguir}
...
\begin{EntryWithPhonetic}{街道}{jie1dao4}{12,12}{⾏,⾡}[HSK 4]
  ...
  \synonymref{大街}{da4jie1}
  \synonymref{道路}{dao4lu4}
  \synonymref{马路}{ma3lu4}
  \seealsoref{街}{jie1}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{街道办事处}{jie1dao4 ban4shi4 chu4}{12,12,4,8,5}{⾏,⾡,⼒,⼅,⼡}[HSK 5]
  \definition{s.}{escritório de bairro; funcionário que trabalha com moradores locais para reportar a autoridades governamentais superiores; representante do bairro; escritório do subdistrito}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{街头}{jie1tou2}{12,5}{⾏,⼤}[HSK 6]
  \definition{s.}{rua; esquina da rua}
  \synonymref{路口}{lu4kou3}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{节能}{jie2neng2}{5,10}{⾋,⾁}[HSK 6]
...
\begin{EntryWithPhonetic}{结婚戒指}{jie2hun1 jie4zhi3}{9,11,7,9}{⽷,⼥,⼽,⼿}[HSK 5]
...
\begin{EntryWithPhonetic}{结婚礼服}{jie2hun1 li3fu2}{9,11,5,8}{⽷,⼥,⽰,⽉}
  \definition{s.}{vestido de casamento; vestido de noiva}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{结婚礼物}{jie2hun1 li3wu4}{9,11,5,8}{⽷,⼥,⽰,⽜}[HSK 5]
...
\begin{EntryWithPhonetic}{结束辩论}{jie2shu4 bian4lun4}{9,7,16,6}{⽷,⽊,⾟,⾔}
  \definition{s.}{debate de encerramento}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{结束工作}{jie2shu4 gong1zuo4}{9,7,3,7}{⽷,⽊,⼯,⼈}
...
\begin{EntryWithPhonetic}{结业}{jie2//ye4}{9,5}{⽷,⼀}
...
\begin{EntryWithPhonetic}{捷径}{jie2jing4}{11,8}{⼿,⼻}
  \definition[条]{s.}{um atalho; uma estrada real; um atalho é um meio ou método inteligente que permite atingir um objetivo mais rapidamente}
  \synonymref{便捷}{bian4jie2}
  \synonymref{窍门}{qiao4men2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{解开}{jie3kai1}{13,4}{⾓,⼶}[HSK 3]
...
\begin{EntryWithPhonetic}{解释}{jie3shi4}{13,12}{⾓,⾤}[HSK 4]
  ...
  \synonymref{解说}{jie3shuo1}
  \synonymref{说明}{shuo1ming2}
  \seealsoref{解答}{jie3da2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{解说员}{jie3shuo1 yuan2}{13,9,7}{⾓,⾔,⼝}[HSK 5]
  \definition{s.}{narrador; locutor; comentarista; profissionais especializados em fornecer comentários, apresentações e análises de eventos esportivos}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{解压}{jie3ya1}{13,6}{⾓,⼚}
  \definition{v.}{aliviar o estresse; aliviar o estresse e eliminar a tensão e a ansiedade | Computação: descomprimir; o arquivo está compactado, reduzindo seu espaço de armazenamento, mas não pode ser usado diretamente}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{介绍人}{jie4shao4 ren2}{4,8,2}{⼈,⽷,⼈}[HSK 5]
...
\begin{EntryWithPhonetic}{介意}{jie4yi4}{4,13}{⼈,⼼}[HSK 7-9]
...
%%%%%%%%%% 价 %%%%%%%%%%
\subsection*{价}\addcontentsline{loh}{figure}{价 \dpy{jie4}}

\begin{EntryWithPhonetic}{价}{jie4}{6}{⼈}
...
\begin{EntryWithPhonetic}{戒烟}{jie4yan1}{7,10}{⼽,⽕}[HSK 7-9]
...
%%%%%%%%%% 价 %%%%%%%%%%
\subsection*{价}\addcontentsline{loh}{figure}{价 \dpy{jie5}}

\begin{EntryWithPhonetic}{价}{jie5}{6}{⼈}
...
\begin{EntryWithPhonetic}{金色}{jin1se4}{8,6}{⾦,⾊}
...
\begin{EntryWithPhonetic}{仅次于}{jin3ci4yu2}{4,6,3}{⼈,⽋,⼆}[HSK 7-9]
...
\begin{EntryWithPhonetic}{尽管……还是}{jin3guan3 hai2shi4}{6,14,7,9}{⼫,⽵,⾡,⽇}
  \definition{conj.}{apesar de\dots ainda; embora\dots ainda assim}
  \seealsoref{虽然……但是}{sui1ran2 dan4shi4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{尽可能}{jin3 ke3neng2}{6,5,10}{⼫,⼝,⾁}[HSK 5]
...
\begin{EntryWithPhonetic}{紧接着}{jin3jie1zhe5}{10,11,11}{⽷,⼿,⽬}[HSK 7-9]
...
\begin{EntryWithPhonetic}{锦上添花}{jin3shang4tian1hua1}{13,3,11,7}{⾦,⼀,⽔,⾋}
  \definition{expr.}{adicionar flores ao brocado, tornar o que é bom ainda melhor; melhorar | dourando o lírio}
\end{EntryWithPhonetic}

%%%%%%%%%% 仅 %%%%%%%%%%
\subsection*{仅}\addcontentsline{loh}{figure}{仅 \dpy{jin4}}

\begin{EntryWithPhonetic}{仅}{jin4}{4}{⼈}
...
\begin{EntryWithPhonetic}{尽量}{jin4liang4}{6,12}{⼫,⾥}
...
\begin{EntryWithPhonetic}{近年来}{jin4nian2lai2}{7,6,7}{⾡,⼲,⽊}[HSK 7-9]
...
\begin{EntryWithPhonetic}{进出口}{jin4chu1kou3}{7,5,3}{⾡,⼐,⼝}[HSK 7-9]
...
\begin{EntryWithPhonetic}{进来}{jin4lai2}{7,7}{⾡,⽊}[HSK 1]
...
\begin{EntryWithPhonetic}{进去}{jin4qu4}{7,5}{⾡,⼛}[HSK 1]
...
\begin{EntryWithPhonetic}{进行编程}{jin4xing2 bian1cheng2}{7,6,12,12}{⾡,⾏,⽷,⽲}
...
\begin{EntryWithPhonetic}{京剧演员}{jing1ju4 yan3yuan2}{8,10,14,7}{⼇,⼑,⽔,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{经济部门}{jing1ji4 bu4men2}{8,9,10,3}{⽷,⽔,⾢,⾨}[HSK 5]
...
\begin{EntryWithPhonetic}{经理办公室}{jing1li3 ban4gong1shi4}{8,11,4,4,9}{⽷,⽟,⼒,⼋,⼧}[HSK 5]
...
\begin{EntryWithPhonetic}{经营者}{jing1ying2 zhe3}{8,11,8}{⽷,⾋,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{鲸鲨}{jing1sha1}{16,15}{⿂,⿂}
  \definition[头,群]{s.}{tubarão"-baleia}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{鲸鱼}{jing1yu2}{16,8}{⿂,⿂}
  \definition[条]{s.}{baleia}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{景点}{jing3dian3}{12,9}{⽇,⽕}[HSK 6]
  ...
  \synonymref{景区}{jing3qu1}
  \synonymref{名胜}{ming2sheng4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{景色}{jing3se4}{12,6}{⽇,⾊}[HSK 3]
  ...
  \synonymref{风光}{feng1guang1}
  \synonymref{风景}{feng1jing3}
  \synonymref{景观}{jing3guan1}
...
\begin{EntryWithPhonetic}{警}{jing3}{19}{⾔}
  \definition{adj.}{alerta; vigilante}
  \definition{s.}{alarme | polícia; policial; abeviação de 交通警察}
  \definition{v.}{avisar; alarmar; alertar | proteger contra; guarnecer}
  \seealsoref{交通警察}{jiao1tong1jing3cha2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{警察局}{jing3cha2 ju2}{19,14,7}{⾔,⼧,⼫}[HSK 5]
  \definition{s.}{delegacia de polícia; departamento de polícia; sede do departamento de polícia municipal}
  \synonymref{公安局}{gong1'an1ju2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{竞争对手}{jing4zheng1 dui4shou3}{10,6,5,4}{⽴,⼑,⼨,⼿}[HSK 5]
  \definition{s.}{concorrente | rival}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{竞争者}{jing4zheng1 zhe3}{10,6,8}{⽴,⼑,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{镜花缘}{jing4hua1 yuan2}{16,7,12}{⾦,⾋,⽷}
  \definition*{s.}{Jinghua Yuan ou Flores no Espelho, romance de fantasia e erudição da dinastia Qing (início do século XIX) de Li Ruzhen (李汝珍)}
...
\begin{EntryWithPhonetic}{九鼎}{jiu3ding3}{2,12}{⼄,⿍}
  \definition{s.}{conjunto de nove grandes caldeirões tripés que, segundo a lenda, foram fundidos pelo Rei Yu (夏禹) e transmitidos como tesouro de Estado | grande peso; coisa de grande valor}
  \definition{s.}{Os Nove Caldeirões Tripés, símbolo do poder estatal, que remontam à Dinastia Xia}
  \seealsoref{夏禹}{xia4yu3}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{久而久之}{jiu3'er2jiu3zhi1}{3,6,3,3}{⼃,⽽,⼃,⼂}[HSK 5]
  \definition{expr.}{a longo prazo; com o tempo; eventualmente; após um período considerável de tempo; com o passar do tempo; conforme o tempo passa; à medida que o tempo passa}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{旧址}{jiu4zhi3}{5,7}{⽇,⼟}
...
\begin{EntryWithPhonetic}{救出}{jiu4chu1}{11,5}{⽁,⼐}
  \definition{v.}{arrancar do perigo | resgatar}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{救灾}{jiu4zai1}{11,7}{⽁,⽕}[HSK 5]
...
\begin{EntryWithPhonetic}{救助}{jiu4zhu4}{11,7}{⽁,⼒}[HSK 6]
  ...
  \synonymref{援助}{yuan2zhu4}
  \synonymref{拯救}{zheng3jiu4}
  \antonymref{毒害}{du2hai4}
  \seealsoref{帮助}{bang1zhu4}
  \seealsoref{救济}{jiu4ji4}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{就可以了}{jiu4 ke3yi3 le5}{12,5,4,2}{⼪,⼝,⼈,⼅}
...
\begin{EntryWithPhonetic}{就是}{jiu4shi4}{12,9}{⼪,⽇}[HSK 3]
  ...
  \definition{conj.}{ainda que; mesmo que se reconheça que essa situação é verdadeira, a situação posterior não mudará | frequentemente usadas com 也 | usado na linguagem falada}
  \definition{part.}{usado no final de uma frase para expressar afirmação}
  \synonymref{便是}{bian4shi4}
...
\begin{EntryWithPhonetic}{菊花}{ju2hua1}{11,7}{⾋,⾋}[HSK 7-9]
  \definition[朵,枝,把,束,棵,株]{s.}{crisântemo | Gíria: ânus (ou reto) humano}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{举办者}{ju3ban4 zhe3}{9,4,8}{⼂,⼒,⽼}[HSK 5]
...
\begin{EntryWithPhonetic}{举手}{ju3shou3}{9,4}{⼂,⼿}[HSK 2]
...
\begin{EntryWithPhonetic}{举一反三}{ju3yi1fan3san1}{9,1,4,3}{⼂,⼀,⼜,⼀}[HSK 7-9]
...
\begin{EntryWithPhonetic}{决无}{jue2wu2}{6,4}{⼎,⽆}
...
\begin{EntryWithPhonetic}{军事博物馆}{jun1shi4 bo2wu4guan3}{6,8,12,8,11}{⼍,⼅,⼗,⽜,⾷}[HSK 5]
  \definition{s.}{museu militar}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{军事专家}{jun1shi4 zhuan1jia1}{6,8,4,10}{⼍,⼅,⼀,⼧}[HSK 5]
