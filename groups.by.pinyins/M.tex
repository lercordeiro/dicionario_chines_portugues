...
\begin{EntryWithPhonetic}{妈妈}{ma1ma5}{6,6}{⼥,⼥}[HSK 1]
...
\begin{EntryWithPhonetic}{马车}{ma3che1}{3,4}{⾺,⾞}[HSK 6]
...
\begin{EntryWithPhonetic}{马克思列宁主义}{ma3ke4si1lie4ning2zhu3yi4}{3,7,9,6,5,5,3}{⾺,⼗,⼼,⼑,⼧,⼂,⼂}
...
\begin{EntryWithPhonetic}{码头}{ma3tou5}{8,5}{⽯,⼤}[HSK 5]
...
\begin{EntryWithPhonetic}{骂大街}{ma4da4jie1}{9,3,12}{⾺,⼤,⾏}
...
\begin{EntryWithPhonetic}{买不起}{mai3 bu5qi3}{6,4,10}{⼄,⼀,⾛}[HSK 7-9]
...
\begin{EntryWithPhonetic}{买卖}{mai3mai4}{6,8}{⼄,⼗}[HSK 5]
...
\begin{EntryWithPhonetic}{买卖}{mai3mai5}{6,8}{⼄,⼗}
...
\begin{EntryWithPhonetic}{麦克风}{mai4ke4feng1}{7,7,4}{⿆,⼗,⾵}[HSK 5]
...
\begin{EntryWithPhonetic}{嫚骂}{man4 ma4}{14,9}{⼥,⾺}
...
\begin{EntryWithPhonetic}{慢车}{man4che1}{14,4}{⼼,⾞}[HSK 6]
...
\begin{EntryWithPhonetic}{慢慢}{man4man4}{14,14}{⼼,⼼}[HSK 3]
...
\begin{EntryWithPhonetic}{慢慢来}{man4man4lai2}{14,14,7}{⼼,⼼,⽊}[HSK 7-9]
...
\begin{EntryWithPhonetic}{漫步}{man4bu4}{14,7}{⽔,⽌}
...
\begin{EntryWithPhonetic}{蔓延}{man4yan2}{14,6}{⾋,⼵}[HSK 7-9]
  \definition{v.}{espalhar; esticar; estender | infestar; espalhar; descreve coisas que se estendem e se expandem para fora como trepadeiras rastejantes}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{忙得}{mang2 de2}{6,11}{⼼,⼻}
  \definition{adj.}{muito ocupado}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{忙得团团转}{mang2 de2 tuan2tuan2zhuan4}{6,11,6,6,8}{⼼,⼻,⼞,⼞,⾞}[HSK 5]
...
\begin{EntryWithPhonetic}{盲人}{mang2ren2}{8,2}{⽬,⼈}[HSK 6]
...
\begin{EntryWithPhonetic}{毛笔}{mao2bi3}{4,10}{⽑,⽵}[HSK 5]
...
\begin{EntryWithPhonetic}{毛衣}{mao2yi1}{4,6}{⽑,⾐}[HSK 4]
...
\begin{EntryWithPhonetic}{茅台酒}{mao2tai2jiu3}{8,5,10}{⾋,⼝,⾣}
...
\begin{EntryWithPhonetic}{冒顿单于}{mao4dun4 chan2yu2}{9,10,8,3}{⽇,⾴,⼗,⼆}
...
\begin{EntryWithPhonetic}{冒险家}{mao4xian3 jia1}{9,9,10}{⽇,⾩,⼧}[HSK 5]
...
\begin{EntryWithPhonetic}{贸易公司}{mao4yi4 gong1si1}{9,8,4,5}{⾙,⽇,⼋,⼝}[HSK 5]
...
\begin{EntryWithPhonetic}{没错}{mei2cuo4}{7,13}{⽔,⾦}[HSK 4]
...
\begin{EntryWithPhonetic}{没红过脸}{mei2 hong2guo4 lian3}{7,6,6,11}{⽔,⽷,⾡,⾁}[HSK 5]
...
\begin{EntryWithPhonetic}{没了}{mei2 le5}{7,2}{⽔,⼅}
  \definition{v.}{não ser ou deixar de existir | estar morto}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{没什么}{mei2shen2me5}{7,4,3}{⽔,⼈,⼃}[HSK 1]
  \definition{expr.}{não é nada; está tudo bem; não importa}
  \synonymref{不要紧}{bu2yao4jin3}
  \synonymref{没关系}{mei2guan1xi5}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{没事儿}{mei2shi4r5}{7,8,2}{⽔,⼅,⼉}[HSK 1]
...
\begin{EntryWithPhonetic}{没戏}{mei2//xi4}{7,6}{⽔,⼽}
...
\begin{EntryWithPhonetic}{没想到}{mei2 xiang3dao4}{7,13,8}{⽔,⼼,⼑}[HSK 4]
  \definition{expr.}{não esperava; inesperado}
  \seealsoref{不料}{bu2liao4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{没意思}{mei2yi4si5}{7,13,9}{⽔,⼼,⼼}[HSK 7-9]
...
\begin{EntryWithPhonetic}{没有关系}{mei2you3 guan1xi5}{7,6,6,7}{⽔,⽉,⼋,⽷}
  \definition{expr.}{Está tudo bem; sem problemas}
  \seealsoref{没关系}{mei2guan1xi5}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{没有哪一种东西}{mei2you3 na3 yi4zhong3 dong1xi1}{7,6,9,1,9,5,6}{⽔,⽉,⼝,⼀,⽲,⼀,⾑}
...
\begin{EntryWithPhonetic}{没有意思}{mei2you3 yi4si5}{7,6,13,9}{⽔,⽉,⼼,⼼}
  \definition{adj.}{entediante; desinteressante}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{没有}{mei2you5}{7,6}{⽔,⽉}[HSK 1]
...
\begin{EntryWithPhonetic}{梅花}{mei2hua1}{11,7}{⽊,⾋}[HSK 6]
...
\begin{EntryWithPhonetic}{煤气}{mei2qi4}{13,4}{⽕,⽓}[HSK 5]
...
\begin{EntryWithPhonetic}{每个人}{mei3ge5 ren2}{7,3,2}{⽏,⼈,⼈}
...
\begin{EntryWithPhonetic}{美国人}{mei3guo2 ren2}{9,8,2}{⽺,⼞,⼈}
  \definition[个,位,名]{s.}{americano | pessoa ou povo dos Estados Unidos da América}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{美好}{mei3hao3}{9,6}{⽺,⼥}[HSK 3]
...
\begin{EntryWithPhonetic}{美金}{mei3jin1}{9,8}{⽺,⾦}[HSK 4]
...
\begin{EntryWithPhonetic}{美女}{mei3nv3}{9,3}{⽺,⼥}[HSK 4]
...
\begin{EntryWithPhonetic}{美洲人}{mei3zhou1 ren2}{9,9,2}{⽺,⽔,⼈}
...
\begin{EntryWithPhonetic}{妹妹}{mei4mei5}{8,8}{⼥,⼥}[HSK 1]
  \definition[个]{s.}{irmã mais nova}
  \synonymref{姐妹}{jie3mei4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{妹丈}{mei4zhang4}{8,3}{⼥,⼀}
  \definition{s.}{marido da irmã mais nova; cunhado}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{门口}{men2kou3}{3,3}{⾨,⼝}[HSK 1]
...
\begin{EntryWithPhonetic}{门票}{men2piao4}{3,11}{⾨,⽰}[HSK 1]
...
\begin{EntryWithPhonetic}{门诊}{men2zhen3}{3,7}{⾨,⾔}[HSK 5]
...
\begin{EntryWithPhonetic}{蒙城}{meng2cheng2}{13,9}{⾋,⼟}
...
%%%%%%%%%% 孟 %%%%%%%%%%
\subsection*{孟}\addcontentsline{loh}{figure}{孟 \dpy{meng4}}

\begin{EntryWithPhonetic}{孟}{meng4}{8}{⼦}
  \definition*{s.}{Sobrenome: Meng}
  \definition{s.}{o primeiro mês de uma estação | Obsoleto: o mais velho entre os irmãos}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{孟子}{meng4zi3}{8,3}{⼦,⼦}
...
\begin{EntryWithPhonetic}{梦见}{meng4jian4}{11,4}{⼣,⾒}[HSK 4]
...
%%%%%%%%%% 眯 %%%%%%%%%%
\subsection*{眯}\addcontentsline{loh}{figure}{眯 \dpy{mi3}}

\begin{EntryWithPhonetic}{眯}{mi3}{11}{⽬}
...
\begin{EntryWithPhonetic}{秘书长}{mi4shu1zhang3}{10,4,4}{⽲,⼄,⾧}
...
%%%%%%%%%% 眯 %%%%%%%%%%
\subsection*{眯}\addcontentsline{loh}{figure}{眯 \dpy{mi4}}

\begin{EntryWithPhonetic}{眯}{mi4}{11}{⽬}
...
\begin{EntryWithPhonetic}{棉}{mian2}{12}{⽊}[HSK 6]
...
\begin{EntryWithPhonetic}{面对面}{mian4dui4mian4}{9,5,9}{⾯,⼨,⾯}[HSK 6]
  \definition{adj./expr.}{frente a frente; cara a cara; vis"-à"-vis}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{面对面吃面}{mian4dui4mian4 chi1mian4}{9,5,9,6,9}{⾯,⼨,⾯,⼝,⾯}
...
\begin{EntryWithPhonetic}{面前}{mian4qian2}{9,9}{⾯,⼑}[HSK 2]
...
\begin{EntryWithPhonetic}{面试}{mian4shi4}{9,8}{⾯,⾔}[HSK 4]
...
\begin{EntryWithPhonetic}{面条儿}{mian4tiao2r5}{9,7,2}{⾯,⽊,⼉}[HSK 1]
...
\begin{EntryWithPhonetic}{面团儿}{mian4tuan2r5}{9,6,2}{⾯,⼞,⼉}
  \definition{s.}{massa; pedaço de massa}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{面向}{mian4xiang4}{9,6}{⾯,⼝}[HSK 6]
...
\begin{EntryWithPhonetic}{描述}{miao2shu4}{11,8}{⼿,⾡}[HSK 4]
...
\begin{EntryWithPhonetic}{民歌}{min2ge1}{5,14}{⽒,⽋}[HSK 6]
...
\begin{EntryWithPhonetic}{民工}{min2gong1}{5,3}{⽒,⼯}[HSK 6]
...
\begin{EntryWithPhonetic}{民警}{min2jing3}{5,19}{⽒,⾔}[HSK 6]
...
\begin{EntryWithPhonetic}{民意}{min2yi4}{5,13}{⽒,⼼}[HSK 6]
...
%%%%%%%%%% 闽 %%%%%%%%%%
\subsection*{闽}\addcontentsline{loh}{figure}{闽 \dpy{min3}}

\begin{EntryWithPhonetic}{闽}{min3}{9}{⾨}
...
\begin{EntryWithPhonetic}{名称}{ming2cheng1}{6,10}{⼝,⽲}[HSK 2]
...
\begin{EntryWithPhonetic}{名单}{ming2dan1}{6,8}{⼝,⼗}[HSK 2]
...
\begin{EntryWithPhonetic}{名流}{ming2liu2}{6,10}{⼝,⽔}
...
\begin{EntryWithPhonetic}{名牌服装}{ming2pai2 fu2zhuang1}{6,12,8,12}{⼝,⽚,⽉,⾐}[HSK 5]
  \definition{s.}{roupas de grife; roupas de marca}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{名牌儿}{ming2pai2r5}{6,12,2}{⼝,⽚,⼉}[HSK 4]
...
\begin{EntryWithPhonetic}{名人}{ming2ren2}{6,2}{⼝,⼈}[HSK 4]
...
\begin{EntryWithPhonetic}{名胜}{ming2sheng4}{6,9}{⼝,⾁}[HSK 6]
...
\begin{EntryWithPhonetic}{名胜古迹}{ming2sheng4 gu3ji4}{6,9,5,9}{⼝,⾁,⼝,⾡}[HSK 5]
...
\begin{EntryWithPhonetic}{名义}{ming2yi4}{6,3}{⼝,⼂}[HSK 6]
...
\begin{EntryWithPhonetic}{明亮}{ming2liang4}{8,9}{⽇,⼇}[HSK 5]
...
\begin{EntryWithPhonetic}{明年}{ming2nian2}{8,6}{⽇,⼲}[HSK 1]
...
\begin{EntryWithPhonetic}{明日}{ming2ri4}{8,4}{⽇,⽇}[HSK 6]
  \definition{s.}{amanhã}
...
\begin{EntryWithPhonetic}{明信片}{ming2xin4pian4}{8,9,4}{⽇,⼈,⽚}[HSK 5]
...
\begin{EntryWithPhonetic}{摸不着头脑}{mo1 bu4zhao2 tou2nao3}{13,4,11,5,10}{⼿,⼀,⽬,⼤,⾁}[HSK 5]
...
\begin{EntryWithPhonetic}{摸}{mo2}{13}{⼿}
...
\begin{EntryWithPhonetic}{模特儿}{mo2te4r5}{14,10,2}{⽊,⽜,⼉}[HSK 4]
...
\begin{EntryWithPhonetic}{摩托}{mo2tuo1}{15,6}{⼿,⼿}[HSK 5]
...
%%%%%%%%%% 万 %%%%%%%%%%
\subsection*{万}\addcontentsline{loh}{figure}{万 \dpy{mo4}}

\begin{EntryWithPhonetic}{万}{mo4}{3}{⼀}
  \definition{s.}{elemento formador de palavras}
  \seeref{wan4}
\end{EntryWithPhonetic}

\begin{EntryWithPhonetic}{万俟}{mo4qi2}{3,9}{⼀,⼈}
...
\begin{EntryWithPhonetic}{没收}{mo4shou1}{7,6}{⽔,⽁}[HSK 6]
...
\begin{EntryWithPhonetic}{陌生人}{mo4sheng1 ren2}{8,5,2}{⾩,⽣,⼈}[HSK 5]
  \definition[个,位,名,些]{s.}{estranho; pessoas desconhecidas}
\end{EntryWithPhonetic}

%%%%%%%%%% 冒 %%%%%%%%%%
\subsection*{冒}\addcontentsline{loh}{figure}{冒 \dpy{mo4}}

\begin{EntryWithPhonetic}{冒}{mo4}{9}{⽇}
...
\begin{EntryWithPhonetic}{墨水}{mo4shui3}{15,4}{⿊,⽔}[HSK 6]
  \definition[瓶]{s.}{tinta chinesa preparada; tinta (para caneta"-tinteiro) | aprendizagem; alfabetização; conhecimento ou capacidade de ler e escrever}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{默默}{mo4mo4}{16,16}{⿊,⿊}[HSK 4]
  ...
  \synonymref{沉默}{chen2mo4}
  \synonymref{悄悄}{qiao1qiao1}
  \antonymref{高调}{gao1diao4}
  \antonymref{喧哗}{xuan1hua2}
  \antonymref{张扬}{zhang1yang2}
\end{EntryWithPhonetic}
...
\begin{EntryWithPhonetic}{某些}{mou3xie1}{9,8}{⽊,⼆}
...
\begin{EntryWithPhonetic}{母子}{mu3zi3}{5,3}{⽏,⼦}[HSK 6]
...
\begin{EntryWithPhonetic}{木头桌子}{mu4tou5 zhuo1zi5}{4,5,10,3}{⽊,⼤,⽊,⼦}[HSK 5]
...
\begin{EntryWithPhonetic}{目光短浅}{mu4guang1duan3qian3}{5,6,12,8}{⽬,⼉,⽮,⽔}[HSK 5]
...
\begin{EntryWithPhonetic}{墓}{mu4}{13}{⼟}[HSK 6]
...
\begin{EntryWithPhonetic}{墓园}{mu4yuan2}{13,7}{⼟,⼞}
