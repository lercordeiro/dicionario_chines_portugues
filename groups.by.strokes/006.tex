...
\begin{Entry}{买卖}{6,8}{⼄,⼗}
  \begin{Phonetics}{买卖}{mai3mai4}[][HSK 5]
...
\begin{Entry}{争议}{6,5}{⼑,⾔}
  ...
  \antonymref{共识}{gong4shi2}
  \antonymref{让步}{rang4//bu4}
  \antonymref{退让}{tui4rang4}
...
\begin{Entry}{争先恐后}{6,6,10,6}{⼑,⼉,⼼,⼝}
  ...
  \antonymref{七上八下}{qi1 shang4 ba1 xia4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{争夺}{6,6}{⼑,⼤}
  ...
  \synonymref{夺取}{duo2qu3}
  \synonymref{掠夺}{lve4duo2}
  \synonymref{抢夺}{qiang3duo2}
  \synonymref{争取}{zheng1qu3}
  \antonymref{礼让}{li3rang4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{争取}{6,8}{⼑,⼜}
  ...
  \synonymref{夺取}{duo2qu3}
  \synonymref{力求}{li4qiu2}
  \synonymref{力争}{li4zheng1}
  \synonymref{谋求}{mou2qiu2}
  \synonymref{争夺}{zheng1duo2}
...
\begin{Entry}{亚运会}{6,7,6}{⼆,⾡,⼈}
  ...
  \seealsoref{亚洲运动会}{ya4zhou1 yun4dong4hui4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{亚洲人}{6,9,2}{⼆,⽔,⼈}
  \begin{Phonetics}{亚洲人}{ya4zhou1 ren2}[][HSK 5]
    \definition{s.}{asiático | pessoa ou povo da Ásia}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{亚洲运动会}{6,9,7,6,6}{⼆,⽔,⾡,⼒,⼈}
  \begin{Phonetics}{亚洲运动会}{ya4zhou1 yun4dong4hui4}
    \definition*{s.}{Jogos Asiáticos}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{价}{6}{⼈}
  ...
  \end{Phonetics}
  \begin{Phonetics}{价}{jie4}
    \definition{s.}{mensageiro; pessoa referida como aquela que entrega coisas ou transmite mensagens}
  \end{Phonetics}
  \begin{Phonetics}{价}{jie5}
    \definition{part.}{usado após um advérbio negativo para reforçar o tom; usado entre uma expressão adverbial e um verbo ou adjetivo, é equivalente a 地}[别价，这事好商量。===Não faça isso, isso é negociável.]
    \definition{suf.}{adicionado a certas palavras para indicar que a palavra é um adjunto adverbial; usado após um advérbio negativo que aparece sozinho na frase para reforçar o tom}[她认真价做功课。===Ela fez a lição de casa com diligência.]
  \seealsoref{地}{de5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{价值连城}{6,10,7,9}{⼈,⼈,⾡,⼟}
  \begin{Phonetics}{价值连城}{jia4zhi2 lian2cheng2}[][HSK 5]
    \definition{expr.}{vale várias cidades; inestimável; de valor inestimável; item cujo preço é tão alto que poderia valer o equivalente a várias cidades é usado para descrever algo extremamente valioso}
...
\begin{Entry}{任务}{6,5}{⼈,⼒}
  \begin{Phonetics}{任务}{ren4wu4}[][HSK 3]
...
\begin{Entry}{企业家}{6,5,10}{⼈,⼀,⼧}
  \begin{Phonetics}{企业家}{qi3ye4 jia1}[][HSK 5]
    \definition[名,位]{s.}{empreendedor; pessoa especializada em operações empresariais e que alcançou sucesso considerável}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{休闲}{6,7}{⼈,⾨}
  ...
  \synonymref{空地}{kong1di4}
  \synonymref{空地}{kong4di4}
  \synonymref{消遣}{xiao1qian3}
  \antonymref{耕地}{geng1//di4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{休闲中心}{6,7,4,4}{⼈,⾨,⼁,⼼}
  \begin{Phonetics}{休闲中心}{xiu1xian2 zhong1xin1}[][HSK 5]
    \definition{s.}{centro de Lazer}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{众志成城}{6,7,6,9}{⼈,⼼,⼽,⼟}
  \begin{Phonetics}{众志成城}{zhong4zhi4-cheng2cheng2}[][HSK 7-9]
    \definition{expr.}{``A unidade de vontade é uma fortaleza inexpugnável.''; quando todos trabalham juntos com um só coração e uma só mente, o resultado é tão sólido quanto uma muralha; a união nos permite superar dificuldades e alcançar o sucesso; a união é uma fortaleza inexpugnável; ``A união faz a força.'' ou ``Unidos venceremos.''}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{优惠}{6,12}{⼈,⼼}
  \begin{Phonetics}{优惠}{you1hui4}[][HSK 5]
    \definition{adj.}{especial; pechincha; reduzido; com desconto | favorável; preferencial; melhores condições ou tratamento do que o normal, permitindo que as pessoas obtenham mais benefícios | refere"-se a descontos ou promoções oferecidos pelos vendedores}
  \seealsoref{实惠}{shi2hui4}
...
\begin{Entry}{伙计}{6,4}{⼈,⾔}
  \begin{Phonetics}{伙计}{huo3ji5}
    \definition[个]{s.}{parceiro; refere"-se a pessoas que operam conjuntamente um negócio ou indústria; também se refere, de forma geral, a sócios que trabalham juntos (com um senso de intimidade) | garçom; funcionário; antigamente, referia"-se a um balconista ou a um trabalhador de longa duração}
  \synonymref{伴侣}{ban4lv3}
  \synonymref{搭档}{da1dang4}
  \synonymref{店员}{dian4yuan2}
...
\begin{Entry}{会议室}{6,5,9}{⼈,⾔,⼧}
  \begin{Phonetics}{会议室}{hui4yi4 shi4}[][HSK 5]
    \definition{s.}{sala de reuniões; sala de conferências}
  \synonymref{办公室}{ban4gong1shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{会员}{6,7}{⼈,⼝}
  ...
  \synonymref{成员}{cheng2yuan2}
  \synonymref{队员}{dui4yuan2}
  \synonymref{股东}{gu3dong1}
  \synonymref{团员}{tuan2yuan2}
  \synonymref{委员}{wei3yuan2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{伤痕}{6,11}{⼈,⽧}
  \begin{Phonetics}{伤痕}{shang1hen2}[][HSK 7-9]
    \definition[道,处]{s.}{cicatriz; ferida; também se refere a uma marca deixada após um objeto ter sido danificado | cicatriz; ferida; trauma psicológico}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{充分}{6,4}{⼉,⼑}
  ...
  \seealsoref{充实}{chong1shi2}
  \seealsoref{充足}{chong1zu2}
  \synonymref{饱和}{bao3he2}
...
\begin{Entry}{先生}{6,5}{⼉,⽣}
  \begin{Phonetics}{先生}{xian1sheng5}[][HSK 1]
    \definition[个,位,名,些]{s.}{professor; títulos honoríficos para professores, médicos, etc. | marido; antigamente, referia"-se ao marido de outra pessoa ou ao próprio marido (ambos com pronomes pessoais como determinantes) | médico; títulos usados para se referir aos médicos no passado | refere"-se a pessoas cuja profissão envolve contar histórias, adivinhação, etc.; antigamente, era chamado de contador | senhor; \emph{sir}; título dado aos intelectuais}
...
\begin{Entry}{光明}{6,8}{⼉,⽇}
  \begin{Phonetics}{光明}{guang1ming2}[][HSK 3]
    \definition{adj.}{brilhante; luminoso | sincero; ingênuo; justiça e esperança | justo; honesto; franco}
    \definition{s.}{luz}
...
\begin{Entry}{光环}{6,8}{⼉,⽟}
  \begin{Phonetics}{光环}{guang1huan2}[][HSK 7-9]
    \definition[道]{s.}{um anel de luz; matéria brilhante ao redor de alguns planetas | halo; auréola; o halo anular na cabeça de uma divindade | um halo colorido que às vezes aparece ao redor do sol ou da lua | glória; distinção; esplendor; fama e honra}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{光亮}{6,9}{⼉,⼇}
  \begin{Phonetics}{光亮}{guang1liang4}
...
\begin{Entry}{光辉}{6,12}{⼉,⾞}
  ...
  \seealsoref{光芒}{guang1mang2}
  \seealsoref{辉煌}{hui1huang2}
  \synonymref{灿烂}{can4lan4}
  \synonymref{光彩}{guang1cai3}
  \synonymref{光环}{guang1huan2}
  \synonymref{光明}{guang1ming2}
  \synonymref{光泽}{guang1ze2}
  \antonymref{凄惨}{qi1can3}
  \antonymref{阴影}{yin1ying3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{全世界}{6,5,9}{⼊,⼀,⽥}
  \begin{Phonetics}{全世界}{quan2 shi4jie4}[][HSK 5]
...
\begin{Entry}{全都}{6,10}{⼊,⾢}
  ...
  \synonymref{全部}{quan2bu4}
  \synonymref{全体}{quan2ti3}
  \synonymref{通通}{tong1tong1}
  \synonymref{统统}{tong3tong3}
  \synonymref{无不}{wu2bu4}
  \synonymref{悉数}{xi1shu4}
  \antonymref{个别}{ge4bie2}
  \antonymref{局部}{ju2bu4}
...
\begin{Entry}{全球}{6,11}{⼊,⽟}
  ...
  \synonymref{国际}{guo2ji4}
  \synonymref{环球}{huan2qiu2}
...
\begin{Entry}{共鸣}{6,8}{⼋,⿃}
  \begin{Phonetics}{共鸣}{gong4ming2}[][HSK 7-9]
    \definition{s.}{ressonância; fenômeno que ocorre quando um objeto ressoa, por exemplo, quando dois diapasões com a mesma frequência são colocados próximos um do outro, quando um vibra e emite um som, o outro também emite um som | resposta simpática; ter as mesmas emoções que outra pessoa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{关于}{6,3}{⼋,⼆}
  ...
  \seealsoref{对于}{dui4yu2}
  \seealsoref{有关}{you3guan1}
  \seealsoref{至于}{zhi4yu2}
...
\begin{Entry}{关闭}{6,6}{⼋,⾨}
  ...
  \synonymref{封闭}{feng1bi4}
  \synonymref{关机}{guan1ji1}
...
\begin{Entry}{关键}{6,13}{⼋,⾦}
  ...
  \synonymref{根本}{gen1ben3}
  \synonymref{关节}{guan1jie2}
  \synonymref{关头}{guan1tou2}
  \synonymref{基本}{ji1ben3}
  \synonymref{枢纽}{shu1niu3}
  \synonymref{要害}{yao4hai4}
  \synonymref{症结}{zheng1jie2}
  \synonymref{重要}{zhong4yao4}
  \synonymref{主要}{zhu3yao4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{关键人物}{6,13,2,8}{⼋,⾦,⼈,⽜}
  \begin{Phonetics}{关键人物}{guan1jian4 ren2wu4}[][HSK 5]
    \definition{s.}{pivô; figura"-chave}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{兴盛}{6,11}{⼋,⽫}
  \begin{Phonetics}{兴盛}{xing1sheng4}
    \definition{adj.}{próspero; florescente}
  \seealsoref{兴旺}{xing1wang4}
...
\begin{Entry}{再三}{6,3}{⼌,⼀}
  ...
  \seealsoref{不断}{bu2duan4}
  \seealsoref{来回}{lai2hui2}
  \synonymref{反复}{fan3fu4}
  \synonymref{屡次}{lv3ci4}
  \synonymref{频频}{pin2pin2}
  \synonymref{一再}{yi2zai4}
...
\begin{Entry}{再次}{6,6}{⼌,⽋}
  ...
  \synonymref{屡次}{lv3ci4}
  \synonymref{频频}{pin2pin2}
  \antonymref{初次}{chu1ci4}
  \antonymref{首次}{shou3ci4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{军人}{6,2}{⼍,⼈}
  ...
  \synonymref{武士}{wu3shi4}
  \synonymref{战士}{zhan4shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{军事专家}{6,8,4,10}{⼍,⼅,⼀,⼧}
  \begin{Phonetics}{军事专家}{jun1shi4 zhuan1jia1}[][HSK 5]
    \definition{s.}{especialista militar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{军事博物馆}{6,8,12,8,11}{⼍,⼅,⼗,⽜,⾷}
  \begin{Phonetics}{军事博物馆}{jun1shi4 bo2wu4guan3}[][HSK 5]
    \definition{s.}{museu militar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{冰山}{6,3}{⼎,⼭}
  \begin{Phonetics}{冰山}{bing1shan1}[][HSK 7-9]
    \definition[座]{s.}{montanha gelada; montanha coberta de gelo | \emph{iceberg}; enormes blocos de gelo flutuando no mar | Figurativo: indivíduo ou grupo em que não se pode confiar por muito tempo; poder em que não se pode confiar por muito tempo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{冲击}{6,5}{⼎,⼐}
  \begin{Phonetics}{冲击}{chong1ji1}[][HSK 6]
    \definition{v.}{chicotear; bater | correr; voar; atacar; assaltar; atacar bravamente em direção a um alvo predeterminado | chocar; interferir ou dar um golpe sério}
  \synonymref{冲锋}{chong1//feng1}
...
\begin{Entry}{冲刺}{6,8}{⼎,⼑}
  \begin{Phonetics}{冲刺}{chong1ci4}[][HSK 7-9]
    \definition{v.}{arrancar; correr; disparar | fazer o maior esforço ao se aproximar de uma meta ou estar prestes a ter sucesso}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{冲浪}{6,10}{⼎,⽔}
  \begin{Phonetics}{冲浪}{chong1//lang4}[][HSK 7-9]
    \definition{v.+compl.}{surfar; um esporte aquático em que os atletas surfam em pranchas especialmente construídas e deslizam ao longo das ondas | navegar na \emph{Internet}}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{冲锋}{6,12}{⼎,⾦}
  \begin{Phonetics}{冲锋}{chong1//feng1}
    \definition{v.+compl.}{atacar; avançar; assaltar (frente de batalha); estar na vanguarda}
  \synonymref{冲刺}{chong1ci4}
  \synonymref{冲击}{chong1ji1}
...
\begin{Entry}{划}{6}{⼑}
  ...
  \end{Phonetics}
  \begin{Phonetics}{划}{huai5}
    \definition{v.}{organizar; lidar com; gerenciar; resolver}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{刚强}{6,12}{⼑,⼸}
  \begin{Phonetics}{刚强}{gang1qiang2}
...
\begin{Entry}{创业}{6,5}{⼑,⼀}
  \begin{Phonetics}{创业}{chuang4//ye4}[][HSK 3]
    \definition{s.}{empreendedorismo}
    \definition{v.+compl.}{começar um empreendimento; iniciar/fundar um negócio, uma empresa}
  \synonymref{创办}{chuang4ban4}
  \synonymref{开创}{kai1chuang4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{创伤}{6,6}{⼑,⼈}
  \begin{Phonetics}{创伤}{chuang1shang1}[][HSK 7-9]
    \definition{s.}{ferida; parte do corpo lesionada, geralmente se refere a trauma | trauma; dano emocional ou dano material}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{创建}{6,8}{⼑,⼵}
  ...
  \seealsoref{创立}{chuang4li4}
  \synonymref{成立}{cheng2li4}
  \synonymref{创办}{chuang4ban4}
  \synonymref{创造}{chuang4zao4}
  \synonymref{构建}{gou4jian4}
  \synonymref{建立}{jian4li4}
  \synonymref{建树}{jian4shu4}
  \synonymref{树立}{shu4li4}
  \synonymref{制造}{zhi4zao4}
  \antonymref{重建}{chong2jian4}
  \antonymref{摧毁}{cui1hui3}
  \antonymref{颠覆}{dian1fu4}
  \antonymref{推翻}{tui1//fan1}
...
\begin{Entry}{动作}{6,7}{⼒,⼈}
  \begin{Phonetics}{动作}{dong4zuo4}[][HSK 1]
    \definition[个,种,套]{s.}{movimento; ação; atividade de todo o corpo ou parte do corpo}
...
\begin{Entry}{动员}{6,7}{⼒,⼝}
  \begin{Phonetics}{动员}{dong4//yuan2}[][HSK 5]
    \definition{v.+compl.}{despertar; mobilizar; iniciar (para fazer algo ou participar de uma atividade) | mobilizar toda a nação; transferir dos setores militar, político e econômico para uma situação de guerra}
  \synonymref{倡导}{chang4dao3}
  \synonymref{带动}{dai4dong4}
  \synonymref{发动}{fa1dong4}
  \synonymref{鼓动}{gu3dong4}
  \synonymref{鼓舞}{gu3wu3}
  \synonymref{号召}{hao4zhao4}
  \synonymref{激励}{ji1li4}
...
\begin{Entry}{动物医院}{6,8,7,9}{⼒,⽜,⼖,⾩}
  \begin{Phonetics}{动物医院}{dong4wu4 yi1yuan4}[][HSK 5]
    \definition{s.}{hospital veterinário}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{动物学家}{6,8,8,10}{⼒,⽜,⼦,⼧}
  \begin{Phonetics}{动物学家}{dong4wu4 xue2 jia1}[][HSK 5]
    \definition{s.}{zoólogo}[动物学家研究野生动物。===Zoólogos estudam a vida selvagem.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{动脑筋}{6,10,12}{⼒,⾁,⽵}
  \begin{Phonetics}{动脑筋}{dong4 nao3jin1}[][HSK 5]
    \definition{v.}{usar a mente; exercitar o cérebro; usar seu cérebro para pensar; ter ideias | considerar; pensar bastante; usar a cabeça; usar o cérebro para pensar; quebrar a cabeça | u sar a inteligência}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{动摇}{6,13}{⼒,⼿}
  ...
  \antonymref{坚固}{jian1gu4}
  \antonymref{坚决}{jian1jue2}
  \antonymref{决心}{jue2xin1}
  \antonymref{稳定}{wen3ding4}
  \antonymref{稳固}{wen3gu4}
  \antonymref{执着}{zhi2zhuo2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{华人}{6,2}{⼗,⼈}
  ...
  \seealsoref{华侨}{hua2qiao2}
  \synonymref{华裔}{hua2yi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{协议}{6,5}{⼗,⾔}
  \begin{Phonetics}{协议}{xie2yi4}[][HSK 5]
    \definition[份,项]{s.}{acordo; tratado; decisão conjunta alcançada através de negociação e consulta | geralmente se refere a opiniões obtidas, não se limitando a opiniões entre países e grupos, mas também podendo ocorrer entre empresas e unidades, sem um tom formal | pode ser usado como adjunto adverbial ou predicado; pode ser usado como objeto}
    \definition{v.}{concordar em}
  \seealsoref{协定}{xie2ding4}
  \seealsoref{协商}{xie2shang1}
  \synonymref{公约}{gong1yue1}
  \synonymref{合同}{he2tong5}
  \synonymref{契约}{qi4yue1}
  \synonymref{条约}{tiao2yue1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{协议书}{6,5,4}{⼗,⾔,⼄}
  \begin{Phonetics}{协议书}{xie2yi4shu1}[][HSK 5]
    \definition{s.}{contrato; documento formal no qual as partes ou grupos chegam a um acordo por meio de negociação ou consulta | protocolo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{协商}{6,11}{⼗,⼝}
  \begin{Phonetics}{协商}{xie2shang1}[][HSK 6]
    \definition{v.}{discutir; consultar; negociar; várias partes discutiram e decidiram em conjunto para chegar à mesma visão  | somente pode ser usado como objeto de certos verbos, por exemplo 参与协商 (participar de uma negociação)}
  \seealsoref{参与}{can1yu4}
  \seealsoref{协议}{xie2yi4}
...
\begin{Entry}{压力}{6,2}{⼚,⼒}
  \begin{Phonetics}{压力}{ya1li4}[][HSK 3]
    \definition[份,个]{s.}{pressão; força atuando perpendicularmente à superfície de um objeto | pressão; força esmagadora; força que coage e intimida as pessoas (principalmente nos aspectos espirituais e psicológicos) | tensão; fardo; os encargos econômicos, psicológicos e espirituais impostos pelo mundo exterior}
  \synonymref{逼迫}{bi1po4}
  \synonymref{负担}{fu4dan1}
  \synonymref{压迫}{ya1po4}
  \synonymref{重任}{zhong4ren4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{厌恶}{6,10}{⼚,⼼}
  \begin{Phonetics}{厌恶}{yan4wu4}
    \definition{v.}{detestar; abominar; sentir nojo de; ter uma forte aversão a pessoas ou coisas}
  \seealsoref{不喜欢}{bu4 xi3huan1}
  \seealsoref{讨厌}{tao3yan4}
  \synonymref{可恶}{ke3wu4}
  \synonymref{厌烦}{yan4fan2}
  \antonymref{爱好}{ai4hao4}
  \antonymref{宠爱}{chong3'ai4}
  \antonymref{迷恋}{mi2lian4}
  \antonymref{佩服}{pei4fu2}
  \antonymref{期盼}{qi1pan4}
  \antonymref{亲切}{qin1qie4}
  \antonymref{热爱}{re4'ai4}
...
\begin{Entry}{吃力}{6,2}{⼝,⼒}
  \begin{Phonetics}{吃力}{chi1li4}[][HSK 5]
    \definition{adj.}{suado; extenuante; trabalhoso; laborioso | cansado; fatigado | significa fazer esforço e também sentir dificuldade}
  \seealsoref{费力}{fei4li4}
...
\begin{Entry}{各人自扫门前雪}{6,2,6,6,3,9,11}{⼝,⼈,⾃,⼿,⾨,⼑,⾬}
  \begin{Phonetics}{各人自扫门前雪}{ge4 ren2 zi4 sao3 men2 qian2 xue3}[][HSK 5]
    \definition{expr.}{``Cada um varre a neve em frente à sua própria porta.''; cada um cuida da sua própria vida; significa não se intrometer na vida alheia}
...
\begin{Entry}{合同}{6,6}{⼝,⼝}
  ...
  \synonymref{公约}{gong1yue1}
  \synonymref{合约}{he2yue1}
  \synonymref{契约}{qi4yue1}
  \synonymref{条款}{tiao2kuan3}
  \synonymref{条约}{tiao2yue1}
  \synonymref{协定}{xie2ding4}
  \synonymref{协议}{xie2yi4}
...
\begin{Entry}{合成}{6,6}{⼝,⼽}
  ...
  \synonymref{复合}{fu4he2}
  \synonymref{构成}{gou4cheng2}
  \synonymref{化合}{hua4he2}
  \synonymref{形成}{xing2cheng2}
  \synonymref{整合}{zheng3he2}
...
\begin{Entry}{合作}{6,7}{⼝,⼈}
  ...
  \seealsoref{协作}{xie2zuo4}
  \synonymref{搭配}{da1pei4}
  \synonymref{互助}{hu4zhu4}
  \synonymref{配合}{pei4he2}
  \synonymref{团结}{tuan2jie2}
  \antonymref{对峙}{dui4zhi4}
  \antonymref{竞争}{jing4zheng1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{合作伙伴}{6,7,6,7}{⼝,⼈,⼈,⼈}
  \begin{Phonetics}{合作伙伴}{he2zuo4 huo3ban4}[][HSK 5]
    \definition{s.}{parceiro cooperativo; parceria que representa o mais alto nível de cooperação entre indivíduos ou empresas; ela se baseia na confiança mútua}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{合法}{6,8}{⼝,⽔}
  ...
  \synonymref{正当}{zheng4dang1}
  \antonymref{非法}{fei1fa3}
  \antonymref{违法}{wei2//fa3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{吉祥}{6,10}{⼝,⽰}
  ...
  \synonymref{吉利}{ji2li4}
  \synonymref{平安}{ping2'an1}
  \synonymref{祥和}{xiang2he2}
  \synonymref{幸运}{xing4yun4}
...
\begin{Entry}{同行}{6,6}{⼝,⾏}
  \begin{Phonetics}{同行}{tong2hang2}[][HSK 6]
    \definition[位,个]{s.}{do mesmo ofício ou ocupação; pessoas no mesmo setor}
    \definition{v.}{ser do mesmo ofício ou ocupação; trabalhar no mesmo setor}
  \end{Phonetics}
  \begin{Phonetics}{同行}{tong2xing2}
    \definition{v.}{viajar juntos; caminhar juntos}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{同胞}{6,9}{⼝,⾁}
  ...
  \synonymref{国人}{guo2ren2}
  \synonymref{乡亲}{xiang1qin1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{名人}{6,2}{⼝,⼈}
  ...
  \synonymref{巨星}{ju4xing1}
  \synonymref{名流}{ming2liu2}
  \antonymref{常人}{chang2ren2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{名胜古迹}{6,9,5,9}{⼝,⾁,⼝,⾡}
  \begin{Phonetics}{名胜古迹}{ming2sheng4 gu3ji4}[][HSK 5]
    \definition[处]{s.}{locais de interesse histórico e beleza cênica; lugar famoso com belas paisagens e ruínas antigas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{名牌服装}{6,12,8,12}{⼝,⽚,⽉,⾐}
  \begin{Phonetics}{名牌服装}{ming2pai2 fu2zhuang1}[][HSK 5]
    \definition{s.}{roupas de grife; roupas de marca}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{后台}{6,5}{⼝,⼝}
  \begin{Phonetics}{后台}{hou4tai2}[][HSK 7-9]
    \definition{s.}{bastidores; plano de fundo | apoiador de bastidores; apoiador dos bastidores; pessoa ou grupo que manipula ou apoia algo nos bastidores}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{后面}{6,9}{⼝,⾯}
  ...
  \seealsoref{后}{hou4}
  \seealsoref{后边}{hou4bian5}
  \seealsoref{后头}{hou4tou5}
  \synonymref{背后}{bei4hou4}
  \synonymref{背面}{bei4mian4}
  \synonymref{反面}{fan3mian4}
  \antonymref{跟前}{gen1qian2}
  \antonymref{面前}{mian4qian2}
  \antonymref{前方}{qian2fang1}
  \antonymref{前面}{qian2mian4}
  \antonymref{前头}{qian2tou5}
...
\begin{Entry}{后悔}{6,10}{⼝,⼼}
  \begin{Phonetics}{后悔}{hou4hui3}[][HSK 5]
    \definition{v.}{lamentar; ter remorso; arrepender"-se | geralmente é usado para assuntos comuns}
  \seealsoref{懊悔}{ao4hui3}
  \seealsoref{悔恨}{hui3hen4}
  \antonymref{心安理得}{xin1'an1-li3de2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{吐}{6}{⼝}
  ...
  \begin{Phonetics}{吐}{tu4}[][HSK 5]
    \definition{v.}{vomitar; sair pela boca | vomitar; expelir; ser forçado a devolver bens usurpados}
  \antonymref{吃}{chi1}
  \antonymref{纳}{na4}
  \antonymref{吞}{tun1}
  \antonymref{咽}{yan4}
...
\begin{Entry}{向导}{6,6}{⼝,⼨}
  ...
  \synonymref{导师}{dao3shi1}
  \synonymref{导游}{dao3you2}
...
\begin{Entry}{吓}{6}{⼝}
  \begin{Phonetics}{吓}{he4}
    \definition{v.}{ameaçar; intimidar; utilizar ameaças ou métodos para coagir ou intimidar}
  \end{Phonetics}
...
\begin{Entry}{吸引}{6,4}{⼝,⼸}
  ...
  \synonymref{迷人}{mi2ren2}
  \synonymref{引人入胜}{yin3ren2-ru4sheng4}
...
\begin{Entry}{吸烟}{6,10}{⼝,⽕}
  ...
  \synonymref{抽烟}{chou1//yan1}
  \antonymref{戒烟}{jie4yan1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{回去}{6,5}{⼞,⼛}
  \begin{Phonetics}{回去}{hui2qu4}[][HSK 1]
...
\begin{Entry}{回来}{6,7}{⼞,⽊}
  \begin{Phonetics}{回来}{hui2lai2}[][HSK 1]
...
\begin{Entry}{在乎}{6,5}{⼟,⼃}
  ...
  \synonymref{关注}{guan1zhu4}
  \synonymref{介意}{jie4yi4}
  \synonymref{在于}{zai4yu2}
...
\begin{Entry}{在意}{6,13}{⼟,⼼}
  \begin{Phonetics}{在意}{zai4yi4}[][HSK 7-9]
    \definition{v.}{(geralmente na forma negativa) ter em mente; preocupar"-se com; levar a sério; prestar atenção em}
  \synonymref{介意}{jie4yi4}
...
\begin{Entry}{地上车库}{6,3,4,7}{⼟,⼀,⾞,⼴}
  \begin{Phonetics}{地上车库}{di4shang4 che1ku4}[][HSK 5]
    \definition{s.}{garagem de superfície; estacionamento de superfície}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{地下}{6,3}{⼟,⼀}
  \begin{Phonetics}{地下}{di4xia4}
    \definition{s.}{no chão; no local}
  \antonymref{地上}{di4shang5}
  \antonymref{公开}{gong1kai1}
  \antonymref{明朗}{ming2lang3}
  \antonymref{天上}{tian1shang4}
  \antonymref{透明}{tou4ming2}
  \end{Phonetics}
...
\begin{Entry}{地下车库}{6,3,4,7}{⼟,⼀,⾞,⼴}
  \begin{Phonetics}{地下车库}{di4xia4 che1ku4}[][HSK 5]
    \definition{s.}{garagem subterrânea; estacionamento subterrâneo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{地方政府}{6,4,9,8}{⼟,⽅,⽁,⼴}
  \begin{Phonetics}{地方政府}{di4fang1 zheng4fu3}[][HSK 5]
    \definition{s.}{governo local; governo regional}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{地形}{6,7}{⼟,⼺}
  \begin{Phonetics}{地形}{di4xing2}[][HSK 5]
    \definition{s.}{topografia; forma do terreno; relevo; disposição do terreno; característica do relevo; característica da superfície; terreno | inclui estruturas no solo}
  \seealsoref{地势}{di4shi4}
...
\begin{Entry}{地势}{6,8}{⼟,⼒}
  \begin{Phonetics}{地势}{di4shi4}
    \definition{s.}{relevo; terreno; topografia; características físicas de um lugar}
  \seealsoref{地形}{di4xing2}
  \synonymref{形势}{xing2shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{地图}{6,8}{⼟,⼞}
  \begin{Phonetics}{地图}{di4tu2}[][HSK 1]
    \definition[张,幅,份,个]{s.}{mapa; mapa que mostra a distribuição de coisas e fenômenos na superfície da Terra, com símbolos e textos, e às vezes também com cores}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{地板}{6,8}{⼟,⽊}
  ...
  \synonymref{地面}{di4mian4}
  \synonymref{地上}{di4shang5}
  \antonymref{屋顶}{wu1ding3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{地带}{6,9}{⼟,⼱}
  \begin{Phonetics}{地带}{di4dai4}[][HSK 5]
    \definition[个,条]{s.}{distrito; região; zona; área de uma determinada natureza ou extensão | não pode modificar nomes de lugares}
  \seealsoref{地区}{di4qu1}
  \synonymref{地段}{di4duan4}
  \synonymref{地域}{di4yu4}
...
\begin{Entry}{地狱}{6,9}{⼟,⽝}
  \begin{Phonetics}{地狱}{di4yu4}[][HSK 7-9]
    \definition[个,层,重,处]{s.}{inferno; submundo; algumas religiões se referem ao lugar onde a alma sofre após a morte | inferno na terra; lugar de tormento como o inferno; ambiente de vida sombrio e miserável}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{地面}{6,9}{⼟,⾯}
  ...
  \synonymref{大地}{da4di4}
  \synonymref{当地}{dang1di4}
  \synonymref{地板}{di4ban3}
  \synonymref{地区}{di4qu1}
  \synonymref{地域}{di4yu4}
  \synonymref{地上}{di4shang5}
  \synonymref{区域}{qu1yu4}
  \antonymref{地下}{di4xia5}
  \antonymref{高空}{gao1kong1}
  \antonymref{空中}{kong1zhong1}
  \antonymref{天花板}{tian1hua1ban3}
  \antonymref{天空}{tian1kong1}
...
\begin{Entry}{场面}{6,9}{⼟,⾯}
  ...
  \synonymref{场合}{chang3he2}
  \synonymref{场景}{chang3jing3}
  \synonymref{段落}{duan4luo4}
  \synonymref{局面}{ju2mian4}
...
\begin{Entry}{多管闲事}{6,14,7,8}{⼣,⽵,⾨,⼅}
  \begin{Phonetics}{多管闲事}{duo1 guan3 xian2shi4}[][HSK 5]
    \definition{expr.}{intrometer"-se nos negócios alheios; não há necessidade de se intrometer na vida alheia}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{夺取}{6,8}{⼤,⼜}
  ...
  \seealsoref{夺得}{duo2de2}
  \synonymref{掠夺}{lve4duo2}
  \synonymref{窃取}{qie4qu3}
...
\begin{Entry}{夺得}{6,11}{⼤,⼻}
  \begin{Phonetics}{夺得}{duo2de2}
    \definition{v.}{tomar; apoderar"-se; ganhar; levar embora; obter; conseguir}
  \seealsoref{夺取}{duo2qu3}
  \synonymref{赢得}{ying2de2}
  \synonymref{斩获}{zhan3huo4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{好像}{6,13}{⼥,⼈}
  \begin{Phonetics}{好像}{hao3xiang4}[][HSK 2]
    ...
    \definition{v.}{parecer; ser como; parecer"-se com | pode ser usado para expressar especulação ou estimativa}
...
\begin{Entry}{如今}{6,4}{⼥,⼈}
  ...
  \antonymref{过往}{guo4wang3}
  \antonymref{往常}{wang3chang2}
  \antonymref{往昔}{wang3xi1}
  \antonymref{未来}{wei4lai2}
  \antonymref{昔日}{xi1ri4}
  \antonymref{以往}{yi3wang3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{如此}{6,6}{⼥,⽌}
  \begin{Phonetics}{如此}{ru2ci3}[][HSK 5]
    \definition{adv.}{assim; tal; desta forma; desta maneira; refere"-se a uma situação mencionada anteriormente}
...
\begin{Entry}{妈}{6}{⼥}
  \begin{Phonetics}{妈}{ma1}[][HSK 1]
    \definition[个,位,名,些]{s.}{mãe; mamãe | uma forma de tratamento para uma mulher casada uma geração mais velha | (antigo) uma forma de tratamento para uma empregada doméstica de meia"-idade ou velha}
...
\begin{Entry}{存款}{6,12}{⼦,⽋}
  \begin{Phonetics}{存款}{cun2//kuan3}[][HSK 5]
    ...
    \definition{v.+compl.}{depositar dinheiro; colocar dinheiro no banco}
  \synonymref{储存}{chu3cun2}
  \synonymref{储蓄}{chu3xu4}
  \synonymref{积蓄}{ji1xu4}
  \antonymref{贷款}{dai4kuan3}
  \antonymref{取款}{qu3//kuan3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{宇航员}{6,10,7}{⼧,⾈,⼝}
  ...
  \synonymref{普通人}{pu3tong1ren2}
  \antonymref{航天员}{hang2tian1yuan2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{安全气囊}{6,6,4,22}{⼧,⼊,⽓,⾐}
  \begin{Phonetics}{安全气囊}{an1quan2 qi4nang2}[][HSK 5]
    \definition{s.}{\emph{airbag}; \emph{airbag} de segurança (automotivo); sistema de proteção de segurança passiva que atua em conjunto com os cintos de segurança para oferecer proteção eficaz aos ocupantes em caso de colisão}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{安检}{6,11}{⼧,⽊}
  \begin{Phonetics}{安检}{an1//jian3}[][HSK 6]
    ...
    \definition{v.+compl.}{realizar verificação de segurança}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{寻找}{6,7}{⼨,⼿}
  \begin{Phonetics}{寻找}{xun2zhao3}[][HSK 4]
    \definition{v.}{buscar; procurar; pesquisar; encontrar, que pode ser usado tanto para coisas concretas quanto para coisas abstratas | o objeto de 寻找 é principalmente um substantivo concreto ou um substantivo abstrato}
  \seealsoref{寻求}{xun2qiu2}
  \synonymref{摸索}{mo1suo3}
  \synonymref{搜索}{sou1suo3}
  \synonymref{探求}{tan4qiu2}
  \synonymref{探索}{tan4suo3}
  \synonymref{寻觅}{xun2mi4}
  \synonymref{找出}{zhao3chu1}
...
\begin{Entry}{寻找帮助}{6,7,9,7}{⼨,⼿,⼱,⼒}
  \begin{Phonetics}{寻找帮助}{xun2zhao3 bang1zhu4}[][HSK 5]
    \definition{expr.}{buscar ajuda; procurar ajuda}[她四处寻找帮助。===Ela procurou ajuda por toda parte.]
  \end{Phonetics}
\end{Entry}

\begin{Entry}{寻求}{6,7}{⼨,⽔}
  \begin{Phonetics}{寻求}{xun2qiu2}[][HSK 5]
    \definition{v.}{procurar; perseguir; explorar; ir em busca de | o objeto de 寻求 é um substantivo abstrato}
  \seealsoref{寻找}{xun2zhao3}
  \synonymref{摸索}{mo1suo3}
  \synonymref{谋求}{mou2qiu2}
  \synonymref{搜索}{sou1suo3}
  \synonymref{探求}{tan4qiu2}
...
\begin{Entry}{尖}{6}{⼩}
  \begin{Phonetics}{尖}{jian1}[][HSK 6]
    ...
    \definition[个]{s.}{ponto; ponta; topo | o melhor do seu tipo; a melhor escolha; a nata da safra; uma pessoa ou coisa notável}
...
\begin{Entry}{尖端}{6,14}{⼩,⽴}
  \begin{Phonetics}{尖端}{jian1duan1}[][HSK 7-9]
    ...
    \definition{s.}{ponta pontiaguda; pico; a ponta fina e pontiaguda de algo | topo; ápice; pico; o mais alto nível de ciência e tecnologia}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{尽力}{6,2}{⼫,⼒}
  ...
  \seealsoref{竭力}{jie2li4}
  \synonymref{奋力}{fen4li4}
  \synonymref{极力}{ji2li4}
  \synonymref{尽量}{jin4liang4}
  \synonymref{力求}{li4qiu2}
  \synonymref{努力}{nu3li4}
  \synonymref{拼命}{pin1//ming4}
...
\begin{Entry}{尽可能}{6,5,10}{⼫,⼝,⾁}
  \begin{Phonetics}{尽可能}{jin3 ke3neng2}[][HSK 5]
  ...
  \synonymref{尽力}{jin4//li4}
  \synonymref{全力以赴}{quan2li4yi3fu4}
  \antonymref{敷衍}{fu1yan3}
  \antonymref{应付}{ying4fu5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{尽量}{6,12}{⼫,⾥}
  ...
  \antonymref{放弃}{fang4qi4}
  \end{Phonetics}
  \begin{Phonetics}{尽量}{jin4liang4}
    \definition{v.}{beber ou comer até a saciedade; atingir o grau/capacidade máxima}
  \seealsoref{尽情}{jin4qing2}
  \synonymref{极力}{ji2li4}
...
\begin{Entry}{尽管……还是}{6,14,7,9}{⼫,⽵,⾡,⽇}
  \begin{Phonetics}{尽管……还是}{jin3guan3 hai2shi4}
    \definition{conj.}{apesar de\dots ainda; embora\dots ainda assim}
...
\begin{Entry}{师傅}{6,12}{⼱,⼈}
  ...
  \synonymref{导师}{dao3shi1}
  \synonymref{老师}{lao3shi1}
  \synonymref{师父}{shi1fu5}
  \antonymref{传人}{chuan2ren2}
  \antonymref{弟子}{di4zi3}
  \antonymref{徒弟}{tu2di5}
  \antonymref{学生}{xue2sheng5}
  \end{Phonetics}
...
\begin{Entry}{年轻人}{6,9,2}{⼲,⾞,⼈}
  \begin{Phonetics}{年轻人}{nian2qing1 ren2}[][HSK 5]
    \definition[群,个,班,帮]{s.}{jovens; garotada; refere"-se a alguém jovem, mas também é frequentemente usado por pessoas mais velhas para se dirigirem a quem é mais jovem do que elas}
  \synonymref{小伙子}{xiao3huo3zi5}
  \antonymref{老头儿}{lao3tou2r5}
  \antonymref{老头子}{lao3tou2zi5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{庆祝}{6,9}{⼴,⽰}
  ...
  \seealsoref{庆贺}{qing4he4}
  \synonymref{喜庆}{xi3qing4}
...
\begin{Entry}{延长}{6,4}{⼵,⾧}
  ...
  \seealsoref{延伸}{yan2shen1}
  \synonymref{增长}{zeng1zhang3}
  \antonymref{缩短}{suo1duan3}
  \antonymref{缩小}{suo1xiao3}
...
\begin{Entry}{延期}{6,12}{⼵,⽉}
  ...
  \antonymref{按期}{an4qi1}
  \antonymref{按时}{an4shi2}
  \antonymref{提前}{ti2qian2}
...
\begin{Entry}{当中}{6,4}{⼹,⼁}
  ...
  \synonymref{之间}{zhi1 jian1}
  \synonymref{之内}{zhi1 nei4}
...
\begin{Entry}{当天}{6,4}{⼹,⼤}
  ...
  \synonymref{当日}{dang1ri4}
  \synonymref{当日}{dang4ri4}
...
\begin{Entry}{当代人}{6,5,2}{⼹,⼈,⼈}
  \begin{Phonetics}{当代人}{dang1dai4 ren2}[][HSK 5]
    \definition{s.}{as pessoas de hoje; pessoa contemporânea}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{当地政府}{6,6,9,8}{⼹,⼟,⽁,⼴}
  \begin{Phonetics}{当地政府}{dang1di4 zheng4fu3}[][HSK 5]
    \definition{s.}{governo local}[该学校隶属于当地政府。===A escola é vinculada ao governo local.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{当场}{6,6}{⼹,⼟}
  ...
  \synonymref{当时}{dang4shi2}
  \synonymref{就地}{jiu4di4}
  \synonymref{马上}{ma3shang4}
  \synonymref{现场}{xian4chang3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{忙得团团转}{6,11,6,6,8}{⼼,⼻,⼞,⼞,⾞}
  \begin{Phonetics}{忙得团团转}{mang2 de2 tuan2tuan2zhuan4}[][HSK 5]
    \definition{expr.}{``Ocupado correndo por aí.''; correr em círculos, extremamente ocupado}[我忙得团团转没时间吃饭。===Estou tão ocupado que não tenho tempo para comer.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{戏}{6}{⼽}
  \begin{Phonetics}{戏}{hu1}
    \definition{interj.}{``Oh!''; ``Ei!''; ``Uau!''}
  \end{Phonetics}
...
\begin{Entry}{成人}{6,2}{⼽,⼈}
  ...
  \synonymref{大人}{da4ren2}
  \synonymref{长大}{zhang3da4}
  \antonymref{宝宝}{bao3bao5}
  \antonymref{儿童}{er2tong2}
  \antonymref{孩子}{hai2zi5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{成功}{6,5}{⼽,⼒}
  \begin{Phonetics}{成功}{cheng2//gong1}[][HSK 3]
    \definition{adj.}{bem"-sucedido; frutífero}
    \definition[个,次]{s.}{sucesso}
    \definition{v.+compl.}{ter sucesso; obter os resultados esperados}
...
\begin{Entry}{成功者}{6,5,8}{⼽,⼒,⽼}
  \begin{Phonetics}{成功者}{cheng2gong1 zhe3}[][HSK 5]
    \definition{s.}{pessoa bem"-sucedidas}[他是少数成功者之一。===Ele é uma das poucas pessoas bem"-sucedidas.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{成交}{6,6}{⼽,⼇}
  \begin{Phonetics}{成交}{cheng2jiao1}[][HSK 5]
    \definition{v.}{fechar um acordo; fazer uma barganha; concluir uma transação}
  \synonymref{交易}{jiao1yi4}
...
\begin{Entry}{成问题}{6,6,15}{⼽,⾨,⾴}
  \begin{Phonetics}{成问题}{cheng2//wen4ti2}[][HSK 7-9]
    \definition{v.+compl.}{Coloquial: ser um problema; estar aberto a questionamentos (ou dúvidas, objeções)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{成婚}{6,11}{⼽,⼥}
  \begin{Phonetics}{成婚}{cheng2//hun1}
    \definition{v.+compl.}{casar"-se}
...
\begin{Entry}{执行}{6,6}{⼿,⾏}
  ...
  \seealsoref{履行}{lv3xing2}
  \synonymref{贯彻}{guan4che4}
...
\begin{Entry}{扩大}{6,3}{⼿,⼤}
  ...
  \seealsoref{扩充}{kuo4chong1}
  \seealsoref{扩展}{kuo4zhan3}
  \synonymref{放大}{fang4da4}
  \synonymref{扩张}{kuo4zhang1}
  \synonymref{伸张}{shen1zhang1}
  \synonymref{增大}{zeng1da4}
  \synonymref{增加}{zeng1jia1}
  \synonymref{增添}{zeng1tian1}
  \antonymref{收缩}{shou1suo1}
  \antonymref{缩小}{suo1xiao3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{扩充}{6,6}{⼿,⼉}
  \begin{Phonetics}{扩充}{kuo4chong1}
    \definition{v.}{expandir; ampliar; aumentar; expandir e enriquecer}
  \seealsoref{扩大}{kuo4da4}
...
\begin{Entry}{收回}{6,6}{⽁,⼞}
  ...
  \antonymref{颁发}{ban1fa1}
  \antonymref{出示}{chu1shi4}
  \antonymref{发出}{fa1chu1}
  \antonymref{发放}{fa1fang4}
  \antonymref{放出}{fang4chu1}
  \antonymref{付出}{fu4chu1}
  \antonymref{抛开}{pao1kai1}
  \antonymref{送给}{song4 gei3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{收成}{6,6}{⽁,⼽}
  \begin{Phonetics}{收成}{shou1cheng2}
    \definition{s.}{colheita; situação da colheita}
    \definition{v.}{colher}
  \seealsoref{收获}{shou1huo4}
  \synonymref{产量}{chan3liang4}
  \synonymref{丰收}{feng1shou1}
  \antonymref{付出}{fu4chu1}
  \antonymref{栽种}{zai1zhong4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{收听}{6,7}{⽁,⼝}
  ...
  \antonymref{播送}{bo1song4}
  \antonymref{广播}{guang3bo1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{收购}{6,8}{⽁,⾙}
  ...
  \seealsoref{收买}{shou1mai3}
  \synonymref{采购}{cai3gou4}
  \synonymref{购买}{gou4mai3}
  \antonymref{出卖}{chu1mai4}
  \antonymref{出售}{chu1shou4}
  \antonymref{销售}{xiao1shou4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{收养}{6,9}{⽁,⼋}
  ...
  \synonymref{领养}{ling3yang3}
  \synonymref{收留}{shou1liu2}
  \antonymref{遗弃}{yi2qi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{收费}{6,9}{⽁,⾙}
  ...
  \synonymref{收取}{shou1qu3}
  \antonymref{免费}{mian3//fei4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{收费处}{6,9,5}{⽁,⾙,⼡}
  \begin{Phonetics}{收费处}{shou1fei4 chu4}[][HSK 5]
    \definition{s.}{caixa; guichê de pagamento; posto de cobrança}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{收获}{6,10}{⽁,⾋}
  ...
  \seealsoref{收成}{shou1cheng2}
  \synonymref{成果}{cheng2guo3}
  \synonymref{成就}{cheng2jiu4}
  \synonymref{成效}{cheng2xiao4}
  \synonymref{获取}{huo4qu3}
  \synonymref{硕果}{shuo4guo3}
  \antonymref{付出}{fu4chu1}
  \antonymref{损失}{sun3shi1}
  \antonymref{种植}{zhong4zhi2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{收款台}{6,12,5}{⽁,⽋,⼝}
  \begin{Phonetics}{收款台}{shou1 kuan3 tai2}[][HSK 5]
    \definition{s.}{caixa; a área do caixa em uma loja | caixa; balcão de caixa | balcão de pagamento}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{早已}{6,3}{⽇,⼰}
  ...
  \synonymref{当初}{dang1chu1}
  \synonymref{已经}{yi3jing1}
  \synonymref{以前}{yi3qian2}
  \synonymref{已然}{yi3ran2}
  \synonymref{早就}{zao3jiu4}
...
\begin{Entry}{早晚}{6,11}{⽇,⽇}
  ...
  \synonymref{迟早}{chi2zao3}
  \synonymref{时段}{shi2duan4}
  \synonymref{时节}{shi2jie2}
  \synonymref{时刻}{shi2ke4}
  \antonymref{随时}{sui2shi2}
  \antonymref{中午}{zhong1wu3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{有利于}{6,7,3}{⽉,⼑,⼆}
  \begin{Phonetics}{有利于}{you3 li4yu2}[][HSK 5]
...
\begin{Entry}{有时}{6,7}{⽉,⽇}
  ...
  \antonymref{屡次}{lv3ci4}
  \antonymref{时时}{shi2shi2}
  \antonymref{一向}{yi2xiang4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{有时候}{6,7,10}{⽉,⽇,⼈}
  \begin{Phonetics}{有时候}{you3 shi2hou5}[][HSK 1]
...
\begin{Entry}{有限}{6,8}{⽉,⾩}
  ...
  \synonymref{少量}{shao3liang4}
  \antonymref{充足}{chong1zu2}
  \antonymref{大量}{da4liang4}
  \antonymref{无穷}{wu2qiong2}
  \antonymref{无限}{wu2xian4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{有效}{6,10}{⽉,⽁}
  ...
  \synonymref{高效}{gao1xiao4}
  \synonymref{管用}{guan3yong4}
  \synonymref{生效}{sheng1//xiao4}
  \synonymref{有用}{you3yong4}
  \synonymref{奏效}{zou4//xiao4}
  \antonymref{失效}{shi1//xiao4}
  \antonymref{无效}{wu2xiao4}
  \antonymref{作废}{zuo4fei4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{机关}{6,6}{⽊,⼋}
  ...
  \synonymref{结构}{jie2gou4}
  \synonymref{陷阱}{xian4jing3}
  \synonymref{组织}{zu3zhi1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{机场}{6,6}{⽊,⼟}
  \begin{Phonetics}{机场}{ji1chang3}[][HSK 1]
    \definition[个,家,座]{s.}{aeródromo; campo de aviação; aeroporto; campo de voo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{机械}{6,11}{⽊,⽊}
  \begin{Phonetics}{机械}{ji1xie4}[][HSK 6]
    \definition{adj.}{rígido; mecânico; inflexível; abordagem rígida e imutável}
    \definition[台,部,个]{s.}{máquina; maquinário; mecanismo; vários dispositivos compostos por princípios mecânicos}
  \synonymref{机器}{ji1qi4}
  \synonymref{器械}{qi4xie4}
  \antonymref{创新}{chuang4xin1}
  \antonymref{灵活}{ling2huo2}
  \antonymref{灵巧}{ling2qiao3}
  \antonymref{生动}{sheng1dong4}
  \antonymref{手工}{shou3gong1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{杀毒}{6,9}{⽊,⽏}
  \begin{Phonetics}{杀毒}{sha1//du2}[][HSK 5]
    ...
    \definition{v.+compl.}{esterilizar; desinfetar | Computação: eliminar um vírus}
  \synonymref{消毒}{xiao1du2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{杂志}{6,7}{⽊,⼼}
  ...
  \synonymref{报刊}{bao4kan1}
  \synonymref{笔记}{bi3ji4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{权力}{6,2}{⽊,⼒}
  ...
  \synonymref{势力}{shi4li4}
  \synonymref{政权}{zheng4quan2}
  \synonymref{职权}{zhi2quan2}
...
\begin{Entry}{权利}{6,7}{⽊,⼑}
  ...
  \seealsoref{权力}{quan2li4}
  \synonymref{筹码}{chou2ma3}
  \synonymref{权益}{quan2yi4}
  \synonymref{势力}{shi4li4}
  \synonymref{职权}{zhi2quan2}
  \antonymref{义务}{yi4wu4}
  \end{Phonetics}
...
\begin{Entry}{次序}{6,7}{⽋,⼴}
  \begin{Phonetics}{次序}{ci4xu4}
    \definition{s.}{ordem; sequência; a ordem em que as coisas estão organizadas no espaço ou no tempo}
  \seealsoref{顺序}{shun4xu4}
...
\begin{Entry}{欢乐}{6,5}{⽋,⼃}
  ...
  \seealsoref{欢喜}{huan1xi3}
  \synonymref{欢快}{huan1kuai4}
  \synonymref{狂欢}{kuang2huan1}
...
\begin{Entry}{欢喜}{6,12}{⽋,⼝}
  \begin{Phonetics}{欢喜}{huan1xi3}
    \definition{adj.}{alegre; feliz; encantado}
    \definition{v.}{gostar; ter apreço por; deleitar"-se com; curtir; favoritar}
  \seealsoref{欢乐}{huan1le4}
...
\begin{Entry}{此时}{6,7}{⽌,⽇}
  ...
  \seealsoref{此刻}{ci3ke4}
  \synonymref{当下}{dang1xia4}
  \synonymref{目前}{mu4qian2}
  \synonymref{如今}{ru2jin1}
  \synonymref{这时}{zhe4shi2}
  \synonymref{至此}{zhi4ci3}
  \antonymref{过去}{guo4qu4}
  \antonymref{以后}{yi3hou4}
  \antonymref{以前}{yi3qian2}
  \end{Phonetics}
...
\begin{Entry}{此刻}{6,8}{⽌,⼑}
  ...
  \seealsoref{此时}{ci3 shi2}
  \synonymref{当前}{dang1qian2}
  \synonymref{目前}{mu4qian2}
  \synonymref{如今}{ru2jin1}
  \synonymref{现在}{xian4zai4}
  \synonymref{眼下}{yan3xia4}
  \antonymref{从前}{cong2qian2}
  \antonymref{那时}{na4shi2}
  \antonymref{以前}{yi3qian2}
  \antonymref{以往}{yi3wang3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{死}{6}{⽍}
  ...
  \seealsoref{去世}{qu4shi4}
  \seealsoref{牺牲}{xi1sheng1}
  \synonymref{呆}{dai1}
  \synonymref{很}{hen3}
  \synonymref{极}{ji2}
  \synonymref{拘}{ju1}
...
\begin{Entry}{竹熊}{6,14}{⽵,⽕}
  \begin{Phonetics}{竹熊}{zhu2xiong2}[][HSK 5]
    \definition{s.}{panda}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{纪念}{6,8}{⽷,⼼}
  ...
  \seealsoref{留念}{liu2nian4}
  \synonymref{怀念}{huai2nian4}
  \synonymref{缅怀}{mian3huai2}
...
\begin{Entry}{纪念册}{6,8,5}{⽷,⼼,⼌}
  \begin{Phonetics}{纪念册}{ji4nian4ce4}[][HSK 5]
    \definition{s.}{livro de autógrafos; álbum de autógrafos; álbum comemorativo; Em livretos comemorativos, é comum pedir a outras pessoas que escrevam dedicatórias neles}
  \synonymref{回忆录}{hui2yi4lu4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{纪念品}{6,8,9}{⽷,⼼,⼝}
  \begin{Phonetics}{纪念品}{ji4nian4pin3}[][HSK 5]
    \definition[个]{s.}{lembrança; recordação; \emph{souvenir}; itens guardados como lembranças}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{网球运动员}{6,11,7,6,7}{⽹,⽟,⾡,⼒,⼝}
  \begin{Phonetics}{网球运动员}{wang3qiu2 yun4dong4yuan2}[][HSK 5]
    \definition{s.}{tenista; jogador de tênis}[他是一名优秀的网球运动员。===Ele é um excelente jogador de tênis.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{羽毛}{6,4}{⽻,⽑}
  \begin{Phonetics}{羽毛}{yu3mao2}
    \definition[根,片]{s.}{pluma; pena; as penas das aves podem proteger seus corpos e ajudá"-las a voar, entre outras coisas | reputação; reputação de uma pessoa}
  \synonymref{名声}{ming2sheng1}
  \synonymref{名誉}{ming2yu4}
  \synonymref{声望}{sheng1wang4}
  \synonymref{声誉}{sheng1yu4}
...
\begin{Entry}{老太太}{6,4,4}{⽼,⼤,⼤}
  \begin{Phonetics}{老太太}{lao3 tai4tai5}[][HSK 3]
...
\begin{Entry}{老头儿}{6,5,2}{⽼,⼤,⼉}
  ...
  \antonymref{年轻人}{nian2qing1 ren2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{老年}{6,6}{⽼,⼲}
  ...
  \antonymref{中年}{zhong1 nian2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{老年公寓}{6,6,4,12}{⽼,⼲,⼋,⼧}
  \begin{Phonetics}{老年公寓}{lao3nian2 gong1yu4}[][HSK 5]
    \definition{s.}{apartamento para idosos | residência para idosos, casa para idosos, asilo}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{老死不相往来}{6,6,4,9,8,7}{⽼,⽍,⼀,⽬,⼻,⽊}
  \begin{Phonetics}{老死不相往来}{lao3si3 bu4 xiang1 wang3lai2}[][HSK 5]
    \definition{expr.}{``Nunca mais se verem pelo resto da vida.''; não manter contato um com o outro por muito tempo; estar de relações cortadas; descreve uma situação em que não há contato entre as partes por um longo período; envelhecer e morrer sem ter tido qualquer interação; nunca entrar em contato um com o outro; estar totalmente isolado um do outro}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{老朋友}{6,8,4}{⽼,⽉,⼜}
  \begin{Phonetics}{老朋友}{lao3 peng2you3}[][HSK 2]
...
\begin{Entry}{老虎}{6,8}{⽼,⾌}
  \begin{Phonetics}{老虎}{lao3hu3}
    \definition[只]{s.}{tigre | instalações que consomem grande quantidade de energia ou matérias"-primas, ou que geram resíduos ou danos significativos; metaforicamente, refere"-se a máquinas e equipamentos que consomem grandes quantidades de energia ou matérias"-primas | pessoa muito gananciosa; pessoa que comete corrupção, roubo ou sonegação fiscal em grande escala; descreve alguém que usa seu poder para cometer crimes em larga escala, como peculato, roubo e sonegação fiscal}
  \seealsoref{虎}{hu3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{而立之年}{6,5,3,6}{⽽,⽴,⼂,⼲}
  \begin{Phonetics}{而立之年}{er2li4 zhi1 nian2}[][HSK 5]
    \definition{expr.}{a casa dos trinta; a idade de trinta; quando uma pessoa tem trinta anos}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{而是}{6,9}{⽽,⽇}
  ...
  \seealsoref{不是……，而是……}{bu2shi4 er2 shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{肌肉发达}{6,6,5,6}{⾁,⾁,⼜,⾡}
  \begin{Phonetics}{肌肉发达}{ji1rou4 fa1da2}[][HSK 5]
    \definition{adj.}{musculoso; forte; robusto | ter músculos bem desenvolvidos}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{自己}{6,3}{⾃,⼰}
  ...
  \seealsoref{亲自}{qin1zi4}
  \seealsoref{自身}{zi4shen1}
  \seealsoref{自我}{zi4wo3}
  \synonymref{本身}{ben3shen1}
  \antonymref{别人}{bie2ren2}
...
\begin{Entry}{自以为是}{6,4,4,9}{⾃,⼈,⼂,⽇}
  ...
  \antonymref{设身处地}{she4shen1chu3de5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{自在}{6,6}{⾃,⼟}
  ...
  \synonymref{稳重}{wen3zhong4}
  \synonymref{悠闲}{you1xian2}
  \synonymref{自如}{zi4ru2}
  \synonymref{自由}{zi4you2}
  \antonymref{烦躁}{fan2zao4}
  \antonymref{拘束}{ju1shu4}
  \antonymref{限制}{xian4zhi4}
  \end{Phonetics}
...
\begin{Entry}{自信}{6,9}{⾃,⼈}
  ...
  \synonymref{信心}{xin4xin1}
  \synonymref{胸有成竹}{xiong1you3cheng2zhu2}
  \antonymref{自卑}{zi4bei1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{自然}{6,12}{⾃,⽕}
  ...
  \seealsoref{必然}{bi4ran2}
  \seealsoref{大方}{da4fang5}
  \seealsoref{当然}{dang1ran2}
  \synonymref{理所当然}{li3suo3dang1ran2}
  \synonymref{天然}{tian1ran2}
  \antonymref{拘束}{ju1shu4}
  \antonymref{勉强}{mian3qiang3}
  \antonymref{人为}{ren2wei2}
  \antonymref{人造}{ren2zao4}
...
\begin{Entry}{自豪}{6,14}{⾃,⾗}
  ...
  \seealsoref{骄傲}{jiao1'ao4}
  \synonymref{高傲}{gao1'ao4}
  \synonymref{自负}{zi4fu4}
  \synonymref{自信}{zi4xin4}
  \synonymref{自尊}{zi4zun1}
...
\begin{Entry}{至今}{6,4}{⾄,⼈}
  ...
  \synonymref{迄今}{qi4jin1}
  \antonymref{从此}{cong2ci3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{至少}{6,4}{⾄,⼩}
  ...
  \seealsoref{起码}{qi3ma3}
  \seealsoref{最少}{zui4shao3}
...
\begin{Entry}{色彩}{6,11}{⾊,⼺}
  \begin{Phonetics}{色彩}{se4cai3}[][HSK 4]
    \definition[种,丝]{s.}{cor; matiz; tonalidade | cor; sabor; característica; determinado estado de espírito ou tendência de pensamento}
  \seealsoref{彩色}{cai3se4}
...
\begin{Entry}{血}{6}{⾎}[Kangxi 143]
  \begin{Phonetics}{血}{xie3}
    \definition[滴,袋,口,毫升]{s.}{sangue}
  \end{Phonetics}
  \begin{Phonetics}{血}{xue4}[][HSK 3]
    \definition[滴,袋,口,毫升]{s.}{sangue | parente consanguíneo; com laços de parentesco | pessoa ativa e animada; personalidade ou espírito forte e sincero | medicina tradicional chinesa refere"-se à menstruação}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{血液}{6,11}{⾎,⽔}
  \begin{Phonetics}{血液}{xue4ye4}[][HSK 6]
    \definition[毫升]{s.}{sangue | linha de vida; sangue vital; importante componente ou força que mantém a vitalidade coletiva}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{行驶}{6,8}{⾏,⾺}
  ...
  \synonymref{驾驶}{jia4shi3}
  \synonymref{行进}{xing2jin4}
  \synonymref{运行}{yun4xing2}
  \antonymref{停泊}{ting2bo2}
  \antonymref{停车}{ting2che1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{行程}{6,12}{⾏,⽲}
  ...
  \synonymref{过程}{guo4cheng2}
  \synonymref{进程}{jin4cheng2}
  \synonymref{路程}{lu4cheng2}
  \synonymref{路途}{lu4tu2}
  \synonymref{旅程}{lv3cheng2}
  \synonymref{日程}{ri4cheng2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{西式厨房}{6,6,12,8}{⾑,⼷,⼚,⼾}
  \begin{Phonetics}{西式厨房}{xi1shi4 chu2fang2}[][HSK 5]
    \definition{s.}{cozinha de estilo ocidental}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{西式餐厅}{6,6,16,4}{⾑,⼷,⾷,⼚}
  \begin{Phonetics}{西式餐厅}{xi1shi4 can1ting1}[][HSK 5]
    \definition{s.}{restaurante ocidental; restaurante de estilo ocidental}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{西部}{6,10}{⾑,⾢}
  ...
  \seealsoref{西边}{xi1bian5}
  \seealsoref{西方}{xi1fang1}
  \antonymref{东部}{dong1bu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{观光}{6,6}{⾒,⼉}
  ...
  \seealsoref{游览}{you2lan3}
  \synonymref{参观}{can1guan1}
  \synonymref{观赏}{guan1shang3}
  \synonymref{旅行}{lv3xing2}
  \synonymref{欣赏}{xin1shang3}
  \antonymref{不理}{bu4//li3}
  \antonymref{忽视}{hu1shi4}
  \antonymref{无视}{wu2shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{讲信用}{6,9,5}{⾔,⼈,⽤}
  \begin{Phonetics}{讲信用}{jiang3 xin4yong4}[][HSK 5]
    \definition{v.}{agir de boa"-fé | manter a fidelidade; ser digno de confiança; cumprir a palavra}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{许可}{6,5}{⾔,⼝}
  ...
  \seealsoref{容许}{rong2xu3}
  \seealsoref{允许}{yun3xu3}
  \synonymref{承诺}{cheng2nuo4}
...
\begin{Entry}{设身处地}{6,7,5,6}{⾔,⾝,⼡,⼟}
  \begin{Phonetics}{设身处地}{she4shen1chu3de5}[][HSK 5]
    \definition{expr.}{``Colocar"-se no lugar do outro.''; colocar"-se no lugar de outra pessoa; considerar as coisas sob a perspectiva de outra pessoa}
  \synonymref{将心比心}{jiang1xin1bi3xin1}
  \antonymref{随心所欲}{sui2xin1suo3yu4}
  \antonymref{自以为是}{zi4yi3wei2shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{设施}{6,9}{⾔,⽅}
  \begin{Phonetics}{设施}{she4shi1}[][HSK 4]
    \definition{s.}{instalaçôes; instituições, sistemas, organizações, edifícios, etc., estabelecidos para realizar um trabalho ou atender a uma necessidade}
  \synonymref{安排}{an1pai2}
  \synonymref{部署}{bu4shu3}
  \synonymref{布置}{bu4zhi4}
  \synonymref{筹划}{chou2//hua4}
...
\begin{Entry}{访问者}{6,6,8}{⾔,⾨,⽼}
  \begin{Phonetics}{访问者}{fang3wen4 zhe3}[][HSK 5]
    \definition{s.}{visitante; referindo"-se a alguém que visita uma pessoa ou local, ou a um usuário que navega em um \emph{site}}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{负能量}{6,10,12}{⾙,⾁,⾥}
  \begin{Phonetics}{负能量}{fu4 neng2liang4}[][HSK 5]
    \definition{s.}{energia negativa; estado de espírito ou humor negativo e deprimido | negatividade}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{轨迹}{6,9}{⾞,⾡}
  \begin{Phonetics}{轨迹}{gui3ji4}[][HSK 7-9]
    \definition{s.}{trilha; caminho; trajetória | órbita; caminho | trilha; pegada; experiências de vida ou o caminho de desenvolvimento das coisas}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{轨道}{6,12}{⾞,⾡}
  \begin{Phonetics}{轨道}{gui3dao4}[][HSK 6]
    \definition[条]{s.}{trilha; uma rota pavimentada com trilhos de aço para trens, bondes, etc. | órbita; trajetória; corpos celestes e objetos têm trajetórias de movimento regulares | caminho; curso; maneira adequada de fazer as coisas; curso adequado; desenvolvimento normal das coisas ou as normas e procedimentos que as pessoas devem seguir}
  \synonymref{轨迹}{gui3ji4}
  \synonymref{铁路}{tie3lu4}
...
\begin{Entry}{过于}{6,3}{⾡,⼆}
  ...
  \synonymref{过分}{guo4fen4}
  \antonymref{不过}{bu2guo4}
  \antonymref{欠缺}{qian4que1}
  \antonymref{适度}{shi4du4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{过分}{6,4}{⾡,⼑}
  ...
  \seealsoref{过度}{guo4du4}
  \seealsoref{过火}{guo4huo3}
  \synonymref{过头}{guo4//tou2}
  \synonymref{过于}{guo4yu2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{过火}{6,4}{⾡,⽕}
  \begin{Phonetics}{过火}{guo4huo3}
    \definition{adj.}{longe demais; exagerado; extremo; excessivo; acima do limite}
  \seealsoref{过度}{guo4du4}
  \seealsoref{过分}{guo4fen4}
  \synonymref{过头}{guo4//tou2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{过去}{6,5}{⾡,⼛}
  \begin{Phonetics}{过去}{guo4qu4}[][HSK 2,3]
...
\begin{Entry}{过后}{6,6}{⾡,⼝}
  ...
  \antonymref{先前}{xian1qian2}
  \antonymref{预先}{yu4xian1}
  \antonymref{原先}{yuan2xian1}
  \antonymref{之前}{zhi1qian2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{过年}{6,6}{⾡,⼲}
  \begin{Phonetics}{过年}{guo4nian2}[][HSK 2]
...
\begin{Entry}{过时}{6,7}{⾡,⽇}
  ...
  \synonymref{逾期}{yu2//qi1}
  \antonymref{尖端}{jian1duan1}
  \antonymref{流行}{liu2xing2}
  \antonymref{时髦}{shi2mao2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{过来}{6,7}{⾡,⽊}
  \begin{Phonetics}{过来}{guo4lai2}[][HSK 2]
    \definition{v.+compl.}{vir até aqui | ser capaz de cuidar de | lidar com | administrar}
  \seealsoref{过去}{guo4qu4}
  \synonymref{回来}{hui2lai2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{过度}{6,9}{⾡,⼴}
  ...
  \seealsoref{过分}{guo4fen4}
  \seealsoref{过火}{guo4huo3}
  \synonymref{超标}{chao1//biao1}
  \synonymref{过头}{guo4//tou2}
  \synonymref{极度}{ji2du4}
  \synonymref{透支}{tou4zhi1}
  \antonymref{适当}{shi4dang4}
  \antonymref{适度}{shi4du4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{过屠门而大嚼}{6,11,3,6,3,20}{⾡,⼫,⾨,⽽,⼤,⼝}
  \begin{Phonetics}{过屠门而大嚼}{guo4 tu2men2 er2 da4 jiao2}
    \definition{expr.}{``Passar pelo portão do açougueiro e comer com apetite.''; descreve alguém que admira algo, mas não pode tê"-lo, e usa métodos irreais para se consolar; alimente"-se de ilusões; tem significado negativo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{过期药}{6,12,9}{⾡,⽉,⾋}
  \begin{Phonetics}{过期药}{guo4qi1 yao4}[][HSK 5]
    \definition{s.}{medicamento vencido}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{过期食品}{6,12,9,9}{⾡,⽉,⾷,⼝}
  \begin{Phonetics}{过期食品}{guo4qi1 shi2pin3}[][HSK 5]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{过意不去}{6,13,4,5}{⾡,⼼,⼀,⼛}
  \begin{Phonetics}{过意不去}{guo4yi4bu2qu4}[][HSK 7-9]
    \definition{expr.}{sentir"-se arrependido ou culpado; sentir"-se mal ou envergonhado; sentir"-se envergonhado ou arrependido; aceitar um favor de alguém, mas não retribuí"-lo, ou sentir pena de algo e não ser culpado, o que faz com que alguém se sinta arrependido e desconfortável}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{那时}{6,7}{⾢,⽇}
  ...
  \seealsoref{那时候}{na4 shi2hou4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{那时候}{6,7,10}{⾢,⽇,⼈}
  \begin{Phonetics}{那时候}{na4 shi2hou4}[][HSK 2]
...
\begin{Entry}{闭幕}{6,13}{⾨,⼱}
  ...
  \antonymref{开幕}{kai1mu4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{闭幕式}{6,13,6}{⾨,⼱,⼷}
  \begin{Phonetics}{闭幕式}{bi4mu4 shi4}[][HSK 5]
...
\begin{Entry}{问好}{6,6}{⾨,⼥}
  \begin{Phonetics}{问好}{wen4//hao3}
    \definition{v.+compl.}{cumprimentar; enviar saudações a}
  \seealsoref{问候}{wen4hou4}
  \synonymref{问安}{wen4'an1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{阳光}{6,6}{⾩,⼉}
  ...
  \synonymref{活泼}{huo2po1}
  \synonymref{开朗}{kai1lang3}
  \synonymref{乐观}{le4guan1}
  \synonymref{明媚}{ming2mei4}
  \synonymref{正直}{zheng4zhi2}
  \antonymref{悲观}{bei1guan1}
  \antonymref{阴暗}{yin1'an4}
...
\begin{Entry}{阴谋}{6,11}{⾩,⾔}
  ...
  \synonymref{妄想}{wang4xiang3}
  \synonymref{野心}{ye3xin1}
  \antonymref{计策}{ji4ce4}
  \antonymref{计划}{ji4hua4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{阴暗}{6,13}{⾩,⽇}
  \begin{Phonetics}{阴暗}{yin1'an4}[][HSK 7-9]
    \definition{adj.}{escuro; sombrio; não confiável ou honroso | escuro; sombrio; deprimido; descreve o mau humor de uma pessoa; uma mentalidade negativa; pensamentos negativos sobre pessoas e coisas; ou um ambiente social que carece de justiça ou equidade}
...
\begin{Entry}{齐}{6}{⿑}[Kangxi 210]
  \begin{Phonetics}{齐}{ji4}
    \definition{s.}{tempero; condimento}
    \definition{v.}{coordenar; combinar; misturar}
  \end{Phonetics}
