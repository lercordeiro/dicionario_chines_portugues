...
\begin{Entry}{愈来愈}{13,7,13}{⼼,⽊,⼼}
  \begin{Phonetics}{愈来愈}{yu4 lai2 yu4}[][HSK 7-9]
...
\begin{Entry}{意料之外}{13,10,3,5}{⼼,⽃,⼂,⼣}
  \begin{Phonetics}{意料之外}{yi4liao4 zhi1 wai4}[][HSK 7-9]
...
\begin{Entry}{滚轮}{13,8}{⽔,⾞}
  \begin{Phonetics}{滚轮}{gun3lun2}
    \definition{s.}{pneu | dial rotativo | roda de rolagem de mouse de computador (\emph{scroll})}
  \end{Phonetics}
\end{Entry}
