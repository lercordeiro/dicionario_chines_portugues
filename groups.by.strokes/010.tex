...
\begin{Entry}{桌面}{10,9}{⽊,⾯}
  \begin{Phonetics}{桌面}{zhuo1mian4}
    \definition{s.}{tampo da mesa; a parte superior da mesa; a superfície de uma mesa, incluindo as superfícies fixas e móveis | Computação: área de trabalho; uma metáfora para uma janela na tela de um computador que exibe o sistema operacional básico para o operador}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{热门}{10,3}{⽕,⾨}
  \begin{Phonetics}{热门}{re4men2}[][HSK 5]
    ...
    \definition{s.}{algo que desperta o interesse popular; metáfora para algo que está na moda e recebe a atenção de todos}
  \synonymref{流行}{liu2xing2}
...
\begin{Entry}{被迫}{10,8}{⾐,⾡}
  \begin{Phonetics}{被迫}{bei4po4}[][HSK 4]
...
\begin{Entry}{高于}{10,3}{⾼,⼆}
  \begin{Phonetics}{高于}{gao1yu2}[][HSK 5]
...
\begin{Entry}{高潮}{10,15}{⾼,⽔}
  \begin{Phonetics}{高潮}{gao1chao2}[][HSK 4]
    \definition[个,场]{s.}{maré alta; o nível mais alto da maré em um ciclo de maré | pico; aumento; maré alta; uma metáfora para o estágio mais próspero de desenvolvimento das coisas | (ficção, drama e filmes) clímax}
