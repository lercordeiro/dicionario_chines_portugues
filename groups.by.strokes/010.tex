...
%%% 10画
%%%
\section*{10画}\addcontentsline{toc}{section}{10画}\addcontentsline{loh}{figure}{\#\#\#\# 10画}
...
%%%%%%%%%% 亳 %%%%%%%%%%
\subsection*{亳}\addcontentsline{loh}{figure}{亳}

\begin{Entry}{亳}{10}{⼇}
  \begin{Phonetics}{亳}{bo2}
    \definition*{s.}{Bozhou, uma cidade na província de Anhui (安徽) | Capital de Yin | Nome de distrito em Anhui (安徽)}
  \seealsoref{安徽}{an1hui1}
  \seealsoref{亳州}{bo2zhou1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{亳州}{10,6}{⼇,⼮}
  \begin{Phonetics}{亳州}{bo2zhou1}
    \definition*{s.}{Bozhou, uma cidade na província de Anhui ()}
  \seealsoref{安徽}{an1hui1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{倒是}{10,9}{⼈,⽇}
  ...
  \synonymref{不过}{bu2guo4}
  \synonymref{不料}{bu2liao4}
...
\begin{Entry}{倘使}{10,8}{⼈,⼈}
  \begin{Phonetics}{倘使}{tang3shi3}
    \definition{conj.}{Literário: se; supondo que; no caso}
  \seealsoref{倘然}{tang3ran2}
...
\begin{Entry}{倘或}{10,8}{⼈,⼽}
  \begin{Phonetics}{倘或}{tang3huo4}
    \definition{conj.}{se; supondo; caso | supondo que}
  \synonymref{假如}{jia3ru2}
  \synonymref{如果}{ru2guo3}
  \synonymref{倘若}{tang3ruo4}
  \end{Phonetics}
...
\begin{Entry}{倘若}{10,8}{⼈,⾋}
  \begin{Phonetics}{倘若}{tang3ruo4}[][HSK 7-9]
...
\begin{Entry}{倘然}{10,12}{⼈,⽕}
  \begin{Phonetics}{倘然}{tang3ran2}
    \definition{adv.}{se; caso | tranquilamente | supondo que}
  \synonymref{假设}{jia3she4}
  \synonymref{倘若}{tang3ruo4}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 倚 %%%%%%%%%%
\subsection*{倚}\addcontentsline{loh}{figure}{倚}

\begin{Entry}{倚}{10}{⼈}
  \begin{Phonetics}{倚}{yi3}[][HSK 7-9]
...
\begin{Entry}{债务}{10,5}{⼈,⼒}
  \begin{Phonetics}{债务}{zhai4wu4}[][HSK 7-9]
...
\begin{Entry}{值班人员}{10,10,2,7}{⼈,⽟,⼈,⼝}
  \begin{Phonetics}{值班人员}{zhi2ban1 ren2yuan2}[][HSK 5]
    \definition[名,位,个]{s.}{pessoal de plantão}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{值钱}{10,10}{⼈,⾦}
  \begin{Phonetics}{值钱}{zhi2qian2}[][HSK 7-9]
...
\begin{Entry}{倾城}{10,9}{⼈,⼟}
  \begin{Phonetics}{倾城}{qing1cheng2}
    \definition{adj.}{deslumbrante (de mulher)}
    \definition{adv.}{toda a cidade ou toda a vila | vindo de todos os lugares | de todos os lugares}
...
\begin{Entry}{倾斜}{10,11}{⼈,⽃}
  \begin{Phonetics}{倾斜}{qing1xie2}[][HSK 7-9]
    \definition{v.}{inclinar; inclinar"-se; pender | ser a favor de; dar tratamento preferencial a; descreve uma orientação política que enfatiza um aspecto específico}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{健身}{10,7}{⼈,⾝}
  ...
  \synonymref{健美}{jian4mei3}
  \synonymref{运动}{yun4dong4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{健身教练}{10,7,11,8}{⼈,⾝,⽁,⽷}
  \begin{Phonetics}{健身教练}{jian4shen1 jiao4lian4}[][HSK 5]
    \definition{s.}{treinador físico; \emph{personal trainer}}[健身教练教我正确动作。===O treinador físico me ensina os movimentos corretos.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{健康人}{10,11,2}{⼈,⼴,⼈}
  \begin{Phonetics}{健康人}{jian4kang1 ren2}[][HSK 5]
    \definition{s.}{pessoa saudável; pessoa que goza de boa saúde e não apresenta doenças}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{健康饮料}{10,11,7,10}{⼈,⼴,⾷,⽃}
  \begin{Phonetics}{健康饮料}{jian4kang1 yin3liao4}[][HSK 5]
    \definition{s.}{bebida saudável}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{健康食品}{10,11,9,9}{⼈,⼴,⾷,⼝}
  \begin{Phonetics}{健康食品}{jian4kang1 shi2pin3}[][HSK 5]
    \definition{s.}{alimento saudável; tipo de alimento que compartilha as características comuns dos alimentos convencionais}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 剔 %%%%%%%%%%
\subsection*{剔}\addcontentsline{loh}{figure}{剔}

\begin{Entry}{剔}{10}{⼑}
  \begin{Phonetics}{剔}{ti1}
...
\begin{Entry}{剔除}{10,9}{⼑,⾩}
  \begin{Phonetics}{剔除}{ti1chu2}[][HSK 7-9]
...
%%%%%%%%%% 剥 %%%%%%%%%%
\subsection*{剥}\addcontentsline{loh}{figure}{剥}
...
%%%%%%%%%% 剧 %%%%%%%%%%
\subsection*{剧}\addcontentsline{loh}{figure}{剧}
...
\begin{Entry}{原木}{10,4}{⼚,⽊}
  \begin{Phonetics}{原木}{yuan2mu4}
    \definition{s.}{toras; madeira bruta; madeira não processada após o corte}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{原本}{10,5}{⼚,⽊}
  \begin{Phonetics}{原本}{yuan2ben3}[][HSK 7-9]
...
\begin{Entry}{原汁原味}{10,5,10,8}{⼚,⽔,⼚,⼝}
  \begin{Phonetics}{原汁原味}{yuan2zhi1-yuan2wei4}[][HSK 7-9]
...
\begin{Entry}{原创}{10,6}{⼚,⼑}
  \begin{Phonetics}{原创}{yuan2chuang4}[][HSK 7-9]
...
\begin{Entry}{原因}{10,6}{⼚,⼞}
  ...
  \seealsoref{理由}{li3you2}
  \seealsoref{缘故}{yuan2gu4}
...
\begin{Entry}{原地}{10,6}{⼚,⼟}
  \begin{Phonetics}{原地}{yuan2di4}[][HSK 7-9]
...
\begin{Entry}{原色}{10,6}{⼚,⾊}
  \begin{Phonetics}{原色}{yuan2se4}
    \definition{s.}{cor primária; as cores primárias dos pigmentos básicos que podem ser misturados para criar diversas cores são o vermelho, o amarelo e o azul}
  \seealsoref{基色}{ji1se4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{原材料}{10,7,10}{⼚,⽊,⽃}
  \begin{Phonetics}{原材料}{yuan2cai2liao4}[][HSK 7-9]
...
\begin{Entry}{原始}{10,8}{⼚,⼥}
  ...
  \synonymref{古老}{gu3lao3}
  \synonymref{最初}{zui4chu1}
  \antonymref{先进}{xian1jin4}
  \antonymref{现代}{xian4dai4}
  \antonymref{最新}{zui4xin1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{原型}{10,9}{⼚,⼟}
  \begin{Phonetics}{原型}{yuan2xing2}[][HSK 7-9]
...
\begin{Entry}{原料}{10,10}{⼚,⽃}
  ...
  \antonymref{成品}{cheng2pin3}
  \antonymref{制品}{zhi4pin3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{原谅}{10,10}{⼚,⾔}
  ...
  \seealsoref{谅解}{liang4jie3}
  \seealsoref{体谅}{ti3liang4}
  \synonymref{包容}{bao1rong2}
  \synonymref{放过}{fang4guo4}
  \synonymref{宽容}{kuan1rong2}
  \synonymref{宽恕}{kuan1shu4}
  \synonymref{饶恕}{rao2shu4}
  \antonymref{抱怨}{bao4//yuan4}
...
\begin{Entry}{原理}{10,11}{⼚,⽟}
  ...
  \synonymref{道理}{dao4li3}
  \synonymref{理论}{li3lun4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{原装}{10,12}{⼚,⾐}
  \begin{Phonetics}{原装}{yuan2zhuang1}[][HSK 7-9]
...
\begin{Entry}{哩哩啦啦}{10,10,11,11}{⼝,⼝,⼝,⼝}
  \begin{Phonetics}{哩哩啦啦}{li1li1la1la1}
...
\begin{Entry}{哭墙}{10,14}{⼝,⼟}
  \begin{Phonetics}{哭墙}{ku1qiang2}
    \definition*{s.}{Muro das Lamentações ou Muro Ocidental (Jerusalém)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{哲学}{10,8}{⼝,⼦}
  ...
  \synonymref{形而上学}{xing2'er2shang4xue2}
  \synonymref{玄学}{xuan2xue2}
  \synonymref{哲理}{zhe2li3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{哲学家}{10,8,10}{⼝,⼦,⼧}
  \begin{Phonetics}{哲学家}{zhe2xue2 jia1}[][HSK 5]
    \definition[名,位]{s.}{filósofo; acadêmicos e especialistas com amplo conhecimento em filosofia}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{唐人街}{10,2,12}{⼝,⼈,⾏}
  \begin{Phonetics}{唐人街}{tang2ren2jie1}
  ...
  \seealsoref{中国城}{zhong1guo2 cheng2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{唐初四大家}{10,7,5,3,10}{⼝,⾐,⼞,⼤,⼧}
  \begin{Phonetics}{唐初四大家}{tang2chu1 si4 da4jia1}
...
%%%%%%%%%% 壶 %%%%%%%%%%
\subsection*{壶}\addcontentsline{loh}{figure}{壶}
...
\begin{Entry}{夏令营}{10,5,11}{⼢,⼈,⾋}
  \begin{Phonetics}{夏令营}{xia4ling4ying2}[][HSK 7-9]
...
\begin{Entry}{套问}{10,6}{⼤,⾨}
  \begin{Phonetics}{套问}{tao4wen4}
    ...
    \definition{v.}{descobrir fazendo perguntas aparentemente casuais; sondar com tato; persuadir; convencer | descobrir por meio de questionamentos indiretos e discretos | sondar alguém}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{套餐}{10,16}{⼤,⾷}
  \begin{Phonetics}{套餐}{tao4can1}[][HSK 4]
    \definition[个]{s.}{combo; pacote de produtos; pacote de serviços; metaforicamente, bens ou projetos que são combinados e levados ao mercado | refeição preparada; pacotes de refeições completos}
  \synonymref{配套}{pei4//tao4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{娱乐}{10,5}{⼥,⼃}
  ...
  \synonymref{文娱}{wen2yu2}
  \synonymref{消遣}{xiao1qian3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{娱乐中心}{10,5,4,4}{⼥,⼃,⼁,⼼}
  \begin{Phonetics}{娱乐中心}{yu2le4 zhong1xin1}[][HSK 5]
    \definition{s.}{centro de recreação (ou de lazer); parque de diversões; centro de entretenimento}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 宰 %%%%%%%%%%
\subsection*{宰}\addcontentsline{loh}{figure}{宰}

\begin{Entry}{宰}{10}{⼧}
  \begin{Phonetics}{宰}{zai3}[][HSK 7-9]
...
\begin{Entry}{害怕}{10,8}{⼧,⼼}
  ...
  \seealsoref{可怕}{ke3pa4}
  \seealsoref{恐惧}{kong3ju4}
  \seealsoref{怕}{pa4}
...
\begin{Entry}{家园}{10,7}{⼧,⼞}
  \begin{Phonetics}{家园}{jia1yuan2}[][HSK 6]
...
\begin{Entry}{家里}{10,7}{⼧,⾥}
  \begin{Phonetics}{家里}{jia1li3}[][HSK 1]
    \definition{s.}{(em) casa; (em sua) família | esposa}
  \synonymref{夫人}{fu1ren5}
  \synonymref{家庭}{jia1ting2}
  \synonymref{老婆}{lao3po2}
  \antonymref{户外}{hu4wai4}
  \antonymref{外界}{wai4jie4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{家具}{10,8}{⼧,⼋}
  \begin{Phonetics}{家具}{jia1ju5}[][HSK 3]
...
\begin{Entry}{家庭}{10,9}{⼧,⼴}
  ...
  \seealsoref{家}{jia1}
  \synonymref{家里}{jia1li3}
  \synonymref{家园}{jia1yuan2}
  \synonymref{全家}{quan2jia1}
  \synonymref{人家}{ren2jia1}
...
\begin{Entry}{家常便饭}{10,11,9,7}{⼧,⼱,⼈,⾷}
  \begin{Phonetics}{家常便饭}{jia1chang2bian4fan4}[][HSK 5]
    \definition[顿]{expr.}{comida caseira; refeição comum; uma refeição compartilhada; jantar comunitário; ao receber visitas, uma refeição comum, sem preparo prévio, ou uma refeição simples, é suficiente | ocorrência comum; rotina; parte do trabalho diário; descreve algo que acontece com frequência e é comum}
  \synonymref{司空见惯}{si1kong1-jian4guan4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{容貌}{10,14}{⼧,⾘}
  \begin{Phonetics}{容貌}{rong2mao4}
    \definition{s.}{aparência; características faciais; rosto; frequentemente referindo"-se a uma aparência bonita}
...
\begin{Entry}{宽度}{10,9}{⼧,⼴}
  \begin{Phonetics}{宽度}{kuan1du4}[][HSK 5]
...
\begin{Entry}{宽阔}{10,12}{⼧,⾨}
  \begin{Phonetics}{宽阔}{kuan1kuo4}[][HSK 6]
    \definition{adj.}{amplo; largo; espaçoso | tolerante; mente aberta; descreve uma mente alegre e ampla}
  \seealsoref{宽广}{kuan1guang3}
  \seealsoref{宽敞}{kuan1chang5}
  \synonymref{广大}{guang3da4}
  \synonymref{广阔}{guang3kuo4}
  \synonymref{豁达}{huo4da2}
  \synonymref{开阔}{kai1kuo4}
...
\begin{Entry}{宽影片}{10,15,4}{⼧,⼺,⽚}
  \begin{Phonetics}{宽影片}{kuan1 ying3pian4}
    \definition{s.}{filme \emph{widescreen}; filme em tela ampla}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{射击运动员}{10,5,7,6,7}{⼨,⼐,⾡,⼒,⼝}
  \begin{Phonetics}{射击运动员}{she4ji1 yun4dong4yuan2}[][HSK 5]
    \definition{s.}{atletas de tiro; atirador}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 展 %%%%%%%%%%
\subsection*{展}\addcontentsline{loh}{figure}{展}
...
\begin{Entry}{展开}{10,4}{⼫,⼶}
  ...
  \seealsoref{开展}{kai1zhan3}
  \synonymref{敞开}{chang3kai1}
  \synonymref{打开}{da3kai1}
  \antonymref{收敛}{shou1lian3}
  \antonymref{收缩}{shou1suo1}
  \antonymref{压缩}{ya1suo1}
  \antonymref{折叠}{zhe2die2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{展出}{10,5}{⼫,⼐}
  \begin{Phonetics}{展出}{zhan3chu1}[][HSK 7-9]
...
\begin{Entry}{展览会}{10,9,6}{⼫,⾒,⼈}
  \begin{Phonetics}{展览会}{zhan3lan3hui4}[][HSK 7-9]
...
\begin{Entry}{展望}{10,11}{⼫,⽉}
  \begin{Phonetics}{展望}{zhan3wang4}[][HSK 7-9]
...
\begin{Entry}{席位}{10,7}{⼱,⼈}
  \begin{Phonetics}{席位}{xi2wei4}[][HSK 7-9]
...
\begin{Entry}{座位}{10,7}{⼴,⼈}
  ...
  \synonymref{席位}{xi2wei4}
  \antonymref{站台}{zhan4tai2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{座谈会}{10,10,6}{⼴,⾔,⼈}
  \begin{Phonetics}{座谈会}{zuo4tan2hui4}[][HSK 6]
    \definition{s.}{fórum; simpósio; discussão informal | conferência | conversa franca}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{徐徐}{10,10}{⼻,⼻}
  \begin{Phonetics}{徐徐}{xu2xu2}[][HSK 7-9]
    \definition{adv.}{lentamente; suavemente}
  \seealsoref{缓}{huan3}
...
\begin{Entry}{徒手}{10,4}{⼻,⼿}
  \begin{Phonetics}{徒手}{tu2shou3}
    \definition{adj.}{desarmado; sem armas; de mãos vazias (sem equipamento)}
  \antonymref{工具}{gong1ju4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{恋爱}{10,10}{⼼,⽖}
  ...
  \synonymref{爱情}{ai4qing2}
  \antonymref{分手}{fen1//shou3}
  \antonymref{冷漠}{leng3mo4}
  \antonymref{失恋}{shi1//lian4}
...
\begin{Entry}{恐怕}{10,8}{⼼,⼼}
  ...
  \seealsoref{担心}{dan1xin1}
  \seealsoref{可能}{ke3neng2}
  \seealsoref{怕}{pa4}
  \seealsoref{生怕}{sheng1pa4}
...
\begin{Entry}{恶心}{10,4}{⼼,⼼}
  ...
  \synonymref{讨厌}{tao3yan4}
  \synonymref{厌恶}{yan4wu4}
  \antonymref{迷人}{mi2ren2}
  \antonymref{舒服}{shu1fu5}
  \antonymref{喜爱}{xi3'ai4}
  \antonymref{喜欢}{xi3huan5}
  \antonymref{诱人}{you4ren2}
  \end{Phonetics}
...
\begin{Entry}{悄悄}{10,10}{⼼,⼼}
  ...
  \seealsoref{暗暗}{an4'an4}
  \seealsoref{偷偷}{tou1tou1}
  \synonymref{寂静}{ji4jing4}
  \synonymref{默默}{mo4mo4}
  \antonymref{公然}{gong1ran2}
...
\begin{Entry}{悔恨}{10,9}{⼼,⼼}
  \begin{Phonetics}{悔恨}{hui3hen4}[][HSK 7-9]
    \definition{v.}{arrepender"-se profundamente; estar amargamente arrependido | mais séria do que 后悔}
  \seealsoref{后悔}{hou4hui3}
  \synonymref{懊悔}{ao4hui3}
  \synonymref{怨恨}{yuan4hen4}
...
%%%%%%%%%% 扇 %%%%%%%%%%
\subsection*{扇}\addcontentsline{loh}{figure}{扇}

\begin{Entry}{扇}{10}{⼾}
  \begin{Phonetics}{扇}{shan1}[][HSK 5]
    \definition{v.}{ventilar; agitar um leque para fazer o ar circular | dar um tapa; bater com a palma da mão | bater asas; esvoaçar | incitar; instigar; estimular; agitar}
  \end{Phonetics}
...
\begin{Entry}{拳王}{10,4}{⼿,⽟}
  \begin{Phonetics}{拳王}{quan2wang2}
    \definition{s.}{campeão de boxe; senhor do ringue}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{拳头}{10,5}{⼿,⼤}
  \begin{Phonetics}{拳头}{quan2tou2}[][HSK 7-9]
    \definition{adj.}{nocaute; (de produtos) de boa qualidade e competitividade; ter uma vantagem e uma forte competitividade}
...
\begin{Entry}{拳法}{10,8}{⼿,⽔}
  \begin{Phonetics}{拳法}{quan2fa3}
    \definition{s.}{boxe | técnica de luta}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{拿不出手}{10,4,5,4}{⼿,⼀,⼐,⼿}
  \begin{Phonetics}{拿不出手}{na2 bu4 chu1shou3}[][HSK 5]
    \definition{expr.}{não apresentável; não suficientemente bom}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{拿主意}{10,5,13}{⼿,⼂,⼼}
  \begin{Phonetics}{拿主意}{na2//zhu3yi5}[][HSK 5]
    \definition{v.+compl.}{tomar uma decisão; decidir"-se; decidir sobre os métodos ou estratégias para lidar com o assunto}
  \synonymref{裁决}{cai2jue2}
  \synonymref{策划}{ce4hua4}
  \synonymref{出主意}{chu1//zhu3yi5}
...
\begin{Entry}{拿走}{10,7}{⼿,⾛}
  \begin{Phonetics}{拿走}{na2zou3}[][HSK 6]
...
\begin{Entry}{挨打}{10,5}{⼿,⼿}
  \begin{Phonetics}{挨打}{ai2da3}[][HSK 6]
    \definition{v.}{levar uma surra; ser atacado; ser espancado}
...
\begin{Entry}{振兴}{10,6}{⼿,⼋}
  \begin{Phonetics}{振兴}{zhen4xing1}[][HSK 7-9]
  ...
  \synonymref{强盛}{qiang2sheng4}
  \synonymref{兴盛}{xing1sheng4}
  \antonymref{衰弱}{shuai1ruo4}
...
\begin{Entry}{振作}{10,7}{⼿,⼈}
  \begin{Phonetics}{振作}{zhen4zuo4}[][HSK 7-9]
...
\begin{Entry}{振奋}{10,8}{⼿,⼤}
  \begin{Phonetics}{振奋}{zhen4fen4}[][HSK 7-9]
...
%%%%%%%%%% 挽 %%%%%%%%%%
\subsection*{挽}\addcontentsline{loh}{figure}{挽}

\begin{Entry}{挽}{10}{⼿}
  \begin{Phonetics}{挽}{wan3}[][HSK 7-9]
...
\begin{Entry}{挽回}{10,6}{⼿,⼞}
  \begin{Phonetics}{挽回}{wan3hui2}[][HSK 7-9]
...
\begin{Entry}{挽救}{10,11}{⼿,⽁}
  \begin{Phonetics}{挽救}{wan3jiu4}[][HSK 7-9]
...
%%%%%%%%%% 捂 %%%%%%%%%%
\subsection*{捂}\addcontentsline{loh}{figure}{捂}

\begin{Entry}{捂}{10}{⼿}
  \begin{Phonetics}{捂}{wu2}
    \definition{v.}{encobrir; esconder; evitar; falar de forma vaga ou evasiva: ignorar}
  \antonymref{揭}{jie1}
  \end{Phonetics}
  \begin{Phonetics}{捂}{wu3}[][HSK 7-9]
...
%%%%%%%%%% 捅 %%%%%%%%%%
\subsection*{捅}\addcontentsline{loh}{figure}{捅}

\begin{Entry}{捅}{10}{⼿}
  \begin{Phonetics}{捅}{tong3}[][HSK 7-9]
...
\begin{Entry}{捉迷藏}{10,9,17}{⼿,⾡,⾋}
  \begin{Phonetics}{捉迷藏}{zhuo1mi2cang2}[][HSK 7-9]
    \definition{s.}{esconde"-esconde; cabra"-cega; uma brincadeira infantil em que você venda os olhos e tateia para encontrar quem está escondido}
    \definition{v.}{esquivar"-se; ser ardiloso e evasivo; brincar de esconde"-esconde com; dar voltas e voltas; descreve ações ou palavras que são enigmáticas e deliberadamente difíceis de entender}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{损}{10}{⼿}
  \begin{Phonetics}{损}{sun3}[][HSK 7-9]
...
\begin{Entry}{损人利己}{10,2,7,3}{⼿,⼈,⼑,⼰}
  \begin{Phonetics}{损人利己}{sun3ren2-li4ji3}[][HSK 7-9]
...
\begin{Entry}{损伤}{10,6}{⼿,⼈}
  \begin{Phonetics}{损伤}{sun3shang1}[][HSK 7-9]
  ...
  \synonymref{受伤}{shou4shang1}
  \synonymref{损害}{sun3hai4}
  \antonymref{保护}{bao3hu4}
  \antonymref{保养}{bao3yang3}
  \antonymref{修补}{xiu1bu3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{损坏}{10,7}{⼿,⼟}
  \begin{Phonetics}{损坏}{sun3huai4}[][HSK 7-9]
...
\begin{Entry}{损害}{10,10}{⼿,⼧}
  \begin{Phonetics}{损害}{sun3hai4}[][HSK 5]
    \definition{v.}{prejudicar; danificar; ferir; causar danos; causar perdas}
  \seealsoref{伤害}{shang1hai4}
  \seealsoref{损伤}{sun3shang1}
  \seealsoref{危害}{wei1hai4}
  \synonymref{妨碍}{fang2'ai4}
  \synonymref{破坏}{po4huai4}
  \synonymref{侵害}{qin1hai4}
  \synonymref{受伤}{shou4shang1}
  \synonymref{损坏}{sun3huai4}
  \antonymref{爱护}{ai4hu4}
  \antonymref{保护}{bao3hu4}
  \antonymref{防护}{fang2hu4}
  \antonymref{呵护}{he1hu4}
  \antonymref{获得}{huo4de2}
...
\begin{Entry}{换}{10}{⼿}
  ...
  \seealsoref{兑换}{dui4huan4}
  \seealsoref{交换}{jiao1huan4}
...
\begin{Entry}{换钱}{10,10}{⼿,⾦}
  \begin{Phonetics}{换钱}{huan4//qian2}
    \definition{v.+compl.}{trocar dinheiro; trocar notas de valor alto por notas de valor baixo ou vice"-versa; trocar uma moeda por outra | vender; trocar (mercadorias) por dinheiro; ganhar dinheiro vendendo coisas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{效力}{10,2}{⽁,⼒}
  \begin{Phonetics}{效力}{xiao4li4}[][HSK 7-9]
...
\begin{Entry}{效仿}{10,6}{⽁,⼈}
  \begin{Phonetics}{效仿}{xiao4fang3}[][HSK 7-9]
...
\begin{Entry}{效应}{10,7}{⽁,⼴}
  \begin{Phonetics}{效应}{xiao4ying4}[][HSK 7-9]
...
\begin{Entry}{效果}{10,8}{⽁,⽊}
  ...
  \seealsoref{成果}{cheng2guo3}
  \synonymref{成绩}{cheng2ji4}
  \synonymref{成就}{cheng2jiu4}
  \synonymref{成效}{cheng2xiao4}
  \synonymref{功效}{gong1xiao4}
  \synonymref{结果}{jie2guo3}
  \synonymref{效益}{xiao4yi4}
  \synonymref{效应}{xiao4ying4}
  \antonymref{动机}{dong4ji1}
  \antonymref{失效}{shi1//xiao4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{效益}{10,10}{⽁,⽫}
  \begin{Phonetics}{效益}{xiao4yi4}[][HSK 7-9]
...
\begin{Entry}{敌人}{10,2}{⾆,⼈}
  ...
  \seealsoref{敌}{di2}
  \synonymref{仇人}{chou2ren2}
  \antonymref{队友}{dui4you3}
  \antonymref{伙伴}{huo3ban4}
  \antonymref{朋友}{peng2you5}
  \antonymref{同志}{tong2zhi4}
  \antonymref{友人}{you3ren2}
  \antonymref{知己}{zhi1ji3}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 斋 %%%%%%%%%%
\subsection*{斋}\addcontentsline{loh}{figure}{斋}

\begin{Entry}{斋}{10}{⽂}
  \begin{Phonetics}{斋}{zhai1}
    \definition{s.}{dieta vegetariana adotada por motivos religiosos | Obsoleto: sala; quarto; prédio; edifício | jejum}
    \definition{v.}{dar esmola (a um monge); dar comida aos monges}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{斋月}{10,4}{⽂,⽉}
  \begin{Phonetics}{斋月}{zhai1yue4}
    \definition*{s.}{Ramadã (Islã); mês do jejum, especificamente o nono mês do calendário islâmico}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{料}{10}{⽃}
  \begin{Phonetics}{料}{liao4}[][HSK 6]
    ...
    \definition[块]{s.}{material; coisa | (grão) alimento; forragem | artigos de vidro; vidros coloridos opacos | (para pílulas de medicina chinesa) prescrição}
...
\begin{Entry}{旅行社}{10,6,7}{⽅,⾏,⽰}
  \begin{Phonetics}{旅行社}{lv3xing2she4}[][HSK 3]
...
\begin{Entry}{旅店}{10,8}{⽅,⼴}
  \begin{Phonetics}{旅店}{lv3dian4}[][HSK 6]
...
\begin{Entry}{旅馆}{10,11}{⽅,⾷}
  \begin{Phonetics}{旅馆}{lv3guan3}[][HSK 3]
...
\begin{Entry}{旅游市场}{10,12,5,6}{⽅,⽔,⼱,⼟}
  \begin{Phonetics}{旅游市场}{lv3you2 shi4chang3}[][HSK 5]
    \definition{s.}{mercado turístico}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 晃 %%%%%%%%%%
\subsection*{晃}\addcontentsline{loh}{figure}{晃}
...
%%%%%%%%%% 晋 %%%%%%%%%%
\subsection*{晋}\addcontentsline{loh}{figure}{晋}
...
%%%%%%%%%% 晒 %%%%%%%%%%
\subsection*{晒}\addcontentsline{loh}{figure}{晒}
...
\begin{Entry}{晒干}{10,3}{⽇,⼲}
  ...
  \synonymref{烘干}{hong1gan1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{晒太阳}{10,4,6}{⽇,⼤,⾩}
  \begin{Phonetics}{晒太阳}{shai4tai4yang2}[][HSK 7-9]
...
%%%%%%%%%% 晓 %%%%%%%%%%
\subsection*{晓}\addcontentsline{loh}{figure}{晓}
...
\begin{Entry}{晓得}{10,11}{⽇,⼻}
  \begin{Phonetics}{晓得}{xiao3de2}[][HSK 6]
  ...
  \antonymref{不解}{bu4jie3}
  \antonymref{不知}{bu4zhi1}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 晕 %%%%%%%%%%
\subsection*{晕}\addcontentsline{loh}{figure}{晕}
...
\begin{Entry}{晕车}{10,4}{⽇,⾞}
  \begin{Phonetics}{晕车}{yun4che1}[][HSK 6]
    \definition{v.}{ter enjoo no carro; ter tontura e vômito ao andar de carro}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{晕倒}{10,10}{⽇,⼈}
  \begin{Phonetics}{晕倒}{yun1dao3}[][HSK 7-9]
...
\begin{Entry}{校}{10}{⽊}
  \begin{Phonetics}{校}{jiao4}
    \definition{v.}{verificar; revisar; organizar; comparar diferentes textos e corrigir erros tipográficos | comparar; contrastar}
  \end{Phonetics}
...
%%%%%%%%%% 株 %%%%%%%%%%
\subsection*{株}\addcontentsline{loh}{figure}{株}

\begin{Entry}{株}{10}{⽊}
  \begin{Phonetics}{株}{zhu1}[][HSK 7-9]
...
\begin{Entry}{样}{10}{⽊}
  ...
  \synonymref{形}{xing2}
  \synonymref{状}{zhuang4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{样儿}{10,2}{⽊,⼉}
  \begin{Phonetics}{样儿}{yang4r5}
    \definition{s.}{aparência; forma; aspecto; figura | maneira; ar; aparência | amostra; modelo; padrão | tendência;  probabilidade}
...
\begin{Entry}{样本}{10,5}{⽊,⽊}
  \begin{Phonetics}{样本}{yang4ben3}[][HSK 7-9]
...
\begin{Entry}{样式}{10,6}{⽊,⼷}
  \begin{Phonetics}{样式}{yang4shi4}
    \definition{s.}{tipo; forma; estilo; modelo; padrão de gênero; modalidade}
  \seealsoref{样子}{yang4zi5}
  \synonymref{款式}{kuan3shi4}
...
\begin{Entry}{样品}{10,9}{⽊,⼝}
  \begin{Phonetics}{样品}{yang4pin3}[][HSK 7-9]
...
\begin{Entry}{样样}{10,10}{⽊,⽊}
  \begin{Phonetics}{样样}{yang4yang4}
    \definition{pron.}{todos; de todos os tipos; cada um e todos; cada; cada tipo; todos os tipos}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{根据}{10,11}{⽊,⼿}
  ...
  \seealsoref{依据}{yi1ju4}
  \synonymref{本着}{ben3zhe5}
  \synonymref{道理}{dao4li3}
...
\begin{Entry}{格外}{10,5}{⽊,⼣}
  ...
  \seealsoref{分外}{fen4wai4}
  \synonymref{额外}{e2wai4}
...
\begin{Entry}{栽}{10}{⽊}
  \begin{Phonetics}{栽}{zai1}[][HSK 7-9]
...
\begin{Entry}{栽种}{10,9}{⽊,⽲}
  \begin{Phonetics}{栽种}{zai1zhong4}
    \definition{v.}{plantar (flores, mudas, etc.); cultivar}
  \synonymref{栽培}{zai1pei2}
  \synonymref{栽植}{zai1zhi2}
  \synonymref{种植}{zhong4zhi2}
  \antonymref{收成}{shou1cheng2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{栽倒}{10,10}{⽊,⼈}
  \begin{Phonetics}{栽倒}{zai1dao3}
    \definition{v.}{levar um tombo; sofrer uma queda; cair}
  \synonymref{家长}{jia1zhang3}
...
\begin{Entry}{栽赃}{10,10}{⽊,⾙}
  \begin{Phonetics}{栽赃}{zai1zang1}
    \definition{v.}{plantar mercadorias roubadas ou proibidas em alguém; entregar os bens roubados a outra pessoa e acusar falsamente de um crime | incriminar alguém; fabricar uma acusação contra alguém}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{栽培}{10,11}{⽊,⼟}
  \begin{Phonetics}{栽培}{zai1pei2}[][HSK 7-9]
...
\begin{Entry}{框架}{10,9}{⽊,⽊}
  \begin{Phonetics}{框架}{kuang4jia4}[][HSK 7-9]
    \definition[个,副,种,套]{s.}{moldura; estrutura; na construção civil, as estruturas são formadas por conexões como vigas e colunas | estrutura; estrutura básica de um sistema, texto, etc.; organização e estrutura das coisas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{桌面}{10,9}{⽊,⾯}
  \begin{Phonetics}{桌面}{zhuo1mian4}
    \definition{s.}{tampo da mesa; a parte superior da mesa; a superfície de uma mesa, incluindo as superfícies fixas e móveis | Computação: área de trabalho; janela na tela de um computador que exibe o sistema operacional básico para o operador}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{桌球}{10,11}{⽊,⽟}
  \begin{Phonetics}{桌球}{zhuo1qiu2}
    \definition[种]{s.}{bilhar | sinuca (Hong Kong, Singapura, Malásia) | tênis de mesa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{桑巴舞}{10,4,14}{⽊,⼰,⾇}
  \begin{Phonetics}{桑巴舞}{sang1ba1wu3}
    \definition*{s.}{Samba, uma dança brasileira}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{桑树}{10,9}{⽊,⽊}
  \begin{Phonetics}{桑树}{sang1shu4}
    \definition[棵,株]{s.}{amoreira branca; amoreira (árvore) | amoreira, cujas folhas são usadas para alimentar bichos"-da"-seda}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{桥}{10}{⽊}
  ...
  \seealsoref{桥梁}{qiao2liang2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{桥梁}{10,11}{⽊,⽊}
  \begin{Phonetics}{桥梁}{qiao2liang2}[][HSK 6]
    \definition[座]{s.}{ponte; acesso; uma obra construída na superfície do rio, conectando as duas margens | ponte; pessoas ou coisas que podem se comunicar}
  \seealsoref{桥}{qiao2}
  \synonymref{纽带}{niu3dai4}
  \antonymref{隔阂}{ge2he2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{桩}{10}{⽊}
  \begin{Phonetics}{桩}{zhuang1}[][HSK 7-9]
...
\begin{Entry}{氧}{10}{⽓}
  \begin{Phonetics}{氧}{yang3}[][HSK 7-9]
...
\begin{Entry}{氧气}{10,4}{⽓,⽓}
  ...
  \synonymref{空气}{kong1qi4}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 泰 %%%%%%%%%%
\subsection*{泰}\addcontentsline{loh}{figure}{泰}

\begin{Entry}{泰}{10}{⽔}
  \begin{Phonetics}{泰}{tai4}
...
\begin{Entry}{流}{10}{⽔}
  \begin{Phonetics}{流}{liu2}[][HSK 2]
    ...
    \definition{clas.}{lúmen; abreviação de 流明}
...
\begin{Entry}{流水}{10,4}{⽔,⽔}
  \begin{Phonetics}{流水}{liu2shui3}[][HSK 7-9]
    \definition{s.}{água corrente; coisas contínuas | faturamento (nos negócios); isso se refere à receita de vendas de uma loja}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{流失}{10,5}{⽔,⼤}
  \begin{Phonetics}{流失}{liu2shi1}[][HSK 7-9]
    \definition{v.}{escorrer; ser levado pela água; rochas, água e solo na natureza desaparecem por si mesmos ou são levados pela água e pelo vento | perder; esgotar; fluir para longe; perder algo útil e valioso | ir embora; perder funcionários; descreve pessoas que deixam sua região ou local de trabalho}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{流传}{10,6}{⽔,⼈}
  ...
  \synonymref{传承}{chuan2cheng2}
  \synonymref{散布}{san4bu4}
  \synonymref{宣传}{xuan1chuan2}
  \synonymref{宣扬}{xuan1yang2}
  \antonymref{失传}{shi1chuan2}
  \antonymref{消失}{xiao1shi1}
  \antonymref{遗失}{yi2shi1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{流动}{10,6}{⽔,⼒}
  \begin{Phonetics}{流动}{liu2dong4}[][HSK 5]
    \definition{v.}{(água, ar, etc.) fluir; correr; circular | ir de um lugar para outro; estar em movimento; ser móvel}
  \antonymref{固定}{gu4ding4}
  \antonymref{凝固}{ning2gu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{流行}{10,6}{⽔,⾏}
  ...
  \seealsoref{风行}{feng1xing2}
  \synonymref{流通}{liu2tong1}
  \synonymref{盛行}{sheng4xing2}
...
\begin{Entry}{流行性感冒}{10,6,8,13,9}{⽔,⾏,⼼,⼼,⽇}
  \begin{Phonetics}{流行性感冒}{liu2xing2xing4 gan3mao4}
...
\begin{Entry}{流星}{10,9}{⽔,⽇}
  \begin{Phonetics}{流星}{liu2xing1}
    \definition[道]{s.}{meteoro; estrela cadente | Arcaico: uma arma composta por duas bolas de ferro fixadas em uma longa corrente de ferro}
  \seealsoref{流星锤}{liu2xing1chui2}
  \seealsoref{贼星}{zei2xing1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{流星锤}{10,9,13}{⽔,⽇,⾦}
  \begin{Phonetics}{流星锤}{liu2xing1chui2}
    \definition*{s.}{Martelo Meteoro}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{浪花}{10,7}{⽔,⾋}
  \begin{Phonetics}{浪花}{lang4hua1}
    \definition[朵]{s.}{espuma de ondas quebrando | Figurativo: episódios na vida de alguém | caldo; spray; espuma | borrifo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{浪费}{10,9}{⽔,⾙}
  ...
  \seealsoref{耗费}{hao4fei4}
  \synonymref{不惜}{bu4xi1}
  \synonymref{滥用}{lan4yong4}
  \synonymref{奢侈}{she1chi3}
  \antonymref{爱惜}{ai4xi1}
  \antonymref{俭省}{jian3sheng3}
  \antonymref{节俭}{jie2jian3}
  \antonymref{节省}{jie2sheng3}
  \antonymref{节约}{jie2yue1}
  \antonymref{精打细算}{jing1da3-xi4suan4}
  \antonymref{珍惜}{zhen1xi1}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 浬 %%%%%%%%%%
\subsection*{浬}\addcontentsline{loh}{figure}{浬}

\begin{Entry}{浬}{10}{⽔}
  \begin{Phonetics}{浬}{hai3}
    \definition{s.}{milha náutica (unidade de distância usada no mar, equivalente a 1,852 quilômetros)}
  \end{Phonetics}
  \begin{Phonetics}{浬}{li3}
    \definition{s.}{milha náutica; milha marítima}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{浮}{10}{⽔}
  \begin{Phonetics}{浮}{fu2}[][HSK 6]
    ...
    \definition{v.}{flutuar | Dialeto: nadar | flutuar; derivar; flutuar na superfície do líquido}
  \synonymref{漂}{piao1}
  \antonymref{沉}{chen2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{浮屠}{10,11}{⽔,⼫}
  \begin{Phonetics}{浮屠}{fu2tu2}
    \definition*{s.}{Buda}
    \definition{s.}{Literário: monge budista | pagode ou estupa budista | budismo}
  \seealsoref{浮图}{fu2tu2}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 浴 %%%%%%%%%%
\subsection*{浴}\addcontentsline{loh}{figure}{浴}

\begin{Entry}{浴}{10}{⽔}
  \begin{Phonetics}{浴}{yu4}
    \definition{v.}{tomar banho; banhar"-se}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{浴室}{10,9}{⽔,⼧}
  \begin{Phonetics}{浴室}{yu4shi4}[][HSK 7-9]
...
\begin{Entry}{海}{10}{⽔}
  \begin{Phonetics}{海}{hai3}[][HSK 2]
    ...
    \definition[片]{s.}{mar; grande lago; a parte do oceano próxima à costa, alguns grandes lagos também são chamados de mar | grande número de pessoas ou coisas reunidas; muitas coisas semelhantes que formam um grande conjunto}
  \seealsoref{差}{cha4}
  \synonymref{多}{duo1}
  \synonymref{巨}{ju4}
  \antonymref{少}{shao3}
...
\begin{Entry}{海内外}{10,4,5}{⽔,⼌,⼣}
  \begin{Phonetics}{海内外}{hai3nei4wai4}[][HSK 7-9]
    \definition{s.}{em casa e no exterior | nacional e internacional}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{海水}{10,4}{⽔,⽔}
  \begin{Phonetics}{海水}{hai3shui3}[][HSK 4]
...
\begin{Entry}{海风}{10,4}{⽔,⾵}
  \begin{Phonetics}{海风}{hai3feng1}
    \definition{s.}{brisa marítima | vento marítimo (ou seja, vindo do mar)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{海外}{10,5}{⽔,⼣}
  \begin{Phonetics}{海外}{hai3wai4}[][HSK 6]
    \definition[次]{s.}{fora das fronteiras nacionais; no exterior}
  \synonymref{国外}{guo2wai4}
  \synonymref{外国}{wai4guo2}
  \antonymref{国内}{guo2nei4}
  \antonymref{境内}{jing4nei4}
  \antonymref{内地}{nei4di4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{海边}{10,5}{⽔,⾡}
  \begin{Phonetics}{海边}{hai3bian1}[][HSK 2]
...
\begin{Entry}{海军}{10,6}{⽔,⼍}
  \begin{Phonetics}{海军}{hai3jun1}[][HSK 6]
...
\begin{Entry}{海报}{10,7}{⽔,⼿}
  \begin{Phonetics}{海报}{hai3bao4}[][HSK 6]
...
\begin{Entry}{海里}{10,7}{⽔,⾥}
  \begin{Phonetics}{海里}{hai3li3}
    \definition{s.}{milha marítima; milha náutica; unidade de comprimento usada para medir distâncias no mar; uma milha náutica equivale a 1.852 metros (anteriormente escrita como 浬).}
  \seealsoref{浬}{li3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{海底}{10,8}{⽔,⼴}
  \begin{Phonetics}{海底}{hai3di3}[][HSK 6]
    \definition{s.}{fundo do mar; fundo do oceano; solo oceânico}
  \antonymref{海面}{hai3mian4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{海洋}{10,9}{⽔,⽔}
  ...
  \synonymref{大海}{da4hai3}
  \synonymref{汪洋}{wang1yang2}
  \antonymref{大陆}{da4lu4}
  \antonymref{陆地}{lu4di4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{海鸥}{10,9}{⽔,⿃}
  \begin{Phonetics}{海鸥}{hai3'ou1}
    \definition{s.}{(espécie de ave da China) gaivota"-comum (\emph{Larus canus}); gaivota"-marinha}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{海浪}{10,10}{⽔,⽔}
  \begin{Phonetics}{海浪}{hai3lang4}[][HSK 6]
    \definition{s.}{ondas do mar}
  \synonymref{波浪}{bo1lang4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{海棠}{10,12}{⽔,⽊}
  \begin{Phonetics}{海棠}{hai3tang2}
    \definition{s.}{Macieira"-ornamental chinesa (\emph{Malus spectabilis}) | begônia}
  \seealsoref{海棠花}{hai3tang2hua1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{海棠花}{10,12,7}{⽔,⽊,⾋}
  \begin{Phonetics}{海棠花}{hai3tang2hua1}
    \definition{s.}{macieira"-brava chinesa (\emph{Malus spectabilis})}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{海湾}{10,12}{⽔,⽔}
  \begin{Phonetics}{海湾}{hai3wan1}[][HSK 6]
...
%%%%%%%%%% 涂 %%%%%%%%%%
\subsection*{涂}\addcontentsline{loh}{figure}{涂}

\begin{Entry}{涂}{10}{⽔}
  \begin{Phonetics}{涂}{tu2}[][HSK 7-9]
...
\begin{Entry}{消}{10}{⽔}
  \begin{Phonetics}{消}{xiao1}[][HSK 7-9]
...
\begin{Entry}{消化}{10,4}{⽔,⼔}
  \begin{Phonetics}{消化}{xiao1hua4}[][HSK 4]
    \definition{v.}{digerir (alimentos) | digerir (conhecimento); pensar e absorver; compreensão total de novos conhecimentos ou informações e a capacidade de transformá"-los em algo que possa ser usado}
...
\begin{Entry}{消失}{10,5}{⽔,⼤}
  ...
  \synonymref{灭绝}{mie4jue2}
  \synonymref{灭亡}{mie4wang2}
  \synonymref{没落}{mo4luo4}
  \synonymref{消灭}{xiao1mie4}
  \antonymref{呈现}{cheng2xian4}
  \antonymref{出现}{chu1xian4}
  \antonymref{存在}{cun2zai4}
  \antonymref{浮现}{fu2xian4}
  \antonymref{弥漫}{mi2man4}
  \antonymref{形成}{xing2cheng2}
...
\begin{Entry}{消灭}{10,5}{⽔,⽕}
  ...
  \seealsoref{歼灭}{jian1mie4}
  \synonymref{毁灭}{hui3mie4}
  \synonymref{灭绝}{mie4jue2}
  \synonymref{灭亡}{mie4wang2}
  \synonymref{清除}{qing1chu2}
  \synonymref{消除}{xiao1chu2}
  \synonymref{消失}{xiao1shi1}
  \antonymref{保存}{bao3cun2}
  \antonymref{保留}{bao3liu2}
  \antonymref{产生}{chan3sheng1}
  \antonymref{生存}{sheng1cun2}
  \antonymref{生长}{sheng1zhang3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{消防}{10,6}{⽔,⾩}
  \begin{Phonetics}{消防}{xiao1fang2}[][HSK 5]
    \definition{v.}{combater incêndios; prevenir incêndios}
  \synonymref{灭火}{mie4huo3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{消极}{10,7}{⽔,⽊}
  ...
  \antonymref{踊跃}{yong3yue4}
  \antonymref{主动}{zhu3dong4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{消极情绪}{10,7,11,11}{⽔,⽊,⼼,⽷}
  \begin{Phonetics}{消极情绪}{xiao1ji2 qing2xu4}[][HSK 5]
    \definition{s.}{emoções negativas}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{消沉}{10,7}{⽔,⽔}
  \begin{Phonetics}{消沉}{xiao1chen2}[][HSK 7-9]
...
\begin{Entry}{消毒}{10,9}{⽔,⽏}
  ...
  \synonymref{排除}{pai2chu2}
  \synonymref{清除}{qing1chu2}
  \synonymref{杀毒}{sha1//du2}
  \synonymref{消除}{xiao1chu2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{消费}{10,9}{⽔,⾙}
  ...
  \seealsoref{消耗}{xiao1hao4}
  \synonymref{耗费}{hao4fei4}
  \synonymref{花费}{hua1fei5}
  \antonymref{储蓄}{chu3xu4}
  \antonymref{积累}{ji1lei3}
  \antonymref{生产}{sheng1chan3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{消费者}{10,9,8}{⽔,⾙,⽼}
  \begin{Phonetics}{消费者}{xiao1fei4zhe3}[][HSK 5]
...
\begin{Entry}{消除}{10,9}{⽔,⾩}
  ...
  \seealsoref{清除}{qing1chu2}
  \synonymref{解除}{jie3chu2}
  \synonymref{排斥}{pai2chi4}
  \synonymref{排除}{pai2chu2}
  \synonymref{排挤}{pai2ji3}
...
\begin{Entry}{消息}{10,10}{⽔,⼼}
  ...
  \seealsoref{新闻}{xin1wen2}
  \seealsoref{信息}{xin4xi1}
...
\begin{Entry}{消耗}{10,10}{⽔,⽾}
  ...
  \seealsoref{消费}{xiao1fei4}
  \synonymref{耗费}{hao4fei4}
  \synonymref{花费}{hua1fei5}
  \synonymref{话费}{hua4fei4}
  \synonymref{流失}{liu2shi1}
  \antonymref{补充}{bu3chong1}
  \antonymref{储蓄}{chu3xu4}
  \antonymref{积累}{ji1lei3}
  \antonymref{积蓄}{ji1xu4}
  \antonymref{累积}{lei3ji1}
  \antonymref{贮藏}{zhu4cang2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{消遣}{10,13}{⽔,⾡}
  \begin{Phonetics}{消遣}{xiao1qian3}[][HSK 7-9]
...
\begin{Entry}{涉嫌}{10,13}{⽔,⼥}
  \begin{Phonetics}{涉嫌}{she4xian2}[][HSK 7-9]
    \definition{v.}{ser suspeito; ser suspeito de estar envolvido; ser suspeito de envolvimento em determinado assunto}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 涌 %%%%%%%%%%
\subsection*{涌}\addcontentsline{loh}{figure}{涌}

\begin{Entry}{涌}{10}{⽔}
  \begin{Phonetics}{涌}{chong1}
    \definition{s.}{um braço de um rio, frequentemente usado em nomes de lugares}
  \end{Phonetics}
  \begin{Phonetics}{涌}{yong3}[][HSK 7-9]
...
\begin{Entry}{涌入}{10,2}{⽔,⼊}
  \begin{Phonetics}{涌入}{yong3ru4}[][HSK 7-9]
...
\begin{Entry}{涌现}{10,8}{⽔,⾒}
  \begin{Phonetics}{涌现}{yong3xian4}[][HSK 7-9]
...
%%%%%%%%%% 润 %%%%%%%%%%
\subsection*{润}\addcontentsline{loh}{figure}{润}

\begin{Entry}{润}{10}{⽔}
  \begin{Phonetics}{润}{run4}[][HSK 7-9]
...
\begin{Entry}{涨}{10}{⽔}
  ...
  \antonymref{落}{luo4}
  \end{Phonetics}
  \begin{Phonetics}{涨}{zhang4}[][HSK 6]
...
\begin{Entry}{涨价}{10,6}{⽔,⼈}
  ...
  \antonymref{打折}{da3//zhe2}
  \antonymref{降价}{jiang4jia4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{烟火}{10,4}{⽕,⽕}
  \begin{Phonetics}{烟火}{yan1huo3}[][HSK 7-9]
    \definition{s.}{fumaça e fogo | comida cozida | descendentes; incenso oferecido aos ancestrais; metaforicamente referindo"-se aos descendentes | guerra; fumaça e chamas da guerra}
  \end{Phonetics}
...
\begin{Entry}{烟灰缸}{10,6,9}{⽕,⽕,⽸}
  \begin{Phonetics}{烟灰缸}{yan1hui1 gang1}[][HSK 5]
    \definition{s.}{cinzeiro; recipiente usado para apagar cinzas de cigarro e recolher bitucas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{烧}{10}{⽕}
  \begin{Phonetics}{烧}{shao1}[][HSK 4]
    ...
    \definition{v.}{queimar; pegar fogo | cozinhar; aquecer; assar | guisar depois de fritar ou fritar depois de guisar | assar; grelhar os ingredientes dos alimentos diretamente sobre o fogo | ter febre; estar com febre | danificar (matar ou murchar) as plantas pelo uso excessivo (ou inadequado) de fertilizantes | tornar"-se arrogante ou presunçoso; estar em uma boa posição e se deixar levar}
  \seealsoref{发烧}{fa1shao1}
  \synonymref{焚}{fen2}
  \synonymref{燃}{ran2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{热门}{10,3}{⽕,⾨}
  \begin{Phonetics}{热门}{re4men2}[][HSK 5]
    ...
    \definition{s.}{algo que desperta o interesse popular; algo que está na moda e recebe a atenção de todos}
  \synonymref{流行}{liu2xing2}
  \synonymref{热点}{re4dian3}
  \synonymref{盛行}{sheng4xing2}
  \antonymref{冷门}{leng3men2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{热心}{10,4}{⽕,⼼}
  ...
  \seealsoref{热情}{re4qing2}
  \synonymref{爱心}{ai4xin1}
...
\begin{Entry}{热心人}{10,4,2}{⽕,⼼,⼈}
  \begin{Phonetics}{热心人}{re4xin1 ren2}[][HSK 5]
    \definition{s.}{pessoa de bom coração; entusiasta; pessoa entusiasta; aqueles que demonstram entusiasmo ativo pelos assuntos alheios e pelas questões públicas mostram"-se prontos a ajudar e tomam a iniciativa de demonstrar preocupação}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{热水}{10,4}{⽕,⽔}
  ...
  \synonymref{开水}{kai1shui3}
  \antonymref{冷水}{leng3shui3}
  \antonymref{凉水}{liang2shui3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{热点}{10,9}{⽕,⽕}
  \begin{Phonetics}{热点}{re4dian3}[][HSK 6]
    \definition[个]{s.}{ponto de acesso; \emph{hotspot}}
  \synonymref{焦点}{jiao1dian3}
  \synonymref{热门}{re4men2}
  \antonymref{冷门}{leng3men2}
...
\begin{Entry}{爱好者}{10,6,8}{⽖,⼥,⽼}
  \begin{Phonetics}{爱好者}{ai4hao4 zhe3}[][HSK 5]
...
%%%%%%%%%% 爹 %%%%%%%%%%
\subsection*{爹}\addcontentsline{loh}{figure}{爹}
...
\begin{Entry}{特长}{10,4}{⽜,⾧}
  \begin{Phonetics}{特长}{te4chang2}[][HSK 7-9]
...
\begin{Entry}{特产}{10,6}{⽜,⼇}
  \begin{Phonetics}{特产}{te4chan3}[][HSK 7-9]
...
\begin{Entry}{特价}{10,6}{⽜,⼈}
  ...
  \synonymref{降价}{jiang4jia4}
  \synonymref{优惠}{you1hui4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{特权}{10,6}{⽜,⽊}
  \begin{Phonetics}{特权}{te4quan2}[][HSK 7-9]
...
\begin{Entry}{特色}{10,6}{⽜,⾊}
  \begin{Phonetics}{特色}{te4se4}[][HSK 3]
    \definition[种,个]{s.}{característica; característica distintiva; a cor única, estilo, etc. de um objeto}
  \seealsoref{特点}{te4dian3}
...
\begin{Entry}{特别}{10,7}{⽜,⼑}
  ...
  \seealsoref{分外}{fen4wai4}
  \seealsoref{是}{shi4}
  \seealsoref{特殊}{te4shu1}
  \synonymref{别致}{bie2zhi4}
  \synonymref{独特}{du2te4}
  \synonymref{非常}{fei1chang2}
  \synonymref{格外}{ge2wai4}
  \synonymref{十分}{shi2fen1}
...
\begin{Entry}{特别快车}{10,7,7,4}{⽜,⼑,⼼,⾞}
  \begin{Phonetics}{特别快车}{te4bie2kuai4che1}
...
\begin{Entry}{特快}{10,7}{⽜,⼼}
  ...
  \seealsoref{特别快车}{te4bie2kuai4che1}
  \antonymref{普快}{pu3kuai4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{特技}{10,7}{⽜,⼿}
  \begin{Phonetics}{特技}{te4ji4}
    \definition{s.}{acrobacia; truque | efeitos especiais}
...
\begin{Entry}{特例}{10,8}{⽜,⼈}
  \begin{Phonetics}{特例}{te4li4}[][HSK 7-9]
...
\begin{Entry}{特制}{10,8}{⽜,⼑}
  \begin{Phonetics}{特制}{te4zhi4}[][HSK 7-9]
...
\begin{Entry}{特质}{10,8}{⽜,⾙}
  \begin{Phonetics}{特质}{te4zhi4}[][HSK 7-9]
...
\begin{Entry}{特邀}{10,16}{⽜,⾡}
  \begin{Phonetics}{特邀}{te4yao1}[][HSK 7-9]
...
\begin{Entry}{牺牲}{10,9}{⽜,⽜}
  ...
  \seealsoref{逝世}{shi4shi4}
  \seealsoref{死}{si3}
  \seealsoref{献身}{xian4shen1}
  \synonymref{祭祀}{ji4si4}
  \synonymref{丧失}{sang4shi1}
  \synonymref{失掉}{shi1diao4}
...
\begin{Entry}{珠子}{10,3}{⽟,⼦}
  \begin{Phonetics}{珠子}{zhu1zi5}
    \definition[粒,颗,串]{s.}{pérola | miçanga; conta}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{珠宝}{10,8}{⽟,⼧}
  \begin{Phonetics}{珠宝}{zhu1bao3}[][HSK 6]
    \definition[串]{s.}{joias; pérolas; um termo geral para pérolas, pedras preciosas e outros ornamentos}
  \synonymref{宝石}{bao3shi2}
  \synonymref{首饰}{shou3shi4}
  \antonymref{废物}{fei4wu4}
...
\begin{Entry}{班长}{10,4}{⽟,⾧}
  \begin{Phonetics}{班长}{ban1zhang3}[][HSK 2]
...
\begin{Entry}{瓶颈}{10,11}{⽡,⾴}
  \begin{Phonetics}{瓶颈}{ping2jing3}[][HSK 7-9]
    \definition[个]{s.}{gargalo; gargalo de uma garrafa | gargalo; elo crucial que impede o desenvolvimento de algo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{留下}{10,3}{⽥,⼀}
  ...
  \synonymref{剩下}{sheng4xia5}
  \antonymref{迁移}{qian1yi2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{疼痛}{10,12}{⽧,⽧}
  \begin{Phonetics}{疼痛}{teng2tong4}[][HSK 6]
...
\begin{Entry}{疾病}{10,10}{⽧,⽧}
  ...
  \seealsoref{病}{bing4}
  \synonymref{病症}{bing4zheng4}
  \synonymref{患病}{huan4bing4}
...
\begin{Entry}{病人}{10,2}{⽧,⼈}
  ...
  \seealsoref{病号}{bing4hao4}
  \synonymref{患者}{huan4zhe3}
  \synonymref{伤员}{shang1yuan2}
  \antonymref{医生}{yi1sheng1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{病号}{10,5}{⽧,⼝}
  \begin{Phonetics}{病号}{bing4hao4}
    \definition[个]{s.}{pessoa doente; inválido; paciente | pessoal doente; pessoa na lista de doentes; pacientes em unidades militares, escolas, agências governamentais e outros grupos semelhantes}
  \seealsoref{病人}{bing4ren2}
  \synonymref{患者}{huan4zhe3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{病房}{10,8}{⽧,⼾}
  \begin{Phonetics}{病房}{bing4fang2}[][HSK 6]
...
\begin{Entry}{病情}{10,11}{⽧,⼼}
  \begin{Phonetics}{病情}{bing4qing2}[][HSK 6]
...
\begin{Entry}{症结}{10,9}{⽧,⽷}
  \begin{Phonetics}{症结}{zheng1jie2}[][HSK 7-9]
...
%%%%%%%%%% 皱 %%%%%%%%%%
\subsection*{皱}\addcontentsline{loh}{figure}{皱}

\begin{Entry}{皱}{10}{⽪}
  \begin{Phonetics}{皱}{zhou4}[][HSK 7-9]
...
%%%%%%%%%% 益 %%%%%%%%%%
\subsection*{益}\addcontentsline{loh}{figure}{益}
...
\begin{Entry}{益处}{10,5}{⽫,⼡}
  \begin{Phonetics}{益处}{yi4chu4}[][HSK 7-9]
...
%%%%%%%%%% 盏 %%%%%%%%%%
\subsection*{盏}\addcontentsline{loh}{figure}{盏}

\begin{Entry}{盏}{10}{⽫}
  \begin{Phonetics}{盏}{zhan3}[][HSK 7-9]
...
%%%%%%%%%% 盐 %%%%%%%%%%
\subsection*{盐}\addcontentsline{loh}{figure}{盐}
...
%%%%%%%%%% 监 %%%%%%%%%%
\subsection*{监}\addcontentsline{loh}{figure}{监}
...
\begin{Entry}{监测}{10,9}{⽫,⽔}
  \begin{Phonetics}{监测}{jian1ce4}[][HSK 6]
...
\begin{Entry}{监督}{10,13}{⽫,⽬}
  ...
  \seealsoref{监视}{jian1shi4}
  \synonymref{督促}{du1cu4}
  \synonymref{监察}{jian1cha2}
...
\begin{Entry}{真切}{10,4}{⼗,⼑}
  \begin{Phonetics}{真切}{zhen1qie4}
    \definition{adj.}{claro; distinto; claro e preciso | sincero; genuíno; sincero e honesto}
  ...
  \synonymref{真实}{zhen1shi2}
  \synonymref{知道}{zhi1dao5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{真心}{10,4}{⼗,⼼}
  \begin{Phonetics}{真心}{zhen1xin1}[][HSK 7-9]
...
\begin{Entry}{真正}{10,5}{⼗,⽌}
  ...
  \synonymref{真实}{zhen1shi2}
  \antonymref{假冒}{jia3mao4}
  \antonymref{冒充}{mao4chong1}
...
\begin{Entry}{真实}{10,8}{⼗,⼧}
  ...
  \synonymref{真正}{zhen1zheng4}
  \antonymref{荒诞}{huang1dan4}
  \antonymref{荒谬}{huang1miu4}
  \antonymref{荒唐}{huang1tang2}
  \antonymref{夸张}{kua1zhang1}
  \antonymref{虚幻}{xu1huan4}
  \antonymref{虚假}{xu1jia3}
  \antonymref{虚拟}{xu1ni3}
  \antonymref{虚伪}{xu1wei3}
  \antonymref{做作}{zuo4zuo5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{真的}{10,8}{⼗,⽩}
  ...
  \seealsoref{实在}{shi2zai5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{真空}{10,8}{⼗,⽳}
  \begin{Phonetics}{真空}{zhen1kong1}[][HSK 7-9]
...
\begin{Entry}{真是的}{10,9,8}{⼗,⽇,⽩}
  \begin{Phonetics}{真是的}{zhen1shi5de5}[][HSK 7-9]
...
\begin{Entry}{真相}{10,9}{⼗,⽬}
  ...
  \synonymref{实质}{shi2zhi4}
  \synonymref{事实}{shi4shi2}
  \antonymref{谎言}{huang3yan2}
  \antonymref{谣言}{yao2yan2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{真挚}{10,10}{⼗,⼿}
  \begin{Phonetics}{真挚}{zhen1zhi4}[][HSK 7-9]
...
\begin{Entry}{真真}{10,10}{⼗,⼗}
  \begin{Phonetics}{真真}{zhen1zhen1}
    \definition{adv.}{genuinamente | de fato | realmente | escrupulosamente}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{真假}{10,11}{⼗,⼈}
  \begin{Phonetics}{真假}{zhen1jia3}[][HSK 7-9]
    \definition{adj.}{verdadeiro e falso; genuíno e falso}
    \definition{s.}{verdade ou falsidade; o verdadeiro ou o falso}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{真情}{10,11}{⼗,⼼}
  \begin{Phonetics}{真情}{zhen1qing2}[][HSK 7-9]
...
%%%%%%%%%% 砧 %%%%%%%%%%
\subsection*{砧}\addcontentsline{loh}{figure}{砧}

\begin{Entry}{砧}{10}{⽯}
  \begin{Phonetics}{砧}{zhen1}
    \definition{s.}{bloco de martelar; bigorna; a ferramenta usada como apoio ao martelar ou esmagar algo}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{砧骨}{10,9}{⽯,⾻}
  \begin{Phonetics}{砧骨}{zhen1gu3}
    \definition{s.}{bigorna ou osso da orelha média, responsável por transmitir a vibração sonora do martelo para o estribo; um dos ossículos da audição, em forma de bigorna, com a extremidade externa conectada ao martelo e a extremidade interna conectada ao estribo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{破坏}{10,7}{⽯,⼟}
  ...
  \seealsoref{损坏}{sun3huai4}
  \synonymref{摧毁}{cui1hui3}
  \synonymref{捣乱}{dao3//luan4}
  \synonymref{粉碎}{fen3sui4}
  \synonymref{毁坏}{hui3huai4}
  \synonymref{伤害}{shang1hai4}
  \synonymref{损害}{sun3hai4}
  \synonymref{危害}{wei1hai4}
  \antonymref{爱护}{ai4hu4}
  \antonymref{帮忙}{bang1//mang2}
  \antonymref{保护}{bao3hu4}
  \antonymref{建立}{jian4li4}
  \antonymref{建设}{jian4she4}
  \antonymref{维持}{wei2chi2}
  \antonymref{维护}{wei2hu4}
  \antonymref{修理}{xiu1li3}
  \antonymref{整理}{zheng3li3}
  \antonymref{装饰}{zhuang1shi4}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 祥 %%%%%%%%%%
\subsection*{祥}\addcontentsline{loh}{figure}{祥}

\begin{Entry}{祥}{10}{⽰}
  \begin{Phonetics}{祥}{xiang2}
...
\begin{Entry}{祥和}{10,8}{⽰,⼝}
  \begin{Phonetics}{祥和}{xiang2he2}[][HSK 7-9]
...
\begin{Entry}{离不开}{10,4,4}{⼇,⼀,⼶}
  \begin{Phonetics}{离不开}{li2bu5kai1}[][HSK 4]
...
\begin{Entry}{离别}{10,7}{⼇,⼑}
  \begin{Phonetics}{离别}{li2bie2}
    \definition{v.}{partir; deixar; despedir"-se; estar separado de pessoas ou lugares familiares por um período relativamente longo de tempo}
  \seealsoref{分别}{fen1bie2}
  \synonymref{分手}{fen1//shou3}
  \synonymref{分离}{fen1li2}
  \synonymref{诀别}{jue2bie2}
  \antonymref{重逢}{chong2feng2}
  \antonymref{见面}{jian4//mian4}
  \antonymref{团聚}{tuan2ju4}
  \antonymref{团圆}{tuan2yuan2}
  \antonymref{相遇}{xiang1yu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{秘书长}{10,4,4}{⽲,⼄,⾧}
  \begin{Phonetics}{秘书长}{mi4shu1zhang3}
...
\begin{Entry}{秘密}{10,11}{⽲,⼧}
  ...
  \seealsoref{奥秘}{ao4mi4}
  \seealsoref{机密}{ji1mi4}
...
\begin{Entry}{租用}{10,5}{⽲,⽤}
  \begin{Phonetics}{租用}{zu1yong4}
    \definition{v.}{alugar; arrendar; ceder em regime de arrendamento; utilizar pertences de outra pessoa sob a condição de devolvê"-los e pagar um determinado valor}
  \synonymref{租赁}{zu1lin4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{租让}{10,5}{⽲,⾔}
  \begin{Phonetics}{租让}{zu1rang4}
    \definition{v.}{alugar | arrendar | subalocar; alugar (a propriedade de alguém para outra pessoa)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{租约}{10,6}{⽲,⽷}
  \begin{Phonetics}{租约}{zu1yue1}
    \definition{s.}{aluguel; contratos que estabelecem uma relação de arrendamento}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{租赁}{10,10}{⽲,⾙}
  \begin{Phonetics}{租赁}{zu1lin4}[][HSK 7-9]
...
\begin{Entry}{租船}{10,11}{⽲,⾈}
  \begin{Phonetics}{租船}{zu1chuan2}
    \definition{v.}{fretar (um navio) | fretar um navio | alugar uma embarcação}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{积木}{10,4}{⽲,⽊}
  \begin{Phonetics}{积木}{ji1mu4}
    \definition{s.}{blocos de brinquedo; blocos de construção; blocos de montar; são conjuntos de blocos de madeira de diferentes tamanhos e formatos, geralmente coloridos, que podem ser organizados para formar modelos de vários tipos de edifícios}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{积极}{10,7}{⽲,⽊}
  ...
  \synonymref{乐观}{le4guan1}
  \synonymref{热心}{re4xin1}
  \synonymref{踊跃}{yong3yue4}
  \synonymref{正面}{zheng4mian4}
...
\begin{Entry}{积累}{10,11}{⽲,⽷}
  \begin{Phonetics}{积累}{ji1lei3}[][HSK 4]
    ...
    \definition{v.}{acumular}
  \seealsoref{积蓄}{ji1xu4}
  \synonymref{累积}{lei3ji1}
  \antonymref{耗费}{hao4fei4}
  \antonymref{消费}{xiao1fei4}
...
\begin{Entry}{称为}{10,4}{⽲,⼂}
  ...
  \synonymref{称作}{cheng1zuo4}
  \synonymref{号称}{hao4cheng1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{称号}{10,5}{⽲,⼝}
  ...
  \seealsoref{称呼}{cheng1hu5}
  \synonymref{名称}{ming2cheng1}
  \synonymref{头衔}{tou2xian2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{称赞}{10,16}{⽲,⾙}
  ...
  \seealsoref{表扬}{biao3yang2}
  \seealsoref{夸奖}{kua1jiang3}
  \seealsoref{赞扬}{zan4yang2}
...
\begin{Entry}{窄}{10}{⽳}
  \begin{Phonetics}{窄}{zhai3}[][HSK 7-9]
...
\begin{Entry}{站}{10}{⽴}
  \begin{Phonetics}{站}{zhan4}[][HSK 1,2]
    \definition*{s.}{Sobrenome: Zhan}
    \definition[个,座,排,类]{s.}{parada; estação; ponto de parada | central; estação; instituição criada para um determinado tipo de atividade | filial de uma empresa ou organização; local de trabalho criado para realizar uma determinada tarefa | \emph{website}; na rede de computadores, refere"-se a um \emph{site}}
...
\begin{Entry}{站长}{10,4}{⽴,⾧}
  \begin{Phonetics}{站长}{zhan4zhang3}
    \definition{s.}{chefe de uma estação, centro, etc.; o chefe de todos os assuntos da estação}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{站台}{10,5}{⽴,⼝}
  \begin{Phonetics}{站台}{zhan4tai2}[][HSK 6]
    \definition{s.}{plataforma (em uma estação ferroviária)}
  \synonymref{车站}{che1zhan4}
...
\begin{Entry}{站立}{10,5}{⽴,⽴}
  \begin{Phonetics}{站立}{zhan4li4}[][HSK 7-9]
...
\begin{Entry}{站住}{10,7}{⽴,⼈}
  \begin{Phonetics}{站住}{zhan4zhu4}[][HSK 2]
  ...
  \synonymref{合情合理}{he2qing2-he2li3}
  \synonymref{立足}{li4zu2}
  \synonymref{扎根}{zha1//gen1}
  \antonymref{出发}{chu1fa1}
  \antonymref{流动}{liu2dong4}
  \antonymref{行进}{xing2jin4}
...
\begin{Entry}{站点}{10,9}{⽴,⽕}
  \begin{Phonetics}{站点}{zhan4dian3}
    \definition{s.}{parada; estação | ponto de trabalho | Computação: estação de trabalho; \emph{workstation} | \emph{website}}
...
\begin{Entry}{竞争}{10,6}{⽴,⼑}
  ...
  \seealsoref{竞赛}{jing4sai4}
  \synonymref{比赛}{bi3sai4}
  \synonymref{竞相}{jing4xiang1}
  \synonymref{角逐}{jue2zhu2}
  \antonymref{合作}{he2zuo4}
  \antonymref{垄断}{long3duan4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{竞争对手}{10,6,5,4}{⽴,⼑,⼨,⼿}
  \begin{Phonetics}{竞争对手}{jing4zheng1 dui4shou3}[][HSK 5]
    \definition{s.}{concorrente | rival}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{竞争者}{10,6,8}{⽴,⼑,⽼}
  \begin{Phonetics}{竞争者}{jing4zheng1 zhe3}[][HSK 5]
    \definition{s.}{competidor; concorrente; rival}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{竞赛}{10,14}{⽴,⾙}
  ...
  \seealsoref{比赛}{bi3sai4}
  \seealsoref{竞争}{jing4zheng1}
  \synonymref{比拼}{bi3pin1}
  \synonymref{比试}{bi3shi4}
  \synonymref{较量}{jiao4liang4}
  \synonymref{竞技}{jing4ji4}
  \synonymref{角逐}{jue2zhu2}
  \antonymref{和平}{he2ping2}
  \antonymref{合作}{he2zuo4}
  \antonymref{协作}{xie2zuo4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{笋}{10}{⽵}
  \begin{Phonetics}{笋}{sun3}
    \definition[个,棵,根]{s.}{broto de bambu}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{笑声}{10,7}{⽵,⼠}
  \begin{Phonetics}{笑声}{xiao4sheng1}[][HSK 6]
...
\begin{Entry}{笑话儿}{10,8,2}{⽵,⾔,⼉}
  \begin{Phonetics}{笑话儿}{xiao4hua4r5}[][HSK 2]
    \definition{s.}{piada; brincadeira; gracejo}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{笑容}{10,10}{⽵,⼧}
  \begin{Phonetics}{笑容}{xiao4rong2}[][HSK 6]
    \definition[丝,抹,个]{s.}{sorriso; expressão sorridente; o olhar no rosto de alguém ao sorrir}
  \synonymref{笑脸}{xiao4lian3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{笑脸}{10,11}{⽵,⾁}
  \begin{Phonetics}{笑脸}{xiao4lian3}[][HSK 6]
    \definition[张,个,副]{s.}{\emph{smiley}; rosto sorridente (emoji)}
  \synonymref{笑容}{xiao4rong2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{笔记}{10,5}{⽵,⾔}
  \begin{Phonetics}{笔记}{bi3ji4}[][HSK 2]
  ...
  \synonymref{记录}{ji4lu4}
  \synonymref{记载}{ji4zai3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{笔记本}{10,5,5}{⽵,⾔,⽊}
  \begin{Phonetics}{笔记本}{bi3ji4ben3}[][HSK 2]
    \definition[个,本,台]{s.}{caderno para anotações | \emph{laptop}; refere"-se a um computador portátil}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{笔试}{10,8}{⽵,⾔}
  \begin{Phonetics}{笔试}{bi3shi4}[][HSK 6]
    \definition[次,个]{s.}{exame escrito; um tipo de exame que exige respostas escritas}
  \antonymref{口试}{kou3shi4}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 紊 %%%%%%%%%%
\subsection*{紊}\addcontentsline{loh}{figure}{紊}

\begin{Entry}{紊}{10}{⽷}
  \begin{Phonetics}{紊}{wen3}
    \definition{adj.}{desordenado; confuso}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{紊乱}{10,7}{⽷,⼄}
  \begin{Phonetics}{紊乱}{wen3luan4}[][HSK 7-9]
...
%%%%%%%%%% 素 %%%%%%%%%%
\subsection*{素}\addcontentsline{loh}{figure}{素}

\begin{Entry}{素}{10}{⽷}
  \begin{Phonetics}{素}{su4}[][HSK 7-9]
...
\begin{Entry}{素不相识}{10,4,9,7}{⽷,⼀,⽬,⾔}
  \begin{Phonetics}{素不相识}{su4bu4xiang1shi2}[][HSK 7-9]
...
\begin{Entry}{素材}{10,7}{⽷,⽊}
  \begin{Phonetics}{素材}{su4cai2}[][HSK 7-9]
...
\begin{Entry}{素质}{10,8}{⽷,⾙}
  ...
  \synonymref{性质}{xing4zhi4}
  \synonymref{修养}{xiu1yang3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{素养}{10,9}{⽷,⼋}
  \begin{Phonetics}{素养}{su4yang3}[][HSK 7-9]
...
\begin{Entry}{索取}{10,8}{⽷,⼜}
  \begin{Phonetics}{索取}{suo3qu3}[][HSK 7-9]
  ...
  \antonymref{予以}{yu3yi3}
  \antonymref{赠送}{zeng4song4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{索性}{10,8}{⽷,⼼}
  \begin{Phonetics}{索性}{suo3xing4}[][HSK 7-9]
...
\begin{Entry}{索赔}{10,12}{⽷,⾙}
  \begin{Phonetics}{索赔}{suo3pei2}[][HSK 7-9]
...
%%%%%%%%%% 紧 %%%%%%%%%%
\subsection*{紧}\addcontentsline{loh}{figure}{紧}
...
\begin{Entry}{紧张}{10,7}{⽷,⼸}
  ...
  \seealsoref{紧急}{jin3ji2}
  \seealsoref{紧迫}{jin3po4}
  \synonymref{不安}{bu4'an1}
...
\begin{Entry}{紧急}{10,9}{⽷,⼼}
  ...
  \seealsoref{紧迫}{jin3po4}
  \seealsoref{紧张}{jin3zhang1}
  \synonymref{告急}{gao4ji2}
  \synonymref{急迫}{ji2po4}
  \synonymref{急切}{ji2qie4}
...
\begin{Entry}{紧紧}{10,10}{⽷,⽷}
  \begin{Phonetics}{紧紧}{jin3jin3}[][HSK 5]
  ...
  \synonymref{牢牢}{lao2lao2}
  \synonymref{稳妥}{wen3tuo3}
  \synonymref{严密}{yan2mi4}
  \antonymref{疏散}{shu1san4}
...
\begin{Entry}{紧密}{10,11}{⽷,⼧}
  ...
  \antonymref{分离}{fen1li2}
  \antonymref{间隙}{jian4xi4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{紧接着}{10,11,11}{⽷,⼿,⽬}
  \begin{Phonetics}{紧接着}{jin3jie1zhe5}[][HSK 7-9]
...
%%%%%%%%%% 绣 %%%%%%%%%%
\subsection*{绣}\addcontentsline{loh}{figure}{绣}

\begin{Entry}{绣}{10}{⽷}
  \begin{Phonetics}{绣}{xiu4}[][HSK 7-9]
...
%%%%%%%%%% 继 %%%%%%%%%%
\subsection*{继}\addcontentsline{loh}{figure}{继}
...
\begin{Entry}{继承}{10,8}{⽷,⼿}
  ...
  \synonymref{承受}{cheng2shou4}
  \synonymref{传承}{chuan2cheng2}
  \synonymref{接收}{jie1shou1}
  \synonymref{接手}{jie1shou3}
  \synonymref{接替}{jie1ti4}
...
\begin{Entry}{罢工}{10,3}{⽹,⼯}
  \begin{Phonetics}{罢工}{ba4//gong1}[][HSK 6]
    \definition{v.+compl.}{parar de trabalhar; entrar em greve; abandonar o emprego}
...
%%%%%%%%%% 羞 %%%%%%%%%%
\subsection*{羞}\addcontentsline{loh}{figure}{羞}

\begin{Entry}{羞}{10}{⽺}
  \begin{Phonetics}{羞}{xiu1}
...
\begin{Entry}{羞愧}{10,12}{⽺,⼼}
  \begin{Phonetics}{羞愧}{xiu1kui4}[][HSK 7-9]
...
%%%%%%%%%% 翅 %%%%%%%%%%
\subsection*{翅}\addcontentsline{loh}{figure}{翅}
...
%%%%%%%%%% 耕 %%%%%%%%%%
\subsection*{耕}\addcontentsline{loh}{figure}{耕}
...
%%%%%%%%%% 耗 %%%%%%%%%%
\subsection*{耗}\addcontentsline{loh}{figure}{耗}
...
%%%%%%%%%% 胳 %%%%%%%%%%
\subsection*{胳}\addcontentsline{loh}{figure}{胳}
...
\begin{Entry}{胳肢窝}{10,8,12}{⾁,⾁,⽳}
  \begin{Phonetics}{胳肢窝}{ga1zhi1wo1}
...
%%%%%%%%%% 胶 %%%%%%%%%%
\subsection*{胶}\addcontentsline{loh}{figure}{胶}
...
\begin{Entry}{胶卷}{10,8}{⾁,⼙}
  \begin{Phonetics}{胶卷}{jiao1juan3}
    \definition[卷]{s.}{filme em rolo; filme; filmes fotográficos que são utilizados em fotografia analógica}
  \synonymref{胶片}{jiao1pian4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{胶带}{10,9}{⾁,⼱}
  \begin{Phonetics}{胶带}{jiao1dai4}[][HSK 5]
...
%%%%%%%%%% 胸 %%%%%%%%%%
\subsection*{胸}\addcontentsline{loh}{figure}{胸}
...
\begin{Entry}{胸有成竹}{10,6,6,6}{⾁,⽉,⼽,⽵}
  \begin{Phonetics}{胸有成竹}{xiong1you3cheng2zhu2}[][HSK 7-9]
...
\begin{Entry}{胸怀}{10,7}{⾁,⼼}
  \begin{Phonetics}{胸怀}{xiong1huai2}
...
\begin{Entry}{胸部}{10,10}{⾁,⾢}
  \begin{Phonetics}{胸部}{xiong1bu4}[][HSK 4]
    \definition{s.}{peito; tórax; seios}
  \synonymref{胸膛}{xiong1tang2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{胸膛}{10,15}{⾁,⾁}
  \begin{Phonetics}{胸膛}{xiong1tang2}[][HSK 7-9]
...
%%%%%%%%%% 能 %%%%%%%%%%
\subsection*{能}\addcontentsline{loh}{figure}{能}
...
\begin{Entry}{能}{10}{⾁}
  \begin{Phonetics}{能}{neng2}[][HSK 1]
    ...
    \definition{v.aux.}{poder fazer; ser capaz de | ser possível | entre 不 \dots 不 para expressar obrigação, certeza ou grande probabilidade | poder; ter permissão para | ser bom em fazer algo | permitir}
  \seealsoref{会}{hui4}
  \seealsoref{可以}{ke3yi3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{能人}{10,2}{⾁,⼈}
  \begin{Phonetics}{能人}{neng2ren2}[][HSK 7-9]
...
\begin{Entry}{能力}{10,2}{⾁,⼒}
  ...
  \synonymref{才干}{cai2gan4}
  \synonymref{才华}{cai2hua2}
  \synonymref{才能}{cai2neng2}
  \synonymref{技能}{ji4neng2}
  \synonymref{潜能}{qian2neng2}
  \synonymref{实力}{shi2li4}
  \antonymref{无力}{wu2li4}
...
\begin{Entry}{能上能下}{10,3,10,3}{⾁,⼀,⾁,⼀}
  \begin{Phonetics}{能上能下}{neng2shang4neng2xia4}
    \definition{expr.}{ser capaz de trabalhar tanto no topo quanto na base; estar pronto para aceitar um cargo superior ou inferior; estar pronto para trabalhar em qualquer cargo, seja ele alto ou baixo; estar pronto para trabalhar tanto no topo quanto na base}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{能不能}{10,4,10}{⾁,⼀,⾁}
  \begin{Phonetics}{能不能}{neng2 bu4neng2}[][HSK 3]
    \definition{adv.}{pode ou não pode\dots?}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{能否}{10,7}{⾁,⼝}
  \begin{Phonetics}{能否}{neng2fou3}[][HSK 6]
...
\begin{Entry}{能耐}{10,9}{⾁,⽽}
  \begin{Phonetics}{能耐}{neng2nai5}[][HSK 7-9]
    \definition{adj.}{habilidade; capacidade; destreza; competência | talento}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{能耗}{10,10}{⾁,⽾}
  \begin{Phonetics}{能耗}{neng2hao4}[][HSK 7-9]
    \definition{s.}{consumo de energia}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{能够}{10,11}{⾁,⼣}
  \begin{Phonetics}{能够}{neng2gou4}[][HSK 2]
  ...
  \synonymref{擅长}{shan4chang2}
  \antonymref{不可}{bu4ke3}
  \antonymref{不许}{bu4xu3}
  \antonymref{欠缺}{qian4que1}
  \antonymref{无法}{wu2fa3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{能量}{10,12}{⾁,⾥}
  ...
  \synonymref{力量}{li4liang5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{能源}{10,13}{⾁,⽔}
  \begin{Phonetics}{能源}{neng2yuan2}[][HSK 7-9]
...
%%%%%%%%%% 脂 %%%%%%%%%%
\subsection*{脂}\addcontentsline{loh}{figure}{脂}
...
\begin{Entry}{脂肪}{10,8}{⾁,⾁}
  \begin{Phonetics}{脂肪}{zhi1fang2}[][HSK 7-9]
...
%%%%%%%%%% 脆 %%%%%%%%%%
\subsection*{脆}\addcontentsline{loh}{figure}{脆}
...
%%%%%%%%%% 脊 %%%%%%%%%%
\subsection*{脊}\addcontentsline{loh}{figure}{脊}
...
%%%%%%%%%% 脏 %%%%%%%%%%
\subsection*{脏}\addcontentsline{loh}{figure}{脏}

\begin{Entry}{脏}{10}{⾁}
  \begin{Phonetics}{脏}{zang1}
    \definition{adj.}{sujo; imundo | imundo; vulgaridade e obscenidade}
    \definition{v.}{tornar algo sujo ou impuro}
  \antonymref{洁}{jie2}
  \antonymref{净}{jing4}
  \end{Phonetics}
  \begin{Phonetics}{脏}{zang4}[][HSK 2]
...
\begin{Entry}{脏字}{10,6}{⾁,⼦}
  \begin{Phonetics}{脏字}{zang1zi4}
    \definition{s.}{palavra obscena; palavrão; palavra suja; palavra vulgar}
  \seealsoref{脏字儿}{zang1zi4r5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{脏字儿}{10,6,2}{⾁,⼦,⼉}
  \begin{Phonetics}{脏字儿}{zang1zi4r5}
    \definition{s.}{palavra obscena (ou palavrão, palavra suja)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{脏病}{10,10}{⾁,⽧}
  \begin{Phonetics}{脏病}{zang1bing4}
    \definition{s.}{doença venérea (DST)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{脏器}{10,16}{⾁,⼝}
  \begin{Phonetics}{脏器}{zang4qi4}
    \definition{s.}{órgãos internos do corpo; vísceras | órgãos internos}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{脏辫}{10,17}{⾁,⾟}
  \begin{Phonetics}{脏辫}{zang1 bian4}
    \definition{s.}{\emph{dreadlocks}}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 脑 %%%%%%%%%%
\subsection*{脑}\addcontentsline{loh}{figure}{脑}
...
\begin{Entry}{脑子}{10,3}{⾁,⼦}
  \begin{Phonetics}{脑子}{nao3zi5}[][HSK 5]
  ...
  \synonymref{脑海}{nao3hai3}
  \synonymref{脑筋}{nao3jin1}
  \synonymref{脑袋}{nao3dai5}
...
\begin{Entry}{脑瓜}{10,5}{⾁,⽠}
  \begin{Phonetics}{脑瓜}{nao3gua1}
    \definition{s.}{Coloquial: cabeça | Coloquial: cérebro; crânio | Coloquial: ideias | Coloquial: mentalidade | Coloquial: mente}
...
\begin{Entry}{脑海}{10,10}{⾁,⽔}
  \begin{Phonetics}{脑海}{nao3hai3}[][HSK 7-9]
...
\begin{Entry}{脑袋}{10,11}{⾁,⾐}
  ...
  \synonymref{脑筋}{nao3jin1}
  \synonymref{脑子}{nao3zi5}
  \synonymref{头脑}{tou2nao3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{脑筋}{10,12}{⾁,⽵}
  \begin{Phonetics}{脑筋}{nao3jin1}[][HSK 7-9]
...
\begin{Entry}{臭}{10}{⾃}
  \begin{Phonetics}{臭}{chou4}[][HSK 5]
    \definition{adj.}{sujo; malcheiroso; fedorento | repugnante; nojento; repulsivo | ruim; pobre; péssimo}
...
\begin{Entry}{般乐}{10,5}{⾈,⼃}
  \begin{Phonetics}{般乐}{pan2le4}
    \definition{v.}{divertir"-se | jogar; brincar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{莫}{10}{⾋}
  ...
  \seealsoref{没有哪一种东西}{mei2you3 na3 yi4zhong3 dong1xi1}
...
\begin{Entry}{莲花}{10,7}{⾋,⾋}
  \begin{Phonetics}{莲花}{lian2hua1}
    \definition[朵,株,束,池]{s.}{flor de lótus}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{莲花三太子}{10,7,3,4,3}{⾋,⾋,⼀,⼤,⼦}
  \begin{Phonetics}{莲花三太子}{lian2hua1 san1 tai4zi3}
    \definition*{s.}{Terceiro Príncipe do Lótus; título recebido por Nezha após ter se tornado uma deidade}
...
\begin{Entry}{莲藕}{10,18}{⾋,⾋}
  \begin{Phonetics}{莲藕}{lian2'ou3}
    \definition{s.}{raiz de lótus; uma planta de lótus e sua raiz; os caules acima do solo e os caules subterrâneos do lótus}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{获}{10}{⾋}
  ...
  \synonymref{赢得}{ying2de2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{获取}{10,8}{⾋,⼜}
  \begin{Phonetics}{获取}{huo4qu3}[][HSK 4]
    \definition{v.}{adquirir; obter; ganhar; colher}
  \seealsoref{获得}{huo4de2}
  \synonymref{得到}{de2dao4}
  \synonymref{取得}{qu3de2}
  \antonymref{传授}{chuan2shou4}
...
\begin{Entry}{获奖}{10,9}{⾋,⼤}
  \begin{Phonetics}{获奖}{huo4jiang3}[][HSK 4]
...
\begin{Entry}{获得}{10,11}{⾋,⼻}
  ...
  \seealsoref{得到}{de2dao4}
  \seealsoref{获取}{huo4qu3}
  \seealsoref{取得}{qu3de2}
  \synonymref{得出}{de2 chu1}
  \synonymref{荣获}{rong2huo4}
  \synonymref{享有}{xiang3you3}
  \synonymref{赢得}{ying2de2}
...
%%%%%%%%%% 蚊 %%%%%%%%%%
\subsection*{蚊}\addcontentsline{loh}{figure}{蚊}
...
\begin{Entry}{蚊子}{10,3}{⾍,⼦}
  \begin{Phonetics}{蚊子}{wen2zi5}[][HSK 7-9]
    \definition[只]{s.}{pernilongo; mosquito}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{蚊帐}{10,7}{⾍,⼱}
  \begin{Phonetics}{蚊帐}{wen2zhang4}[][HSK 7-9]
  ...
  \synonymref{帐子}{zhang4zi5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{蚊香}{10,9}{⾍,⾹}
  \begin{Phonetics}{蚊香}{wen2xiang1}
    \definition{s.}{incenso ou espiral repelente de mosquitos; varetas ou espirais de incenso contendo ingredientes medicinais que, quando queimados, podem matar ou repelir mosquitos}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 蚕 %%%%%%%%%%
\subsection*{蚕}\addcontentsline{loh}{figure}{蚕}
...
\begin{Entry}{蚕纸}{10,7}{⾍,⽷}
  \begin{Phonetics}{蚕纸}{can2zhi3}
    \definition{s.}{folha de ovos de bicho"-da"-seda (uma folha de papel na qual as mariposas da seda depositaram seus ovos) | papel no qual o bicho"-da"-seda deposita seus ovos; os criadores de bicho"-da"-seda normalmente fazem com que as mariposas do bicho"-da"-seda depositem seus ovos em papel}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 蚝 %%%%%%%%%%
\subsection*{蚝}\addcontentsline{loh}{figure}{蚝}
...
%%%%%%%%%% 衰 %%%%%%%%%%
\subsection*{衰}\addcontentsline{loh}{figure}{衰}

\begin{Entry}{衰}{10}{⾐}
  \begin{Phonetics}{衰}{cui1}
    \definition{s.}{vestimenta de luto de linho grosso; capa de chuva}
    \definition{v.}{diminuir}
  \synonymref{败}{bai4}
  \end{Phonetics}
  \begin{Phonetics}{衰}{shuai1}
...
\begin{Entry}{衰退}{10,9}{⾐,⾡}
  ...
  \antonymref{振兴}{zhen4xing1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{衰弱}{10,10}{⾐,⼸}
  \begin{Phonetics}{衰弱}{shuai1ruo4}[][HSK 7-9]
  ...
  \synonymref{虚弱}{xu1ruo4}
  \antonymref{昌盛}{chang1sheng4}
  \antonymref{健康}{jian4kang1}
  \antonymref{健壮}{jian4zhuang4}
  \antonymref{强盛}{qiang2sheng4}
  \antonymref{强壮}{qiang2zhuang4}
  \antonymref{兴盛}{xing1sheng4}
  \antonymref{雄壮}{xiong2zhuang4}
  \antonymref{振兴}{zhen4xing1}
  \antonymref{壮大}{zhuang4da4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{衰减}{10,11}{⾐,⼎}
  \begin{Phonetics}{衰减}{shuai1jian3}[][HSK 7-9]
    \definition{v.}{enfraquecer; falhar; diminuir | Eletrônica: atenuar; reduzir}
  \synonymref{放大}{fang4da4}
...
\begin{Entry}{衰竭}{10,14}{⾐,⽴}
  \begin{Phonetics}{衰竭}{shuai1jie2}[][HSK 7-9]
...
%%%%%%%%%% 衷 %%%%%%%%%%
\subsection*{衷}\addcontentsline{loh}{figure}{衷}

\begin{Entry}{衷}{10}{⾐}
  \begin{Phonetics}{衷}{zhong1}
...
\begin{Entry}{衷心}{10,4}{⾐,⼼}
  \begin{Phonetics}{衷心}{zhong1xin1}[][HSK 7-9]
...
%%%%%%%%%% 袖 %%%%%%%%%%
\subsection*{袖}\addcontentsline{loh}{figure}{袖}
...
\begin{Entry}{袖儿}{10,2}{⾐,⼉}
  \begin{Phonetics}{袖儿}{xiu4r5}
    \definition{s.}{manga (de camisa, camiseta, etc.)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{袖手旁观}{10,4,10,6}{⾐,⼿,⽅,⾒}
  \begin{Phonetics}{袖手旁观}{xiu4shou3-pang2guan1}[][HSK 7-9]
    \definition{expr.}{``Observar de braços cruzados.''; olhar sem levantar um dedo; descreve alguém que se mantém longe de problemas ou não ajuda os outros; observar (ou ficar de braços cruzados); observar com indiferença}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{袖珍}{10,9}{⾐,⽟}
  \begin{Phonetics}{袖珍}{xiu4zhen1}[][HSK 6]
    \definition{adj.}{do tamanho do bolso; de bolso (livro, agenda, etc.)}
  \synonymref{精致}{jing1zhi4}
  \synonymref{迷你}{mi2ni3}
  \synonymref{微型}{wei1xing2}
...
%%%%%%%%%% 袜 %%%%%%%%%%
\subsection*{袜}\addcontentsline{loh}{figure}{袜}
...
%%%%%%%%%% 被 %%%%%%%%%%
\subsection*{被}\addcontentsline{loh}{figure}{被}
...
\begin{Entry}{被子}{10,3}{⾐,⼦}
  ...
  \synonymref{毯子}{tan3zi5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{被动}{10,6}{⾐,⼒}
  \begin{Phonetics}{被动}{bei4dong4}[][HSK 5]
    \definition{adj.}{passivo;  agir com base em um impulso externo | passivo; impossibilidade de prosseguir como pretendido devido a resistência ou interferência}
  \seealsoref{被迫}{bei4//po4}
  \antonymref{机动}{ji1dong4}
  \antonymref{主动}{zhu3dong4}
  \antonymref{自动}{zi4dong4}
  \antonymref{自觉}{zi4jue2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{被告}{10,7}{⾐,⼝}
  \begin{Phonetics}{被告}{bei4gao4}[][HSK 6]
    \definition{s.}{réu; indiciado; acusado}
  \antonymref{原告}{yuan2gao4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{被迫}{10,8}{⾐,⾡}
  \begin{Phonetics}{被迫}{bei4//po4}[][HSK 4]
    \definition{v.+compl.}{ser forçado; ser coagido; ser compelido; ser constrangido; ser forçado a fazer algo por força externa}
  \seealsoref{被动}{bei4dong4}
  \synonymref{强行}{qiang2xing2}
  \synonymref{强制}{qiang2zhi4}
  \antonymref{强迫}{qiang3po4}
  \antonymref{情愿}{qing2yuan4}
  \antonymref{自动}{zi4dong4}
  \antonymref{自觉}{zi4jue2}
...
\begin{Entry}{被套}{10,10}{⾐,⼤}
  \begin{Phonetics}{被套}{bei4tao4}
    \definition{s.}{um saco de cama; uma sacola retangular de tecido para transportar roupa de cama ao sair, com uma abertura no meio de um dos lados | uma capa ou saco para edredom; para facilitar a remoção e a lavagem, o forro e a capa da colcha são costurados em formato de saco, chamado capa de colcha | enchimento de algodão para edredom; forro de algodão para edredom}
...
%%%%%%%%%% 请 %%%%%%%%%%
\subsection*{请}\addcontentsline{loh}{figure}{请}
...
\begin{Entry}{请帖}{10,8}{⾔,⼱}
  \begin{Phonetics}{请帖}{qing3tie3}[][HSK 7-9]
...
\begin{Entry}{请柬}{10,9}{⾔,⽊}
  \begin{Phonetics}{请柬}{qing3jian3}[][HSK 7-9]
...
\begin{Entry}{请假条}{10,11,7}{⾔,⼈,⽊}
  \begin{Phonetics}{请假条}{qing3jia4tiao2}
    \definition{s.}{pedido escrito de licença de ausência (do trabalho ou da escola)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{请教}{10,11}{⾔,⽁}
  ...
  \synonymref{请问}{qing3wen4}
  \antonymref{赐教}{ci4jiao4}
  \antonymref{指导}{zhi3dao3}
  \antonymref{指教}{zhi3jiao4}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 诸 %%%%%%%%%%
\subsection*{诸}\addcontentsline{loh}{figure}{诸}
...
\begin{Entry}{诸多}{10,6}{⾔,⼣}
  \begin{Phonetics}{诸多}{zhu1duo1}[][HSK 7-9]
...
\begin{Entry}{诸如此类}{10,6,6,9}{⾔,⼥,⽌,⽶}
  \begin{Phonetics}{诸如此类}{zhu1ru2-ci3lei4}[][HSK 7-9]
...
\begin{Entry}{诸位}{10,7}{⾔,⼈}
  ...
  \synonymref{各位}{ge4wei4}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 诺 %%%%%%%%%%
\subsection*{诺}\addcontentsline{loh}{figure}{诺}
...
\begin{Entry}{诺贝尔奖}{10,4,5,9}{⾔,⾙,⼩,⼤}
  \begin{Phonetics}{诺贝尔奖}{nuo4bei4'er3jiang3}
    \definition*{s.}{Prêmio Nobel}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{诺言}{10,7}{⾔,⾔}
  \begin{Phonetics}{诺言}{nuo4yan2}[][HSK 7-9]
...
\begin{Entry}{诺奖}{10,9}{⾔,⼤}
  ...
  \seealsoref{诺贝尔奖}{nuo4bei4'er3jiang3}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 读 %%%%%%%%%%
\subsection*{读}\addcontentsline{loh}{figure}{读}
...
\begin{Entry}{读书}{10,4}{⾔,⼄}
  ...
  \synonymref{攻读}{gong1du2}
  \synonymref{念书}{nian4//shu1}
  \synonymref{上学}{shang4xue2}
  \synonymref{学习}{xue2xi2}
  \synonymref{阅读}{yue4du2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{读者}{10,8}{⾔,⽼}
  \begin{Phonetics}{读者}{du2zhe3}[][HSK 3]
  ...
  \synonymref{观众}{guan1zhong4}
  \synonymref{学者}{xue2zhe3}
  \antonymref{作者}{zuo4zhe3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{读音}{10,9}{⾔,⾳}
  \begin{Phonetics}{读音}{du2yin1}[][HSK 2]
    \definition[种]{s.}{pronúncia}
  \synonymref{发音}{fa1//yin1}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 诽 %%%%%%%%%%
\subsection*{诽}\addcontentsline{loh}{figure}{诽}
...
%%%%%%%%%% 课 %%%%%%%%%%
\subsection*{课}\addcontentsline{loh}{figure}{课}

\begin{Entry}{课}{10}{⾔}
  \begin{Phonetics}{课}{ke4}[][HSK 1]
    \definition{clas.}{aula; lição; unidade de tempo de ensino; parágrafo do material didático}
    \definition[门,节,堂,次]{s.}{classe; aula; ensino por etapas planejado | disciplina; curso | imposto; antiga referência a impostos | seção; departamentos de escritório criados no antigo governo}
...
%%%%%%%%%% 谁 %%%%%%%%%%
\subsection*{谁}\addcontentsline{loh}{figure}{谁}
...
\begin{Entry}{谁知道}{10,8,12}{⾔,⽮,⾡}
  \begin{Phonetics}{谁知道}{shei2 zhi1dao4}[][HSK 7-9]
    \definition{interj.}{``Quem sabe?''; ``Só Deus sabe\dots''; ``Quem diria?''; ``Quem poderia imaginar?''}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 调 %%%%%%%%%%
\subsection*{调}\addcontentsline{loh}{figure}{调}
...
\begin{Entry}{调皮}{10,5}{⾔,⽪}
  ...
  \synonymref{狡猾}{jiao3hua2}
  \synonymref{淘气}{tao2//qi4}
  \synonymref{顽皮}{wan2pi2}
  \antonymref{乖巧}{guai1qiao3}
...
\begin{Entry}{调节}{10,5}{⾔,⾋}
  ...
  \seealsoref{调剂}{tiao2ji4}
  \synonymref{安排}{an1pai2}
  \synonymref{调动}{diao4dong4}
  \synonymref{调度}{diao4du4}
  \synonymref{调控}{tiao2kong4}
...
\begin{Entry}{调侃}{10,8}{⾔,⼈}
  \begin{Phonetics}{调侃}{tiao2kan3}[][HSK 7-9]
...
\begin{Entry}{调剂}{10,8}{⾔,⼑}
  \begin{Phonetics}{调剂}{tiao2ji4}
    \definition{v.}{prescrever | ajustar; moderar; equilibrar}
  \seealsoref{调节}{tiao2jie2}
  \synonymref{调整}{tiao2zheng3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{调和}{10,8}{⾔,⼝}
  \begin{Phonetics}{调和}{tiao2he2}
    \definition{adj.}{harmonioso; bem coordenado}
    \definition{v.}{mediar; reconciliar; ajudar ambas as partes a resolver e eliminar conflitos e a restaurar um bom relacionamento | fazer um acordo (geralmente na forma negativa) | combinar; misturar dois ou mais ingredientes diferentes}
  \seealsoref{调解}{tiao2jie3}
  \synonymref{化解}{hua4jie3}
  ...
  \antonymref{争执}{zheng1zhi2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{调试}{10,8}{⾔,⾔}
  \begin{Phonetics}{调试}{tiao2shi4}[][HSK 7-9]
...
\begin{Entry}{调律}{10,9}{⾔,⼻}
  \begin{Phonetics}{调律}{diao4lv4}
    \definition{s.}{temperamento}
  \end{Phonetics}
...
\begin{Entry}{调查}{10,9}{⾔,⽊}
  ...
  \synonymref{采访}{cai3fang3}
  \synonymref{观察}{guan1cha2}
  \synonymref{考察}{kao3cha2}
  \synonymref{了解}{liao3jie3}
  \synonymref{视察}{shi4cha2}
  \synonymref{侦察}{zhen1cha2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{调查者}{10,9,8}{⾔,⽊,⽼}
  \begin{Phonetics}{调查者}{diao4cha2 zhe3}[][HSK 5]
    \definition{s.}{investigador}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{调研}{10,9}{⾔,⽯}
  \begin{Phonetics}{调研}{diao4yan2}[][HSK 6]
...
\begin{Entry}{调料}{10,10}{⾔,⽃}
  \begin{Phonetics}{调料}{tiao2liao4}[][HSK 7-9]
...
\begin{Entry}{调控}{10,11}{⾔,⼿}
  \begin{Phonetics}{调控}{tiao2kong4}[][HSK 7-9]
...
\begin{Entry}{调解}{10,13}{⾔,⾓}
  ...
  \seealsoref{调和}{tiao2he2}
  \synonymref{化解}{hua4jie3}
  \synonymref{斡旋}{wo4xuan2}
  \synonymref{协调}{xie2tiao2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{调整}{10,16}{⾔,⽁}
  ...
  \synonymref{调动}{diao4dong4}
  \synonymref{调度}{diao4du4}
  \synonymref{调剂}{tiao2ji4}
  \synonymref{调节}{tiao2jie2}
  \synonymref{调控}{tiao2kong4}
  \antonymref{保持}{bao3chi2}
  \antonymref{复原}{fu4//yuan2}
  \antonymref{固定}{gu4ding4}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 谅 %%%%%%%%%%
\subsection*{谅}\addcontentsline{loh}{figure}{谅}
...
%%%%%%%%%% 谈 %%%%%%%%%%
\subsection*{谈}\addcontentsline{loh}{figure}{谈}
...
\begin{Entry}{谈到}{10,8}{⾔,⼑}
  \begin{Phonetics}{谈到}{tan2dao4}[][HSK 7-9]
...
\begin{Entry}{谈恋爱}{10,10,10}{⾔,⼼,⽖}
  \begin{Phonetics}{谈恋爱}{tan2lian4'ai4}
    \definition{v.}{namorar; estar apaixonado; ter um caso amoroso; estar saindo com alguém}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{谈起}{10,10}{⾔,⾛}
  \begin{Phonetics}{谈起}{tan2qi3}[][HSK 7-9]
    \definition{v.}{mencionar; falar de}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{谈得上}{10,11,3}{⾔,⼻,⼀}
  \begin{Phonetics}{谈得上}{tan2 de2 shang4}[][HSK 5]
    \definition{v.}{pode"-se dizer; leve em consideração | pode ser considerado; pode ser mencionado}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 豹 %%%%%%%%%%
\subsection*{豹}\addcontentsline{loh}{figure}{豹}
...
\begin{Entry}{豹子}{10,3}{⾘,⼦}
  \begin{Phonetics}{豹子}{bao4zi5}
    \definition[头]{s.}{leopardo; espécie animal pertencente ao gênero \emph{Panthera}, da família \emph{Felidae}}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 贼 %%%%%%%%%%
\subsection*{贼}\addcontentsline{loh}{figure}{贼}

\begin{Entry}{贼}{10}{⾙}
  \begin{Phonetics}{贼}{zei2}[][HSK 7-9]
...
\begin{Entry}{贼星}{10,9}{⾙,⽇}
  \begin{Phonetics}{贼星}{zei2xing1}
    \definition{s.}{Astronomia: meteoro; estrela cadente}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{资}{10}{⾙}
  \begin{Phonetics}{资}{zi1}
    ...
    \definition{s.}{dinheiro; despesas | meios; recursos | riqueza; despesas | inteligência; dotação | qualificações; histórico de serviço}
    \definition{v.}{subsidiar; apoiar; assistir; financiar | fornecer; abastecer}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{资历}{10,4}{⾙,⼚}
  \begin{Phonetics}{资历}{zi1li4}[][HSK 7-9]
...
\begin{Entry}{资本}{10,5}{⾙,⽊}
  \begin{Phonetics}{资本}{zi1ben3}[][HSK 5]
    \definition{s.}{capital; meios de produção ou moeda utilizados para fins lucrativos | o que é capitalizado; algo usado em benefício próprio; que obtém benefícios}
  \synonymref{本钱}{ben3qian2}
  \synonymref{资金}{zi1jin1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{资本主义}{10,5,5,3}{⾙,⽊,⼂,⼂}
  \begin{Phonetics}{资本主义}{zi1ben3zhu3yi4}[][HSK 7-9]
  ...
  \synonymref{帝国主义}{di4guo2zhu3yi4}
  \antonymref{马列主义}{ma3-lie4 zhu3yi4}
  \antonymref{社会主义}{she4hui4zhu3yi4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{资讯}{10,5}{⾙,⾔}
  \begin{Phonetics}{资讯}{zi1xun4}[][HSK 7-9]
...
\begin{Entry}{资金}{10,8}{⾙,⾦}
  ...
  \synonymref{本金}{ben3jin1}
  \synonymref{本钱}{ben3qian2}
  \synonymref{财力}{cai2li4}
  \synonymref{资本}{zi1ben3}
...
\begin{Entry}{资料}{10,10}{⾙,⽃}
  ...
  \synonymref{材料}{cai2liao4}
  \synonymref{档案}{dang4'an4}
  \synonymref{素材}{su4cai2}
  \synonymref{文件}{wen2jian4}
  \synonymref{文献}{wen2xian4}
  \synonymref{物品}{wu4pin3}
  \synonymref{物资}{wu4zi1}
  \synonymref{用品}{yong4pin3}
...
\begin{Entry}{资格}{10,10}{⾙,⽊}
  ...
  \seealsoref{资历}{zi1li4}
  \synonymref{经验}{jing1yan4}
  \synonymref{门槛}{men2kan3}
  \synonymref{条件}{tiao2jian4}
  \antonymref{初级}{chu1ji2}
  \antonymref{新手}{xin1shou3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{资深}{10,11}{⾙,⽔}
  \begin{Phonetics}{资深}{zi1shen1}[][HSK 7-9]
...
\begin{Entry}{赶鸭子上架}{10,10,3,3,9}{⾛,⿃,⼦,⼀,⽊}
  \begin{Phonetics}{赶鸭子上架}{gan3 ya1zi3 shang4jia4}[][HSK 5]
    \definition{expr.}{``Forçar um pato a um poleiro.''; pressionar alguém a fazer algo que está totalmente além de sua capacidade; forçar alguém a fazer algo além de sua capacidade}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{起飞}{10,3}{⾛,⾶}
  \begin{Phonetics}{起飞}{qi3fei1}[][HSK 2]
    \definition{v.}{decolar; levantar voo | crescer rapidamente; decolar; disparar; rápido desenvolvimento de negócios, economia, etc.}
...
\begin{Entry}{起伏}{10,6}{⾛,⼈}
  \begin{Phonetics}{起伏}{qi3fu2}[][HSK 7-9]
    \definition{v.}{subir e descer; ondular;  subida e descida contínuas | (emoções, relações, etc.) flutuar; oscilar; aumentar e diminuir; descreve a oscilação de emoções, relacionamentos, etc.}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{起作用}{10,7,5}{⾛,⼈,⽤}
  \begin{Phonetics}{起作用}{qi3 zuo4yong4}[][HSK 5]
    \definition{expr.}{entrar em vigor; ter um efeito; significa que algo pode produzir uma influência ou resultado | ter um impacto}
...
\begin{Entry}{起床}{10,7}{⾛,⼴}
  ...
  \synonymref{起来}{qi3lai2}
  \antonymref{睡觉}{shui4//jiao4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{起来}{10,7}{⾛,⽊}
  \begin{Phonetics}{起来}{qi3lai2}[][HSK 1]
    \definition{v.}{levantar"-se; passar de posições como deitado, sentado ou ajoelhado para ficar em pé | levantar"-se; sair da cama | levantar"-se; revoltar"-se; rebelar"-se; refere"-se a ascensão, surgimento, levantamento, etc.}
  \seealsoref{上来}{shang4lai2}
  \end{Phonetics}
...
\begin{Entry}{起码}{10,8}{⾛,⽯}
  ...
  \synonymref{最少}{zui4shao3}
  \antonymref{顶多}{ding3duo1}
...
\begin{Entry}{起点}{10,9}{⾛,⽕}
  ...
  \synonymref{出发点}{chu1fa1dian3}
  \synonymref{开始}{kai1shi3}
  \antonymref{尽头}{jin4tou2}
...
%%%%%%%%%% 载 %%%%%%%%%%
\subsection*{载}\addcontentsline{loh}{figure}{载}

\begin{Entry}{载}{10}{⾞}
  \begin{Phonetics}{载}{zai3}
...
\begin{Entry}{载体}{10,7}{⾞,⼈}
  \begin{Phonetics}{载体}{zai4ti3}[][HSK 7-9]
...
\begin{Entry}{载……载……}{10,10}{⾞,⾞}
  \begin{Phonetics}{载……载……}{zai4 zai4}
...
\begin{Entry}{较}{10}{⾞}
  \begin{Phonetics}{较}{jiao4}[][HSK 3]
    ...
    \definition{prep.}{usado para comparar características e graus; introduzir o objeto de comparação}
    \definition{v.}{comparar | disputar}
  \seealsoref{比较}{bi3jiao4}
  \synonymref{比}{bi3}
  \synonymref{校}{jiao4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{透水}{10,4}{⾡,⽔}
  \begin{Phonetics}{透水}{tou4shui3}
    ...
    \definition{s.}{percolação; infiltração | vazamento de água}
    \definition{v.}{ser permeável; permitir a passagem de água}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{透明}{10,8}{⾡,⽇}
  ...
  \seealsoref{透亮}{tou4liang4}
  \synonymref{公开}{gong1kai1}
  \synonymref{晶莹}{jing1ying2}
  \synonymref{明朗}{ming2lang3}
  \synonymref{清澈}{qing1che4}
  \synonymref{清楚}{qing1chu5}
...
\begin{Entry}{透顶}{10,8}{⾡,⾴}
  \begin{Phonetics}{透顶}{tou4ding3}
    \definition{adv./part.}{completamente; totalmente; ao extremo; de cabo a rabo (depreciativo)}
  \synonymref{彻底}{che4di3}
...
\begin{Entry}{透亮}{10,9}{⾡,⼇}
  \begin{Phonetics}{透亮}{tou4liang4}
    \definition{adj.}{brilhante; transparente | limpo; claro}
  \seealsoref{透明}{tou4ming2}
  \synonymref{懂得}{dong3de5}
  \synonymref{晶莹}{jing1ying2}
...
\begin{Entry}{透辟}{10,13}{⾡,⾟}
  \begin{Phonetics}{透辟}{tou4pi4}
    \definition{adj.}{penetrante; incisivo; minucioso; minucioso e perspicaz}
  \synonymref{透彻}{tou4che4}
  \synonymref{透澈}{tou4che4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{逐年}{10,6}{⾡,⼲}
  \begin{Phonetics}{逐年}{zhu2nian2}[][HSK 7-9]
...
\begin{Entry}{逐步}{10,7}{⾡,⽌}
  ...
  \seealsoref{逐渐}{zhu2jian4}
  \synonymref{慢慢}{man4man4}
  \synonymref{日益}{ri4yi4}
  \antonymref{忽然}{hu1ran2}
  \antonymref{立即}{li4ji2}
  \antonymref{猛然}{meng3ran2}
  \antonymref{突然}{tu1ran2}
  \antonymref{骤然}{zhou4ran2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{逐渐}{10,11}{⾡,⽔}
  ...
  \seealsoref{渐渐}{jian4jian4}
  \seealsoref{逐步}{zhu2bu4}
  \synonymref{慢慢}{man4man4}
  \synonymref{日趋}{ri4qu1}
  \synonymref{日益}{ri4yi4}
  \antonymref{忽然}{hu1ran2}
  \antonymref{立刻}{li4ke4}
  \antonymref{马上}{ma3shang4}
  \antonymref{猛然}{meng3ran2}
  \antonymref{突然}{tu1ran2}
  \antonymref{骤然}{zhou4ran2}
  \end{Phonetics}
...
\begin{Entry}{途中}{10,4}{⾡,⼁}
  ...
  \synonymref{路上}{lu4shang5}
  \synonymref{中途}{zhong1tu2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{途径}{10,8}{⾡,⼻}
  ...
  \synonymref{路线}{lu4xian4}
  \synonymref{路子}{lu4zi5}
  \synonymref{门路}{men2lu5}
  \synonymref{渠道}{qu2dao4}
...
\begin{Entry}{通用}{10,5}{⾡,⽤}
  ...
  \antonymref{固定}{gu4ding4}
  \antonymref{特定}{te4ding4}
  \antonymref{特制}{te4zhi4}
  \antonymref{专用}{zhuan1yong4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{通行}{10,6}{⾡,⾏}
  ...
  \synonymref{风行}{feng1xing2}
  \synonymref{流行}{liu2xing2}
  \synonymref{盛行}{sheng4xing2}
  \synonymref{通畅}{tong1chang4}
  \synonymref{通过}{tong1guo4}
  \synonymref{通用}{tong1yong4}
  \antonymref{停止}{ting2zhi3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{通观}{10,6}{⾡,⾒}
  \begin{Phonetics}{通观}{tong1guan1}
    \definition{s.}{visão abrangente}
    \definition{v.}{ter uma visão geral (de algo); considerar algo como um todo}
  \synonymref{纵观}{zong4guan1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{通识}{10,7}{⾡,⾔}
  \begin{Phonetics}{通识}{tong1shi2}
    \definition{s.}{entendimento comum | conhecimentos geral | conhecimento comum | erudição | conhecimento geral | amplamente conhecido}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{通知书}{10,8,4}{⾡,⽮,⼄}
  \begin{Phonetics}{通知书}{tong1zhi1 shu1}[][HSK 4]
...
\begin{Entry}{通牒}{10,13}{⾡,⽚}
  \begin{Phonetics}{通牒}{tong1die2}
    \definition{s.}{nota diplomática; um documento pelo qual um país notifica outro país e solicita uma resposta}
...
\begin{Entry}{造价}{10,6}{⾡,⼈}
  \begin{Phonetics}{造价}{zao4jia4}[][HSK 7-9]
...
\begin{Entry}{造成}{10,6}{⾡,⼽}
  ...
  \synonymref{引发}{yin3fa1}
  \synonymref{诱发}{you4fa1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{造纸术}{10,7,5}{⾡,⽷,⽊}
  \begin{Phonetics}{造纸术}{zao4zhi3shu4}[][HSK 7-9]
...
\begin{Entry}{造假}{10,11}{⾡,⼈}
  \begin{Phonetics}{造假}{zao4jia3}[][HSK 7-9]
    \definition{v.}{falsificar | fazer passar algo falso por autêntico}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{造就}{10,12}{⾡,⼪}
  \begin{Phonetics}{造就}{zao4jiu4}[][HSK 7-9]
...
\begin{Entry}{造福}{10,13}{⾡,⽰}
  \begin{Phonetics}{造福}{zao4fu2}[][HSK 7-9]
...
\begin{Entry}{部门}{10,3}{⾢,⾨}
  ...
  \synonymref{单位}{dan1wei4}
  \synonymref{分支}{fen1zhi1}
...
\begin{Entry}{部位}{10,7}{⾢,⼈}
  \begin{Phonetics}{部位}{bu4wei4}[][HSK 5]
    \definition[个]{s.}{lugar; posição (usado principalmente para o corpo humano)}
...
%%%%%%%%%% 酌 %%%%%%%%%%
\subsection*{酌}\addcontentsline{loh}{figure}{酌}

\begin{Entry}{酌}{10}{⾣}
  \begin{Phonetics}{酌}{zhuo2}
...
\begin{Entry}{酌情}{10,11}{⾣,⼼}
  \begin{Phonetics}{酌情}{zhuo2qing2}[][HSK 7-9]
...
\begin{Entry}{配备}{10,8}{⾣,⼡}
  ...
  \synonymref{分配}{fen1pei4}
  \synonymref{配置}{pei4zhi4}
  \synonymref{设备}{she4bei4}
  \synonymref{装备}{zhuang1bei4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{酒馆}{10,11}{⾣,⾷}
  \begin{Phonetics}{酒馆}{jiu3guan3}
    \definition{s.}{um bar; um restaurante; um estabelecimento onde se serve vinho; lojas que vendem vinho e petiscos para acompanhá"-lo}
  \synonymref{酒吧}{jiu3ba1}
  \synonymref{酒楼}{jiu3lou2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{钱}{10}{⾦}
  \begin{Phonetics}{钱}{qian2}[][HSK 1]
    ...
    \definition[块,元,角,毛,分,笔]{s.}{dinheiro; riqueza; bens | moeda de cobre; dinheiro | objeto em forma de moeda de cobre | fundo; montante | dinheiro guardado ou gasto para algum fim específico (geralmente se refere a quantias significativas de dinheiro que entram e saem de órgãos públicos, organizações, etc.)}
  \seealsoref{钞票}{chao1piao4}
  \seealsoref{款}{kuan3}
  \seealsoref{两}{liang3}
...
\begin{Entry}{钱财}{10,7}{⾦,⾙}
  \begin{Phonetics}{钱财}{qian2cai2}[][HSK 7-9]
    \definition{s.}{riqueza; dinheiro}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 钳 %%%%%%%%%%
\subsection*{钳}\addcontentsline{loh}{figure}{钳}

\begin{Entry}{钳}{10}{⾦}
  \begin{Phonetics}{钳}{qian2}
...
\begin{Entry}{钳子}{10,3}{⾦,⼦}
  \begin{Phonetics}{钳子}{qian2zi5}[][HSK 7-9]
...
\begin{Entry}{钻石}{10,5}{⾦,⽯}
  \begin{Phonetics}{钻石}{zuan4shi2}[][HSK 7-9]
...
\begin{Entry}{钻空子}{10,8,3}{⾦,⽳,⼦}
  \begin{Phonetics}{钻空子}{zuan1kong4zi5}[][HSK 7-9]
...
\begin{Entry}{钻研}{10,9}{⾦,⽯}
  \begin{Phonetics}{钻研}{zuan1yan2}[][HSK 7-9]
...
\begin{Entry}{铁}{10}{⾦}
  \begin{Phonetics}{铁}{tie3}[][HSK 3]
    ...
    \definition{adj.}{duro; forte; sólido como ferro; de natureza dura; de vontade forte | violento ou cruel | inabalável; inalterável; determinado}
...
\begin{Entry}{铁轨}{10,6}{⾦,⾞}
  \begin{Phonetics}{铁轨}{tie3gui3}
    \definition[根]{s.}{trilho ferroviário | trilho | trilho de trem}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{铁路}{10,13}{⾦,⾜}
  \begin{Phonetics}{铁路}{tie3lu4}[][HSK 3]
...
\begin{Entry}{铃声}{10,7}{⾦,⼠}
  \begin{Phonetics}{铃声}{ling2sheng1}[][HSK 5]
...
\begin{Entry}{铅}{10}{⾦}
  \begin{Phonetics}{铅}{qian1}[][HSK 7-9]
...
\begin{Entry}{阅历}{10,4}{⾨,⼚}
  \begin{Phonetics}{阅历}{yue4li4}[][HSK 7-9]
...
\begin{Entry}{阅览室}{10,9,9}{⾨,⾒,⼧}
  \begin{Phonetics}{阅览室}{yue4lan3shi4}[][HSK 5]
...
\begin{Entry}{阅读}{10,10}{⾨,⾔}
  ...
  \synonymref{浏览}{liu2lan3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{阅读广度}{10,10,3,9}{⾨,⾔,⼴,⼴}
  \begin{Phonetics}{阅读广度}{yue4du2 guang3du4}
    \definition{s.}{amplitude de leitura; interesses de leitura}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{阅读时间}{10,10,7,7}{⾨,⾔,⽇,⾨}
  \begin{Phonetics}{阅读时间}{yue4du2 shi2jian1}
    \definition{s.}{tempo de leitura}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{阅读理解}{10,10,11,13}{⾨,⾔,⽟,⾓}
  \begin{Phonetics}{阅读理解}{yue4du2 li3jie3}
    \definition{s.}{compreensão de leitura}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{阅读装置}{10,10,12,13}{⾨,⾔,⾐,⽹}
  \begin{Phonetics}{阅读装置}{yue4du2 zhuang1zhi4}
...
\begin{Entry}{阅读器}{10,10,16}{⾨,⾔,⼝}
  \begin{Phonetics}{阅读器}{yue4du2qi4}
    \definition[个]{s.}{leitor (\emph{software})}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{陵园}{10,7}{⾩,⼞}
  \begin{Phonetics}{陵园}{ling2yuan2}
    \definition{s.}{cemitério; túmulos rodeados por um parque; jardins com predominância de mausoléus}
  \seealsoref{墓园}{mu4yuan2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{陷}{10}{⾩}
  \begin{Phonetics}{陷}{xian4}[][HSK 7-9]
...
\begin{Entry}{陷阱}{10,6}{⾩,⾩}
  \begin{Phonetics}{陷阱}{xian4jing3}[][HSK 7-9]
    \definition[个,处]{s.}{fosso; armadilha; laço; uma cova cavada para capturar animais selvagens ou inimigos | armadilha; fosso; armadilha ou plano para prejudicar alguém}
...
\begin{Entry}{难为}{10,4}{⾫,⼂}
  \begin{Phonetics}{难为}{nan2wei5}
    \definition{v.}{envergonhar; tornar difícil para alguém; fazer as pessoas se sentirem desconfortáveis | ser difícil; ser um trabalho árduo para; obrigar a (alguém que fez algo que geralmente não é fácil de fazer) | usado para expressar gratidão a alguém por sua ajuda (expressão educada); um agradecimento por fazer algo por outra pessoa}
  \seealsoref{为难}{wei2nan2}
  \synonymref{不易}{bu2 yi4}
  \synonymref{刁难}{diao1nan4}
  \synonymref{多亏}{duo1kui1}
  \synonymref{难得}{nan2de2}
...
\begin{Entry}{难以}{10,4}{⾫,⼈}
  \begin{Phonetics}{难以}{nan2yi3}[][HSK 5]
    \definition{adj.}{difícil; complicado}
  \synonymref{不易}{bu2 yi4}
  \synonymref{不便}{bu2bian4}
  \synonymref{为难}{wei2nan2}
  \synonymref{无从}{wu2cong2}
  \synonymref{无法}{wu2fa3}
  \synonymref{无力}{wu2li4}
  \antonymref{便于}{bian4yu2}
  \antonymref{不难}{bu4nan2}
...
\begin{Entry}{难关}{10,6}{⾫,⼋}
  \begin{Phonetics}{难关}{nan2guan1}[][HSK 7-9]
    \definition[道,个]{s.}{crise; barreira; apertado; dificuldade; obstáculo; aperto; dificuldade difícil de superar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{难免}{10,7}{⾫,⼉}
  \begin{Phonetics}{难免}{nan2mian3}[][HSK 4]
    \definition{adj.}{inevitável; difícil de evitar}
  \seealsoref{不免}{bu4mian3}
  \synonymref{免不了}{mian3bu5liao3}
...
\begin{Entry}{难忘}{10,7}{⾫,⼼}
  \begin{Phonetics}{难忘}{nan2wang4}[][HSK 6]
    \definition{adj.}{memorável; inesquecível}
  \synonymref{牢记}{lao2ji4}
  \synonymref{铭记}{ming2ji4}
  \synonymref{深刻}{shen1ke4}
  \synonymref{深入人心}{shen1ru4-ren2xin1}
...
\begin{Entry}{难受}{10,8}{⾫,⼜}
  ...
  \synonymref{不适}{bu2shi4}
  \synonymref{恶心}{e3xin5}
...
\begin{Entry}{难度}{10,9}{⾫,⼴}
  \begin{Phonetics}{难度}{nan2du4}[][HSK 3]
...
\begin{Entry}{难看}{10,9}{⾫,⽬}
  \begin{Phonetics}{难看}{nan2kan4}[][HSK 2]
  ...
  \synonymref{丢脸}{diu1//lian3}
  \antonymref{好看}{hao3kan4}
  \antonymref{靓丽}{liang4li4}
  \antonymref{美观}{mei3guan1}
  \antonymref{美丽}{mei3li4}
  \antonymref{漂亮}{piao4liang5}
  \antonymref{体面}{ti3mian4}
  \antonymref{英俊}{ying1jun4}
...
\begin{Entry}{难得一见}{10,11,1,4}{⾫,⼻,⼀,⾒}
  \begin{Phonetics}{难得一见}{nan2de2yi2jian4}[][HSK 7-9]
...
\begin{Entry}{难道}{10,12}{⾫,⾡}
  ...
  \seealsoref{吗}{ma5}
  \synonymref{恐怕}{kong3pa4}
  \synonymref{莫非}{mo4fei1}
  \synonymref{难怪}{nan2guai4}
  \antonymref{必然}{bi4ran2}
  \antonymref{肯定}{ken3ding4}
...
\begin{Entry}{难题}{10,15}{⾫,⾴}
  \begin{Phonetics}{难题}{nan2ti2}[][HSK 2]
...
%%%%%%%%%% 顽 %%%%%%%%%%
\subsection*{顽}\addcontentsline{loh}{figure}{顽}
...
\begin{Entry}{顽皮}{10,5}{⾴,⽪}
  \begin{Phonetics}{顽皮}{wan2pi2}[][HSK 6]
...
\begin{Entry}{顽固}{10,8}{⾴,⼞}
  \begin{Phonetics}{顽固}{wan2gu4}[][HSK 7-9]
...
%%%%%%%%%% 顾 %%%%%%%%%%
\subsection*{顾}\addcontentsline{loh}{figure}{顾}
...
%%%%%%%%%% 顿 %%%%%%%%%%
\subsection*{顿}\addcontentsline{loh}{figure}{顿}

\begin{Entry}{顿}{10}{⾴}
  \begin{Phonetics}{顿}{du2}
    \definition*{s.}{Maodun Chanyu (冒顿单于), nome do príncipe herdeiro do povo Xiongnu (匈奴) no início da Dinastia Han}
  \seealsoref{冒顿单于}{mao4dun4 chan2yu2}
  \seealsoref{匈奴}{xiong1nu2}
  \end{Phonetics}
...
%%%%%%%%%% 颁 %%%%%%%%%%
\subsection*{颁}\addcontentsline{loh}{figure}{颁}
...
%%%%%%%%%% 预 %%%%%%%%%%
\subsection*{预}\addcontentsline{loh}{figure}{预}

\begin{Entry}{预}{10}{⾴}
  \begin{Phonetics}{预}{yu4}
    \definition{adj.}{primeiro}
    \definition{adv.}{antecipadamente; com antecedência; previamente}
    \definition{v.}{participar de}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{预习}{10,3}{⾴,⼄}
  ...
  \synonymref{自学}{zi4xue2}
  \antonymref{复习}{fu4xi2}
  \antonymref{温习}{wen1xi2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{预见}{10,4}{⾴,⾒}
  \begin{Phonetics}{预见}{yu4jian4}[][HSK 7-9]
...
\begin{Entry}{预计}{10,4}{⾴,⾔}
  \begin{Phonetics}{预计}{yu4ji4}[][HSK 3]
    \definition{v.}{estimar; calcular com antecedência}
  \seealsoref{预测}{yu4ce4}
...
\begin{Entry}{预订}{10,4}{⾴,⾔}
  ...
  \synonymref{订购}{ding4gou4}
  \synonymref{预定}{yu4ding4}
  \synonymref{预购}{yu4gou4}
...
\begin{Entry}{预付}{10,5}{⾴,⼈}
  \begin{Phonetics}{预付}{yu4fu4}
    ...
    \definition{v.}{pré"-pagar; adiantar um pagamento; pagar antecipadamente}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{预示}{10,5}{⾴,⽰}
  \begin{Phonetics}{预示}{yu4shi4}[][HSK 7-9]
...
\begin{Entry}{预兆}{10,6}{⾴,⼉}
  \begin{Phonetics}{预兆}{yu4zhao4}[][HSK 7-9]
...
\begin{Entry}{预先}{10,6}{⾴,⼉}
  \begin{Phonetics}{预先}{yu4xian1}[][HSK 7-9]
...
\begin{Entry}{预判}{10,7}{⾴,⼑}
  \begin{Phonetics}{预判}{yu4pan4}
    \definition{v.}{antecipar; prever}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{预告}{10,7}{⾴,⼝}
  \begin{Phonetics}{预告}{yu4gao4}[][HSK 7-9]
...
\begin{Entry}{预报}{10,7}{⾴,⼿}
  ...
  \synonymref{预告}{yu4gao4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{预言}{10,7}{⾴,⾔}
  \begin{Phonetics}{预言}{yu4yan2}[][HSK 7-9]
...
\begin{Entry}{预备}{10,8}{⾴,⼡}
  \begin{Phonetics}{预备}{yu4bei4}[][HSK 5]
    \definition{v.}{preparar"-se; ficar pronto}
  \synonymref{安排}{an1pai2}
  \synonymref{部署}{bu4shu3}
  \synonymref{筹备}{chou2//bei4}
  \synonymref{筹办}{chou2ban4}
  \synonymref{打算}{da3suan5}
  \synonymref{计划}{ji4hua4}
...
\begin{Entry}{预定}{10,8}{⾴,⼧}
  \begin{Phonetics}{预定}{yu4ding4}[][HSK 7-9]
...
\begin{Entry}{预购}{10,8}{⾴,⾙}
  \begin{Phonetics}{预购}{yu4gou4}
    \definition{s.}{fazer um pedido (ou compra) antecipadamente | comprar antecipadamente; fazer uma pré"-encomenda}
    \definition{v.}{comprar antecipadamente}
  \synonymref{采购}{cai3gou4}
  \synonymref{订购}{ding4gou4}
...
\begin{Entry}{预测}{10,9}{⾴,⽔}
  \begin{Phonetics}{预测}{yu4ce4}[][HSK 4]
    \definition{v.}{prever; prognosticar; predizer}
  \seealsoref{预计}{yu4ji4}
...
\begin{Entry}{预祝}{10,9}{⾴,⽰}
  \begin{Phonetics}{预祝}{yu4zhu4}
    \definition{v.}{dar os parabéns antecipadamente; dar parabéns ou votos antecipados}
...
\begin{Entry}{预览}{10,9}{⾴,⾒}
  \begin{Phonetics}{预览}{yu4lan3}
    \definition{s.}{pré"-visualização}
    \definition{v.}{visualizar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{预料}{10,10}{⾴,⽃}
  \begin{Phonetics}{预料}{yu4liao4}[][HSK 7-9]
...
\begin{Entry}{预留}{10,10}{⾴,⽥}
  \begin{Phonetics}{预留}{yu4liu2}
    \definition{adj.}{taciturno, reservado; reservado, com reserva prévia; reservado, agendado; armazenado, estocado}
    \definition{s.}{possuidor (de um certo direito, etc.)}
    \definition{v.}{reter; reservar; separar}
  \synonymref{预定}{yu4ding4}
  \synonymref{预订}{yu4ding4}
  \antonymref{放弃}{fang4qi4}
...
\begin{Entry}{预售}{10,11}{⾴,⼝}
  \begin{Phonetics}{预售}{yu4shou4}[][HSK 7-9]
...
\begin{Entry}{预谋}{10,11}{⾴,⾔}
  \begin{Phonetics}{预谋}{yu4mou2}
    ...
    \definition{v.}{premeditar; planejar com antecedência; planejar previamente; o planejamento prévio à prática de um crime refere"-se especificamente ao ato de criminosos planejarem suas ações antes de cometerem atos ilegais}
...
\begin{Entry}{预感}{10,13}{⾴,⼼}
  \begin{Phonetics}{预感}{yu4gan3}[][HSK 7-9]
...
\begin{Entry}{预算}{10,14}{⾴,⽵}
  \begin{Phonetics}{预算}{yu4suan4}[][HSK 7-9]
...
\begin{Entry}{预赛}{10,14}{⾴,⾙}
  \begin{Phonetics}{预赛}{yu4sai4}[][HSK 7-9]
...
\begin{Entry}{预警}{10,19}{⾴,⾔}
  \begin{Phonetics}{预警}{yu4jing3}
    \definition{s.}{aviso prévio; alerta antecipado}
  \synonymref{提醒}{ti2//xing3}
  \synonymref{预示}{yu4shi4}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 饿 %%%%%%%%%%
\subsection*{饿}\addcontentsline{loh}{figure}{饿}

\begin{Entry}{饿}{10}{⾷}
  \begin{Phonetics}{饿}{e4}[][HSK 1]
    \definition{adj.}{faminto}
    \definition{v.}{passar fome; causar fome}
  \seealsoref{饥饿}{ji1'e4}
  \synonymref{饥}{ji1}
  \antonymref{饱}{bao3}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 验 %%%%%%%%%%
\subsection*{验}\addcontentsline{loh}{figure}{验}

\begin{Entry}{验}{10}{⾺}
  \begin{Phonetics}{验}{yan4}[][HSK 7-9]
...
\begin{Entry}{验收}{10,6}{⾺,⽁}
  \begin{Phonetics}{验收}{yan4shou1}[][HSK 7-9]
...
\begin{Entry}{验证}{10,7}{⾺,⾔}
  \begin{Phonetics}{验证}{yan4zheng4}[][HSK 7-9]
...
%%%%%%%%%% 高 %%%%%%%%%%
\subsection*{高}\addcontentsline{loh}{figure}{高}
...
\begin{Entry}{高大}{10,3}{⾼,⼤}
  \begin{Phonetics}{高大}{gao1da4}[][HSK 5]
  ...
  \antonymref{渺小}{miao3xiao3}
  \antonymref{年轻}{nian2qing1}
  \antonymref{平凡}{ping2fan2}
  \antonymref{普通}{pu3tong1}
  \antonymref{袖珍}{xiu4zhen1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{高中}{10,4}{⾼,⼁}
  \begin{Phonetics}{高中}{gao1zhong1}[][HSK 2]
    \definition[所,个]{s.}{ensino médio; escola secundária de ensino médio}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{高手}{10,4}{⾼,⼿}
  \begin{Phonetics}{高手}{gao1shou3}[][HSK 6]
...
\begin{Entry}{高级宾馆}{10,6,10,11}{⾼,⽷,⼧,⾷}
  \begin{Phonetics}{高级宾馆}{gao1ji2 bin1guan3}[][HSK 5]
    \definition{s.}{hotel de luxo}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{高考}{10,6}{⾼,⽼}
  \begin{Phonetics}{高考}{gao1kao3}[][HSK 6]
...
\begin{Entry}{高层}{10,7}{⾼,⼫}
  \begin{Phonetics}{高层}{gao1ceng2}[][HSK 6]
  ...
  \antonymref{底层}{di3ceng2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{高技术}{10,7,5}{⾼,⼿,⽊}
  \begin{Phonetics}{高技术}{gao1ji4shu4}
...
\begin{Entry}{高尚}{10,8}{⾼,⼩}
  ...
  \seealsoref{崇高}{chong2gao1}
  \synonymref{高贵}{gao1gui4}
  \synonymref{高雅}{gao1ya3}
  \synonymref{伟大}{wei3da4}
  \synonymref{尊贵}{zun1gui4}
  \antonymref{低下}{di1xia4}
...
\begin{Entry}{高度}{10,9}{⾼,⼴}
  \begin{Phonetics}{高度}{gao1du4}[][HSK 5]
  ...
  \seealsoref{高低}{gao1di1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{高科技}{10,9,7}{⾼,⽲,⼿}
  \begin{Phonetics}{高科技}{gao1ke1ji4}[][HSK 6]
    \definition[种,类]{s.}{alta tecnologia; \emph{high tech}}
  \synonymref{高技术}{gao1ji4shu4}
  \synonymref{高新技术}{gao1xin1-ji4shu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{高原}{10,10}{⾼,⼚}
  \begin{Phonetics}{高原}{gao1yuan2}[][HSK 5]
    \definition[片]{s.}{platô; terras altas; planalto | planalto continental}
  \synonymref{丘陵}{qiu1ling2}
  \antonymref{平地}{ping2di4}
  \antonymref{平原}{ping2yuan2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{高峰}{10,10}{⾼,⼭}
  \begin{Phonetics}{高峰}{gao1feng1}[][HSK 6]
    \definition[个,座]{s.}{cume; pináculo; pico da montanha | pico (de atividade, qualidade ou realização); o ponto mais alto no desenvolvimento das coisas | cúpula; principais líderes; o mais alto nível de liderança}
  \synonymref{高层}{gao1ceng2}
  \synonymref{高潮}{gao1chao2}
  \antonymref{低谷}{di1gu3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{高档}{10,10}{⾼,⽊}
  ...
  \seealsoref{高级}{gao1ji2}
  \synonymref{高等}{gao1deng3}
  \synonymref{尖端}{jian1duan1}
  \antonymref{低等}{di1deng3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{高档服装}{10,10,8,12}{⾼,⽊,⽉,⾐}
  \begin{Phonetics}{高档服装}{gao1dang4 fu2zhuang1}[][HSK 5]
    \definition{s.}{roupas de alto padrão; roupas de qualidade superior; moda de altíssima qualidade; roupas caras e de alta qualidade | alta"-costura | roupas de alta"-costura}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{高烧}{10,10}{⾼,⽕}
  \begin{Phonetics}{高烧}{gao1shao1}
    \definition[次,场]{s.}{febre alta; temperatura corporal acima de 39°C}
  \seealsoref{高温}{gao1wen1}
  \synonymref{发烧}{fa1shao1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{高速}{10,10}{⾼,⾡}
  \begin{Phonetics}{高速}{gao1su4}[][HSK 3]
...
\begin{Entry}{高速公路}{10,10,4,13}{⾼,⾡,⼋,⾜}
  \begin{Phonetics}{高速公路}{gao1su4 gong1lu4}[][HSK 3]
...
\begin{Entry}{高铁}{10,10}{⾼,⾦}
  \begin{Phonetics}{高铁}{gao1tie3}[][HSK 4]
...
\begin{Entry}{高跟鞋}{10,13,15}{⾼,⾜,⾰}
  \begin{Phonetics}{高跟鞋}{gao1gen1xie2}[][HSK 5]
...
\begin{Entry}{高潮}{10,15}{⾼,⽔}
  \begin{Phonetics}{高潮}{gao1chao2}[][HSK 4]
    \definition[个,场]{s.}{maré alta; o nível mais alto da maré em um ciclo de maré | pico; aumento; maré alta; estágio mais próspero de desenvolvimento das coisas | (ficção, drama e filmes) clímax}
  \seealsoref{热潮}{re4chao2}
  \synonymref{高峰}{gao1feng1}
  \synonymref{高涨}{gao1zhang3}
  \antonymref{低潮}{di1chao2}
  \antonymref{低谷}{di1gu3}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 鬯 %%%%%%%%%%
\subsection*{鬯}\addcontentsline{loh}{figure}{鬯}
...
\begin{Entry}{鸵鸟}{10,5}{⿃,⿃}
  \begin{Phonetics}{鸵鸟}{tuo2niao3}
    \definition[只,些,群]{s.}{avestruz (ave)}
  \end{Phonetics}
\end{Entry}
