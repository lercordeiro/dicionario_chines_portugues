...
%%%%%%%%%% 歙 %%%%%%%%%%
\subsection*{歙}\addcontentsline{loh}{figure}{歙}

\begin{Entry}{歙}{16}{⽋}
  \begin{Phonetics}{歙}{she4}
    \definition{s.}{Nome de um distrito em Anhui (安徽)}
  \seealsoref{安徽}{an1hui1}
  \end{Phonetics}
  \begin{Phonetics}{歙}{xi1}
...
%%%%%%%%%% 瘾 %%%%%%%%%%
\subsection*{瘾}\addcontentsline{loh}{figure}{瘾}

\begin{Entry}{瘾}{16}{⽧}
  \begin{Phonetics}{瘾}{yin3}[][HSK 7-9]
...
\begin{Entry}{醒目}{16,5}{⾣,⽬}
  \begin{Phonetics}{醒目}{xing3mu4}[][HSK 7-9]
...
\begin{Entry}{醒来}{16,7}{⾣,⽊}
  \begin{Phonetics}{醒来}{xing3lai5}[][HSK 7-9]
...
\begin{Entry}{醒悟}{16,10}{⾣,⼼}
  \begin{Phonetics}{醒悟}{xing3wu4}[][HSK 7-9]
...
%%%%%%%%%% 霎 %%%%%%%%%%
\subsection*{霎}\addcontentsline{loh}{figure}{霎}

\begin{Entry}{霎}{16}{⾬}
  \begin{Phonetics}{霎}{sha4}
    \definition{s.}{um período de tempo muito curto; momento; instante}
    \definition{v.}{piscar; dar uma piscadela}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{霎时间}{16,7,7}{⾬,⽇,⾨}
  \begin{Phonetics}{霎时间}{sha4shi2jian1}
