...
%%%%%%%%%% 凿 %%%%%%%%%%
\subsection*{凿}\addcontentsline{loh}{figure}{凿}

\begin{Entry}{凿}{12}{⼐}
  \begin{Phonetics}{凿}{zao2}[][HSK 7-9]
...
\begin{Entry}{剩下}{12,3}{⼑,⼀}
  \begin{Phonetics}{剩下}{sheng4xia5}[][HSK 5]
...
\begin{Entry}{喂奶}{12,5}{⼝,⼥}
  \begin{Phonetics}{喂奶}{wei4nai3}
    \definition{v.}{amamentar; dar de mamar; nutrir; alimentar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{喂养}{12,9}{⼝,⼋}
  \begin{Phonetics}{喂养}{wei4yang3}[][HSK 7-9]
...
\begin{Entry}{喂食}{12,9}{⼝,⾷}
  \begin{Phonetics}{喂食}{wei4shi2}
    \definition{v.}{alimentar (um bebê, um animal, etc.)}
...
\begin{Entry}{喂料}{12,10}{⼝,⽃}
  \begin{Phonetics}{喂料}{wei4liao4}
    \definition{v.}{alimentar (especialmente animais de tração) | fornecer combustível para um fogo ou material para uma máquina; alimentar (um fogo ou uma máquina) | alimentar (também figurativamente)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{喔}{12}{⼝}
  ...
  \end{Phonetics}
  \begin{Phonetics}{喔}{wo1}
    \definition{s.}{Onomatopéia: o canto de um galo}
  \end{Phonetics}
  \begin{Phonetics}{喔}{wo5}
    \definition{interj./part.}{Onomatopéia: marcador de surpresa, percepção repentina, lembrete}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{喜出望外}{12,5,11,5}{⼝,⼐,⽉,⼣}
  \begin{Phonetics}{喜出望外}{xi3chu1wang4wai4}[][HSK 7-9]
...
\begin{Entry}{喜好}{12,6}{⼝,⼥}
  \begin{Phonetics}{喜好}{xi3hao4}[][HSK 7-9]
...
\begin{Entry}{喜庆}{12,6}{⼝,⼴}
  \begin{Phonetics}{喜庆}{xi3qing4}[][HSK 7-9]
...
\begin{Entry}{喜事}{12,8}{⼝,⼅}
  \begin{Phonetics}{喜事}{xi3shi4}[][HSK 7-9]
...
\begin{Entry}{喜怒哀乐}{12,9,9,5}{⼝,⼼,⼝,⼃}
  \begin{Phonetics}{喜怒哀乐}{xi3-nu4-ai1-le4}[][HSK 7-9]
...
\begin{Entry}{喜洋洋}{12,9,9}{⼝,⽔,⽔}
  \begin{Phonetics}{喜洋洋}{xi3yang2yang2}[][HSK 7-9]
...
\begin{Entry}{喜剧}{12,10}{⼝,⼑}
  \begin{Phonetics}{喜剧}{xi3ju4}[][HSK 5]
    \definition[部]{s.}{comédia | comédia; uma das principais categorias do teatro; usa o exagero para satirizar e ridicularizar o feio; fenômenos retrógrados; destaca as contradições inerentes a esses fenômenos e seu conflito com coisas saudáveis; costuma provocar risadas; o final geralmente é feliz}
  \antonymref{悲剧}{bei1ju4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{喜悦}{12,10}{⼝,⼼}
  \begin{Phonetics}{喜悦}{xi3yue4}[][HSK 7-9]
...
\begin{Entry}{喜酒}{12,10}{⼝,⾣}
  \begin{Phonetics}{喜酒}{xi3jiu3}[][HSK 7-9]
...
\begin{Entry}{喜糖}{12,16}{⼝,⽶}
  \begin{Phonetics}{喜糖}{xi3tang2}[][HSK 7-9]
...
\begin{Entry}{喝彩}{12,11}{⼝,⼺}
  \begin{Phonetics}{喝彩}{he4cai3}
    \definition{s.}{aplaudir; ovacionar; gritar ``Bravo!''}
  \synonymref{喝采}{he4//cai3}
  \synonymref{欢呼}{huan1hu1}
  \synonymref{加油}{jia1//you2}
  \synonymref{叫好}{jiao4//hao3}
...
\begin{Entry}{喝醉}{12,15}{⼝,⾣}
  \begin{Phonetics}{喝醉}{he1zui4}
    \definition{v.}{ficar bêbado; a intoxicação ocorre quando o controle de vários sentidos, causado pelo álcool, fica enfraquecido ou suprimido, levando eventualmente a um estado de inconsciência}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 喧 %%%%%%%%%%
\subsection*{喧}\addcontentsline{loh}{figure}{喧}

\begin{Entry}{喧}{12}{⼝}
  \begin{Phonetics}{喧}{xuan1}
...
\begin{Entry}{喧闹}{12,8}{⼝,⾾}
  \begin{Phonetics}{喧闹}{xuan1nao4}[][HSK 7-9]
...
\begin{Entry}{喧哗}{12,9}{⼝,⼝}
  \begin{Phonetics}{喧哗}{xuan1hua2}[][HSK 7-9]
    \definition{adj.}{barulhento; ruidoso}
...
\begin{Entry}{奥林匹克运动会}{12,8,4,7,7,6,6}{⼤,⽊,⼖,⼗,⾡,⼒,⼈}
  \begin{Phonetics}{奥林匹克运动会}{ao4lin2pi3ke4yun4dong4hui4}
...
\begin{Entry}{富人}{12,2}{⼧,⼈}
  ...
  \synonymref{富豪}{fu4hao2}
  \synonymref{富翁}{fu4weng1}
  \antonymref{乞丐}{qi3gai4}
  \antonymref{穷人}{qiong2ren2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{富有}{12,6}{⼧,⽉}
  \begin{Phonetics}{富有}{fu4you3}[][HSK 6]
    \definition{adj.}{rico; abastado; possuir uma grande quantidade de propriedades | rico em espírito; vida espiritual rica}
...
\begin{Entry}{寒冷}{12,7}{⼧,⼎}
  ...
  \synonymref{冰冷}{bing1leng3}
  \antonymref{暖和}{nuan3huo5}
  \antonymref{温暖}{wen1nuan3}
...
\begin{Entry}{寒假}{12,11}{⼧,⼈}
  ...
  \antonymref{暑假}{shu3jia4}
  \antonymref{暑期}{shu3qi1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{寓言}{12,7}{⼧,⾔}
  \begin{Phonetics}{寓言}{yu4yan2}[][HSK 7-9]
...
\begin{Entry}{寓意}{12,13}{⼧,⼼}
  \begin{Phonetics}{寓意}{yu4yi4}[][HSK 7-9]
...
\begin{Entry}{尊严}{12,7}{⼨,⼀}
  \begin{Phonetics}{尊严}{zun1yan2}[][HSK 7-9]
...
\begin{Entry}{尊贵}{12,9}{⼨,⾙}
  \begin{Phonetics}{尊贵}{zun1gui4}[][HSK 7-9]
...
\begin{Entry}{就可以了}{12,5,4,2}{⼪,⼝,⼈,⼅}
  \begin{Phonetics}{就可以了}{jiu4 ke3yi3 le5}
...
\begin{Entry}{幅度}{12,9}{⼱,⼴}
  \begin{Phonetics}{幅度}{fu2du4}[][HSK 5]
    \definition{s.}{alcance; escopo; extensão; largura; largura da propagação de um objeto que vibra ou balança, a magnitude de uma mudança em algo}
  \synonymref{宽度}{kuan1du4}
...
\begin{Entry}{强扭的瓜不甜}{12,7,8,5,4,11}{⼸,⼿,⽩,⽠,⼀,⽢}
  \begin{Phonetics}{强扭的瓜不甜}{qiang2 niu3 de5 gua1 bu4 tian2}[][HSK 5]
    \definition{expr.}{``Um melão colhido à força não é doce.''; se você força algo contra a sua natureza, o resultado não será bom; forçar a realização de algo quando as condições ainda não estão maduras, tais tentativas raramente produzem resultados satisfatórios; um arranjo (desajeitado) feito sem o consentimento das partes envolvidas; se algo não é para acontecer, não adianta tentar forçar a situação}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{循序渐进}{12,7,11,7}{⼻,⼴,⽔,⾡}
  \begin{Phonetics}{循序渐进}{xun2xu4-jian4jin4}[][HSK 7-9]
...
\begin{Entry}{愤怒}{12,9}{⼼,⼼}
  ...
  \seealsoref{发怒}{fa1nu4}
  \seealsoref{恼怒}{nao3nu4}
...
\begin{Entry}{普及}{12,3}{⽇,⼃}
  ...
  \seealsoref{普遍}{pu3bian4}
  \synonymref{广泛}{guang3fan4}
  \synonymref{科普}{ke1pu3}
...
\begin{Entry}{普通}{12,10}{⽇,⾡}
  ...
  \antonymref{显赫}{xian3he4}
  \antonymref{卓越}{zhuo2yue4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{普通人}{12,10,2}{⽇,⾡,⼈}
  \begin{Phonetics}{普通人}{pu3tong1ren2}[][HSK 7-9]
...
\begin{Entry}{普通话}{12,10,8}{⽇,⾡,⾔}
  \begin{Phonetics}{普通话}{pu3tong1hua4}[][HSK 2]
    \definition*[讲]{s.}{Mandarim (``linguagem comum'') | Putonghua (fala comum da língua chinesa) | Língua oficial da China}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{智商}{12,11}{⽇,⼝}
  \begin{Phonetics}{智商}{zhi4shang1}[][HSK 7-9]
...
\begin{Entry}{暂}{12}{⽇}
  \begin{Phonetics}{暂}{zan4}[][HSK 7-9]
...
\begin{Entry}{替别人着想}{12,7,2,11,13}{⽈,⼑,⼈,⽬,⼼}
  \begin{Phonetics}{替别人着想}{ti4 bie2ren2 zhuo2xiang3}[][HSK 5]
    \definition{expr.}{pense nos outros; seja atencioso com os outros}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{最好}{12,6}{⽈,⼥}
  \begin{Phonetics}{最好}{zui4 hao3}[][HSK 1]
...
\begin{Entry}{期}{12}{⽉}
  \begin{Phonetics}{期}{ji1}
    \definition{s.}{um ano inteiro; um mês inteiro}
  \end{Phonetics}
  \begin{Phonetics}{期}{qi1}[][HSK 3]
    \definition{clas.}{questão; número; termo; coisas usadas para parcelamento | (第+)几+期; o número periódico de liberações de uma série de eventos}[这是第几期的杂志？===De qual edição da revista se trata?]
...
\begin{Entry}{期限}{12,8}{⽉,⾩}
  ...
  \seealsoref{时限}{shi2xian4}
  \synonymref{定期}{ding4qi1}
  \synonymref{为期}{wei2qi1}
...
\begin{Entry}{植物人}{12,8,2}{⽊,⽜,⼈}
  \begin{Phonetics}{植物人}{zhi2wu4ren2}
    \definition{s.}{paciente em estado vegetativo}[医院里有个植物人。===Há um paciente em estado vegetativo no hospital.]
  \end{Phonetics}
\end{Entry}

\begin{Entry}{植物学家}{12,8,8,10}{⽊,⽜,⼦,⼧}
  \begin{Phonetics}{植物学家}{zhi2wu4 xue2 jia1}[][HSK 5]
...
\begin{Entry}{椰子}{12,3}{⽊,⼦}
  \begin{Phonetics}{椰子}{ye1zi5}[][HSK 7-9]
...
\begin{Entry}{椰菜}{12,11}{⽊,⾋}
  \begin{Phonetics}{椰菜}{ye1cai4}
...
\begin{Entry}{欺负}{12,6}{⽋,⾙}
  ...
  \antonymref{扶持}{fu2chi2}
  \antonymref{关照}{guan1zhao4}
...
\begin{Entry}{款待}{12,9}{⽋,⼻}
  \begin{Phonetics}{款待}{kuan3dai4}
    \definition{v.}{entreter; tratar cordialmente; ser hospitaleiro com; receber sinceramente; referindo"-se especificamente a um banquete}
...
%%%%%%%%%% 渣 %%%%%%%%%%
\subsection*{渣}\addcontentsline{loh}{figure}{渣}

\begin{Entry}{渣}{12}{⽔}
  \begin{Phonetics}{渣}{zha1}
...
\begin{Entry}{温习}{12,3}{⽔,⼄}
  \begin{Phonetics}{温习}{wen1xi2}[][HSK 7-9]
...
\begin{Entry}{温和}{12,8}{⽔,⼝}
  ...
  \seealsoref{温柔}{wen1rou2}
  \synonymref{和蔼}{he2'ai3}
  \synonymref{和气}{he2qi5}
  \synonymref{暖和}{nuan3huo5}
  \synonymref{随和}{sui2he5}
  \synonymref{温暖}{wen1nuan3}
  \antonymref{暴躁}{bao4zao4}
  \antonymref{浮躁}{fu2zao4}
  \antonymref{寒冷}{han2leng3}
  \antonymref{激烈}{ji1lie4}
  \antonymref{尖锐}{jian1rui4}
  \antonymref{剧烈}{ju4lie4}
  \antonymref{猛烈}{meng3lie4}
  \antonymref{强烈}{qiang2lie4}
  \antonymref{严厉}{yan2li4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{温室}{12,9}{⽔,⼧}
  \begin{Phonetics}{温室}{wen1shi4}[][HSK 7-9]
    \definition[个,座,间]{s.}{estufa; jardim de inverno; originalmente referindo"-se a um ambiente interno aquecido, o termo é agora usado principalmente no contexto do aquecimento global | um ambiente criado propositadamente para que as pessoas cresçam sem desvantagens; um ambiente de vida confortável}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{温度}{12,9}{⽔,⼴}
  ...
  \synonymref{气温}{qi4wen1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{温度计}{12,9,4}{⽔,⼴,⾔}
  \begin{Phonetics}{温度计}{wen1du4ji4}[][HSK 7-9]
...
\begin{Entry}{温柔}{12,9}{⽔,⽊}
  \begin{Phonetics}{温柔}{wen1rou2}[][HSK 7-9]
...
\begin{Entry}{温泉}{12,9}{⽔,⽔}
  \begin{Phonetics}{温泉}{wen1quan2}[][HSK 7-9]
...
\begin{Entry}{温暖}{12,13}{⽔,⽇}
  ...
  \synonymref{温和}{wen1he2}
  \synonymref{温馨}{wen1xin1}
  \antonymref{冰冷}{bing1leng3}
  \antonymref{刺骨}{ci4gu3}
  \antonymref{寒冷}{han2leng3}
  \antonymref{冷漠}{leng3mo4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{温馨}{12,20}{⽔,⾹}
  \begin{Phonetics}{温馨}{wen1xin1}[][HSK 7-9]
...
\begin{Entry}{游戏厅}{12,6,4}{⽔,⼽,⼚}
  \begin{Phonetics}{游戏厅}{you2xi4 ting1}[][HSK 5]
...
\begin{Entry}{游戏软件}{12,6,8,6}{⽔,⼽,⾞,⼈}
  \begin{Phonetics}{游戏软件}{you2xi4 ruan3jian4}[][HSK 5]
...
\begin{Entry}{游泳馆}{12,8,11}{⽔,⽔,⾷}
  \begin{Phonetics}{游泳馆}{you2yong3 guan3}
...
\begin{Entry}{游泳镜}{12,8,16}{⽔,⽔,⾦}
  \begin{Phonetics}{游泳镜}{you2yong3 jing4}
...
\begin{Entry}{游览}{12,9}{⽔,⾒}
  \begin{Phonetics}{游览}{you2lan3}[][HSK 7-9]
...
\begin{Entry}{游船}{12,11}{⽔,⾈}
  \begin{Phonetics}{游船}{you2chuan2}[][HSK 7-9]
...
%%%%%%%%%% 湘 %%%%%%%%%%
\subsection*{湘}\addcontentsline{loh}{figure}{湘}

\begin{Entry}{湘}{12}{⽔}
  \begin{Phonetics}{湘}{xiang1}
...
\begin{Entry}{湘江}{12,6}{⽔,⽔}
  \begin{Phonetics}{湘江}{xiang1jiang1}
...
%%%%%%%%%% 滋 %%%%%%%%%%
\subsection*{滋}\addcontentsline{loh}{figure}{滋}

\begin{Entry}{滋}{12}{⽔}
  \begin{Phonetics}{滋}{zi1}
...
\begin{Entry}{滋味}{12,8}{⽔,⼝}
  \begin{Phonetics}{滋味}{zi1wei4}[][HSK 7-9]
...
\begin{Entry}{滋润}{12,10}{⽔,⽔}
  \begin{Phonetics}{滋润}{zi1run4}[][HSK 7-9]
...
%%%%%%%%%% 滞 %%%%%%%%%%
\subsection*{滞}\addcontentsline{loh}{figure}{滞}

\begin{Entry}{滞}{12}{⽔}
  \begin{Phonetics}{滞}{zhi4}
...
\begin{Entry}{滞后}{12,6}{⽔,⼝}
  \begin{Phonetics}{滞后}{zhi4hou4}[][HSK 7-9]
    \definition{v.}{atrasar; atrasar"-se; ficar para trás}
  \synonymref{落后}{luo4//hou4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{滞留}{12,10}{⽔,⽥}
  \begin{Phonetics}{滞留}{zhi4liu2}[][HSK 7-9]
...
\begin{Entry}{猩猩}{12,12}{⽝,⽝}
  \begin{Phonetics}{猩猩}{xing1xing5}[][HSK 7-9]
...
%%%%%%%%%% 琢 %%%%%%%%%%
\subsection*{琢}\addcontentsline{loh}{figure}{琢}

\begin{Entry}{琢}{12}{⽟}
  \begin{Phonetics}{琢}{zhuo2}
    \definition{v.}{entalhar; esculpir | esmerilhar; esculpir jade em objetos}
  \end{Phonetics}
  \begin{Phonetics}{琢}{zuo2}
...
\begin{Entry}{琴键}{12,13}{⽟,⾦}
  \begin{Phonetics}{琴键}{qin2jian4}
    \definition{s.}{tecla (em um instrumento musical) | uma tecla de piano; as teclas brancas e pretas em órgãos, pianos e outros instrumentos similares}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{番}{12}{⽥}
  ...
  \seealsoref{种}{zhong3}
  \end{Phonetics}
  \begin{Phonetics}{番}{pan1}
    \definition*{s.}{Phan Ngu, um condado na província de Guangdong (广东)}
...
\begin{Entry}{痛快}{12,7}{⽧,⼼}
  ...
  \seealsoref{爽快}{shuang3kuai5}
  \synonymref{干脆}{gan1cui4}
  \synonymref{高兴}{gao1xing4}
  \synonymref{酣畅}{han1chang4}
  \synonymref{开心}{kai1//xin1}
  \synonymref{快乐}{kuai4le4}
...
\begin{Entry}{痛骂}{12,9}{⽧,⾺}
  \begin{Phonetics}{痛骂}{tong4ma4}
    \definition{v.}{amaldiçoar veementemente; repreender | berrar | repreender severamente}
...
\begin{Entry}{登记处}{12,5,5}{⽨,⾔,⼡}
  \begin{Phonetics}{登记处}{deng1ji4 chu4}[][HSK 5]
...
%%%%%%%%%% 皖 %%%%%%%%%%
\subsection*{皖}\addcontentsline{loh}{figure}{皖}

\begin{Entry}{皖}{12}{⽩}
  \begin{Phonetics}{皖}{wan3}
    \definition*{s.}{Outro nome para a Província de Anhui (安徽) | Sobrenome: Wan}
...
\begin{Entry}{硬币}{12,4}{⽯,⼱}
  \begin{Phonetics}{硬币}{ying4bi4}[][HSK 7-9]
...
\begin{Entry}{硬卧车厢}{12,8,4,11}{⽯,⾂,⾞,⼚}
  \begin{Phonetics}{硬卧车厢}{ying4wo4 che1xiang1}[][HSK 5]
    \definition{s.}{vagão"-leito (classe econômica)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{硬座车厢}{12,10,4,11}{⽯,⼴,⾞,⼚}
  \begin{Phonetics}{硬座车厢}{ying4zuo4 che1xiang1}[][HSK 5]
    \definition{s.}{vagão de assentos rígidos}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{硬朗}{12,10}{⽯,⽉}
  \begin{Phonetics}{硬朗}{ying4lang5}[][HSK 7-9]
...
\begin{Entry}{硬盘}{12,11}{⽯,⽫}
  \begin{Phonetics}{硬盘}{ying4pan2}[][HSK 7-9]
...
\begin{Entry}{硬磁盘}{12,14,11}{⽯,⽯,⽫}
  \begin{Phonetics}{硬磁盘}{ying4ci2pan2}
...
\begin{Entry}{确}{12}{⽯}
  \begin{Phonetics}{确}{que4}
    \definition{adj.}{verdadeiro; confiável; autêntico; de acordo com os fatos | firme; resoluto | estéril (terra)}
    \definition{adv.}{realmente; de fato; definitivamente}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{确定}{12,8}{⽯,⼧}
  ...
  \antonymref{猜想}{cai1xiang3}
  \antonymref{大概}{da4gai4}
  \antonymref{大致}{da4zhi4}
  \antonymref{感觉}{gan3jue2}
  \antonymref{估计}{gu1ji4}
  \antonymref{好象}{hao3xiang4}
  \antonymref{似乎}{si4hu1}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 稀 %%%%%%%%%%
\subsection*{稀}\addcontentsline{loh}{figure}{稀}

\begin{Entry}{稀}{12}{⽲}
  \begin{Phonetics}{稀}{xi1}[][HSK 7-9]
...
\begin{Entry}{稀少}{12,4}{⽲,⼩}
  \begin{Phonetics}{稀少}{xi1shao3}[][HSK 7-9]
...
\begin{Entry}{稀罕}{12,7}{⽲,⽹}
  \begin{Phonetics}{稀罕}{xi1han5}[][HSK 7-9]
...
\begin{Entry}{稀奇}{12,8}{⽲,⼤}
  \begin{Phonetics}{稀奇}{xi1qi2}[][HSK 7-9]
...
\begin{Entry}{窝}{12}{⽳}
  \begin{Phonetics}{窝}{wo1}[][HSK 7-9]
    ...
    \definition[个,只,块]{s.}{ninho; habitat de aves, animais e insetos | toca; covil; ninho; lugar onde pessoas más se reúnem | lugar; posição ocupada por um corpo humano ou objeto | poço; cavidade; área rebaixada}
...
%%%%%%%%%% 筑 %%%%%%%%%%
\subsection*{筑}\addcontentsline{loh}{figure}{筑}

\begin{Entry}{筑}{12}{⽵}
  \begin{Phonetics}{筑}{zhu4}[][HSK 7-9]
...
%%%%%%%%%% 絮 %%%%%%%%%%
\subsection*{絮}\addcontentsline{loh}{figure}{絮}

\begin{Entry}{絮}{12}{⽷}
  \begin{Phonetics}{絮}{xu4}
...
\begin{Entry}{絮叨}{12,5}{⽷,⼝}
  \begin{Phonetics}{絮叨}{xu4dao5}[][HSK 7-9]
...
\begin{Entry}{编剧}{12,10}{⽷,⼑}
  \begin{Phonetics}{编剧}{bian1//ju4}[][HSK 7-9]
...
\begin{Entry}{编造}{12,10}{⽷,⾡}
  \begin{Phonetics}{编造}{bian1//zao4}[][HSK 7-9]
...
\begin{Entry}{编辑部}{12,13,10}{⽷,⾞,⾢}
  \begin{Phonetics}{编辑部}{bian1ji2 bu4}[][HSK 5]
...
\begin{Entry}{缘分}{12,4}{⽷,⼑}
  \begin{Phonetics}{缘分}{yuan2fen4}[][HSK 7-9]
...
\begin{Entry}{羡慕}{12,14}{⽺,⼼}
  \begin{Phonetics}{羡慕}{xian4mu4}[][HSK 7-9]
...
\begin{Entry}{翘尾巴}{12,7,4}{⽻,⼫,⼰}
  \begin{Phonetics}{翘尾巴}{qiao4//wei3ba1}[][HSK 5]
    \definition{v.+compl.}{ficar metido; tornar"-se convencido; ficar cheio de si; estar de nariz empinado; ficar arrogante e esnobe; andar de nariz em pé; arrogância e presunção}
...
\begin{Entry}{落后地区}{12,6,6,4}{⾋,⼝,⼟,⼖}
  \begin{Phonetics}{落后地区}{luo4hou4 di4qu1}[][HSK 5]
...
\begin{Entry}{落花生}{12,7,5}{⾋,⾋,⽣}
  \begin{Phonetics}{落花生}{luo4hua1sheng1}
...
\begin{Entry}{葵花}{12,7}{⾋,⾋}
  \begin{Phonetics}{葵花}{kui2hua1}
    \definition[棵,朵,片]{s.}{girassol (flor)}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 蛤 %%%%%%%%%%
\subsection*{蛤}\addcontentsline{loh}{figure}{蛤}

\begin{Entry}{蛤}{12}{⾍}
  \begin{Phonetics}{蛤}{ge2}
  ...
  \end{Phonetics}
  \begin{Phonetics}{蛤}{ha2}
    \definition[只]{s.}{sapo; rã}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{蛤蟆}{12,16}{⾍,⾍}
  \begin{Phonetics}{蛤蟆}{ha2ma2}
    \definition{s.}{rã; sapo}
  \synonymref{青蛙}{qing1wa1}
  \antonymref{天鹅}{tian1'e2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{街道办事处}{12,12,4,8,5}{⾏,⾡,⼒,⼅,⼡}
  \begin{Phonetics}{街道办事处}{jie1dao4 ban4shi4 chu4}[][HSK 5]
...
\begin{Entry}{装扮}{12,7}{⾐,⼿}
  \begin{Phonetics}{装扮}{zhuang1ban4}[][HSK 7-9]
...
\begin{Entry}{裤子}{12,3}{⾐,⼦}
  ...
  \synonymref{短裤}{duan3ku4}
  \synonymref{裤}{ku4}
  \synonymref{牛仔裤}{niu2zai3ku4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{谢绝}{12,9}{⾔,⽷}
  \begin{Phonetics}{谢绝}{xie4jue2}[][HSK 5]
    \definition{v.}{recusar; negar educadamente; uma forma educada de recusar (usada principalmente na linguagem escrita)}
  \seealsoref{拒绝}{ju4jue2}
  \synonymref{不容}{bu4rong2}
...
%%%%%%%%%% 谣 %%%%%%%%%%
\subsection*{谣}\addcontentsline{loh}{figure}{谣}

\begin{Entry}{谣}{12}{⾔}
  \begin{Phonetics}{谣}{yao2}
...
\begin{Entry}{谣言}{12,7}{⾔,⾔}
  \begin{Phonetics}{谣言}{yao2yan2}[][HSK 7-9]
...
\begin{Entry}{谦虚}{12,11}{⾔,⾌}
  ...
  \seealsoref{谦逊}{qian1xun4}
  \seealsoref{虚心}{xu1xin1}
  \synonymref{低调}{di1diao4}
  \synonymref{客气}{ke4qi4}
  \antonymref{傲慢}{ao4man4}
  \antonymref{高傲}{gao1'ao4}
  \antonymref{骄傲}{jiao1'ao4}
  \antonymref{夸耀}{kua1yao4}
  \antonymref{狂妄}{kuang2wang4}
  \antonymref{卖弄}{mai4nong5}
  \antonymref{炫耀}{xuan4yao4}
...
\begin{Entry}{超市人口}{12,5,2,3}{⾛,⼱,⼈,⼝}
  \begin{Phonetics}{超市人口}{chao1shi4 ren2kou3}[][HSK 5]
...
\begin{Entry}{越过}{12,6}{⾛,⾡}
  \begin{Phonetics}{越过}{yue4guo4}[][HSK 7-9]
...
\begin{Entry}{趋势}{12,8}{⾛,⼒}
  ...
  \synonymref{苗头}{miao2tou5}
  \synonymref{势头}{shi4tou5}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 逾 %%%%%%%%%%
\subsection*{逾}\addcontentsline{loh}{figure}{逾}

\begin{Entry}{逾}{12}{⾡}
  \begin{Phonetics}{逾}{yu2}
    \definition{adv.}{Literário: ainda mais}
    \definition{v.}{exceder; cruzar; ir além}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{逾期}{12,12}{⾡,⽉}
  \begin{Phonetics}{逾期}{yu2//qi1}[][HSK 7-9]
...
\begin{Entry}{遇上}{12,3}{⾡,⼀}
  \begin{Phonetics}{遇上}{yu4shang4}[][HSK 7-9]
    \definition{v.}{encontrar alguém; esbarrar em alguém}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{遇见}{12,4}{⾡,⾒}
  \begin{Phonetics}{遇见}{yu4jian4}[][HSK 4]
...
\begin{Entry}{遇险}{12,9}{⾡,⾩}
  \begin{Phonetics}{遇险}{yu4//xian3}[][HSK 7-9]
...
\begin{Entry}{遇难}{12,10}{⾡,⾫}
  \begin{Phonetics}{遇难}{yu4//nan4}[][HSK 7-9]
...
\begin{Entry}{道理}{12,11}{⾡,⽟}
  \begin{Phonetics}{道理}{dao4li3}[][HSK 2]
...
\begin{Entry}{遗体}{12,7}{⾡,⼈}
  \begin{Phonetics}{遗体}{yi2ti3}[][HSK 7-9]
...
\begin{Entry}{遗址}{12,7}{⾡,⼟}
  \begin{Phonetics}{遗址}{yi2zhi3}[][HSK 7-9]
...
\begin{Entry}{遗弃}{12,7}{⾡,⼶}
  \begin{Phonetics}{遗弃}{yi2qi4}[][HSK 7-9]
...
\begin{Entry}{遗忘}{12,7}{⾡,⼼}
  \begin{Phonetics}{遗忘}{yi2wang4}[][HSK 7-9]
...
\begin{Entry}{遗物}{12,8}{⾡,⽜}
  \begin{Phonetics}{遗物}{yi2wu4}[][HSK 7-9]
...
\begin{Entry}{遗留}{12,10}{⾡,⽥}
  \begin{Phonetics}{遗留}{yi2liu2}[][HSK 7-9]
...
\begin{Entry}{遗愿}{12,14}{⾡,⽕}
  \begin{Phonetics}{遗愿}{yi2yuan4}[][HSK 7-9]
...
\begin{Entry}{遗嘱}{12,15}{⾡,⼝}
  \begin{Phonetics}{遗嘱}{yi2zhu3}[][HSK 7-9]
...
\begin{Entry}{酢浆草}{12,10,9}{⾣,⽔,⾋}
  \begin{Phonetics}{酢浆草}{zuo4jiang1cao3}
...
%%%%%%%%%% 铸 %%%%%%%%%%
\subsection*{铸}\addcontentsline{loh}{figure}{铸}

\begin{Entry}{铸}{12}{⾦}
  \begin{Phonetics}{铸}{zhu4}
    \definition*{s.}{Zhu, um estado da Dinastia Zhou | Sobrenome: Zhu}
    \definition{v.}{fundir metais | cunhar moedas}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{铸造}{12,10}{⾦,⾡}
  \begin{Phonetics}{铸造}{zhu4zao4}[][HSK 7-9]
...
\begin{Entry}{铺垫}{12,9}{⾦,⼟}
  \begin{Phonetics}{铺垫}{pu1dian4}
    \definition{s.}{roupa de cama; lençóis; colchão; almofada}
    \definition{v.}{servir de contraste; realçar; destacar; complementar | colocar roupa de cama ou um colchão}
  \synonymref{衬托}{chen4tuo1}
  \synonymref{奠定}{dian4ding4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{销}{12}{⾦}
  \begin{Phonetics}{销}{xiao1}[][HSK 7-9]
...
\begin{Entry}{销售人员}{12,11,2,7}{⾦,⼝,⼈,⼝}
  \begin{Phonetics}{销售人员}{xiao1shou4 ren2yuan2}[][HSK 5]
    \definition{s.}{equipe de vendas; vendedores}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{销售员}{12,11,7}{⾦,⼝,⼝}
  \begin{Phonetics}{销售员}{xiao1shou4 yuan2}[][HSK 5]
    \definition[个,位,名,些]{s.}{vendedor; são profissionais cuja função principal envolve a venda de produtos ou serviços, desempenhando um papel fundamental nas atividades comerciais; eles transmitem informações por meio de recursos tangíveis, como os próprios produtos ou materiais promocionais, ao mesmo tempo em que utilizam técnicas de persuasão para concretizar vendas com sucesso}
  \synonymref{售货员}{shou4huo4yuan2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{销量}{12,12}{⾦,⾥}
  \begin{Phonetics}{销量}{xiao1liang4}[][HSK 7-9]
    \definition{s.}{vendas (volume); quantidade de mercadorias vendidas}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{销毁}{12,13}{⾦,⽎}
  \begin{Phonetics}{销毁}{xiao1hui3}[][HSK 7-9]
...
%%%%%%%%%% 锈 %%%%%%%%%%
\subsection*{锈}\addcontentsline{loh}{figure}{锈}

\begin{Entry}{锈}{12}{⾦}
  \begin{Phonetics}{锈}{xiu4}[][HSK 7-9]
...
\begin{Entry}{雄伟}{12,6}{⾫,⼈}
  ...
  \seealsoref{雄壮}{xiong2zhuang4}
  \synonymref{宏大}{hong2da4}
  \synonymref{盛大}{sheng4da4}
...
\begin{Entry}{雄壮}{12,6}{⾫,⼠}
  \begin{Phonetics}{雄壮}{xiong2zhuang4}
    \definition{adj.}{heróico; majestoso; magnífico; imponente}
  \seealsoref{雄伟}{xiong2wei3}
...
\begin{Entry}{雄厚}{12,9}{⾫,⼚}
  \begin{Phonetics}{雄厚}{xiong2hou4}[][HSK 7-9]
...
%%%%%%%%%% 雅 %%%%%%%%%%
\subsection*{雅}\addcontentsline{loh}{figure}{雅}

\begin{Entry}{雅}{12}{⾫}
  \begin{Phonetics}{雅}{ya1}
    \variantof{鸦}
  \end{Phonetics}
  \begin{Phonetics}{雅}{ya3}
...
\begin{Entry}{骗人}{12,2}{⾺,⼈}
  \begin{Phonetics}{骗人}{pian4ren2}[][HSK 7-9]
...
\begin{Entry}{黑手}{12,4}{⿊,⼿}
  \begin{Phonetics}{黑手}{hei1shou3}[][HSK 7-9]
    \definition{s.}{mão negra; manipulador maligno dos bastidores | uma pessoa cruel manipulando alguém ou algo nos bastidores; pessoas ou forças que secretamente realizam atividades de conspiração}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{黑白}{12,5}{⿊,⽩}
  \begin{Phonetics}{黑白}{hei1bai2}[][HSK 7-9]
    \definition[只]{s.}{preto e branco | certo e errado; o certo e o errado, o bem e o mal}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{黑体}{12,7}{⿊,⼈}
  \begin{Phonetics}{黑体}{hei1ti3}
    \definition{s.}{Física: corpo negro | negrito (impressão) | negrito (tipo de letra)}
  \end{Phonetics}
\end{Entry}
