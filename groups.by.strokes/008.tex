...
\begin{Entry}{丧钟}{8,9}{⼗,⾦}
  \begin{Phonetics}{丧钟}{sang1zhong1}
    \definition{s.}{sino fúnebre; toque de finados; sinete; na tradição ocidental, o toque dos sinos da igreja para anunciar a morte de um membro da congregação ou para realizar cerimônias religiosas em memória do falecido é chamado de tocar o sino fúnebre; portanto, o sino fúnebre é usado como metáfora para a morte ou o falecimento}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{乳房}{8,8}{⼄,⼾}
  \begin{Phonetics}{乳房}{ru3fang2}
    \definition{s.}{mama; teta; úbere (de vaca, cabra, etc.); órgão mamário exclusivo dos seres humanos e mamíferos}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{事}{8}{⼅}
  \begin{Phonetics}{事}{shi4}[][HSK 1]
    \definition[件,回]{s.}{assunto; questão; coisa; negócio | problema; acidente | emprego; trabalho | responsabilidade; envolvimento | caso, coisa; o que aconteceu}
    \definition{v.}{servir; atender | estar envolvido em; dedicar"-se a}
  \seealsoref{事情}{shi4qing5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{事儿}{8,2}{⼅,⼉}
  \begin{Phonetics}{事儿}{shi4r5}
    \definition[件,桩]{s.}{coisa; assunto; caso; negócio; matéria | problema; acidente | emprego; trabalho; ocupação | responsabilidade; envolvimento; participação}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{事业}{8,5}{⼅,⼀}
  ...
  \seealsoref{工作}{gong1zuo4}
  \synonymref{成果}{cheng2guo3}
  \synonymref{成绩}{cheng2ji4}
  \synonymref{公办}{gong1ban4}
  \synonymref{公立}{gong1li4}
  \synonymref{业绩}{ye4ji4}
...
\begin{Entry}{事实}{8,8}{⼅,⼧}
  ...
  \antonymref{设想}{she4xiang3}
  \antonymref{神话}{shen2hua4}
  \antonymref{虚构}{xu1gou4}
...
\begin{Entry}{事实上}{8,8,3}{⼅,⼧,⼀}
  \begin{Phonetics}{事实上}{shi4shi2 shang4}[][HSK 3]
...
\begin{Entry}{事物}{8,8}{⼅,⽜}
  ...
  \synonymref{实物}{shi2wu4}
  \synonymref{物品}{wu4pin3}
  \synonymref{物体}{wu4ti3}
  \synonymref{现象}{xian4xiang4}
  \antonymref{虚构}{xu1gou4}
  \antonymref{虚幻}{xu1huan4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{享}{8}{⼇}
  \begin{Phonetics}{享}{xiang3}[][HSK 7-9]
    \definition{v.}{aproveitar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{享乐}{8,5}{⼇,⼃}
  \begin{Phonetics}{享乐}{xiang3le4}
    \definition{v.}{levar uma vida de prazeres; entregar"-se aos confortos materiais; aproveitar a felicidade | aproveitar a vida}
  \seealsoref{享受}{xiang3shou4}
  \synonymref{坐享}{zuo4xiang3}
  \antonymref{吃苦}{chi1//ku3}
  \antonymref{受苦}{shou4//ku3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{享用}{8,5}{⼇,⽤}
  \begin{Phonetics}{享用}{xiang3yong4}
    \definition{v.}{desfrutar; aproveitar o uso de; usar algo para sua satisfação; obter satisfação material ou espiritual através do uso de algo}
  \seealsoref{享受}{xiang3shou4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{享有}{8,6}{⼇,⽉}
  \begin{Phonetics}{享有}{xiang3you3}[][HSK 7-9]
...
\begin{Entry}{享受}{8,8}{⼇,⼜}
  ...
  \seealsoref{享乐}{xiang3le4}
  \seealsoref{享用}{xiang3yong4}
  \antonymref{吃苦}{chi1//ku3}
...
\begin{Entry}{京剧演员}{8,10,14,7}{⼇,⼑,⽔,⼝}
  \begin{Phonetics}{京剧演员}{jing1ju4 yan3yuan2}[][HSK 5]
    \definition{s.}{ator da Ópera de Pequim}[她是一位京剧演员。===Ela é uma atriz de Ópera de Pequim.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{使用}{8,5}{⼈,⽤}
  ...
  \seealsoref{利用}{li4yong4}
  \seealsoref{试用}{shi4yong4}
...
\begin{Entry}{使用者}{8,5,8}{⼈,⽤,⽼}
  \begin{Phonetics}{使用者}{shi3yong4 zhe3}[][HSK 5]
    \definition{s.}{usuário; termo da área de gestão e tecnologia; membros de uma organização que efetivamente utilizam os produtos ou serviços adquiridos}[我通过地址找到了使用者。===Encontrei o usuário pelo endereço.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{使劲}{8,7}{⼈,⼒}
  ...
  \synonymref{用力}{yong4//li4}
  \antonymref{放松}{fang4song1}
  \antonymref{袖手旁观}{xiu4shou3-pang2guan1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{使劲儿}{8,7,2}{⼈,⼒,⼉}
  \begin{Phonetics}{使劲儿}{shi3jin4r5}
    \definition{v.}{empregar todas as suas forças; fazer ao máximo | exercer força; empenhar"-se; usar todas as suas forças; esforçar"-se ao máximo; dar tudo de si}
  \seealsoref{用力}{yong4//li4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{使命}{8,8}{⼈,⼝}
  \begin{Phonetics}{使命}{shi3ming4}[][HSK 7-9]
    \definition{s.}{dever; missão; propósito (uma grande responsabilidade ou dever que uma pessoa assume); a grande responsabilidade que se carrega | missão (uma tarefa ou dever atribuído a alguém que deve ser cumprido); as ordens recebidas pelo instigador}
...
\begin{Entry}{侃大山}{8,3,3}{⼈,⼤,⼭}
  \begin{Phonetics}{侃大山}{kan3da4shan1}[][HSK 7-9]
...
\begin{Entry}{例外}{8,5}{⼈,⼣}
  ...
  \antonymref{常规}{chang2gui1}
  \antonymref{一律}{yi2lv4}
  \antonymref{照例}{zhao4li4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{例如}{8,6}{⼈,⼥}
  ...
  \synonymref{比方}{bi3fang1}
  \synonymref{比如}{bi3ru2}
  \synonymref{好比}{hao3bi3}
  \synonymref{举例}{ju3//li4}
...
\begin{Entry}{供应}{8,7}{⼈,⼴}
  ...
  \seealsoref{供给}{gong1ji3}
  \synonymref{提供}{ti2gong1}
  \antonymref{需求}{xu1qiu2}
  \antonymref{需要}{xu1yao4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{供给}{8,9}{⼈,⽷}
  ...
  \seealsoref{供应}{gong1ying4}
  \synonymref{补给}{bu3ji3}
...
\begin{Entry}{依旧}{8,5}{⼈,⽇}
  ...
  \seealsoref{依然}{yi1ran2}
  \synonymref{还是}{hai2shi5}
  \synonymref{仍旧}{reng2jiu4}
  \synonymref{仍然}{reng2ran2}
  \synonymref{照例}{zhao4li4}
  \synonymref{照样}{zhao4yang4}
  \antonymref{变化}{bian4hua4}
  \antonymref{变换}{bian4huan4}
  \antonymref{重新}{chong2xin1}
  \antonymref{改变}{gai3bian4}
  \antonymref{改动}{gai3dong4}
  \antonymref{改革}{gai3ge2}
  \antonymref{转变}{zhuan3bian4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{依托}{8,6}{⼈,⼿}
  \begin{Phonetics}{依托}{yi1tuo1}[][HSK 7-9]
...
\begin{Entry}{依依不舍}{8,8,4,8}{⼈,⼈,⼀,⾆}
  \begin{Phonetics}{依依不舍}{yi1yi1-bu4she3}[][HSK 7-9]
...
\begin{Entry}{依法}{8,8}{⼈,⽔}
  ...
  \synonymref{合法}{he2fa3}
  \antonymref{非法}{fei1fa3}
  \antonymref{任意}{ren4yi4}
  \antonymref{擅自}{shan4zi4}
  \antonymref{违法}{wei2//fa3}
  \antonymref{违规}{wei2gui1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{依偎}{8,11}{⼈,⼈}
  \begin{Phonetics}{依偎}{yi1wei1}
    \definition{v.}{inclinar"-se para perto de; aconchegar"-se a}
  \synonymref{依靠}{yi1kao4}
...
\begin{Entry}{依赖}{8,13}{⼈,⾙}
  ...
  \seealsoref{依靠}{yi1kao4}
  \synonymref{凭借}{ping2jie4}
  \antonymref{独立}{du2li4}
  \antonymref{自立}{zi4li4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{依靠}{8,15}{⼈,⾮}
  ...
  \seealsoref{依赖}{yi1lai4}
  \synonymref{凭借}{ping2jie4}
  \synonymref{依托}{yi1tuo1}
  \synonymref{依偎}{yi1wei1}
  \antonymref{独立}{du2li4}
  \antonymref{自立}{zi4li4}
...
%%%%%%%%%% 侥 %%%%%%%%%%
\subsection*{侥}\addcontentsline{loh}{figure}{侥}

\begin{Entry}{侥}{8}{⼈}
  \begin{Phonetics}{侥}{jiao3}
    \definition{adj.}{por sorte; por um acaso | por pura sorte}
  \end{Phonetics}
  \begin{Phonetics}{侥}{yao2}
    \definition{s.}{pessoa baixa}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{侥幸}{8,8}{⼈,⼲}
  \begin{Phonetics}{侥幸}{jiao3xing4}
    \definition{adj.}{sorte; sortudo; feliz; afortunado; descreve a obtenção de benefícios inesperada ou acidental, ou a fuga de uma desgraça}
  \seealsoref{幸运}{xing4yun4}
  \synonymref{碰巧}{peng4qiao3}
...
%%%%%%%%%% 侦 %%%%%%%%%%
\subsection*{侦}\addcontentsline{loh}{figure}{侦}

\begin{Entry}{侦}{8}{⼈}
  \begin{Phonetics}{侦}{zhen1}
    \definition{v.}{detectar; explorar; investigar; investigar secretamente; escutar às escondidas}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{侦察}{8,14}{⼈,⼧}
  \begin{Phonetics}{侦察}{zhen1cha2}[][HSK 7-9]
...
\begin{Entry}{侧}{8}{⼈}
  ...
  \antonymref{正}{zheng4}
  \end{Phonetics}
  \begin{Phonetics}{侧}{ze4}
    \definition{s.}{lado, lateral}
  \antonymref{正}{zheng4}
  \end{Phonetics}
...
\begin{Entry}{兔子}{8,3}{⼉,⼦}
  \begin{Phonetics}{兔子}{tu4zi5}
    \definition[只,群,批,窝]{s.}{lebre; coelho}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{其}{8}{⼋}
  \begin{Phonetics}{其}{ji1}
    \definition*{s.}{Usado em nomes pessoais; Li Yiji (郦食其); um erudito da Dinastia Han}
  \seealsoref{郦食其}{li4 yi4ji1}
  \end{Phonetics}
...
\begin{Entry}{其中}{8,4}{⼋,⼁}
  ...
  \seealsoref{当中}{dang1zhong1}
  \seealsoref{其间}{qi2jian1}
  \synonymref{中间}{zhong1jian1}
  \antonymref{其他}{qi2ta1}
  \antonymref{其余}{qi2yu2}
...
\begin{Entry}{其他}{8,5}{⼋,⼈}
  ...
  \seealsoref{其余}{qi2yu2}
  \synonymref{别的}{bie2 de5}
  \synonymref{此外}{ci3wai4}
  \antonymref{其中}{qi2zhong1}
...
\begin{Entry}{典礼}{8,5}{⼋,⽰}
  ...
  \synonymref{礼仪}{li3yi2}
  \synonymref{庆典}{qing4dian3}
  \synonymref{盛会}{sheng4hui4}
  \synonymref{仪式}{yi2shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{到处}{8,5}{⼑,⼡}
  ...
  \seealsoref{处处}{chu4chu4}
  \synonymref{遍地}{bian4di4}
  \synonymref{四处}{si4chu4}
...
\begin{Entry}{到达}{8,6}{⼑,⾡}
  ...
  \seealsoref{达到}{da2dao4}
  \seealsoref{到}{dao4}
  \seealsoref{抵达}{di3da2}
  \synonymref{赶到}{gan3dao4}
...
\begin{Entry}{制}{8}{⼑}
  \begin{Phonetics}{制}{zhi4}[][HSK 7-9]
...
\begin{Entry}{制止}{8,4}{⼑,⽌}
  \begin{Phonetics}{制止}{zhi4zhi3}[][HSK 7-9]
...
\begin{Entry}{制订}{8,4}{⼑,⾔}
  ...
  \synonymref{拟定}{ni3ding4}
  \synonymref{协议}{xie2yi4}
  \synonymref{制定}{zhi4ding4}
...
\begin{Entry}{制服}{8,8}{⼑,⽉}
  \begin{Phonetics}{制服}{zhi4fu2}[][HSK 7-9]
...
\begin{Entry}{制品}{8,9}{⼑,⼝}
  \begin{Phonetics}{制品}{zhi4pin3}[][HSK 7-9]
...
\begin{Entry}{制造}{8,10}{⼑,⾡}
  ...
  \seealsoref{制作}{zhi4zuo4}
  \synonymref{编造}{bian1//zao4}
  \synonymref{创建}{chuang4jian4}
  \synonymref{创造}{chuang4zao4}
  \synonymref{建造}{jian4zao4}
  \synonymref{酿造}{niang4zao4}
  \synonymref{研制}{yan2zhi4}
  \antonymref{拆除}{chai1chu2}
  \antonymref{化解}{hua4jie3}
...
\begin{Entry}{制造者}{8,10,8}{⼑,⾡,⽼}
  \begin{Phonetics}{制造者}{zhi4zao4 zhe3}[][HSK 5]
    \definition{s.}{fabricante; criador; \emph{maker}}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{制裁}{8,12}{⼑,⾐}
  \begin{Phonetics}{制裁}{zhi4cai2}[][HSK 7-9]
...
\begin{Entry}{刷}{8}{⼑}
  \begin{Phonetics}{刷}{shua1}[][HSK 4]
    ...
    \definition{v.}{escovar; esfregar; remover com uma escova | borrar; colar; aplicar com um pincel | eliminar; remover; limpar | rolar; navegar; visualizar grandes quantidades de informações muito rapidamente em um curto período de tempo \emph{on"-line} ou em dispositivos móveis | deslizar (passar o cartão magnético)}
  \end{Phonetics}
...
\begin{Entry}{刷新}{8,13}{⼑,⽄}
  \begin{Phonetics}{刷新}{shua1xin1}[][HSK 7-9]
    \definition{v.}{renovar; reformar; atualizar; criar novo | atualizar (um site, uma página da \emph{web}) | quebrar (um recorde); descreve a substituição de conquistas existentes por novas e melhores}
...
\begin{Entry}{刺}{8}{⼑}
  ...
  \begin{Phonetics}{刺}{ci4}[][HSK 4]
    ...
    \definition[根]{s.}{espinho; farpa; algo afiado como uma agulha | cartão de visita | saliências; projeções pequenas e pontiagudas na superfície de um objeto ou na pele de uma pessoa}
...
%%%%%%%%%% 卓 %%%%%%%%%%
\subsection*{卓}\addcontentsline{loh}{figure}{卓}

\begin{Entry}{卓}{8}{⼗}
  \begin{Phonetics}{卓}{zhuo2}
...
\begin{Entry}{卓越}{8,12}{⼗,⾛}
  \begin{Phonetics}{卓越}{zhuo2yue4}[][HSK 7-9]
...
\begin{Entry}{单}{8}{⼗}
  ...
  \begin{Phonetics}{单}{dan1}[][HSK 4]
    ...
    \definition{num.}{zero; colocado entre duas quantidades para indicar que uma quantidade com uma unidade menor sucede uma com uma unidade maior; funciona da mesma maneira que o 零}
...
\begin{Entry}{单一}{8,1}{⼗,⼀}
  ...
  \synonymref{单调}{dan1diao4}
  \synonymref{简单}{jian3dan1}
  \synonymref{唯一}{wei2yi1}
  \antonymref{多样}{duo1yang4}
...
\begin{Entry}{单于}{8,3}{⼗,⼆}
  \begin{Phonetics}{单于}{chan2yu2}
    \definition*{s.}{Sobrenome: Chanyu}
    \definition{s.}{título do chefe dos Xiongnu (匈奴) | chanyu, nome da dinastia Han para chefes dos Xiongnu Hunos (匈奴)}
...
\begin{Entry}{单位证明}{8,7,7,8}{⼗,⼈,⾔,⽇}
  \begin{Phonetics}{单位证明}{dan1wei4 zheng4ming2}[][HSK 5]
    \definition{s.}{certificado do empregador; certificado de unidade}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{单纯}{8,7}{⼗,⽷}
  ...
  \synonymref{纯真}{chun2zhen1}
  \synonymref{单调}{dan1diao4}
  \synonymref{单一}{dan1yi1}
  \synonymref{简单}{jian3dan1}
  \antonymref{多样}{duo1yang4}
  \antonymref{丰富}{feng1fu4}
  \antonymref{丰盛}{feng1sheng4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{单质}{8,8}{⼗,⾙}
  \begin{Phonetics}{单质}{dan1zhi4}
    \definition{s.}{Química: substância simples (consistindo puramente de um elemento, como diamante, grafite, etc.)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{单独}{8,9}{⼗,⽝}
  ...
  \seealsoref{独自}{du2zi4}
  \seealsoref{孤独}{gu1du2}
  \synonymref{独立}{du2li4}
  \synonymref{孤单}{gu1dan1}
  \synonymref{孤立}{gu1li4}
  \synonymref{只身}{zhi1shen1}
  \antonymref{共同}{gong4tong2}
  \antonymref{合伙}{he2huo3}
  \antonymref{联合}{lian2he2}
  \antonymref{陪伴}{pei2ban4}
  \antonymref{众多}{zhong4duo1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{单调}{8,10}{⼗,⾔}
  ...
  \synonymref{单一}{dan1yi1}
  \synonymref{枯燥}{ku1zao4}
  \antonymref{缤纷}{bin1fen1}
  \antonymref{丰富}{feng1fu4}
  \antonymref{复杂}{fu4za2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{单脚滑行车}{8,11,12,6,4}{⼗,⾁,⽔,⾏,⾞}
  \begin{Phonetics}{单脚滑行车}{dan1jiao3 hua2xing2 che1}
    \definition{s.}{\emph{scooter}; lambreta; mobilete; ``patinete de uma perna só''}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{卧车}{8,4}{⾂,⾞}
  \begin{Phonetics}{卧车}{wo4che1}
    \definition{s.}{vagão"-leito; vagão"-dormitório; cabine"-leito; carruagens com camas"-leito | automóvel; carro; limusine; sedã}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{卧床}{8,7}{⾂,⼴}
  \begin{Phonetics}{卧床}{wo4chuang2}
    \definition{adj.}{acamado devido a doença, idade avançada, etc.}
    \definition{v.}{deitar na cama}
    \definition{v.}{ficar acamado; permanecer deitado na cama devido a doença ou idade avançada}
  \synonymref{卧铺}{wo4pu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{卧室}{8,9}{⾂,⼧}
  ...
  \synonymref{寝室}{qin3shi4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{卧倒}{8,10}{⾂,⼈}
  \begin{Phonetics}{卧倒}{wo4dao3}
    \definition{v.}{cair no chão; deitar"-se de bruços | assumir a posição prona; deitar"-se}
  \antonymref{屹立}{yi4li4}
...
\begin{Entry}{卧病}{8,10}{⾂,⽧}
  \begin{Phonetics}{卧病}{wo4bing4}
    \definition{s.}{doente na cama; acamado; deitado devido a doença}
    \definition{v.}{ficar confinado à cama; ficar acamado}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{卧榻}{8,14}{⾂,⽊}
  \begin{Phonetics}{卧榻}{wo4ta4}
    \definition{s.}{cama | um sofá | uma cama estreita}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{厕所}{8,8}{⼚,⼾}
  ...
  \synonymref{茅厕}{mao2ce4}
  \synonymref{卫生}{wei4sheng1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{参加}{8,5}{⼛,⼒}
  ...
  \seealsoref{出席}{chu1xi2}
  \seealsoref{加入}{jia1ru4}
...
\begin{Entry}{参观者}{8,6,8}{⼛,⾒,⽼}
  \begin{Phonetics}{参观者}{can1guan1 zhe3}[][HSK 5]
    \definition{s.}{visitante; visita}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{参展}{8,10}{⼛,⼫}
  \begin{Phonetics}{参展}{can1//zhan3}[][HSK 6]
    \definition{v.+compl.}{expor ou participar de uma feira comercial, etc.}
  \synonymref{陈列}{chen2lie4}
  \synonymref{展出}{zhan3chu1}
  \antonymref{收藏}{shou1cang2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{参赛}{8,14}{⼛,⾙}
  \begin{Phonetics}{参赛}{can1sai4}[][HSK 6]
...
\begin{Entry}{取水}{8,4}{⼜,⽔}
  \begin{Phonetics}{取水}{qu3shui3}
    \definition{v.}{buscar água | obter água (de um poço, etc.) | ingerir de água}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{取决于}{8,6,3}{⼜,⼎,⼆}
  \begin{Phonetics}{取决于}{qu3jue2yu2}[][HSK 7-9]
    \definition{v.}{depender de; ser determinado por (algo)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{取名}{8,6}{⼜,⼝}
  \begin{Phonetics}{取名}{qu3//ming2}[][HSK 5]
    \definition{v.+compl.}{dar (ou receber) um nome a; chamar"-se; refere"-se ao uso de diversos métodos para atribuir um nome a uma pessoa ou objeto, facilitando sua identificação e distinção}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{取悦}{8,10}{⼜,⼼}
  \begin{Phonetics}{取悦}{qu3yue4}
    \definition{v.}{tentar agradar; bajular alguém; conquistar o favor de alguém}
  \synonymref{讨好}{tao3//hao3}
  \antonymref{得罪}{de2zui4}
  \antonymref{冒犯}{mao4fan4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{取消}{8,10}{⼜,⽔}
  ...
  \antonymref{制定}{zhi4ding4}
  \antonymref{制订}{zhi4ding4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{受伤}{8,6}{⼜,⼈}
  ...
  \synonymref{受害}{shou4//hai4}
  \synonymref{损害}{sun3hai4}
  \synonymref{损伤}{sun3shang1}
  \antonymref{康复}{kang1fu4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{受欢迎}{8,6,7}{⼜,⽋,⾡}
  \begin{Phonetics}{受欢迎}{shou4 huan1ying2}[][HSK 5]
    \definition{adj.}{popular; bem recebido; bem"-quisto; muitas pessoas gostam e aceitam isso com satisfação}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{受灾}{8,7}{⼜,⽕}
  \begin{Phonetics}{受灾}{shou4zai1}[][HSK 5]
...
\begin{Entry}{受得了}{8,11,2}{⼜,⼻,⼅}
  \begin{Phonetics}{受得了}{shou4de5liao3}
    \definition{expr.}{poder suportar (ou aguentar) | suportar | tolerar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{变心}{8,4}{⼜,⼼}
  \begin{Phonetics}{变心}{bian4//xin1}
    \definition{v.+compl.}{deixar de ser fiel; mudar de lealdade; quebrar a fé | deixar de ser fiel; mudar seu amor ou lealdade original por pessoas ou carreira}
...
\begin{Entry}{变成}{8,6}{⼜,⼽}
  \begin{Phonetics}{变成}{bian4cheng2}[][HSK 2]
...
\begin{Entry}{变迁}{8,6}{⼜,⾡}
  \begin{Phonetics}{变迁}{bian4qian1}[][HSK 7-9]
    \definition{v.}{mudar; alterar; fazer a transição; fazer uma mudança de um estado para outro; mudar nas tendências ou condições; mudar ou alterar nas circunstâncias ou fases | verbo intransitivo, não pode ser seguido por um objeto e não pode ser usado com a estrutura da frase 把}
  \seealsoref{把}{ba3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{变性}{8,8}{⼜,⼼}
  \begin{Phonetics}{变性}{bian4//xing4}
    \definition{s.}{Medicina: cirurgia de mudança de sexo | deterioração; degeneração; desnaturação; desestruturação; um objeto ou célula de um organismo que altera suas propriedades, características ou perde sua função devido a mudanças químicas ou físicas | transexual}
    \definition{v.+compl.}{Química: desnaturar | mudar de sexo por meio de cirurgia; alterar o próprio gênero por meio de cirurgia; fazer uma cirurgia de mudança de sexo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{变换}{8,10}{⼜,⼿}
  ...
  \antonymref{保持}{bao3chi2}
  \antonymref{固定}{gu4ding4}
  \antonymref{锁定}{suo3ding4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{变装}{8,12}{⼜,⾐}
  \begin{Phonetics}{变装}{bian4zhuang1}
    \definition{v.}{trocar de roupa | vestir"-se bem; colocar uma fantasia; fazer cosplay | vestir"-se com roupas do sexo oposto}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{周末}{8,5}{⼝,⽊}
  ...
  \synonymref{星期六}{xing1qi1liu4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{周边}{8,5}{⼝,⾡}
  \begin{Phonetics}{周边}{zhou1bian1}[][HSK 7-9]
    \definition{s.}{vizinhança; área circundante; por toda parte}
  \synonymref{附近}{fu4jin4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{周边城市}{8,5,9,5}{⼝,⾡,⼟,⼱}
  \begin{Phonetics}{周边城市}{zhou1bian1 cheng2shi4}[][HSK 5]
    \definition{s.}{cidade vizinha; cidade periférica}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{周围}{8,7}{⼝,⼞}
  ...
  \synonymref{边缘}{bian1yuan2}
  \synonymref{四周}{si4zhou1}
  \synonymref{外围}{wai4wei2}
...
\begin{Entry}{周到}{8,8}{⼝,⼑}
  \begin{Phonetics}{周到}{zhou1dao4}[][HSK 7-9]
...
\begin{Entry}{周密}{8,11}{⼝,⼧}
  \begin{Phonetics}{周密}{zhou1mi4}[][HSK 7-9]
...
\begin{Entry}{周旋}{8,11}{⼝,⽅}
  \begin{Phonetics}{周旋}{zhou1xuan2}[][HSK 7-9]
...
\begin{Entry}{呼啸}{8,11}{⼝,⼝}
  \begin{Phonetics}{呼啸}{hu1xiao4}
    \definition{v.}{zunir; rugir; assobiar; gritar; produzir um som agudo e prolongado}
...
\begin{Entry}{命令}{8,5}{⼝,⼈}
  ...
  \synonymref{吩咐}{fen1fu4}
  \synonymref{下令}{xia4//ling4}
  \synonymref{指令}{zhi3ling4}
  \synonymref{指示}{zhi3shi4}
  \antonymref{哀求}{ai1qiu2}
  \antonymref{恳求}{ken3qiu2}
  \antonymref{请求}{qing3qiu2}
  \antonymref{听命}{ting1ming4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{命运}{8,7}{⼝,⾡}
  \begin{Phonetics}{命运}{ming4yun4}[][HSK 3]
    \definition[个]{s.}{tendência de desenvolvimento; tendência de futuro; direção e tendência do desenvolvimento e das mudanças | destino; sina; sorte; refere"-se à vida e à morte, à riqueza e à pobreza e a todas as experiências da vida}
...
\begin{Entry}{咀嚼}{8,20}{⼝,⼝}
  \begin{Phonetics}{咀嚼}{ju3jue2}
    \definition{v.}{mastigar; triturar alimentos com os dentes | refletir sobre; descreve o ato de ponderar e compreender algo repetidamente}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{和平}{8,5}{⼝,⼲}
  ...
  \synonymref{柔和}{rou2he2}
  \antonymref{暴力}{bao4li4}
  \antonymref{刺激}{ci4ji1}
  \antonymref{猛烈}{meng3lie4}
  \antonymref{强烈}{qiang2lie4}
  \antonymref{战争}{zhan4zheng1}
  \antonymref{作战}{zuo4zhan4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{咒骂}{8,9}{⼝,⾺}
  \begin{Phonetics}{咒骂}{zhou4ma4}
    \definition{v.}{amaldiçoar; jurar; insultar; injuriar | xingar (uma pessoa)}
...
\begin{Entry}{咖啡色}{8,11,6}{⼝,⼝,⾊}
  \begin{Phonetics}{咖啡色}{ka1fei1se4}
    \definition[种]{s.}{cor café; marrom}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{咖啡壶}{8,11,10}{⼝,⼝,⼠}
  \begin{Phonetics}{咖啡壶}{ka1fei1 hu2}[][HSK 5]
    \definition{s.}{bule de café; cafeteira; uma cafeteira para preparar ou servir café}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{咖啡馆}{8,11,11}{⼝,⼝,⾷}
  \begin{Phonetics}{咖啡馆}{ka1fei1guan3}
    \definition[家]{s.}{café; cafeteria; lojas que vendem café e outras bebidas para os clientes se sentarem e consumirem}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{国家政府}{8,10,9,8}{⼞,⼧,⽁,⼴}
  \begin{Phonetics}{国家政府}{guo2jia1 zheng4fu3}[][HSK 5]
    \definition{s.}{governo nacional}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{国家银行}{8,10,11,6}{⼞,⼧,⾦,⾏}
  \begin{Phonetics}{国家银行}{guo2jia1 yin2hang2}[][HSK 5]
    \definition{s.}{banco nacional}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{国家领导人}{8,10,11,6,2}{⼞,⼧,⾴,⼨,⼈}
  \begin{Phonetics}{国家领导人}{guo2jia1 ling3dao3 ren2}[][HSK 5]
    \definition{s.}{líderes nacionais; líderes estaduais}[党和国家领导人和群众一道参加五一节游园联欢。===Líderes do partido e do Estado juntaram"-se às massas nas comemorações do Primeiro de Maio nos parques.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{图书管理员}{8,4,14,11,7}{⼞,⼄,⽵,⽟,⼝}
  \begin{Phonetics}{图书管理员}{tu2shu1 guan3li3 yuan2}[][HSK 5]
    \definition[名,位,个]{s.}{bibliotecário}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{坡}{8}{⼟}
  \begin{Phonetics}{坡}{po1}[][HSK 6]
    ...
    \definition[个,道,面,座]{s.}{declive | encosta}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{坦诚}{8,8}{⼟,⾔}
  ...
  \antonymref{疙瘩}{ge1da5}
  \antonymref{撒谎}{sa1//huang3}
  \antonymref{作弊}{zuo4//bi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{垂头丧气}{8,5,8,4}{⼠,⼤,⼗,⽓}
  \begin{Phonetics}{垂头丧气}{chui2tou2-sang4qi4}[][HSK 7-9]
    \definition{expr.}{estar desanimado; estar abatido; abaixar a cabeça com um olhar abatido}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{垃圾}{8,6}{⼟,⼟}
  \begin{Phonetics}{垃圾}{la1ji1}[][HSK 4]
    ...
    \definition[袋,桶,堆,车,片]{s.}{entulho; lixo; refugo; rejeito; resíduo; coisa inútil que é jogada fora; alguém ou algo que perdeu seu valor ou serve a um propósito ruim}
  \synonymref{废品}{fei4pin3}
  \synonymref{废物}{fei4wu4}
  \antonymref{宝贝}{bao3bei4}
  \antonymref{宝贵}{bao3gui4}
  \antonymref{宝藏}{bao3zang4}
  \antonymref{精品}{jing1pin3}
  \antonymref{精英}{jing1ying1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{垃圾工}{8,6,3}{⼟,⼟,⼯}
  \begin{Phonetics}{垃圾工}{la1ji1 gong1}
    \definition{s.}{coletor de lixo; lixeiro; gari}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{垃圾车}{8,6,4}{⼟,⼟,⾞}
  \begin{Phonetics}{垃圾车}{la1ji1che1}
    \definition{s.}{caminhão de lixo (ou outro veículo); caminhões de lixo que recolhem o lixo ao longo da rua em horários ou locais fixos}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{垃圾电邮}{8,6,5,7}{⼟,⼟,⽥,⾢}
  ...
  \seealsoref{垃圾邮件}{la1ji1you2jian4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{垃圾食品}{8,6,9,9}{⼟,⼟,⾷,⼝}
  \begin{Phonetics}{垃圾食品}{la1ji1 shi2pin3}
    \definition[种,些]{s.}{\emph{junk food}; alimentos com alto teor de açúcar, gordura e sal são geralmente considerados prejudiciais à saúde}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{垃圾堆}{8,6,11}{⼟,⼟,⼟}
  \begin{Phonetics}{垃圾堆}{la1ji1dui1}
    \definition{s.}{monte de lixo; lixão; monte de entulho; depósito de lixo; como o próprio nome sugere, é uma coleção de diferentes tipos de lixo em formatos individuais, formando uma pilha}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{垃圾筒}{8,6,12}{⼟,⼟,⽵}
  \begin{Phonetics}{垃圾筒}{la1ji1tong3}
    \definition{s.}{lata de lixo}
  \synonymref{垃圾箱}{la1ji1xiang1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{垃圾箱}{8,6,15}{⼟,⼟,⾋}
  \begin{Phonetics}{垃圾箱}{la1ji1xiang1}
    \definition{s.}{lixeira; lata de lixo; lata de cinzas (ou lixo, resíduos)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{备份}{8,6}{⼡,⼈}
  \begin{Phonetics}{备份}{bei4fen4}
    \definition{s.}{\emph{backup}; uma cópia de (um disco); uma cópia feita para fins de segurança; atualmente, o termo é frequentemente usado para se referir a um arquivo copiado em aplicativos de computador}
    \definition{v.}{fazer \emph{backup} de documentos}
  \synonymref{预备}{yu4bei4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{备受}{8,8}{⼡,⼜}
  \begin{Phonetics}{备受}{bei4//shou4}[][HSK 7-9]
    \definition{v.+compl.}{experimentar plenamente (o bem ou o mal)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{备胎}{8,9}{⼡,⾁}
  \begin{Phonetics}{备胎}{bei4tai1}
    \definition{s.}{Gíria: substituto; pessoa de reserva; candidato metafórico, opção de reserva | pneu sobressalente; roda sobressalente}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{夜以继日}{8,4,10,4}{⼣,⼈,⽷,⽇}
  \begin{Phonetics}{夜以继日}{ye4yi3ji4ri4}[][HSK 7-9]
...
\begin{Entry}{夜市}{8,5}{⼣,⼱}
  \begin{Phonetics}{夜市}{ye4shi4}[][HSK 7-9]
...
\begin{Entry}{夜场}{8,6}{⼣,⼟}
  \begin{Phonetics}{夜场}{ye4chang3}
    \definition{s.}{espetáculo noturno; apresentação noturna}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{夜里}{8,7}{⼣,⾥}
  \begin{Phonetics}{夜里}{ye4li5}[][HSK 2]
    \definition{s.}{noturno; à noite; o período do anoitecer ao amanhecer | substantivo incontável}
  \seealsoref{夜间}{ye4jian1}
  \seealsoref{夜晚}{ye4wan3}
  \synonymref{晚间}{wan3jian1}
  \synonymref{晚上}{wan3shang5}
  \antonymref{白天}{bai2tian5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{夜间}{8,7}{⼣,⾨}
  \begin{Phonetics}{夜间}{ye4jian1}[][HSK 5]
    \definition{s.}{noite; à noite; noturno; durante a noite | substantivo incontável}
  \seealsoref{夜里}{ye4li5}
  \seealsoref{夜晚}{ye4wan3}
  \synonymref{黑夜}{hei1ye4}
  \synonymref{晚上}{wan3shang5}
  \antonymref{白天}{bai2tian5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{夜夜}{8,8}{⼣,⼣}
  \begin{Phonetics}{夜夜}{ye4ye4}
    \definition{adv.}{todas as noites}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{夜学}{8,8}{⼣,⼦}
  \begin{Phonetics}{夜学}{ye4xue2}
...
\begin{Entry}{夜店}{8,8}{⼣,⼴}
  \begin{Phonetics}{夜店}{ye4dian4}
    \definition[个,家]{s.}{boate; \emph{nightclub}; casas noturnas, bares e outros locais de entretenimento que funcionam à noite}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{夜总会}{8,9,6}{⼣,⼼,⼈}
  \begin{Phonetics}{夜总会}{ye4zong3hui4}[][HSK 7-9]
    \definition{s.}{boate; cabaré; discoteca; casa noturna}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{夜校}{8,10}{⼣,⽊}
  \begin{Phonetics}{夜校}{ye4xiao4}[][HSK 7-9]
    \definition{s.}{escola noturna (ou vespertina)}
  \seealsoref{夜学}{ye4xue2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{夜班}{8,10}{⼣,⽟}
  \begin{Phonetics}{夜班}{ye4ban1}[][HSK 7-9]
    \definition[个]{s.}{turno da noite; turnos noturnos}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{夜晚}{8,11}{⼣,⽇}
  \begin{Phonetics}{夜晚}{ye4wan3}[][HSK 7-9]
    \definition[个]{s.}{noite; entardecer | substantivo contável}
  \seealsoref{夜间}{ye4jian1}
  \seealsoref{夜里}{ye4li5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{奋斗}{8,4}{⼤,⽃}
  ...
  \seealsoref{斗争}{dou4zheng1}
  \synonymref{奋战}{fen4zhan4}
...
\begin{Entry}{奋战}{8,9}{⼤,⼽}
  \begin{Phonetics}{奋战}{fen4zhan4}
    \definition{v.}{lutar bravamente; trabalhar arduamente}
  \synonymref{奋斗}{fen4dou4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{奔跑}{8,12}{⼤,⾜}
  ...
  \antonymref{步行}{bu4xing2}
  \antonymref{停止}{ting2zhi3}
  \antonymref{走路}{zou3lu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{妹丈}{8,3}{⼥,⼀}
  \begin{Phonetics}{妹丈}{mei4zhang4}
    \definition{s.}{marido da irmã mais nova; cunhado}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{妻子}{8,3}{⼥,⼦}
  ...
  \seealsoref{夫人}{fu1ren5}
  \seealsoref{老婆}{lao3po2}
  \seealsoref{媳妇儿}{xi2fu5r5}
  \synonymref{夫妇}{fu1fu4}
...
\begin{Entry}{姐}{8}{⼥}
  \begin{Phonetics}{姐}{jie3}[][HSK 1]
    \definition[个,位,名,些]{s.}{irmã mais velha; irmã | termo genérico para mulheres jovens | mulheres da mesma geração que são mais velhas do que você (geralmente não inclui aquelas que podem ser chamadas de cunhadas) | um título respeitoso para mulheres jovens profissionais em determinados cargos}
...
\begin{Entry}{姐夫}{8,4}{⼥,⼤}
  \begin{Phonetics}{姐夫}{jie3fu5}
    \definition{s.}{marido da irmã mais velha; cunhado}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{姐妹}{8,8}{⼥,⼥}
  ...
  \synonymref{妹妹}{mei4mei5}
  \antonymref{兄弟}{xiong1di5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{姓氏}{8,4}{⼥,⽒}
  \begin{Phonetics}{姓氏}{xing4shi4}[][HSK 7-9]
...
\begin{Entry}{季节}{8,5}{⼦,⾋}
  ...
  \synonymref{季度}{ji4du4}
  \synonymref{时节}{shi2jie2}
  \synonymref{四季}{si4ji4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{孤独}{8,9}{⼦,⽝}
  ...
  \seealsoref{孤单}{gu1dan1}
  \seealsoref{寂寞}{ji4mo4}
  \synonymref{独自}{du2zi4}
  \synonymref{孤立}{gu1li4}
  \synonymref{孤零零}{gu1ling2ling2}
  \synonymref{寂寥}{ji4liao2}
  \synonymref{只身}{zhi1shen1}
  \antonymref{充实}{chong1shi2}
  \antonymref{欢聚}{huan1ju4}
  \antonymref{狂欢}{kuang2huan1}
  \antonymref{联合}{lian2he2}
  \antonymref{陪伴}{pei2ban4}
...
\begin{Entry}{学习用具}{8,3,5,8}{⼦,⼄,⽤,⼋}
  \begin{Phonetics}{学习用具}{xue2xi2 yong4ju4}[][HSK 5]
    \definition{s.}{material escolar; kit educacional; ferramenta de estudo; artigos de papelaria}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{学生公寓}{8,5,4,12}{⼦,⽣,⼋,⼧}
  \begin{Phonetics}{学生公寓}{xue2sheng1 gong1yu4}[][HSK 5]
    \definition{s.}{dormitório estudantil}[学生公寓离学校很近。===Os dormitórios estudantis ficam muito perto da escola.]
  \end{Phonetics}
\end{Entry}

\begin{Entry}{学生处}{8,5,5}{⼦,⽣,⼡}
  \begin{Phonetics}{学生处}{xue2sheng1 chu4}[][HSK 5]
    \definition{s.}{divisão de assuntos estudantis (em instituições de ensino superior) | escritório de assuntos estudantis}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{学生宿舍}{8,5,11,8}{⼦,⽣,⼧,⾆}
  \begin{Phonetics}{学生宿舍}{xue2sheng1 su4she4}[][HSK 5]
    \definition{s.}{dormitório estudantil; alojamento estudantil; residência universitária; acomodação para estudantes}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{学生登记处}{8,5,12,5,5}{⼦,⽣,⽨,⾔,⼡}
  \begin{Phonetics}{学生登记处}{xue2sheng1 deng1ji4 chu4}[][HSK 5]
    \definition{s.}{registro de alunos}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{学生餐厅}{8,5,16,4}{⼦,⽣,⾷,⼚}
  \begin{Phonetics}{学生餐厅}{xue2sheng1 can1ting1}[][HSK 5]
    \definition{s.}{refeitório estudantil}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{学者}{8,8}{⼦,⽼}
  \begin{Phonetics}{学者}{xue2zhe3}[][HSK 5]
    \definition[位,名,个]{s.}{erudito; homem culto; pessoas que fazem pesquisas acadêmicas geralmente se referem àquelas que alcançaram certo sucesso acadêmico | refere"-se principalmente a especialistas voltados para a pesquisa teórica}
  \seealsoref{专家}{zhuan1jia1}
  \seealsoref{专家学者}{zhuan1jia1 xue2zhe3}
  \synonymref{博士}{bo2shi4}
...
\begin{Entry}{学前班}{8,9,10}{⼦,⼑,⽟}
  \begin{Phonetics}{学前班}{xue2qian2ban1}
    \definition{s.}{pré"-escola; jardim de infância | aula pré"-escolar}
  \seealsoref{幼儿园}{you4'er2yuan2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{学费}{8,9}{⼦,⾙}
  \begin{Phonetics}{学费}{xue2fei4}[][HSK 3]
    \definition[笔]{s.}{mensalidade (taxa); prêmio; taxas que os alunos devem pagar para estudar na escola, conforme estabelecido pela escola | preço pelo que se aprendeu ao custo do próprio bolso; preço a pagar para obter uma determinada experiência | custo; preço; todas as despesas necessárias durante o período de estudos do aluno}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{学校证明}{8,10,7,8}{⼦,⽊,⾔,⽇}
  \begin{Phonetics}{学校证明}{xue2xiao4 zheng4ming2}[][HSK 5]
    \definition{s.}{certificado escolar; certificado da empresa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{宗}{8}{⼧}
  \begin{Phonetics}{宗}{zong1}[][HSK 7-9]
...
\begin{Entry}{宗旨}{8,6}{⼧,⽇}
  \begin{Phonetics}{宗旨}{zong1zhi3}[][HSK 7-9]
...
\begin{Entry}{官僚主义}{8,14,5,3}{⼧,⼈,⼂,⼂}
  \begin{Phonetics}{官僚主义}{guan1liao2zhu3yi4}[][HSK 7-9]
...
\begin{Entry}{宝贝}{8,4}{⼧,⾙}
  ...
  \synonymref{瑰宝}{gui1bao3}
  \synonymref{甜心}{tian2xin1}
...
\begin{Entry}{宝石}{8,5}{⼧,⽯}
  ...
  \synonymref{明珠}{ming2zhu1}
  \synonymref{珠宝}{zhu1bao3}
  \synonymref{钻石}{zuan4shi2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{宝库}{8,7}{⼧,⼴}
  ...
  \synonymref{宝藏}{bao3zang4}
  \synonymref{矿藏}{kuang4cang2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{实用}{8,5}{⼧,⽤}
  ...
  \synonymref{适用}{shi4yong4}
  \synonymref{有用}{you3yong4}
  \antonymref{没用}{mei2 yong4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{实在}{8,6}{⼧,⼟}
  \begin{Phonetics}{实在}{shi2zai4}
    \definition{adj.}{honesto; muito honesto | verdadeiro; honesto; realista (não falso, não enganador)}
    \definition{adv.}{verdadeiramente; utilizado para reforçar o tom afirmativo e enfatizar que este é de fato o caso}
  \seealsoref{老实}{lao3shi5}
  \seealsoref{其实}{qi2shi2}
  \seealsoref{确实}{que4shi2}
  \seealsoref{真的}{zhen1 de5}
  ...
  \synonymref{着实}{zhuo2shi2}
  \antonymref{虚构}{xu1gou4}
  \antonymref{虚假}{xu1jia3}
  \antonymref{虚伪}{xu1wei3}
  \end{Phonetics}
  \begin{Phonetics}{实在}{shi2zai5}[][HSK 2]
    \definition{adj.}{real; confiável; cuidadoso; habilidoso; bom (trabalho ou tarefa); (trabalho, tarefa) sólido; autêntico; meticuloso | ``na verdade'' e ``realmente'' indicam que o que está sendo dito é a situação atual (e implica uma mudança de pensamento em relação ao contexto anterior)}
    \definition{adv.}{honestamente, sinceramente | realmente; verdadeiramente; de fato}
  \seealsoref{老实}{lao3shi5}
  \seealsoref{其实}{qi2shi2}
  \seealsoref{确实}{que4shi2}
  \seealsoref{真的}{zhen1 de5}
...
\begin{Entry}{实在人}{8,6,2}{⼧,⼟,⼈}
  \begin{Phonetics}{实在人}{shi2zai4 ren2}[][HSK 5]
    \definition{s.}{pessoa honesta e com os pés no chão; pessoa real}[他是个实在人，值得信赖。===Ele é uma pessoa sensata e de confiança.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{实际}{8,7}{⼧,⾩}
  ...
  \seealsoref{现实}{xian4shi2}
  \synonymref{具体}{ju4ti3}
  \synonymref{切实}{qie4shi2}
  \synonymref{确切}{que4qie4}
  \synonymref{实践}{shi2jian4}
  \synonymref{实况}{shi2kuang4}
  ...
  \antonymref{理论}{li3lun4}
  \antonymref{理想}{li3xiang3}
  \antonymref{梦想}{meng4xiang3}
...
\begin{Entry}{实际上}{8,7,3}{⼧,⾩,⼀}
  ...
  \seealsoref{其实}{qi2shi2}
  \synonymref{事实上}{shi4shi2 shang4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{实事求是}{8,8,7,9}{⼧,⼅,⽔,⽇}
  ...
  \antonymref{异想天开}{yi4xiang3-tian1kai1}
...
\begin{Entry}{实验室}{8,10,9}{⼧,⾺,⼧}
  \begin{Phonetics}{实验室}{shi2yan4 shi4}[][HSK 3]
...
\begin{Entry}{实践}{8,12}{⼧,⾜}
  ...
  \antonymref{空想}{kong1xiang3}
  \antonymref{理论}{li3lun4}
  \antonymref{原理}{yuan2li3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{实践活动}{8,12,9,6}{⼧,⾜,⽔,⼒}
  \begin{Phonetics}{实践活动}{shi2jian4 huo2dong4}[][HSK 5]
    \definition{s.}{atividade prática}[课程中穿插了实践活动。===Atividades práticas foram incorporadas ao curso.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{宠物医院}{8,8,7,9}{⼧,⽜,⼖,⾩}
  \begin{Phonetics}{宠物医院}{chong3wu4 yi1yuan4}[][HSK 5]
    \definition{s.}{clínica veterinária | hospital veterinário}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{岭}{8}{⼭}
  \begin{Phonetics}{岭}{ling3}
    \definition*{s.}{As Cinco Cristas, As Cinco Montanhas Sagradas (五岳) | Sobrenome: Ling}
    \definition[个,座]{s.}{montanha; serra | cordilheira}
...
\begin{Entry}{底下}{8,3}{⼴,⼀}
  \begin{Phonetics}{底下}{di3xia5}[][HSK 3]
    \definition[台]{s.}{em baixo; abaixo; sob | próximo; mais tarde; depois; daqui para a frente}
  \synonymref{下方}{xia4fang1}
  \synonymref{下面}{xia4mian4}
  \synonymref{以下}{yi3xia4}
  \antonymref{上方}{shang4fang1}
  \antonymref{上级}{shang4ji2}
  \antonymref{上面}{shang4mian4}
...
\begin{Entry}{废物}{8,8}{⼴,⽜}
  ...
  \begin{Phonetics}{废物}{fei4wu5}
    \definition{s.}{imprestável (insulto); pessoa inútil (palavrão)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{建议}{8,5}{⼵,⾔}
  \begin{Phonetics}{建议}{jian4yi4}[][HSK 3]
    \definition[条,个,点,项]{s.}{proposta; sugestão; recomendação; para que alguém ou alguma coisa evolua para melhor, para o coletivo; pontos de vista e opiniões apresentados pelos líderes, etc.}
...
\begin{Entry}{建设}{8,6}{⼵,⾔}
  \begin{Phonetics}{建设}{jian4she4}[][HSK 3]
    ...
    \definition{v.}{construir; edificar; (Estado ou coletividade) criar novos empreendimentos ou aumento de novas instalações | o objeto pode ser tanto um substantivo concreto, como ``construir uma ponte'', quanto um substantivo abstrato, como ``construir uma cultura espiritual''}
...
\begin{Entry}{建筑}{8,12}{⼵,⽵}
  \begin{Phonetics}{建筑}{jian4zhu4}[][HSK 5]
    \definition[座,幢,排]{s.}{construção; estrutura; edifício; prédio | substantivo contável que pode ser modificado por quantificadores}
    \definition{v.}{construir; erguer; edificar; construir casas, estradas, pontes, etc.}
  \seealsoref{建设}{jian4she4}
...
\begin{Entry}{建筑工程师}{8,12,3,12,6}{⼵,⽵,⼯,⽲,⼱}
  \begin{Phonetics}{建筑工程师}{jian4zhu4 gong1cheng2 shi1}[][HSK 5]
    \definition{s.}{engenheiro civil; profissional responsável por projetar, supervisionar e gerenciar a construção de edificações}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{往生}{8,5}{⼻,⽣}
  \begin{Phonetics}{往生}{wang3sheng1}
    \definition{s.}{(após) a morte de alguém}
...
\begin{Entry}{往昔}{8,8}{⼻,⽇}
  \begin{Phonetics}{往昔}{wang3xi1}
    \definition{s.}{Literário: (no) passado; (em) tempos antigos}
...
\begin{Entry}{往复}{8,9}{⼻,⼢}
  \begin{Phonetics}{往复}{wang3fu4}
    \definition{s.}{mover"-se para frente e para trás; retribuir; mover"-se para lá e para cá; mover"-se repetidamente | entrar em contato; ter relações sexuais}
...
\begin{Entry}{往程}{8,12}{⼻,⽲}
  \begin{Phonetics}{往程}{wang3cheng2}
    \definition{s.}{trecho de ida (de uma viagem de ônibus ou trem, etc.)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{征}{8}{⼻}
  \begin{Phonetics}{征}{zheng1}[][HSK 7-9]
...
\begin{Entry}{征收}{8,6}{⼻,⽁}
  \begin{Phonetics}{征收}{zheng1shou1}[][HSK 7-9]
...
\begin{Entry}{征集}{8,12}{⼻,⾫}
  \begin{Phonetics}{征集}{zheng1ji2}[][HSK 7-9]
...
\begin{Entry}{忽视}{8,8}{⼼,⾒}
  ...
  \seealsoref{忽略}{hu1lve4}
  \seealsoref{轻视}{qing1shi4}
  \synonymref{大意}{da4yi5}
  \synonymref{冷漠}{leng3mo4}
  \synonymref{马虎}{ma3hu5}
  \synonymref{疏忽}{shu1hu5}
  \antonymref{关心}{guan1xin1}
  \antonymref{讲究}{jiang3jiu5}
  \antonymref{看见}{kan4jian5}
  \antonymref{望见}{wang4jian4}
  \antonymref{重视}{zhong4shi4}
  \antonymref{注视}{zhu4shi4}
  \antonymref{注意}{zhu4yi4}
  \antonymref{着重}{zhuo2zhong4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{忽略}{8,11}{⼼,⽥}
  ...
  \synonymref{大意}{da4yi5}
  \synonymref{马虎}{ma3hu5}
  \synonymref{轻视}{qing1shi4}
  \synonymref{疏忽}{shu1hu5}
  \synonymref{无视}{wu2shi4}
  \antonymref{留心}{liu2//xin1}
  \antonymref{强调}{qiang2diao4}
  \antonymref{在意}{zai4yi4}
  \antonymref{重视}{zhong4shi4}
  \antonymref{注意}{zhu4yi4}
...
\begin{Entry}{性格直}{8,10,8}{⼼,⽊,⽬}
  \begin{Phonetics}{性格直}{xing4ge2 zhi2}[][HSK 5]
    \definition{adj.}{de caráter direto; sincero}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{房子}{8,3}{⼾,⼦}
  ...
  \seealsoref{房间}{fang2jian1}
  \synonymref{房屋}{fang2wu5}
  \synonymref{屋子}{wu1zi5}
  \synonymref{住宅}{zhu4zhai2}
  \antonymref{空地}{kong1di4}
  \antonymref{空地}{kong4di4}
  \antonymref{旷野}{kuang4ye3}
  \antonymref{露天}{lu4tian1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{房东}{8,5}{⼾,⼀}
  ...
  \synonymref{房主}{fang2zhu3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{房主}{8,5}{⼾,⼂}
  \begin{Phonetics}{房主}{fang2zhu3}
    \definition{s.}{proprietário da casa; dono da casa | senhorio}
  \seealsoref{房产主}{fang2chan3zhu3}
  \synonymref{房东}{fang2dong1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{房产主}{8,6,5}{⼾,⼇,⼂}
  \begin{Phonetics}{房产主}{fang2chan3zhu3}
    \definition{s.}{proprietário da casa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{所有}{8,6}{⼾,⽉}
  \begin{Phonetics}{所有}{suo3you3}[][HSK 2]
    ...
    \definition[把]{s.}{bens; posses}
    \definition{v.}{possuir; ter}
  \seealsoref{全部}{quan2bu4}
  \seealsoref{一切}{yi2qie4}
  \seealsoref{一切}{yi2qie4}
  ...
  \antonymref{失去}{shi1qu4}
  \antonymref{一些}{yi4xie1}
  \antonymref{有些}{you3xie1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{承办}{8,4}{⼿,⼒}
  ...
  \seealsoref{承包}{cheng2bao1}
  \synonymref{包办}{bao1ban4}
  \synonymref{受理}{shou4li3}
...
\begin{Entry}{承受}{8,8}{⼿,⼜}
  ...
  \synonymref{继承}{ji4cheng2}
  \synonymref{接收}{jie1shou1}
  \synonymref{接受}{jie1shou4}
  \synonymref{经受}{jing1shou4}
  \synonymref{忍受}{ren3shou4}
...
\begin{Entry}{抬头}{8,5}{⼿,⼤}
  \begin{Phonetics}{抬头}{tai2tou2}[][HSK 5]
  ...
  \synonymref{振兴}{zhen4xing1}
  \synonymref{致敬}{zhi4jing4}
  \antonymref{低头}{di1tou2}
  \antonymref{俯首}{fu3shou3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{抱怨}{8,9}{⼿,⼼}
  \begin{Phonetics}{抱怨}{bao4//yuan4}[][HSK 5]
    \definition{v.+compl.}{reclamar ou expressar descontentamento ou insatisfação; falar com os outros sobre pessoas ou coisas com as quais você não está satisfeito}
  \seealsoref{埋怨}{man2yuan4}
  \synonymref{诉苦}{su4//ku3}
  \synonymref{怨恨}{yuan4hen4}
  \synonymref{怨言}{yuan4yan2}
  \antonymref{感激}{gan3ji1}
  \antonymref{感谢}{gan3xie4}
  \antonymref{理解}{li3jie3}
  \antonymref{谅解}{liang4jie3}
  \antonymref{体谅}{ti3liang4}
...
\begin{Entry}{抱歉}{8,14}{⼿,⽋}
  ...
  \seealsoref{道歉}{dao4//qian4}
  \synonymref{对不起}{dui4bu5qi3}
  \synonymref{歉意}{qian4yi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{抵达}{8,6}{⼿,⾡}
  ...
  \seealsoref{到达}{dao4da2}
  \synonymref{达到}{da2dao4}
  \synonymref{赶到}{gan3dao4}
  \synonymref{降落}{jiang4luo4}
  \synonymref{来到}{lai2dao4}
  \antonymref{出发}{chu1fa1}
  \antonymref{动身}{dong4//shen1}
  \antonymref{离开}{li2kai1}
  \antonymref{启程}{qi3cheng2}
  \antonymref{起程}{qi3cheng2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{抵抗}{8,7}{⼿,⼿}
  ...
  \seealsoref{反抗}{fan3kang4}
  \synonymref{抵触}{di3chu4}
  \synonymref{抵挡}{di3dang3}
  \synonymref{抵御}{di3yu4}
  ...
  \antonymref{投降}{tou2xiang2}
  \antonymref{压迫}{ya1po4}
  \antonymref{执行}{zhi2xing2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{押后}{8,6}{⼿,⼝}
  \begin{Phonetics}{押后}{ya1 hou4}
    \definition{v.}{adiar | postergar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{押运}{8,7}{⼿,⾡}
  \begin{Phonetics}{押运}{ya1yun4}
    \definition{v.}{escoltar (mercadorias) no transporte}
  \synonymref{押送}{ya1song4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{押注}{8,8}{⼿,⽔}
  \begin{Phonetics}{押注}{ya1zhu4}
    \definition{v.}{(em jogos de azar) apostar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{押金}{8,8}{⼿,⾦}
  ...
  \synonymref{定金}{ding4jin1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{押送}{8,9}{⼿,⾡}
  \begin{Phonetics}{押送}{ya1song4}
    \definition{v.}{enviar (um prisioneiro ou cativo) sob escolta; escoltar | escoltar (mercadorias, dinheiro, etc.) no transporte | enviar sob escolta | transportar um detido}
  \synonymref{押运}{ya1yun4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{押租}{8,10}{⼿,⽲}
  \begin{Phonetics}{押租}{ya1zu1}
    \definition{s.}{Obsoleto: depósito de aluguel; antigamente, pagava"-se um depósito de segurança ao alugar um terreno ou uma casa}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{押韵}{8,13}{⼿,⾳}
  \begin{Phonetics}{押韵}{ya1yun4}
    \definition{v.}{rimar; na poesia e na prosa, certos versos terminam com palavras que possuem vogais iguais ou semelhantes para criar um tom harmonioso e belo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{抽奖}{8,9}{⼿,⼤}
  \begin{Phonetics}{抽奖}{chou1jiang3}[][HSK 4]
...
%%%%%%%%%% 拄 %%%%%%%%%%
\subsection*{拄}\addcontentsline{loh}{figure}{拄}

\begin{Entry}{拄}{8}{⼿}
  \begin{Phonetics}{拄}{zhu3}[][HSK 7-9]
...
\begin{Entry}{拆}{8}{⼿}
  \begin{Phonetics}{拆}{ca1}
    \definition{v.}{excretar; eliminar resíduos (urina ou fezes)}
  \end{Phonetics}
...
\begin{Entry}{拆迁}{8,6}{⼿,⾡}
  ...
  \synonymref{搬迁}{ban1qian1}
  \synonymref{迁移}{qian1yi2}
  \antonymref{重建}{chong2jian4}
  \antonymref{复原}{fu4//yuan2}
  \antonymref{修复}{xiu1fu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{拆除}{8,9}{⼿,⾩}
  ...
  \antonymref{安装}{an1zhuang1}
  \antonymref{建立}{jian4li4}
  \antonymref{建造}{jian4zao4}
  \antonymref{扩建}{kuo4jian4}
  \antonymref{设立}{she4li4}
  \antonymref{兴建}{xing1jian4}
  \antonymref{修复}{xiu1fu4}
  \antonymref{修建}{xiu1jian4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{拉}{8}{⼿}
  ...
  \seealsoref{拉丁美洲}{la1ding1mei3zhou1}
  \seealsoref{拖}{tuo1}
  \synonymref{拔}{ba2}
  \synonymref{扯}{che3}
  \synonymref{摧}{cui1}
  ...
  \antonymref{推}{tui1}
  \end{Phonetics}
  \begin{Phonetics}{拉}{la2}
    \definition{v.}{puxar; cortar; fatiar | abrir; remover; operar; realizar cirurgia}
  \synonymref{拔}{ba2}
  \synonymref{引}{yin3}
  \synonymref{拽}{zhuai4}
  \antonymref{推}{tui1}
  \end{Phonetics}
  \begin{Phonetics}{拉}{la3}
    \definition{adj.}{metade; uma metade; frequentemente usado com 半}
  \seealsoref{半}{ban4}
  \end{Phonetics}
  \begin{Phonetics}{拉}{la4}
    \definition{s.}{usado em 拉拉蛄}
  \seealsoref{拉拉蛄}{la4 la4gu3}
  \synonymref{拔}{ba2}
  \synonymref{引}{yin3}
  \synonymref{拽}{zhuai1}
  \antonymref{推}{tui1}
...
\begin{Entry}{拉丁美洲}{8,2,9,9}{⼿,⼀,⽺,⽔}
  \begin{Phonetics}{拉丁美洲}{la1ding1mei3zhou1}
...
\begin{Entry}{拉肚子}{8,7,3}{⼿,⾁,⼦}
  \begin{Phonetics}{拉肚子}{la1//du4zi5}[][HSK 5]
    \definition{v.+compl.}{ter diarreia; sofrer de diarreia; ter fezes soltas}
  \synonymref{腹泻}{fu4xie4}
  \synonymref{跑肚}{pao3 du4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{拉拉蛄}{8,8,11}{⼿,⼿,⾍}
  \begin{Phonetics}{拉拉蛄}{la4 la4gu3}
    \variantof{蝲蝲蛄}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{拍马}{8,3}{⼿,⾺}
  \begin{Phonetics}{拍马}{pai1ma3}
    \definition{v.}{bajular alguém; adular; bajular; agradar a alguém; adular | Figurativo: encorajar | o mesmo que 拍马屁 | incentivar um cavalo dando tapinhas em sua garupa}
...
\begin{Entry}{拍马屁}{8,3,7}{⼿,⾺,⼫}
  \begin{Phonetics}{拍马屁}{pai1ma3pi4}
    ...
    \definition{v.}{bajular; adular; lamber os sapatos de alguém; lamber as botas de alguém}
...
\begin{Entry}{拔尖}{8,6}{⼿,⼩}
  \begin{Phonetics}{拔尖}{ba2//jian1}
    \definition{adj.}{de primeira; de alta qualidade; excepcional; o melhor; fora do comum}
    \definition{v.+compl.}{impulsionar"-se para a frente; destacar"-se; sentir"-se superior aos outros}
...
%%%%%%%%%% 拙 %%%%%%%%%%
\subsection*{拙}\addcontentsline{loh}{figure}{拙}

\begin{Entry}{拙}{8}{⼿}
  \begin{Phonetics}{拙}{zhuo1}
...
\begin{Entry}{拙劣}{8,6}{⼿,⼒}
  \begin{Phonetics}{拙劣}{zhuo1lie4}[][HSK 7-9]
...
\begin{Entry}{招手}{8,4}{⼿,⼿}
  \begin{Phonetics}{招手}{zhao1shou3}[][HSK 5]
    \definition{v.}{acenar; chamar a atenção; levantar a mão e acenar com a palma, para indicar que a outra pessoa se aproxime ou para cumprimentá"-la}
  \synonymref{示意}{shi4yi4}
  \synonymref{招揽}{zhao1lan3}
  \antonymref{摆手}{bai3//shou3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{招收}{8,6}{⼿,⽁}
  \begin{Phonetics}{招收}{zhao1shou1}[][HSK 7-9]
...
\begin{Entry}{招呼}{8,8}{⼿,⼝}
  ...
  \seealsoref{打招呼}{da3zhao1hu5}
  \synonymref{吩咐}{fen1fu4}
  \synonymref{呼唤}{hu1huan4}
...
\begin{Entry}{招待}{8,9}{⼿,⼻}
  \begin{Phonetics}{招待}{zhao1dai4}[][HSK 7-9]
...
\begin{Entry}{招待会}{8,9,6}{⼿,⼻,⼈}
  \begin{Phonetics}{招待会}{zhao1dai4hui4}[][HSK 7-9]
    \definition[个,次]{s.}{recepção; encontros realizados com o objetivo de estabelecer contatos e promover oportunidades}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{招待员}{8,9,7}{⼿,⼻,⼝}
  \begin{Phonetics}{招待员}{zhao1dai4 yuan2}[][HSK 5]
    \definition[名,位,个]{s.}{recepcionista; porteiro | atendente; pessoal de serviço}
  \synonymref{服务员}{fu2wu4yuan2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{招标}{8,9}{⼿,⽊}
  \begin{Phonetics}{招标}{zhao1//biao1}[][HSK 7-9]
...
\begin{Entry}{招募}{8,12}{⼿,⼒}
  \begin{Phonetics}{招募}{zhao1mu4}[][HSK 7-9]
...
\begin{Entry}{招揽}{8,12}{⼿,⼿}
  \begin{Phonetics}{招揽}{zhao1lan3}[][HSK 7-9]
...
\begin{Entry}{招牌}{8,12}{⼿,⽚}
  \begin{Phonetics}{招牌}{zhao1pai5}[][HSK 7-9]
    \definition[块]{s.}{placa de loja; letreiro; as placas com o nome da loja penduradas na frente de lojas, restaurantes, etc. | honra; reputação; fachada enganosa}
  \synonymref{商标}{shang1biao1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{招数}{8,13}{⼿,⽁}
  \begin{Phonetics}{招数}{zhao1shu4}[][HSK 7-9]
...
\begin{Entry}{招聘}{8,13}{⼿,⽿}
  ...
  \antonymref{应聘}{ying4pin4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{招聘广告}{8,13,3,7}{⼿,⽿,⼴,⼝}
  \begin{Phonetics}{招聘广告}{zhao1pin4 guang3gao4}[][HSK 5]
    \definition[则]{s.}{anúncio de vaga de emprego; anúncios de recrutamento são utilizados principalmente para divulgar informações sobre contratações e devem oferecer aos candidatos um meio de obter mais detalhes}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{招聘者}{8,13,8}{⼿,⽿,⽼}
  \begin{Phonetics}{招聘者}{zhao1pin4 zhe3}[][HSK 5]
    \definition{s.}{recrutador; anunciante de vagas; potencial empregador; profissionais responsáveis pelo recrutamento}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{拥有}{8,6}{⼿,⽉}
  ...
  \seealsoref{具有}{ju4you3}
  \seealsoref{有}{you3}
  \synonymref{持有}{chi2you3}
  \synonymref{富有}{fu4you3}
...
\begin{Entry}{拥护}{8,7}{⼿,⼿}
  \begin{Phonetics}{拥护}{yong1hu4}[][HSK 7-9]
...
\begin{Entry}{拥抱}{8,8}{⼿,⼿}
  \begin{Phonetics}{拥抱}{yong1bao4}[][HSK 5]
    ...
    \definition{v.}{abraçar; aconchegar; segurar nos braços}
  \seealsoref{抱}{bao4}
  \synonymref{依偎}{yi1wei1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{拥挤}{8,9}{⼿,⼿}
  \begin{Phonetics}{拥挤}{yong1ji3}[][HSK 7-9]
...
\begin{Entry}{拨转}{8,8}{⼿,⾞}
  \begin{Phonetics}{拨转}{bo1zhuan3}
    \definition{v.}{virar"-se; dar a volta; virar; dar meia"-volta | transferir (fundos etc.)}
  \synonymref{掉转}{diao4zhuan3}
  \synonymref{转动}{zhuan4dong4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{拨通}{8,10}{⼿,⾡}
  \begin{Phonetics}{拨通}{bo1tong1}[][HSK 7-9]
    \definition{v.}{discar (os números de um telefone, etc.)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{拨款}{8,12}{⼿,⽋}
  \begin{Phonetics}{拨款}{bo1//kuan3}[][HSK 7-9]
    \definition[项,笔]{s.}{dinheiro apropriado; apropriação; subsídio financeiro do estado; alocação de fundos; financiamento alocado}
    \definition{v.+compl.}{apropriar"-se de dinheiro; alocar fundos}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{放下}{8,3}{⽅,⼀}
  ...
  \synonymref{搁置}{ge1zhi4}
  \synonymref{容纳}{rong2na4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{放大}{8,3}{⽅,⼤}
  ...
  \synonymref{夸大}{kua1da4}
  \synonymref{扩大}{kuo4da4}
  \synonymref{膨胀}{peng2zhang4}
  \synonymref{拓宽}{tuo4kuan1}
...
\begin{Entry}{放飞}{8,3}{⽅,⾶}
  \begin{Phonetics}{放飞}{fang4fei1}
    \definition{s.}{permitir (que aviões) decolar | soltar; libertar (pássaros) | permitir voar}
  \synonymref{起飞}{qi3fei1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{放心}{8,4}{⽅,⼼}
  ...
  \synonymref{省心}{sheng3//xin1}
  \antonymref{不安}{bu4'an1}
  \antonymref{操心}{cao1//xin1}
  \antonymref{担心}{dan1xin1}
  \antonymref{担忧}{dan1you1}
  \antonymref{顾虑}{gu4lv4}
...
\begin{Entry}{放出}{8,5}{⽅,⼐}
  \begin{Phonetics}{放出}{fang4chu1}
    \definition{v.}{liberar; expelir; emitir; descarregar; explodir; sangrar; borrifar; entrar em; exalar; enviar; escapar para; desengatar; extrair; ejetar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{放电}{8,5}{⽅,⽥}
  \begin{Phonetics}{放电}{fang4dian4}
    \definition{s.}{Física: descarga elétrica}
    \definition{v.}{Coloquial: atrair; seduzir}
  \antonymref{充电}{chong1//dian4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{放任}{8,6}{⽅,⼈}
  \begin{Phonetics}{放任}{fang4ren4}
    \definition{v.}{não interferir; dar liberdade de ação}
  \synonymref{罢休}{ba4xiu1}
  \synonymref{放弃}{fang4qi4}
  \synonymref{放肆}{fang4si4}
  \synonymref{放纵}{fang4zong4}
  \synonymref{停止}{ting2zhi3}
  \synonymref{纵容}{zong4rong2}
  \antonymref{操纵}{cao1zong4}
  \antonymref{督促}{du1cu4}
  \antonymref{杜绝}{du4jue2}
  \antonymref{干涉}{gan1she4}
  \antonymref{呵护}{he1hu4}
  \antonymref{控制}{kong4zhi4}
  \antonymref{审核}{shen3he2}
...
\begin{Entry}{放在眼里}{8,6,11,7}{⽅,⼟,⽬,⾥}
  \begin{Phonetics}{放在眼里}{fang4 zai4 yan3 li3}[][HSK 5]
    \definition{v.}{atribuir importância a | importar"-se com | prestar atenção a}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{放弃}{8,7}{⽅,⼶}
  ...
  \seealsoref{丢掉}{diu1diao4}
  \synonymref{罢休}{ba4xiu1}
  \synonymref{丢弃}{diu1qi4}
  \synonymref{放下}{fang4xia4}
  \synonymref{抛弃}{pao1qi4}
  \synonymref{遗弃}{yi2qi4}
  \antonymref{保持}{bao3chi2}
  \antonymref{保存}{bao3cun2}
  \antonymref{保留}{bao3liu2}
  \antonymref{采用}{cai3yong4}
  \antonymref{打算}{da3suan5}
  \antonymref{坚持}{jian1chi2}
  \antonymref{坚守}{jian1shou3}
  \antonymref{始终}{shi3zhong1}
  \antonymref{争取}{zheng1qu3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{放弃权利}{8,7,6,7}{⽅,⼶,⽊,⼑}
  \begin{Phonetics}{放弃权利}{fang4qi4 quan2li4}
    \definition{s.}{renúncia de direitos}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{放弃者}{8,7,8}{⽅,⼶,⽼}
  \begin{Phonetics}{放弃者}{fang4qi4 zhe3}
    \definition{s.}{desistente; abandonador}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{放走}{8,7}{⽅,⾛}
  \begin{Phonetics}{放走}{fang4zou3}
    \definition{v.}{libertar; soltar; deixar ir; refere"-se a uma corrida em ritmo acelerado; liberar alguém de maiores responsabilidades}
  \synonymref{放过}{fang4guo4}
  \synonymref{释放}{shi4fang4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{放学}{8,8}{⽅,⼦}
  ...
  \synonymref{下课}{xia4//ke4}
  \antonymref{上学}{shang4xue2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{放松}{8,8}{⽅,⽊}
  ...
  \seealsoref{轻松}{qing1song1}
  \synonymref{减弱}{jian3ruo4}
  \synonymref{松弛}{song1chi2}
  \antonymref{加紧}{jia1jin3}
  \antonymref{加强}{jia1qiang2}
  \antonymref{紧张}{jin3zhang1}
  \antonymref{警惕}{jing3ti4}
  \antonymref{严格}{yan2ge2}
  \antonymref{抓紧}{zhua1//jin3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{放养}{8,9}{⽅,⼋}
  \begin{Phonetics}{放养}{fang4yang3}
    \definition{v.}{criar (aves, gado, etc.) fora dos currais; criar ao ar livre | criar (peixes, insetos, etc.) em local adequado; cultivar | soltar animais selvagens (criados em cativeiro) em um ambiente selvagem limitado; reabilitar | colocar (peixes, etc.) em um local adequado para reprodução; repovoar}
...
\begin{Entry}{放鞭炮}{8,18,9}{⽅,⾰,⽕}
  \begin{Phonetics}{放鞭炮}{fang4bian1pao4}
    \definition{v.}{soltar fogos de artifício, para celebrar ou comemorar uma ocasião especial ou festival}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{明天}{8,4}{⽇,⼤}
  ...
  \synonymref{次日}{ci4ri4}
  \synonymref{将来}{jiang1lai2}
  \synonymref{明日}{ming2ri4}
  \synonymref{未来}{wei4lai2}
  \antonymref{过去}{guo4qu4}
  \antonymref{今天}{jin1tian1}
  \antonymref{昨日}{zuo2ri4}
...
\begin{Entry}{明信片}{8,9,4}{⽇,⼈,⽚}
  \begin{Phonetics}{明信片}{ming2xin4pian4}[][HSK 5]
    \definition[张,套]{s.}{cartão"-postal; folha de papel rígido fornecida pelos correios para escrever cartas, com o porte postal incluído}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{明星}{8,9}{⽇,⽇}
  ...
  \synonymref{星星}{xing1xing5}
  \synonymref{艺人}{yi4ren2}
  \synonymref{影星}{ying3xing1}
  \antonymref{普通人}{pu3tong1ren2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{明珠}{8,10}{⽇,⽟}
  \begin{Phonetics}{明珠}{ming2zhu1}
    \definition[方]{s.}{pérola brilhante; joia; pessoas queridas ou coisas belas | Figurativo: a menina dos olhos; aquilo que é mais precioso}
  \synonymref{宝石}{bao3shi2}
  \synonymref{珍珠}{zhen1zhu1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{易拉罐}{8,8,23}{⽇,⼿,⽸}
  \begin{Phonetics}{易拉罐}{yi4la1guan4}[][HSK 7-9]
...
\begin{Entry}{服从}{8,4}{⽉,⼈}
  ...
  \antonymref{反抗}{fan3kang4}
  \antonymref{吩咐}{fen1fu4}
  \antonymref{抗拒}{kang4ju4}
  \antonymref{违背}{wei2bei4}
  \antonymref{违反}{wei2fan3}
  \antonymref{挣扎}{zheng1zha2}
  \antonymref{指挥}{zhi3hui1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{服务}{8,5}{⽉,⼒}
  ...
  \synonymref{办事}{ban4//shi4}
  \synonymref{任职}{ren4//zhi2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{服务人员}{8,5,2,7}{⽉,⼒,⼈,⼝}
  \begin{Phonetics}{服务人员}{fu2wu4 ren2yuan2}[][HSK 5]
    \definition{s.}{pessoal de serviço; equipe de serviço}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{服务对象}{8,5,5,11}{⽉,⼒,⼨,⾗}
  \begin{Phonetics}{服务对象}{fu2wu4 dui4xiang4}[][HSK 5]
    \definition{s.}{público"-alvo; destinatário do serviço; cliente}[我们的服务对象是学生。===Nosso serviço é voltado para estudantes.]
  \end{Phonetics}
\end{Entry}

\begin{Entry}{服务员}{8,5,7}{⽉,⼒,⼝}
  \begin{Phonetics}{服务员}{fu2wu4yuan2}[][HSK 5]
  ...
  \synonymref{招待员}{zhao1dai4 yuan2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{服装}{8,12}{⽉,⾐}
  ...
  \seealsoref{衣服}{yi1fu5}
  \synonymref{服饰}{fu2shi4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{服装杂志}{8,12,6,7}{⽉,⾐,⽊,⼼}
  \begin{Phonetics}{服装杂志}{fu2zhuang1 za2zhi4}[][HSK 5]
    \definition{s.}{revista de moda}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{服装设计师}{8,12,6,4,6}{⽉,⾐,⾔,⾔,⼱}
  \begin{Phonetics}{服装设计师}{fu2zhuang1 she4ji4 shi1}[][HSK 5]
    \definition{s.}{profissionais de design de moda}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{服装供应商}{8,12,8,7,11}{⽉,⾐,⼈,⼴,⼝}
  \begin{Phonetics}{服装供应商}{fu2zhuang1 gong1ying4 shang1}[][HSK 5]
    \definition{s.}{fornecedor de vestuário}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{服装柜台}{8,12,8,5}{⽉,⾐,⽊,⼝}
  \begin{Phonetics}{服装柜台}{fu2zhuang1 gui4tai2}[][HSK 5]
    \definition{s.}{balcão de roupas}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{服装超市}{8,12,12,5}{⽉,⾐,⾛,⼱}
  \begin{Phonetics}{服装超市}{fu2zhuang1 chao1shi4}[][HSK 5]
    \definition{s.}{loja de roupas; supermercado de roupas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{杯具}{8,8}{⽊,⼋}
  \begin{Phonetics}{杯具}{bei1ju4}
    \definition{s.}{Gíria: (trocadilho com 悲剧) tão ruim | desapontamento | xícara | desastre | fiasco}
  \seealsoref{悲剧}{bei1ju4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{杰出}{8,5}{⽊,⼐}
  ...
  \synonymref{出色}{chu1se4}
  \synonymref{非凡}{fei1fan2}
  \synonymref{空前}{kong1qian2}
  \synonymref{突出}{tu1chu1}
...
\begin{Entry}{松木}{8,4}{⽊,⽊}
  \begin{Phonetics}{松木}{song1mu4}
    \definition{s.}{madeira de pinho; pinho; lariço}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{板块}{8,7}{⽊,⼟}
  \begin{Phonetics}{板块}{ban3kuai4}[][HSK 7-9]
    \definition[个]{s.}{placa tectônica; segmentos móveis da crosta terrestre | seção; combinação de partes que têm algo em comum ou conectado}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{枕头}{8,5}{⽊,⼤}
  \begin{Phonetics}{枕头}{zhen3tou5}[][HSK 7-9]
...
\begin{Entry}{果实}{8,8}{⽊,⼧}
  \begin{Phonetics}{果实}{guo3shi2}[][HSK 4]
    \definition[种]{s.}{fruta; o órgão que se desenvolve a partir do ovário ou com outras partes da flor após a fertilização da flor | ganhos; frutos; conquista ou recompensa por trabalho árduo}
  \synonymref{成果}{cheng2guo3}
  \synonymref{果子}{guo3zi5}
  \synonymref{收获}{shou1huo4}
  \synonymref{硕果}{shuo4guo3}
  \antonymref{失败}{shi1bai4}
  \antonymref{损失}{sun3shi1}
  \antonymref{种子}{zhong3zi5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{果酱}{8,13}{⽊,⾣}
  \begin{Phonetics}{果酱}{guo3jiang4}[][HSK 6]
    \definition[瓶]{s.}{geléia | compota ou doce (de frutas); fruta em conserva}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 枣 %%%%%%%%%%
\subsection*{枣}\addcontentsline{loh}{figure}{枣}

\begin{Entry}{枣}{8}{⽊}
  \begin{Phonetics}{枣}{zao3}[][HSK 7-9]
...
\begin{Entry}{枫叶}{8,5}{⽊,⼝}
  \begin{Phonetics}{枫叶}{feng1ye4}
    \definition{s.}{folhas de liquidâmbar chinês, bordo, etc., que ficam vermelhas no outono | folha de bordo (maple, tipo de árvore)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{欣欣向荣}{8,8,6,9}{⽋,⽋,⼝,⾋}
  \begin{Phonetics}{欣欣向荣}{xin1xin1-xiang4rong2}[][HSK 7-9]
...
\begin{Entry}{欣喜}{8,12}{⽋,⼝}
  \begin{Phonetics}{欣喜}{xin1xi3}[][HSK 7-9]
...
\begin{Entry}{欣赏}{8,12}{⽋,⾙}
  ...
  \seealsoref{观赏}{guan1shang3}
  \seealsoref{喜欢}{xi3huan5}
  \synonymref{鉴赏}{jian4shang3}
...
\begin{Entry}{欣慰}{8,15}{⽋,⼼}
  \begin{Phonetics}{欣慰}{xin1wei4}[][HSK 7-9]
...
\begin{Entry}{欧体}{8,7}{⽋,⼈}
  \begin{Phonetics}{欧体}{ou1ti3}
    \definition*{s.}{Estilo de Caligrafia Ouyang, criado por Ouyang Xun (欧阳询) da Dinastia Tang}
  \seealsoref{欧阳询}{ou1yang2 xun2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{欧罗巴洲}{8,8,4,9}{⽋,⽹,⼰,⽔}
  \begin{Phonetics}{欧罗巴洲}{ou1luo2ba1zhou1}
    \definition{s.}{Europa; Continente Europeu}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{欧洲}{8,9}{⽋,⽔}
  \begin{Phonetics}{欧洲}{ou1zhou1}
    \definition*{s.}{Europa, abreviação de}
  \seealsoref{欧罗巴洲}{ou1luo2ba1zhou1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{欧洲共同体}{8,9,6,6,7}{⽋,⽔,⼋,⼝,⼈}
  \begin{Phonetics}{欧洲共同体}{ou1zhou1gong4tong2ti3}
...
\begin{Entry}{武士}{8,3}{⽌,⼠}
  \begin{Phonetics}{武士}{wu3shi4}
    \definition{s.}{Arcaico: guarda do palácio | Obsoleto: homem de bravura; guerreiro; cavaleiro | (no Japão) samurai}
  \synonymref{军人}{jun1ren2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{武艺}{8,4}{⽌,⾋}
  \begin{Phonetics}{武艺}{wu3yi4}
    \definition{s.}{habilidade em wushu; habilidade em artes marciais | artes marciais | habilidade militar}
...
\begin{Entry}{武术爱好者}{8,5,10,6,8}{⽌,⽊,⽖,⼥,⽼}
  \begin{Phonetics}{武术爱好者}{wu3shu4 ai4hao4 zhe3}[][HSK 5]
    \definition{s.}{entusiasta de artes marciais}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{武断}{8,11}{⽌,⽄}
  \begin{Phonetics}{武断}{wu3duan4}
    \definition{adj.}{assertivo; arbitrário; subjetivo; dogmático; despótico}
    \definition{v.}{fazer julgamentos baseados unicamente em opiniões subjetivas}
  \synonymref{果断}{guo3duan4}
  \synonymref{疏忽}{shu1hu5}
  \antonymref{谨慎}{jin3shen4}
  \antonymref{考虑}{kao3lv4}
  \antonymref{讨论}{tao3lun4}
...
\begin{Entry}{河}{8}{⽔}
  ...
  \seealsoref{河流}{he2liu2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{河北}{8,5}{⽔,⼔}
  \begin{Phonetics}{河北}{he2bei3}
    \definition*{s.}{Província de Hebei no norte da China, circundando Pequim (); nome abreviado: 冀; capital: Shijiazhuang (石家庄)}
  \seealsoref{冀}{ji4}
  \seealsoref{石家庄}{shi2jia1zhuang1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{河蚌}{8,10}{⽔,⾍}
  \begin{Phonetics}{河蚌}{he2bang4}
    \definition{s.}{mexilhão de água doce; amêijoa | bivalves que crescem em rios e lagos | mexilhões}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{沸腾}{8,13}{⽔,⾁}
  \begin{Phonetics}{沸腾}{fei4teng2}[][HSK 7-9]
    \definition{v.}{ferver; vaporizar | fervilhar de excitação; alto astral ou vozes barulhentas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{油画}{8,8}{⽔,⽥}
  \begin{Phonetics}{油画}{you2hua4}[][HSK 7-9]
...
\begin{Entry}{油炸食品}{8,9,9,9}{⽔,⽕,⾷,⼝}
  \begin{Phonetics}{油炸食品}{you2 zha2 shi2pin3}[][HSK 5]
    \definition{s.}{alimento frito por imersão}[油炸食品最易伤人。===Alimentos fritos em imersão são os mais prejudiciais à saúde.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{治学}{8,8}{⽔,⼦}
  \begin{Phonetics}{治学}{zhi4xue2}[][HSK 7-9]
...
\begin{Entry}{治愈}{8,13}{⽔,⼼}
  \begin{Phonetics}{治愈}{zhi4yu4}[][HSK 7-9]
...
%%%%%%%%%% 沼 %%%%%%%%%%
\subsection*{沼}\addcontentsline{loh}{figure}{沼}

\begin{Entry}{沼}{8}{⽔}
  \begin{Phonetics}{沼}{zhao3}
    \definition{s.}{pântano; charco; lagoa natural; piscina natural}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{沼泽}{8,8}{⽔,⽔}
  \begin{Phonetics}{沼泽}{zhao3ze2}[][HSK 7-9]
...
%%%%%%%%%% 沾 %%%%%%%%%%
\subsection*{沾}\addcontentsline{loh}{figure}{沾}

\begin{Entry}{沾}{8}{⽔}
  \begin{Phonetics}{沾}{zhan1}
...
\begin{Entry}{沾光}{8,6}{⽔,⼉}
  \begin{Phonetics}{沾光}{zhan1//guang1}[][HSK 7-9]
...
\begin{Entry}{沿海}{8,10}{⽔,⽔}
  ...
  \synonymref{滨海}{bin1hai3}
  \synonymref{海滨}{hai3bin1}
  \synonymref{沿岸}{yan2'an4}
  \antonymref{内地}{nei4di4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{沿途}{8,10}{⽔,⾡}
  \begin{Phonetics}{沿途}{yan2tu2}[][HSK 7-9]
...
\begin{Entry}{泄}{8}{⽔}
  \begin{Phonetics}{泄}{xie4}[][HSK 7-9]
...
\begin{Entry}{泄气}{8,4}{⽔,⽓}
  \begin{Phonetics}{泄气}{xie4//qi4}[][HSK 7-9]
...
\begin{Entry}{泄密}{8,11}{⽔,⼧}
  \begin{Phonetics}{泄密}{xie4//mi4}[][HSK 7-9]
...
\begin{Entry}{泄漏}{8,14}{⽔,⽔}
  \begin{Phonetics}{泄漏}{xie4lou4}[][HSK 7-9]
    \definition{v.}{vazar; vazamentos de líquidos, gases, etc., através de buracos, rachaduras, etc. | divulgar; descreve o vazamento acidental de (informações secretas, etc.)}
...
\begin{Entry}{泄露}{8,21}{⽔,⾬}
  \begin{Phonetics}{泄露}{xie4lou4}[][HSK 7-9]
...
\begin{Entry}{法令}{8,5}{⽔,⼈}
  \begin{Phonetics}{法令}{fa3ling4}
    \definition[项,条,部]{s.}{decreto; leis e decretos | ordem; estatutos; termo geral para ordens, instruções, decisões, etc., emitidas por órgãos governamentais}
  \seealsoref{法律}{fa3lv4}
  \synonymref{法规}{fa3gui1}
  \synonymref{法则}{fa3ze2}
  \synonymref{规则}{gui1ze2}
  \synonymref{规章}{gui1zhang1}
  \synonymref{条例}{tiao2li4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{法则}{8,6}{⽔,⼑}
  \begin{Phonetics}{法则}{fa3ze2}
    \definition{s.}{regra; padrão; leis e regulamentos}
  \seealsoref{法规}{fa3gui1}
  \synonymref{道理}{dao4li3}
...
\begin{Entry}{法网}{8,6}{⽔,⽹}
  \begin{Phonetics}{法网}{fa3wang3}
    ...
    \definition{s.}{a rede da justiça; o longo braço da lei; o processo rigoroso da lei}
...
\begin{Entry}{法国人}{8,8,2}{⽔,⼞,⼈}
  \begin{Phonetics}{法国人}{fa3guo2ren2}
    \definition[个,位,名]{s.}{francês | pessoa ou povo da França}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{法规}{8,8}{⽔,⾒}
  ...
  \seealsoref{法则}{fa3ze2}
  \synonymref{法令}{fa3ling4}
  \synonymref{法律}{fa3lv4}
  \synonymref{规则}{gui1ze2}
  \synonymref{规矩}{gui1ju5}
  \synonymref{条例}{tiao2li4}
...
\begin{Entry}{泡}{8}{⽔}
  ...
  \begin{Phonetics}{泡}{pao4}[][HSK 6]
    ...
    \definition{v.}{mergulhar; encharcar | despejar água fervente em (chá, sopa instantânea, etc.) | enrolar; demorar"-se; ficar por aí | Coloquial: (um homem) brincar no campo; brincar com uma mulher | perder tempo; matar o tempo deliberadamente}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{泡沫}{8,8}{⽔,⽔}
  \begin{Phonetics}{泡沫}{pao4mo4}[][HSK 7-9]
    \definition{s.}{espuma; pequenas bolhas se aglomeraram na superfície do líquido | ilusão; bolha econômica; descreve a prosperidade superficial e o florescimento de algo que, na realidade, é vazio e irreal}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{波}{8}{⽔}
  \begin{Phonetics}{波}{bo1}
    ...
    \definition{s.}{ondas, a superfície irregular da água em rios, lagos e oceanos | onda, o processo de propagação da vibração | mudanças inesperadas; uma reviravolta inesperada nos acontecimentos; metáfora para mudanças inesperadas nas coisas | olhos; olhar errante}
...
\begin{Entry}{波浪}{8,10}{⽔,⽔}
  ...
  \synonymref{波澜}{bo1lan2}
  \synonymref{波涛}{bo1tao1}
  \synonymref{海浪}{hai3lang4}
  \synonymref{浪花}{lang4hua1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{注}{8}{⽔}
  \begin{Phonetics}{注}{zhu4}[][HSK 7-9]
...
\begin{Entry}{注入}{8,2}{⽔,⼊}
  \begin{Phonetics}{注入}{zhu4ru4}[][HSK 7-9]
...
\begin{Entry}{注册人}{8,5,2}{⽔,⼌,⼈}
  \begin{Phonetics}{注册人}{zhu4ce4 ren2}
    \definition{s.}{registrante; requerente; interessado}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{注定}{8,8}{⽔,⼧}
  \begin{Phonetics}{注定}{zhu4ding4}[][HSK 7-9]
...
\begin{Entry}{注视}{8,8}{⽔,⾒}
  ...
  \synonymref{直视}{zhi2shi4}
  \synonymref{瞩目}{zhu3mu4}
...
\begin{Entry}{注意力缺失症}{8,13,2,10,5,10}{⽔,⼼,⼒,⽸,⼤,⽧}
  \begin{Phonetics}{注意力缺失症}{zhu4yi4li4 que1shi1 zheng4}
...
\begin{Entry}{注意地}{8,13,6}{⽔,⼼,⼟}
  \begin{Phonetics}{注意地}{zhu4yi4 di4}
...
\begin{Entry}{泳池}{8,6}{⽔,⽔}
  ...
  \seealsoref{游泳馆}{you2yong3 guan3}
...
\begin{Entry}{泳衣}{8,6}{⽔,⾐}
  \begin{Phonetics}{泳衣}{yong3yi1}
    \definition[件,个]{s.}{roupa de banho; maiô; traje de banho}
  \seealsoref{游泳衣}{you2yong3yi1}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 泻 %%%%%%%%%%
\subsection*{泻}\addcontentsline{loh}{figure}{泻}

\begin{Entry}{泻}{8}{⽔}
  \begin{Phonetics}{泻}{xie4}[][HSK 7-9]
...
\begin{Entry}{泼冷水}{8,7,4}{⽔,⼎,⽔}
  \begin{Phonetics}{泼冷水}{po1leng3shui3}[][HSK 7-9]
...
\begin{Entry}{爬行}{8,6}{⽖,⾏}
  \begin{Phonetics}{爬行}{pa2xing2}
    \definition{v.}{rastejar; engatinhar | trabalhar de forma lenta; arrastar os pés; alguém que se apega aos métodos antigos e trabalha lentamente}
  \antonymref{站立}{zhan4li4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{爸妈}{8,6}{⽗,⼥}
  \begin{Phonetics}{爸妈}{ba4ma1}
    \definition{s.}{pais; ambos os pais; pai e mãe}[爸妈每天都很辛苦工作。===Meus pais trabalham muito todos os dias.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{爸爸}{8,8}{⽗,⽗}
  ...
  \seealsoref{爸}{ba4}
  \seealsoref{父亲}{fu4qin1}
  \antonymref{妈妈}{ma1ma5}
  \antonymref{母亲}{mu3qin1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{牦牛}{8,4}{⽜,⽜}
  \begin{Phonetics}{牦牛}{mao2niu2}
    \definition{s.}{iaque (\emph{Bos Grunniens})}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{物理}{8,11}{⽜,⽟}
  \begin{Phonetics}{物理}{wu4li3}
    \definition[对]{s.}{lógica; os princípios e leis das coisas | física, abreviação de 物理学, é uma disciplina fundamental das ciências naturais}
  \seealsoref{物理学}{wu4li3xue2}
  \antonymref{充电}{chong1//dian4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{物理学}{8,11,8}{⽜,⽟,⼦}
  \begin{Phonetics}{物理学}{wu4li3xue2}
    \definition[门]{s.}{física; disciplina fundamental nas ciências naturais, incluindo acústica, termodinâmica, magnetismo, óptica, física atômica, etc.}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{玩伴}{8,7}{⽟,⼈}
  \begin{Phonetics}{玩伴}{wan2ban4}
    \definition{s.}{companheiro de brincadeiras}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{玩具车}{8,8,4}{⽟,⼋,⾞}
  \begin{Phonetics}{玩具车}{wan2ju4che1}
    \definition{s.}{carrinho de brinquedo}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{玩具生产商}{8,8,5,6,11}{⽟,⼋,⽣,⼇,⼝}
  \begin{Phonetics}{玩具生产商}{wan2ju4 sheng1chan3 shang1}[][HSK 5]
    \definition{s.}{fabricante de brinquedos}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{玩具柜台}{8,8,8,5}{⽟,⼋,⽊,⼝}
  \begin{Phonetics}{玩具柜台}{wan2ju4 gui4tai2}[][HSK 5]
    \definition{s.}{balcão de brinquedos}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{玩味}{8,8}{⽟,⼝}
  \begin{Phonetics}{玩味}{wan2wei4}
    \definition{v.}{ponderar; ruminar; contemplar}
...
\begin{Entry}{玩家}{8,10}{⽟,⼧}
  \begin{Phonetics}{玩家}{wan2jia1}
    \definition{s.}{jogador (de um jogo) | entusiasta; pessoas que são apaixonadas, proficientes e particularmente fascinadas por certas atividades (como colecionar, jogar videogames, etc.)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{玩偶}{8,11}{⽟,⼈}
  \begin{Phonetics}{玩偶}{wan2'ou3}
    \definition{s.}{brinquedo; figura de ação; boneca; brinquedos em forma humana feitos de tecido, madeira, argila, plástico, etc.}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{玩遍}{8,12}{⽟,⾡}
  \begin{Phonetics}{玩遍}{wan2bian4}
    \definition{v.}{fazer um tour (por todo o país, toda a cidade etc.) | visitar (um grande número de lugares)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{玩意}{8,13}{⽟,⼼}
  \begin{Phonetics}{玩意}{wan2yi4}
    \definition[个]{s.}{brinquedo; objeto de diversão | coisa; objeto | truque (em uma apresentação, espetáculo de palco, acrobacia etc.); refere"-se às artes folclóricas, acrobacias, etc. | alguém sendo menosprezado; ao se referir a uma pessoa, carrega um tom de desprezo}
  \synonymref{玩艺}{wan2yi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{环保}{8,9}{⽟,⼈}
  ...
  \synonymref{低碳}{di1tan4}
  \synonymref{环卫}{huan2wei4}
  \synonymref{节能}{jie2neng2}
  \synonymref{绿色}{lv4se4}
  \antonymref{破坏}{po4huai4}
...
\begin{Entry}{环境}{8,14}{⽟,⼟}
  ...
  \synonymref{境地}{jing4di4}
  \synonymref{境遇}{jing4yu4}
...
\begin{Entry}{环境专家}{8,14,4,10}{⽟,⼟,⼀,⼧}
  \begin{Phonetics}{环境专家}{huan2jing4 zhuan1jia1}[][HSK 5]
    \definition{s.}{especialista em meio ambiente}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{现代}{8,5}{⾒,⼈}
  ...
  \seealsoref{当代}{dang1dai4}
  \synonymref{新颖}{xin1ying3}
  \antonymref{传统}{chuan2tong3}
  \antonymref{古代}{gu3dai4}
  \antonymref{古典}{gu3dian3}
  \antonymref{古老}{gu3lao3}
  \antonymref{上古}{shang4gu3}
  \antonymref{原始}{yuan2shi3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{现代人}{8,5,2}{⾒,⼈,⼈}
  \begin{Phonetics}{现代人}{xian4dai4 ren2}[][HSK 5]
    \definition{s.}{\emph{homo sapiens}; refere"-se a indivíduos que, sob a influência de modos de produção modernos, desenvolveram atitudes modernas em relação à vida, valores e formas de comportamento | o homem moderno}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{现出}{8,5}{⾒,⼐}
  \begin{Phonetics}{现出}{xian4//chu1}
...
\begin{Entry}{现任}{8,6}{⾒,⼈}
  \begin{Phonetics}{现任}{xian4ren4}[][HSK 7-9]
...
\begin{Entry}{现场}{8,6}{⾒,⼟}
  ...
  \synonymref{当场}{dang1chang3}
  \synonymref{实地}{shi2di4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{现成}{8,6}{⾒,⼽}
  \begin{Phonetics}{现成}{xian4cheng2}[][HSK 7-9]
...
\begin{Entry}{现行}{8,6}{⾒,⾏}
  \begin{Phonetics}{现行}{xian4xing2}[][HSK 7-9]
...
\begin{Entry}{现实}{8,8}{⾒,⼧}
  ...
  \seealsoref{实际}{shi2ji4}
  \seealsoref{现状}{xian4zhuang4}
  \synonymref{事实}{shi4shi2}
  \antonymref{幻想}{huan4xiang3}
  \antonymref{空想}{kong1xiang3}
  \antonymref{浪漫}{lang4man4}
  \antonymref{理想}{li3xiang3}
  \antonymref{梦幻}{meng4huan4}
  \antonymref{梦想}{meng4xiang3}
  \antonymref{妄想}{wang4xiang3}
  \antonymref{虚幻}{xu1huan4}
  \antonymref{虚拟}{xu1ni3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{现实主义者}{8,8,5,3,8}{⾒,⼧,⼂,⼂,⽼}
  \begin{Phonetics}{现实主义者}{xian4shi2 zhu3yi4 zhe3}[][HSK 5]
    \definition{s.}{realista}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{现象}{8,11}{⾒,⾗}
  ...
  \synonymref{迹象}{ji4xiang4}
  \synonymref{景象}{jing3xiang4}
  \synonymref{气象}{qi4xiang4}
...
\begin{Entry}{畅谈}{8,10}{⽥,⾔}
  \begin{Phonetics}{畅谈}{chang4//tan2}[][HSK 7-9]
    \definition{v.+compl.}{falar livremente e com entusiasmo; falar livremente e com satisfação; falar com entusiasmo sobre}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 疙 %%%%%%%%%%
\subsection*{疙}\addcontentsline{loh}{figure}{疙}

\begin{Entry}{疙}{8}{⽧}
  \begin{Phonetics}{疙}{ge1}
    \definition[个]{s.}{espinha | verruga}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{疙瘩}{8,14}{⽧,⽧}
  \begin{Phonetics}{疙瘩}{ge1da5}
...
\begin{Entry}{的士}{8,3}{⽩,⼠}
  \begin{Phonetics}{的士}{di1shi4}
    \definition[辆]{s.}{Empréstimo Linguístico: táxi}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{的确}{8,12}{⽩,⽯}
  ...
  \seealsoref{确实}{que4shi2}
  \synonymref{果然}{guo3ran2}
  \synonymref{简直}{jian3zhi2}
  \synonymref{切实}{qie4shi2}
  \synonymref{确切}{que4qie4}
...
\begin{Entry}{盲目}{8,5}{⽬,⽬}
  \begin{Phonetics}{盲目}{mang2mu4}[][HSK 7-9]
    \definition{adj.}{cego; sem rumo; descreve a falta de compreensão clara; consideração incompleta ou descuidada; objetivos pouco claros}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{直至}{8,6}{⽬,⾄}
  \begin{Phonetics}{直至}{zhi2zhi4}[][HSK 7-9]
...
\begin{Entry}{直观}{8,6}{⽬,⾒}
  \begin{Phonetics}{直观}{zhi2guan1}[][HSK 7-9]
...
\begin{Entry}{直达}{8,6}{⽬,⾡}
  \begin{Phonetics}{直达}{zhi2da2}[][HSK 7-9]
...
\begin{Entry}{直译}{8,7}{⽬,⾔}
  \begin{Phonetics}{直译}{zhi2yi4}
    \definition{s.}{tradução literal (ou palavra por palavra); refere"-se a uma tradução que prioriza o texto e as frases originais}
    \definition{v.}{traduzir literalmente}
...
\begin{Entry}{直到}{8,8}{⽬,⼑}
  ...
  \synonymref{等到}{deng3dao4}
  \synonymref{迄今}{qi4jin1}
  \synonymref{直至}{zhi2zhi4}
  \synonymref{终于}{zhong1yu2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{直奔}{8,8}{⽬,⼤}
  \begin{Phonetics}{直奔}{zhi2ben4}[][HSK 7-9]
...
\begin{Entry}{直径}{8,8}{⽬,⼻}
  \begin{Phonetics}{直径}{zhi2jing4}[][HSK 7-9]
...
\begin{Entry}{直线}{8,8}{⽬,⽷}
  ...
  \synonymref{坦白}{tan3bai2}
  \synonymref{直径}{zhi2jing4}
  \antonymref{间接}{jian4jie1}
  \antonymref{曲线}{qu1xian4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{直视}{8,8}{⽬,⾒}
  \begin{Phonetics}{直视}{zhi2shi4}[][HSK 7-9]
...
\begin{Entry}{直觉}{8,9}{⽬,⾒}
  \begin{Phonetics}{直觉}{zhi2jue2}[][HSK 7-9]
...
\begin{Entry}{空中}{8,4}{⽳,⼁}
  ...
  \synonymref{广播}{guang3bo1}
  \synonymref{天空}{tian1kong1}
  \synonymref{卫星}{wei4xing1}
  \antonymref{地面}{di4mian4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{空中小姐}{8,4,3,8}{⽳,⼁,⼩,⼥}
  \begin{Phonetics}{空中小姐}{kong1zhong1 xiao3jie3}
    \definition{s.}{aeromoça; comissária de bordo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{空气}{8,4}{⽳,⽓}
  ...
  \seealsoref{气氛}{qi4fen1}
  \synonymref{潮流}{chao2liu2}
  \synonymref{传言}{chuan2yan2}
  \synonymref{氛围}{fen1wei2}
  \synonymref{风气}{feng1qi4}
  \synonymref{风尚}{feng1shang4}
  \synonymref{氧气}{yang3qi4}
  \synonymref{谣言}{yao2yan2}
  \antonymref{传统}{chuan2tong3}
  \antonymref{真相}{zhen1xiang4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{空间}{8,7}{⽳,⾨}
  ...
  \synonymref{太空}{tai4kong1}
  \synonymref{宇宙}{yu3zhou4}
  \antonymref{时间}{shi2jian1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{空间站}{8,7,10}{⽳,⾨,⽴}
  \begin{Phonetics}{空间站}{kong1jian1zhan4}
    \definition{s.}{estação espacial | espaçoporto}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{空姐}{8,8}{⽳,⼥}
  ...
  \seealsoref{空中小姐}{kong1zhong1 xiao3jie3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{线条}{8,7}{⽷,⽊}
  \begin{Phonetics}{线条}{xian4tiao2}[][HSK 7-9]
...
\begin{Entry}{线索}{8,10}{⽷,⽷}
  \begin{Phonetics}{线索}{xian4suo3}[][HSK 5]
    \definition[条,个]{s.}{pista; fio; desenvolvimento das coisas ou a maneira de explorar um problema | fio; linha; refere"-se ao contexto de desenvolvimento do enredo em obras literárias}
  \synonymref{痕迹}{hen2ji4}
  \synonymref{脉络}{mai4luo4}
  \synonymref{思路}{si1lu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{组建}{8,8}{⽷,⼵}
  \begin{Phonetics}{组建}{zu3jian4}[][HSK 7-9]
...
\begin{Entry}{组织}{8,8}{⽷,⽷}
  \begin{Phonetics}{组织}{zu3zhi1}[][HSK 5]
    \definition[个,家]{s.}{organização; um coletivo ou grupo estabelecido de acordo com determinados objetivos e princípios | sistema organizado; vários fatores interligados de determinada maneira, formando um sistema | tecer; a combinação de linhas horizontais e verticais nos têxteis | tecido; os seres humanos, os animais, as plantas e outros seres vivos são compostos por uma combinação de células com formas e funções semelhantes, que formam os tecidos; os tecidos são as unidades que compõem os diversos órgãos}
  \seealsoref{组成}{zu3cheng2}
  \synonymref{布局}{bu4ju2}
  \synonymref{构造}{gou4zao4}
  \synonymref{机构}{ji1gou4}
  \synonymref{机关}{ji1guan1}
...
\begin{Entry}{组织者}{8,8,8}{⽷,⽷,⽼}
  \begin{Phonetics}{组织者}{zu3zhi1 zhe3}[][HSK 5]
    \definition{s.}{organizador; pessoa responsável pela organização}[他们举我为活动的组织者。===Eles me nomearam organizador do evento.]
  \end{Phonetics}
\end{Entry}

\begin{Entry}{组装}{8,12}{⽷,⾐}
  \begin{Phonetics}{组装}{zu3zhuang1}[][HSK 7-9]
...
\begin{Entry}{终生}{8,5}{⽷,⽣}
  \begin{Phonetics}{终生}{zhong1sheng1}[][HSK 7-9]
...
\begin{Entry}{终究}{8,7}{⽷,⽳}
  \begin{Phonetics}{终究}{zhong1jiu1}[][HSK 7-9]
...
\begin{Entry}{终身大事}{8,7,3,8}{⽷,⾝,⼤,⼅}
  \begin{Phonetics}{终身大事}{zhong1shen1 da4shi4}[][HSK 5]
    \definition{expr.}{``O evento mais importante da vida.''; ponto de virada crucial de importância para toda a vida (especialmente o casamento); assunto importante que diz respeito a toda a vida de uma pessoa; grande evento na vida de alguém (geralmente referindo"-se ao casamento)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{终点}{8,9}{⽷,⽕}
  ...
  \synonymref{尽头}{jin4tou2}
  \antonymref{起步}{qi3bu4}
  \antonymref{起点}{qi3dian3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{终结}{8,9}{⽷,⽷}
  \begin{Phonetics}{终结}{zhong1jie2}[][HSK 7-9]
...
\begin{Entry}{经历}{8,4}{⽷,⼚}
  ...
  \seealsoref{经验}{jing1yan4}
  \synonymref{经受}{jing1shou4}
  \synonymref{历经}{li4jing1}
...
\begin{Entry}{经过}{8,6}{⽷,⾡}
  ...
  \seealsoref{路过}{lu4guo4}
  \seealsoref{通过}{tong1guo4}
...
\begin{Entry}{经济部门}{8,9,10,3}{⽷,⽔,⾢,⾨}
  \begin{Phonetics}{经济部门}{jing1ji4 bu4men2}[][HSK 5]
    \definition{s.}{ramos da economia; serviço econômico | setor econômico}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{经费}{8,9}{⽷,⾙}
  \begin{Phonetics}{经费}{jing1fei4}[][HSK 5]
    \definition[笔]{s.}{fundos; orçamento; despesas incorridas por agências governamentais, escolas, etc.}
  \synonymref{费用}{fei4yong5}
  \synonymref{开销}{kai1xiao1}
  \synonymref{款项}{kuan3xiang4}
...
\begin{Entry}{经验}{8,10}{⽷,⾺}
  ...
  \seealsoref{经历}{jing1li4}
  \synonymref{教训}{jiao4xun5}
  \synonymref{体会}{ti3hui4}
  \synonymref{体验}{ti3yan4}
  \synonymref{阅历}{yue4li4}
  \antonymref{无知}{wu2zhi1}
...
\begin{Entry}{经理办公室}{8,11,4,4,9}{⽷,⽟,⼒,⼋,⼧}
  \begin{Phonetics}{经理办公室}{jing1li3 ban4gong1shi4}[][HSK 5]
    \definition{s.}{sala do gerente}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{经营者}{8,11,8}{⽷,⾋,⽼}
  \begin{Phonetics}{经营者}{jing1ying2 zhe3}[][HSK 5]
    \definition{s.}{executivo; refere"-se a uma pessoa que administra, opera ou organiza atividades comerciais | gerente | agente de transação}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 肢 %%%%%%%%%%
\subsection*{肢}\addcontentsline{loh}{figure}{肢}

\begin{Entry}{肢}{8}{⾁}
  \begin{Phonetics}{肢}{zhi1}
    \definition{s.}{membro; braços e pernas humanos; pernas de certos animais}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{肢体}{8,7}{⾁,⼈}
  \begin{Phonetics}{肢体}{zhi1ti3}[][HSK 7-9]
...
%%%%%%%%%% 肽 %%%%%%%%%%
\subsection*{肽}\addcontentsline{loh}{figure}{肽}

\begin{Entry}{肽}{8}{⾁}
  \begin{Phonetics}{肽}{tai4}
    \definition{s.}{Química: peptídeo, dois ou mais aminoácidos unidos por ligações peptídicas CO"-NH}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{肿瘤}{8,15}{⾁,⽧}
  \begin{Phonetics}{肿瘤}{zhong3liu2}[][HSK 7-9]
...
%%%%%%%%%% 胀 %%%%%%%%%%
\subsection*{胀}\addcontentsline{loh}{figure}{胀}

\begin{Entry}{胀}{8}{⾁}
  \begin{Phonetics}{胀}{zhang4}[][HSK 7-9]
...
\begin{Entry}{舍不得}{8,4,11}{⾆,⼀,⼻}
  ...
  \synonymref{离不开}{li2bu5kai1}
  \antonymref{舍得}{she3de5}
  \antonymref{无所谓}{wu2suo3wei4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{舍得}{8,11}{⾆,⼻}
  \begin{Phonetics}{舍得}{she3de5}[][HSK 5]
  ...
  \synonymref{慷慨}{kang1kai3}
  \synonymref{留恋}{liu2lian4}
  \synonymref{忍心}{ren3//xin1}
  \antonymref{小气}{xiao3qi5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{苦瓜}{8,5}{⾋,⽠}
  \begin{Phonetics}{苦瓜}{ku3gua1}
    \definition[张]{s.}{melão amargo (cabaça amarga, pêra bálsamo, maçã bálsamo, pepino amargo); melão"-de"-são"-caetano}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{苦练}{8,8}{⾋,⽷}
  \begin{Phonetics}{苦练}{ku3lian4}[][HSK 7-9]
...
\begin{Entry}{英国人}{8,8,2}{⾋,⼞,⼈}
  \begin{Phonetics}{英国人}{ying1guo2ren2}
    \definition[个,位,名]{s.}{inglês | pessoa ou povo do Reino Unido}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{英俊}{8,9}{⾋,⼈}
  \begin{Phonetics}{英俊}{ying1jun4}[][HSK 7-9]
...
\begin{Entry}{英雄}{8,12}{⾋,⾫}
  ...
  \antonymref{胆小鬼}{dan3xiao3gui3}
  \antonymref{小丑}{xiao3chou3}
  \antonymref{自私自利}{zi4si1-zi4li4}
  \antonymref{罪人}{zui4ren2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{英镑}{8,15}{⾋,⾦}
  \begin{Phonetics}{英镑}{ying1bang4}[][HSK 7-9]
...
\begin{Entry}{茅台}{8,5}{⾋,⼝}
  ...
  \seealsoref{茅台酒}{mao2tai2jiu3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{茅台酒}{8,5,10}{⾋,⼝,⾣}
  \begin{Phonetics}{茅台酒}{mao2tai2jiu3}
...
\begin{Entry}{虎口}{8,3}{⾌,⼝}
  \begin{Phonetics}{虎口}{hu3kou3}
    \definition{s.}{boca de tigre; mandíbulas da morte; lugar perigoso | parte da mão entre o polegar e o indicador}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{虎鼬}{8,18}{⾌,⿏}
  \begin{Phonetics}{虎鼬}{hu3 you4}
    \definition{s.}{doninha (mamífero)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{表白}{8,5}{⾐,⽩}
  \begin{Phonetics}{表白}{biao3//bai2}[][HSK 7-9]
    \definition{v.+compl.}{justificar; explicar"-se; expressar ou declarar claramente; explicar (as próprias intenções) aos outros}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{表示}{8,5}{⾐,⽰}
  ...
  \seealsoref{表达}{biao3da2}
  \synonymref{表白}{biao3//bai2}
...
\begin{Entry}{表决}{8,6}{⾐,⼎}
  \begin{Phonetics}{表决}{biao3//jue2}[][HSK 7-9]
    \definition{v.+compl.}{votar; colocar em votação; decidir por votação}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{表扬}{8,6}{⾐,⼿}
  ...
  \antonymref{批判}{pi1pan4}
  \antonymref{批评}{pi1ping2}
  \antonymref{谴责}{qian3ze2}
  \antonymref{投诉}{tou2su4}
  \antonymref{责备}{ze2bei4}
  \antonymref{制裁}{zhi4cai2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{表扬信}{8,6,9}{⾐,⼿,⼈}
  \begin{Phonetics}{表扬信}{biao3yang2xin4}
...
\begin{Entry}{表现}{8,8}{⾐,⾒}
  ...
  \seealsoref{体现}{ti3xian4}
  \synonymref{表示}{biao3shi4}
  \synonymref{呈现}{cheng2xian4}
  \synonymref{出现}{chu1xian4}
  \synonymref{浮现}{fu2xian4}
  \synonymref{显示}{xian3shi4}
  \synonymref{涌现}{yong3xian4}
...
\begin{Entry}{表情}{8,11}{⾐,⼼}
  ...
  \seealsoref{脸色}{lian3se4}
  \synonymref{神气}{shen2qi4}
  \synonymref{神情}{shen2qing2}
  \synonymref{神色}{shen2se4}
  \synonymref{神态}{shen2tai4}
...
\begin{Entry}{表演}{8,14}{⾐,⽔}
  \begin{Phonetics}{表演}{biao3yan3}[][HSK 3]
    ...
    \definition{v.}{atuar; representar; interpretar | demonstrar; fazer demonstrações | fingir; agir de forma afetada; fingir deliberadamente uma determinada atitude para enganar alguém}
  \seealsoref{演}{yan3}
  \seealsoref{演出}{yan3chu1}
  \synonymref{扮演}{ban4yan3}
  \synonymref{上演}{shang4yan3}
  \synonymref{演唱}{yan3chang4}
  \synonymref{演示}{yan3shi4}
  \synonymref{演绎}{yan3yi4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{表演艺术}{8,14,4,5}{⾐,⽔,⾋,⽊}
  \begin{Phonetics}{表演艺术}{biao3yan3yi4shu4}
    \definition*{s.}{Artes Cênicas}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{表演者}{8,14,8}{⾐,⽔,⽼}
  \begin{Phonetics}{表演者}{biao3yan3 zhe3}[][HSK 5]
...
\begin{Entry}{衬衣}{8,6}{⾐,⾐}
  ...
  \synonymref{衬衫}{chen4shan1}
  \antonymref{外套}{wai4tao4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{规则}{8,6}{⾒,⼑}
  \begin{Phonetics}{规则}{gui1ze2}[][HSK 4]
    ...
    \definition[条,项]{s.}{regra; regulamento; sistema ou código de conduta prescrito para observância comum | lei; norma}
  \seealsoref{规律}{gui1lv4}
  \seealsoref{规章}{gui1zhang1}
  \synonymref{法规}{fa3gui1}
  \synonymref{法令}{fa3ling4}
  \synonymref{法则}{fa3ze2}
  \synonymref{规定}{gui1ding4}
...
\begin{Entry}{规章}{8,11}{⾒,⾳}
  \begin{Phonetics}{规章}{gui1zhang1}
    \definition[项]{s.}{regulamento; refere"-se especificamente a documentos normativos relativos à gestão administrativa, formulados por órgãos administrativos estatais em conformidade com a lei | regra; regras e regulamentos}
  \seealsoref{规则}{gui1ze2}
  \synonymref{规定}{gui1ding4}
  \synonymref{准则}{zhun3ze2}
  \end{Phonetics}
...
\begin{Entry}{视频}{8,13}{⾒,⾴}
  ...
  \synonymref{电视}{dian4shi4}
  \synonymref{录像}{lu4//xiang4}
  \synonymref{影片}{ying3pian4}
  \synonymref{影像}{ying3xiang4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{诗句}{8,5}{⾔,⼝}
  \begin{Phonetics}{诗句}{shi1ju4}
    \definition[行]{s.}{verso; linha}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{诗词}{8,7}{⾔,⾔}
  \begin{Phonetics}{诗词}{shi1ci2}
    \definition{s.}{poesia e letras de música | verso}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{诗意}{8,13}{⾔,⼼}
  \begin{Phonetics}{诗意}{shi1yi4}
    \definition{s.}{poesia; qualidade ou sabor poético; uma bela concepção artística, como a expressa no poema}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{诚实}{8,8}{⾔,⼧}
  ...
  \antonymref{骗人}{pian4ren2}
  \antonymref{欺骗}{qi1pian4}
  \antonymref{欺诈}{qi1zha4}
  \antonymref{说谎}{shuo1//huang3}
  \antonymref{虚假}{xu1jia3}
  \antonymref{虚伪}{xu1wei3}
  \antonymref{诈骗}{zha4pian4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{诞生}{8,5}{⾔,⽣}
  ...
  \seealsoref{出生}{chu1sheng1}
  \synonymref{产生}{chan3sheng1}
  \synonymref{出现}{chu1xian4}
  \synonymref{兴起}{xing1qi3}
  \synonymref{形成}{xing2cheng2}
  \antonymref{灭亡}{mie4wang2}
  \antonymref{去世}{qu4shi4}
  \antonymref{逝世}{shi4shi4}
  \antonymref{死亡}{si3wang2}
  \antonymref{消失}{xiao1shi1}
  \antonymref{谢世}{xie4shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{询问}{8,6}{⾔,⾨}
  ...
  \seealsoref{提问}{ti2wen4}
  \synonymref{咨询}{zi1xun2}
  \antonymref{答复}{da2fu4}
...
\begin{Entry}{详尽}{8,6}{⾔,⼫}
  \begin{Phonetics}{详尽}{xiang2jin4}[][HSK 7-9]
...
\begin{Entry}{责任人}{8,6,2}{⾙,⼈,⼈}
  \begin{Phonetics}{责任人}{ze2ren4 ren2}[][HSK 5]
    \definition{s.}{coordenador; pessoa diretamente responsável por um trabalho ou tarefa específica | pessoa responsável}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{责备}{8,8}{⾙,⼡}
  \begin{Phonetics}{责备}{ze2bei4}[][HSK 7-9]
...
\begin{Entry}{责怪}{8,8}{⾙,⼼}
  \begin{Phonetics}{责怪}{ze2guai4}[][HSK 7-9]
    \definition{v.}{culpar}
  \synonymref{谴责}{qian3ze2}
...
\begin{Entry}{账号}{8,5}{⾙,⼝}
  \begin{Phonetics}{账号}{zhang4hao4}[][HSK 7-9]
...
\begin{Entry}{账单}{8,8}{⾙,⼗}
  \begin{Phonetics}{账单}{zhang4dan1}[][HSK 7-9]
...
\begin{Entry}{货物车厢}{8,8,4,11}{⾙,⽜,⾞,⼚}
  \begin{Phonetics}{货物车厢}{huo4wu4 che1xiang1}[][HSK 5]
    \definition{s.}{vagão de carga}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{质地}{8,6}{⾙,⼟}
  \begin{Phonetics}{质地}{zhi4di4}[][HSK 7-9]
...
\begin{Entry}{质朴}{8,6}{⾙,⽊}
  \begin{Phonetics}{质朴}{zhi4pu3}[][HSK 7-9]
...
\begin{Entry}{质问}{8,6}{⾙,⾨}
  \begin{Phonetics}{质问}{zhi4wen4}[][HSK 7-9]
...
\begin{Entry}{质疑}{8,14}{⾙,⽦}
  \begin{Phonetics}{质疑}{zhi4yi2}[][HSK 7-9]
...
\begin{Entry}{贫民窟}{8,5,13}{⾙,⽒,⽳}
  \begin{Phonetics}{贫民窟}{pin2min2ku1}
    \definition{s.}{habitações precárias; cortiços; favela}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{贫困}{8,7}{⾙,⼞}
  ...
  \antonymref{富强}{fu4qiang2}
  \antonymref{富有}{fu4you3}
  \antonymref{富裕}{fu4yu4}
  \antonymref{富足}{fu4zu2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{贫富}{8,12}{⾙,⼧}
  \begin{Phonetics}{贫富}{pin2fu4}[][HSK 7-9]
...
\begin{Entry}{贬值}{8,10}{⾙,⼈}
  \begin{Phonetics}{贬值}{bian3//zhi2}[][HSK 7-9]
    \definition{v.+compl.}{depreciar; tornar"-se desvalorizado; refere"-se à diminuição do poder de compra do dinheiro | depreciar; geralmente se refere à diminuição do valor de algo | desvalorizar; reduzir o teor de ouro da moeda de um país ou reduzir a taxa de câmbio da moeda de um país em relação às moedas estrangeiras}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{购物中心}{8,8,4,4}{⾙,⽜,⼁,⼼}
  \begin{Phonetics}{购物中心}{gou4wu4 zhong4 xin1}[][HSK 5]
    \definition[家]{s.}{\emph{shopping center}; centro comercial; galerias comerciais}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 贮 %%%%%%%%%%
\subsection*{贮}\addcontentsline{loh}{figure}{贮}

\begin{Entry}{贮}{8}{⾙}
  \begin{Phonetics}{贮}{zhu4}
    \definition{v.}{armazenar; guardar; reservar | acumular}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{贮藏}{8,17}{⾙,⾋}
  \begin{Phonetics}{贮藏}{zhu4cang2}[][HSK 7-9]
...
\begin{Entry}{转交}{8,6}{⾞,⼇}
  \begin{Phonetics}{转交}{zhuan3jiao1}[][HSK 7-9]
...
\begin{Entry}{转向}{8,6}{⾞,⼝}
  \begin{Phonetics}{转向}{zhuan3xiang4}[][HSK 5]
...
\begin{Entry}{转机}{8,6}{⾞,⽊}
  \begin{Phonetics}{转机}{zhuan3ji1}[][HSK 7-9]
...
\begin{Entry}{转达}{8,6}{⾞,⾡}
  \begin{Phonetics}{转达}{zhuan3da2}[][HSK 7-9]
...
\begin{Entry}{转折}{8,7}{⾞,⼿}
  \begin{Phonetics}{转折}{zhuan3zhe2}[][HSK 7-9]
...
\begin{Entry}{转折点}{8,7,9}{⾞,⼿,⽕}
  \begin{Phonetics}{转折点}{zhuan3zhe2dian3}[][HSK 7-9]
...
\begin{Entry}{转身}{8,7}{⾞,⾝}
  \begin{Phonetics}{转身}{zhuan3shen1}[][HSK 4]
...
\begin{Entry}{转学}{8,8}{⾞,⼦}
  \begin{Phonetics}{转学}{zhuan3//xue2}[][HSK 7-9]
...
\begin{Entry}{转念}{8,8}{⾞,⼼}
  \begin{Phonetics}{转念}{zhuan3nian4}
    \definition{v.}{reconsiderar e desistir de uma ideia; repensar a ideia | mudar de ideia, após uma reflexão mais aprofundada}
...
\begin{Entry}{转型}{8,9}{⾞,⼟}
  \begin{Phonetics}{转型}{zhuan3xing2}[][HSK 7-9]
...
\begin{Entry}{转递}{8,10}{⾞,⾡}
  \begin{Phonetics}{转递}{zhuan3di4}
    \definition{v.}{passar adiante; repassar; transmitir}
  \synonymref{传递}{chuan2di4}
...
\begin{Entry}{转悠}{8,11}{⾞,⼼}
  \begin{Phonetics}{转悠}{zhuan4you5}[][HSK 7-9]
...
\begin{Entry}{转眼}{8,11}{⾞,⽬}
  \begin{Phonetics}{转眼}{zhuan3yan3}[][HSK 7-9]
...
\begin{Entry}{转播}{8,15}{⾞,⼿}
  \begin{Phonetics}{转播}{zhuan3bo1}[][HSK 7-9]
...
\begin{Entry}{轮回}{8,6}{⾞,⼞}
  \begin{Phonetics}{轮回}{lun2hui2}
    \definition[个]{s.}{Budismo: samsara; reencarmação; transmigração; o budismo ensina que os seres vivos estão em constante ciclo de transformação, passando por seis reinos (o céu, o inferno, o reino humano e assim por diante) como uma roda giratória}
    \definition{v.}{reencarnar | (estações do ano etc.) seguir um ao outro ciclicamente; circular; alternar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{软件}{8,6}{⾞,⼈}
  ...
  \synonymref{硬件}{ying4jian4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{软卧车厢}{8,8,4,11}{⾞,⾂,⾞,⼚}
  \begin{Phonetics}{软卧车厢}{ruan3wo4 che1xiang1}[][HSK 5]
    \definition{s.}{vagão"-leito (categoria superior)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{软座车厢}{8,10,4,11}{⾞,⼴,⾞,⼚}
  \begin{Phonetics}{软座车厢}{ruan3 zuo4 che1xiang1}[][HSK 5]
    \definition{s.}{vagão com assentos confortáveis}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{郊区}{8,4}{⾢,⼖}
  ...
  \antonymref{城区}{cheng2qu1}
  \antonymref{城市}{cheng2shi4}
  \antonymref{市区}{shi4 qu1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{采用}{8,5}{⾤,⽤}
  ...
  \seealsoref{采纳}{cai3na4}
  \seealsoref{采取}{cai3qu3}
  \synonymref{接纳}{jie1na4}
  \synonymref{使用}{shi3yong4}
  \synonymref{选用}{xuan3yong4}
...
\begin{Entry}{金}{8}{⾦}[Kangxi 167]
  \begin{Phonetics}{金}{jin1}[][HSK 3]
    ...
    \definition{adj.}{dourado | altamente respeitado; precioso; nobre}
...
\begin{Entry}{金融}{8,16}{⾦,⿀}
  ...
  \synonymref{财经}{cai2jing1}
  \synonymref{经济}{jing1ji4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{闸}{8}{⾨}
  \begin{Phonetics}{闸}{zha2}[][HSK 7-9]
...
\begin{Entry}{陌生人}{8,5,2}{⾩,⽣,⼈}
  \begin{Phonetics}{陌生人}{mo4sheng1 ren2}[][HSK 5]
    \definition[个,位,名,些]{s.}{estranho; pessoas desconhecidas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{降}{8}{⾩}
  ...
  \antonymref{涨}{zhang4}
  \end{Phonetics}
  \begin{Phonetics}{降}{xiang2}
    \definition{v.}{render"-se; capitular | domar; domesticar; subjugar; vencer}
  \synonymref{沉}{chen2}
  \synonymref{落}{lao4}
  \synonymref{落}{luo4}
  \antonymref{提}{di1}
...
\begin{Entry}{降低}{8,7}{⾩,⼈}
  ...
  \antonymref{升高}{sheng1gao1}
  \antonymref{提高}{ti2gao1}
  \antonymref{提升}{ti2sheng1}
...
\begin{Entry}{降温}{8,12}{⾩,⽔}
  \begin{Phonetics}{降温}{jiang4wen1}[][HSK 4]
    \definition{v.}{baixar a temperatura (como em uma oficina);  recusar | cair a temperatura | esfriar; resfriar; declínio no entusiasmo ou uma diminuição no ímpeto de algo}
  \synonymref{淡化}{dan4hua4}
  \synonymref{减弱}{jian3ruo4}
  \synonymref{冷冻}{leng3dong4}
  \synonymref{凉快}{liang2kuai5}
  \synonymref{衰退}{shuai1tui4}
  \antonymref{保暖}{bao3//nuan3}
  \antonymref{激化}{ji1hua4}
  \antonymref{加热}{jia1//re4}
  \antonymref{强化}{qiang2hua4}
  \antonymref{升温}{sheng1wen1}
  \antonymref{增长}{zeng1zhang3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{限}{8}{⾩}
  \begin{Phonetics}{限}{xian4}[][HSK 7-9]
...
\begin{Entry}{限于}{8,3}{⾩,⼆}
  \begin{Phonetics}{限于}{xian4yu2}[][HSK 7-9]
...
\begin{Entry}{限制}{8,8}{⾩,⼑}
  ...
  \seealsoref{局限}{ju2xian4}
  \seealsoref{限定}{xian4ding4}
  \synonymref{范围}{fan4wei2}
  \synonymref{控制}{kong4zhi4}
  \synonymref{束缚}{shu4fu4}
  \synonymref{限度}{xian4du4}
  \synonymref{约束}{yue1shu4}
  \synonymref{制约}{zhi4yue1}
...
\begin{Entry}{限定}{8,8}{⾩,⼧}
  \begin{Phonetics}{限定}{xian4ding4}[][HSK 7-9]
...
\begin{Entry}{限度}{8,9}{⾩,⼴}
  \begin{Phonetics}{限度}{xian4du4}[][HSK 7-9]
...
\begin{Entry}{雨}{8}{⾬}[Kangxi 173]
  ...
  \begin{Phonetics}{雨}{yu4}
    \definition{v.}{cair (chuva, neve, etc.);  precipitar; chover}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{雨伞}{8,6}{⾬,⼈}
  \begin{Phonetics}{雨伞}{yu3san3}
    \definition[个,把]{s.}{guarda"-chuva; os guarda"-chuvas impermeáveis são feitos de materiais como papel oleado, tecido encerado, náilon ou plástico}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{雨蚀}{8,9}{⾬,⾷}
  \begin{Phonetics}{雨蚀}{yu3shi2}
    \definition{s.}{erosão pela chuva}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{雨靴}{8,13}{⾬,⾰}
  \begin{Phonetics}{雨靴}{yu3xue1}
    \definition[双]{s.}{botas de borracha (ou impermeáveis); galochas | botas de chuva}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{青天}{8,4}{⾭,⼤}
  \begin{Phonetics}{青天}{qing1tian1}
    \definition{s.}{céu claro, limpo ou azul | um juiz justo; um magistrado íntegro (termo antigo para um funcionário honesto e íntegro)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{青少年}{8,4,6}{⾭,⼩,⼲}
  ...
  \synonymref{年轻人}{nian2qing1 ren2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{青玉米}{8,5,6}{⾭,⽟,⽶}
  \begin{Phonetics}{青玉米}{qing1 yu4mi3}
...
\begin{Entry}{青年}{8,6}{⾭,⼲}
  ...
  \seealsoref{青春}{qing1chun1}
  \synonymref{年轻人}{nian2qing1 ren2}
  \synonymref{少年}{shao4nian2}
...
\begin{Entry}{青菜}{8,11}{⾭,⾋}
  \begin{Phonetics}{青菜}{qing1cai4}
    \definition[棵,把,斤,堆]{s.}{hortaliças verdes; verduras}
  \synonymref{蔬菜}{shu1cai4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{青椒}{8,12}{⾭,⽊}
  \begin{Phonetics}{青椒}{qing1jiao1}
    \definition[个]{s.}{pimentão verde}
  \synonymref{辣椒}{la4jiao1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{非……不可}{8,4,5}{⾮,⼀,⼝}
  \begin{Phonetics}{非……不可}{fei1 bu4ke3}
    \definition{expr.}{devo\dots não posso}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{非洲}{8,9}{⾮,⽔}
  \begin{Phonetics}{非洲}{fei1zhou1}
    \definition*{s.}{África, abreviação de}
  \seealsoref{阿非利加洲}{a1fei1li4jia1 zhou1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{非常}{8,11}{⾮,⼱}
  ...
  \seealsoref{异常}{yi4chang2}
  \synonymref{分外}{fen4wai4}
...
\begin{Entry}{饱满}{8,13}{⾷,⽔}
  ...
  \seealsoref{饱和}{bao3he2}
  \seealsoref{丰满}{feng1man3}
  \synonymref{充分}{chong1fen4}
...
\begin{Entry}{驾车}{8,4}{⾺,⾞}
  \begin{Phonetics}{驾车}{jia4che1}[][HSK 7-9]
...
\begin{Entry}{驾驶}{8,8}{⾺,⾺}
  ...
  \synonymref{操纵}{cao1zong4}
  \synonymref{驾车}{jia4che1}
  \synonymref{驾驭}{jia4yu4}
  \synonymref{开车}{kai1//che1}
  \synonymref{控制}{kong4zhi4}
  \synonymref{行驶}{xing2shi3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{驾驶证}{8,8,7}{⾺,⾺,⾔}
  \begin{Phonetics}{驾驶证}{jia4shi3 zheng4}[][HSK 5]
    \definition[张]{s.}{carteira de motorista; licenças exigidas para condutores de veículos motorizados de acordo com a lei}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{驾照}{8,13}{⾺,⽕}
  ...
  \synonymref{驾驶证}{jia4shi3 zheng4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{鱼片}{8,4}{⿂,⽚}
  \begin{Phonetics}{鱼片}{yu2pian4}
    \definition[些,种]{s.}{carne de peixe fatiada | filé de peixe | fatia de carne de peixe}
  \seealsoref{鱼片儿}{yu2 pian1r5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{鱼片儿}{8,4,2}{⿂,⽚,⼉}
  \begin{Phonetics}{鱼片儿}{yu2 pian1r5}
    \definition{s.}{filé de peixe}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{鱼香}{8,9}{⿂,⾹}
  ...
  \seealsoref{鱼香肉丝}{yu2xiang1rou4si1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{鱼香肉丝}{8,9,6,5}{⿂,⾹,⾁,⼀}
  \begin{Phonetics}{鱼香肉丝}{yu2xiang1rou4si1}
    \definition{s.}{Prato: tiras de carne de porco salteadas com yuxiang (鱼香)}
