...
\begin{Entry}{参展}{8,10}{⼛,⼫}
  \begin{Phonetics}{参展}{can1zhan3}[][HSK 6]
...
\begin{Entry}{变动}{8,6}{⼜,⼒}
  \begin{Phonetics}{变动}{bian4dong4}[][HSK 5]
    ...
    \definition{v.}{mudar; alterar; oscilar; modificar; variar | verbo transitivo, pode ser seguido por um objeto e pode ser usado com a estrutura da frase 把}
  \seealsoref{把}{ba3}
...
\begin{Entry}{变性}{8,8}{⼜,⼼}
  \begin{Phonetics}{变性}{bian4xing4}
    ...
    \definition{v.}{Química: desnaturar | mudar de sexo por meio de cirurgia; alterar o próprio gênero por meio de cirurgia; fazer uma cirurgia de mudança de sexo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{季节}{8,5}{⼦,⾋}
  ...
  \antonymref{季度}{ji4du4}
  \antonymref{时节}{shi2jie2}
  \antonymref{四季}{si4ji4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{明珠}{8,10}{⽇,⽟}
  \begin{Phonetics}{明珠}{ming2zhu1}
    \definition[方]{s.}{pérola brilhante; joia; metáfora para pessoas queridas ou coisas belas | Figurativo: a menina dos olhos; aquilo que é mais precioso}
...
\begin{Entry}{表演者}{8,14,8}{⾐,⽔,⽼}
  \begin{Phonetics}{表演者}{biao3yan3zhe3}
