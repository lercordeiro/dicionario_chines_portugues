...
\begin{Entry}{奴}{5}{⼥}
  \begin{Phonetics}{奴}{nu2}
    ...
    \definition[个,位]{s.}{servo; escravo; pessoas da sociedade antiga que eram oprimidas, exploradas e escravizadas, e que não tinham liberdade pessoal nem direitos políticos (em oposição ao 主)}
    \definition{v.}{escravizar; tornar alguém escravo | escravizar (tratados e usados ​​como escravos)}
  \seealsoref{主}{zhu3}
  \end{Phonetics}
\end{Entry}
