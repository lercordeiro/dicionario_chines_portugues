...
\begin{Entry}{出于}{5,3}{⼐,⼆}
  \begin{Phonetics}{出于}{chu1yu2}[][HSK 5]
...
\begin{Entry}{出毛病}{5,4,10}{⼐,⽑,⽧}
  \begin{Phonetics}{出毛病}{chu1mao2bing4}[][HSK 7-9]
    \definition{v.}{estar (sair) fora de ordem; dar errado; quebrar; ter problemas com; falhar; sofrer um acidente | Coloquial: estar (ou ficar) fora de serviço}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{出风头}{5,4,5}{⼐,⾵,⼤}
  \begin{Phonetics}{出风头}{chu1feng1tou5}[][HSK 7-9]
...
\begin{Entry}{出名}{5,6}{⼐,⼝}
  \begin{Phonetics}{出名}{chu1ming2}[][HSK 6]
...
\begin{Entry}{出汗}{5,6}{⼐,⽔}
  \begin{Phonetics}{出汗}{chu1han4}[][HSK 5]
...
\begin{Entry}{出事}{5,8}{⼐,⼅}
  \begin{Phonetics}{出事}{chu1shi4}[][HSK 6]
...
\begin{Entry}{出洋相}{5,9,9}{⼐,⽔,⽬}
  \begin{Phonetics}{出洋相}{chu1yang2xiang4}[][HSK 7-9]
    \definition{v.}{fazer papel de bobo}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{出院}{5,9}{⼐,⾩}
  \begin{Phonetics}{出院}{chu1yuan4}[][HSK 2]
...
\begin{Entry}{出面}{5,9}{⼐,⾯}
  \begin{Phonetics}{出面}{chu1mian4}[][HSK 6]
...
\begin{Entry}{出席}{5,10}{⼐,⼱}
  \begin{Phonetics}{出席}{chu1//xi2}[][HSK 4]
    \definition{v.+compl.}{comparecer; estar presente; participar de reuniões com o direito de falar e votar; juntar"-se a uma organização ou atividade}
...
\begin{Entry}{出难题}{5,10,15}{⼐,⾫,⾴}
  \begin{Phonetics}{出难题}{chu1nan2ti2}[][HSK 7-9]
...
\begin{Entry}{出境}{5,14}{⼐,⼟}
  \begin{Phonetics}{出境}{chu1jing4}[][HSK 7-9]
    \definition{v.}{sair do país | sair de uma determinada região | partir; sair; emigrar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{加上}{5,3}{⼒,⼀}
  \begin{Phonetics}{加上}{jia1shang5}[][HSK 5]
...
\begin{Entry}{加热}{5,10}{⼒,⽕}
  \begin{Phonetics}{加热}{jia1re4}[][HSK 5]
...
\begin{Entry}{发明者}{5,8,8}{⼜,⽇,⽼}
  \begin{Phonetics}{发明者}{fa1ming2zhe3}[][HSK 5]
...
\begin{Entry}{处在}{5,6}{⼡,⼟}
  \begin{Phonetics}{处在}{chu3zai4}[][HSK 5]
...
\begin{Entry}{失控}{5,11}{⼤,⼿}
  \begin{Phonetics}{失控}{shi1kong4}[][HSK 7-9]
...
\begin{Entry}{打包}{5,5}{⼿,⼓}
  \begin{Phonetics}{打包}{da3//bao1}[][HSK 5]
...
\begin{Entry}{正能量}{5,10,12}{⽌,⾁,⾥}
  \begin{Phonetics}{正能量}{zheng4neng2liang4}[][HSK 7-9]
...
\begin{Entry}{纠葛}{5,12}{⽷,⾋}
  \begin{Phonetics}{纠葛}{jiu1ge2}
    \definition{s.}{briga; disputa; contenda; ``cipós de kudzu entrelaçados'', uma metáfora para uma questão complexa e não resolvida}
  \synonymref{纠缠}{jiu1chan2}
...
\begin{Entry}{讨厌}{5,6}{⾔,⼚}
  \begin{Phonetics}{讨厌}{tao3//yan4}[][HSK 5]
