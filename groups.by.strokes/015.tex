...
%%%%%%%%%% 嬉 %%%%%%%%%%
\subsection*{嬉}\addcontentsline{loh}{figure}{嬉}

\begin{Entry}{嬉}{15}{⼥}
  \begin{Phonetics}{嬉}{xi1}
    \definition{v.}{jogar; brincar; praticar esporte}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{嬉笑}{15,10}{⼥,⽵}
  \begin{Phonetics}{嬉笑}{xi1xiao4}[][HSK 7-9]
...
%%%%%%%%%% 幢 %%%%%%%%%%
\subsection*{幢}\addcontentsline{loh}{figure}{幢}

\begin{Entry}{幢}{15}{⼱}
  \begin{Phonetics}{幢}{chuang2}
  ...
  \end{Phonetics}
  \begin{Phonetics}{幢}{zhuang4}[][HSK 7-9]
...
\begin{Entry}{影片}{15,4}{⼺,⽚}
  \begin{Phonetics}{影片}{ying3pian4}[][HSK 2]
...
\begin{Entry}{影视}{15,8}{⼺,⾒}
  \begin{Phonetics}{影视}{ying3shi4}[][HSK 3]
...
\begin{Entry}{影响力}{15,9,2}{⼺,⼝,⼒}
  \begin{Phonetics}{影响力}{ying3xiang3li4}
    \definition{s.}{impacto | influência}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{影星}{15,9}{⼺,⽇}
  \begin{Phonetics}{影星}{ying3xing1}[][HSK 6]
...
%%%%%%%%%% 懊 %%%%%%%%%%
\subsection*{懊}\addcontentsline{loh}{figure}{懊}

\begin{Entry}{懊}{15}{⼼}
  \begin{Phonetics}{懊}{ao4}
    \definition{adj.}{arrependido; pesaroso | irritado; aborrecido}
    \definition{v.}{arrepender"-se; lamentar"-se}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{懊悔}{15,10}{⼼,⼼}
  \begin{Phonetics}{懊悔}{ao4hui3}
    \definition{s.}{arrependimento; remorso}
    \definition{v.}{arrepender"-se; estar arrependido; arrepender"-se (de); sentir remorso | expressa um grau de arrependimento maior do que 后悔, mas é menos usado}
...
%%%%%%%%%% 瘫 %%%%%%%%%%
\subsection*{瘫}\addcontentsline{loh}{figure}{瘫}

\begin{Entry}{瘫}{15}{⽧}
  \begin{Phonetics}{瘫}{tan1}[][HSK 7-9]
...
\begin{Entry}{瘫痪}{15,12}{⽧,⽧}
  \begin{Phonetics}{瘫痪}{tan1huan4}[][HSK 7-9]
...
\begin{Entry}{聪明人}{15,8,2}{⽿,⽇,⼈}
  \begin{Phonetics}{聪明人}{cong1ming2 ren2}[][HSK 5]
...
%%%%%%%%%% 膝 %%%%%%%%%%
\subsection*{膝}\addcontentsline{loh}{figure}{膝}

\begin{Entry}{膝}{15}{⾁}
  \begin{Phonetics}{膝}{xi1}
    \definition[个]{s.}{joelho | genu; a parte frontal da articulação que liga a coxa à parte inferior da perna}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{膝盖}{15,11}{⾁,⽫}
  \begin{Phonetics}{膝盖}{xi1gai4}[][HSK 7-9]
...
\begin{Entry}{蝲蝲蛄}{15,15,11}{⾍,⾍,⾍}
  \begin{Phonetics}{蝲蝲蛄}{la4 la4gu3}
...
\begin{Entry}{镇定}{15,8}{⾦,⼧}
  \begin{Phonetics}{镇定}{zhen4ding4}[][HSK 7-9]
...
\begin{Entry}{震}{15}{⾬}
  \begin{Phonetics}{震}{zhen4}[][HSK 7-9]
...
\begin{Entry}{震动}{15,6}{⾬,⼒}
  \begin{Phonetics}{震动}{zhen4dong4}[][HSK 7-9]
...
\begin{Entry}{震撼}{15,16}{⾬,⼿}
  \begin{Phonetics}{震撼}{zhen4han4}[][HSK 7-9]
...
\begin{Entry}{颜色}{15,6}{⾴,⾊}
  \begin{Phonetics}{颜色}{yan2se4}[][HSK 2]
...
\begin{Entry}{颜真卿}{15,10,10}{⾴,⼗,⼙}
  \begin{Phonetics}{颜真卿}{yan2 zhen1qing1}
...
\begin{Entry}{鲨鱼}{15,8}{⿂,⿂}
  \begin{Phonetics}{鲨鱼}{sha1yu2}[][HSK 7-9]
