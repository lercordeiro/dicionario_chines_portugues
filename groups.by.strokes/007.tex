...
\begin{Entry}{劳动}{7,6}{⼒,⼒}
  \begin{Phonetics}{劳动}{lao2dong5}[][HSK 5]
...
\begin{Entry}{吵架}{7,9}{⼝,⽊}
  \begin{Phonetics}{吵架}{chao3jia4}[][HSK 3]
    \definition{v.}{brigar; discutir; ter uma discussão acalorada}
  \seealsoref{吵}{chao1}
  \seealsoref{吵}{chao3}
...
\begin{Entry}{屁股}{7,8}{⼫,⾁}
  \begin{Phonetics}{屁股}{pi4gu5}
    \definition[个,瓣]{s.}{bunda; traseiro; nádegas; parte posterior; a parte posterior do corpo humano, entre as pernas e a cintura; a parte do animal onde se senta | fim; extremidade; uma metáfora para a parte final ou o fim de algo}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{投资者}{7,10,8}{⼿,⾙,⽼}
  \begin{Phonetics}{投资者}{tou2zi1zhe3}[][HSK 5]
...
\begin{Entry}{没法儿}{7,8,2}{⽔,⽔,⼉}
  \begin{Phonetics}{没法儿}{mei2fa3r5}[][HSK 4]
...
\begin{Entry}{补考}{7,6}{⾐,⽼}
  \begin{Phonetics}{补考}{bu3kao3}[][HSK 6]
...
\begin{Entry}{角色}{7,6}{⾓,⾊}
  \begin{Phonetics}{角色}{jue2se4}[][HSK 4]
    \definition[个]{s.}{papel; personagem em uma peça; personagem representado por um ator | papel; função; parte; uma metáfora para um certo tipo de pessoas na vida social}
...
\begin{Entry}{豆制品}{7,8,9}{⾖,⼑,⼝}
  \begin{Phonetics}{豆制品}{dou4zhi4pin3}[][HSK 5]
...
\begin{Entry}{违法}{7,8}{⾡,⽔}
  \begin{Phonetics}{违法}{wei2fa3}[][HSK 5]
...
\begin{Entry}{连锁反应}{7,12,4,7}{⾡,⾦,⼜,⼴}
  \begin{Phonetics}{连锁反应}{lian2suo3fan3ying4}
    \definition{s.}{reação em cadeia; efeito em cadeia; efeito dominó; essa metáfora descreve um grupo de coisas relacionadas, onde uma mudança em uma delas leva a uma mudança nas outras}
  \end{Phonetics}
\end{Entry}
