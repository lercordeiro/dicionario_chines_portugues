...
\begin{Entry}{但是}{7,9}{⼈,⽇}
  ...
  \antonymref{尽管}{jin3guan3}
  \antonymref{虽然}{sui1ran2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{别}{7}{⼑}
  ...
  \seealsoref{别的}{bie2de5}
  \seealsoref{是}{shi4}
  \synonymref{别的}{bie2de5}
  \synonymref{插}{cha1}
  \synonymref{分}{fen1}
  \synonymref{挤}{ji3}
  \synonymref{卡}{ka3}
...
\begin{Entry}{饭店}{7,8}{⾷,⼴}
  ...
  \synonymref{饭馆}{fan4guan3}
  \synonymref{饭馆儿}{fan4guan3r5}
