...
\begin{Entry}{乌鲁木齐}{4,12,4,6}{⼃,⿂,⽊,⿑}
  ...
  \seealsoref{新疆维吾尔自治区}{xin1jiang1 wei2wu2'er3 zi4zhi4qu1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{分之}{4,3}{⼑,⼂}
  \begin{Phonetics}{分之}{fen1zhi1}[][HSK 4]
...
\begin{Entry}{少林寺}{4,8,6}{⼩,⽊,⼨}
  \begin{Phonetics}{少林寺}{shao4lin2 si4}[][HSK 7-9]
...
\begin{Entry}{手刹}{4,8}{⼿,⼑}
  ...
  \seealsoref{手刹车}{shou3sha1che1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{手刹车}{4,8,4}{⼿,⼑,⾞}
  \begin{Phonetics}{手刹车}{shou3sha1che1}
    \definition{s.}{freio de mão}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{文艺界}{4,4,9}{⽂,⾋,⽥}
  \begin{Phonetics}{文艺界}{wen2 yi4 jie4}
...
\begin{Entry}{无人机}{4,2,6}{⽆,⼈,⽊}
  \begin{Phonetics}{无人机}{wu2ren2ji1}
    \definition{s.}{\emph{drone}; veículo aéreo não tripulado(VANT/UAV)}[大疆无人机很受欢迎。===Os drones da DJI são muito populares.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{止咳}{4,9}{⽌,⼝}
  \begin{Phonetics}{止咳}{zhi3 ke2}[][HSK 7-9]
...
\begin{Entry}{毛}{4}{⽑}[Kangxi 82]
  \begin{Phonetics}{毛}{mao2}[][HSK 1,3]
    ...
    \definition[根]{s.}{(animal, planta, etc.) cabelo; pena; penugem | (humanos) cabelo; barba | planta; colheita | lã | mofo; bolor}
