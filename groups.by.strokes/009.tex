...
\begin{Entry}{前程}{9,12}{⼑,⽲}
  \begin{Phonetics}{前程}{qian2cheng2}
    \definition{s.}{futuro; perspectiva; a jornada que se avizinha; uma metáfora para as circunstâncias futuras | carreira; antigamente, referia"-se aos títulos e cargos oficiais aos quais estudiosos ou funcionários aspiravam}
...
\begin{Entry}{差（一）点儿}{9,1,9,2}{⼯,⼀,⽕,⼉}
  \begin{Phonetics}{差（一）点儿}{cha1(yi4)dian3r5}
...
\begin{Entry}{帮教}{9,11}{⼱,⽁}
  \begin{Phonetics}{帮教}{bang1jiao4}
    \definition{v.}{orientar; ser mentor; ajudar e ensinar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{省事}{9,8}{⽬,⼅}
  \begin{Phonetics}{省事}{sheng3shi4}[][HSK 7-9]
    \definition{adj.}{conveniente; prático; sem problemas}
    \definition{v.}{evitar problemas; simplificar as coisas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{穿上}{9,3}{⽳,⼀}
  \begin{Phonetics}{穿上}{chuan1 shang5}[][HSK 4]
    \definition{v.}{vestir (roupas, etc.); colocar roupas}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{穿小鞋}{9,3,15}{⽳,⼩,⾰}
  \begin{Phonetics}{穿小鞋}{chuan1xiao3xie2}[][HSK 7-9]
...
\begin{Entry}{胆小鬼}{9,3,9}{⾁,⼩,⿁}
  \begin{Phonetics}{胆小鬼}{dan3xiao3gui3}[][HSK 5]
    \definition[个,群]{adj.}{chorão; covarde; medroso; uma pessoa com pouca coragem (em tom sarcástico)}
