...
\begin{Entry}{举一反三}{9,1,4,3}{⼂,⼀,⼜,⼀}
  \begin{Phonetics}{举一反三}{ju3yi1fan3san1}[][HSK 7-9]
...
\begin{Entry}{举办}{9,4}{⼂,⼒}
  ...
  \seealsoref{举行}{ju3xing2}
  \synonymref{承办}{cheng2ban4}
  \synonymref{进行}{jin4xing2}
  \synonymref{开办}{kai1ban4}
  \synonymref{开展}{kai1zhan3}
  \synonymref{兴办}{xing1ban4}
  \synonymref{召开}{zhao4kai1}
  \synonymref{主办}{zhu3ban4}
  \antonymref{停办}{ting2ban4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{举办者}{9,4,8}{⼂,⼒,⽼}
  \begin{Phonetics}{举办者}{ju3ban4 zhe3}[][HSK 5]
    \definition{s.}{organizador; anfitrião}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{举手}{9,4}{⼂,⼿}
  \begin{Phonetics}{举手}{ju3shou3}[][HSK 2]
    \definition{v.}{levantar a mão ou as mãos; levantar a mão para sinalizar ou responder a uma pergunta}
  \synonymref{毫不费力}{hao2bu2fei4li4}
  \synonymref{轻而易举}{qing1'er2yi4ju3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{举世闻名}{9,5,9,6}{⼂,⼀,⾨,⼝}
  ...
  \synonymref{远近闻名}{yuan3jin4-wen2ming2}
...
\begin{Entry}{举世瞩目}{9,5,17,5}{⼂,⼀,⽬,⽬}
  ...
  \synonymref{引人注目}{yin3ren2-zhu4mu4}
  \antonymref{默默无闻}{mo4mo4-wu2wen2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{举行}{9,6}{⼂,⾏}
  ...
  \seealsoref{举办}{ju3ban4}
  \seealsoref{召开}{zhao4kai1}
  \synonymref{进行}{jin4xing2}
  \antonymref{撤销}{che4xiao1}
  \antonymref{取缔}{qu3di4}
...
\begin{Entry}{亭}{9}{⼇}
  \begin{Phonetics}{亭}{ting2}
    \definition{adj.}{Literário: bem equilibrado; bem proporcionado; simétrico; moderado; uniforme}
    \definition{s.}{pavilhão (em um parque ou ao lado de uma estrada para descanso) | barraca; quiosque | pavilhão; caramanchão | casa pequena em formato de pavilhão}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{亮点}{9,9}{⼇,⽕}
  \begin{Phonetics}{亮点}{liang4dian3}[][HSK 7-9]
    \definition{s.}{destaque; ponto alto; mérito; algo que vale a pena mencionar; pontos que emitem luz | mérito; ponto final; um mérito excepcional; pessoa ou coisa bela, louvável e que chama a atenção}
  \synonymref{特色}{te4se4}
  \synonymref{突出}{tu1chu1}
...
\begin{Entry}{亲人}{9,2}{⼇,⼈}
  \begin{Phonetics}{亲人}{qin1ren2}[][HSK 3]
    \definition[个,位]{s.}{um membro da família; os pais, o cônjuge, os filhos, etc.; refere"-se a parentes ou cônjuges | queridos; entes queridos; aqueles queridos para alguém; pessoas que têm um relacionamento próximo e sentimentos profundos}
...
\begin{Entry}{亲切}{9,4}{⼇,⼑}
  ...
  \seealsoref{亲密}{qin1mi4}
  \seealsoref{亲热}{qin1re4}
...
\begin{Entry}{亲密}{9,11}{⼇,⼧}
  ...
  \seealsoref{密切}{mi4qie4}
  \seealsoref{亲切}{qin1qie4}
  \seealsoref{亲热}{qin1re4}
  \synonymref{接近}{jie1jin4}
...
%%%%%%%%%% 侮 %%%%%%%%%%
\subsection*{侮}\addcontentsline{loh}{figure}{侮}

\begin{Entry}{侮}{9}{⼈}
  \begin{Phonetics}{侮}{wu3}
    \definition{v.}{insultar; intimidar | humilhar; caluniar; assediar (assédio moral); menosprezar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{侮辱}{9,10}{⼈,⾠}
  \begin{Phonetics}{侮辱}{wu3ru3}[][HSK 7-9]
...
\begin{Entry}{侵略者}{9,11,8}{⼈,⽥,⽼}
  \begin{Phonetics}{侵略者}{qin1lve4 zhe3}[][HSK 5]
    \definition{s.}{agressor; invasor; refere"-se a um saqueador que viola o território de outras nações, rouba riquezas e recursos ou escraviza a população de outros países}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{便于}{9,3}{⼈,⼆}
  ...
  \seealsoref{以便}{yi3bian4}
  \synonymref{方便}{fang1bian4}
  \synonymref{容易}{rong2yi4}
  \antonymref{不便}{bu2bian4}
  \antonymref{麻烦}{ma2fan5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{便利}{9,7}{⼈,⼑}
  ...
  \seealsoref{方便}{fang1bian4}
  \synonymref{便捷}{bian4jie2}
  \synonymref{容易}{rong2yi4}
  \antonymref{不便}{bu2bian4}
  \antonymref{困难}{kun4nan5}
  \antonymref{麻烦}{ma2fan5}
...
\begin{Entry}{便宜}{9,8}{⼈,⼧}
  ...
  \synonymref{简便}{jian3bian4}
  \synonymref{快捷}{kuai4jie2}
  \synonymref{廉价}{lian2jia4}
  \synonymref{容易}{rong2yi4}
  \synonymref{省钱}{sheng3//qian2}
  \antonymref{昂贵}{ang2gui4}
  \antonymref{不便}{bu2bian4}
  \antonymref{高昂}{gao1'ang2}
  \antonymref{困难}{kun4nan5}
  \antonymref{麻烦}{ma2fan5}
  \antonymref{珍贵}{zhen1gui4}
  \antonymref{值钱}{zhi2qian2}
  \end{Phonetics}
  ...
  \antonymref{昂贵}{ang2gui4}
  \antonymref{高昂}{gao1'ang2}
  \antonymref{高价}{gao1jia4}
  \antonymref{公益}{gong1yi4}
  \antonymref{贵重}{gui4zhong4}
  \antonymref{奢侈}{she1chi3}
  \antonymref{珍贵}{zhen1gui4}
  \antonymref{值钱}{zhi2qian2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{便是}{9,9}{⼈,⽇}
  ...
  \synonymref{即是}{ji2 shi4}
  \synonymref{即便}{ji2bian4}
  \synonymref{即使}{ji2shi3}
  \synonymref{就是}{jiu4shi4}
  \synonymref{正是}{zheng4shi4}
...
\begin{Entry}{促进}{9,7}{⼈,⾡}
  ...
  \seealsoref{促}{cu4}
  \seealsoref{促使}{cu4shi3}
  \synonymref{鞭策}{bian1ce4}
  \synonymref{促成}{cu4cheng2}
  \synonymref{督促}{du1cu4}
  \synonymref{鼓动}{gu3dong4}
  \synonymref{鼓励}{gu3li4}
  \synonymref{鼓舞}{gu3wu3}
  \synonymref{推动}{tui1dong4}
  \synonymref{推进}{tui1jin4}
  \synonymref{增进}{zeng1jin4}
...
\begin{Entry}{促销}{9,12}{⼈,⾦}
  ...
  \synonymref{推销}{tui1xiao1}
  \synonymref{宣传}{xuan1chuan2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{促销活动}{9,12,9,6}{⼈,⾦,⽔,⼒}
  \begin{Phonetics}{促销活动}{cu4xiao1 huo2dong4}[][HSK 5]
    \definition{s.}{evento promocional; promoção de vendas, atividade promocional; atividades como reduções de preço ou a oferta de brindes, realizadas para impulsionar as vendas de um produto ou serviço específico}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{俄罗斯人}{9,8,12,2}{⼈,⽹,⽄,⼈}
  \begin{Phonetics}{俄罗斯人}{e2luo2si1 ren2}
...
%%%%%%%%%% 俗 %%%%%%%%%%
\subsection*{俗}\addcontentsline{loh}{figure}{俗}

\begin{Entry}{俗}{9}{⼈}
  \begin{Phonetics}{俗}{su2}[][HSK 7-9]
...
\begin{Entry}{保卫}{9,3}{⼈,⼙}
  ...
  \seealsoref{捍卫}{han4wei4}
  \synonymref{保护}{bao3hu4}
  \synonymref{防守}{fang2shou3}
  \synonymref{防卫}{fang2wei4}
  \synonymref{守护}{shou3hu4}
  \synonymref{维护}{wei2hu4}
  \antonymref{抵抗}{di3kang4}
  \antonymref{攻击}{gong1ji1}
  \antonymref{掠夺}{lve4duo2}
  \antonymref{侵犯}{qin1fan4}
  \antonymref{侵略}{qin1lve4}
  \antonymref{袭击}{xi2ji1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{保不住}{9,4,7}{⼈,⼀,⼈}
  \begin{Phonetics}{保不住}{bao3bu5zhu4}
    \definition{adv.}{muito provavelmente; mais provável do que improvável; pode muito bem ser | não pode garantir; não pode mais}
    \definition{v.}{falhar em manter ou preservar; não conseguir manter; ser incapaz de conservar; não ser possível manter}
...
\begin{Entry}{保存}{9,6}{⼈,⼦}
  ...
  \seealsoref{保管}{bao3guan3}
  \seealsoref{保留}{bao3liu2}
...
\begin{Entry}{保守}{9,6}{⼈,⼧}
  ...
  \antonymref{改良}{gai3liang2}
  \antonymref{进步}{jin4bu4}
  \antonymref{开放}{kai1fang4}
  \antonymref{开拓}{kai1tuo4}
  \antonymref{冒险}{mao4//xian3}
  \antonymref{前进}{qian2jin4}
  \antonymref{先进}{xian1jin4}
  \antonymref{泄露}{xie4lou4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{保佑}{9,7}{⼈,⼈}
  ...
  \synonymref{保重}{bao3//zhong4}
  \synonymref{祈祷}{qi2dao3}
  \antonymref{诅咒}{zu3zhou4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{保护}{9,7}{⼈,⼿}
  ...
  \synonymref{保卫}{bao3wei4}
  \synonymref{保障}{bao3zhang4}
  \synonymref{捍卫}{han4wei4}
  \synonymref{呵护}{he1hu4}
...
\begin{Entry}{保护国}{9,7,8}{⼈,⼿,⼞}
  \begin{Phonetics}{保护国}{bao3hu4guo2}
    \definition{s.}{protetorado; países que foram forçados a assinar tratados desiguais, cedendo parte de sua soberania (como a soberania diplomática) a outros países e, assim, recebendo sua ``proteção''}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{保护者}{9,7,8}{⼈,⼿,⽼}
  \begin{Phonetics}{保护者}{bao3hu4zhe3}
    \definition{s.}{protetor; assegurador}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{保证}{9,7}{⼈,⾔}
  ...
  \seealsoref{保障}{bao3zhang4}
  \seealsoref{担保}{dan1bao3}
  \synonymref{承诺}{cheng2nuo4}
  \synonymref{抵押}{di3ya1}
  \synonymref{确保}{que4bao3}
  \antonymref{放弃}{fang4qi4}
  \antonymref{风险}{feng1xian3}
  \antonymref{忽视}{hu1shi4}
  \antonymref{违约}{wei2//yue1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{保证书}{9,7,4}{⼈,⾔,⼄}
  \begin{Phonetics}{保证书}{bao3zheng4shu1}[][HSK 5]
    \definition{s.}{compromisso por escrito; promessa escrita | garantia; carta de garantia}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{保姆}{9,8}{⼈,⼥}
  ...
  \synonymref{管家}{guan3jia1}
  \synonymref{家政}{jia1zheng4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{保定}{9,8}{⼈,⼧}
  \begin{Phonetics}{保定}{bao3ding4}
    \definition*{s.}{Baoding, uma cidade na província de Hebei (河北)}
    \definition{v.}{(geralmente na forma negativa e interrogativa) ter certeza (ou convicção)}
...
\begin{Entry}{保修}{9,9}{⼈,⼈}
  \begin{Phonetics}{保修}{bao3//xiu1}[][HSK 7-9]
    \definition{v.+compl.}{garantir que a loja ou fábrica forneça serviço de reparo gratuito dentro de um determinado período de tempo; refere"-se ao reparo gratuito de mercadorias pela unidade de vendas ou pelo fabricante, de acordo com os regulamentos, após a venda das mercadorias | manter; manter em bom estado}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{保养}{9,9}{⼈,⼋}
  ...
  \synonymref{保重}{bao3//zhong4}
  \synonymref{保健}{bao3jian4}
  \synonymref{珍视}{zhen1shi4}
...
\begin{Entry}{保持}{9,9}{⼈,⼿}
  ...
  \seealsoref{维持}{wei2chi2}
  \synonymref{保留}{bao3liu2}
  \synonymref{坚持}{jian1chi2}
  \synonymref{依旧}{yi1jiu4}
  \antonymref{变更}{bian4geng1}
  \antonymref{丢掉}{diu1diao4}
  \antonymref{放弃}{fang4qi4}
  \antonymref{改变}{gai3bian4}
  \antonymref{改动}{gai3dong4}
  \antonymref{更改}{geng1gai3}
  \antonymref{流失}{liu2shi1}
  \antonymref{丧失}{sang4shi1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{保重}{9,9}{⼈,⾥}
  \begin{Phonetics}{保重}{bao3//zhong4}[][HSK 7-9]
    \definition{v.+compl.}{cuidar de si mesmo}
  \synonymref{保养}{bao3yang3}
  \synonymref{保佑}{bao3you4}
  \synonymref{珍视}{zhen1shi4}
...
\begin{Entry}{保险}{9,9}{⼈,⾩}
  \begin{Phonetics}{保险}{bao3//xian3}[][HSK 3]
    ...
    \definition{v.+compl.}{ter certeza; estar obrigado a; garantir que algo aconteça (o que as pessoas desejam)}
  \synonymref{安全}{an1quan2}
  \synonymref{保障}{bao3zhang4}
  \synonymref{保证}{bao3zheng4}
  \synonymref{必定}{bi4ding4}
  \synonymref{必然}{bi4ran2}
  \synonymref{可靠}{ke3kao4}
...
\begin{Entry}{保留}{9,10}{⼈,⽥}
  ...
  \seealsoref{保存}{bao3cun2}
  \synonymref{保持}{bao3chi2}
  \antonymref{撤销}{che4xiao1}
  \antonymref{放弃}{fang4qi4}
  \antonymref{废除}{fei4chu2}
  \antonymref{解除}{jie3chu2}
  \antonymref{开除}{kai1chu2}
  \antonymref{抛弃}{pao1qi4}
  \antonymref{清除}{qing1chu2}
  \antonymref{取消}{qu3xiao1}
...
\begin{Entry}{保密}{9,11}{⼈,⼧}
  ...
  \antonymref{泄密}{xie4//mi4}
  \antonymref{泄漏}{xie4lou4}
  \antonymref{泄露}{xie4lou4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{保障}{9,13}{⼈,⾩}
  ...
  \seealsoref{保证}{bao3zheng4}
  \synonymref{保险}{bao3//xian3}
  \synonymref{保护}{bao3hu4}
  \antonymref{侵犯}{qin1fan4}
  \antonymref{危害}{wei1hai4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{保鲜}{9,14}{⼈,⿂}
  \begin{Phonetics}{保鲜}{bao3//xian1}[][HSK 7-9]
    \definition{v.+compl.}{manter fresco; preservar o frescor}
...
\begin{Entry}{信件}{9,6}{⼈,⼈}
  \begin{Phonetics}{信件}{xin4jian4}[][HSK 7-9]
...
\begin{Entry}{信任}{9,6}{⼈,⼈}
  ...
  \antonymref{怀疑}{huai2yi2}
  \antonymref{可疑}{ke3yi2}
  \antonymref{嫌疑}{xian2yi2}
...
\begin{Entry}{信贷}{9,9}{⼈,⾙}
  \begin{Phonetics}{信贷}{xin4dai4}[][HSK 7-9]
...
\begin{Entry}{信誉}{9,13}{⼈,⾔}
  \begin{Phonetics}{信誉}{xin4yu4}[][HSK 7-9]
...
\begin{Entry}{信赖}{9,13}{⼈,⾙}
  \begin{Phonetics}{信赖}{xin4lai4}[][HSK 7-9]
...
\begin{Entry}{俩}{9}{⼈}
  ...
  \seealsoref{两}{liang3}
  \end{Phonetics}
  \begin{Phonetics}{俩}{liang3}
    \definition{s.}{truque; plano; ato; meios antiéticos}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{俩钱}{9,10}{⼈,⾦}
  \begin{Phonetics}{俩钱}{lia3 qian2}
    \definition{s.}{uma pequena quantia de dinheiro | duas moedas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{俭省}{9,9}{⼈,⽬}
  ...
  \synonymref{节俭}{jie2jian3}
  \synonymref{节省}{jie2sheng3}
  \synonymref{节约}{jie2yue1}
...
\begin{Entry}{修订}{9,4}{⼈,⾔}
  \begin{Phonetics}{修订}{xiu1ding4}[][HSK 7-9]
...
\begin{Entry}{修长}{9,4}{⼈,⾧}
  \begin{Phonetics}{修长}{xiu1chang2}[][HSK 7-9]
...
\begin{Entry}{修正}{9,5}{⼈,⽌}
  \begin{Phonetics}{修正}{xiu1zheng4}[][HSK 7-9]
...
\begin{Entry}{修改}{9,7}{⼈,⽁}
  ...
  \seealsoref{修正}{xiu1zheng4}
  \synonymref{改正}{gai3zheng4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{修补}{9,7}{⼈,⾐}
  \begin{Phonetics}{修补}{xiu1bu3}[][HSK 7-9]
...
\begin{Entry}{修建}{9,8}{⼈,⼵}
  ...
  \seealsoref{修筑}{xiu1zhu4}
  \synonymref{建筑}{jian4zhu4}
  \synonymref{修理}{xiu1li3}
  \synonymref{修造}{xiu1zao4}
...
\begin{Entry}{修养}{9,9}{⼈,⼋}
  ...
  \antonymref{操劳}{cao1lao2}
  \antonymref{劳累}{lao2lei4}
  \antonymref{疲劳}{pi2lao2}
  \antonymref{无知}{wu2zhi1}
  \antonymref{野蛮}{ye3man2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{修复}{9,9}{⼈,⼢}
  ...
  \synonymref{维修}{wei2xiu1}
  \synonymref{修补}{xiu1bu3}
  \synonymref{修理}{xiu1li3}
  \antonymref{拆除}{chai1chu2}
  \antonymref{毁坏}{hui3huai4}
  \antonymref{破坏}{po4huai4}
  \antonymref{烧毁}{shao1hui3}
  \antonymref{损害}{sun3hai4}
  \antonymref{损伤}{sun3shang1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{修造}{9,10}{⼈,⾡}
  \begin{Phonetics}{修造}{xiu1zao4}
    \definition{v.}{construir e reparar; fabricar}
  \seealsoref{建造}{jian4zao4}
  \synonymref{建筑}{jian4zhu4}
  \synonymref{修建}{xiu1jian4}
  \synonymref{修筑}{xiu1zhu4}
  \antonymref{拆除}{chai1chu2}
  \antonymref{毁坏}{hui3huai4}
  \antonymref{破坏}{po4huai4}
  \end{Phonetics}
...
\begin{Entry}{修理}{9,11}{⼈,⽟}
  ...
  \seealsoref{维修}{wei2xiu1}
  \seealsoref{修}{xiu1}
  \synonymref{修补}{xiu1bu3}
  \synonymref{修复}{xiu1fu4}
  \synonymref{修建}{xiu1jian4}
  \antonymref{破坏}{po4huai4}
  \antonymref{损坏}{sun3huai4}
  \end{Phonetics}
...
\begin{Entry}{修筑}{9,12}{⼈,⽵}
  \begin{Phonetics}{修筑}{xiu1zhu4}
    \definition{v.}{construir (estradas, fortificações, etc.); erguer; montar}
  \seealsoref{修建}{xiu1jian4}
  \synonymref{建设}{jian4she4}
...
\begin{Entry}{修路}{9,13}{⼈,⾜}
  \begin{Phonetics}{修路}{xiu1//lu4}[][HSK 7-9]
    \definition{v.+compl.}{reparar uma estrada; construir estradas}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 兹 %%%%%%%%%%
\subsection*{兹}\addcontentsline{loh}{figure}{兹}

\begin{Entry}{兹}{9}{⼋}
  \begin{Phonetics}{兹}{ci2}
    \definition*{s.}{Qiuci, 龟兹, era um antigo reino nas Regiões Ocidentais, localizado no que hoje é a área do Condado de Kuche, 库车, em Xinjiang, 新疆}
  \seealsoref{库车}{ku4che1}
  \seealsoref{龟兹}{qiu1ci2}
  \seealsoref{新疆}{xin1jiang1}
  \end{Phonetics}
  \begin{Phonetics}{兹}{zi1}[][HSK 7-9]
...
\begin{Entry}{养分}{9,4}{⼋,⼑}
  \begin{Phonetics}{养分}{yang3fen4}
    \definition{s.}{nutriente; nutrientes contidos em substâncias que promovem o crescimento e o desenvolvimento dos organismos}
  \seealsoref{养料}{yang3liao4}
  \synonymref{营养}{ying2yang3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{养生}{9,5}{⼋,⽣}
  \begin{Phonetics}{养生}{yang3sheng1}[][HSK 7-9]
...
\begin{Entry}{养老}{9,6}{⼋,⽼}
  \begin{Phonetics}{养老}{yang3lao3}[][HSK 6]
...
\begin{Entry}{养老金}{9,6,8}{⼋,⽼,⾦}
  \begin{Phonetics}{养老金}{yang3lao3jin1}[][HSK 7-9]
    \definition{s.}{pensão; gratificação; aposentadorias para funcionários mais velhos | pensão de velhice}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{养老院}{9,6,9}{⼋,⽼,⾩}
  \begin{Phonetics}{养老院}{yang3lao3yuan4}[][HSK 7-9]
...
\begin{Entry}{养鱼池}{9,8,6}{⼋,⿂,⽔}
  \begin{Phonetics}{养鱼池}{yang3 yu2 chi2}[][HSK 5]
    \definition{s.}{aquário; tanque de peixes}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{养活}{9,9}{⼋,⽔}
  \begin{Phonetics}{养活}{yang3huo5}[][HSK 7-9]
...
\begin{Entry}{养料}{9,10}{⼋,⽃}
  \begin{Phonetics}{养料}{yang3liao4}
    \definition[种]{s.}{alimento; nutrição; substâncias que podem fornecer nutrição aos organismos}
  \seealsoref{养分}{yang3fen4}
  \synonymref{此外}{ci3wai4}
  \synonymref{肥料}{fei2liao4}
...
\begin{Entry}{养殖}{9,12}{⼋,⽍}
  \begin{Phonetics}{养殖}{yang3zhi2}[][HSK 7-9]
...
\begin{Entry}{冒}{9}{⽇}
  ...
  \end{Phonetics}
  \begin{Phonetics}{冒}{mo4}
    \definition*{s.}{Mo, nome de um rei Xiongnu (单于) durante o início da dinastia Han | Sobrenome: Mo}
    \definition{v.}{emitir; expelir; vir para fora; elevar"-se | arriscar; ousar; ser imprudente; ser precipitado; ser presunçoso | arriscar; ousar; independentemente de (perigo, ambiente hostil, etc.) | personificar; se fazer passar por}
...
\begin{Entry}{冒险家}{9,9,10}{⽇,⾩,⼧}
  \begin{Phonetics}{冒险家}{mao4xian3 jia1}[][HSK 5]
    \definition{s.}{aventureiro; refere"-se a um aventureiro, seja na política ou nos negócios, que avança com ousadia}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{冒顿单于}{9,10,8,3}{⽇,⾴,⼗,⼆}
  \begin{Phonetics}{冒顿单于}{mao4dun4 chan2yu2}
    \definition*{s.}{Maodun Chanyu, nome do príncipe herdeiro do povo Xiongnu no início da Dinastia Han}
...
\begin{Entry}{冠军}{9,6}{⼍,⼍}
  ...
  \synonymref{榜首}{bang3shou3}
  \synonymref{夺冠}{duo2//guan4}
  \synonymref{状元}{zhuang4yuan5}
  \antonymref{倒数}{dao4shu4}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 剃 %%%%%%%%%%
\subsection*{剃}\addcontentsline{loh}{figure}{剃}

\begin{Entry}{剃}{9}{⼑}
  \begin{Phonetics}{剃}{ti4}[][HSK 7-9]
    \definition{v.}{depilar; raspar; cortar; usar uma lâmina especial para raspar (cabelo, barba, etc.)}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 削 %%%%%%%%%%
\subsection*{削}\addcontentsline{loh}{figure}{削}

\begin{Entry}{削}{9}{⼑}
  \begin{Phonetics}{削}{xiao1}[][HSK 7-9]
...
\begin{Entry}{削弱}{9,10}{⼑,⼸}
  \begin{Phonetics}{削弱}{xue1ruo4}[][HSK 7-9]
...
\begin{Entry}{前方}{9,4}{⼑,⽅}
  ...
  \synonymref{前面}{qian2mian4}
  \synonymref{前线}{qian2xian4}
  \antonymref{后方}{hou4fang1}
...
\begin{Entry}{前边}{9,5}{⼑,⾡}
  ...
  \seealsoref{前面}{qian2mian4}
  \antonymref{后边}{hou4bian5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{前后}{9,6}{⼑,⼝}
  ...
  \seealsoref{先后}{xian1hou4}
  \synonymref{附近}{fu4jin4}
  \synonymref{左右}{zuo3you4}
  \antonymref{同时}{tong2shi2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{前进}{9,7}{⼑,⾡}
  ...
  \synonymref{挺进}{ting3jin4}
  \synonymref{行进}{xing2jin4}
  \antonymref{保守}{bao3shou3}
  \antonymref{倒车}{dao4che1}
  \antonymref{后退}{hou4tui4}
...
\begin{Entry}{前往}{9,8}{⼑,⼻}
  ...
  \synonymref{出发}{chu1fa1}
  \synonymref{赶赴}{gan3fu4}
  \antonymref{返回}{fan3hui2}
  \antonymref{后退}{hou4tui4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{前面}{9,9}{⼑,⾯}
  ...
  \seealsoref{前边}{qian2bian5}
  \synonymref{前方}{qian2fang1}
  \synonymref{前头}{qian2tou5}
  \synonymref{前者}{qian2zhe3}
...
\begin{Entry}{前途}{9,10}{⼑,⾡}
  ...
  \seealsoref{前程}{qian2cheng2}
  \synonymref{出路}{chu1lu4}
  \synonymref{出息}{chu1xi5}
  \synonymref{前景}{qian2jing3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{前提}{9,12}{⼑,⼿}
  ...
  \antonymref{结果}{jie2guo3}
  \antonymref{结论}{jie2lun4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{前程}{9,12}{⼑,⽲}
  \begin{Phonetics}{前程}{qian2cheng2}
    \definition{s.}{futuro; perspectiva; a jornada que se avizinha; as circunstâncias futuras | carreira; antigamente, referia"-se aos títulos e cargos oficiais aos quais estudiosos ou funcionários aspiravam}
  \seealsoref{前途}{qian2tu2}
  \synonymref{出路}{chu1lu4}
  \synonymref{出息}{chu1xi5}
  \synonymref{前景}{qian2jing3}
  \end{Phonetics}
...
\begin{Entry}{剑客}{9,9}{⼑,⼧}
  \begin{Phonetics}{剑客}{jian4ke4}
    \definition[名,位]{s.}{espadachim cavalheiresco (em romances antigos) | esgrimista (isto é, desportista envolvido na esgrima)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{勇于}{9,3}{⼒,⼆}
  \begin{Phonetics}{勇于}{yong3yu2}[][HSK 7-9]
    \definition{v.}{ser corajoso em; ser ousado em; ter a coragem de; não recuar}
  \synonymref{敢于}{gan3yu2}
  \antonymref{胆小}{dan3 xiao3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{勇士}{9,3}{⼒,⼠}
  \begin{Phonetics}{勇士}{yong3shi4}
    \definition[位,名,个]{s.}{uma pessoa corajosa | um guerreiro}
  \synonymref{好汉}{hao3han4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{勇往直前}{9,8,8,9}{⼒,⼻,⽬,⼑}
  \begin{Phonetics}{勇往直前}{yong3wang3-zhi2qian2}[][HSK 7-9]
  ...
  \antonymref{打退堂鼓}{da3tui4tang2gu3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{勇敢}{9,11}{⼒,⽁}
  \begin{Phonetics}{勇敢}{yong3gan3}[][HSK 4]
    \definition{adj.}{bravo; valente; galante; corajoso | tem um significado positivo}
  \seealsoref{大胆}{da4dan3}
  \seealsoref{敢}{gan3}
  \seealsoref{英勇}{ying1yong3}
  \seealsoref{用于}{yong4 yu2}
  \synonymref{勇气}{yong3qi4}
  \antonymref{胆小}{dan3 xiao3}
  \antonymref{胆怯}{dan3qie4}
  \antonymref{害怕}{hai4pa4}
  \antonymref{畏惧}{wei4ju4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{勇敢者}{9,11,8}{⼒,⽁,⽼}
  \begin{Phonetics}{勇敢者}{yong3gan3 zhe3}[][HSK 5]
    \definition{s.}{pessoa corajosa; os corajosos; pessoa corajosa e destemida}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 勋 %%%%%%%%%%
\subsection*{勋}\addcontentsline{loh}{figure}{勋}

\begin{Entry}{勋}{9}{⼒}
  \begin{Phonetics}{勋}{xun1}
    \definition{s.}{mérito; serviço meritório; conquista}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{勋章}{9,11}{⼒,⾳}
  \begin{Phonetics}{勋章}{xun1zhang1}[][HSK 7-9]
...
\begin{Entry}{南}{9}{⼗}
  \begin{Phonetics}{南}{na1}
    \definition*{s.}{Namo; uma saudação budista respeitosa; terminologia budista, frequentemente usada antes dos nomes de Budas, Bodhisattvas ou escrituras, para expressar respeito ou refúgio}
  \end{Phonetics}
...
\begin{Entry}{南方}{9,4}{⼗,⽅}
  ...
  \synonymref{南边}{nan2bian5}
  \synonymref{南部}{nan2bu4}
  \synonymref{南面}{nan2mian4}
  \antonymref{北方}{bei3fang1}
  \antonymref{北面}{bei3mian4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{南面}{9,9}{⼗,⾯}
  \begin{Phonetics}{南面}{nan2mian4}
    \definition{s.}{sul; o lado sul}
    \definition{v.}{voltar"-se para o sul; tornar"-se governante (o imperador sempre se sentava voltado para o sul quando presidia audiências)}
  \antonymref{北面}{bei3mian4}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 叙 %%%%%%%%%%
\subsection*{叙}\addcontentsline{loh}{figure}{叙}

\begin{Entry}{叙}{9}{⼜}
  \begin{Phonetics}{叙}{xu4}
...
\begin{Entry}{叙述}{9,8}{⼜,⾡}
  \begin{Phonetics}{叙述}{xu4shu4}[][HSK 7-9]
...
\begin{Entry}{叛变}{9,8}{⼜,⼜}
  \begin{Phonetics}{叛变}{pan4bian4}
    \definition{v.}{trair o próprio país, partido, etc.; tornar"-se renegado | tornar"-se traidor; silenciar; delatar; desertar; trair a própria classe ou grupo através de ações hostis ou desertando para o lado oposto}
  \seealsoref{背叛}{bei4pan4}
  \synonymref{变节}{bian4jie2}
  \synonymref{哗变}{hua2bian4}
  \synonymref{叛逆}{pan4ni4}
  \antonymref{履行}{lv3xing2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{咨询处}{9,8,5}{⼝,⾔,⼡}
  \begin{Phonetics}{咨询处}{zi1xun2 chu4}[][HSK 5]
    \definition{s.}{balcão de informações}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{咱}{9}{⼝}
  ...
  \seealsoref{多咱}{duo1zan5}
  \seealsoref{那咱}{na4zan5}
  \seealsoref{早晚}{zao3wan3}
  \seealsoref{这咱}{zhe4zan5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{咱们}{9,5}{⼝,⼈}
  ...
  \antonymref{他们}{ta1men5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{咱俩}{9,9}{⼝,⼈}
  \begin{Phonetics}{咱俩}{zan2lia3}
    \definition{pron./s.}{nós dois}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{咱家}{9,10}{⼝,⼧}
  \begin{Phonetics}{咱家}{za2jia1}
    \definition{pron.}{eu (frequentemente usado na literatura vernácula antiga) | nós | minha casa | nossa casa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{咳嗽药}{9,14,9}{⼝,⼝,⾋}
  \begin{Phonetics}{咳嗽药}{ke2sou4 yao4}[][HSK 5]
    \definition{s.}{xarope para tosse}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 咽 %%%%%%%%%%
\subsection*{咽}\addcontentsline{loh}{figure}{咽}

\begin{Entry}{咽}{9}{⼝}
  \begin{Phonetics}{咽}{yan1}
    \definition{s.}{deglutição; garganta; faringe}
  \end{Phonetics}
  \begin{Phonetics}{咽}{yan4}[][HSK 7-9]
    \definition{v.}{engolir; permitir que alimentos ou outras substâncias presentes na boca passem pela faringe e cheguem ao esôfago | engolir (metaforicamente); descreve o ato de suprimir ou não expressar as próprias palavras ou a raiva}
  \antonymref{吐}{tu3}
  \end{Phonetics}
  \begin{Phonetics}{咽}{ye4}
    \definition{v.}{engasgar (ao chorar)}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{咽喉}{9,12}{⼝,⼝}
  \begin{Phonetics}{咽喉}{yan1hou2}[][HSK 7-9]
...
\begin{Entry}{哈马斯}{9,3,12}{⼝,⾺,⽄}
  \begin{Phonetics}{哈马斯}{ha1ma3si1}
    \definition*{s.}{Hamas (Grupo Palestino radical); Movimento de Resistência Islâmica}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{哈哈}{9,9}{⼝,⼝}
  \begin{Phonetics}{哈哈}{ha1ha1}[][HSK 3]
...
\begin{Entry}{响声}{9,7}{⼝,⼠}
  ...
  \synonymref{声音}{sheng1yin1}
  \synonymref{噪音}{zao4yin1}
...
\begin{Entry}{响应}{9,7}{⼝,⼴}
  \begin{Phonetics}{响应}{xiang3ying4}[][HSK 7-9]
...
\begin{Entry}{响亮}{9,9}{⼝,⼇}
  \begin{Phonetics}{响亮}{xiang3liang4}[][HSK 7-9]
...
\begin{Entry}{响起}{9,10}{⼝,⾛}
  \begin{Phonetics}{响起}{xiang3qi3}[][HSK 7-9]
    \definition{v.}{(som) surgir; (fonte sonora) soar; emitir som; explodir}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 哑 %%%%%%%%%%
\subsection*{哑}\addcontentsline{loh}{figure}{哑}

\begin{Entry}{哑}{9}{⼝}
  \begin{Phonetics}{哑}{ya1}
    \definition{interj.}{interjeição que expressa surpresa, o mesmo que 呀}
  \seealsoref{呀}{ya1}
  \end{Phonetics}
  \begin{Phonetics}{哑}{ya3}[][HSK 7-9]
...
\begin{Entry}{哗啦啦}{9,11,11}{⼝,⼝,⼝}
  \begin{Phonetics}{哗啦啦}{hua1la1la5}
...
\begin{Entry}{哪}{9}{⼝}
  ...
  \seealsoref{啊}{a5}
  \end{Phonetics}
  \begin{Phonetics}{哪}{ne2}
    \definition*{s.}{Nezha (哪吒), um personagem da mitologia}
  \seealsoref{哪吒}{ne2zha1}
  \end{Phonetics}
...
\begin{Entry}{哪吒}{9,6}{⼝,⼝}
  \begin{Phonetics}{哪吒}{ne2zha1}
    \definition{s.}{Nezha, Na Zha ou Nata é um deus protetor no taoísmo, procedente da mitologia budista chinesa; seu nome oficial no taoismo é "Marechal do Altar Central" (中坛元帅); depois de se tornar deidade, também recebe o título de "Terceiro Príncipe do Lótus" (莲花三太子)}
  \seealsoref{莲花三太子}{lian2hua1 san1 tai4zi3}
  \seealsoref{中坛元帅}{zhong1 tan2 yuan2shuai4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{哪国人}{9,8,2}{⼝,⼞,⼈}
  \begin{Phonetics}{哪国人}{na3 guo2ren2}
    \definition{expr.}{De que país você é?}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{城区}{9,4}{⼟,⼖}
  ...
  \synonymref{城里}{cheng2 li3}
  \synonymref{市区}{shi4 qu1}
  \antonymref{郊区}{jiao1qu1}
  \antonymref{郊外}{jiao1wai4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{城市}{9,5}{⼟,⼱}
  ...
  \seealsoref{城}{cheng2}
  \synonymref{城镇}{cheng2zhen4}
  \synonymref{都会}{du1hui4}
  \synonymref{都市}{du1shi4}
  \antonymref{郊区}{jiao1qu1}
  \antonymref{郊外}{jiao1wai4}
  \antonymref{农村}{nong2cun1}
  \antonymref{乡村}{xiang1cun1}
  \antonymref{乡下}{xiang1xia4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{复习}{9,3}{⼢,⼄}
  ...
  \synonymref{温习}{wen1xi2}
  \antonymref{预习}{yu4xi2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{复习材料}{9,3,7,10}{⼢,⼄,⽊,⽃}
  \begin{Phonetics}{复习材料}{fu4xi2 cai2liao4}[][HSK 5]
    \definition{s.}{material de revisão}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{复印}{9,5}{⼢,⼙}
  ...
  \synonymref{复制}{fu4zhi4}
  \synonymref{印刷}{yin4shua1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{复合}{9,6}{⼢,⼝}
  \begin{Phonetics}{复合}{fu4he2}[][HSK 7-9]
    \definition{v.}{compor; tornar complexo; combinar; juntar | recombinar; juntar; estar juntos novamente depois de estar separados}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{复苏}{9,7}{⼢,⾋}
  ...
  \synonymref{恢复}{hui1fu4}
  \synonymref{苏醒}{su1xing3}
  \synonymref{再生}{zai4sheng1}
...
\begin{Entry}{复制}{9,8}{⼢,⼑}
  ...
  \synonymref{克隆}{ke4long2}
  \antonymref{首创}{shou3chuang4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{复刻}{9,8}{⼢,⼑}
  \begin{Phonetics}{复刻}{fu4ke4}
    \definition{s.}{réplica}
    \definition{v.}{reimprimir (uma obra que está esgotada) |relançar (um álbum de vinil em CD, etc.) | replicar | recriar | Computação: \emph{fork}}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{奖励}{9,7}{⼤,⼒}
  \begin{Phonetics}{奖励}{jiang3li4}[][HSK 5]
    \definition[份]{s.}{prêmio; recompensa; dinheiro ou honras dadas em troca de elogios ou incentivos}
    \definition{v.}{recompensar; incentivar; encorajar}
  \seealsoref{奖}{jiang3}
  \synonymref{夸奖}{kua1jiang3}
  \synonymref{赏赐}{shang3ci4}
  \antonymref{惩罚}{cheng2fa2}
  \antonymref{处罚}{chu3fa2}
  \antonymref{处分}{chu3fen4}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 姿 %%%%%%%%%%
\subsection*{姿}\addcontentsline{loh}{figure}{姿}

\begin{Entry}{姿}{9}{⼥}
  \begin{Phonetics}{姿}{zi1}
    \definition{s.}{aparência; aspecto; aspecto | gesto; porte; postura; comportamento; atitude}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{姿势}{9,8}{⼥,⼒}
  \begin{Phonetics}{姿势}{zi1shi4}[][HSK 7-9]
...
\begin{Entry}{姿态}{9,8}{⼥,⼼}
  \begin{Phonetics}{姿态}{zi1tai4}[][HSK 7-9]
...
\begin{Entry}{威力}{9,2}{⼥,⼒}
  \begin{Phonetics}{威力}{wei1li4}[][HSK 7-9]
...
\begin{Entry}{威风}{9,4}{⼥,⾵}
  \begin{Phonetics}{威风}{wei1feng1}[][HSK 7-9]
...
\begin{Entry}{威信}{9,9}{⼥,⼈}
  \begin{Phonetics}{威信}{wei1xin4}[][HSK 7-9]
...
\begin{Entry}{威慑}{9,13}{⼥,⼼}
  \begin{Phonetics}{威慑}{wei1she4}[][HSK 7-9]
...
\begin{Entry}{客人}{9,2}{⼧,⼈}
  ...
  \synonymref{顾客}{gu4ke4}
  \synonymref{来宾}{lai2bin1}
  \synonymref{旅客}{lv3ke4}
  \synonymref{商人}{shang1ren2}
  \antonymref{东道主}{dong1dao4zhu3}
...
\begin{Entry}{客服}{9,8}{⼧,⽉}
  \begin{Phonetics}{客服}{ke4fu2}
    \definition{s.}{atendimento ao cliente; serviço de atendimento ao cliente (SAC); refere"-se ao trabalho de atendimento ao cliente (receber solicitações de clientes e responder a perguntas de clientes) ou à organização que realiza esse trabalho}
  \seealsoref{战胜}{zhan4sheng4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{宣扬}{9,6}{⼧,⼿}
  \begin{Phonetics}{宣扬}{xuan1yang2}[][HSK 7-9]
...
\begin{Entry}{宣告}{9,7}{⼧,⼝}
  \begin{Phonetics}{宣告}{xuan1gao4}[][HSK 7-9]
...
\begin{Entry}{宣言}{9,7}{⼧,⾔}
  \begin{Phonetics}{宣言}{xuan1yan2}[][HSK 7-9]
...
\begin{Entry}{宣泄}{9,8}{⼧,⽔}
  \begin{Phonetics}{宣泄}{xuan1xie4}[][HSK 7-9]
...
\begin{Entry}{宣称}{9,10}{⼧,⽲}
  \begin{Phonetics}{宣称}{xuan1cheng1}[][HSK 7-9]
...
\begin{Entry}{宣读}{9,10}{⼧,⾔}
  \begin{Phonetics}{宣读}{xuan1du2}[][HSK 7-9]
...
\begin{Entry}{宣誓}{9,14}{⼧,⾔}
  \begin{Phonetics}{宣誓}{xuan1//shi4}[][HSK 7-9]
...
\begin{Entry}{宪法}{9,8}{⼧,⽔}
  \begin{Phonetics}{宪法}{xian4fa3}[][HSK 7-9]
...
\begin{Entry}{封口}{9,3}{⼨,⼝}
  \begin{Phonetics}{封口}{feng1kou3}
    \definition{s.}{uma abertura (de um envelope, etc.); envelopes, capas e outros locais que podem ser selados.}
    \definition{v.}{selar; curar; fechar; selar ou fechar áreas abertas (como a boca de uma garrafa ou envelope), ou fechar locais abertos (como feridas) | calar"-se; dizer a última palavra; falar em tom definitivo; recusar"-se a discutir o assunto; fazer uma declaração firme e recusar"-se a mudá"-la}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{封印}{9,5}{⼨,⼙}
  \begin{Phonetics}{封印}{feng1yin4}
    \definition{s.}{selo (na correspondência); carimbo de lacre}
    \definition{v.}{selar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{封四}{9,5}{⼨,⼞}
  \begin{Phonetics}{封四}{feng1si4}
    \definition{s.}{contracapa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{封闭}{9,6}{⼨,⾨}
  ...
  \synonymref{封锁}{feng1suo3}
  \synonymref{关闭}{guan1bi4}
  \synonymref{密封}{mi4feng1}
  \antonymref{敞开}{chang3kai1}
  \antonymref{打开}{da3kai1}
  \antonymref{交流}{jiao1liu2}
  \antonymref{开放}{kai1fang4}
  \antonymref{开启}{kai1qi3}
  \antonymref{通风}{tong1//feng1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{封冻}{9,7}{⼨,⼎}
  \begin{Phonetics}{封冻}{feng1dong4}
    \definition{v.}{(um rio, do solo, etc.) congelar | congelar (a água ou a terra)}
  \antonymref{融化}{rong2hua4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{封底}{9,8}{⼨,⼴}
  \begin{Phonetics}{封底}{feng1di3}
    \definition{s.}{a contracapa de um livro}
  \seealsoref{封四}{feng1si4}
  \antonymref{封面}{feng1mian4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{封斋}{9,10}{⼨,⽂}
  \begin{Phonetics}{封斋}{feng1zhai1}
    \definition*{s.}{Ramadã (Islã) | Quarema (Catolicismo) | Jejum (em diversas religiões)}
  \seealsoref{把斋}{ba3//zhai1}
  \seealsoref{斋月}{zhai1yue4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{将}{9}{⼨}
  \begin{Phonetics}{将}{jiang1}[][HSK 5]
    \definition*{s.}{Sobrenome: Jiang}
    \definition{adv.}{estar indo para; parcialmente\dots parcialmente\dots | usado para narração objetiva com um tom suave; pode indicar tanto o futuro muito próximo quanto o futuro distante}
    ...
    \definition{v.}{fazer algo; lidar com (um assunto) | dar um xeque"-mate | cuidar (da saúde) | incitar alguém a agir; desafiar; estimular | segurar; pegar | colocar; tirar | levar; trazer | dar suporte; dar apoio}
  \seealsoref{把}{ba3}
  \seealsoref{必将}{bi4jiang1}
  \seealsoref{出去}{chu1qu4}
  \seealsoref{即将}{ji2jiang1}
  \seealsoref{将要}{jiang1yao4}
  \seealsoref{进来}{jin4lai2}
  \synonymref{搀}{chan1}
  \synonymref{扶}{fu2}
  \synonymref{激}{ji1}
  \synonymref{快}{kuai4}
...
\begin{Entry}{将心比心}{9,4,4,4}{⼨,⼼,⽐,⼼}
  \begin{Phonetics}{将心比心}{jiang1xin1bi3xin1}[][HSK 5]
    \definition{expr.}{``Colocar"-se no lugar de outra pessoa.''; avaliar os sentimentos dos outros com base nos próprios; colocar"-se no lugar de alguém; solidarizar"-se com os outros; ser empático; isso descreve o princípio de levar em consideração as perspectivas alheias ao agir}
  \synonymref{设身处地}{she4shen1chu3de5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{将军}{9,6}{⼨,⼍}
  \begin{Phonetics}{将军}{jiang1//jun1}[][HSK 6]
    ...
    \definition{v.+compl.}{dar xeque"-mate; atacar o general ou rei do oponente no xadrez; colocar alguém em grandes apuros; dar a alguém um problema difícil ou dificultar a tarefa para essa pessoa}
  \synonymref{刁难}{diao1nan4}
  \synonymref{难为}{nan2wei5}
  \synonymref{为难}{wei2nan2}
  \antonymref{士兵}{shi4bing1}
  \antonymref{战士}{zhan4shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{将来}{9,7}{⼨,⽊}
  ...
  \seealsoref{未来}{wei4lai2}
  \synonymref{以后}{yi3hou4}
  \antonymref{从前}{cong2qian2}
  \antonymref{刚刚}{gang1gang1}
  \antonymref{过去}{guo4qu4}
  \antonymref{目前}{mu4qian2}
  \antonymref{往事}{wang3shi4}
...
\begin{Entry}{将近}{9,7}{⼨,⾡}
  \begin{Phonetics}{将近}{jiang1jin4}[][HSK 3]
    \definition{adv.}{quase | frequentemente usado para descrever um tempo ou evento que está próximo ou prestes a acontecer em um futuro próximo;  将近 + quantidade indica uma quantidade que está prestes a ser alcançada}
  \seealsoref{将要}{jiang1yao4}
  \synonymref{几乎}{ji1hu1}
  \synonymref{靠近}{kao4jin4}
...
\begin{Entry}{将要}{9,9}{⼨,⾑}
  \begin{Phonetics}{将要}{jiang1yao4}[][HSK 5]
    \definition{adv.}{irá; deverá; estará prestes a; irá a; indica que um ato ou situação ocorre logo em seguida | indica o futuro próximo; não pode ser seguido por substantivos de tempo específico}
  \seealsoref{即将}{ji2jiang1}
  \seealsoref{将}{jiang1}
  \seealsoref{将近}{jiang1jin4}
...
\begin{Entry}{尝}{9}{⼩}
  \begin{Phonetics}{尝}{chang2}[][HSK 5]
    ...
    \definition{v.}{provar; experimentar o sabor de | provar; experimentar; conhecer | tentar; testar | significa comer um pouco, com o objetivo de sentir um pouco do sabor}
  \seealsoref{吃}{chi1}
  \synonymref{曾}{ceng2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{尝试}{9,8}{⼩,⾔}
  ...
  \synonymref{实验}{shi2yan4}
  \synonymref{试探}{shi4tan4}
  \synonymref{试图}{shi4tu2}
  \synonymref{试验}{shi4yan4}
  \synonymref{试探}{shi4tan5}
...
\begin{Entry}{屋子}{9,3}{⼫,⼦}
  ...
  \synonymref{房子}{fang2zi5}
  \synonymref{房屋}{fang2wu5}
  \synonymref{住宅}{zhu4zhai2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{屋顶}{9,8}{⼫,⾴}
  \begin{Phonetics}{屋顶}{wu1ding3}[][HSK 7-9]
...
\begin{Entry}{屌丝}{9,5}{⼫,⼀}
  \begin{Phonetics}{屌丝}{diao3si1}
    \definition{adj.}{Gíria:  \emph{looser} (\emph{Internet}); perdedor}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{屎}{9}{⼫}
  \begin{Phonetics}{屎}{shi3}
    \definition[把]{s.}{excremento; fezes; bosta; merda | secreção (do olho, ouvido, etc.)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{差}{9}{⼯}
  ...
  \end{Phonetics}
  \begin{Phonetics}{差}{chai4}
    \definition{v.}{recuperar"-se; melhorar; curar"-se; Literário: o mesmo que 瘥, que significa recuperar"-se de uma doença}
  \synonymref{次}{ci4}
  \synonymref{赖}{lai4}
  \synonymref{劣}{lie4}
  \synonymref{糟}{zao1}
  ...
  \antonymref{优}{you1}
  \end{Phonetics}
  \begin{Phonetics}{差}{ci1}
    \definition{adj.}{desigual; não uniforme; com altura variável; desiguais em comprimento e altura}
    \definition{adv.}{quase; por pouco}
  \synonymref{次}{ci4}
  \synonymref{赖}{lai4}
  \synonymref{劣}{lie4}
  \synonymref{糟}{zao1}
...
\begin{Entry}{差（一）点儿}{9,1,9,2}{⼯,⼀,⽕,⼉}
  \begin{Phonetics}{差（一）点儿}{cha1(yi4)dian3r5}[][HSK 5]
...
\begin{Entry}{差点儿}{9,9,2}{⼯,⽕,⼉}
  \begin{Phonetics}{差点儿}{cha4dian3r5}[][HSK 5]
    \definition{adj.}{não é bom o suficiente; ligeiramente inferior a; não está à altura do esperado; (qualidade, tecnologia, desempenho, etc.) ligeiramente inferior; ligeiramente abaixo da média}
    \definition{adv.}{quase; por pouco; prestes a; isso indica que uma determinada situação esteve perto de se concretizar, mas não se concretizou, ou que uma determinada situação se concretizou, mas por pouco}
  \seealsoref{几乎}{ji1hu1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{帝国主义}{9,8,5,3}{⼱,⼞,⼂,⼂}
  \begin{Phonetics}{帝国主义}{di4guo2zhu3yi4}[][HSK 7-9]
...
\begin{Entry}{带头人}{9,5,2}{⼱,⼤,⼈}
  \begin{Phonetics}{带头人}{dai4tou2ren2}[][HSK 7-9]
    \definition{s.}{líder; pioneiro}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{带动}{9,6}{⼱,⼒}
  \begin{Phonetics}{带动}{dai4dong4}[][HSK 3]
  ...
  \synonymref{带头}{dai4//tou2}
  \synonymref{带领}{dai4ling3}
  \synonymref{动员}{dong4//yuan2}
  \synonymref{发动}{fa1dong4}
  \synonymref{鼓动}{gu3dong4}
  \synonymref{拉动}{la1dong4}
  \synonymref{牵头}{qian1//tou2}
...
\begin{Entry}{带来}{9,7}{⼱,⽊}
  \begin{Phonetics}{带来}{dai4lai2}[][HSK 2]
...
\begin{Entry}{带领}{9,11}{⼱,⾴}
  ...
  \antonymref{袖手旁观}{xiu4shou3-pang2guan1}
  \antonymref{追随}{zhui1sui2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{帮佣}{9,7}{⼱,⼈}
  \begin{Phonetics}{帮佣}{bang1//yong1}
    \definition{s.}{trabalhador doméstico; empregada doméstica; servo; servente}
    \definition{v.+compl.}{trabalhar ou ser contratado como trabalhador doméstico, servo, etc.}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{帮助}{9,7}{⼱,⼒}
  ...
  \synonymref{助理}{zhu4li3}
  \antonymref{捣乱}{dao3//luan4}
  \antonymref{刁难}{diao1nan4}
  \antonymref{妨碍}{fang2'ai4}
  \antonymref{干扰}{gan1rao3}
  \antonymref{欺负}{qi1fu5}
  \antonymref{阻碍}{zu3'ai4}
  \antonymref{阻挠}{zu3nao2}
  \end{Phonetics}
...
\begin{Entry}{帮倒忙}{9,10,6}{⼱,⼈,⼼}
  \begin{Phonetics}{帮倒忙}{bang1//dao4mang2}[][HSK 5]
    \definition{v.+compl.}{ser mais um obstáculo do que uma ajuda; prejudicar alguém; oferecer ajuda de forma inadequada pode, na verdade, causar problemas para os outros | ser mais um obstáculo do que uma ajuda; significa que alguém ofereceu ajuda com boas intenções, mas na verdade teve o efeito contrário}
  \synonymref{画蛇添足}{hua4she2-tian1zu2}
  \antonymref{锦上添花}{jin3shang4tian1hua1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{帮教}{9,11}{⼱,⽁}
  \begin{Phonetics}{帮教}{bang1//jiao4}
    \definition{v.+compl.}{orientar; ser mentor; ajudar e ensinar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{幽默}{9,16}{⼳,⿊}
  ...
  \synonymref{风趣}{feng1qu4}
  \synonymref{搞笑}{gao3xiao4}
  \synonymref{滑稽}{hua2ji1}
...
\begin{Entry}{很难说}{9,10,9}{⼻,⾫,⾔}
  \begin{Phonetics}{很难说}{hen3nan2shuo1}[][HSK 6]
...
\begin{Entry}{律师执照}{9,6,6,13}{⼻,⼱,⼿,⽕}
  \begin{Phonetics}{律师执照}{lv4shi1 zhi2zhao4}[][HSK 5]
    \definition{s.}{licença de advogado}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{怎么办}{9,3,4}{⼼,⼃,⼒}
  \begin{Phonetics}{怎么办}{zen3me5 ban4}[][HSK 2]
...
\begin{Entry}{怎么样}{9,3,10}{⼼,⼃,⽊}
  \begin{Phonetics}{怎么样}{zen3me5 yang4}[][HSK 2]
...
\begin{Entry}{思维}{9,11}{⼼,⽷}
  \begin{Phonetics}{思维}{si1wei2}[][HSK 5]
    ...
    \definition{v.}{pensar}
  \seealsoref{思想}{si1xiang3}
  \synonymref{逻辑}{luo2ji2}
...
\begin{Entry}{思想家}{9,13,10}{⼼,⼼,⼧}
  \begin{Phonetics}{思想家}{si1xiang3jia1}[][HSK 5]
    \definition{s.}{pensador; pessoa que possui percepções originais sobre a realidade objetiva e consegue formar um sistema coerente de compreensão}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{急切}{9,4}{⼼,⼑}
  \begin{Phonetics}{急切}{ji2qie4}
    \definition{adj.}{ansioso; urgente; impaciente; imperativo | com pressa; apressado}
  \seealsoref{急忙}{ji2mang2}
  \synonymref{火速}{huo3su4}
  \synonymref{急迫}{ji2po4}
  \synonymref{紧急}{jin3ji2}
  \synonymref{紧迫}{jin3po4}
  \synonymref{迫切}{po4qie4}
  \antonymref{沉着}{chen2zhuo2}
  \antonymref{从容}{cong2rong2}
  \antonymref{缓慢}{huan3man4}
  \antonymref{镇定}{zhen4ding4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{急忙}{9,6}{⼼,⼼}
  ...
  \seealsoref{匆忙}{cong1mang2}
  \seealsoref{急切}{ji2qie4}
  \synonymref{匆匆}{cong1cong1}
  \synonymref{赶紧}{gan3jin3}
  \synonymref{赶快}{gan3kuai4}
  \synonymref{慌忙}{huang1mang2}
  \synonymref{连忙}{lian2mang2}
  \synonymref{马上}{ma3shang4}
  \synonymref{迅速}{xun4su4}
  \antonymref{从容}{cong2rong2}
  \antonymref{稳重}{wen3zhong4}
...
\begin{Entry}{总之}{9,3}{⼼,⼂}
  ...
  \synonymref{反正}{fan3zheng5}
  \synonymref{归纳}{gui1na4}
  \synonymref{横竖}{heng2shu5}
...
\begin{Entry}{总体}{9,7}{⼼,⼈}
  ...
  \synonymref{宏观}{hong2guan1}
  \synonymref{集体}{ji2ti3}
  \synonymref{全部}{quan2bu4}
  \synonymref{全局}{quan2ju2}
  \synonymref{全体}{quan2ti3}
...
\begin{Entry}{总是}{9,9}{⼼,⽇}
  \begin{Phonetics}{总是}{zong3 shi4}[][HSK 3]
...
\begin{Entry}{总结}{9,9}{⼼,⽷}
  ...
  \synonymref{概括}{gai4kuo4}
  \synonymref{归纳}{gui1na4}
  \synonymref{回顾}{hui2gu4}
  \synonymref{总之}{zong3zhi1}
...
\begin{Entry}{总统}{9,9}{⼼,⽷}
  ...
  \synonymref{首相}{shou3xiang4}
  \synonymref{元首}{yuan2shou3}
...
\begin{Entry}{总数}{9,13}{⼼,⽁}
  ...
  \synonymref{总额}{zong3'e2}
  \synonymref{总计}{zong3ji4}
  \synonymref{总量}{zong3liang4}
  \antonymref{部分}{bu4fen5}
  \antonymref{少数}{shao3shu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{总算}{9,14}{⼼,⽵}
  ...
  \synonymref{基本上}{ji1ben3 shang4}
  \synonymref{侥幸}{jiao3xing4}
...
\begin{Entry}{恨铁不成钢}{9,10,4,6,9}{⼼,⾦,⼀,⼽,⾦}
  \begin{Phonetics}{恨铁不成钢}{hen4 tie3 bu4cheng2 gang1}[][HSK 5]
    \definition{expr.}{``Odiar o ferro por não se transformar em aço.''; desapontados por não estarem à altura do seu potencial; ansiar pela melhora de alguém; sentir ressentimento em relação a alguém por não atender às expectativas e impaciência para ver melhorias}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{恰好}{9,6}{⼼,⼥}
  ...
  \seealsoref{恰巧}{qia4qiao3}
  \synonymref{凑巧}{cou4qiao3}
  \synonymref{刚好}{gang1hao3}
  \synonymref{恰恰}{qia4qia4}
...
\begin{Entry}{恼怒}{9,9}{⼼,⼼}
  \begin{Phonetics}{恼怒}{nao3nu4}
    \definition{adj.}{indignado; furioso; irritado}
    \definition{v.}{aborrecer; irritar; incomodar; provocar | ficar com raiva}
  \seealsoref{愤怒}{fen4nu4}
  \synonymref{气愤}{qi4fen4}
...
\begin{Entry}{战斗}{9,4}{⼽,⽃}
  \begin{Phonetics}{战斗}{zhan4dou4}[][HSK 4]
    ...
    \definition{v.}{lutar; combater | lutar; trabalho duro ou labor}
  \synonymref{搏斗}{bo2dou4}
  \synonymref{冲突}{chong1tu1}
  \synonymref{斗争}{dou4zheng1}
  \synonymref{交锋}{jiao1//feng1}
...
\begin{Entry}{战术}{9,5}{⼽,⽊}
  ...
  \synonymref{办法}{ban4fa3}
  \synonymref{策略}{ce4lve4}
  \synonymref{措施}{cuo4shi1}
  \synonymref{对策}{dui4ce4}
  \synonymref{方法}{fang1fa3}
  \synonymref{方式}{fang1shi4}
  \synonymref{举措}{ju3cuo4}
  \synonymref{手段}{shou3duan4}
  \synonymref{战略}{zhan4lve4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{战争}{9,6}{⼽,⼑}
  ...
  \synonymref{大战}{da4zhan4}
  \synonymref{斗争}{dou4zheng1}
  \synonymref{干戈}{gan1ge1}
  \synonymref{交锋}{jiao1//feng1}
  \synonymref{战斗}{zhan4dou4}
  \antonymref{安定}{an1ding4}
  \antonymref{安宁}{an1ning2}
  \antonymref{和睦}{he2mu4}
  \antonymref{和平}{he2ping2}
  \antonymref{太平}{tai4ping2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{战胜}{9,9}{⼽,⾁}
  \begin{Phonetics}{战胜}{zhan4sheng4}[][HSK 4]
    \definition{v.}{derrotar; vencer; superar; triunfar sobre; superar dificuldades e alcançar o sucesso}
  \seealsoref{客服}{ke4fu2}
  \synonymref{获胜}{huo4sheng4}
  \synonymref{克服}{ke4fu2}
  \synonymref{取胜}{qu3sheng4}
  \synonymref{征服}{zheng1fu2}
  \synonymref{制服}{zhi4fu2}
  \antonymref{打败}{da3bai4}
  \antonymref{大败}{da4bai4}
...
\begin{Entry}{拜见}{9,4}{⼿,⾒}
  ...
  \synonymref{拜会}{bai4hui4}
  \synonymref{参见}{can1jian4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{拜会}{9,6}{⼿,⼈}
  ...
  \seealsoref{拜访}{bai4fang3}
  \synonymref{拜见}{bai4jian4}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 拯 %%%%%%%%%%
\subsection*{拯}\addcontentsline{loh}{figure}{拯}

\begin{Entry}{拯}{9}{⼿}
  \begin{Phonetics}{拯}{zheng3}
    \definition{v.}{salvar; resgatar | ajudar; apoiar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{拯救}{9,11}{⼿,⽁}
  \begin{Phonetics}{拯救}{zheng3jiu4}[][HSK 7-9]
...
\begin{Entry}{拼音}{9,9}{⼿,⾳}
  \begin{Phonetics}{拼音}{pin1//yin1}
    \definition{s.}{o alfabeto fonético chinês; um único som composto por duas ou mais sílabas, geralmente referindo"-se especificamente a um símbolo criado para ajudar as pessoas a ler caracteres chineses e registrar sua pronúncia | pinyin (romanização chinesa)}
    \definition{v.+compl.}{combinar sons em sílabas; combinar dois ou mais fonemas em um som composto}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 拽 %%%%%%%%%%
\subsection*{拽}\addcontentsline{loh}{figure}{拽}

\begin{Entry}{拽}{9}{⼿}
  \begin{Phonetics}{拽}{ye4}
    \variantof{曳}
  \end{Phonetics}
  \begin{Phonetics}{拽}{zhuai1}
    \definition{v.}{Dialeto: atirar; lançar; arremessar}
  \end{Phonetics}
  \begin{Phonetics}{拽}{zhuai4}[][HSK 7-9]
...
\begin{Entry}{挂号处}{9,5,5}{⼿,⼝,⼡}
  \begin{Phonetics}{挂号处}{gua4hao4 chu4}[][HSK 5]
    \definition{s.}{registro; balcão de inscrição; balcão de cadastro | cartório de registro}[我在医院挂号处排队。===Estou na fila do balcão de cadastro do hospital.]
  \end{Phonetics}
\end{Entry}

\begin{Entry}{挂号信}{9,5,9}{⼿,⼝,⼈}
  \begin{Phonetics}{挂号信}{gua4hao4 xin4}[][HSK 5]
...
\begin{Entry}{指引}{9,4}{⼿,⼸}
  \begin{Phonetics}{指引}{zhi3yin3}[][HSK 7-9]
...
\begin{Entry}{指手划脚}{9,4,6,11}{⼿,⼿,⼑,⾁}
  \begin{Phonetics}{指手划脚}{zhi3shou3-hua4jiao3}
...
\begin{Entry}{指手画脚}{9,4,8,11}{⼿,⼿,⽥,⾁}
  \begin{Phonetics}{指手画脚}{zhi3shou3-hua4jiao3}[][HSK 7-9]
...
\begin{Entry}{指令}{9,5}{⼿,⼈}
  \begin{Phonetics}{指令}{zhi3ling4}[][HSK 7-9]
...
\begin{Entry}{指出}{9,5}{⼿,⼐}
  ...
  \synonymref{揭示}{jie1shi4}
  \synonymref{提出}{ti2chu1}
  \antonymref{含糊}{han2hu5}
  \antonymref{掩饰}{yan3shi4}
  \antonymref{隐瞒}{yin3man2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{指示}{9,5}{⼿,⽰}
  ...
  \seealsoref{指点}{zhi3dian3}
  \synonymref{命令}{ming4ling4}
  \synonymref{引导}{yin3dao3}
  \synonymref{指导}{zhi3dao3}
  \synonymref{指挥}{zhi3hui1}
  \synonymref{指令}{zhi3ling4}
  \synonymref{指向}{zhi3xiang4}
  \synonymref{指引}{zhi3yin3}
  \antonymref{汇报}{hui4bao4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{指向}{9,6}{⼿,⼝}
  \begin{Phonetics}{指向}{zhi3xiang4}[][HSK 7-9]
...
\begin{Entry}{指导}{9,6}{⼿,⼨}
  ...
  \seealsoref{辅导}{fu3dao3}
  \seealsoref{领导}{ling3dao3}
  \synonymref{带领}{dai4ling3}
  \synonymref{教导}{jiao4dao3}
  \synonymref{教育}{jiao4yu4}
  \synonymref{提醒}{ti2//xing3}
...
\begin{Entry}{指南}{9,9}{⼿,⼗}
  \begin{Phonetics}{指南}{zhi3nan2}[][HSK 7-9]
...
\begin{Entry}{指南针}{9,9,7}{⼿,⼗,⾦}
  \begin{Phonetics}{指南针}{zhi3nan2zhen1}[][HSK 7-9]
    \definition[个]{s.}{bússola; um instrumento feito com uma agulha magnética que pode indicar a direção, uma das quatro grandes invenções da antiguidade da China | bússola; serve como base para indicar a direção correta}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{指挥员}{9,9,7}{⼿,⼿,⼝}
  \begin{Phonetics}{指挥员}{zhi3hui1 yuan2}[][HSK 5]
    \definition[名,位,个]{s.}{comandante; quadros que ocupam cargos de liderança em diversos níveis no Exército de Libertação Popular da China; termo geral para o pessoal responsável pelo comando de uma tarefa ou operação específica}
  \synonymref{领导}{ling3dao3}
  \synonymref{主管}{zhu3guan3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{指标}{9,9}{⼿,⽊}
  ...
  \synonymref{尺度}{chi3du4}
  \synonymref{目标}{mu4biao1}
  \synonymref{目的}{mu4di4}
  \synonymref{意向}{yi4xiang4}
  \synonymref{宗旨}{zong1zhi3}
  \antonymref{起点}{qi3dian3}
  \antonymref{随意}{sui2yi4}
  \antonymref{现状}{xian4zhuang4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{指点}{9,9}{⼿,⽕}
  \begin{Phonetics}{指点}{zhi3dian3}[][HSK 7-9]
...
\begin{Entry}{指教}{9,11}{⼿,⽁}
  \begin{Phonetics}{指教}{zhi3jiao4}[][HSK 7-9]
...
\begin{Entry}{指望}{9,11}{⼿,⽉}
  \begin{Phonetics}{指望}{zhi3wang4}[][HSK 7-9]
...
\begin{Entry}{挑战}{9,9}{⼿,⼽}
  ...
  \synonymref{挑衅}{tiao3xin4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{挑战者}{9,9,8}{⼿,⼽,⽼}
  \begin{Phonetics}{挑战者}{tiao3zhan4 zhe3}[][HSK 5]
    \definition{s.}{desafiador; provocador; oponente}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{挑剔}{9,10}{⼿,⼑}
  \begin{Phonetics}{挑剔}{tiao1ti5}[][HSK 7-9]
...
\begin{Entry}{挖土机}{9,3,6}{⼿,⼟,⽊}
  \begin{Phonetics}{挖土机}{wa1tu3ji1}
    \definition{s.}{escavadeira; máquina de escavar | retroescavadeira}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{挖苦}{9,8}{⼿,⾋}
  \begin{Phonetics}{挖苦}{wa1ku5}[][HSK 7-9]
...
\begin{Entry}{挖掘}{9,11}{⼿,⼿}
  \begin{Phonetics}{挖掘}{wa1jue2}[][HSK 7-9]
...
%%%%%%%%%% 挟 %%%%%%%%%%
\subsection*{挟}\addcontentsline{loh}{figure}{挟}

\begin{Entry}{挟}{9}{⼿}
  \begin{Phonetics}{挟}{xie2}
...
\begin{Entry}{挟持}{9,9}{⼿,⼿}
  \begin{Phonetics}{挟持}{xie2chi2}[][HSK 7-9]
...
\begin{Entry}{挣扎}{9,4}{⼿,⼿}
  \begin{Phonetics}{挣扎}{zheng1zha2}[][HSK 7-9]
...
\begin{Entry}{挣得}{9,11}{⼿,⼻}
  \begin{Phonetics}{挣得}{zheng4de2}
    \definition{v.}{ganhar (rendimento) |ganhar (dinheiro)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{挥汗如雨}{9,6,6,8}{⼿,⽔,⼥,⾬}
  \begin{Phonetics}{挥汗如雨}{hui1han4ru2yu3}
    \definition{expr.}{suando profusamente; encharcado de suor; o suor escorria dele; estar encharcado de suor}
...
\begin{Entry}{挺尸}{9,3}{⼿,⼫}
  \begin{Phonetics}{挺尸}{ting3shi1}
    \definition{v.}{Vulgar: ficar deitado rigidamente como um cadáver; ficar deitado dormindo como um cadáver}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{挺立}{9,5}{⼿,⽴}
  \begin{Phonetics}{挺立}{ting3li4}
    \definition{s.}{em pé, com a coluna ereta; com o corpo reto, ambos os pés no chão ou apoiados em algum objeto}
    \definition{v.}{ficar de pé, ereto; ficar firme}
  \synonymref{耸立}{song3li4}
  \synonymref{挺拔}{ting3ba2}
  \synonymref{屹立}{yi4li4}
  \antonymref{倒下}{dao3xia4}
  \antonymref{弯曲}{wan1qu1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{挺住}{9,7}{⼿,⼈}
  \begin{Phonetics}{挺住}{ting3zhu4}
    \definition{v.}{manter"-se firme (diante da adversidade ou da dor)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{挺身}{9,7}{⼿,⾝}
  \begin{Phonetics}{挺身}{ting3shen1}
    \definition{v.}{endireitar as costas; endireitar"-se; ficar de pé, ereto}
  \synonymref{挺立}{ting3li4}
  \synonymref{屹立}{yi4li4}
  \antonymref{退却}{tui4que4}
  \antonymref{畏缩}{wei4suo1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{挺进}{9,7}{⼿,⾡}
  \begin{Phonetics}{挺进}{ting3jin4}
    ...
    \definition{v.}{(tropas) avançar com ousadia; prosseguir; impulsionar"-se para a frente | dirigir com ousadia}
...
\begin{Entry}{挺拔}{9,8}{⼿,⼿}
  \begin{Phonetics}{挺拔}{ting3ba2}
    \definition{adj.}{alto e reto; ereto e imponente | enérgico; poderoso}
  \synonymref{耸立}{song3li4}
  \synonymref{挺立}{ting3li4}
  \synonymref{屹立}{yi4li4}
...
\begin{Entry}{政纲}{9,7}{⽁,⽷}
  \begin{Phonetics}{政纲}{zheng4gang1}
    \definition{s.}{programa político (ou plataforma); um programa político descreve as tarefas e os requisitos políticos de um partido político}
  \seealsoref{政治纲领}{zheng4zhi4gang1ling3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{政府}{9,8}{⽁,⼴}
  ...
  \synonymref{朝廷}{chao2ting2}
  \synonymref{政权}{zheng4quan2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{政府部门}{9,8,10,3}{⽁,⼴,⾢,⾨}
  \begin{Phonetics}{政府部门}{zheng4fu3 bu4men2}[][HSK 5]
    \definition{s.}{órgão governamental | setor governamental}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{政治纲领}{9,8,7,11}{⽁,⽔,⽷,⾴}
  \begin{Phonetics}{政治纲领}{zheng4zhi4gang1ling3}
    \definition{s.}{programa político}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{星际迷航}{9,7,9,10}{⽇,⾩,⾡,⾈}
  \begin{Phonetics}{星际迷航}{xing1ji4 mi2hang2}
...
\begin{Entry}{星星}{9,9}{⽇,⽇}
  \begin{Phonetics}{星星}{xing1xing5}[][HSK 2]
    \definition[颗,群,片]{s.}{estrela; em astronomia, refere"-se aos corpos celestes luminosos no universo, como as estrelas que brilham no céu noturno | estrela; alguém ou algo que se destaca em um determinado campo e atrai atenção | objetos em forma de estrela}
  \synonymref{星辰}{xing1chen2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{星座}{9,10}{⽇,⼴}
  \begin{Phonetics}{星座}{xing1zuo4}[][HSK 7-9]
    \definition[张]{s.}{Astronomia: constelação, cada uma das várias divisões (regiões) do céu noturno}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{星球大战}{9,11,3,9}{⽇,⽟,⼤,⼽}
  \begin{Phonetics}{星球大战}{xing1qiu2 da4zhan4}
...
%%%%%%%%%% 映 %%%%%%%%%%
\subsection*{映}\addcontentsline{loh}{figure}{映}

\begin{Entry}{映}{9}{⽇}
  \begin{Phonetics}{映}{ying4}[][HSK 7-9]
...
\begin{Entry}{春节}{9,5}{⽇,⾋}
  \begin{Phonetics}{春节}{chun1jie2}[][HSK 2]
  ...
  \synonymref{过年}{guo4nian2}
  \synonymref{节日}{jie2ri4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{春季}{9,8}{⽇,⼦}
  ...
  \synonymref{春天}{chun1tian1}
  \antonymref{秋季}{qiu1ji4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{昨天}{9,4}{⽇,⼤}
  ...
  \synonymref{昨日}{zuo2ri4}
  \antonymref{今天}{jin1tian1}
  \antonymref{明日}{ming2ri4}
  \antonymref{明天}{ming2tian1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{是否}{9,7}{⽇,⼝}
  ...
  \synonymref{能否}{neng2fou3}
  \synonymref{是不是}{shi4bu5shi4}
  \synonymref{与否}{yu3fou3}
...
\begin{Entry}{是的}{9,8}{⽇,⽩}
  \begin{Phonetics}{是的}{shi4 de5}
    \definition{expr.}{confirmar; expressar concordância com as opiniões de outras pessoas}
    \definition{part.}{usado para indicar semelhança; usado para indicar alto grau; indica algo ou uma situação semelhante a outra coisa}
...
\begin{Entry}{昼夜}{9,8}{⽇,⼣}
  \begin{Phonetics}{昼夜}{zhou4ye4}[][HSK 7-9]
...
\begin{Entry}{显}{9}{⽇}
  ...
  \seealsoref{显得}{xian3de5}
  \seealsoref{显示}{xian3shi4}
  \synonymref{表}{biao3}
  \synonymref{露}{lou4}
  \synonymref{先}{xian1}
  \synonymref{现}{xian4}
...
\begin{Entry}{显示}{9,5}{⽇,⽰}
  ...
  \antonymref{隐藏}{yin3cang2}
  \antonymref{遮盖}{zhe1gai4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{显示器}{9,5,16}{⽇,⽰,⼝}
  \begin{Phonetics}{显示器}{xian3shi4qi4}[][HSK 7-9]
    \definition[台,个]{s.}{tela; monitor; \emph{display}}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{显而易见}{9,6,8,4}{⽇,⽽,⽇,⾒}
  \begin{Phonetics}{显而易见}{xian3'er2yi4jian4}[][HSK 7-9]
...
\begin{Entry}{显现}{9,8}{⽇,⾒}
  \begin{Phonetics}{显现}{xian3xian4}[][HSK 7-9]
...
\begin{Entry}{显眼}{9,11}{⽇,⽬}
  \begin{Phonetics}{显眼}{xian3yan3}[][HSK 7-9]
...
\begin{Entry}{显著}{9,11}{⽇,⽬}
  ...
  \seealsoref{明显}{ming2xian3}
  \synonymref{可观}{ke3guan1}
  \synonymref{突出}{tu1chu1}
  \synonymref{显赫}{xian3he4}
  \synonymref{醒目}{xing3mu4}
  \synonymref{卓越}{zhuo2yue4}
  \antonymref{模糊}{mo2hu5}
  \antonymref{微弱}{wei1ruo4}
  \antonymref{细微}{xi4wei1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{显然}{9,12}{⽇,⽕}
  ...
  \synonymref{分明}{fen1ming2}
  \synonymref{赫然}{he4ran2}
  \synonymref{明明}{ming2ming2}
  \synonymref{明确}{ming2que4}
  \synonymref{明显}{ming2xian3}
  \synonymref{鲜明}{xian1ming2}
  \antonymref{含蓄}{han2xu4}
  \antonymref{隐约}{yin3yue1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{显赫}{9,14}{⽇,⾚}
  \begin{Phonetics}{显赫}{xian3he4}[][HSK 7-9]
...
\begin{Entry}{枯木}{9,4}{⽊,⽊}
  \begin{Phonetics}{枯木}{ku1mu4}
    \definition{s.}{árvore morta;  árvore ressequida}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{柏}{9}{⽊}
  \begin{Phonetics}{柏}{bai3}
    \definition*{s.}{Bai (nome de um antigo estado da China) | Sobrenome: Bai}
    \definition{s.}{cipreste; zimbro chinês; também conhecido como tuia chinesa ou cipreste plano | madeira de cipreste}
...
\begin{Entry}{查看}{9,9}{⽊,⽬}
  ...
  \seealsoref{查阅}{cha2yue4}
  \synonymref{察看}{cha2kan4}
  \synonymref{观察}{guan1cha2}
  \synonymref{检察}{jian3cha2}
  \synonymref{检查}{jian3cha2}
  \synonymref{审查}{shen3cha2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{查阅}{9,10}{⽊,⾨}
  \begin{Phonetics}{查阅}{cha2yue4}
    \definition{v.}{consultar; pesquisar; verificar; procurar e ler as seções relevantes de livros, documentos, etc.}
  \seealsoref{查看}{cha2kan4}
  \synonymref{查找}{cha2zhao3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{柱子}{9,3}{⽊,⼦}
  \begin{Phonetics}{柱子}{zhu4zi5}[][HSK 6]
    \definition[根]{s.}{poste; pilar; coluna; estrutura de suporte vertical de um edifício, feita de madeira, pedra, aço, concreto armado, etc.}
  \synonymref{栋梁}{dong4liang2}
...
\begin{Entry}{标志}{9,7}{⽊,⼼}
  ...
  \seealsoref{记号}{ji4hao5}
  \synonymref{标示}{biao1shi4}
  \synonymref{符号}{fu2hao4}
  \synonymref{象征}{xiang4zheng1}
...
\begin{Entry}{栏目}{9,5}{⽊,⽬}
  ...
  \synonymref{频道}{pin2dao4}
  \synonymref{项目}{xiang4mu4}
  \synonymref{专栏}{zhuan1lan2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{树莓}{9,10}{⽊,⾋}
  \begin{Phonetics}{树莓}{shu4mei2}
    \definition{s.}{amora silvestre | framboesa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{歪}{9}{⽌}
  \begin{Phonetics}{歪}{wai1}[][HSK 7-9]
...
\begin{Entry}{歪曲}{9,6}{⽌,⽈}
  \begin{Phonetics}{歪曲}{wai1qu1}[][HSK 7-9]
...
\begin{Entry}{歪果仁}{9,8,4}{⽌,⽊,⼈}
  \begin{Phonetics}{歪果仁}{wai1 guo3ren2}
    \definition{s.}{gíria na \emph{Internet} para estrangeiro (外国人)}
  \seealsoref{外国人}{wai4guo2ren2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{残疾}{9,10}{⽍,⽧}
  ...
  \synonymref{伤残}{shang1can2}
  \synonymref{瘫痪}{tan1huan4}
...
\begin{Entry}{残酷}{9,14}{⽍,⾣}
  ...
  \seealsoref{残忍}{can2ren3}
  \synonymref{冷酷}{leng3ku4}
  \synonymref{凶残}{xiong1can2}
...
\begin{Entry}{毒}{9}{⽏}
  \begin{Phonetics}{毒}{du2}[][HSK 5]
    ...
    \definition[种]{s.}{veneno; toxina; propriedade ou substância prejudicial aos organismos vivos | droga; narcóticos | vírus; vírus de computador | influência venenosa}
...
\begin{Entry}{洋葱}{9,12}{⽔,⾋}
  \begin{Phonetics}{洋葱}{yang2cong1}
    \definition[个,只,些]{s.}{cebola}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{洋溢}{9,13}{⽔,⽔}
  \begin{Phonetics}{洋溢}{yang2yi4}[][HSK 7-9]
...
\begin{Entry}{洒水}{9,4}{⽔,⽔}
  \begin{Phonetics}{洒水}{sa3shui3}
    \definition{s.}{borrifo}
    \definition{v.}{borrifar (ou pulverizar) água}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{洗手}{9,4}{⽔,⼿}
  \begin{Phonetics}{洗手}{xi3shou3}
    \definition{v.}{lavar as mãos; eufemismo, referente ao ato de ir ao banheiro | parar de praticar o mal e reformar"-se; refere"-se metaforicamente a ladrões, jogadores ou outros que se reformam e recomeçam a vida | desistir; lavar as mãos de algo; abandono de determinada profissão}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{洗手乳}{9,4,8}{⽔,⼿,⼄}
  \begin{Phonetics}{洗手乳}{xi3shou3 ru3}
...
\begin{Entry}{洗发皂}{9,5,7}{⽔,⼜,⽩}
  \begin{Phonetics}{洗发皂}{xi3fa4 zao4}
    \definition{s.}{xampu}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{洗礼}{9,5}{⽔,⽰}
  \begin{Phonetics}{洗礼}{xi3li3}[][HSK 7-9]
    \definition[次,场]{s.}{batismo; uma cerimônia religiosa realizada quando um cristão se converte ao cristianismo, na qual água é aspergida na testa da pessoa que está sendo batizada, ou seu corpo é imerso em água, para simbolizar a purificação dos pecados passados | teste severo; treinamento e testes rigorosos}
...
\begin{Entry}{洗涤间}{9,10,7}{⽔,⽔,⾨}
  \begin{Phonetics}{洗涤间}{xi3di2 jian1}
    \definition{s.}{lavanderia}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{洗涤剂}{9,10,8}{⽔,⽔,⼑}
  \begin{Phonetics}{洗涤剂}{xi3di2ji4}[][HSK 7-9]
...
\begin{Entry}{洞}{9}{⽔}
  \begin{Phonetics}{洞}{dong4}[][HSK 5]
    ...
    \definition{adv.}{profundamente; completamente}
    \definition{num.}{0; número zero; usado para substituir o 零 ao falar números}
    \definition{s.}{buraco; cavidade; orifício; furo; parte penetrante ou profundamente recuada de um objeto; uma caverna}
    \definition{v.}{penetrar, perfurar}
  \seealsoref{零}{ling2}
  \synonymref{孔}{kong3}
  \synonymref{穴}{xue2}
  \end{Phonetics}
...
\begin{Entry}{洞穴}{9,5}{⽔,⽳}
  \begin{Phonetics}{洞穴}{dong4xue2}
    \definition[个]{s.}{caverna; gruta; cavernas subterrâneas ou nas montanhas que podem abrigar pessoas ou animais}
  \synonymref{窟窿}{ku1long5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{洞庭}{9,9}{⽔,⼴}
  \begin{Phonetics}{洞庭}{dong4ting2}
    \definition*{s.}{Lago Dongting}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{津}{9}{⽔}
  \begin{Phonetics}{津}{jin1}
    ...
    \definition{s.}{suor | travessia de balsa; vau; balsa | cargos importantes | saliva}
...
\begin{Entry}{活动}{9,6}{⽔,⼒}
  ...
  \seealsoref{运动}{yun4dong4}
  \synonymref{动摇}{dong4yao2}
  \synonymref{动弹}{dong4tan5}
  \synonymref{举动}{ju3dong4}
  \synonymref{行动}{xing2dong4}
  \synonymref{行为}{xing2wei2}
...
\begin{Entry}{活动室}{9,6,9}{⽔,⼒,⼧}
  \begin{Phonetics}{活动室}{huo2dong4 shi4}[][HSK 5]
    \definition{s.}{sala de atividades}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{活着}{9,11}{⽔,⽬}
  \begin{Phonetics}{活着}{huo2zhe5}
    \definition{v.}{viver; passar a vida | estar vivo | sobreviver}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{活路}{9,13}{⽔,⾜}
  \begin{Phonetics}{活路}{huo2lu4}
    \definition{s.}{trabalho físico | meios de subsistência; formas de ganhar a vida | método viável; abordagem viável}
  \seealsoref{出路}{chu1lu4}
  \end{Phonetics}
  \begin{Phonetics}{活路}{huo2lu5}
    \definition{s.}{trabalho | trabalho físico}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{派}{9}{⽔}
  \begin{Phonetics}{派}{pa1}
    \definition[个,块,种]{s.}{passe; cartão de entrada}
    \definition{v.}{passar por; alcançar; atravessar; isso indica que o documento foi aprovado}
  \end{Phonetics}
...
\begin{Entry}{测定}{9,8}{⽔,⼧}
  ...
  \synonymref{测量}{ce4liang2}
  \synonymref{测试}{ce4shi4}
  \synonymref{检测}{jian3ce4}
  \synonymref{判定}{pan4ding4}
  \antonymref{猜测}{cai1ce4}
  \antonymref{估计}{gu1ji4}
  \antonymref{评估}{ping2gu1}
  \antonymref{推测}{tui1ce4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{测试}{9,8}{⽔,⾔}
  ...
  \seealsoref{测验}{ce4//yan4}
  \synonymref{测量}{ce4liang2}
  \synonymref{检测}{jian3ce4}
  \synonymref{检验}{jian3yan4}
  \synonymref{考试}{kao3//shi4}
  \synonymref{评估}{ping2gu1}
  \synonymref{验收}{yan4shou1}
  \synonymref{诊断}{zhen3duan4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{测验}{9,10}{⽔,⾺}
  \begin{Phonetics}{测验}{ce4//yan4}[][HSK 7-9]
    \definition[次,个]{s.}{teste; execução de teste; testes com instrumentos ou outros métodos}
    \definition{v.+compl.}{testar; verificar o desempenho acadêmico, etc.}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{测量}{9,12}{⽔,⾥}
  ...
  \seealsoref{测验}{ce4//yan4}
  \synonymref{测定}{ce4ding4}
  \synonymref{测算}{ce4suan4}
  \synonymref{衡量}{heng2liang5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{炸药}{9,9}{⽕,⾋}
  ...
  \synonymref{火药}{huo3yao4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{炸弹}{9,11}{⽕,⼸}
  \begin{Phonetics}{炸弹}{zha4dan4}[][HSK 6]
    \definition[个,枚,颗]{s.}{bomba; uma arma com invólucro de ferro e explosivos dentro que explodem quando um fusível é acionado, geralmente lançada de um avião}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{点燃}{9,16}{⽕,⽕}
  ...
  \seealsoref{点}{dian3}
  \synonymref{点火}{dian3//huo3}
  \synonymref{焚烧}{fen2shao1}
  \synonymref{燃放}{ran2fang4}
  \synonymref{燃烧}{ran2shao1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{独立}{9,5}{⽝,⽴}
  ...
  \synonymref{孤独}{gu1du2}
  \synonymref{孤立}{gu1li4}
  \synonymref{自立}{zi4li4}
  \synonymref{自主}{zi4zhu3}
  \antonymref{附属}{fu4shu3}
  \antonymref{寄生}{ji4sheng1}
...
\begin{Entry}{独自}{9,6}{⽝,⾃}
  ...
  \seealsoref{单独}{dan1du2}
  \synonymref{单身}{dan1shen1}
  \synonymref{只身}{zhi1shen1}
...
\begin{Entry}{狭义}{9,3}{⽝,⼂}
  \begin{Phonetics}{狭义}{xia2yi4}[][HSK 7-9]
...
\begin{Entry}{狭小}{9,3}{⽝,⼩}
  \begin{Phonetics}{狭小}{xia2xiao3}[][HSK 7-9]
...
\begin{Entry}{狭窄}{9,10}{⽝,⽳}
  \begin{Phonetics}{狭窄}{xia2zhai3}[][HSK 7-9]
...
\begin{Entry}{狭隘}{9,12}{⽝,⾩}
  \begin{Phonetics}{狭隘}{xia2'ai4}[][HSK 7-9]
...
\begin{Entry}{珍视}{9,8}{⽟,⾒}
  \begin{Phonetics}{珍视}{zhen1shi4}[][HSK 7-9]
...
\begin{Entry}{珍重}{9,9}{⽟,⾥}
  \begin{Phonetics}{珍重}{zhen1zhong4}[][HSK 7-9]
...
\begin{Entry}{珍藏}{9,17}{⽟,⾋}
  \begin{Phonetics}{珍藏}{zhen1cang2}[][HSK 7-9]
...
\begin{Entry}{甚而}{9,6}{⽢,⽽}
  \begin{Phonetics}{甚而}{shen4'er2}
    ...
    \definition{conj.}{(ir) tão longe a ponto de; tanto que}
...
\begin{Entry}{甚至}{9,6}{⽢,⾄}
  ...
  \seealsoref{乃至}{nai3zhi4}
  \synonymref{甚而}{shen4'er2}
  \synonymref{甚或}{shen4huo4}
...
\begin{Entry}{甚或}{9,8}{⽢,⼽}
  \begin{Phonetics}{甚或}{shen4huo4}
    \definition{adv.}{até (na medida em que)}
    \definition{conj.}{(ir) tão longe a ponto de; tanto que | na medida em que}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{界碑}{9,13}{⽥,⽯}
  \begin{Phonetics}{界碑}{jie4bei1}
    \definition{s.}{placa (ou marcador) de limite | pedra de demarcação | placa que marca a fronteira entre duas regiões, distritos, etc.}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 畏 %%%%%%%%%%
\subsection*{畏}\addcontentsline{loh}{figure}{畏}

\begin{Entry}{畏}{9}{⽥}
  \begin{Phonetics}{畏}{wei4}
...
\begin{Entry}{畏惧}{9,11}{⽥,⼼}
  \begin{Phonetics}{畏惧}{wei4ju4}[][HSK 7-9]
...
\begin{Entry}{畏缩}{9,14}{⽥,⽷}
  \begin{Phonetics}{畏缩}{wei4suo1}[][HSK 7-9]
...
%%%%%%%%%% 疫 %%%%%%%%%%
\subsection*{疫}\addcontentsline{loh}{figure}{疫}

\begin{Entry}{疫}{9}{⽧}
  \begin{Phonetics}{疫}{yi4}
    \definition[场]{s.}{epidemia; doença epidêmica; pestilência; praga}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{疫苗}{9,8}{⽧,⾋}
  \begin{Phonetics}{疫苗}{yi4miao2}[][HSK 7-9]
...
\begin{Entry}{盆}{9}{⽫}
  \begin{Phonetics}{盆}{pen2}[][HSK 5]
    ...
    \definition{clas.}{usado para bacias; banheiras; vasos}
...
%%%%%%%%%% 盈 %%%%%%%%%%
\subsection*{盈}\addcontentsline{loh}{figure}{盈}

\begin{Entry}{盈}{9}{⽫}
  \begin{Phonetics}{盈}{ying2}
...
\begin{Entry}{盈利}{9,7}{⽫,⼑}
  \begin{Phonetics}{盈利}{ying2//li4}[][HSK 7-9]
...
\begin{Entry}{相反}{9,4}{⽬,⼜}
  ...
  \seealsoref{相对}{xiang1dui4}
  \synonymref{对立}{dui4li4}
  \synonymref{反倒}{fan3dao4}
  \antonymref{类似}{lei4si4}
  \antonymref{相似}{xiang1si4}
  \antonymref{相同}{xiang1tong2}
  \antonymref{一致}{yi2zhi4}
  \end{Phonetics}
...
\begin{Entry}{相比}{9,4}{⽬,⽐}
  ...
  \synonymref{比较}{bi3jiao4}
  \synonymref{对比}{dui4bi3}
  \synonymref{对照}{dui4zhao4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{相比之下}{9,4,3,3}{⽬,⽐,⼂,⼀}
  \begin{Phonetics}{相比之下}{xiang1bi3 zhi1xia4}[][HSK 7-9]
...
\begin{Entry}{相对}{9,5}{⽬,⼨}
  \begin{Phonetics}{相对}{xiang1dui4}[][HSK 7-9]
...
\begin{Entry}{相对而言}{9,5,6,7}{⽬,⼨,⽽,⾔}
  \begin{Phonetics}{相对而言}{xiang1dui4-er2yan2}[][HSK 7-9]
...
\begin{Entry}{相传}{9,6}{⽬,⼈}
  \begin{Phonetics}{相传}{xiang1chuan2}[][HSK 7-9]
...
\begin{Entry}{相似}{9,6}{⽬,⼈}
  \begin{Phonetics}{相似}{xiang1si4}[][HSK 3]
    \definition{adj.}{semelhante; similar; parecido; análogo}
  \seealsoref{相像}{xiang1xiang4}
  \synonymref{好像}{hao3xiang4}
  \synonymref{雷同}{lei2tong2}
  \synonymref{类似}{lei4si4}
...
\begin{Entry}{相当于}{9,6,3}{⽬,⼹,⼆}
  \begin{Phonetics}{相当于}{xiang1dang1yu2}[][HSK 7-9]
...
\begin{Entry}{相约}{9,6}{⽬,⽷}
  \begin{Phonetics}{相约}{xiang1yue1}[][HSK 7-9]
...
\begin{Entry}{相伴}{9,7}{⽬,⼈}
  \begin{Phonetics}{相伴}{xiang1ban4}[][HSK 7-9]
...
\begin{Entry}{相应}{9,7}{⽬,⼴}
  \begin{Phonetics}{相应}{xiang1ying1}
    \definition{v.}{deveria; comumente usado em documentos oficiais antigos}
  \synonymref{对应}{dui4ying4}
  ...
  \synonymref{顺应}{shun4ying4}
  \synonymref{响应}{xiang3ying4}
  \synonymref{照应}{zhao4ying4}
  \end{Phonetics}
  \begin{Phonetics}{相应}{xiang1ying5}
    \definition{adj.}{barato; um bom negócio}
  \synonymref{对应}{dui4ying4}
  \synonymref{响应}{xiang3ying4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{相识}{9,7}{⽬,⾔}
  \begin{Phonetics}{相识}{xiang1shi2}[][HSK 7-9]
  ...
  \synonymref{遇见}{yu4jian4}
  \antonymref{陌生}{mo4sheng1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{相连}{9,7}{⽬,⾡}
  \begin{Phonetics}{相连}{xiang1lian2}[][HSK 7-9]
...
\begin{Entry}{相依为命}{9,8,4,8}{⽬,⼈,⼂,⼝}
  \begin{Phonetics}{相依为命}{xiang1yi1-wei2ming4}[][HSK 7-9]
...
\begin{Entry}{相差}{9,9}{⽬,⼯}
  \begin{Phonetics}{相差}{xiang1cha4}[][HSK 7-9]
...
\begin{Entry}{相继}{9,10}{⽬,⽷}
  \begin{Phonetics}{相继}{xiang1ji4}[][HSK 7-9]
    \definition{adv.}{em sucessão; um após o outro}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{相通}{9,10}{⽬,⾡}
  \begin{Phonetics}{相通}{xiang1tong1}[][HSK 7-9]
  ...
  \synonymref{相同}{xiang1tong2}
  \synonymref{一样}{yi2yang4}
  \antonymref{接续}{jie1xu4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{相辅相成}{9,11,9,6}{⽬,⾞,⽬,⼽}
  \begin{Phonetics}{相辅相成}{xiang1fu3-xiang1cheng2}[][HSK 7-9]
    \definition{expr.}{complementam"-se mutuamente; complementar"-se um ao outro; cooperem entre si}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{相提并论}{9,12,6,6}{⽬,⼿,⼲,⾔}
  \begin{Phonetics}{相提并论}{xiang1ti2-bing4lun4}[][HSK 7-9]
...
\begin{Entry}{相遇}{9,12}{⽬,⾡}
  \begin{Phonetics}{相遇}{xiang1yu4}[][HSK 7-9]
...
\begin{Entry}{相像}{9,13}{⽬,⼈}
  \begin{Phonetics}{相像}{xiang1xiang4}
    \definition{adj.}{semelhante; similar; parecido; análogo; em comum}
    \definition{v.}{semelhante; similar; parecido; em comum}
  \synonymref{好像}{hao3xiang4}
  \synonymref{雷同}{lei2tong2}
  \synonymref{类似}{lei4si4}
  \synonymref{相似}{xiang1si4}
...
\begin{Entry}{省力}{9,2}{⽬,⼒}
  \begin{Phonetics}{省力}{sheng3li4}
    \definition{v.}{economizar esforço; poupar trabalho; ampliar a força | economizar esforço; economizar mão de obra}
  \seealsoref{省劲儿}{sheng3 jin4r5}
  \seealsoref{省力气}{sheng3 li4qi4}
  \synonymref{轻松}{qing1song1}
  \synonymref{轻易}{qing1yi5}
  \antonymref{吃力}{chi1li4}
  \antonymref{费劲}{fei4//jin4}
  \antonymref{费力}{fei4li4}
  \antonymref{用力}{yong4//li4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{省力气}{9,2,4}{⽬,⼒,⽓}
  \begin{Phonetics}{省力气}{sheng3 li4qi4}
    \definition{v.}{economizar esforços}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{省心}{9,4}{⽬,⼼}
  \begin{Phonetics}{省心}{sheng3//xin1}
    \definition{adj.}{fácil; sem esforço; sem problemas; simples; sem complicações}
    \definition{v.+compl.}{evitar preocupações; não precisar se preocupar}
  \synonymref{安心}{an1xin1}
  \synonymref{安逸}{an1yi4}
  \synonymref{放心}{fang4xin1}
  \synonymref{简便}{jian3bian4}
  \synonymref{省事}{sheng3//shi4}
  \synonymref{省力}{sheng3li4}
...
\begin{Entry}{省劲儿}{9,7,2}{⽬,⼒,⼉}
  \begin{Phonetics}{省劲儿}{sheng3 jin4r5}
    \definition{v.}{poupar seu esforço}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{省却}{9,7}{⽬,⼙}
  \begin{Phonetics}{省却}{sheng3que4}
    \definition{v.}{economizar | livrar"-se de (para economizar espaço)}
  \synonymref{避免}{bi4mian3}
  \synonymref{除去}{chu2qu4}
  \synonymref{去掉}{qu4diao4}
...
\begin{Entry}{省俭}{9,9}{⽬,⼈}
  \begin{Phonetics}{省俭}{sheng3jian3}
    \definition{adj.}{econômico; frugal}
    \definition{v.}{economizar e poupar}
  \synonymref{节俭}{jie2jian3}
  \synonymref{节省}{jie2sheng3}
  \synonymref{节约}{jie2yue1}
  \antonymref{浪费}{lang4fei4}
...
\begin{Entry}{省钱}{9,10}{⽬,⾦}
  \begin{Phonetics}{省钱}{sheng3//qian2}[][HSK 6]
    ...
    \definition{v.+compl.}{economizar dinheiro}
  \synonymref{便宜}{pian2yi5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{省得}{9,11}{⽬,⼻}
  \begin{Phonetics}{省得}{sheng3de5}
    \definition{conj.}{para economizar; para evitar que uma determinada situação (ruim) ocorra; para impedir}
  \seealsoref{免得}{mian3de5}
  \synonymref{以免}{yi3mian3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{看}{9}{⽬}
  ...
  \seealsoref{打量}{da3liang5}
  \seealsoref{大量}{da4liang4}
  \seealsoref{端详}{duan1xiang2}
  \synonymref{瞅}{chou3}
  \synonymref{顾}{gu4}
  \synonymref{观}{guan1}
  \synonymref{观}{guan4}
...
\begin{Entry}{看上去}{9,3,5}{⽬,⼀,⼛}
  \begin{Phonetics}{看上去}{kan4 shang4qu4}[][HSK 3]
    \definition{adv.}{parece que}
  \seealsoref{看起来}{kan4 qi3lai5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{看不起}{9,4,10}{⽬,⼀,⾛}
  ...
  \seealsoref{歧视}{qi2shi4}
  \seealsoref{轻视}{qing1shi4}
  \synonymref{鄙视}{bi3shi4}
  \synonymref{瞧不起}{qiao2bu5qi3}
  \synonymref{轻蔑}{qing1mie4}
  \synonymref{小看}{xiao3kan4}
  \antonymref{看得起}{kan4de5qi3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{看见}{9,4}{⽬,⾒}
  \begin{Phonetics}{看见}{kan4jian5}[][HSK 1]
    \definition{v.}{ver; avistar; ao olhar, descobrir alguém ou algo}
  \seealsoref{看}{kan4}
  \synonymref{见到}{jian4dao4}
  \synonymref{看到}{kan4dao4}
  \synonymref{望见}{wang4jian4}
  \antonymref{忽视}{hu1shi4}
...
\begin{Entry}{看好}{9,6}{⽬,⼥}
  \begin{Phonetics}{看好}{kan1hao3}
    \definition{v.}{observar atentamente; ficar de olho em; cuidar de perto}
...
\begin{Entry}{看来}{9,7}{⽬,⽊}
  \begin{Phonetics}{看来}{kan4lai2}[][HSK 4]
  ...
  \seealsoref{看起来}{kan4 qi3lai5}
  \seealsoref{看样子}{kan4 yang4zi5}
  \synonymref{可见}{ke3jian4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{看样子}{9,10,3}{⽬,⽊,⼦}
  ...
  \seealsoref{看来}{kan4lai2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{看热闹}{9,10,8}{⽬,⽕,⾾}
  \begin{Phonetics}{看热闹}{kan4re4nao5}[][HSK 7-9]
...
\begin{Entry}{看病}{9,10}{⽬,⽧}
  ...
  \synonymref{就医}{jiu4//yi1}
  \synonymref{就诊}{jiu4//zhen3}
  \synonymref{求医}{qiu2yi1}
  \synonymref{治病}{zhi4bing4}
  \synonymref{治疗}{zhi4liao2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{看起来}{9,10,7}{⽬,⾛,⽊}
  \begin{Phonetics}{看起来}{kan4 qi3lai5}[][HSK 3]
    \definition{adv./v.}{parecer; aparentar; dar a impressão de (ou como se)}
  \seealsoref{看上去}{kan4 shang4qu4}
  \seealsoref{看来}{kan4lai2}
  \synonymref{看样子}{kan4 yang4zi5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{看得起}{9,11,10}{⽬,⼻,⾛}
  ...
  \synonymref{珍重}{zhen1zhong4}
  \synonymref{重视}{zhong4shi4}
  \antonymref{看不起}{kan4bu5qi3}
  \antonymref{瞧不起}{qiao2bu5qi3}
  \antonymref{轻视}{qing1shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{看淡}{9,11}{⽬,⽔}
  \begin{Phonetics}{看淡}{kan4dan4}
    \definition{v.}{(uma economia ou mercado) enfraquecer; os preços e as tendências de mercado estão em queda | ser indiferente à fama, riqueza, etc.; encarar a fama e a fortuna com leviandade e indiferença | considerar como sem importância; considerar algo ou alguém como insignificante}
...
\begin{Entry}{看管}{9,14}{⽬,⽵}
  ...
  \synonymref{保管}{bao3guan3}
  \synonymref{管理}{guan3li3}
  \synonymref{监管}{jian1guan3}
  \synonymref{监控}{jian1kong4}
  \synonymref{监视}{jian1shi4}
  \synonymref{照料}{zhao4liao4}
  \antonymref{不顾}{bu2gu4}
  \antonymref{不管}{bu4guan3}
  \antonymref{放任}{fang4ren4}
  \antonymref{忽视}{hu1shi4}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 眨 %%%%%%%%%%
\subsection*{眨}\addcontentsline{loh}{figure}{眨}

\begin{Entry}{眨}{9}{⽬}
  \begin{Phonetics}{眨}{zha3}
    \definition{v.}{piscar (o olho); olhos fechados e imediatamente abertos}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{眨眼}{9,11}{⽬,⽬}
  \begin{Phonetics}{眨眼}{zha3//yan3}[][HSK 7-9]
...
\begin{Entry}{砍刀}{9,2}{⽯,⼑}
  \begin{Phonetics}{砍刀}{kan3dao1}
    \definition[把]{s.}{facão | machete; uma faca para cortar lenha com lâmina longa, dorso grosso e cabo de madeira}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{砍头}{9,5}{⽯,⼤}
  \begin{Phonetics}{砍头}{kan3tou2}
    \definition{v.}{cortar a cabeça; decapitar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{砍价}{9,6}{⽯,⼈}
  \begin{Phonetics}{砍价}{kan3jia4}
    \definition{v.}{barganhar; negociar; reduzir ou baixar um preço}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{砍伤}{9,6}{⽯,⼈}
  \begin{Phonetics}{砍伤}{kan3shang1}
    \definition{v.}{ferir profundamente | talhar | ferir com uma lâmina ou machado}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{砍死}{9,6}{⽯,⽍}
  \begin{Phonetics}{砍死}{kan3si3}
    \definition{v.}{matar a golpes | matar com um machado}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{砍树}{9,9}{⽯,⽊}
  \begin{Phonetics}{砍树}{kan3shu4}
    \definition{v.}{derrubar árvores | cortar lenha}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{砍掉}{9,11}{⽯,⼿}
  \begin{Phonetics}{砍掉}{kan3diao4}
    \definition{s.}{amputação}
...
\begin{Entry}{砍断}{9,11}{⽯,⽄}
  \begin{Phonetics}{砍断}{kan3duan4}
    \definition{v.}{separar cortando em pedaços; cortar ao meio; desconectar}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{研讨}{9,5}{⽯,⾔}
  \begin{Phonetics}{研讨}{yan2tao3}[][HSK 7-9]
...
\begin{Entry}{砖}{9}{⽯}
  \begin{Phonetics}{砖}{zhuan1}[][HSK 7-9]
...
\begin{Entry}{祖国}{9,8}{⽰,⼞}
  ...
  \antonymref{外国}{wai4guo2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{祖宗}{9,8}{⽰,⼧}
  \begin{Phonetics}{祖宗}{zu3zong5}[][HSK 7-9]
...
\begin{Entry}{祖籍}{9,20}{⽰,⽵}
  \begin{Phonetics}{祖籍}{zu3ji2}[][HSK 7-9]
...
\begin{Entry}{祝告}{9,7}{⽰,⼝}
  \begin{Phonetics}{祝告}{zhu4gao4}
    \definition{v.}{rezar; orar; fazer as suas orações}
  \synonymref{祈祷}{qi2dao3}
  \synonymref{祝愿}{zhu4yuan4}
...
\begin{Entry}{祝寿}{9,7}{⽰,⼨}
  \begin{Phonetics}{祝寿}{zhu4shou4}
    \definition{v.}{parabenizar (uma pessoa idosa) pelo seu aniversário; enviar felicitações de aniversário a uma pessoa idosa; dar os parabéns de aniversário (a uma pessoa idosa); desejar um feliz aniversário a uma pessoa idosa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{祝贺}{9,9}{⽰,⾙}
  ...
  \seealsoref{祝愿}{zhu4yuan4}
  \synonymref{恭喜}{gong1xi3}
...
\begin{Entry}{祝酒}{9,10}{⽰,⾣}
  \begin{Phonetics}{祝酒}{zhu4jiu3}
    \definition{v.}{fazer um brinde; brindar; fazer um brinde a alguém é uma forma de expressar desejos e bênçãos}
  \synonymref{敬酒}{jing4//jiu3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{祝祷}{9,11}{⽰,⽰}
  \begin{Phonetics}{祝祷}{zhu4dao3}
    \definition{v.}{rezar; orar; fazer as suas orações}
  \seealsoref{祝告}{zhu4gao4}
  \synonymref{祈祷}{qi2dao3}
  \synonymref{祝福}{zhu4fu2}
  \synonymref{祝愿}{zhu4yuan4}
  \antonymref{谩骂}{man4ma4}
  \antonymref{唾骂}{tuo4ma4}
  \antonymref{咒骂}{zhou4ma4}
  \antonymref{诅咒}{zu3zhou4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{祝谢}{9,12}{⽰,⾔}
  \begin{Phonetics}{祝谢}{zhu4xie4}
    \definition{v.}{agradecer; dar graças}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{祝福}{9,13}{⽰,⽰}
  ...
  \synonymref{祈祷}{qi2dao3}
  \synonymref{庆贺}{qing4he4}
  \synonymref{祝贺}{zhu4he4}
  \synonymref{祝颂}{zhu4song4}
  \synonymref{祝愿}{zhu4yuan4}
  \antonymref{谩骂}{man4ma4}
  \antonymref{咒骂}{zhou4ma4}
  \antonymref{诅咒}{zu3zhou4}
...
\begin{Entry}{神仙}{9,5}{⽰,⼈}
  \begin{Phonetics}{神仙}{shen2xian1}[][HSK 7-9]
    \definition{s.}{pessoa livre das preocupações mundanas; monge iluminado; pessoa sem restrições e sem preocupações | (na ficção moderna) fada, elfo, duende etc.; figuras míticas possuem habilidades sobre"-humanas, transcendendo o reino mortal e alcançando a imortalidade; imortal | profeta; vidente; alguém que consegue prever ou compreender as coisas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{神色}{9,6}{⽰,⾊}
  \begin{Phonetics}{神色}{shen2se4}
    \definition{s.}{expressão; olhar}
  \seealsoref{神情}{shen2qing2}
  \synonymref{表情}{biao3qing2}
  \synonymref{脸色}{lian3se4}
  \synonymref{神气}{shen2qi4}
  \synonymref{神态}{shen2tai4}
  \synonymref{颜色}{yan2se4}
  \synonymref{样子}{yang4zi5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{神明}{9,8}{⽰,⽇}
  \begin{Phonetics}{神明}{shen2ming2}
    \definition{s.}{deuses; deidades; divindades; o nome coletivo de Deus}
  \antonymref{鬼怪}{gui3guai4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{神经过敏}{9,8,6,11}{⽰,⽷,⾡,⽁}
  \begin{Phonetics}{神经过敏}{shen2jing1 guo4min3}[][HSK 5]
    \definition{adj.}{neurótico; hipersensível | hiperestesia | hipersensível; diabolicamente nervoso | nervosismo; hipersensibilidade; Gíria: alérgico}
    \definition{s.}{neuroticismo; nervosismo | hiperestesia}
  \synonymref{大惊小怪}{da4jing1-xiao3guai4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{神秘人物}{9,10,2,8}{⽰,⽲,⼈,⽜}
  \begin{Phonetics}{神秘人物}{shen2mi4 ren2wu4}[][HSK 5]
    \definition{s.}{figura misteriosa; pessoa misteriosa}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{神兽}{9,11}{⽰,⼋}
  \begin{Phonetics}{神兽}{shen2shou4}
    \definition{s.}{animal mitológico}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{神器}{9,16}{⽰,⼝}
  \begin{Phonetics}{神器}{shen2qi4}
    \definition[种]{s.}{trono; poder imperial | arma ou instrumento mágico | arma divina | objeto mágico | objeto simbólico do poder imperial}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{秋季}{9,8}{⽲,⼦}
  ...
  \synonymref{秋天}{qiu1tian1}
  \antonymref{春季}{chun1ji4}
  \antonymref{冬季}{dong1ji4}
...
\begin{Entry}{种}{9}{⽲}
  \begin{Phonetics}{种}{chong2}
    \definition*{s.}{Sobenome: Chong}
  \end{Phonetics}
...
\begin{Entry}{种地}{9,6}{⽲,⼟}
  \begin{Phonetics}{种地}{zhong4//di4}
    \definition{v.}{cultivar a terra; realizar trabalhos agrícolas; trabalhar na terra; envolver"-se em trabalho de campo}
...
\begin{Entry}{种族}{9,11}{⽲,⽅}
  \begin{Phonetics}{种族}{zhong3zu2}[][HSK 7-9]
...
\begin{Entry}{科技}{9,7}{⽲,⼿}
  ...
  \synonymref{科学}{ke1xue2}
  \synonymref{研究}{yan2jiu1}
  \antonymref{传统}{chuan2tong3}
  \antonymref{迷信}{mi2xin4}
...
\begin{Entry}{科学}{9,8}{⽲,⼦}
  ...
  \synonymref{科技}{ke1ji4}
  \synonymref{科研}{ke1yan2}
  \antonymref{迷信}{mi2xin4}
  \antonymref{算命}{suan4ming4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{穿小鞋}{9,3,15}{⽳,⼩,⾰}
  \begin{Phonetics}{穿小鞋}{chuan1//xiao3xie2}[][HSK 7-9]
    \definition{v.+compl.}{dar a alguém sapatos apertados para usar; dificultar as coisas para alguém abusando do seu poder; dificultar secretamente as coisas para alguém ou impor restrições ou obstáculos a essa pessoa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{穿越}{9,12}{⽳,⾛}
  \begin{Phonetics}{穿越}{chuan1//yue4}[][HSK 7-9]
    \definition{v.+compl.}{passar através de; cortar através de; atravessar; passar por cima}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{结业}{9,5}{⽷,⼀}
  \begin{Phonetics}{结业}{jie2//ye4}
    \definition{v.+compl.}{terminar os estudos (geralmente referindo"-se a treinamentos de curta duração); concluir um curso | (uma empresa) encerrar as atividades}
  \seealsoref{毕业}{bi4//ye4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{结束工作}{9,7,3,7}{⽷,⽊,⼯,⼈}
  \begin{Phonetics}{结束工作}{jie2shu4 gong1zuo4}
...
\begin{Entry}{结束语}{9,7,9}{⽷,⽊,⾔}
  ...
  \antonymref{开场白}{kai1chang3bai2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{结束辩论}{9,7,16,6}{⽷,⽊,⾟,⾔}
  \begin{Phonetics}{结束辩论}{jie2shu4 bian4lun4}
...
\begin{Entry}{结社自由}{9,7,6,5}{⽷,⽰,⾃,⽥}
  \begin{Phonetics}{结社自由}{jie2she4zi4you2}
    \definition*{s.}{Liberdade de Associação (Constitucional)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{结构}{9,8}{⽷,⽊}
  ...
  \synonymref{布局}{bu4ju2}
  \synonymref{格局}{ge2ju2}
  \synonymref{构成}{gou4cheng2}
  \synonymref{构造}{gou4zao4}
  \synonymref{组织}{zu3zhi1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{结果}{9,8}{⽷,⽊}
  \begin{Phonetics}{结果}{jie1guo3}[][HSK 7-9]
    \definition{s.}{frutificar; dar frutos}
  \seealsoref{最后}{zui4hou4}
  \synonymref{结局}{jie2ju2}
  \synonymref{结束}{jie2shu4}
  \synonymref{效果}{xiao4guo3}
  \antonymref{过程}{guo4cheng2}
  \antonymref{开始}{kai1shi3}
  \antonymref{起初}{qi3chu1}
  \antonymref{前期}{qian2qi1}
  \antonymref{原因}{yuan2yin1}
  \end{Phonetics}
...
\begin{Entry}{结婚礼服}{9,11,5,8}{⽷,⼥,⽰,⽉}
  \begin{Phonetics}{结婚礼服}{jie2hun1 li3fu2}
    \definition{s.}{vestido de casamento; vestido de noiva}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{结婚礼物}{9,11,5,8}{⽷,⼥,⽰,⽜}
  \begin{Phonetics}{结婚礼物}{jie2hun1 li3wu4}[][HSK 5]
    \definition{s.}{presente de casamento}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{结婚戒指}{9,11,7,9}{⽷,⼥,⼽,⼿}
  \begin{Phonetics}{结婚戒指}{jie2hun1 jie4zhi3}[][HSK 5]
    \definition{s.}{aliança de casamento; alianças de casamento têm origem no antigo Egito; naquela época, tanto o anel de noivado quanto o de casamento faziam parte do contrato;  nos tempos modernos, é comum trocar alianças no casamento; antes do casamento, o anel é usado no dedo anelar da mão direita e, após o casamento, no dedo anelar da mão esquerda, simbolizando que a mão esquerda está ligada ao coração, representando um laço profundo e duradouro}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{结晶}{9,12}{⽷,⽇}
  \begin{Phonetics}{结晶}{jie2jing1}[][HSK 7-9]
    \definition{s.}{cristal; substâncias cristalinas | Figurativo: os frutos (do trabalho ou da atividade); conquistas preciosas}
...
\begin{Entry}{绕}{9}{⽷}
  \begin{Phonetics}{绕}{rao3}
    \definition{v.}{enrolar; torcer; amarrar; usado para descrever algo como circundante, envolvente, entrelaçado ou persistente}
  \end{Phonetics}
...
\begin{Entry}{给予}{9,4}{⽷,⼅}
  ...
  \synonymref{予以}{yu3yi3}
  \antonymref{剥削}{bo1xue1}
  \antonymref{换取}{huan4qu3}
  \antonymref{接收}{jie1shou1}
  \antonymref{接受}{jie1shou4}
  \antonymref{强占}{qiang2zhan4}
  \antonymref{丧失}{sang4shi1}
  \antonymref{受到}{shou4dao4}
...
\begin{Entry}{绝不}{9,4}{⽷,⼀}
  \begin{Phonetics}{绝不}{jue2bu4}
    \definition{adv.}{absolutamente não; nem um pouco; de modo algum; de jeito nenhum}
  \synonymref{从不}{cong2bu4}
  \synonymref{毫不}{hao2bu4}
  \antonymref{必然}{bi4ran2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{绝对}{9,5}{⽷,⼨}
  ...
  \synonymref{无条件}{wu2tiao2jian4}
  \synonymref{无疑}{wu2yi2}
  \antonymref{可能}{ke3neng2}
  \antonymref{未必}{wei4bi4}
  \antonymref{温和}{wen1he2}
  \antonymref{相对}{xiang1dui4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{绝望}{9,11}{⽷,⽉}
  ...
  \antonymref{憧憬}{chong1jing3}
  \antonymref{盼望}{pan4wang4}
  \antonymref{期待}{qi1dai4}
  \antonymref{期望}{qi1wang4}
  \antonymref{奢望}{she1wang4}
  \antonymref{希望}{xi1wang4}
  \antonymref{有望}{you3wang4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{统一}{9,1}{⽷,⼀}
  ...
  \synonymref{联合}{lian2he2}
  \synonymref{融合}{rong2he2}
  \synonymref{同一}{tong2yi1}
  \synonymref{团结}{tuan2jie2}
  \synonymref{一致}{yi2zhi4}
  \antonymref{对立}{dui4li4}
  \antonymref{分化}{fen1hua4}
...
\begin{Entry}{统治}{9,8}{⽷,⽔}
  \begin{Phonetics}{统治}{tong3zhi4}[][HSK 7-9]
...
\begin{Entry}{统治者}{9,8,8}{⽷,⽔,⽼}
  \begin{Phonetics}{统治者}{tong3zhi4 zhe3}[][HSK 5]
    \definition{s.}{governante}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{统统}{9,9}{⽷,⽷}
  \begin{Phonetics}{统统}{tong3tong3}[][HSK 7-9]
...
\begin{Entry}{统筹}{9,13}{⽷,⽵}
  \begin{Phonetics}{统筹}{tong3chou2}[][HSK 7-9]
...
\begin{Entry}{罚款}{9,12}{⽹,⽋}
  \begin{Phonetics}{罚款}{fa2kuan3}[][HSK 5]
    ...
    \definition{v.}{multar; penalizar; exigir, de acordo com os regulamentos, uma determinada quantia de dinheiro de uma pessoa ou entidade que tenha violado a lei ou descumprido um regulamento ou contrato}
  \synonymref{处罚}{chu3fa2}
  \antonymref{奖金}{jiang3jin1}
  \antonymref{奖励}{jiang3li4}
  \antonymref{赏赐}{shang3ci4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{美术}{9,5}{⽺,⽊}
  ...
  \synonymref{图画}{tu2hua4}
  \synonymref{艺术}{yi4shu4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{美甲}{9,5}{⽺,⽥}
  \begin{Phonetics}{美甲}{mei3jia3}
    \definition{s.}{manicure; pedicure}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{美国}{9,8}{⽺,⼞}
  \begin{Phonetics}{美国}{mei3guo2}
    \definition*{s.}{EUA; os Estados Unidos da América}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{美国人}{9,8,2}{⽺,⼞,⼈}
  \begin{Phonetics}{美国人}{mei3guo2 ren2}
    \definition[个,位,名]{s.}{americano | pessoa ou povo dos Estados Unidos da América}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{美洲}{9,9}{⽺,⽔}
  \begin{Phonetics}{美洲}{mei3zhou1}
    \definition*{s.}{América (incluindo Norte, Central e Sul), abreviação de 亚美利加洲}
  \seealsoref{亚美利加洲}{ya4mei3li4jia1 zhou1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{美洲人}{9,9,2}{⽺,⽔,⼈}
  \begin{Phonetics}{美洲人}{mei3zhou1 ren2}
...
\begin{Entry}{胃}{9}{⾁}
  ...
  \seealsoref{肚子}{du3zi5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{胃口}{9,3}{⾁,⼝}
  \begin{Phonetics}{胃口}{wei4kou3}[][HSK 7-9]
...
\begin{Entry}{胆小}{9,3}{⾁,⼩}
  ...
  \seealsoref{胆怯}{dan3qie4}
  \synonymref{软弱}{ruan3ruo4}
  \antonymref{大胆}{da4dan3}
  \antonymref{勇敢}{yong3gan3}
  \antonymref{勇于}{yong3yu2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{胆小鬼}{9,3,9}{⾁,⼩,⿁}
  \begin{Phonetics}{胆小鬼}{dan3xiao3gui3}[][HSK 5]
    \definition[个,群]{s.}{chorão; covarde; medroso; uma pessoa com pouca coragem (em tom sarcástico)}
  \antonymref{勇士}{yong3shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{背包}{9,5}{⾁,⼓}
  ...
  \synonymref{书包}{shu1bao1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{背包袱}{9,5,11}{⾁,⼓,⾐}
  \begin{Phonetics}{背包袱}{bei1//bao1fu5}[][HSK 5]
    \definition{v.+compl.}{carregar bagagem; ter um peso (ou uma carga) na mente;  tornar"-se um fardo para a mente; carregar um fardo nas costas; assumir uma carga mental; alguém que carrega um fardo que influencia seus pensamentos ou ações}
...
\begin{Entry}{背后}{9,6}{⾁,⼝}
  ...
  \synonymref{背面}{bei4mian4}
  \synonymref{反面}{fan3mian4}
  \synonymref{后头}{hou4tou5}
  \synonymref{私下}{si1xia4}
  \synonymref{偷偷}{tou1tou1}
  \antonymref{当面}{dang1mian4}
  \antonymref{当众}{dang1zhong4}
  \antonymref{前面}{qian2mian4}
...
\begin{Entry}{背叛}{9,9}{⾁,⼜}
  ...
  \seealsoref{叛变}{pan4bian4}
  \synonymref{出卖}{chu1mai4}
  \antonymref{忠诚}{zhong1cheng2}
  \antonymref{忠实}{zhong1shi2}
  \antonymref{忠心}{zhong1xin1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{背诵}{9,9}{⾁,⾔}
  ...
  \seealsoref{朗诵}{lang3song4}
  \synonymref{记忆}{ji4yi4}
  \synonymref{牢记}{lao2ji4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{背面}{9,9}{⾁,⾯}
  ...
  \synonymref{反面}{fan3mian4}
  \synonymref{负面}{fu4mian4}
  \synonymref{后面}{hou4mian4}
  \synonymref{后头}{hou4tou5}
...
\begin{Entry}{背景}{9,12}{⾁,⽇}
  ...
  \synonymref{后台}{hou4tai2}
  \antonymref{前景}{qian2jing3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{背黑锅}{9,12,12}{⾁,⿊,⾦}
  \begin{Phonetics}{背黑锅}{bei1//hei1guo1}[][HSK 5]
    \definition{v.+compl.}{servir de bode expiatório; ser injustamente culpado; assumir a culpa ou pagar o pato por outra pessoa; em sentido amplo, refere"-se a sofrer uma injustiça}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 胎 %%%%%%%%%%
\subsection*{胎}\addcontentsline{loh}{figure}{胎}

\begin{Entry}{胎}{9}{⾁}
  \begin{Phonetics}{胎}{tai1}[][HSK 7-9]
...
\begin{Entry}{胎儿}{9,2}{⾁,⼉}
  \begin{Phonetics}{胎儿}{tai1'er2}[][HSK 7-9]
...
\begin{Entry}{胖}{9}{⾁}
  \begin{Phonetics}{胖}{pan2}
    \definition{adj.}{gordo; robusto; rechonchudo | fácil e confortável}
  \synonymref{肥}{fei2}
  \antonymref{瘦}{shou4}
  \end{Phonetics}
...
\begin{Entry}{胚}{9}{⾁}
  \begin{Phonetics}{胚}{pei1}
    \definition[个]{s.}{embrião, um organismo em seus estágios iniciais de desenvolvimento}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{胜}{9}{⾁}
  \begin{Phonetics}{胜}{sheng1}
    \definition[场]{s.}{peptídeo (composto químico orgânico), ver 肽}
  \seealsoref{肽}{tai4}
  \end{Phonetics}
  \begin{Phonetics}{胜}{sheng4}[][HSK 3]
    ...
    \definition{v.}{vencer | derrotar | (frequentemente seguido por 于 ou 过) superar; ser superior a; levar a melhor sobre | vencer; ter sucesso; derrotar o adversário | ultrapassar; ser superior ao outro | suportar; ser capaz de suportar ou aguentar}
  \seealsoref{过}{guo4}
  \seealsoref{赢}{ying2}
  \seealsoref{于}{yu2}
  \antonymref{败}{bai4}
...
\begin{Entry}{胜利}{9,7}{⾁,⼑}
  ...
  \seealsoref{成功}{cheng2//gong1}
  \synonymref{获胜}{huo4sheng4}
  \synonymref{取胜}{qu3sheng4}
  \antonymref{挫折}{cuo4zhe2}
  \antonymref{失利}{shi1//li4}
  \antonymref{失败}{shi1bai4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{胜利者}{9,7,8}{⾁,⼑,⽼}
  \begin{Phonetics}{胜利者}{sheng4li4 zhe3}[][HSK 5]
    \definition{s.}{ganhador; vencedor}[真正的胜利者是谦虚的。===Os verdadeiros vencedores são humildes.]
  \end{Phonetics}
\end{Entry}

\begin{Entry}{胜算}{9,14}{⾁,⽵}
  \begin{Phonetics}{胜算}{sheng4suan4}
    \definition{s.}{Literário: estratégia que garante o sucesso; probabilidades de sucesso; estratégia que garante o sucesso}
    \definition{v.}{Literário: ter certeza do sucesso}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{胡子}{9,3}{⾁,⼦}
  ...
  \synonymref{胡匪}{hu2fei3}
  \synonymref{土匪}{tu3fei3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{胡同}{9,6}{⾁,⼝}
  \begin{Phonetics}{胡同}{hu2tong5}[][HSK 5]
    \definition[条,个]{s.}{beco; rua pequena}
  \antonymref{大街}{da4jie1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{胡同入口}{9,6,2,3}{⾁,⼝,⼊,⼝}
  \begin{Phonetics}{胡同入口}{hu2tong4 ru4kou3}[][HSK 5]
    \definition{s.}{entrada de hutong; entrada de beco}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{胡同出口}{9,6,5,3}{⾁,⼝,⼐,⼝}
  \begin{Phonetics}{胡同出口}{hu2tong4 chu1kou3}[][HSK 5]
    \definition{s.}{saída do hutong; saída do beco}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{胡匪}{9,10}{⾁,⼕}
  \begin{Phonetics}{胡匪}{hu2fei3}
    \definition{s.}{bandido (antigo); antigamente, os bandidos também eram chamados de ``homens barbudos''}
  \antonymref{官兵}{guan1bing1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{胡萝卜}{9,11,2}{⾁,⾋,⼘}
  \begin{Phonetics}{胡萝卜}{hu2luo2bo5}
    \definition[个,根,斤,些,把]{s.}{cenoura}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{脉搏}{9,13}{⾁,⼿}
  \begin{Phonetics}{脉搏}{mai4bo2}[][HSK 7-9]
    \definition{s.}{pulso; o fenômeno das artérias pulsarem ritmicamente à medida que o sangue bombeado impacta as paredes arteriais durante a contração cardíaca | desenvolvimento, mudanças ou tendências da sociedade, da vida, etc.}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{范成大}{9,6,3}{⾋,⼽,⼤}
  \begin{Phonetics}{范成大}{fan4 cheng2da4}
    \definition*{s.}{Fan Chengda (1126–-1193), de nome de cortesia Zhineng 致能 e também Youyuan 幼元, autodenominou"-se Cishan Jushi 此山 居士em seus primeiros anos e Shihu Jushi 石湖 居士 em seus últimos anos; natural do Condado de Wu, Suzhou (atual Cidade de Suzhou, Província de Jiangsu), foi um oficial, poeta e escritor durante a Dinastia Song do Sul; seu nome póstumo foi Wenmu 文穆}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{范围}{9,7}{⾋,⼞}
  ...
  \seealsoref{范畴}{fan4chou2}
  \synonymref{边界}{bian1jie4}
  \synonymref{规模}{gui1mo2}
  \synonymref{界限}{jie4xian4}
...
\begin{Entry}{茶}{9}{⾋}
  \begin{Phonetics}{茶}{cha2}[][HSK 1]
    ...
    \definition[杯,壶,碗,盒]{s.}{chá (a bebida); bebida feita com folhas de chá | chá (a planta) | certos tipos de bebidas ou alimentos líquidos | árvore de chá"-de"-óleo | camélia}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{草纸}{9,7}{⾋,⽷}
  \begin{Phonetics}{草纸}{cao3zhi3}
    \definition{s.}{papel de palha áspero | papel higiênico | papel grosso | papel pardo | papiro}
  \synonymref{厕纸}{ce4zhi3}
...
\begin{Entry}{草原}{9,10}{⾋,⼚}
  ...
  \seealsoref{草地}{cao3di4}
  \antonymref{沙漠}{sha1mo4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{草莓}{9,10}{⾋,⾋}
  \begin{Phonetics}{草莓}{cao3mei2}
    \definition[颗]{s.}{morango | marca de amor; chupão}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{荒芜}{9,7}{⾋,⾋}
  \begin{Phonetics}{荒芜}{huang1wu2}
    \definition{adj.}{(terreno) abandonado; tomado por ervas daninhas; em ruínas; fora de cultivo}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 荧 %%%%%%%%%%
\subsection*{荧}\addcontentsline{loh}{figure}{荧}

\begin{Entry}{荧}{9}{⾋}
  \begin{Phonetics}{荧}{ying2}
...
\begin{Entry}{荧光}{9,6}{⾋,⼉}
  \begin{Phonetics}{荧光}{ying2guang1}[][HSK 7-9]
...
\begin{Entry}{药方}{9,4}{⾋,⽅}
  \begin{Phonetics}{药方}{yao4fang1}[][HSK 7-9]
...
\begin{Entry}{药片}{9,4}{⾋,⽚}
  ...
  \synonymref{药丸}{yao4wan2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{药材}{9,7}{⾋,⽊}
  \begin{Phonetics}{药材}{yao4cai2}[][HSK 7-9]
...
\begin{Entry}{药补}{9,7}{⾋,⾐}
  \begin{Phonetics}{药补}{yao4bu3}
    ...
    \definition{v.}{fortalecer a saúde tomando tônicos}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{药房}{9,8}{⾋,⼾}
  \begin{Phonetics}{药房}{yao4fang2}
    \definition[个,家]{s.}{drogaria; farmácia; farmácia de manipulação | dispensário; farmácia hospitalar; departamentos que fornecem medicamentos dentro de hospitais ou clínicas}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{药物}{9,8}{⾋,⽜}
  ...
  \seealsoref{药品}{yao4pin3}
  \synonymref{医药}{yi1yao4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{药品}{9,9}{⾋,⼝}
  ...
  \seealsoref{药物}{yao4wu4}
  \synonymref{药方}{yao4fang1}
  \synonymref{医药}{yi1yao4}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 虼 %%%%%%%%%%
\subsection*{虼}\addcontentsline{loh}{figure}{虼}

\begin{Entry}{虼}{9}{⾍}
  \begin{Phonetics}{虼}{ge4}
    \definition{s.}{pulga; barata}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{虼蚤}{9,9}{⾍,⾍}
  \begin{Phonetics}{虼蚤}{ge4zao3}
...
\begin{Entry}{虽说}{9,9}{⾍,⾔}
  \begin{Phonetics}{虽说}{sui1shuo1}[][HSK 7-9]
...
\begin{Entry}{虽然}{9,12}{⾍,⽕}
  ...
  \seealsoref{别看}{bie2kan4}
  \seealsoref{但是}{dan4shi4}
  \seealsoref{尽管}{jin3guan3}
  \seealsoref{可是}{ke3shi4}
  \seealsoref{虽然……但是}{sui1ran2 dan4shi4}
  \seealsoref{虽说}{sui1shuo1}
  \synonymref{固然}{gu4ran2}
  \synonymref{即使}{ji2shi3}
  \antonymref{不过}{bu2guo4}
  \antonymref{然而}{ran2'er2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{虽然……但是}{9,12,7,9}{⾍,⽕,⼈,⽇}
  \begin{Phonetics}{虽然……但是}{sui1ran2 dan4shi4}
    \definition{conj.}{embora\dots mas}
  \seealsoref{尽管……还是}{jin3guan3 hai2shi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{虾}{9}{⾍}
  \begin{Phonetics}{虾}{ha2}
    \definition[只,对]{s.}{sapo; usado em 蛤蟆}
  \seealsoref{蛤蟆}{ha2ma2}
  \end{Phonetics}
  \begin{Phonetics}{虾}{xia1}[][HSK 7-9]
...
\begin{Entry}{要死要活的}{9,6,9,9,8}{⾑,⽍,⾑,⽔,⽩}
  \begin{Phonetics}{要死要活的}{yao4si3 yao4 huo2 de5}[][HSK 5]
    \definition{expr.}{oscilando entre a vida e a morte, morrer ou viver}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{觉悟}{9,10}{⾒,⼼}
  ...
  \seealsoref{觉醒}{jue2xing3}
  \seealsoref{醒悟}{xing3wu4}
  \synonymref{理解}{li3jie3}
...
\begin{Entry}{语气}{9,4}{⾔,⽓}
  \begin{Phonetics}{语气}{yu3qi4}[][HSK 7-9]
...
\begin{Entry}{语言}{9,7}{⾔,⾔}
  ...
  \seealsoref{言语}{yan2yu3}
  \synonymref{共识}{gong4shi2}
  ...
  \antonymref{沉默}{chen2mo4}
  \antonymref{国语}{guo2yu3}
  \antonymref{外语}{wai4yu3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{语言实验室}{9,7,8,10,9}{⾔,⾔,⼧,⾺,⼧}
  \begin{Phonetics}{语言实验室}{yu3yan2 shi2yan4shi4}
...
\begin{Entry}{语调}{9,10}{⾔,⾔}
  \begin{Phonetics}{语调}{yu3diao4}
    \definition[个]{s.}{entonação; tom; afinação; a entonação da fala refere"-se à configuração de tom, volume e velocidade da voz em uma frase, que expressa um determinado tom e emoção}
  \synonymref{口气}{kou3qi4}
  \synonymref{语气}{yu3qi4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{误区}{9,4}{⾔,⼖}
  \begin{Phonetics}{误区}{wu4qu1}[][HSK 7-9]
...
\begin{Entry}{误会}{9,6}{⾔,⼈}
  ...
  \seealsoref{误解}{wu4jie3}
  \synonymref{错觉}{cuo4jue2}
  \antonymref{理解}{li3jie3}
  \antonymref{谅解}{liang4jie3}
  \antonymref{领会}{ling3hui4}
  \antonymref{明白}{ming2bai5}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{误导}{9,6}{⾔,⼨}
  \begin{Phonetics}{误导}{wu4dao3}[][HSK 7-9]
    \definition{v.}{enganar; orientar incorretamente}
  \antonymref{提醒}{ti2//xing3}
  \antonymref{指引}{zhi3yin3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{误差}{9,9}{⾔,⼯}
  \begin{Phonetics}{误差}{wu4cha1}[][HSK 7-9]
...
\begin{Entry}{误点}{9,9}{⾔,⽕}
  \begin{Phonetics}{误点}{wu4//dian3}
    \definition{v.+compl.}{chegar atrasado; estar fora do prazo; estar atrasado em relação ao cronograma | estar atrasado; estar com atraso}
  \synonymref{晚点}{wan3dian3}
...
\begin{Entry}{误解}{9,13}{⾔,⾓}
  ...
  \seealsoref{误会}{wu4hui4}
  \synonymref{歪曲}{wai1qu1}
  \antonymref{理解}{li3jie3}
  \antonymref{领会}{ling3hui4}
  \antonymref{领悟}{ling3wu4}
  \antonymref{明白}{ming2bai5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{诱人}{9,2}{⾔,⼈}
  \begin{Phonetics}{诱人}{you4ren2}[][HSK 7-9]
...
\begin{Entry}{诱发}{9,5}{⾔,⼜}
  \begin{Phonetics}{诱发}{you4fa1}[][HSK 7-9]
...
\begin{Entry}{诱饵}{9,9}{⾔,⾷}
  \begin{Phonetics}{诱饵}{you4'er3}[][HSK 7-9]
    \definition{s.}{isca; chamariz}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{诱惑}{9,12}{⾔,⼼}
  \begin{Phonetics}{诱惑}{you4huo4}[][HSK 7-9]
...
\begin{Entry}{说}{9}{⾔}
  \begin{Phonetics}{说}{shui4}
    \definition{v.}{persuadir os outros a concordarem com seu ponto de vista}
  \end{Phonetics}
  ...
  \seealsoref{讲}{jiang3}
  \seealsoref{日心说}{ri4xin1shuo1}
  \seealsoref{谈}{tan2}
  \synonymref{道}{dao4}
  \synonymref{叙}{xu4}
  \end{Phonetics}
  \begin{Phonetics}{说}{yue4}
    \variantof{悦}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{说干就干}{9,3,12,3}{⾔,⼲,⼪,⼲}
  \begin{Phonetics}{说干就干}{shuo1gan4 jiu4gan4}[][HSK 7-9]
    \definition{expr.}{``Vamos fazê"-lo!''; simplesmente faça; aja sem demora}[说干就干，别犹豫！===Vamos fazer isso sem hesitar!]
  \end{Phonetics}
\end{Entry}

\begin{Entry}{说不上}{9,4,3}{⾔,⼀,⼀}
  \begin{Phonetics}{说不上}{shuo1bu5shang4}[][HSK 7-9]
...
\begin{Entry}{说白了}{9,5,2}{⾔,⽩,⼅}
  \begin{Phonetics}{说白了}{shuo1bai2le5}[][HSK 7-9]
...
\begin{Entry}{说好}{9,6}{⾔,⼥}
  \begin{Phonetics}{说好}{shuo1hao3}
    \definition{v.}{chegar a um acordo (entendimento); quando duas ou mais partes chegam a um consenso ou acordo após negociação e discussão}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{说老实话}{9,6,8,8}{⾔,⽼,⼧,⾔}
  \begin{Phonetics}{说老实话}{shuo1lao3shi5hua4}[][HSK 7-9]
...
\begin{Entry}{说闲话}{9,7,8}{⾔,⾨,⾔}
  \begin{Phonetics}{说闲话}{shuo1xian2hua4}[][HSK 7-9]
...
\begin{Entry}{说闲话儿}{9,7,8,2}{⾔,⾨,⾔,⼉}
  \begin{Phonetics}{说闲话儿}{shuo1xian2hua4 er5}
    \definition{s.}{fofoca}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{说到底}{9,8,8}{⾔,⼑,⼴}
  \begin{Phonetics}{说到底}{shuo1dao4di3}[][HSK 7-9]
...
\begin{Entry}{说服}{9,8}{⾔,⽉}
  ...
  \synonymref{劝说}{quan4shuo1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{说法}{9,8}{⾔,⽔}
  \begin{Phonetics}{说法}{shuo1fa3}[][HSK 5]
...
\begin{Entry}{说真的}{9,10,8}{⾔,⼗,⽩}
  \begin{Phonetics}{说真的}{shuo1zhen1de5}[][HSK 7-9]
...
\begin{Entry}{说起来}{9,10,7}{⾔,⾛,⽊}
  \begin{Phonetics}{说起来}{shuo1 qi3lai2}[][HSK 7-9]
...
\begin{Entry}{说理}{9,11}{⾔,⽟}
  \begin{Phonetics}{说理}{shuo1li3}
    \definition{adj.}{(geralmente na forma negativa) ouvir a razão; ser razoável}
    \definition{v.}{argumentar; chegar a uma conclusão racional | ser razoável}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{说谎}{9,11}{⾔,⾔}
  \begin{Phonetics}{说谎}{shuo1//huang3}[][HSK 7-9]
...
\begin{Entry}{说道}{9,12}{⾔,⾡}
  ...
  \end{Phonetics}
  \begin{Phonetics}{说道}{shuo1dao5}[][HSK 7-9]
...
\begin{Entry}{说道儿}{9,12,2}{⾔,⾡,⼉}
  \begin{Phonetics}{说道儿}{shuo1dao5r5}
...
\begin{Entry}{贸易}{9,8}{⾙,⽇}
  ...
  \synonymref{商业}{shang1ye4}
  \synonymref{生意}{sheng1yi5}
  \synonymref{外贸}{wai4mao4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{贸易公司}{9,8,4,5}{⾙,⽇,⼋,⼝}
  \begin{Phonetics}{贸易公司}{mao4yi4 gong1si1}[][HSK 5]
    \definition[间]{s.}{empresa comercial; empresas que atuam no comércio | empresa comercial; sociedade comercial}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{费力}{9,2}{⾙,⼒}
  \begin{Phonetics}{费力}{fei4li4}
    \definition{v.}{ser árduo, exaustivo; exigir ou demandar grande esforço | significa apenas fazer esforço}
  \seealsoref{吃力}{chi1li4}
  ...
  \antonymref{容易}{rong2yi4}
  \antonymref{省心}{sheng3//xin1}
  \antonymref{省力}{sheng3li4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{费用}{9,5}{⾙,⽤}
  ...
  \synonymref{经费}{jing1fei4}
  \synonymref{开销}{kai1xiao1}
  \synonymref{开支}{kai1zhi1}
...
\begin{Entry}{费尽心思}{9,6,4,9}{⾙,⼫,⼼,⼼}
  \begin{Phonetics}{费尽心思}{fei4 jin4 xin1si1}[][HSK 5]
    \definition{expr.}{quebrar a cabeça e tentar todos os meios possíveis; esforçar"-se muito para pensar em algo até o fim; descreve alguém que planeja e trama com grande empenho}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{轻易}{9,8}{⾞,⽇}
  ...
  \seealsoref{随便}{sui2bian4}
  \synonymref{简单}{jian3dan1}
  \synonymref{轻松}{qing1song1}
  \synonymref{任意}{ren4yi4}
  \synonymref{容易}{rong2yi4}
  \synonymref{随意}{sui2yi4}
  \antonymref{不易}{bu2 yi4}
  \antonymref{艰巨}{jian1ju4}
  \antonymref{艰难}{jian1nan2}
  \antonymref{艰辛}{jian1xin1}
  \antonymref{困难}{kun4nan5}
  \antonymref{难得}{nan2de2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{轻松}{9,8}{⾞,⽊}
  ...
  \seealsoref{放松}{fang4song1}
  \synonymref{简便}{jian3bian4}
  \synonymref{轻易}{qing1yi5}
  \synonymref{容易}{rong2yi4}
  \synonymref{松弛}{song1chi2}
  \synonymref{愉快}{yu2kuai4}
  \antonymref{沉重}{chen2zhong4}
  \antonymref{繁重}{fan2zhong4}
  \antonymref{棘手}{ji2shou3}
  \antonymref{紧张}{jin3zhang1}
  \antonymref{恐怖}{kong3bu4}
  \antonymref{疲劳}{pi2lao2}
  \antonymref{辛苦}{xin1ku3}
  \antonymref{压抑}{ya1yi4}
  \antonymref{严肃}{yan2su4}
  \antonymref{抑郁}{yi4yu4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{轻视}{9,8}{⾞,⾒}
  \begin{Phonetics}{轻视}{qing1shi4}
    \definition{v.}{desprezar; menosprezar; desvalorizar; não levar a sério}
  \seealsoref{忽视}{hu1shi4}
  \seealsoref{看不起}{kan4bu5qi3}
  \synonymref{鄙视}{bi3shi4}
  ...
  \synonymref{小看}{xiao3kan4}
  \antonymref{讲究}{jiang3jiu5}
  \antonymref{敬爱}{jing4'ai4}
  \antonymref{敬佩}{jing4pei4}
  \antonymref{看重}{kan4zhong4}
  \antonymref{佩服}{pei4fu2}
  \antonymref{钦佩}{qin1pei4}
  \antonymref{重视}{zhong4shi4}
...
\begin{Entry}{迷人}{9,2}{⾡,⼈}
  ...
  \synonymref{动人}{dong4ren2}
  \synonymref{美丽}{mei3li4}
  \synonymref{魅力}{mei4li4}
  \synonymref{迷惑}{mi2huo4}
  \synonymref{吸引}{xi1yin3}
  \synonymref{诱人}{you4ren2}
  \antonymref{恶心}{e3xin5}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{迷你}{9,7}{⾡,⼈}
  \begin{Phonetics}{迷你}{mi2ni3}
    \definition[辆]{adj.}{Empréstimo Linguístico: mini, como em minissaia ou \emph{Mini Cooper}; miniatura; minúsculo; extremamente pequeno}
  \synonymref{精致}{jing1zhi4}
  \synonymref{迷人}{mi2ren2}
  \synonymref{袖珍}{xiu4zhen1}
...
\begin{Entry}{迷信}{9,9}{⾡,⼈}
  ...
  \synonymref{盲目}{mang2mu4}
  \synonymref{愚昧}{yu2mei4}
  \antonymref{科学}{ke1xue2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{迷宫}{9,9}{⾡,⼧}
  \begin{Phonetics}{迷宫}{mi2gong1}
    \definition{s.}{labirinto | Figurativo: área desconhecida}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{迷路}{9,13}{⾡,⾜}
  \begin{Phonetics}{迷路}{mi2//lu4}[][HSK 7-9]
    \definition{v.+compl.}{desviar"-se; perder"-se; errar o caminho; perder a noção de direção; ir pelo caminho errado; não conseguir encontrar o caminho | perder"-se; estar perdido na vida; descreve a perda da direção correta}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{追问}{9,6}{⾡,⾨}
  \begin{Phonetics}{追问}{zhui1wen4}[][HSK 7-9]
...
\begin{Entry}{追尾}{9,7}{⾡,⼫}
  \begin{Phonetics}{追尾}{zhui1//wei3}[][HSK 7-9]
...
\begin{Entry}{追赶}{9,10}{⾡,⾛}
  \begin{Phonetics}{追赶}{zhui1gan3}[][HSK 7-9]
  ...
  \synonymref{追逐}{zhui1zhu2}
  \antonymref{逃走}{tao2zou3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{追逐}{9,10}{⾡,⾡}
  \begin{Phonetics}{追逐}{zhui1zhu2}[][HSK 7-9]
...
\begin{Entry}{追悼会}{9,11,6}{⾡,⼼,⼈}
  \begin{Phonetics}{追悼会}{zhui1dao4hui4}[][HSK 7-9]
    \definition{s.}{reunião memorial | um serviço funerário | um serviço memorial}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{追随}{9,11}{⾡,⾩}
  \begin{Phonetics}{追随}{zhui1sui2}[][HSK 7-9]
...
\begin{Entry}{追溯}{9,13}{⾡,⽔}
  \begin{Phonetics}{追溯}{zhui1su4}[][HSK 7-9]
    \definition{v.}{executar; revisar; fazer retrospectiva; datar de; rastrear até; viajar rio acima, partindo da nascente; buscar a essência das coisas indo contra a corrente do tempo}
...
\begin{Entry}{追踪}{9,15}{⾡,⾜}
  \begin{Phonetics}{追踪}{zhui1zong1}[][HSK 7-9]
...
\begin{Entry}{退出}{9,5}{⾡,⼐}
  \begin{Phonetics}{退出}{tui4chu1}[][HSK 3]
  ...
  \antonymref{参加}{can1jia1}
  \antonymref{加入}{jia1ru4}
  \antonymref{进入}{jin4ru4}
  \antonymref{投入}{tou2ru4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{退后}{9,6}{⾡,⼝}
  \begin{Phonetics}{退后}{tui4hou4}
    \definition{v.}{recuar}
  \seealsoref{推迟}{tui1chi2}
  \synonymref{后退}{hou4tui4}
  \synonymref{退却}{tui4que4}
  \synonymref{退让}{tui4rang4}
  \synonymref{退缩}{tui4suo1}
  \antonymref{前进}{qian2jin4}
  \antonymref{向前}{xiang4 qian2}
  \antonymref{争先}{zheng1xian1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{退却}{9,7}{⾡,⼙}
  ...
  \synonymref{畏惧}{wei4ju4}
  \synonymref{畏缩}{wei4suo1}
  \synonymref{谢绝}{xie4jue2}
  \antonymref{冲锋}{chong1//feng1}
...
\begin{Entry}{送礼}{9,5}{⾡,⽰}
  \begin{Phonetics}{送礼}{song4li3}[][HSK 6]
...
\begin{Entry}{送行}{9,6}{⾡,⾏}
  \begin{Phonetics}{送行}{song4xing2}[][HSK 6]
  ...
  \seealsoref{送}{song4}
  \synonymref{送别}{song4//bie2}
  \antonymref{迎接}{ying2jie1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{送给}{9,9}{⾡,⽷}
  ...
  \synonymref{奉献}{feng4xian4}
  \synonymref{赠送}{zeng4song4}
  \antonymref{收回}{shou1hui2}
  \antonymref{索取}{suo3qu3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{适合}{9,6}{⾡,⼝}
  ...
  \seealsoref{合适}{he2shi4}
  \seealsoref{适应}{shi4ying4}
  \synonymref{符合}{fu2he2}
  \synonymref{恰当}{qia4dang4}
  \synonymref{适当}{shi4dang4}
  \synonymref{适宜}{shi4yi2}
  \synonymref{顺应}{shun4ying4}
  \synonymref{吻合}{wen3he2}
  \antonymref{勉强}{mian3qiang3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{适应}{9,7}{⾡,⼴}
  ...
  \synonymref{符合}{fu2he2}
  \synonymref{合适}{he2shi4}
  \synonymref{磨合}{mo2he2}
  \synonymref{顺应}{shun4ying4}
  \synonymref{习惯}{xi2guan4}
  \antonymref{不适}{bu2shi4}
  \antonymref{不服}{bu4fu2}
...
\begin{Entry}{逃跑}{9,12}{⾡,⾜}
  ...
  \synonymref{逃走}{tao2zou3}
  \antonymref{追踪}{zhui1zong1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{选民}{9,5}{⾡,⽒}
  \begin{Phonetics}{选民}{xuan3min2}[][HSK 7-9]
...
\begin{Entry}{选用}{9,5}{⾡,⽤}
  \begin{Phonetics}{选用}{xuan3yong4}[][HSK 7-9]
...
\begin{Entry}{选举}{9,9}{⾡,⼂}
  ...
  \synonymref{评选}{ping2xuan3}
  \synonymref{推选}{tui1xuan3}
  \antonymref{罢免}{ba4mian3}
  \antonymref{免职}{mian3//zhi2}
  \antonymref{世袭}{shi4xi2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{选修}{9,9}{⾡,⼈}
  ...
  \antonymref{必修}{bi4xiu1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{选项}{9,9}{⾡,⾴}
  \begin{Phonetics}{选项}{xuan3xiang4}[][HSK 7-9]
...
%%%%%%%%%% 逊 %%%%%%%%%%
\subsection*{逊}\addcontentsline{loh}{figure}{逊}

\begin{Entry}{逊}{9}{⾡}
  \begin{Phonetics}{逊}{xun4}
...
\begin{Entry}{逊色}{9,6}{⾡,⾊}
  \begin{Phonetics}{逊色}{xun4se4}[][HSK 7-9]
...
%%%%%%%%%% 郦 %%%%%%%%%%
\subsection*{郦}\addcontentsline{loh}{figure}{郦}

\begin{Entry}{郦}{9}{⾢}
  \begin{Phonetics}{郦}{li4}
    \definition*{s.}{nome de lugar antigo | Sobrenome: Li}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{郦食其}{9,9,8}{⾢,⾷,⼋}
  \begin{Phonetics}{郦食其}{li4 yi4ji1}
    \definition*{s.}{Li Yiji, erudito da dinastia Han}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{重合}{9,6}{⾥,⼝}
  \begin{Phonetics}{重合}{chong2he2}[][HSK 7-9]
    \definition{v.}{coincidir; sobrepor"-se}[两个假期的时间重合了。===Os dois feriados se sobrepõem.]
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{重要人物}{9,9,2,8}{⾥,⾑,⼈,⽜}
  \begin{Phonetics}{重要人物}{zhong4yao4 ren2wu4}[][HSK 5]
    \definition{s.}{figura importante; personalidade de destaque; \emph{VIP} | qualquer pessoa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{钟罩}{9,13}{⾦,⽹}
  \begin{Phonetics}{钟罩}{zhong1zhao4}
    \definition{s.}{redoma; dossel de sino; cobertura em forma de sino}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{钥匙}{9,11}{⾦,⼔}
  \begin{Phonetics}{钥匙}{yao4shi5}[][HSK 7-9]
...
\begin{Entry}{钥匙洞孔}{9,11,9,4}{⾦,⼔,⽔,⼦}
  \begin{Phonetics}{钥匙洞孔}{yao4shi5 dong4kong3}
    \definition{s.}{buraco da fechadura}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{闻名}{9,6}{⾨,⼝}
  \begin{Phonetics}{闻名}{wen2ming2}[][HSK 7-9]
...
\begin{Entry}{闻名于}{9,6,3}{⾨,⼝,⼆}
  \begin{Phonetics}{闻名于}{wen2ming2 yu2}[][HSK 5]
    \definition{v.}{ser conhecido por; ser famoso por}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 闽 %%%%%%%%%%
\subsection*{闽}\addcontentsline{loh}{figure}{闽}

\begin{Entry}{闽}{9}{⾨}
  \begin{Phonetics}{闽}{min3}
    \definition*{s.}{Outro nome para a província de Fujian (福建) | Sobrenome: Min}
...
\begin{Entry}{院士}{9,3}{⾩,⼠}
  \begin{Phonetics}{院士}{yuan4shi4}[][HSK 7-9]
...
\begin{Entry}{除了}{9,2}{⾩,⼅}
  ...
  \seealsoref{也}{ye3}
  \seealsoref{只}{zhi3}
  \synonymref{不算}{bu2suan4}
  \synonymref{不仅}{bu4jin3}
  \synonymref{除去}{chu2qu4}
  \synonymref{抛开}{pao1kai1}
  \synonymref{去除}{qu4chu2}
  \synonymref{去掉}{qu4diao4}
  \antonymref{包含}{bao1han2}
  \antonymref{包括}{bao1kuo4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{除非}{9,8}{⾩,⾮}
  \begin{Phonetics}{除非}{chu2fei1}[][HSK 5]
    \definition{conj.}{a menos que; somente se; indica a única condição, frequentemente combinada com 才, 否则, 不然, etc.}
  \seealsoref{不然}{bu4ran2}
  \seealsoref{才}{cai2}
  \seealsoref{否则}{fou3ze2}
  \seealsoref{只有}{zhi3you3}
  \synonymref{才能}{cai2neng2}
  \synonymref{除了}{chu2le5}
  \synonymref{除去}{chu2qu4}
...
%%%%%%%%%% 陨 %%%%%%%%%%
\subsection*{陨}\addcontentsline{loh}{figure}{陨}

\begin{Entry}{陨}{9}{⾩}
  \begin{Phonetics}{陨}{yun3}
    \definition{v.}{cair do céu ou do espaço sideral}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{陨石}{9,5}{⾩,⽯}
  \begin{Phonetics}{陨石}{yun3shi2}[][HSK 7-9]
...
\begin{Entry}{面子}{9,3}{⾯,⼦}
  ...
  \synonymref{人情}{ren2qing2}
  \synonymref{体面}{ti3mian4}
...
\begin{Entry}{面对}{9,5}{⾯,⼨}
  ...
  \synonymref{面临}{mian4lin2}
  \synonymref{正视}{zheng4shi4}
...
\begin{Entry}{面貌}{9,14}{⾯,⾘}
  ...
  \synonymref{风貌}{feng1mao4}
  \synonymref{容貌}{rong2mao4}
  \synonymref{仪表}{yi2biao3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{音乐}{9,5}{⾳,⼃}
  ...
  \synonymref{旋律}{xuan2lv4}
  \synonymref{乐曲}{yue4qu3}
  \antonymref{噪音}{zao4yin1}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{音乐厅}{9,5,4}{⾳,⼃,⼚}
  \begin{Phonetics}{音乐厅}{yin1yue4ting1}[][HSK 5]
    \definition{s.}{sala de concertos;  \emph{concert hall} | sala de música; auditório}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{音乐节}{9,5,5}{⾳,⼃,⾋}
  \begin{Phonetics}{音乐节}{yin1yue4jie2}
    \definition{s.}{festival de música; um evento musical extraordinário com duração de vários dias}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{音乐院}{9,5,9}{⾳,⼃,⾩}
  \begin{Phonetics}{音乐院}{yin1yue4 yuan4}
    \definition{s.}{conservatório | instituto de música}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{音乐家}{9,5,10}{⾳,⼃,⼧}
  \begin{Phonetics}{音乐家}{yin1yue4 jia1}[][HSK 5]
    \definition[个,位,名,些]{s.}{músico; pessoa com conhecimento especializado em música; geralmente se refere a alguém que obteve sucesso como intérprete ou compositor musical}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{音响}{9,9}{⾳,⼝}
  \begin{Phonetics}{音响}{yin1xiang3}[][HSK 7-9]
...
\begin{Entry}{项目}{9,5}{⾴,⽬}
  \begin{Phonetics}{项目}{xiang4mu4}[][HSK 4]
    \definition[个,项]{s.}{evento; categorias em que as coisas são divididas | item; projeto; trabalhos de engenharia, acadêmicos, etc., de conteúdo específico}
  \synonymref{栏目}{lan2mu4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{项目负责人}{9,5,6,8,2}{⾴,⽬,⾙,⾙,⼈}
  \begin{Phonetics}{项目负责人}{xiang4mu4 fu4ze2 ren2}[][HSK 5]
    \definition{s.}{líder do projeto; gestor de projeto}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{项链}{9,12}{⾴,⾦}
  \begin{Phonetics}{项链}{xiang4lian4}[][HSK 7-9]
...
\begin{Entry}{顺水}{9,4}{⾴,⽔}
  \begin{Phonetics}{顺水}{shun4shui3}
    \definition{v.}{ir rio abaixo; ir com a corrente; ir conforme o fluxo}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{顺延}{9,6}{⾴,⼵}
  \begin{Phonetics}{顺延}{shun4yan2}
    \definition{v.}{adiar conforme necessário | adiar; postergar}
  \synonymref{推迟}{tui1chi2}
  \antonymref{提前}{ti2qian2}
  \antonymref{提早}{ti2zao3}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{顺当}{9,6}{⾴,⼹}
  \begin{Phonetics}{顺当}{shun4dang5}
    \definition{adj.}{Coloquial: tranquilo; sem problemas; sem contratempos}
...
\begin{Entry}{顺耳}{9,6}{⾴,⽿}
  \begin{Phonetics}{顺耳}{shun4'er3}
    \definition{adj.}{agradável ao ouvido; combina com meu gosto e parece agradável}
...
\begin{Entry}{顺利}{9,7}{⾴,⼑}
  ...
  \synonymref{成功}{cheng2//gong1}
  \synonymref{得手}{de2shou3}
  \synonymref{顺手}{shun4shou3}
  \synonymref{顺当}{shun4dang5}
  \antonymref{挫折}{cuo4zhe2}
  \antonymref{妨碍}{fang2'ai4}
  \antonymref{棘手}{ji2shou3}
  \antonymref{荆棘}{jing1ji2}
  \antonymref{麻烦}{ma2fan5}
  \antonymref{磨难}{mo2nan4}
  \antonymref{曲折}{qu1zhe2}
  \antonymref{失误}{shi1wu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{顺序}{9,7}{⾴,⼴}
  ...
  \seealsoref{次序}{ci4xu4}
  \synonymref{程序}{cheng2xu4}
  \synonymref{依次}{yi1ci4}
  \synonymref{秩序}{zhi4xu4}
  \antonymref{颠倒}{dian1dao3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{顺其自然}{9,8,6,12}{⾴,⼋,⾃,⽕}
  ...
  \synonymref{自然而然}{zi4ran2'er2ran2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{顺理成章}{9,11,6,11}{⾴,⽟,⼽,⾳}
  \begin{Phonetics}{顺理成章}{shun4li3cheng2zhang1}[][HSK 7-9]
  ...
  \antonymref{自相矛盾}{zi4xiang1-mao2dun4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{顺嘴}{9,16}{⾴,⼝}
  \begin{Phonetics}{顺嘴}{shun4zui3}
    \definition{v.}{ler suavemente | dizer de forma displicente | deixar escapar (sem pensar) | ler fluentemente (um texto) | agradar ao paladar (de alguém)}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 须 %%%%%%%%%%
\subsection*{须}\addcontentsline{loh}{figure}{须}

\begin{Entry}{须}{9}{⾴}
  \begin{Phonetics}{须}{xu1}[][HSK 7-9]
...
\begin{Entry}{飒飒}{9,9}{⾵,⾵}
  \begin{Phonetics}{飒飒}{sa4sa4}
    \definition{s.}{Onomatopéia: sussurro; farfalhar; som de assobio ou de murmúrio (do vento nas árvores, no mar, etc.)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{食物}{9,8}{⾷,⽜}
  ...
  \seealsoref{食品}{shi2pin3}
  \synonymref{伙食}{huo3shi2}
  \synonymref{粮食}{liang2shi5}
  \synonymref{膳食}{shan4shi2}
  \synonymref{养料}{yang3liao4}
  \synonymref{饮食}{yin3shi2}
  \antonymref{毒物}{du2wu4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{食品}{9,9}{⾷,⼝}
  ...
  \seealsoref{食物}{shi2wu4}
  \synonymref{粮食}{liang2shi5}
  \synonymref{美食}{mei3shi2}
  \synonymref{膳食}{shan4shi2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{食品店}{9,9,8}{⾷,⼝,⼴}
  \begin{Phonetics}{食品店}{shi2pin3 dian4}[][HSK 5]
    \definition{s.}{loja de alimentos; mercearia; mercado; secos e molhados}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{食品超市}{9,9,12,5}{⾷,⼝,⾛,⼱}
  \begin{Phonetics}{食品超市}{shi2pin3 chao1shi4}[][HSK 5]
    \definition{s.}{mercearia; supermercado}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{饺子馆}{9,3,11}{⾷,⼦,⾷}
  \begin{Phonetics}{饺子馆}{jiao3zi5 guan3}[][HSK 5]
    \definition{s.}{restaurante especializado em bolinhos de massa}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{首先}{9,6}{⾸,⼉}
  ...
  \synonymref{首要}{shou3yao4}
  \synonymref{率先}{shuai4xian1}
  \synonymref{最初}{zui4chu1}
  \antonymref{结尾}{jie2wei3}
...
\begin{Entry}{首席执行官}{9,10,6,6,8}{⾸,⼱,⼿,⾏,⼧}
  \begin{Phonetics}{首席执行官}{shou3xi2 zhi2xing2guan1}
...
\begin{Entry}{骂大街}{9,3,12}{⾺,⼤,⾏}
  \begin{Phonetics}{骂大街}{ma4da4jie1}
    \definition{v.}{gritar palavrões em público; proferir insultos ruidosamente}
  \synonymref{骂街}{ma4jie1}
  \synonymref{谩骂}{man4ma4}
  \synonymref{怒骂}{nu4ma4}
  \synonymref{辱骂}{ru3ma4}
  \synonymref{痛骂}{tong4ma4}
...
\begin{Entry}{骂名}{9,6}{⾺,⼝}
  \begin{Phonetics}{骂名}{ma4ming2}
    \definition[种,个]{s.}{má reputação; infâmia; má fama; uma reputação amplamente criticada ou detestada}
  \antonymref{赞美}{zan4mei3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{骂街}{9,12}{⾺,⾏}
  \begin{Phonetics}{骂街}{ma4jie1}
    \definition{v.}{gritar insultos em público; xingar pessoas em público | gritar insultos na rua; proferir palavrões sem mencionar nomes}
  \seealsoref{骂大街}{ma4da4jie1}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{骄傲}{9,12}{⾺,⼈}
  \begin{Phonetics}{骄傲}{jiao1'ao4}[][HSK 6]
    ...
    \definition[些,种]{s.}{orgulho; pessoas ou coisas das quais se orgulhar}
  \seealsoref{自豪}{zi4hao2}
  \synonymref{傲慢}{ao4man4}
  \synonymref{得意}{de2//yi4}
  \synonymref{高傲}{gao1'ao4}
  \synonymref{夸耀}{kua1yao4}
  \synonymref{自负}{zi4fu4}
  \antonymref{惭愧}{can2kui4}
  \antonymref{耻辱}{chi3ru3}
  \antonymref{谦虚}{qian1xu1}
  \antonymref{谦逊}{qian1xun4}
  \antonymref{失望}{shi1wang4}
  \antonymref{羞愧}{xiu1kui4}
...
\begin{Entry}{鬼}{9}{⿁}[Kangxi 194]
  \begin{Phonetics}{鬼}{gui3}[][HSK 5]
    ...
    \definition[个,只]{s.}{espírito; fantasma; aparição; refere"-se à alma de uma pessoa após a morte | usado para formar um termo de abuso para caráter ignóbil; refere"-se a pessoas que têm maus hábitos ou cujo comportamento é repugnante | companheiro; pessoa que é considerada divertida}
  \antonymref{神}{shen2}
  \end{Phonetics}
\end{Entry}
