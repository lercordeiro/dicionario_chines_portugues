...
\begin{Entry}{药材}{9,7}{⾋,⽊}
  \begin{Phonetics}{药材}{yao4cai2}[][HSK 7-9]
    \definition{s.}{ervas medicinais | materiais medicinais; drogas brutas | ingrediente medicinal; matérias"-primas ou fatias processadas da medicina tradicional chinesa}
  \end{Phonetics}
\end{Entry}
