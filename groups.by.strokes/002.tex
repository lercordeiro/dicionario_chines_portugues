...
\begin{Entry}{了不得}{2,4,11}{⼅,⼀,⼻}
  \begin{Phonetics}{了不得}{liao3bu5de2}
...
\begin{Entry}{二线城市}{2,8,9,5}{⼆,⽷,⼟,⼱}
  \begin{Phonetics}{二线城市}{er4xian4 cheng2shi4}[][HSK 5]
    \definition{s.}{cidade de segundo nível}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{二战}{2,9}{⼆,⼽}
  \begin{Phonetics}{二战}{er4zhan4}
    \definition*{s.}{Segunda Guerra Mundial (1939--1945)}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{儿子}{2,3}{⼉,⼦}
  ...
  \seealsoref{孩子}{hai2zi5}
  \antonymref{女儿}{nv3'er2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{儿童医院}{2,12,7,9}{⼉,⽴,⼖,⾩}
  \begin{Phonetics}{儿童医院}{er2tong2 yi1yuan4}[][HSK 5]
    \definition{s.}{hospital infantil}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{儿媳}{2,13}{⼉,⼥}
  \begin{Phonetics}{儿媳}{er2xi2}
    \definition{s.}{esposa do filho; nora}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{入乡随俗}{2,3,11,9}{⼊,⼄,⾩,⼈}
  \begin{Phonetics}{入乡随俗}{ru4xiang1sui2su2}
...
\begin{Entry}{厂}{2}{⼚}[Kangxi 27]
  \begin{Phonetics}{厂}{an1}
    \definition[家,间]{s.}{usado principalmente em nomes pessoais}[他名中有个厂字。===O nome dele contém a palavra `An'.]
  \end{Phonetics}
