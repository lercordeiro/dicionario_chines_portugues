...
\begin{Entry}{入手}{2,4}{⼊,⼿}
  \begin{Phonetics}{入手}{ru4shou3}[][HSK 7-9]
    \definition{v.}{começar com; proceder a partir de; tomar como ponto de partida | obter; apoderar-se (oposto a 出手)  | começar; para dar início.}
  \seealsoref{出手}{chu1/shou3}
  \end{Phonetics}
\end{Entry}
