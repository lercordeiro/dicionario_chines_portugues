...
\begin{Entry}{乡亲}{3,9}{⼄,⼇}
  \begin{Phonetics}{乡亲}{xiang1qin1}[][HSK 7-9]
    \definition{s.}{pessoa da mesma aldeia ou cidade; conterrâneo ou morador da mesma cidade | população local; aldeões; gente
povo local | termo de tratamento direto para pessoas locais ou moradores de vilarejos}
