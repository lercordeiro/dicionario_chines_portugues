...
\begin{Entry}{掌管}{12,14}{⼿,⽵}
  \begin{Phonetics}{掌管}{zhang3guan3}[][HSK 7-9]
...
%%%%%%%%%% 揍 %%%%%%%%%%
\subsection*{揍}\addcontentsline{loh}{figure}{揍}

\begin{Entry}{揍}{12}{⼿}
  \begin{Phonetics}{揍}{zou4}[][HSK 7-9]
...
\begin{Entry}{提}{12}{⼿}
  \begin{Phonetics}{提}{di1}
    \definition{v.}{ser cauteloso; proteger"-se de; ficar atento; ter cuidado | carregar; levantar; segurar}
  \antonymref{降}{jiang4}
  \end{Phonetics}
...
\begin{Entry}{提及}{12,3}{⼿,⼃}
  \begin{Phonetics}{提及}{ti2ji2}
    \definition{v.}{falar de; comentar sobre; referir"-se a; mencionar}
  \synonymref{提到}{ti2dao4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{提升}{12,4}{⼿,⼗}
  ...
  \seealsoref{提拔}{ti2ba2}
  \synonymref{进步}{jin4bu4}
  \synonymref{晋升}{jin4sheng1}
...
\begin{Entry}{提出}{12,5}{⼿,⼐}
  \begin{Phonetics}{提出}{ti2chu1}[][HSK 2]
...
\begin{Entry}{提到}{12,8}{⼿,⼑}
  ...
  \synonymref{提及}{ti2ji2}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{提拔}{12,8}{⼿,⼿}
  \begin{Phonetics}{提拔}{ti2ba2}[][HSK 7-9]
    \definition{v.}{promover; favorecer; selecionar pessoal para assumir cargos mais importantes}
  \synonymref{教育}{jiao4yu4}
...
\begin{Entry}{提前}{12,9}{⼿,⼑}
  ...
  \seealsoref{提早}{ti2zao3}
  \synonymref{超前}{chao1qian2}
  \synonymref{尽早}{jin3zao3}
  \synonymref{事先}{shi4xian1}
  \synonymref{先期}{xian1qi1}
...
\begin{Entry}{握手}{12,4}{⼿,⼿}
  \begin{Phonetics}{握手}{wo4shou3}[][HSK 3]
    \definition{v.}{apertar as mãos; dar um aperto de mão; estender a mão e apertar a mão do outro é uma forma de saudação ao se encontrar ou se despedir, e também é usado para expressar felicitações ou condolências}
  \synonymref{携手}{xie2shou3}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{搭}{12}{⼿}
  \begin{Phonetics}{搭}{da1}[][HSK 6]
    \definition{v.}{colocar em prática; construir | ficar pendurado; colocar para cima | entrar em contato; juntar"-se | adicionar (mais pessoas, dinheiro, etc.) | levantar algo junto | pegar (um navio, avião, etc.); viajar (ou ir) por}
    \variantof{褡}
  \synonymref{参}{can1}
  \synonymref{凑}{cou4}
  \synonymref{扶}{fu2}
...
\begin{Entry}{搭讪}{12,5}{⼿,⾔}
  \begin{Phonetics}{搭讪}{da1//shan4}
    \definition{v.+compl.}{iniciar uma conversa com alguém; dizer algo para amenizar uma situação embaraçosa; aproximar"-se de alguém ou quebrar o gelo, é preciso tomar a iniciativa de iniciar uma conversa}
...
\begin{Entry}{搬家公司}{13,10,4,5}{⼿,⼧,⼋,⼝}
  \begin{Phonetics}{搬家公司}{ban1jia1 gong1si1}[][HSK 5]
    \definition{s.}{empresa de mudanças}
  \end{Phonetics}
\end{Entry}

%%%%%%%%%% 携 %%%%%%%%%%
\subsection*{携}\addcontentsline{loh}{figure}{携}

\begin{Entry}{携}{13}{⼿}
  \begin{Phonetics}{携}{xie2}
    \definition{v.}{carregar; levar consigo | pegar (segurar) alguém pela mão}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{携手}{13,4}{⼿,⼿}
  \begin{Phonetics}{携手}{xie2shou3}[][HSK 7-9]
    \definition{v.}{dar as mãos; andar de mãos dadas; juntar as mãos | cooperar; trabalhar em conjunto}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{携带}{13,9}{⼿,⼱}
  \begin{Phonetics}{携带}{xie2dai4}[][HSK 7-9]
...
\begin{Entry}{摄像}{13,13}{⼿,⼈}
  \begin{Phonetics}{摄像}{she4xiang4}[][HSK 5]
...
\begin{Entry}{摄像机}{13,13,6}{⼿,⼈,⽊}
  \begin{Phonetics}{摄像机}{she4xiang4ji1}[][HSK 5]
...
\begin{Entry}{摄影师}{13,15,6}{⼿,⼺,⼱}
  \begin{Phonetics}{摄影师}{she4ying3 shi1}[][HSK 5]
...
\begin{Entry}{摆动}{13,6}{⼿,⼒}
  \begin{Phonetics}{摆动}{bai3dong4}[][HSK 4]
...
\begin{Entry}{摇晃}{13,10}{⼿,⽇}
  \begin{Phonetics}{摇晃}{yao2huang4}[][HSK 7-9]
...
\begin{Entry}{摇摆}{13,13}{⼿,⼿}
  \begin{Phonetics}{摇摆}{yao2bai3}[][HSK 7-9]
...
\begin{Entry}{摇摇欲坠}{13,13,11,7}{⼿,⼿,⽋,⼟}
  \begin{Phonetics}{摇摇欲坠}{yao2yao2-yu4zhui4}[][HSK 7-9]
    \definition{expr.}{cambaleante; em ruínas; à beira do colapso}
  \antonymref{根深蒂固}{gen1shen1-di4gu4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{摇滚}{13,13}{⼿,⽔}
  \begin{Phonetics}{摇滚}{yao2gun3}[][HSK 7-9]
...
\begin{Entry}{摇篮}{13,16}{⼿,⽵}
  \begin{Phonetics}{摇篮}{yao2lan2}[][HSK 7-9]
...
%%%%%%%%%% 摊 %%%%%%%%%%
\subsection*{摊}\addcontentsline{loh}{figure}{摊}

\begin{Entry}{摊}{13}{⼿}
  \begin{Phonetics}{摊}{tan1}[][HSK 7-9]
...
\begin{Entry}{摸}{13}{⼿}
  ...
  \seealsoref{抚摸}{fu3mo1}
  \synonymref{抚}{fu3}
  \synonymref{窃}{qie4}
  \synonymref{探}{tan4}
  \synonymref{偷}{tou1}
  \end{Phonetics}
  \begin{Phonetics}{摸}{mo2}
    \definition{v.}{copiar; imitar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{摸不着头脑}{13,4,11,5,10}{⼿,⼀,⽬,⼤,⾁}
  \begin{Phonetics}{摸不着头脑}{mo1 bu4zhao2 tou2nao3}[][HSK 5]
    \definition{expr.}{totalmente perdido; confuso; perplexo; estar sem saber o que fazer; não conseguir entender nada sobre o assunto}
  \synonymref{糊里糊涂}{hu2li5hu2tu5}
...
\begin{Entry}{摩托}{15,6}{⼿,⼿}
  \begin{Phonetics}{摩托}{mo2tuo1}[][HSK 5]
...
\begin{Entry}{摩托车}{15,6,4}{⼿,⼿,⾞}
  \begin{Phonetics}{摩托车}{mo2tuo1che1}
    \definition[辆]{s.}{Empréstimo Linguístico: motocicleta}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{摩擦}{15,17}{⼿,⼿}
  \begin{Phonetics}{摩擦}{mo2ca1}[][HSK 5]
    \definition{s.}{atrito; desacordo; conflito (entre duas partes); a ação de impedir o movimento relativo entre dois objetos em contato, produzida na superfície de contato | atrito; conflito entre as duas partes}
...
%%%%%%%%%% 撕 %%%%%%%%%%
\subsection*{撕}\addcontentsline{loh}{figure}{撕}

\begin{Entry}{撕}{15}{⼿}
  \begin{Phonetics}{撕}{si1}[][HSK 7-9]
...
\begin{Entry}{撞击}{15,5}{⼿,⼐}
  \begin{Phonetics}{撞击}{zhuang4ji1}[][HSK 7-9]
...
\begin{Entry}{撞运气}{15,7,4}{⼿,⾡,⽓}
  \begin{Phonetics}{撞运气}{zhuang4 yun4qi5}
...
\begin{Entry}{撤离}{15,10}{⼿,⼇}
  \begin{Phonetics}{撤离}{che4li2}[][HSK 6]
...
%%%%%%%%%% 撰 %%%%%%%%%%
\subsection*{撰}\addcontentsline{loh}{figure}{撰}

\begin{Entry}{撰}{15}{⼿}
  \begin{Phonetics}{撰}{zhuan4}
    \definition{v.}{escrever; compor | compilar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{撰写}{15,5}{⼿,⼍}
  \begin{Phonetics}{撰写}{zhuan4xie3}[][HSK 7-9]
...
\begin{Entry}{擒获}{15,10}{⼿,⾋}
  \begin{Phonetics}{擒获}{qin2huo4}
    \definition{v.}{pegar; capturar; prender | apreender}
...
%%%%%%%%%% 攒 %%%%%%%%%%
\subsection*{攒}\addcontentsline{loh}{figure}{攒}

\begin{Entry}{攒}{19}{⼿}
  \begin{Phonetics}{攒}{cuan2}
    \definition{v.}{reunir; concentrar; juntar as peças}
  \end{Phonetics}
  \begin{Phonetics}{攒}{zan3}[][HSK 7-9]
