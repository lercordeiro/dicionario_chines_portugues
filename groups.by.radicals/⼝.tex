...
\begin{Entry}{口味}{3,8}{⼝,⼝}
  \begin{Phonetics}{口味}{kou3wei4}[][HSK 7-9]
    \definition[个,种]{s.}{sabor da comida; o gosto da comida | o gosto de uma pessoa; preferência de cada um em termos de sabor | gostos; interesses e hobbies pessoais}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{嘱咐}{15,8}{⼝,⼝}
  \begin{Phonetics}{嘱咐}{zhu3fu5}[][HSK 7-9]
...
%%%%%%%%%% 嘻 %%%%%%%%%%
\subsection*{嘻}\addcontentsline{loh}{figure}{嘻}

\begin{Entry}{嘻}{15}{⼝}
  \begin{Phonetics}{嘻}{xi1}
...
\begin{Entry}{嘻笑}{15,10}{⼝,⽵}
  \begin{Phonetics}{嘻笑}{xi1xiao4}
    \variantof{嬉笑}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{嘴巴子}{16,4,3}{⼝,⼰,⼦}
  \begin{Phonetics}{嘴巴子}{zui3ba5 zi5}
    \definition{s.}{tapa; bofetada}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{嘴唇}{16,10}{⼝,⼝}
  \begin{Phonetics}{嘴唇}{zui3chun2}[][HSK 7-9]
...
\begin{Entry}{器}{16}{⼝}
  \begin{Phonetics}{器}{qi4}
    \definition[台]{s.}{utensílio; acessório; instrumento; equipamento | órgão | talento; capacidade; medição | resistência; paciência}
  \end{Phonetics}
\end{Entry}
...
%%%%%%%%%% 噪 %%%%%%%%%%
\subsection*{噪}\addcontentsline{loh}{figure}{噪}

\begin{Entry}{噪}{16}{⼝}
  \begin{Phonetics}{噪}{zao4}
...
\begin{Entry}{噪声}{16,7}{⼝,⼠}
  \begin{Phonetics}{噪声}{zao4sheng1}[][HSK 7-9]
...
\begin{Entry}{噪音}{16,9}{⼝,⾳}
  \begin{Phonetics}{噪音}{zao4yin1}[][HSK 7-9]
...
\begin{Entry}{噪音污染}{16,9,6,9}{⼝,⾳,⽔,⽊}
  \begin{Phonetics}{噪音污染}{zao4yin1 wu1ran3}[][HSK 5]
