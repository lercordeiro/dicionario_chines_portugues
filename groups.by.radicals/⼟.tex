...
\begin{Entry}{增收}{15,6}{⼟,⽁}
  \begin{Phonetics}{增收}{zeng1shou1}[][HSK 7-9]
...
\begin{Entry}{增添}{15,11}{⼟,⽔}
  \begin{Phonetics}{增添}{zeng1tian1}[][HSK 7-9]
...
\begin{Entry}{壤}{20}{⼟}
  \begin{Phonetics}{壤}{rang3}
    \definition[块]{s.}{solo; terra | Literário: a terra (em contraste com o céu 天) | região; área; território}
  \end{Phonetics}
\end{Entry}
