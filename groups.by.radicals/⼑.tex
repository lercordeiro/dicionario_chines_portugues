...
\begin{Entry}{刷新}{8,13}{⼑,⽄}
  \begin{Phonetics}{刷新}{shua1xin1}[][HSK 7-9]
    \definition{v.}{1. renovar; reformar; atualizar
Criar novo
2. atualizar (um site, uma página da web)
3. quebrar (um recorde)
Essa metáfora descreve a substituição de conquistas existentes por novas e melhores.}
