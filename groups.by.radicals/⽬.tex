...
%%%%%%%%%% 瞎 %%%%%%%%%%
\subsection*{瞎}\addcontentsline{loh}{figure}{瞎}

\begin{Entry}{瞎}{15}{⽬}
  \begin{Phonetics}{瞎}{xia1}[][HSK 7-9]
...
\begin{Entry}{瞎聊}{15,11}{⽬,⽿}
  \begin{Phonetics}{瞎聊}{xia1liao2}[][HSK 5]
...
%%%%%%%%%% 瞻 %%%%%%%%%%
\subsection*{瞻}\addcontentsline{loh}{figure}{瞻}

\begin{Entry}{瞻}{18}{⽬}
  \begin{Phonetics}{瞻}{zhan1}
...
\begin{Entry}{瞻仰}{18,6}{⽬,⼈}
  \begin{Phonetics}{瞻仰}{zhan1yang3}[][HSK 7-9]
