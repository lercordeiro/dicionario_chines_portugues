...
%%% Radical "⽻"
%%%
\section*{Radical 124: ``⽻''}\addcontentsline{toc}{section}{Radical 124: ⽻}\addcontentsline{loh}{figure}{\#\#\#\# 124: ⽻}
...
\begin{Entry}{翻译者}{18,7,8}{⽻,⾔,⽼}
  \begin{Phonetics}{翻译者}{fan1yi4 zhe3}[][HSK 5]
...
%%%%%%%%%% 耀 %%%%%%%%%%
\subsection*{耀}\addcontentsline{loh}{figure}{耀}

\begin{Entry}{耀}{20}{⽻}
  \begin{Phonetics}{耀}{yao4}
...
\begin{Entry}{耀眼}{20,11}{⽻,⽬}
  \begin{Phonetics}{耀眼}{yao4yan3}[][HSK 7-9]
