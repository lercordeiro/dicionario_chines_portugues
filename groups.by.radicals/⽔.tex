...
\begin{Entry}{源于}{13,3}{⽔,⼆}
  \begin{Phonetics}{源于}{yuan2yu2}[][HSK 7-9]
...
\begin{Entry}{源头}{13,5}{⽔,⼤}
  \begin{Phonetics}{源头}{yuan2tou2}[][HSK 7-9]
    \definition{s.}{cabeça; fonte; nascente; o lugar onde a água nasce}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{源泉}{13,9}{⽔,⽔}
  \begin{Phonetics}{源泉}{yuan2quan2}[][HSK 7-9]
...
\begin{Entry}{源源不断}{13,13,4,11}{⽔,⽔,⼀,⽄}
  \begin{Phonetics}{源源不断}{yuan2yuan2-bu2duan4}[][HSK 7-9]
...
%%%%%%%%%% 溢 %%%%%%%%%%
\subsection*{溢}\addcontentsline{loh}{figure}{溢}

\begin{Entry}{溢}{13}{⽔}
  \begin{Phonetics}{溢}{yi4}[][HSK 7-9]
...
%%%%%%%%%% 溶 %%%%%%%%%%
\subsection*{溶}\addcontentsline{loh}{figure}{溶}

\begin{Entry}{溶}{13}{⽔}
  \begin{Phonetics}{溶}{rong2}
    \definition{v.}{dissolver; solver; solucionar}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{溶解}{13,13}{⽔,⾓}
  \begin{Phonetics}{溶解}{rong2jie3}[][HSK 7-9]
...
\begin{Entry}{滔天}{13,4}{⽔,⼤}
  \begin{Phonetics}{滔天}{tao1tian1}
    \definition{adj.}{hediondo; monstruoso}
    \definition{v.}{(ondas, etc.) elevar"-se aos céus}
  \synonymref{弥漫}{mi2man4}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{滔滔不绝}{13,13,4,9}{⽔,⽔,⼀,⽷}
  \begin{Phonetics}{滔滔不绝}{tao1tao1-bu4jue2}[][HSK 7-9]
  ...
  \synonymref{源源不断}{yuan2yuan2-bu2duan4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{满分}{13,4}{⽔,⼑}
  \begin{Phonetics}{满分}{man3fen1}
    \definition[个]{s.}{nota máxima; crédito total; pontuação mais alta em vários sistemas de pontuação}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{满足}{13,7}{⽔,⾜}
  ...
  \seealsoref{满意}{man3yi4}
  \synonymref{知足}{zhi1zu2}
  \antonymref{不满}{bu4man3}
  \antonymref{不足}{bu4zu2}
  \antonymref{贪婪}{tan1lan2}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{满意}{13,13}{⽔,⼼}
  ...
  \seealsoref{满足}{man3zu2}
  \seealsoref{如意}{ru2//yi4}
  \synonymref{得意}{de2//yi4}
  \synonymref{高兴}{gao1xing4}
  \synonymref{写意}{xie4yi4}
  \synonymref{中意}{zhong4yi4}
  \antonymref{不满}{bu4man3}
  \antonymref{失望}{shi1wang4}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{满满}{13,13}{⽔,⽔}
  \begin{Phonetics}{满满}{man3man3}
    \definition{adj.}{cheio; lotado; indica que o recipiente ou espaço está completamente preenchido, sem deixar espaços vazios}
  \end{Phonetics}
\end{Entry}
...
\begin{Entry}{滨海}{13,10}{⽔,⽔}
  \begin{Phonetics}{滨海}{bin1hai3}[][HSK 7-9]
...
\begin{Entry}{潜水}{15,4}{⽔,⽔}
  \begin{Phonetics}{潜水}{qian2//shui3}[][HSK 7-9]
...
\begin{Entry}{潜在}{15,6}{⽔,⼟}
  \begin{Phonetics}{潜在}{qian2zai4}[][HSK 7-9]
...
\begin{Entry}{潜能}{15,10}{⽔,⾁}
  \begin{Phonetics}{潜能}{qian2neng2}[][HSK 7-9]
    \definition{s.}{proficiência; potencial de habilidades ou energia inexploradas}
  \end{Phonetics}
\end{Entry}

\begin{Entry}{潜移默化}{15,11,16,4}{⽔,⽲,⿊,⼔}
  \begin{Phonetics}{潜移默化}{qian2yi2-mo4hua4}[][HSK 7-9]
...
\begin{Entry}{潜艇}{15,12}{⽔,⾈}
  \begin{Phonetics}{潜艇}{qian2ting3}[][HSK 7-9]
