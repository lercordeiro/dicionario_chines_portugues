...
\makeindex[title=Índice por Pinyin,intoc=true,columns=3,columnsep=15pt,columnseprule=true,noautomatic=true,name=pinyin]
\makeindex[title=Índice por Traço,intoc=true,columns=3,columnsep=15pt,columnseprule=true,noautomatic=true,name=stroke]
\makeindex[title=Índice por Radical,intoc=true,columns=3,columnsep=15pt,columnseprule=true,noautomatic=true,name=radical]
