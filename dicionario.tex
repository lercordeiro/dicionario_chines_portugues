...
\begin{titlingpage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
	...
	\parbox[b]{0.75\textwidth}{ % Paragraph box for holding the title page text, adjust the width to move the title page left or right on the page
		...
		{\large\textit{Dicionário Chinês-Português para o \\Curso de Chinês do Instituto Confúcio}}\\[4\baselineskip] % Subtitle or further description
        {\Large\textsc{罗学凯}\\Luiz Eduardo Roncato Cordeiro} % Author name, lower case for consistent small caps
...
\include{verbetes/A.tex}
\include{verbetes/B.tex}
\include{verbetes/C.tex}
\include{verbetes/D.tex}
\include{verbetes/E.tex}
\include{verbetes/F.tex}
\include{verbetes/G.tex}
\include{verbetes/H.tex}
\include{verbetes/I.tex}
\include{verbetes/J.tex}
\include{verbetes/K.tex}
\include{verbetes/L.tex}
\include{verbetes/M.tex}
\include{verbetes/N.tex}
\include{verbetes/O.tex}
\include{verbetes/P.tex}
\include{verbetes/Q.tex}
\include{verbetes/R.tex}
\include{verbetes/S.tex}
\include{verbetes/T.tex}
\include{verbetes/U.tex}
\include{verbetes/V.tex}
\include{verbetes/W.tex}
\include{verbetes/X.tex}
\include{verbetes/Y.tex}
\include{verbetes/Z.tex}
