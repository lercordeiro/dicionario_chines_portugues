...
\entry{ba4ba0}{n.}{papai; pai|\fbox{个}\fbox{位}}
\end{hanzi}
...
\entry{n.}{recompensa; remuneração}
\end{hanzi}
...
\begin{hanzi}[笔]{bi3}
\entry{bi3}{n.}{caneta; lápis|\fbox{支}}
\end{hanzi}
...
\begin{hanzi}[不]{bu4}
\entry{bu4}{adv.}{não|«\pinyin{bu2}» antes de quarto tom|«\pinyin{bu0}» em expressões\\``verbo$+$不$+$verbo''}
\end{hanzi}
