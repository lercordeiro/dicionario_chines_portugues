...
\end{verbete}
\begin{verbete}[5;4;5;6]{卡车司机}{ka3che1·si1ji1}
  \significado{s.}{motorista de caminhão}
\end{verbete}
\begin{verbete}[5;4]{卡片}{ka3pian4}
  \significado{s.}{cartão}
\end{verbete}
\begin{verbete}[5;4;12;6]{卡片游戏}{ka3pian4·you2xi4}
...
\end{verbete}
\begin{verbete}[4;5;4]{开尔文}{kai1'er3wen2}
...
\end{verbete}
\begin{verbete}[5;12;12]{可编程}{ke3bian1cheng2}
  \significado{adj.}{programável}
\end{verbete}
\begin{verbeteextragrande}[5;17;5;5;12;12;5;10;6;12;16]{可擦写可编程只读存储器}{ke3ca1xie3ke3bian1cheng2zhi1du2cun2chu3qi4}
  \significado{s.}{EPROM (\textit{erasable programmable read-only memory})}
\end{verbeteextragrande}
\begin{verbete*}[5;3;5;5]{可口可乐}{ke3kou3ke3le4}
...
\end{verbete}
\begin{verbete}[8;9]{刻钟}{ke4·zhong1}
...
\end{verbete*}
\begin{verbete*}[4;4;3]{孔夫子}{kong3fu1zi3}
...
\begin{verbete}[3]{口}{kou3}
  ...
  \significado{s.}{boca}
\end{verbete}
\begin{verbete}[3;11]{口袋}{kou3dai4}
  \significado{s.}{bolso; saco}
\end{verbete}
\begin{verbete*}[3;11;7;8]{口袋妖怪}{kou3dai4·yao1guai4}
