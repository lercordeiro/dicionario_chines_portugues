...
\begin{verbete}{再}{zai4}{6}[Radical 冂][Componentes 一冉]
...
\begin{verbete}{在}{zai4}{6}[Radical 土][Componentes 土]
...
\begin{verbete}{在意}{zai4yi4}{6;13}
  \significado{v.}{preocupar-se; importar-se}
\end{verbete}
...
\begin{verbete}{赞}{zan4}{16}[Radical 貝][Componentes 兟贝]
...
\begin{verbete}{脏}{zang1}{10}[Radical 肉][Componentes ⺼庄]
...
\begin{verbete}{盏}{zhan3}{10}[Radical 皿][Componentes 戋皿]
  \significado{p.c.}{para lâmpadas}
  \significado{s.}{copo pequeno}
\end{verbete}

\begin{verbete}{战}{zhan4}{9}[Radical 戈][Componentes 占戈]
...
\begin{verbete}{站}{zhan4}{10}[Radical 立][Componentes 立占]
...
\begin{verbete}{张}{zhang1}{7}[Radical 弓][Componentes 弓长]
...
\begin{verbete}{章}{zhang1}{11}[Radical 音][Componentes 立早]
  \significado*{s.}{sobrenome Zhang}
...
\begin{verbete}{着}{zhao1}{11}[Radical 目][Componentes 羊目]
...
\begin{verbete}{朝}{zhao1}{12}[Radical 月][Componentes 龺月]
  \significado{s.}{manhã}
  \veja{朝}{chao2}
\end{verbete}

\begin{verbete}{着}{zhao2}{11}[Radical 目][Componentes 羊目]
...
\begin{verbete}{找}{zhao3}{7}[Radical 手][Componentes 扌戈]
...
\begin{verbete}{正}{zheng1}{5}[Radical 止][Componentes 一止]
...
\begin{verbete}{整天}{zheng3tian1}{16;4}
  \significado{p.t.}{dia todo; o dia inteiro}
\end{verbete}

\begin{verbete}{正}{zheng4}{5}[Radical 止][Componentes 一止]
...
\begin{verbete}{挣}{zheng4}{9}[Radical 手][Componentes 扌争]
...
\begin{verbete}{之外}{zhi1wai4}{3;5}
  \significado{p.d.l.}{lado de fora}
\end{verbete}

\begin{verbete}{支}{zhi1}{4}[Radical 支][Componentes 十又][Kangxi 65]
...
\begin{verbete}{只}{zhi1}{5}[Radical 口][Componentes 口八]
...
\begin{verbete}{殖}{zhi2}{12}[Radical 歹][Componentes 歹直]
  \significado{v.}{crescer; reproduzir}
\end{verbete}

\begin{verbete}{只}{zhi3}{5}[Radical 口][Componentes 口八]
...
\begin{verbete}{治理}{zhi4li3}{8;11}
  \significado{p.d.l.}{governança; governo}
...
\begin{verbete}{众}{zhong4}{6}[Radical 人][Componentes 人从]
...
\begin{verbete}{重}{zhong4}{9}[Radical ⾥][Componentes 千⾥]
...
\begin{verbete}{周}{zhou1}{8}[Radical 口][Componentes 田口]
...
\begin{verbete}{住}{zhu4}{7}[Radical 人][Componentes 亻主]
...
\begin{verbete}{祝}{zhu4}{9}[Radical 示][Componentes 礻兄]
...
\begin{verbete}{传}{zhuan4}{6}[Radical 人][Componentes ⺅专]
  \significado{s.}{biografia; narrativa histórica; comentários; estação de retransmissão}
  \veja{传}{chuan2}
\end{verbete}

\begin{verbete}{转}{zhuan4}{8}[Radical 車][Componentes 车专]
...
\begin{verbete}{妆}{zhuang1}{6}[Radical 女][Componentes 丬女]
...
\begin{verbete}{桩}{zhuang1}{10}[Radical 木][Componentes 木庄]
  \significado{p.c.}{para eventos, casos, transações, assuntos, etc.}
  \significado{s.}{toco, estaca, pilha}
\end{verbete}

\begin{verbete}{装}{zhuang1}{12}[Radical 衣][Componentes 壮衣]
...
\begin{verbete}{坠}{zhui4}{7}[Radical 土][Componentes 队土]
...
\begin{verbete}{准}{zhun3}{10}[Radical 冫][Componentes 冫隹]
  \significado{adv.}{certamente; de acordo com; à luz de}
  \significado{v.}{permitir; conceder}
\end{verbete}

\begin{verbete}{桌}{zhuo1}{10}[Radical 木][Componentes ⺊杲]
...
\begin{verbete}{资}{zi1}{10}[Radical 貝][Componentes 次贝]
...
\begin{verbete}{紫}{zi3}{12}[Radical 糸][Componentes 此糸]
...
\begin{verbete}{字}{zi4}{6}[Radical 子][Componentes 宀子]
...
\begin{verbete}{租}{zu1}{10}[Radical 禾][Componentes 禾且]
...
\begin{verbete}{族}{zu2}{11}[Radical 方][Componentes 方矢𠂉]
...
\begin{verbete}{最}{zui4}{12}[Radical 冂][Componentes 曰取]
...
\begin{verbete}{坐}{zuo4}{7}[Radical 土][Componentes 土从]
  \significado*{s.}{sobrenome Zuo}
