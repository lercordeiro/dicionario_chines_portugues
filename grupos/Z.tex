...
\begin{verbete}{再}{zai4}{6}
  \significado{adv.}{de novo; outra vez; uma segunda vez; não importa como... (seguido por um adjetivo ou verbo, e então (normalmente) 也 ou 都 para dar ênfase)}
\end{verbete}
...
\begin{verbete}{正}{zheng4}{5}
  \significado{adj.}{reto; vertical; adequado; principa; matemática: positivo}
...
\begin{verbete}{自然}{zi4ran2}{6;12}
  \significado{interr.}{naturalmente; de maneira natural}
\end{verbete}
...
\begin{verbete}{最}{zui4}{12}
  \significado{adv.}{o mais; o melhor; a coisa mais...; grau superlativo relativo de superioridade}
\end{verbete}
