...
\begin{verbete}{天才}{tian1cai2}{4;3}
  \significado{adj.}{talentoso; superdotado}
...
\begin{verbete}{吐}{tu3}{6}
  \significado{v.}{cuspir; enviar (seda de um bicho-da-seda, cápsulas de flores de algodão etc.); dizer; despejar (as próprias queixas)}
  \veja{吐}{tu4}
\end{verbete}

\begin{verbete}{吐}{tu4}{6}
  \significado{v.}{vomitar, cuspir, tossir}
  \veja{吐}{tu3}
\end{verbete}
