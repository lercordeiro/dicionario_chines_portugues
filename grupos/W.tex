...
\begin{verbete}{玩}{wan2}{8}[Radical 玉][Componentes 王元]
...
\begin{verbete}{碗}{wan3}{13}[Radical 石][Componentes 石宛]
...
\begin{verbete}{万}{wan4}{3}[Radical 一][Componentes 一丿𠃌]
...
\begin{verbete}{王}{wang2}{4}[Radical 玉][Componentes 一土]
...
\begin{verbete}{网}{wang3}{6}[Radical 网][Componentes 冂爻][Kangxi 122]
  \significado{s.}{rede}
\end{verbete}
...
\begin{verbete}{往}{wang3}{8}[Radical 彳][Componentes 彳主]
...
\begin{verbete}{罔}{wang3}{8}[Radical 网][Componentes 冂]
  \significado{v.}{enganar}
\end{verbete}

\begin{verbete}{王}{wang4}{4}[Radical 玉][Componentes 一土]
  \significado{v.}{(literário) (um monarca) reinar (um reino)}
  \veja{王}{wang2}
\end{verbete}

\begin{verbete}{忘}{wang4}{7}[Radical 心][Componentes 亡心]
...
\begin{verbete}{位}{wei4}{7}[Radical 人][Componentes 亻立]
...
\begin{verbete}{味}{wei4}{8}[Radical 口][Componentes 口未]
...
\begin{verbete}{喂}{wei4}{12}[Radical 口][Componentes 口畏]
...
\begin{verbete}{问}{wen4}{6}[Radical 門][Componentes 门口]
...
\begin{verbete}{我}{wo3}{7}[Radical 戈][Componentes 手戈]
...
\begin{verbete}{卧}{wo4}{8}[Radical 卜][Componentes 臣卜]
