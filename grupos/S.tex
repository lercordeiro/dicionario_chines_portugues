...
\end{verbete*}
﻿\begin{verbete}[3;7;10;10]{三角恋爱}{san1jiao3lian4'ai4}
...
\end{verbete}
\begin{verbete}[3;9]{上面}{shang4mian4}
  \significado{p.l.}{acima de; parte de cima; por cima}
\end{verbete}
...
\end{verbete}
\begin{verbete}[5;11]{生菜}{sheng1cai4}
...
\end{verbete}
\begin{verbete}[5;9;9]{生活型}{sheng1huo2·xing2}
...
\end{verbete}
\begin{verbeteextragrande}[11;6;6;8;6;12;16]{随机存取存储器}{sui2ji1cun2qu3cun2chu3qi4}
  \significado{s.}{RAM (\textit{random access memory})}
  \veja{内存}{nei4cun2}
  \veja*{随机存取记忆体}{sui2ji1cun2qu3ji4yi4ti3}
\end{verbeteextragrande}
\begin{verbeteextragrande}[11;6;6;8;5;4;7]{随机存取记忆体}{sui2ji1cun2qu3ji4yi4ti3}
  \significado{s.}{RAM (\textit{random access memory})}
  \veja{内存}{nei4cun2}
