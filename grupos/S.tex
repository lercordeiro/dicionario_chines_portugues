...
\begin{verbete}{散}{san3}{12}[Radical 攴][Componentes ⺼攵龷]
...
\begin{verbete}{散}{san4}{12}[Radical 攴][Componentes ⺼攵龷]
...
\begin{verbete}{桑}{sang1}{10}[Radical 木][Componentes 叒木]
...
\begin{verbete}{上}{shang4}{3}[Radical 一][Componentes ⺊一]
...
\begin{verbete}{深夜}{shen1ye4}{11;8}
  \significado{p.t.}{tarde da noite}
\end{verbete}
...
\begin{verbete}{师}{shi1}{6}[Radical 巾][Componentes 丨丿帀]
...
\begin{verbete}{十}{shi2}{2}[Radical 十][Componentes 一丨][Kangxi 24]
...
\begin{verbete}{式}{shi4}{6}[Radical 弋][Componentes 弋工]
...
\begin{verbete}{收}{shou1}{6}[Radical 攴][Componentes 丩⺙]
...
\begin{verbete}{手}{shou3}{4}[Radical 手][Componentes ㇒扌][Kangxi 64]
...
\begin{verbete}{瘦}{shou4}{14}[Radical 疒][Componentes 疒叟]
...
\begin{verbete}{属}{shu3}{12}[Radical 尸][Componentes 尸禹]
...
\begin{verbete}{薯}{shu3}{16}[Radical 艸][Componentes 艹署]
  \significado{s.}{batata; inhame}
\end{verbete}

\begin{verbete}{束}{shu4}{7}[Radical 木][Componentes 木口]
...
\begin{verbete}{树}{shu4}{9}[Radical 木][Componentes 木对]
...
\begin{verbete}{耍}{shua3}{9}[Radical 而][Componentes 而女]
...
\begin{verbete}{摔}{shuai1}{14}[Radical 手][Componentes 扌率]
  \significado{v.}{cair; cair e quebrar; partir}
\end{verbete}

\begin{verbete}{帅}{shuai4}{5}[Radical 巾][Componentes 丨丿巾]
...
\begin{verbete}{双}{shuang1}{4}[Radical 又][Componentes 又]
...
\begin{verbete}{霜}{shuang1}{17}[Radical 雨][Componentes 雨相]
  \significado{s.}{geada; pó branco ou creme espalhado por uma superfície; glacê; creme de pele}
\end{verbete}

\begin{verbete}{谁}{shui2}{10}[Radical 言][Componentes 讠隹]
  \significado{interr.}{quem?}
  \veja{谁}{shei2}
\end{verbete}

\begin{verbete}{水}{shui3}{4}[Radical 水][Componentes ㇇丿乀亅][Kangxi 85]
...
\begin{verbete}{说}{shuo1}{9}[Radical 言][Componentes 讠兑]
...
\begin{verbete}{丝}{si1}{5}[Radical 一][Componentes 一]
  \significado{adj.}{filiforme; delgado como um fio; que se assemelha a um fio}
  \significado{p.c.}{um traço (de fumaça, etc.), um pouquinho, etc.}
...
\begin{verbete}{寺}{si4}{6}[Radical 寸][Componentes 土寸]
...
\begin{verbete}{尿}{suan1}{14}[Radical 酉][Componentes 酉夋]
...
\begin{verbete}{尿}{sui1}{7}[Radical 尸][Componentes 尸水]
  \significado{s.}{(coloquial) urina}
  \veja{尿}{niao4}
\end{verbete}

\begin{verbete}{虽}{sui1}{9}[Radical 虫][Componentes 口虫]
...
\begin{verbete}{岁}{sui4}{6}[Radical 山][Componentes 山夕]
  \significado{p.c.}{para anos (de idade)}
  \significado{s.}{idade; ano (idade ou colheita)}
\end{verbete}

\begin{verbete}{碎}{sui4}{13}[Radical 石][Componentes 石卒]
