...
\begin{verbete}[6;10;14;5]{戏剧演出}[\\]{xi4·ju4·yan3chu1}
...
\begin{verbete}[9;7]{香艳}{xiang1yan1}
...
\begin{verbete}[6;7]{向汪}{xiang4·wang3}
...
\begin{verbete}[3;9;5;12]{小洋白菜}[\\]{xiao3·yang2bai2cai1}
...
\begin{verbete}[9;5;9]{性生活}{xing2\ ye4sheng1}
  \significado{s.}{vida sexual}
\end{verbete}

\begin{verbete}[9]{省}{xing3}
  \significado[个]{s.}{governadoria}
  \significado{v.}{estar ciente; examinar; inspecionar; fazer uma visita (aos pais ou idosos)}
  \veja{省}{sheng3}
\end{verbete}
