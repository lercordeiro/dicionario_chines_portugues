...
\begin{verbete}{阳}{yang2}{6}
  \significado{s.}{Yang (o princípio positivo de Yin e Yang); positivo (eletricida de); sol}
  \veja{阴}{yin1}
  \veja{阴阳}{yin1yang2}
\end{verbete}
...
\begin{verbete}{一}{yi1}[(quando usado sozinho)]{1}
  \significado{num.}{1, um; pronunciado como «\pinyin{yao1}» quando dito número a número}
  \veja{一}{yi2}
  \veja{一}{yi4}
\end{verbete}
