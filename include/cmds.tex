...
\newcommand{\areference}[2]
 {
%  \hyperref[\l_label_tl : #1 : #2]{#1\ \dpy{#2}\ (p.~\pageref*{\l_label_tl : #1 : #2})}
  \StrLen{#1}[\hlen]%
  \StrLen{#2}[\plen]%
   \ifnumcomp{\hlen+\plen}{>}{24}
    {%
     \hyperref[\l_label_tl : #1 : #2]{\foreignlanguage{chinese-hans}{#1} (\pageref*{\l_label_tl : #1 : #2})\newline\dpy{#2}}
    }
    {%
     \hyperref[\l_label_tl : #1 : #2]{\foreignlanguage{chinese-hans}{#1}\ \dpy{#2} (\pageref*{\l_label_tl : #1 : #2})}
    }
 }
