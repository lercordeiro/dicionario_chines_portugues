...
\begin{Entry}{刻舟求剑}{8,6,7,9}{⼑、⾈、⽔、⼑}
  \begin{Phonetics}{刻舟求剑}{ke4zhou1-qiu2jian4}[][HSK 7-9]
    \definition{expr.}{``Marcando o barco para encontrar a espada.''; Literalmente: um entalhe na lateral de um barco para localizar uma espada que caiu ao mar; Figurativo: uma ação que se torna inútil devido a circunstâncias alteradas; tomar medidas sem levar em conta mudanças nas circunstâncias; ``Um homem do estado de Chu deixou cair sua espada no rio enquanto o atravessava. Ele marcou o local onde a espada havia caído na lateral do barco. Quando o barco parou, ele entrou na água a partir do ponto marcado para procurar sua espada, mas, naturalmente, não a encontrou.'' (de ``Lüshi Chunqiu, 吕氏春秋'', ``Observando o Presente, 察今'' )}
  \end{Phonetics}
\end{Entry}
