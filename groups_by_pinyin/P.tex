...
\begin{entry}{拍}{pai1}{8}[HSK 3][Radical ⼿]
...
\begin{entry}{排队}{pai2dui4}{11,4}[HSK 2][Radicais ⼿、⾩]
  \definition{v.+compl.}{formar uma fila | alinhar | listar | classificar}
\end{entry}

\begin{entry}{排列}{pai2lie4}{11,6}[HSK 4][Radicais ⼿、⼑]
  \definition{v.}{classificar; colocar; variar; organizar; pôr em ordem}
\end{entry}

\begin{entry}{排名}{pai2 ming2}{11,6}[HSK 3][Radicais ⼿、⼝]
  \definition{s.}{classificação; resultado}
\end{entry}

\begin{entry}{排球}{pai2 qiu2}{11,11}[HSK 2][Radicais ⼿、⽟]
  \definition[个]{s.}{voleibol}
\end{entry}

\begin{entry}{排水}{pai2shui3}{11,4}[Radicais ⼿、⽔]
  \definition{v.}{drenar}
\end{entry}

\begin{entry}{牌}{pai2}{12}[HSK 4][Radical ⽚]
...
\begin{entry}{牌子}{pai2 zi5}{12,3}[HSK 3][Radicais ⽚、⼦]
  \definition[个,种,块]{s.}{sinal; placa | marca; marca registrada}
\end{entry}

\begin{entry}{派}{pai4}{9}[HSK 3][Radical ⽔]
...
\begin{entry}{攀爬}{pan1pa2}{19,8}[Radicais ⼿、⽖]
  \definition{v.}{escalar}
\end{entry}

\begin{entry}{攀岩}{pan1yan2}{19,8}[Radicais ⼿、⼭]
  \definition{s.}{alpinista}
  \definition{v.}{escalar uma montanha}
\end{entry}

\begin{entry}{胖}{pan2}{9}[Radical ⾁]
  \definition{adj.}{saudável}
  \seeref{胖}{pang4}
\end{entry}

\begin{entry}{般}{pan2}{10}[Radical ⾈]
  \definition{s.}{utilizado em 般乐 \dpy{pan2le4}}
  \seeref{般乐}{pan2le4}
\end{entry}

\begin{entry}{般乐}{pan2le4}{10,5}[Radicais ⾈、⼃]
  \definition{v.}{jogar | divertir-se}
\end{entry}

\begin{entry}{盘}{pan2}{11}[HSK 4][Radical ⽫]
...
\begin{entry}{盘子}{pan2zi5}{11,3}[HSK 4][Radicais ⽫、⼦]
...
\begin{entry}{槃}{pan2}{14}[Radical ⽊]
  \variantof{盘}
\end{entry}

\begin{entry}{判断}{pan4duan4}{7,11}[HSK 3][Radicais ⼑、⽄]
  \definition[个]{s.}{julgamento}
  \definition{v.}{julgar; decidir}
\end{entry}

\begin{entry}{旁边}{pang2bian1}{10,5}[HSK 1][Radicais ⽅、⾡]
  \definition{adv.}{junto a | próximo de | ao lado}
\end{entry}

\begin{entry}{胖}{pang4}{9}[HSK 3][Radical ⾁]
  \definition{adj.}{gordo; robusto; rechonchudo}
  \seeref{胖}{pan2}
\end{entry}

\begin{entry}{胖子}{pang4 zi5}{9,3}[HSK 4][Radicais ⾁、⼦]
  \definition{s.}{obeso; gordo; pessoa gorda}
\end{entry}

\begin{entry}{泡}{pao1}{8}[Radical ⽔]
...
\begin{entry}{胚}{pei1}{9}[Radical ⾁]
  \definition{s.}{embrião}
\end{entry}

\begin{entry}{陪}{pei2}{10}[Radical ⾩]
  \definition{v.}{acompanhar | ajudar | fazer companhia a alguém}
\end{entry}

\begin{entry}{培训}{pei2xun4}{11,5}[HSK 4][Radicais ⼟、⾔]
  \definition{v.}{treinar (trabalhadores técnicos, quadros profissionais, etc.)}
\end{entry}

\begin{entry}{培训班}{pei2 xun4 ban1}{11,5,10}[HSK 4][Radicais ⼟、⾔、⽟]
  \definition{s.}{aula de treinamento; curso de treinamento}
\end{entry}

\begin{entry}{培养}{pei2yang3}{11,9}[HSK 4][Radicais ⼟、⼋]
...
\begin{entry}{培育}{pei2yu4}{11,8}[HSK 4][Radicais ⼟、⾁]
  \definition{v.}{criar; fomentar; educar; procriar; nutrir; cultivar}
\end{entry}

\begin{entry}{赔钱}{pei2qian2}{12,10}[Radicais ⾙、⾦]
  \definition{v.+compl.}{perder dinheiro | pagar pelos danos}
\end{entry}

\begin{entry}{佩服}{pei4fu2}{8,8}[Radicais ⼈、⽉]
  \definition{v.}{admirar}
\end{entry}

\begin{entry}{配}{pei4}{10}[HSK 3][Radical ⾣]
  \definition{s.}{esposa}
...
\begin{entry}{批评}{pi1ping2}{7,7}[HSK 3][Radicais ⼿、⾔]
  \definition{s.}{crítica}
  \definition{v.}{criticar; comentar sobre}
\end{entry}

\begin{entry}{批准}{pi1zhun3}{7,10}[HSK 3][Radicais ⼿、⼎]
  \definition{v.}{aprovar}
\end{entry}

\begin{entry}{皮}{pi2}{5}[HSK 3][Kangxi 107][Radical ⽪]
...
\begin{entry}{篇}{pian1}{15}[HSK 2][Radical ⽵]
...
\begin{entry}{便宜}{pian2yi5}{9,8}[HSK 2][Radicais ⼈、⼧]
  \definition{adj.}{barato}
  \definition{v.}{deixar alguém levemente de lado}
\end{entry}

\begin{entry}{片}{pian4}{4}[HSK 2][Kangxi 91][Radical ⽚]
...
\begin{entry}{票价}{piao4 jia4}{11,6}[HSK 3][Radicais ⽰、⼈]
  \definition[个]{s.}{o preço de um bilhete; taxa de admissão; taxa de entrada}
\end{entry}

\begin{entry}{漂}{piao4}{14}[Radical ⽔]
...
\begin{entry}{漂亮}{piao4liang5}{14,9}[HSK 2][Radicais ⽔、⼇]
  \definition{adj.}{bonita, linda | bonito, lindo (para objetos inanimados)}
\end{entry}

\begin{entry}{拼}{pin1}{9}[Radical ⼿]
  \definition{v.}{soletrar | juntar | unir}
\end{entry}

\begin{entry}{拼命}{pin1ming4}{9,8}[Radicais ⼿、⼝]
...
\begin{entry}{拼音}{pin1yin1}{9,9}[Radicais ⼿、⾳]
  \definition{s.}{escrita fonética | pinyin (romanização chinesa)}
\end{entry}

\begin{entry}{贫民窟}{pin2min2ku1}{8,5,13}[Radicais ⾙、⽒、⽳]
  \definition{s.}{favela}
\end{entry}

\begin{entry}{频道}{pin2dao4}{13,12}[Radicais ⾴、⾡]
  \definition{s.}{frequência | (televisão) canal}
\end{entry}

\begin{entry}{品德}{pin3de2}{9,15}[Radicais ⼝、⼻]
  \definition{s.}{caráter moral | moralidade}
\end{entry}

\begin{entry}{品质}{pin3zhi4}{9,8}[HSK 4][Radicais ⼝、⾙]
...
\begin{entry}{乒乓球}{ping1pang1qiu2}{6,6,11}[Radicais ⼃、⼃、⽟]
  \definition[个]{s.}{tênis de mesa |ping-pong}
\end{entry}

\begin{entry}{平}{ping2}{5}[HSK 2][Radical ⼲]
...
\begin{entry}{破产}{po4chan3}{10,6}[HSK 4][Radicais ⽯、⼇]
...
\begin{entry}{破坏}{po4huai4}{10,7}[HSK 3][Radicais ⽯、⼟]
