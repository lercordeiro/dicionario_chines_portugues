...
\begin{entry}{汉语}{han4yu3}{5,9}
  \definition[门]{s.}{chinês, língua chinesa, mandarim}
\end{entry}
...
\begin{entry}{号}{hao4}{5}[Radical 口]
  ...
  \definition[个]{s.}{dia do mês | número}
  \seeref{号}{hao2}
\end{entry}
...
\begin{entry}{和}{he2}{8}[Radical 口]
  ...
  \definition{conj.}{e (somente para palavras)}
  \seeref{和}{he4}
  \seeref{和}{hu2}
  \seeref{和}{huo2}
  \seeref{和}{huo4}
...
\begin{entry}{和}{he4}{8}[Radical 口]
  \definition{v.}{conversar com os outros | compor um poema em resposta (ao poema de alguém) usando a mesma sequência de rimas | juntar-se ao canto (canção)}
  \seeref{和}{he2}
  \seeref{和}{hu2}
  \seeref{和}{huo2}
  \seeref{和}{huo4}
...
\begin{entry}{和}{huo4}{8}[Radical 口]
  \definition{clas.}{para fervuras de ervas medicinais | para enxágue de roupas}
  \definition{v.}{misturar | misturar (ingredientes) juntos}
  \seeref{和}{he2}
  \seeref{和}{he4}
  \seeref{和}{hu2}
  \seeref{和}{huo2}
