...
\begin{entry}{回}{hui2}{6}{⼞}[HSK 1,2]
  \definition{clas.}{para coisas, ações, número de vezes |  um trecho de um conto; um capítulo de um romance em capítulos}
  \definition{s.}{seção ou capítulo (de um livro clássico) | grupo étnico Hui (mulçumanos chineses) | sobrenome Hui}
  \definition{v.}{circular | retornar; voltar; voltar ao lugar de origem; devolver | dar a volta; dar meia-volta | responder; retribuir | informar; relatar; responder}
\end{entry}
...
\begin{entry}{回来}{hui2 lai5}{6,7}{⼞、⽊}[HSK 1]
  \definition{v.}{voltar; retornar (para a minha localização) | usado após o verbo, significa ``vir ao lugar original''}
\end{entry}
