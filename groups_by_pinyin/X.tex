...
\begin{entry}{吸}{xi1}{6}[HSK 4][Radical ⼝]
...
\begin{entry}{吸管}{xi1 guan3}{6,14}[HSK 4][Radicais ⼝、⽵]
...
\begin{entry}{吸收}{xi1shou1}{6,6}[HSK 4][Radicais ⼝、⽁]
...
\begin{entry}{吸烟}{xi1yan1}{6,10}[HSK 4][Radicais ⼝、⽕]
  \definition{v.+compl.}{fumar}
\end{entry}

\begin{entry}{吸引}{xi1yin3}{6,4}[HSK 4][Radicais ⼝、⼸]
...
\begin{entry}{西语}{xi1yu3}{6,9}[Radicais ⾑、⾔]
  \definition{s.}{espanhol | língua espanhola}
  \seealsoref{西班牙语}{xi1ban1ya2yu3}
\end{entry}

\begin{entry}{希望}{xi1wang4}{7,11}[HSK 3][Radicais ⼱、⽉]
...
\begin{entry}{戏院}{xi4yuan4}{6,9}[Radicais ⼽、⾩]
  \definition{s.}{teatro}
\end{entry}

\begin{entry}{系}{xi4}{7}[HSK 3,4][Radical ⽷]
...
\begin{entry}{系列}{xi4lie4}{7,6}[HSK 4][Radicais ⽷、⼑]
  \definition{s.}{série; conjunto; conjunto de coisas relacionadas (matemática)}
\end{entry}

\begin{entry}{系囚}{xi4qiu2}{7,5}[Radicais ⽷、⼞]
  \definition{s.}{prisioneiro}
\end{entry}

\begin{entry}{系统}{xi4tong3}{7,9}[HSK 4][Radicais ⽷、⽷]
...
\begin{entry}{细}{xi4}{8}[HSK 4][Radical ⽷]
...
\begin{entry}{细节}{xi4jie2}{8,5}[HSK 4][Radicais ⽷、⾋]
...
\begin{entry}{细菌战}{xi4jun1zhan4}{8,11,9}[Radicais ⽷、⾋、⼽]
  \definition{s.}{guerra biológica}
\end{entry}

\begin{entry}{细致}{xi4zhi4}{8,10}[HSK 4][Radicais ⽷、⾄]
  \definition{adj.}{meticuloso; cuidadoso; minucioso | intrincado; delicado}
\end{entry}

\begin{entry}{虾}{xia1}{9}[Radical ⾍]
  \definition{s.}{camarão}
\end{entry}

\begin{entry}{下}{xia4}{3}[HSK 1,2][Radical ⼀]
...
\begin{entry}{下楼}{xia4 lou2}{3,13}[HSK 4][Radicais ⼀、⽊]
  \definition{v.}{descer as escadas}
\end{entry}

\begin{entry}{下面}{xia4 mian4}{3,9}[HSK 3][Radicais ⼀、⾯]
...
\begin{entry}{下去}{xia4 qu4}{3,5}[HSK 3][Radicais ⼀、⼛]
...
\begin{entry}{夏季}{xia4 ji4}{10,8}[HSK 4][Radicais ⼢、⼦]
...
\begin{entry}{鲜}{xian1}{14}[HSK 4][Radical ⿂]
...
\begin{entry}{咸盐}{xian2yan2}{9,10}[Radicais ⼝、⽫]
  \definition{s.}{(coloquial) sal | sal de mesa}
\end{entry}

\begin{entry}{咸鱼}{xian2yu2}{9,8}[Radicais ⼝、⿂]
  \definition{s.}{peixe salgado}
\end{entry}

\begin{entry}{显得}{xian3de5}{9,11}[HSK 3][Radicais ⽇、⼻]
  \definition{v.}{parecer; aparecer}
\end{entry}

\begin{entry}{显然}{xian3ran2}{9,12}[HSK 3][Radicais ⽇、⽕]
  \definition{adj.}{claro; evidente; óbvio}
  \definition{adv.}{claramente; evidentemente; obviamente}
\end{entry}

\begin{entry}{显示}{xian3shi4}{9,5}[HSK 3][Radicais ⽇、⽰]
  \definition{v.}{mostrar | exibir}
\end{entry}

\begin{entry}{显著}{xian3zhu4}{9,11}[HSK 4][Radicais ⽇、⽬]
...
\begin{entry}{猃狁}{xian3yun3}{10,7}[Radicais ⽝、⽝]
...
\begin{entry}{线香}{xian4xiang1}{8,9}[Radicais ⽷、⾹]
  \definition{s.}{bastão ou vareta de incenso}
\end{entry}

\begin{entry}{宪法法院}{xian4fa3fa3yuan4}{9,8,8,9}[Radicais ⼧、⽔、⽔、⾩]
  \definition{s.}{tribunal constitucional}
\end{entry}

\begin{entry}{宪政}{xian4zheng4}{9,9}[Radicais ⼧、⽁]
  \definition{s.}{governo constitucional}
\end{entry}

\begin{entry}{宪制}{xian4zhi4}{9,8}[Radicais ⼧、⼑]
  \definition{adj.}{constitucional}
  \definition{s.}{sistema de governo constitucional}
\end{entry}

\begin{entry}{陷入}{xian4ru4}{10,2}[Radicais ⾩、⼊]
  \definition{v.}{afundar | ser pego em | pousar (em uma situação)}
\end{entry}

\begin{entry}{羡慕}{xian4mu4}{12,14}[Radicais ⽺、⼼]
  \definition{v.}{invejar | admirar}
\end{entry}

\begin{entry}{乡巴佬}{xiang1ba1lao3}{3,4,8}[Radicais ⼄、⼰、⼈]
  \definition{s.}{aldeão | caipira}
\end{entry}

\begin{entry}{乡村}{xiang1cun1}{3,7}[Radicais ⼄、⽊]
  \definition{adj.}{rural | rústico}
  \definition{s.}{vila | campo}
\end{entry}

\begin{entry}{相比}{xiang1 bi3}{9,4}[HSK 3][Radicais ⽬、⽐]
...
\begin{entry}{相处}{xiang1chu3}{9,5}[Radicais ⽬、⼡]
  \definition{v.}{entrar em contato (com alguém) | associar | interagir | se dar bem (bem, mal)}
\end{entry}

\begin{entry}{相当}{xiang1dang1}{9,6}[HSK 3][Radicais ⽬、⼹]
...
\begin{entry}{相关}{xiang1guan1}{9,6}[HSK 3][Radicais ⽬、⼋]
  \definition{v.}{mutuamente relacionados; inter-relacionados}
\end{entry}

\begin{entry}{相互}{xiang1 hu4}{9,4}[HSK 3][Radicais ⽬、⼆]
  \definition{adj.}{mútuo; recíproco}
  \definition{adv.}{mutuamente; um ao outro}
\end{entry}

\begin{entry}{相聚}{xiang1ju4}{9,14}[Radicais ⽬、⽿]
  \definition{v.}{reunir-se | montar}
\end{entry}

\begin{entry}{相亲}{xiang1qin1}{9,9}[Radicais ⽬、⼇]
...
\begin{entry}{相思病}{xiang1si1bing4}{9,9,10}[Radicais ⽬、⼼、⽧]
  \definition{s.}{saudade de amor}
\end{entry}

\begin{entry}{相似}{xiang1si4}{9,6}[HSK 3][Radicais ⽬、⼈]
  \definition{v.}{assemelhar-se; ser semelhante; ser igual}
\end{entry}

\begin{entry}{相同}{xiang1tong2}{9,6}[HSK 2][Radicais ⽬、⼝]
  \definition{adj.}{igual | idêntico | o mesmo}
\end{entry}

\begin{entry}{相信}{xiang1xin4}{9,9}[HSK 2][Radicais ⽬、⼈]
  \definition{v.}{acreditar | estar convencido | aceitar como verdadeiro}
\end{entry}

\begin{entry}{相宜}{xiang1yi2}{9,8}[Radicais ⽬、⼧]
  \definition{adj.}{adequado | apropriado}
  \definition{v.}{ser adequado ou apropriado}
\end{entry}

\begin{entry}{相遇}{xiang1yu4}{9,12}[Radicais ⽬、⾡]
  \definition{v.}{encontrar (reunião, encontro, etc.)}
\end{entry}

\begin{entry}{香}{xiang1}{9}[HSK 3][Kangxi 186][Radical ⾹]
...
\begin{entry}{香槟酒}{xiang1bin1jiu3}{9,14,10}[Radicais ⾹、⽊、⾣]
  \definition[杯]{s.}{(empréstimo linguístico) \emph{champagne}}
\end{entry}

\begin{entry}{香波}{xiang1bo1}{9,8}[Radicais ⾹、⽔]
  \definition{s.}{xampu}
\end{entry}

\begin{entry}{香肠}{xiang1chang2}{9,7}[Radicais ⾹、⾁]
  \definition[根]{s.}{salsicha}
\end{entry}

\begin{entry}{香港}{xiang1gang3}{9,12}[Radicais ⾹、⽔]
...
\begin{entry}{想念}{xiang3nian4}{13,8}[Radicais ⼼、⼼]
  \definition{v.}{perder | sentir falta | lembrar com saudade}
\end{entry}

\begin{entry}{想起}{xiang3 qi3}{13,10}[HSK 2][Radicais ⼼、⾛]
...
\begin{entry}{想想看}{xiang3xiang3kan4}{13,13,9}[Radicais ⼼、⼼、⽬]
  \definition{v.}{pensar sobre isso}
\end{entry}

\begin{entry}{想象}{xiang3xiang4}{13,11}[Radicais ⼼、⾗]
  \definition{v.}{imaginar}
\end{entry}

\begin{entry}{向}{xiang4}{6}[HSK 2][Radical ⼝]
  \definition*{s.}{sobrenome Xiang}
  \definition{prep.}{para}
  \definition{v.}{enfrentar | virar para | apoiar}
\end{entry}

\begin{entry}{向汪}{xiang4wang1}{6,7}[Radicais ⼝、⽔]
  \definition{v.}{esperar que}
\end{entry}

\begin{entry}{向往}{xiang4wang3}{6,8}[Radicais ⼝、⼻]
...
\begin{entry}{鞋}{xie2}{15}[HSK 2][Radical ⾰]
  \definition[双,只]{s.}{sapatos}
\end{entry}

\begin{entry}{写}{xie3}{5}[HSK 1][Radical ⼍]
  \definition{v.}{escrever}
\end{entry}

\begin{entry}{写意}{xie3yi4}{5,13}[Radicais ⼍、⼼]
...
\begin{entry}{写照}{xie3zhao4}{5,13}[Radicais ⼍、⽕]
  \definition{s.}{retrato}
\end{entry}

\begin{entry}{写真}{xie3zhen1}{5,10}[Radicais ⼍、⼗]
  \definition{s.}{retrato}
  \definition{v.}{descrever algo com precisão}
\end{entry}

\begin{entry}{写字}{xie3zi4}{5,6}[Radicais ⼍、⼦]
  \definition{v.}{escrever (à mão) | praticar caligrafia}
\end{entry}

\begin{entry}{写字匠}{xie3zi4 jiang4}{5,6,6}[Radicais ⼍、⼦、⼕]
  \definition{s.}{calígrafo}
\end{entry}

\begin{entry}{写作}{xie3zuo4}{5,7}[HSK 3][Radicais ⼍、⼈]
...
\begin{entry}{血}{xie3}{6}[Kangxi 143][Radical ⾎]
  \seeref{血}{xue4}
\end{entry}

\begin{entry}{写意}{xie4yi4}{5,13}[Radicais ⼍、⼼]
  \definition{adj.}{confortável | agradável | relaxado}
  \seeref{写意}{xie3yi4}
\end{entry}

\begin{entry}{泄气}{xie4qi4}{8,4}[Radicais ⽔、⽓]
...
\begin{entry}{谢病}{xie4bing4}{12,10}[Radicais ⾔、⽧]
...
\begin{entry}{新加坡}{xin1jia1po1}{13,5,8}[Radicais ⽄、⼒、⼟]
  \definition*{s.}{Singapura}
\end{entry}

\begin{entry}{新疆}{xin1jiang1}{13,19}[Radicais ⽄、⼸]
...
\begin{entry}{信封}{xin4feng1}{9,9}[HSK 3][Radicais ⼈、⼨]
  \definition[个]{s.}{envelope de carta}
\end{entry}

\begin{entry}{信号}{xin4hao4}{9,5}[HSK 2][Radicais ⼈、⼝]
  \definition[个]{s.}{sinal | ponte de sinalização}
\end{entry}

\begin{entry}{信经}{xin4jing1}{9,8}[Radicais ⼈、⽷]
  \definition[个]{s.}{crença | credo (seção da missa católica)}
\end{entry}

\begin{entry}{信任}{xin4ren4}{9,6}[HSK 3][Radicais ⼈、⼈]
  \definition[个]{s.}{confiança; certeza; convicção}
  \definition{v.}{confiar; ter confiança em}
\end{entry}

\begin{entry}{信息}{xin4xi1}{9,10}[HSK 2][Radicais ⼈、⼼]
  \definition[个,条]{s.}{notícias | informação | mensagem}
\end{entry}

\begin{entry}{信心}{xin4xin1}{9,4}[HSK 2][Radicais ⼈、⼼]
  \definition[个]{s.}{confiança | fé (em alguém ou algo)}
\end{entry}

\begin{entry}{信用}{xin4yong4}{9,5}[Radicais ⼈、⽤]
  \definition{s.}{crédito (comércio)}
\end{entry}

\begin{entry}{信用卡}{xin4yong4ka3}{9,5,5}[HSK 2][Radicais ⼈、⽤、⼘]
  \definition[些]{s.}{cartão de crédito}
\end{entry}

\begin{entry}{兴}{xing1}{6}[Radical ⼋]
...
\begin{entry}{星表}{xing1biao3}{9,8}[Radicais ⽇、⾐]
  \definition{s.}{catálogo de estrelas}
\end{entry}

\begin{entry}{星辰}{xing1chen2}{9,7}[Radicais ⽇、⾠]
...
\begin{entry}{形状}{xing2zhuang4}{7,7}[HSK 3][Radicais ⼺、⽝]
...
\begin{entry}{幸亏}{xing4kui1}{8,3}[Radicais ⼲、⼆]
  \definition{adv.}{felizmente}
\end{entry}

\begin{entry}{幸运}{xing4yun4}{8,7}[HSK 3][Radicais ⼲、⾡]
  \definition{adj.}{sortudo; feliz; afortunado}
  \definition[个]{s.}{boa sorte; boa fortuna}
\end{entry}

\begin{entry}{幸运抽奖}{xing4yun4chou1jiang3}{8,7,8,9}[Radicais ⼲、⾡、⼿、⼤]
  \definition{s.}{loteria | sorteio}
\end{entry}

\begin{entry}{幸运儿}{xing4yun4'er2}{8,7,2}[Radicais ⼲、⾡、⼉]
  \definition{s.}{pessoa de sorte}
\end{entry}

\begin{entry}{性}{xing4}{8}[HSK 3][Radical ⼼]
  \definition*{s.}{sobrenome Xing}
...
\begin{entry}{性别}{xing4bie2}{8,7}[HSK 3][Radicais ⼼、⼑]
  \definition[种]{s.}{sexo; gênero}
\end{entry}

\begin{entry}{性格}{xing4ge2}{8,10}[HSK 3][Radicais ⼼、⽊]
  \definition[种,个]{s.}{caráter; temperamento}
\end{entry}

\begin{entry}{性侵}{xing4qin1}{8,9}[Radicais ⼼、⼈]
  \definition{s.}{agressão sexual}
  \definition{v.}{agredir sexualmente}
\end{entry}

\begin{entry}{性生活}{xing4sheng1huo2}{8,5,9}[Radicais ⼼、⽣、⽔]
  \definition{s.}{vida sexual}
\end{entry}

\begin{entry}{兄弟}{xiong1di4}{5,7}[Radicais ⼉、⼸]
...
\begin{entry}{修改}{xiu1gai3}{9,7}[HSK 3][Radicais ⼈、⽁]
  \definition{v.}{revisar; alterar}
\end{entry}

\begin{entry}{修规}{xiu1gui1}{9,8}[Radicais ⼈、⾒]
  \definition{s.}{plano de construção}
\end{entry}

\begin{entry}{绣}{xiu4}{10}[Radical ⽷]
...
\begin{entry}{宣布}{xuan1bu4}{9,5}[HSK 3][Radicais ⼧、⼱]
...
\begin{entry}{学分}{xue2fen1}{8,4}[Radicais ⼦、⼑]
  \definition{s.}{créditos de um curso}
\end{entry}

\begin{entry}{学好}{xue2hao3}{8,6}[Radicais ⼦、⼥]
  \definition{v.}{seguir bons exemplos | aprender bem}
\end{entry}

\begin{entry}{学会}{xue2hui4}{8,6}[Radicais ⼦、⼈]
...
\begin{entry}{学期}{xue2qi1}{8,12}[HSK 2][Radicais ⼦、⽉]
  \definition[个]{s.}{semestre}
\end{entry}

\begin{entry}{学生}{xue2sheng5}{8,5}[HSK 1][Radicais ⼦、⽣]
  \definition{s.}{estudante | aluno}
\end{entry}

\begin{entry}{学生证}{xue2sheng5zheng4}{8,5,7}[Radicais ⼦、⽣、⾔]
  \definition{s.}{cartão de identidade de estudante}
\end{entry}

\begin{entry}{学术}{xue2shu4}{8,5}[Radicais ⼦、⽊]
  \definition[个]{s.}{aprendizagem | ciência}
\end{entry}

\begin{entry}{学问}{xue2wen4}{8,6}[Radicais ⼦、⾨]
...
\begin{entry}{血汗}{xue4han4}{6,6}[Radicais ⾎、⽔]
  \definition{s.}{(fig.) suor e labuta, trabalho duro}
\end{entry}

\begin{entry}{熏香}{xun1xiang1}{14,9}[Radicais ⽕、⾹]
  \definition{s.}{incenso}
\end{entry}

\begin{entry}{巡逻}{xun2luo2}{6,11}[Radicais ⾡、⾡]
  \definition{s.}{patrulha}
  \definition{v.}{patrulhar (polícia, exército ou marinha)}
\end{entry}

\begin{entry}{训练}{xun4lian4}{5,8}[HSK 3][Radicais ⾔、⽷]
