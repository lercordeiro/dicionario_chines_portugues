...
\begin{entry}{打}{da2}{5}[Radical 手]
  \definition{s.}{(empréstimo linguístico) dúzia}
  \seeref{打}{da3}
\end{entry}

\begin{entry}{答案}{da2'an4}{12,10}
  \definition[个]{s.}{resposta | solução}
\end{entry}

\begin{entry}{打}{da3}{5}[Radical 手]
...
\begin{entry}{打电话}{da3dian4hua4}{5,5,8}
  \definition{v.}{ligar | dar um telefonema}
  \seealsoref{给……打电话}{gei3 da3dian4hua4}
\end{entry}

\begin{entry}{打工}{da3gong1}{5,3}
...
\begin{entry}{打球}{da3qiu2}{5,11}
  \definition{v.}{jogar bola | jogar (futebol, basquetebol, handbol, etc.)}
\end{entry}

\begin{entry}{打扰}{da3rao3}{5,7}
  \definition{v.}{perturbar | incomodar}
\end{entry}

\begin{entry}{打算}{da3suan4}{5,14}
...
\begin{entry}{打针}{da3zhen1}{5,7}
  \definition{v.+compl.}{dar injeção | levar injeção}
\end{entry}

\begin{entry}{大}{da4}{3}[Radical ⼈][Kangxi 37]
  \definition{adj.}{grande}
  \seeref{大}{dai4}
\end{entry}

\begin{entry}{大胆}{da4dan3}{3,9}
...
\begin{entry}{大}{dai4}{3}[Radical ⼈]
  \definition{s.}{usado em 大夫 \dpy{dai4fu5}}
  \seeref{大}{da4}
  \seeref{大夫}{dai4fu5}
\end{entry}
...
\begin{entry}{带}{dai4}{9}[Radical ⼱]
  \definition{v.}{levar | trazer}
\end{entry}

\begin{entry}{带来}{dai4lai2}{9,7}
  \definition{v.}{trazer | (figurativo) provocar, produzir}
\end{entry}

\begin{entry}{逮}{dai4}{11}[Radical 辵]
...
\begin{entry}{单}{dan1}{8}[Radical 十]
...
\begin{entry}{刀}{dao1}{2}[Radical ⼑][Kangxi 18]
...
\begin{entry}{倒}{dao3}{10}[Radical 人]
...
\begin{entry}{到}{dao4}{8}[Radical 刀]
  \definition{prep.}{a | até | para}
  \definition{v.}{chegar}
\end{entry}

\begin{entry}{到处}{dao4chu4}{8,5}
  \definition{adv.}{em todos os lugares}
\end{entry}

\begin{entry}{到底}{dao4di3}{8,8}
...
\begin{entry}{倒}{dao4}{10}[Radical 人]
...
\begin{entry}{得}{de2}{11}[Radical 彳]
  \definition{v.}{obter | ganhar | pegar (uma doença)}
  \seeref{得}{de5}
  \seeref{得}{dei3}
\end{entry}

\begin{entry}{得到}{de2dao4}{11,8}
  \definition{v.}{obter | receber}
\end{entry}

\begin{entry}{得了}{de2le5}{11,2}
...
\begin{entry}{德}{de2}{15}[Radical 彳]
...
\begin{entry}{地}{de5}{6}[Radical 土]
  \definition{part.}{(estrutural) utilizada antes de um verbo ou adjetivo, ligando-o ao adjunto adverbial modificador precedente}
  \seeref{地}{di4}
\end{entry}

\begin{entry}{的}{de5}{8}[Radical 白]
  \definition{part.}{utilizada em possessivos | utilizada entre adjetivos e substantivos (opcional se o adjetivo possui apenas um carácter) | utilizada após um atributo | utilizada no final de uma frase declarativa para dar ênfase | para formar uma expressão nominal}
  \seeref{的}{di1}
  \seeref{的}{di2}
  \seeref{的}{di4}
\end{entry}

\begin{entry}{得}{de5}{11}[Radical 彳]
  \definition{part.}{(estrutural) ligando um verbo à frase seguinte indicando efeito, grau, possibilidade, etc.}
  \seeref{得}{de2}
  \seeref{得}{dei3}
\end{entry}

\begin{entry}{得}{dei3}{11}[Radical 彳]
  \definition{v.}{haver de | ter de}
  \seeref{得}{de2}
  \seeref{得}{de5}
\end{entry}

\begin{entry}{灯}{deng1}{6}[Radical 火]
...
\begin{entry}{登}{deng1}{12}[Radical 癶]
  \definition{v.}{subir (montanha, cume)}
\end{entry}

\begin{entry}{等}{deng3}{12}[Radical 竹]
  \definition{v.}{esperar | esperar por}
\end{entry}

\begin{entry}{等待}{deng3dai4}{12,9}
  \definition{v.}{esperar | esperar por}
\end{entry}

\begin{entry}{低}{di1}{7}[Radical 人]
  \definition{adj.}{baixo}
  \definition{adv.}{abaixo}
  \definition{v.}{abaixar (a cabeça) | deixar cair | pendurar | inclinar}
\end{entry}

\begin{entry}{的}{di1}{8}[Radical 白]
  \definition{s.}{um táxi (abreviação de 的士)}
  \seeref{的}{de5}
  \seeref{的}{di2}
  \seeref{的}{di4}
...
\begin{entry}{滴}{di1}{14}[Radical 水]
  \definition{s.}{uma gota}
  \definition{v.}{pingar}
\end{entry}

\begin{entry}{的}{di2}{8}[Radical 白]
...
\begin{entry}{的确}{di2que4}{8,12}
  \definition{adv.}{de fato | realmente}
\end{entry}

\begin{entry}{笛}{di2}{11}[Radical 竹]
  \definition{s.}{flauta}
\end{entry}
...
\begin{entry}{地}{di4}{6}[Radical 土]
  \definition[个,片]{s.}{mundo | campo | chão | terra | lugar}
  \seeref{地}{de5}
\end{entry}

\begin{entry}{地点}{di4dian3}{6,9}
...
\begin{entry}{地球}{di4qiu2}{6,11}
  \definition{s.}{o planeta terra}
\end{entry}

\begin{entry}{地区}{di4qu1}{6,4}
...
\begin{entry}{地铁}{di4tie3}{6,10}
  \definition{s.}{metrô, metropolitano}
\end{entry}

\begin{entry}{地图}{di4tu2}{6,8}
...
\begin{entry}{弟}{di4}{7}[Radical 弓]
  \definition{s.}{irmão mais novo | júnior}
\end{entry}

\begin{entry}{弟弟}{di4di5}{7,7}
...
\begin{entry}{的}{di4}{8}[Radical 白]
  \definition{s.}{alvo | mosca (centro do alvo)}
  \seeref{的}{de5}
  \seeref{的}{di1}
  \seeref{的}{di2}
\end{entry}
...
\begin{entry}{第}{di4}{11}[Radical 竹]
...
\begin{entry}{点}{dian3}{9}[Radical 火]
  \definition{clas.}{para itens | hora cheia}
  \definition{s.}{ponto | ponto (no espaço ou no tempo) | gota | partícula}
\end{entry}
...
\begin{entry}{电影}{dian4ying3}{5,15}
  \definition[部,片,幕,场]{s.}{cinema | filme}
\end{entry}
...
\begin{entry}{掉}{diao4}{11}[Radical 手]
...
\begin{entry}{东西}{dong1xi5}{5,6}
  \definition[个,件]{s.}{coisa | materia | pessoa}
  \seeref{东西}{dong1xi1}
\end{entry}
...
\begin{entry}{冬天}{dong1tian1}{5,4}
  \definition{s.}{inverno}
\end{entry}

\begin{entry}{懂}{dong3}{15}[Radical 心]
  \definition{v.}{compreender | entender}
\end{entry}

\begin{entry}{动}{dong4}{6}[Radical 力]
...
\begin{entry}{动物}{dong4wu4}{6,8}
  \definition[只,群,个]{s.}{animal}
\end{entry}

\begin{entry}{动物园}{dong4wu4yuan2}{6,8,7}
  \definition[个]{s.}{jardim zoológico | zoo}
\end{entry}

\begin{entry}{动作}{dong4zuo4}{6,7}
...
\begin{entry}{都}{dou1}{10}[Radical 邑]
...
\begin{entry}{读}{dou4}{10}[Radical 言]
  \definition{s.}{vírgula | frase marcada por pausa}
  \seeref{读}{du2}
\end{entry}

\begin{entry}{都}{du1}{10}[Radical 邑]
...
\begin{entry}{肚}{du4}{7}[Radical 肉]
  \definition{s.}{barriga}
  \seeref{肚}{du3}
\end{entry}

\begin{entry}{肚子}{du4zi5}{7,3}
  \definition[个]{s.}{abdómen | barriga}
\end{entry}

\begin{entry}{度}{du4}{9}[Radical ⼴]
...
\begin{entry}{短}{duan3}{12}[Radical ⽮]
  \definition{adj.}{curto | breve}
\end{entry}

\begin{entry}{短处}{duan3chu4}{12,5}
...
\begin{entry}{锻炼}{duan4lian4}{14,9}
  \definition{v.}{fazer exercício físico | praticar esporte}
\end{entry}

\begin{entry}{队}{dui4}{4}[Radical 阜]
...
\begin{entry}{顿}{dun4}{10}[Radical 頁]
...
\begin{entry}{多少}{duo1shao5}{6,4}
  \definition{adv.}{quanto? | quantos? | (para mais de 10 itens)}
  \seeref{多少}{duo1shao3}
\end{entry}

\begin{entry}{多云}{duo1yun2}{6,4}
