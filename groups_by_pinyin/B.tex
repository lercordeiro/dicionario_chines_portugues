...
\begin{entry}{北京}{bei3jing1}{5,8}
  \definition*{s.}{Beijing (Pequim), Capital da China}
\end{entry}
...
\begin{entry}{本}{ben3}{5}[Radical 木]
  \definition{adv.}{inerente | originalmente}
  \definition{clas.}{para livros, dicionários, periódicos, arquivos, etc.}
  \definition{s.}{origem | fonte | raiz}
\end{entry}
...
\begin{entry}{不客气}{bu2ke4qi5}{4,9,4}
  \definition{expr.}{de nada | não há de que}
\end{entry}
