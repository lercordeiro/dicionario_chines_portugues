...
\begin{entry}{北}{bei3}{5}{⼔}[HSK 1]
  \definition*{s.}{Norte (os países desenvolvidos) | Especifica a parte norte da China | sobrenome Bei}
...
\begin{entry}{本}{ben3}{5}{⽊}[HSK 1]
  ...
  \definition[个]{s.}{caule ou raiz de plantas | base; origem; fundamento; fundação;  alicerce | capital; capital social | livro; caderno; livreto | edição; versão | cópia; roteiro; manuscrito |
memorial do trono; na era feudal, referia-se a um documento oficial |}
...
\begin{entry}{不}{bu4}{4}{⼀}[HSK 1]
  \definition{adv.}{(antes de verbos, adjetivos e outros advérbios; nunca antes do verbo 有) não; não vai; não quer | em algumas expressões educadas, significa que não é necessário fazer isso, o que equivale a ``不用'' ou ``不要'' | | (entre um verbo e seu complemento) não pode |
usado com "就" para indicar escolha}
