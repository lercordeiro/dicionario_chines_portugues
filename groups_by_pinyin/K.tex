...
\begin{entry}{刻}{ke4}{8}{⼑}[HSK 2,5]
  \definition{adj.}{no mais alto grau | áspero; ríspido; rude; indelicado}
  \definition{clas.}{um quarto (de uma hora)}
  \definition{s.}{momento;}
  \definition{v.}{cortar; esculpir; inscrever; gravar; esculpir com uma faca (padrões, texto, etc.) |
