...
\begin{entry}{擦}{ca1}{17}[HSK 4][Radical ⼿]
...
\begin{entry}{擦拭}{ca1shi4}{17,9}[Radicais ⼿、⼿]
  \definition{v.}{limpar com um pano}
\end{entry}

\begin{entry}{猜}{cai1}{11}[Radical ⽝]
  \definition{v.}{advinhar}
\end{entry}

\begin{entry}{才}{cai2}{3}[HSK 2,4][Radical ⼿]
...
\begin{entry}{才华}{cai2hua2}{3,6}[Radicais ⼿、⼗]
  \definition[份]{s.}{talento}
\end{entry}

\begin{entry}{才略}{cai2lve4}{3,11}[Radicais ⼿、⽥]
  \definition{s.}{habilidade e sagacidade}
\end{entry}

\begin{entry}{才能}{cai2 neng2}{3,10}[HSK 3][Radicais ⼿、⾁]
  \definition[间]{s.}{talento | habilidade | dom | capacidade}
\end{entry}

\begin{entry}{材料}{cai2liao4}{7,10}[HSK 4][Radicais ⽊、⽃]
...
\begin{entry}{采访}{cai3fang3}{8,6}[HSK 4][Radicais ⾤、⾔]
...
\begin{entry}{采取}{cai3qu3}{8,8}[HSK 3][Radicais ⾤、⼜]
  \definition{v.}{adotar | reunir | coletar | tomar | assumir}
\end{entry}

\begin{entry}{采用}{cai3 yong4}{8,5}[HSK 3][Radicais ⾤、⽤]
...
\begin{entry}{参考}{can1kao3}{8,6}[HSK 4][Radicais ⼛、⽼]
...
\begin{entry}{参与}{can1yu4}{8,3}[HSK 4][Radicais ⼛、⼀]
...
\begin{entry}{蚕纸}{can2zhi3}{10,7}[Radicais ⾍、⽷]
  \definition{s.}{papel onde o bicho-da-seda põe seus ovos}
\end{entry}

\begin{entry}{惨}{can3}{11}[Radical ⽕]
...
\begin{entry}{长途}{chang2tu2}{4,10}[HSK 4][Radicais ⾧、⾡]
...
\begin{entry}{常识}{chang2shi2}{11,7}[HSK 4][Radicais ⼱、⾔]
  \definition{s.}{senso comum; conhecimento geral; conhecimento que uma pessoa comum deve ter}
\end{entry}

\begin{entry}{常问问题}{chang2wen4wen4ti2}{11,6,6,15}[Radicais ⼱、⾨、⾨、⾴]
  \definition{s.}{FAQ; perguntas frequentes}
\end{entry}

\begin{entry}{常用}{chang2 yong4}{11,5}[HSK 2][Radicais ⼱、⽤]
  \definition{adj.}{em uso comum}
\end{entry}

\begin{entry}{厂}{chang3}{2}[HSK 3][Radical ⼚]
  \definition[家]{s.}{fábrica; moinho; planta; obra | pátio; depósito}
  \seeref{厂}{han3}
\end{entry}

\begin{entry}{场}{chang3}{6}[HSK 2][Radical ⼟]
...
\begin{entry}{场合}{chang3he2}{6,6}[HSK 3][Radicais ⼟、⼝]
  \definition[种]{s.}{ocasião; situação}
\end{entry}

\begin{entry}{场景}{chang3jing3}{6,12}[Radicais ⼟、⽇]
  \definition{s.}{cena | cenário | situação | contexto}
\end{entry}

\begin{entry}{场面}{chang3mian4}{6,9}[Radicais ⼟、⾯]
  \definition{s.}{cena | espetáculo | ocasião | situação}
\end{entry}

\begin{entry}{场所}{chang3suo3}{6,8}[HSK 3][Radicais ⼟、⼾]
  \definition{s.}{lugar; sítio; arena}
\end{entry}

\begin{entry}{唱}{chang4}{11}[HSK 1][Radical ⼝]
  \definition{v.}{cantar}
\end{entry}

\begin{entry}{唱歌}{chang4 ge1}{11,14}[HSK 1][Radicais ⼝、⽋]
  \definition{v.+compl.}{cantar}
\end{entry}

\begin{entry}{唱片}{chang4 pian4}{11,4}[HSK 4][Radicais ⼝、⽚]
...
\begin{entry}{抄}{chao1}{7}[HSK 4][Radical ⼿]
...
\begin{entry}{朝}{chao2}{12}[HSK 3][Radical ⽉]
  \definition*{s.}{sobrenome Chao}
...
\begin{entry}{朝廷}{chao2ting2}{12,6}[Radicais ⽉、⼵]
  \definition{s.}{corte imperial | dinastia}
\end{entry}

\begin{entry}{朝鲜}{chao2xian3}{12,14}[Radicais ⽉、⿂]
  \definition*{s.}{Coréia do Norte}
\end{entry}

\begin{entry}{潮}{chao2}{15}[HSK 4][Radical ⽔]
...
\begin{entry}{潮流}{chao2liu2}{15,10}[HSK 4][Radicais ⽔、⽔]
...
\begin{entry}{沉}{chen2}{7}[HSK 4][Radical ⽔]
...
\begin{entry}{称赞}{cheng1zan4}{10,16}[HSK 4][Radicais ⽲、⾙]
...
\begin{entry}{成人}{cheng2ren2}{6,2}[HSK 4][Radicais ⼽、⼈]
  \definition[个]{s.}{adulto; crescido; pessoa adulta}
  \definition{v.}{crescer; tornar-se adulto}
\end{entry}

\begin{entry}{成色}{cheng2se4}{6,6}[Radicais ⼽、⾊]
  \definition{v.}{sair-se bem | ser bem sucedido}
\end{entry}
...
\begin{entry}{承担}{cheng2dan1}{8,8}[HSK 4][Radicais ⼿、⼿]
  \definition{v.}{suportar; empreender; assumir; tomar conta de algo}
\end{entry}

\begin{entry}{承认}{cheng2ren4}{8,4}[HSK 4][Radicais ⼿、⾔]
...
\begin{entry}{诚信}{cheng2 xin4}{8,9}[HSK 4][Radicais ⾔、⼈]
...
\begin{entry}{城市}{cheng2shi4}{9,5}[HSK 3][Radicais ⼟、⼱]
...
\begin{entry}{程序}{cheng2xu4}{12,7}[HSK 4][Radicais ⽲、⼴]
...
\begin{entry}{冲锋}{chong1feng1}{6,12}[Radicais ⼎、⾦]
  \definition{v.}{cobrar | tomar de assalto}
\end{entry}

\begin{entry}{冲浪}{chong1lang4}{6,10}[Radicais ⼎、⽔]
  \definition{s.}{surfe}
  \definition{v.}{surfar}
\end{entry}

\begin{entry}{冲突}{chong1tu1}{6,9}[Radicais ⼎、⽳]
  \definition{s.}{conflito | choque de forças opostas | colisão (de interesses)}
\end{entry}

\begin{entry}{憧憬}{chong1jing3}{15,15}[Radicais ⼼、⼼]
  \definition{v.}{ansiar por | esperar por}
\end{entry}

\begin{entry}{虫子}{chong2 zi5}{6,3}[HSK 4][Radicais ⾍、⼦]
...
\begin{entry}{宠物}{chong3wu4}{8,8}[Radicais ⼧、⽜]
...
\begin{entry}{抽}{chou1}{8}[HSK 4][Radical ⼿]
...
\begin{entry}{抽奖}{chou1 jiang3}{8,9}[HSK 4][Radicais ⼿、⼤]
  \definition{s.}{loteria; sorteio de loteria}
\end{entry}

\begin{entry}{抽烟}{chou1yan1}{8,10}[HSK 4][Radicais ⼿、⽕]
  \definition{v.+compl.}{fumar (um cigarro ou um cachimbo)}
\end{entry}

\begin{entry}{酬劳}{chou2lao2}{13,7}[Radicais ⾣、⼒]
...
\begin{entry}{臭气}{chou4qi4}{10,4}[Radicais ⾃、⽓]
  \definition{s.}{fedor}
\end{entry}

\begin{entry}{出}{chu1}{5}[HSK 1][Radical ⼐]
  \definition{clas.}{para dramas, peças, óperas, etc.}
  \definition{v.}{sair | ir para fora | vir para fora}
\end{entry}

\begin{entry}{出版}{chu1ban3}{5,8}[Radicais ⼐、⽚]
  \definition{v.}{publicar | editar}
\end{entry}

\begin{entry}{出版社}{chu1ban3she4}{5,8,7}[Radicais ⼐、⽚、⽰]
  \definition{s.}{editora}
\end{entry}

\begin{entry}{出差}{chu1chai1}{5,9}[Radicais ⼐、⼯]
...
\begin{entry}{出口}{chu1kou3}{5,3}[HSK 2,4][Radicais ⼐、⼝]
...
\begin{entry}{出色}{chu1se4}{5,6}[HSK 4][Radicais ⼐、⾊]
...
\begin{entry}{出售}{chu1 shou4}{5,11}[HSK 4][Radicais ⼐、⼝]
  \definition{v.}{vender; oferecer para venda}
\end{entry}

\begin{entry}{出席}{chu1xi2}{5,10}[HSK 4][Radicais ⼐、⼱]
...
\begin{entry}{出行}{chu1xing2}{5,6}[Radicais ⼐、⾏]
  \definition{v.}{sair para algum lugar (viagem relativamente curta) | partir em uma viagem (viagem mais longa)}
\end{entry}

\begin{entry}{出院}{chu1 yuan4}{5,9}[HSK 2][Radicais ⼐、⾩]
  \definition{v.}{deixar o hospital | estar fora do hospital | ter alta do hospital}
\end{entry}

\begin{entry}{出站}{chu1 zhan4}{5,10}[Radicais ⼐、⽴]
  \definition{s.}{saída da estação}
\end{entry}

\begin{entry}{出租}{chu1 zu1}{5,10}[HSK 2][Radicais ⼐、⽲]
  \definition{v.}{alugar | arrendar}
\end{entry}

\begin{entry}{出租车}{chu1zu1che1}{5,10,4}[HSK 2][Radicais ⼐、⽲、⾞]
  \definition{s.}{táxi}
  \seealsoref{出租汽车}{chu1zu1qi4che1}
\end{entry}

\begin{entry}{出租汽车}{chu1zu1qi4che1}{5,10,7,4}[Radicais ⼐、⽲、⽔、⾞]
  \definition[辆]{s.}{táxi}
  \seealsoref{出租车}{chu1zu1che1}
\end{entry}

\begin{entry}{出租司机}{chu1zu1si1ji1}{5,10,5,6}[Radicais ⼐、⽲、⼝、⽊]
  \definition{s.}{motorista de táxi}
\end{entry}

\begin{entry}{初}{chu1}{7}[HSK 3][Radical ⾐]
...
\begin{entry}{初步}{chu1bu4}{7,7}[HSK 3][Radicais ⾐、⽌]
  \definition{adj.}{inicial; preliminar}
\end{entry}

\begin{entry}{初级}{chu1ji2}{7,6}[HSK 3][Radicais ⾐、⽷]
  \definition{adj.}{elementar; primário; júnior; inicial}
\end{entry}

\begin{entry}{初心}{chu1xin1}{7,4}[Radicais ⾐、⼼]
...
\begin{entry}{初中}{chu1 zhong1}{7,4}[HSK 3][Radicais ⾐、⼁]
  \definition[所,个]{s.}{ensino médio; ensino fundamental}
\end{entry}

\begin{entry}{除非}{chu2fei1}{9,8}[Radicais ⾩、⾮]
  \definition{conj.}{a menos que | somente se}
\end{entry}

\begin{entry}{除了}{chu2le5}{9,2}[HSK 3][Radicais ⾩、⼅]
  \definition{prep.}{exceto; à parte | além disso; além de | ou \dots ou \dots}
\end{entry}

\begin{entry}{厨房}{chu2fang2}{12,8}[Radicais ⼚、⼾]
  \definition[间]{s.}{cozinha}
\end{entry}

\begin{entry}{处}{chu3}{5}[HSK 4][Radical ⼡]
  \definition*{s.}{sobrenome Chu}
...
\begin{entry}{处罚}{chu3fa2}{5,9}[Radicais ⼡、⽹]
  \definition{v.}{penalizar | punir}
\end{entry}

\begin{entry}{处理}{chu3li3}{5,11}[HSK 3][Radicais ⼡、⽟]
...
\begin{entry}{处于}{chu3 yu2}{5,3}[HSK 4][Radicais ⼡、⼆]
...
\begin{entry}{处处}{chu4chu4}{5,5}[Radicais ⼡、⼡]
...
\begin{entry}{穿}{chuan1}{9}[HSK 1][Radical ⽳]
  \definition{v.}{vestir}
\end{entry}

\begin{entry}{穿上}{chuan1 shang4}{9,3}[HSK 4][Radicais ⽳、⼀]
  \definition{v.}{vestir (roupas, etc.); colocar roupas}
\end{entry}

\begin{entry}{传}{chuan2}{6}[HSK 3][Radical ⼈]
...
\begin{entry}{传播}{chuan2bo1}{6,15}[HSK 3][Radicais ⼈、⼿]
  \definition{v.}{espalhar; difundir; propagar; disseminar}
\end{entry}

\begin{entry}{传承}{chuan2cheng2}{6,8}[Radicais ⼈、⼿]
...
\begin{entry}{传真}{chuan2zhen1}{6,10}[Radicais ⼈、⼗]
...
\begin{entry}{绰号}{chuo4hao4}{11,5}[Radicais ⽷、⼝]
  \definition{s.}{apelido}
\end{entry}

\begin{entry}{刺}{ci1}{8}[Radical ⼑]
  \definition{s.}{(onomatopéia) som de rasgo, fricção, etc.}
\end{entry}

\begin{entry}{词}{ci2}{7}[HSK 2][Radical ⾔]
...
\begin{entry}{刺}{ci4}{8}[HSK 4][Radical ⼑]
  \definition*{s.}{sobrenome Ci}
...
\begin{entry}{刺激}{ci4ji1}{8,16}[HSK 4][Radicais ⼑、⽔]
...
\begin{entry}{聪慧}{cong1hui4}{15,15}[Radicais ⽿、⼼]
...
\begin{entry}{从此}{cong2ci3}{4,6}[HSK 4][Radicais ⼈、⽌]
...
\begin{entry}{粗}{cu1}{11}[HSK 4][Radical ⽶]
...
\begin{entry}{窾}{cuan4}{17}[Radical ⽳]
  \definition{v.}{esconder}
  \seeref{窾}{kuan3}
\end{entry}

\begin{entry}{村}{cun1}{7}[HSK 3][Radical ⽊]
  \definition{adj.}{rústico; grosseiro}
  \definition{s.}{aldeia; vila}
\end{entry}

\begin{entry}{存}{cun2}{6}[HSK 3][Radical ⼦]
