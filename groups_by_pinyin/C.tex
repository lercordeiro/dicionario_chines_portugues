...
\begin{entry}{长}{chang2}{4}{⾧}[HSK 2][Kangxi 168]
  ...
  \definition{adj.}{longo; comprido; a distância entre uma extremidade e outra é grande (em oposição a短 ) | para sempre; duradouro; a distância entre o ponto inicial e o ponto final de um determinado período é grande | excesso; o que sobra; o que é desnecessário}
...
\begin{entry}{车}{che1}{4}{⾞}[HSK 1][Kangxi 159]
  ...
  \definition[辆]{s.}{veículo; meios de transporte terrestres com rodas | máquina ou instrumento com rodas; ferramentas com eixo giratório | máquina}
  \definition{v.}{girar; tornear; usinar com torno mecânico | pegar água por meio de uma roda d'água | girar, geralmente se refere ao corpo}
  \seeref{车}{ju1}
\end{entry}
