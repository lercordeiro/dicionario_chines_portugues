...
\begin{entry}{麻}{ma2}{11}{⿇}[Kangxi 200]
...
\begin{entry}{马车}{ma3 che1}{3,4}{⾺、⾞}[HSK 6]
...
\begin{entry}{麦}{mai4}{7}{⿆}[Kangxi 199]
  \definition*{s.}{Sobrenome Mai}
...
\begin{entry}{馒头}{man2tou5}{14,5}{⾷、⼤}[HSK 6]
...
\begin{entry}{盲人}{mang2 ren2}{8,2}{⽬、⼈}[HSK 6]
...
\begin{entry}{梅花}{mei2 hua1}{11,7}{⽊、⾋}[HSK 6]
...
\begin{entry}{美容}{mei3 rong2}{9,10}{⽺、⼧}[HSK 6]
...
\begin{entry}{免得}{mian3de5}{7,11}{⼉、⼻}[HSK 6]
...
\begin{entry}{靣}{mian4}{8}{⼀}[Kangxi 176]
  \variantof{面}
\end{entry}
...
\begin{entry}{面对面}{mian4 dui4 mian4}{9,5,9}{⾯、⼨、⾯}[HSK 6]
...
\begin{entry}{面向}{mian4 xiang4}{9,6}{⾯、⼝}[HSK 6]
...
\begin{entry}{民歌}{min2 ge1}{5,14}{⽒、⽋}[HSK 6]
...
\begin{entry}{民工}{min2 gong1}{5,3}{⽒、⼯}[HSK 6]
...
\begin{entry}{民警}{min2 jing3}{5,19}{⽒、⾔}[HSK 6]
  \definition{s.}{polícia; policial}
\end{entry}

\begin{entry}{民意}{min2 yi4}{5,13}{⽒、⼼}[HSK 6]
...
\begin{entry}{民主}{min2zhu3}{5,5}{⽒、⼂}[HSK 6]
...
\begin{entry}{名额}{ming2'e2}{6,15}{⼝、⾴}[HSK 6]
...
\begin{entry}{名胜}{ming2 sheng4}{6,9}{⼝、⾁}[HSK 6]
  \definition[处,个]{s.}{pontos turísticos; atrações famosas; lugares famosos com locais históricos ou belas paisagens}
\end{entry}

\begin{entry}{名义}{ming2 yi4}{6,3}{⼝、⼂}[HSK 6]
  \definition{s.}{nominal; em nome (geralmente seguido por "上"); um nome ou título usado como base para fazer algo}[有人盗用我名义申请贷款。___Alguém solicitou um empréstimo em meu nome. | 他们只是名义上的夫妻。___Eles são marido e mulher apenas no nome.]
  \seealsoref{上}{shang4}
\end{entry}

\begin{entry}{名誉}{ming2yu4}{6,13}{⼝、⾔}[HSK 6]
  \definition{adj.}{1. honorário; nominal (geralmente se refere ao nome de um presente, com um sentido de respeito)}[他是学校的名誉教授。___Ele é professor honorário da escola.]
  \definition{s.}{fama; reputação; honra}[名誉才是最神圣的。___Reputação é a coisa mais sagrada. | 我用自己的名誉发誓。___Juro pela minha honra.]
\end{entry}
...
\begin{entry}{明日}{ming2 ri4}{8,4}{⽇、⽇}[HSK 6]
  \definition{s.}{amanhã}
...
\begin{entry}{没收}{mo4 shou1}{7,6}{⽔、⽁}[HSK 6]
...
\begin{entry}{墨水}{mo4 shui3}{15,4}{⿊、⽔}[HSK 6]
...
\begin{entry}{母}{mu3}{5}{⽏}[HSK 6][Kangxi 80]
  \definition*{s.}{Sobrenome Mu}
...
\begin{entry}{母鸡}{mu3ji1}{5,7}{⽏、⿃}[HSK 6]
  \definition{s.}{galinha}
\end{entry}

\begin{entry}{母女}{mu3 nv3}{5,3}{⽏、⼥}[HSK 6]
...
\begin{entry}{母子}{mu3 zi3}{5,3}{⽏、⼦}[HSK 6]
...
\begin{entry}{目}{mu4}{5}{⽬}[Kangxi 109]
  \definition*{s.}{Sobrenome Mu}
