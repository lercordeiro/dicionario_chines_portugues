...
\begin{entry}{几乎}{ji1hu1}{2,5}[HSK 4][Radicais ⼏、⼃]
...
\begin{entry}{机构}{ji1gou4}{6,8}[HSK 4][Radicais ⽊、⽊]
...
\begin{entry}{级}{ji2}{6}[HSK 2][Radical ⽷]
...
\begin{entry}{即}{ji2}{7}[Radical ⼙]
  \definition{conj.}{e | até | mesmo se/embora}
\end{entry}

\begin{entry}{即便}{ji2bian4}{7,9}[Radicais ⼙、⼈]
  \definition{conj.}{mesmo se/embora}
\end{entry}

\begin{entry}{即或}{ji2huo4}{7,8}[Radicais ⼙、⼽]
  \definition{conj.}{mesmo se/embora}
\end{entry}

\begin{entry}{即将}{ji2jiang1}{7,9}[HSK 4][Radicais ⼙、⼨]
  \definition{adv.}{em breve; estar prestes a; estar a ponto de}
\end{entry}

\begin{entry}{即若}{ji2ruo4}{7,8}[Radicais ⼙、⾋]
  \definition{conj.}{mesmo se/embora}
\end{entry}

\begin{entry}{即使}{ji2shi3}{7,8}[Radicais ⼙、⼈]
  \definition{conj.}{mesmo se/embora}
\end{entry}

\begin{entry}{即是}{ji2shi4}{7,9}[Radicais ⼙、⽇]
  \definition{conj.}{aquilo é}
\end{entry}

\begin{entry}{极}{ji2}{7}[HSK 4][Radical ⽊]
...
\begin{entry}{……极了}{ji2le5}{7,2}[HSK 3][Radicais ⽊、⼅]
  \definition{expr.}{extremamente}
\end{entry}

\begin{entry}{极其}{ji2qi2}{7,8}[HSK 4][Radicais ⽊、⼋]
  \definition{adv.}{mais; extremamente; excessivamente}
\end{entry}

\begin{entry}{急}{ji2}{9}[HSK 2][Radical ⼼]
...
\begin{entry}{纪律}{ji4lv4}{6,9}[HSK 4][Radicais ⽷、⼻]
...
\begin{entry}{技巧}{ji4qiao3}{7,5}[HSK 4][Radicais ⼿、⼯]
...
\begin{entry}{季}{ji4}{8}[HSK 4][Radical ⼦]
  \definition*{s.}{sobrenome Ji}
...
\begin{entry}{季度}{ji4du4}{8,9}[HSK 4][Radicais ⼦、⼴]
  \definition[个]{s.}{trimestre; período de tempo trimestral}
\end{entry}

\begin{entry}{季节}{ji4jie2}{8,5}[HSK 4][Radicais ⼦、⾋]
  \definition[个]{s.}{estação (clima); um período característico do ano}
\end{entry}

\begin{entry}{既}{ji4}{9}[HSK 4][Radical ⽆]
  \definition*{s.}{sobrenome Ji}
  \definition{adv.}{já}
...
\begin{entry}{既然}{ji4ran2}{9,12}[HSK 4][Radicais ⽆、⽕]
...
\begin{entry}{寄存}{ji4cun2}{11,6}[Radicais ⼧、⼦]
  \definition{v.}{depositar | deixar algo com alguém | armazenar}
\end{entry}

\begin{entry}{寄递}{ji4di4}{11,10}[Radicais ⼧、⾡]
  \definition{s.}{entrega de correspondência}
\end{entry}

\begin{entry}{寄放}{ji4fang4}{11,8}[Radicais ⼧、⽅]
  \definition{v.}{deixar algo com alguém}
\end{entry}

\begin{entry}{寄居}{ji4ju1}{11,8}[Radicais ⼧、⼫]
  \definition{s.}{morar longe de casa}
\end{entry}

\begin{entry}{寄卖}{ji4mai4}{11,8}[Radicais ⼧、⼗]
  \definition{v.}{consignar para venda}
\end{entry}

\begin{entry}{寄生}{ji4sheng1}{11,5}[Radicais ⼧、⽣]
...
\begin{entry}{家}{jia1}{10}[HSK 1,2][Radical ⼧]
...
\begin{entry}{架}{jia4}{9}[HSK 3][Radical ⽊]
...
\begin{entry}{减少}{jian3shao3}{11,4}[HSK 4][Radicais ⼎、⼩]
  \definition{v.}{cair; reduzir; diminuir; subtrair uma parte}
\end{entry}

\begin{entry}{检测}{jian3 ce4}{11,9}[HSK 4][Radicais ⽊、⽔]
...
\begin{entry}{简历}{jian3li4}{13,4}[HSK 4][Radicais ⽵、⼚]
...
\begin{entry}{健身}{jian4shen1}{10,7}[HSK 4][Radicais ⼈、⾝]
...
\begin{entry}{江}{jiang1}{6}[HSK 4][Radical ⽔]
  \definition*{s.}{Rio Changjiang | sobrenome Jiang}
  \definition[条,道]{s.}{rio grande}
\end{entry}

\begin{entry}{江南水乡}{jiang1nan2shui3xiang1}{6,9,4,3}[Radicais ⽔、⼗、⽔、⼄]
  \definition*{s.}{Vila Aquática de Jiangnan | Cidades Aquáticas}
\end{entry}

\begin{entry}{江水}{jiang1shui3}{6,4}[Radicais ⽔、⽔]
  \definition{s.}{água do rio}
\end{entry}

\begin{entry}{江西}{jiang1xi1}{6,6}[Radicais ⽔、⾑]
  \definition*{s.}{Jiangxi}
\end{entry}

\begin{entry}{姜}{jiang1}{9}[Radical ⼥]
  \definition*{s.}{sobrenome Jiang}
  \definition{s.}{gengibre}
\end{entry}

\begin{entry}{将近}{jiang1jin4}{9,7}[HSK 3][Radicais ⼨、⾡]
  \definition{adv.}{quase}
\end{entry}

\begin{entry}{将来}{jiang1lai2}{9,7}[HSK 3][Radicais ⼨、⽊]
  \definition[个]{s.}{futuro}
\end{entry}

\begin{entry}{将要}{jiang1yao4}{9,9}[Radicais ⼨、⾑]
  \definition{adv.}{vai | deve}
\end{entry}

\begin{entry}{讲}{jiang3}{6}[HSK 2][Radical ⾔]
...
\begin{entry}{讲话}{jiang3 hua4}{6,8}[HSK 2][Radicais ⾔、⾔]
  \definition{s.}{discurso | guia | introdução}
  \definition{v.+compl.}{falar | conversar | abordar}
\end{entry}

\begin{entry}{讲究}{jiang3jiu5}{6,7}[HSK 4][Radicais ⾔、⽳]
...
\begin{entry}{讲述}{jiang3shu4}{6,8}[Radicais ⾔、⾡]
  \definition{v.}{falar sobre | narrar | descrever}
\end{entry}

\begin{entry}{讲座}{jiang3zuo4}{6,10}[HSK 4][Radicais ⾔、⼴]
...
\begin{entry}{奖学金}{jiang3 xue2 jin1}{9,8,8}[HSK 4][Radicais ⼤、⼦、⾦]
...
\begin{entry}{降}{jiang4}{8}[HSK 4][Radical ⾩]
  \definition*{s.}{sobrenome Jiang}
  \definition{v.}{cair; descer | diminuir; reduzir | nascer}
\end{entry}

\begin{entry}{降低}{jiang4di1}{8,7}[HSK 4][Radicais ⾩、⼈]
  \definition{v.}{reduzir; cortar; diminuir; rebaixar; cair; abaixar}
\end{entry}

\begin{entry}{降价}{jiang4 jia4}{8,6}[HSK 4][Radicais ⾩、⼈]
  \definition{v.}{ficar mais barato; cortar o preço; reduzir o preço}
\end{entry}

\begin{entry}{降落}{jiang4luo4}{8,12}[HSK 4][Radicais ⾩、⾋]
  \definition{v.}{aterrissar; descer; descer do céu}
\end{entry}

\begin{entry}{降温}{jiang4 wen1}{8,12}[HSK 4][Radicais ⾩、⽔]
...
\begin{entry}{叫作}{jiao4 zuo4}{5,7}[HSK 2][Radicais ⼝、⼈]
  \definition{v.}{ser chamado de | ser conhecido como}
\end{entry}

\begin{entry}{校}{jiao4}{10}[Radical ⽊]
  \definition{v.}{verificar | comparar | revisar}
  \seeref{校}{xiao4}
\end{entry}

\begin{entry}{较}{jiao4}{10}[HSK 3][Radical ⾞]
...
\begin{entry}{敎}{jiao4}{11}[Radical ⽁]
  \variantof{教}
\end{entry}

\begin{entry}{教}{jiao4}{11}[Radical ⽁]
...
\begin{entry}{教材}{jiao4cai2}{11,7}[HSK 3][Radicais ⽁、⽊]
  \definition[本,套]{s.}{livro didático; material didático}
\end{entry}

\begin{entry}{教导}{jiao4dao3}{11,6}[Radicais ⽁、⼨]
...
\begin{entry}{接受}{jie1shou4}{11,8}[HSK 2][Radicais ⼿、⼜]
  \definition{v.}{aceitar | concordar}
\end{entry}

\begin{entry}{接下来}{jie1 xia4 lai2}{11,3,7}[HSK 2][Radicais ⼿、⼀、⽊]
  \definition{expr.}{próximo | seguinte | aceitar}
\end{entry}

\begin{entry}{接着}{jie1zhe5}{11,11}[HSK 2][Radicais ⼿、⽬]
  \definition{adv.}{por sua vez | com um seguindo o outro}
  \definition{v.}{seguir | prosseguir | continuar | prosseguir | pegar}
\end{entry}

\begin{entry}{街}{jie1}{12}[HSK 2][Radical ⾏]
  \definition[条]{s.}{rua}
\end{entry}

\begin{entry}{街道}{jie1dao4}{12,12}[HSK 4][Radicais ⾏、⾡]
...
\begin{entry}{街舞}{jie1wu3}{12,14}[Radicais ⾏、⾇]
  \definition{s.}{dança de rua, \emph{street dance} (por exemplo, \emph{breakdance})}
\end{entry}

\begin{entry}{节}{jie2}{5}[HSK 2][Radical ⾋]
...
\begin{entry}{节目}{jie2mu4}{5,5}[HSK 2][Radicais ⾋、⽬]
  \definition{s.}{programa | item (em um programa)}
\end{entry}

\begin{entry}{节日}{jie2ri4}{5,4}[HSK 2][Radicais ⾋、⽇]
  \definition[个]{s.}{festival | feriado}
\end{entry}

\begin{entry}{节省}{jie2sheng3}{5,9}[HSK 4][Radicais ⾋、⽬]
...
\begin{entry}{节约}{jie2yue1}{5,6}[HSK 3][Radicais ⾋、⽷]
  \definition{adj.}{econômico}
  \definition{v.}{guardar; economizar}
\end{entry}

\begin{entry}{节奏}{jie2zou4}{5,9}[Radicais ⾋、⼤]
  \definition{s.}{ritmo | cadência | batida}
\end{entry}

\begin{entry}{结}{jie2}{9}[HSK 4][Radical ⽷]
  \definition*{s.}{sobrenome Jie}
...
\begin{entry}{结构}{jie2gou4}{9,8}[HSK 4][Radicais ⽷、⽊]
...
\begin{entry}{结论}{jie2lun4}{9,6}[HSK 4][Radicais ⽷、⾔]
...
\begin{entry}{姐妹}{jie3 mei4}{8,8}[HSK 4][Radicais ⼥、⼥]
...
\begin{entry}{金子}{jin1zi5}{8,3}[Radicais ⾦、⼦]
...
\begin{entry}{纠葛}{jiu1ge2}{5,12}[Radicais ⽷、⾋]
  \definition{s.}{emaranhado | disputa}
\end{entry}

\begin{entry}{究竟}{jiu1jing4}{7,11}[HSK 4][Radicais ⽳、⾳]
...
\begin{entry}{九}{jiu3}{2}[HSK 1][Radical ⼄]
  \definition{num.}{nove; 9}
\end{entry}

\begin{entry}{久}{jiu3}{3}[HSK 3][Radical ⼃]
  \definition{adj.}{por muito tempo | duração de tempo especificada}
\end{entry}

\begin{entry}{韭菜}{jiu3cai4}{9,11}[Radicais ⾲、⾋]
...
\begin{entry}{酒店}{jiu3 dian4}{10,8}[HSK 2][Radicais ⾣、⼴]
  \definition[家]{s.}{hotel | restaurante}
\end{entry}

\begin{entry}{酒馆}{jiu3guan3}{10,11}[Radicais ⾣、⾷]
  \definition{s.}{bar | taverna | adega}
\end{entry}

\begin{entry}{酒鬼}{jiu3gui3}{10,9}[Radicais ⾣、⿁]
  \definition{adj.}{embriagado | ébrio}
  \definition{s.}{bêbado | alcoólatra | borracho}
\end{entry}

\begin{entry}{旧}{jiu4}{5}[HSK 3][Radical ⽇]
...
\begin{entry}{就是}{jiu4 shi4}{12,9}[HSK 3][Radicais ⼪、⽇]
...
\begin{entry}{卷}{juan4}{8}[HSK 4][Radical ⼙]
...
\begin{entry}{圈}{juan4}{11}[Radical ⼞]
