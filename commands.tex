...
\NewDocumentEnvironment{verbete}{ o m o m o }{%
  ...
  \markboth{#2{\small«\pinyin{\pstr}»}}{#2{\small«\py»}}
  \IfValueTF{#1}{%
    \readlist\listofstrokes{#1}
    \index{\zeropad{000}{\listofstrokes[1]}#4@#2 «\py»}
  }{%
    \index{\zeropad{000}{0}#4@#2 «\py»}
  }
  ...
  \IfValueTF{#3}{%
    ...
    \IfValueTF{#5}
      ...
      {\hspace{1em}«\py»\IfValueT{#1}{\hfill\textsuperscript{\tiny(#1画)}}}%
  }%
  \newline
}{%
  \end{FlushLeft}%
...
\NewDocumentEnvironment{verbete*}{ o m o m o }{%
  ...
  \IfValueTF{#1}{%
    \readlist\listofstrokes{#1}
    \index{\zeropad{000}{\listofstrokes[1]}#4@\textcolor{BrickRed}{#2} «\pinyin{#4}»}
  }{\index{\zeropad{000}{0}#4@\textcolor{BrickRed}{#2} «\pinyin{#4}»}}
  \begin{minipage}[t][][t]{\linewidth}%
  \begin{FlushLeft}%
  ...
  \IfValueTF{#3}{%
    \IfValueT{#1}{\hfill\textsuperscript{\tiny(#1画)}}%
    \IfValueTF{#5}{#3«\pinyin{#4}»#5}{#3«\pinyin{#4}»}
  }{%
    \IfValueTF{#5}
      {\IfValueT{#1}{\hfill\textsuperscript{\tiny(#1画)}} «\pinyin{#4}»#5}%
