...
\begin{verbete}[zen3me0hui2shi4]{怎么i回事}
...
\significado{part.}{
partícula indicando ação em andamento ou estado em andamento
}
\end{pronuncia}
\end{verbete}
...
\begin{verbete}[zhe4yang4]{这样}
\begin{pronuncia}{zhe4yang4}
\significado{adv.}{
assim; dessa maneira; deste modo
}
\end{pronuncia}
\end{verbete}
