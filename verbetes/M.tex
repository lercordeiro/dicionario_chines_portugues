...
\significado{adj.}{ enfastidioso; maçante }
\significado{s.}{ incômodo }
\significado{v.}{ incomodar }
\end{pronuncia}
\end{verbete}

\begin{verbete}[ma2la4dou4fu0]{麻辣豆腐}[11;14;7;14]
\begin{pronuncia}[\\]{ma2la4dou4fu0}
\significado{s.}{ tofú guisado em molho picante }
\end{pronuncia}
\end{verbete}
...
\significado[个]{s.}{ chefe; diretor; líder }
\significado{v.}{ chefiar; dirigir }
\end{pronuncia}
\end{verbete}
...
\significado[个]{s.}{ irmã mais nova }
\end{pronuncia}
\end{verbete}

\begin{verbete}[men2kou3]{门口}[3;3]
\begin{pronuncia}{men2kou3}
\significado{p.d.l.}{ entrada; porta }
\end{pronuncia}
\end{verbete}

\begin{verbete}[men0]{们}[5]
\begin{pronuncia}{men0}
\significado{sufixo}{ sufixo para plural (pessoas e pronomes) }
\end{pronuncia}
\end{verbete}
...
\significado{s.}{ área; superfície }
\end{pronuncia}
\end{verbete}

\begin{verbete}[mian4tiao2]{面条}[9;7]
\begin{pronuncia}{mian4tiao2}
\significado{s.}{ massa; espaguete }
\end{pronuncia}
\end{verbete}
...
\significado{adj.}{ compreendido; percebido }
