...
\significado{v.+compl.}{
ir para o trabalho; ir para o emprego
}
\end{pronuncia}
\end{verbete}
...
\begin{verbete}[shang4lai0]{上来}
\begin{pronuncia}{shang4lai0}
\significado{v.}{
subir (para a minha localização)
}
\end{pronuncia}
\end{verbete}
...
\significado{v.}{
subir (a partir da minha localização)
}
\end{pronuncia}
\end{verbete}
