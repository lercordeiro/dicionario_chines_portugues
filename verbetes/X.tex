...
\begin{verbete}[希望]{xi1wang4}
\significado{xi1wang4}{v.}{
    desejar
}
\significado{xi1wang4}{n.}{
    desejo
}
\end{verbete}
...
\begin{verbete}[写作]{xie3zuo4}
\significado{xie3zuo4}{n.}{
    escrita; redação; composição
}
\significado{xie3zuo4}{v.}{
    escrever
}
\end{verbete}
...
\begin{verbete}[学分]{xue2fen1}
\significado{xue2fen1}{n.}{
    crédito de um curso
}
\end{verbete}
