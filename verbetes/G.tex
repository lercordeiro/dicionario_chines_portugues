...
\begin{verbete}[gei3(alguém)da3dian4hua4]{给(alguém)打电话}[9;5;5;8]
...
\significado[个]{s.}{ artigo de artesanato }
\end{pronuncia}
\end{verbete}
...
\significado[套]{s.}{ apartamento; pensão }
\end{pronuncia}
\end{verbete}
...
\significado[项]{s.}{ publicidade; anúncio }
\end{pronuncia}
\end{verbete}
