...
\significado{s.}{ povo coreano; nascido na Coréia }
\end{pronuncia}
\end{verbete}
...
\significado{v.}{ conversar com os outros; compor um poema em resposta (ao poema de sb) usando a mesma sequência de rimas; para se juntar ao canto (canção) }
\end{pronuncia}
\begin{pronuncia}{hu2}
\significado*{}{ 和\p{hu2}}
\end{pronuncia}
\begin{pronuncia}{huo4}
\significado*{}{ 和\p{huo4}}
\end{pronuncia}
\end{verbete}
